...
var _templateObject$9, _templateObject2$8, _templateObject3$7, _templateObject4$5, _templateObject5$5, _templateObject6$5, _templateObject7$4, _templateObject8$4, _templateObject9$4, _templateObject0$3, _templateObject1$3;
...
var _templateObject$7, _templateObject2$6, _templateObject3$5, _templateObject4$4, _templateObject5$4, _templateObject6$4, _templateObject7$3, _templateObject8$3, _templateObject9$3, _templateObject0$2, _templateObject1$2, _templateObject10$2, _templateObject11$2, _templateObject12$2, _templateObject13$2;
...
var _templateObject$6, _templateObject2$5, _templateObject3$4, _templateObject4$3, _templateObject5$3, _templateObject6$3;
...
class YetAnotherMediaPlayerEditor extends i$1 {
  ...
  _renderBehaviorTab() {
    var _this$_config$idle_ti, _this$_config$show_ch, _this$_config$hold_to, _this$_config$disable, _this$_config$keep_fi, _this$_config$dismiss, _this$_config$disable2, _this$_config$search_, _this$_config$search_2;
  ...
  _renderVisualTab() {
    ...
    }, (_this$_config$control = this._config.control_layout) !== null && _this$_config$control !== void 0 ? _this$_config$control : "classic", e => this._updateConfig("control_layout", e.detail.value), ((_this$_config$control2 = this._config.control_layout) !== null && _this$_config$control2 !== void 0 ? _this$_config$control2 : "classic") === "modern" ? "" : "opacity: 0.5;", ((_this$_config$control3 = this._config.control_layout) !== null && _this$_config$control3 !== void 0 ? _this$_config$control3 : "classic") === "modern" ? "" : "Only available with Modern layout", (_this$_config$swap_pa = this._config.swap_pause_for_stop) !== null && _this$_config$swap_pa !== void 0 ? _this$_config$swap_pa : false, e => this._updateConfig("swap_pause_for_stop", e.target.checked), ((_this$_config$control4 = this._config.control_layout) !== null && _this$_config$control4 !== void 0 ? _this$_config$control4 : "classic") !== "modern", (_this$_config$adaptiv = this._config.adaptive_controls) !== null && _this$_config$adaptiv !== void 0 ? _this$_config$adaptiv : false, e => this._updateConfig("adaptive_controls", e.target.checked), (_this$_config$hide_ac = this._config.hide_active_entity_label) !== null && _this$_config$hide_ac !== void 0 ? _this$_config$hide_ac : false, e => this._updateConfig("hide_active_entity_label", e.target.checked), this.hass, {
      select: {
        multiple: true,
  ...
  _renderActionsTab() {
    ...
    return x(_templateObject20$1 || (_templateObject20$1 = _taggedTemplateLiteral(["\n        <div class=\"action-group config-section\">\n          <div class=\"action-group-header section-header\">\n            <div class=\"action-group-title section-title\">Actions</div>\n            <div class=\"section-description\">Build the action chips that appear in the card or its menu. Drag to reorder, click the pencil to configure each action.</div>\n          </div>\n          <div class=\"form-row\">\n            <yamp-sortable @item-moved=", ">\n              <div class=\"sortable-container\">\n                ", "\n              </div>\n            </yamp-sortable>\n          </div>\n          <div class=\"add-action-button-wrapper\">\n            <ha-icon\n              class=\"icon-button\"\n              icon=\"mdi:plus\"\n              title=\"Add Action\"\n              @click=", "\n            ></ha-icon>\n          </div>\n        </div>\n      "])), e => this._onActionMoved(e), actions.map((act, idx) => {
      var _act$name;
      return x(_templateObject21$1 || (_templateObject21$1 = _taggedTemplateLiteral(["\n                  <div class=\"action-row-inner sortable-item\">\n                    <div class=\"handle action-handle\">\n                      <ha-icon icon=\"mdi:drag\"></ha-icon>\n                    </div>\n                    ", "\n                    <div class=\"grow-children\">\n                      <ha-textfield\n                        placeholder=\"(Icon Only)\"\n                        .value=", "\n                        .helper=", "\n                        .helperPersistent=", "\n                        @input=", "\n                      ></ha-textfield>\n                    </div>\n                    <div class=\"action-row-actions\">\n                      <ha-icon\n                        class=\"icon-button icon-button-compact\"\n                        icon=\"mdi:pencil\"\n                        title=\"Edit Action Settings\"\n                        @click=", "\n                      ></ha-icon>\n                      <ha-icon\n                        class=\"icon-button icon-button-compact icon-button-toggle ", "\"\n                        icon=\"", "\"\n                        title=\"", "\"\n                        role=\"button\"\n                        aria-label=\"", "\"\n                        @click=", "\n                      ></ha-icon>\n                      <ha-icon\n                        class=\"icon-button icon-button-compact\"\n                        icon=\"mdi:trash-can\"\n                        title=\"Delete Action\"\n                        @click=", "\n                      ></ha-icon>\n                    </div>\n                  </div>\n                "])), act !== null && act !== void 0 && act.icon ? x(_templateObject22$1 || (_templateObject22$1 = _taggedTemplateLiteral(["\n                      <ha-icon class=\"action-icon\" icon=\"", "\"></ha-icon>\n                    "])), act === null || act === void 0 ? void 0 : act.icon) : x(_templateObject23$1 || (_templateObject23$1 = _taggedTemplateLiteral(["<span class=\"action-icon-placeholder\"></span>"]))), (_act$name = act === null || act === void 0 ? void 0 : act.name) !== null && _act$name !== void 0 ? _act$name : "", (() => {
  ...
  _renderActionEditor(action) {
    ...
    }, actionMode === "menu" ? x(_templateObject37$1 || (_templateObject37$1 = _taggedTemplateLiteral(["\n          <div class=\"form-row\">\n            <ha-selector\n              .hass=", "\n              label=\"Menu Item\"\n              .selector=", "\n              .value=", "\n              @value-changed=", "\n            ></ha-selector>\n          </div>\n        "])), this.hass, {
      select: {
        mode: "dropdown",
        options: [{
          value: "",
