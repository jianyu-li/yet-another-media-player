 ...
 */const uo=lo(class extends co{constructor(i){if(super(i),i.type!==oo.ATTRIBUTE||i.name!=="class"||i.strings?.length>2)throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(i){return" "+Object.keys(i).filter((e=>i[e])).join(" ")+" "}update(i,[e]){if(this.st===void 0){this.st=new Set,i.strings!==void 0&&(this.nt=new Set(i.strings.join(" ").split(/\s/).filter((a=>a!==""))));for(const a in e)e[a]&&!this.nt?.has(a)&&this.st.add(a);return this.render(e)}const t=i.element.classList;for(const a of this.st)a in e||(t.remove(a),this.st.delete(a));for(const a in e){const r=!!e[a];r===this.st.has(a)||this.nt?.has(a)||(r?(t.add(a),this.st.add(a)):(t.remove(a),this.st.delete(a)))}return it}});var ho={common:{not_found:"Entity not found.",search:"Search",power:"Power",favorite:"Favorite",loading:"Loading...",no_results:"No results.",close:"Close",vol_up:"Volume Up",vol_down:"Volume Down",media_player:"Media Player",edit_entity:"Edit Entity Settings",edit_action:"Edit Action Settings",mute:"Mute",unmute:"Unmute",seek:"Seek",volume:"Volume",play_now:"Play Now",more_options:"More Options",unavailable:"Unavailable",back:"Back",cancel:"Cancel",reset_default:"Reset to default"},editor:{tabs:{entities:"Entities",behavior:"Behavior",look_and_feel:"Look and Feel",artwork:"Artwork",actions:"Actions"},placeholders:{search:"Search music..."},sections:{artwork:{general:{title:"General Settings",description:"Global controls for how artwork is displayed and retrieved."},idle:{title:"Idle Artwork",description:"Show a static image or entity snapshot whenever nothing is playing."},overrides:{title:"Artwork Overrides",description:"Overrides are evaluated from top to bottom. Drag to reorder."}},entities:{title:"Entities*",description:"Add the media players you want to control. Drag entities to reorder the chip row."},behavior:{idle_chips:{title:"Idle & Chips",description:"Choose when the card goes idle and how entity chips behave."},interactions_search:{title:"Interactions & Search",description:"Fine-tune how entities are pinned and how many results show at once."}},look_and_feel:{theme_layout:{title:"Theme & Layout",description:"Match dashboard styling and control the overall footprint."},controls_typography:{title:"Controls & Typography",description:"Tune button sizing, entity labels, and adaptive text."},collapsed_idle:{title:"Collapsed & Idle States",description:"Control when the card collapses and which views show while idle."}},actions:{title:"Actions",description:"Build the action chips that appear in the card or its menu. Drag to reorder, click the pencil to configure each action."}},subtitles:{idle_timeout:"Time in milliseconds before the card enters idle mode. Set to 0 to disable idle behavior.",show_chip_row:'"Auto" hides the chip row when only one entity is configured. "In Menu" moves the chips into the menu overlay. "In Menu on Idle" shows chips inline when active but moves them to the menu when idle.',dim_chips:"When the card enters idle mode with an image, dim the entity and action chips for a cleaner look.",hold_to_pin:"Long press on entity chips instead of short press to pin them, preventing auto-switching during playback.",always_show_group:"Quick grouping controls (+/-/star) will be visible by default on page load. You can still toggle it manually via double-tap.",disable_autofocus:"Keep the search box from stealing focus so on-screen keyboards stay hidden.",search_within_filter:"Enable this to search within the current active filter (Favorites, Recently Played, etc) instead of clearing it.",close_search_on_play:"Automatically close the search screen when a track is played.",pin_search_headers:"Keep search input and filters fixed at the top while scrolling results.",hide_search_headers_on_idle:"Hide search input and filters when the player is idle.",disable_mass:"Disable the optional Mass Queue integration even if it is installed.",swap_pause_stop:"Replace the pause button with stop while using the modern layout.",adaptive_controls:"Let the playback buttons grow or shrink to fit the available space.",hide_menu_player:"When chips live in the menu, hide the entity label at the bottom of the card.",adaptive_text:"Choose which text groups should scale with available space (leave empty to disable adaptive text).",collapse_expand:"Always Collapsed creates mini player mode. Expand on Search temporarily expands when searching.",idle_screen:"Choose which screen to display automatically when the card becomes idle.",hide_controls:"Select which controls to hide for this entity (all are shown by default)",hide_search_chips:"Hide specific search filter chips for this entity",follow_active_entity:"When enabled, the volume entity will automatically follow the active playback entity. Note: This overrides the selected volume entity.",search_limit_full:"Maximum number of search results to display (1-1000, default: 20)",default_search_filter_full:"Choose which filter is active by default when the search screen opens.",default_search_favorites:"Start search with favorites active",result_sorting_full:"Choose how results are ordered.",card_height_full:"Leave blank for automatic height",control_layout_full:"Choose between the legacy evenly sized controls or the modern Home Assistant layout.",artwork_extend:"Let the artwork background continue underneath the chip and action rows.",artwork_extend_label:"Extend artwork",no_artwork_overrides:"No artwork overrides configured. Use the plus button below to add one.",entity_current_hint:"Use 'entity_id: current' to target the card's currently selected media player entity. Note: The 'Test Action' button will be disabled when using this feature.",service_data_note:"Changes to the service data below are not committed to the config until the 'Save Service Data' button is clicked!",jinja_template_hint:"Enter a Jinja template that resolves to a single entity_id. Example switching MA based on a source selector:",jinja_template_vol_hint:"Enter a Jinja template that resolves to an entity_id (e.g. media_player.office_homepod or remote.soundbar). Example switching volume entity based on a boolean:",not_available_alt_collapsed:"Not available with Alternate Progress Bar or Always Collapsed mode",not_available_collapsed:"Not available when Always Collapsed is enabled",only_available_collapsed:"Only available when Always Collapsed is enabled",only_available_modern:"Only available with Modern layout",image_url_helper:"Enter a direct URL to an image or a local file path",selected_entity_helper:"Input text helper that will be updated with the currently selected media player entity ID.",select_entity_helper:"Input text helper to read the entity ID from. The card will automatically select the matching chip.",sync_entity_type:"Choose which entity ID to sync to the helper (defaults to Music Assistant entity if configured).",disable_auto_select:"Prevent this entity's chip from automatically being selected when it starts playing.",search_view:"Choose between a standard list or a card-based grid for search results.",search_card_columns:"Specify how many columns to use in the card view. Artwork will scale automatically.",card_type:"Choose the card mode. 'Default' is the standard media player. 'Dedicated Search' makes the card a permanent search interface."},titles:{edit_entity:"Edit Entity",edit_action:"Edit Action",service_data:"Service Data",add_artwork_override:"Add Artwork Override"},labels:{dim_chips:"Dim Chips on Idle",hold_to_pin:"Hold to Pin",always_show_group:"Quick Group by Default",disable_autofocus:"Disable Search Autofocus",keep_filters:"Keep Filters on Search",dismiss_on_play:"Dismiss search on play",pin_headers:"Pin search headers",hide_search_headers_on_idle:"Hide search headers on idle",default_search_filter:"Default Search Filter",default_search_favorites:"Default to Favorites Filter",disable_mass:"Disable Mass Queue",match_theme:"Match Theme",alt_progress:"Alternate Progress Bar",display_timestamps:"Display Timestamps",swap_pause_stop:"Swap Pause with Stop",adaptive_controls:"Adaptive Control Size",hide_active_entity:"Hide Active Entity Label",collapse_on_idle:"Collapse on Idle",hide_menu_player_toggle:"Hide Menu Player",always_collapsed:"Always Collapsed",expand_on_search:"Expand on Search",script_var:"Script Variable (yamp_entity)",use_ma_template:"Use template for Music Assistant Entity",use_vol_template:"Use template for Volume Entity",follow_active_entity:"Volume Entity Follows Active Entity",use_url_path:"Use URL or Path",adaptive_text_elements:"Adaptive Text Size Elements",disable_auto_select:"Disable Auto-Select"},fields:{artwork_fit:"Artwork Fit",artwork_position:"Artwork Position",artwork_hostname:"Artwork Hostname",match_field:"Match Field",match_value:"Match Value",size_percent:"Size (%)",object_fit:"Object Fit",idle_timeout:"Idle Timeout (ms)",show_chip_row:"Show Chip Row",search_limit:"Search Results Limit",result_sorting:"Result Sorting",vol_step:"Volume Step (0.05 = 5%)",card_height:"Card Height (px)",control_layout:"Control Layout",save_service_data:"Save Service Data",image_url:"Image URL",fallback_image_url:"Fallback Image URL",move_to_main:"Move action to main chips",move_to_menu:"Move action into menu",delete_action:"Delete Action",revert_service_data:"Revert to Saved Service Data",test_action:"Test Action",volume_mode:"Volume Mode",idle_screen:"Idle Screen",name:"Name",hidden_controls:"Hidden Controls",ma_template:"Music Assistant Entity Template (Jinja)",hidden_chips:"Hidden Search Filter Chips",vol_template:"Volume Entity Template (Jinja)",icon:"Icon",action_type:"Action Type",menu_item:"Menu Item",nav_path:"Navigation Path",service:"Service",service_data:"Service Data",idle_image_entity:"Idle Image Entity",match_entity:"Match Entity",ma_entity:"Music Assistant Entity",vol_entity:"Volume Entity",selected_entity_helper:"Selected Entity Helper",sync_entity_type:"Sync Entity Type",placement:"Placement",card_trigger:"Card Trigger",search_view:"Search Result View",search_card_columns:"Card Columns",card_type:"Card Type",appearance:"Appearance",no_artwork_option:"No Artwork"},action_types:{menu:"Open a Card Menu Item",service:"Call a Service",navigate:"Navigate",prev_entity:"Previous Entity Chip",next_entity:"Next Entity Chip",sync_selected_entity:"Sync Selected Entity",select_entity:"Select Entity from Helper"},action_helpers:{sync_selected_entity:"Sync Selected Entity \u2192",select_entity:"Select Entity \u2190",select_helper:"(select helper)"},sync_entity_options:{yamp_entity:"yamp_entity (Music Assistant Entity if configured)",yamp_main_entity:"yamp_main_entity (Main Media Player Entity)",yamp_playback_entity:"yamp_playback_entity (Current Active Playback Entity)"},placements:{chip:"Action Chip",menu:"In Menu",hidden:"Hidden (Artwork Tap)",not_triggerable:"Not Triggerable"},triggers:{none:"None",tap:"Tap",hold:"Hold",double_tap:"Double Tap",swipe_left:"Swipe Left",swipe_right:"Swipe Right"},search_view_options:{list:"List",card:"Card",card_minimal:"Minimal Card"},card_type_options:{default:"Default",search:"Search",group_players:"Group Players"},appearance_options:{automatic:"Automatic",light:"Light",dark:"Dark"}},card:{sections:{details:"Now Playing Details",menu:"Menu & Search Sheets",action_chips:"Action Chips"},media_controls:{shuffle:"Shuffle",previous:"Previous",play_pause:"Play/Pause",stop:"Stop",next:"Next",repeat:"Repeat"},menu:{more_info:"More Info",search:"Search",source:"Source",transfer_queue:"Transfer Queue",group_players:"Group Players",select_entity:"Select Entity for More Info",transfer_to:"Transfer Queue To",no_players:"No other Music Assistant players available."},grouping:{title:"Group Players",sync_volume:"Sync Volume",group_all:"Group All",ungroup_all:"Ungroup All",unavailable:"Player is unavailable",no_players:"No other group-capable players available.",master:"Master",joined:"Joined",available:"Available",current:"Current",unjoin_from:"Unjoin from {master}",join_with:"Join with {master}"}},search:{favorites:"Favorites",recently_played:"Recently Played",next_up:"Next Up",recommendations:"Recommendations",radio_mode:"Radio Mode",play_similar:"Play similar songs",close:"Close Search",no_results:"No results.",play_next:"Play next",replace_play:"Replace existing queue and play now",replace:"Replace queue",add_queue:"Add to the end of the queue",move_up:"Move Up",move_down:"Move Down",move_next:"Move to Next",remove:"Remove from Queue",added:"Added to queue!",added_to_playlist:"Added to playlist!",select_playlist:"Select Playlist for '{track}'",add_to_playlist:"Add to playlist",select_track_for_playlist:"Select the track to add for '{track}' by {artist}",labels:{replace:"Replace",next:"Next",replace_next:"Replace Next",add:"Add",add_to_playlist:"Add to Playlist"},results:"results",result:"result",filters:{all:"All",artist:"Artist",album:"Album",track:"Track",playlist:"Playlist",radio:"Radio",music:"Music",station:"Station",podcast:"Podcast",audiobook:"Audiobook"},search_artist:"Search for this artist",browse_album:"Browse tracks from {album}",play_collection:"Play this collection",play_collection_error:"Unable to play this collection directly",play_item:"Play {item}"}},po={common:{not_found:"Entit\xE4t nicht gefunden.",search:"Suchen",power:"Ein/Aus",favorite:"Favorit",loading:"Laden...",no_results:"Keine Ergebnisse.",close:"Schlie\xDFen",vol_up:"Lauter",vol_down:"Leiser",media_player:"Mediaplayer",edit_entity:"Entit\xE4tseinstellungen bearbeiten",edit_action:"Aktionseinstellungen bearbeiten",mute:"Stumm",unmute:"Stummschaltung aufheben",seek:"Suchen",volume:"Lautst\xE4rke",play_now:"Jetzt abspielen",more_options:"Weitere Optionen",unavailable:"Nicht verf\xFCgbar",back:"Zur\xFCck",cancel:"Abbrechen",reset_default:"Auf Standard zur\xFCcksetzen"},editor:{tabs:{entities:"Entit\xE4ten",behavior:"Verhalten",look_and_feel:"Design",artwork:"Artwork",actions:"Aktionen"},placeholders:{search:"Musik suchen..."},sections:{artwork:{general:{title:"Allgemeine Einstellungen",description:"Globale Steuerung der Artwork-Anzeige und -Abrufung."},idle:{title:"Artwork im Leerlauf",description:"Zeigt ein statisches Bild oder einen Entit\xE4ts-Schnappschuss an, wenn nichts abgespielt wird."},overrides:{title:"Artwork-\xDCberschreibungen",description:"\xDCberschreibungen werden von oben nach unten ausgewertet. Zum Neusortieren ziehen."}},entities:{title:"Entit\xE4ten*",description:"F\xFCgen Sie die zu steuernden Mediaplayer hinzu. Entit\xE4ten ziehen, um sie neu anzuordnen."},behavior:{idle_chips:{title:"Leerlauf & Chips",description:"W\xE4hlen Sie, wann die Karte in den Leerlauf wechselt und wie sich Entit\xE4ts-Chips verhalten."},interactions_search:{title:"Interaktionen & Suche",description:"Feineinstellung des Anpinnens von Entit\xE4ten und der Anzahl der Suchergebnisse."}},look_and_feel:{theme_layout:{title:"Theme & Layout",description:"Anpassung an das Dashboard-Styling und Kontrolle des Platzbedarfs."},controls_typography:{title:"Steuerung & Typografie",description:"Anpassung von Schaltfl\xE4chengr\xF6\xDFe, Entit\xE4ts-Labels und adaptivem Text."},collapsed_idle:{title:"Eingeklappte & Leerlaufzust\xE4nde",description:"Steuerung der Karteneinklappung und der Ansichten im Leerlauf."}},actions:{title:"Aktionen",description:"Erstellen Sie Aktions-Chips f\xFCr die Karte oder das Men\xFC. Ziehen zum Sortieren, Stift zum Konfigurieren anklicken."}},subtitles:{idle_timeout:"Zeit in Millisekunden vor dem Wechsel in den Leerlaufmodus. 0 zum Deaktivieren.",show_chip_row:'"Auto" blendet die Chip-Leiste bei nur einer Entit\xE4t aus. "Im Men\xFC" verschiebt sie ins Men\xFC. "Im Men\xFC bei Inaktivit\xE4t" zeigt Chips inline wenn aktiv, verschiebt sie aber ins Men\xFC bei Inaktivit\xE4t.',dim_chips:"Entit\xE4ts- und Aktions-Chips im Leerlauf mit Bild abdunkeln f\xFCr einen sauberen Look.",hold_to_pin:"Langes Dr\xFCcken statt kurzem Dr\xFCcken zum Anpinnen, um automatisches Umschalten zu verhindern.",always_show_group:"Schnellgruppierungs-Steuerelemente (+/-/Stern) sind standardm\xE4\xDFig beim Laden der Seite sichtbar. Sie k\xF6nnen sie weiterhin manuell per Doppeltipp umschalten.",disable_autofocus:"Suchfeld-Autofokus deaktivieren, damit Bildschirmtastaturen ausgeblendet bleiben.",search_within_filter:"Innerhalb des aktiven Filters suchen (Favoriten, etc.), anstatt ihn zu l\xF6schen.",close_search_on_play:"Suchbildschirm beim Abspielen automatisch schlie\xDFen.",pin_search_headers:"Sucheingabe und Filter beim Scrollen oben fixieren.",hide_search_headers_on_idle:"Sucheingabe und Filter im Leerlauf ausblenden.",disable_mass:"Optionale Mass Queue Integration deaktivieren, auch wenn sie installiert ist.",swap_pause_stop:"Pause-Taste durch Stop-Taste im modernen Layout ersetzen.",adaptive_controls:"Wiedergabetasten an verf\xFCgbaren Platz anpassen.",hide_menu_player:"Entit\xE4ts-Label unten ausblenden, wenn Chips im Men\xFC sind.",adaptive_text:"Textgruppen w\xE4hlen, die mit dem Platz skalieren (leer lassen zum Deaktivieren).",collapse_expand:"Immer eingeklappt aktiviert den Mini-Player-Modus. Bei Suche ausklappen aktiviert ihn tempor\xE4r.",idle_screen:"W\xE4hlen Sie, welcher Bildschirm im Leerlauf automatisch angezeigt wird.",hide_controls:"W\xE4hlen Sie Steuerelemente aus, die f\xFCr diese Entit\xE4t ausgeblendet werden sollen.",hide_search_chips:"Bestimmte Suchfilter-Chips f\xFCr diese Entit\xE4t ausblenden.",follow_active_entity:"Lautst\xE4rke-Entit\xE4t folgt automatisch der aktiven Wiedergabe-Entit\xE4t.",search_limit_full:"Maximale Anzahl an Suchergebnissen (1-1000, Standard: 20).",default_search_filter_full:"W\xE4hlen Sie den Filter, der beim \xD6ffnen der Suche standardm\xE4\xDFig aktiv ist.",default_search_favorites:"Suche mit aktiven Favoriten starten",result_sorting_full:"Sortierung der Suchergebnisse w\xE4hlen. Standard beh\xE4lt die Quellreihenfolge bei.",card_height_full:"Leer lassen f\xFCr automatische H\xF6he.",control_layout_full:"W\xE4hlen Sie zwischen manuellem oder modernem Home Assistant Layout.",artwork_extend:"Artwork-Hintergrund unter die Chip- und Aktionsleisten erweitern.",artwork_extend_label:"Artwork erweitern",no_artwork_overrides:"Keine Artwork-\xDCberschreibungen konfiguriert.",entity_current_hint:"'entity_id: current' verwenden, um den aktuell ausgew\xE4hlten Mediaplayer anzusteuern.",service_data_note:"\xC4nderungen an den Servicedaten werden erst beim Klicken auf 'Servicedaten speichern' \xFCbernommen!",jinja_template_hint:"Jinja-Template eingeben, das eine entity_id ergibt.",jinja_template_vol_hint:"Jinja-Template eingeben, das eine Lautst\xE4rke-entity_id ergibt.",not_available_alt_collapsed:"Nicht verf\xFCgbar mit alternativem Fortschrittsbalken oder im Modus 'Immer eingeklappt'.",not_available_collapsed:"Nicht verf\xFCgbar, wenn 'Immer eingeklappt' aktiviert ist.",only_available_collapsed:"Nur verf\xFCgbar, wenn 'Immer eingeklappt' aktiviert ist.",only_available_modern:"Nur verf\xFCgbar im modernen Layout.",image_url_helper:"Direkte Bild-URL oder lokalen Dateipfad eingeben.",selected_entity_helper:"Input-Text-Helper, der mit der aktuell ausgew\xE4hlten Mediaplayer-Entit\xE4ts-ID aktualisiert wird.",select_entity_helper:"Input-Text-Helper, aus dem die Entit\xE4ts-ID gelesen wird. Die Karte w\xE4hlt automatisch den passenden Chip aus.",sync_entity_type:"W\xE4hlen Sie, welche Entit\xE4ts-ID mit dem Helper synchronisiert werden soll (Standard: Music Assistant Entit\xE4t, falls konfiguriert).",disable_auto_select:"Verhindert, dass der Chip dieser Entit\xE4t automatisch ausgew\xE4hlt wird, wenn die Wiedergabe startet.",search_view:"W\xE4hlen Sie zwischen einer Standardliste oder einem kartenbasierten Raster f\xFCr Suchergebnisse.",search_card_columns:"Geben Sie an, wie viele Spalten in der Kartenansicht verwendet werden sollen. Das Artwork wird automatisch skaliert.",card_type:"W\xE4hlen Sie den Kartenmodus. 'Standard' ist der normale Mediaplayer. 'Dedizierte Suche' macht die Karte zu einer permanenten Suchoberfl\xE4che."},titles:{edit_entity:"Entit\xE4t bearbeiten",edit_action:"Aktion bearbeiten",service_data:"Servicedaten",add_artwork_override:"Artwork-\xDCberschreibung hinzuf\xFCgen"},labels:{dim_chips:"Chips im Leerlauf abdunkeln",hold_to_pin:"Gedr\xFCckt halten zum Anpinnen",always_show_group:"Schnellgruppierung standardm\xE4\xDFig aktivieren",disable_autofocus:"Such-Autofocus deaktivieren",keep_filters:"Filter bei Suche beibehalten",dismiss_on_play:"Suche beim Abspielen beenden",default_search_filter:"Standard-Suchfilter",default_search_favorites:"Standardm\xE4\xDFig Favoritenfilter verwenden",pin_headers:"Such-Header fixieren",hide_search_headers_on_idle:"Such-Header im Leerlauf ausblenden",disable_mass:"Mass Queue deaktivieren",match_theme:"Theme anpassen",alt_progress:"Alternativer Fortschrittsbalken",display_timestamps:"Zeitstempel anzeigen",swap_pause_stop:"Pause durch Stop ersetzen",adaptive_controls:"Adaptive Tastengr\xF6\xDFe",hide_active_entity:"Aktives Entit\xE4ts-Label ausblenden",collapse_on_idle:"Bei Leerlauf einklappen",hide_menu_player_toggle:"Men\xFC-Player ausblenden",always_collapsed:"Immer eingeklappt",expand_on_search:"Bei Suche ausklappen",script_var:"Skript-Variable (yamp_entity)",use_ma_template:"Template f\xFCr Music Assistant Entit\xE4t verwenden",use_vol_template:"Template f\xFCr Lautst\xE4rke-Entit\xE4t verwenden",follow_active_entity:"Lautst\xE4rke folgt aktiver Entit\xE4t",use_url_path:"URL oder Pfad verwenden",adaptive_text_elements:"Elemente f\xFCr adaptive Textgr\xF6\xDFe",disable_auto_select:"Auto-Auswahl deaktivieren"},fields:{artwork_fit:"Artwork-Anpassung",artwork_position:"Artwork-Position",artwork_hostname:"Artwork-Hostname",match_field:"Match-Feld",match_value:"Match-Wert",size_percent:"Gr\xF6\xDFe (%)",object_fit:"Object-Fit",idle_timeout:"Leerlauf-Timeout (ms)",show_chip_row:"Chip-Leiste anzeigen",search_limit:"Suchlimit",result_sorting:"Ergebnissortierung",vol_step:"Lautst\xE4rke-Schritt (0.05 = 5%)",card_height:"Kartenh\xF6he (px)",control_layout:"Steuerungs-Layout",save_service_data:"Servicedaten speichern",image_url:"Bild-URL",fallback_image_url:"Fallback Bild-URL",move_to_main:"Aktion in Haupt-Chips verschieben",move_to_menu:"Aktion ins Men\xFC verschieben",delete_action:"Aktion l\xF6schen",revert_service_data:"Auf gespeicherte Servicedaten zur\xFCcksetzen",test_action:"Aktion testen",volume_mode:"Lautst\xE4rke-Modus",idle_screen:"Leerlauf-Bildschirm",name:"Name",hidden_controls:"Ausgeblendete Steuerungen",ma_template:"Music Assistant Entit\xE4ts-Template (Jinja)",hidden_chips:"Ausgeblendete Suchfilter-Chips",vol_template:"Lautst\xE4rke-Entit\xE4ts-Template (Jinja)",icon:"Icon",action_type:"Aktionstyp",menu_item:"Men\xFCpunkt",nav_path:"Navigationspfad",service:"Dienst",service_data:"Servicedaten",idle_image_entity:"Leerlauf-Bild-Entit\xE4t",match_entity:"Match-Entit\xE4t",ma_entity:"Music Assistant Entit\xE4t",vol_entity:"Lautst\xE4rke-Entit\xE4t",selected_entity_helper:"Ausgew\xE4hlter Entit\xE4ts-Helper",sync_entity_type:"Synchronisierungs-Entit\xE4tstyp",placement:"Platzierung",card_trigger:"Karten-Trigger",search_view:"Suchergebnis-Ansicht",search_card_columns:"Spaltenanzahl",card_type:"Kartentyp",no_artwork_option:"Kein Coverbild"},action_types:{menu:"Kartenmen\xFCpunkt \xF6ffnen",service:"Dienst aufrufen",navigate:"Navigieren",prev_entity:"Vorheriger Entit\xE4ts-Chip",next_entity:"N\xE4chster Entit\xE4ts-Chip",sync_selected_entity:"Ausgew\xE4hlte Entit\xE4t synchronisieren",select_entity:"Entit\xE4t aus Helper ausw\xE4hlen"},action_helpers:{sync_selected_entity:"Entit\xE4t synchronisieren \u2192",select_entity:"Entit\xE4t ausw\xE4hlen \u2190",select_helper:"(Helper ausw\xE4hlen)"},sync_entity_options:{yamp_entity:"yamp_entity (Music Assistant Entit\xE4t, falls konfiguriert)",yamp_main_entity:"yamp_main_entity (Haupt-Mediaplayer-Entit\xE4t)",yamp_playback_entity:"yamp_playback_entity (Aktuelle aktive Wiedergabe-Entit\xE4t)"},placements:{chip:"Aktions-Chip",menu:"Im Men\xFC",hidden:"Ausgeblendet (Artwork-Tippen)",not_triggerable:"Nicht triggerbar"},triggers:{none:"Keiner",tap:"Tippen",hold:"Halten",double_tap:"Doppeltippen",swipe_left:"Nach links wischen",swipe_right:"Nach rechts wischen"},search_view_options:{list:"Liste",card:"Karte",card_minimal:"Minimal-Karte"},card_type_options:{default:"Standard",search:"Suche",group_players:"Player gruppieren"}},card:{sections:{details:"Details zur Wiedergabe",menu:"Men\xFC & Suchbl\xE4tter",action_chips:"Aktions-Chips"},media_controls:{shuffle:"Zufall",previous:"Zur\xFCck",play_pause:"Play/Pause",stop:"Stop",next:"Weiter",repeat:"Wiederholen"},menu:{more_info:"Mehr Info",search:"Suche",source:"Quelle",transfer_queue:"Warteschlange \xFCbertragen",group_players:"Player gruppieren",select_entity:"Entit\xE4t f\xFCr mehr Info w\xE4hlen",transfer_to:"Warteschlange \xFCbertragen zu",no_players:"Keine anderen Music Assistant Player verf\xFCgbar."},grouping:{title:"Player gruppieren",sync_volume:"Lautst\xE4rke synchronisieren",group_all:"Alle gruppieren",ungroup_all:"Alle trennen",unavailable:"Player ist nicht verf\xFCgbar",no_players:"Keine anderen gruppierungsf\xE4higen Player verf\xFCgbar.",master:"Master",joined:"Verbunden",available:"Verf\xFCgbar",current:"Aktuell",unjoin_from:"Von {master} trennen",join_with:"Mit {master} gruppieren"}},search:{favorites:"Favoriten",recently_played:"Zuletzt geh\xF6rt",next_up:"Als N\xE4chstes",recommendations:"Empfehlungen",radio_mode:"Radiomodus",play_similar:"\xC4hnliche Lieder abspielen",close:"Suche schlie\xDFen",no_results:"Keine Ergebnisse.",play_next:"Als N\xE4chstes spielen",replace_play:"Warteschlange ersetzen und jetzt spielen",replace:"Warteschlange ersetzen",add_queue:"Am Ende der Warteschlange hinzuf\xFCgen",move_up:"Nach oben",move_down:"Nach unten",move_next:"Als N\xE4chstes verschieben",remove:"Aus Warteschlange entfernen",added:"Zur Warteschlange hinzugef\xFCgt!",added_to_playlist:"Zur Playlist hinzugef\xFCgt!",select_playlist:"Playlist f\xFCr '{track}' ausw\xE4hlen",add_to_playlist:"Zur Playlist hinzuf\xFCgen",select_track_for_playlist:"Titel zum Hinzuf\xFCgen f\xFCr '{track}' von {artist} ausw\xE4hlen",labels:{replace:"Ersetzen",next:"Weiter",replace_next:"Weiter ersetzen",add:"Hinzuf\xFCgen",add_to_playlist:"Zur Playlist hinzuf\xFCgen"},results:"Ergebnisse",result:"Ergebnis",filters:{all:"Alle",artist:"K\xFCnstler",album:"Album",track:"Titel",playlist:"Playlist",radio:"Radio",music:"Musik",station:"Station",podcast:"Podcast",audiobook:"H\xF6rbuch"},search_artist:"Nach diesem K\xFCnstler suchen",play_collection:"Diese Sammlung abspielen",play_collection_error:"Diese Sammlung kann nicht direkt abgespielt werden",browse_album:"Albentitel von {album} durchsuchen",play_item:"{item} abspielen"}},_o={common:{not_found:"Entidad no encontrada.",search:"Buscar",power:"Encender/Apagar",favorite:"Favorito",loading:"Cargando...",no_results:"Sin resultados.",close:"Cerrar",vol_up:"Subir volumen",vol_down:"Bajar volumen",media_player:"Reproductor multimedia",edit_entity:"Editar ajustes de entidad",edit_action:"Editar ajustes de acci\xF3n",mute:"Silenciar",unmute:"Activar sonido",seek:"Buscar",volume:"Volumen",play_now:"Reproducir ahora",more_options:"M\xE1s opciones",unavailable:"No disponible",back:"Atr\xE1s",cancel:"Cancelar",reset_default:"Restablecer valores"},editor:{tabs:{entities:"Entidades",behavior:"Comportamiento",look_and_feel:"Apariencia",artwork:"Portada",actions:"Acciones"},placeholders:{search:"Buscar m\xFAsica..."},sections:{artwork:{general:{title:"Ajustes generales",description:"Controles globales para la portada."},idle:{title:"Portada en reposo",description:"Mostrar imagen est\xE1tica cuando nada se reproduce."},overrides:{title:"Reemplazos de portada",description:"Los reemplazos se eval\xFAan de arriba a abajo. Arrastre para reordenar."}},entities:{title:"Entidades*",description:"A\xF1ada los reproductores multimedia. Arrastre para reordenar."},behavior:{idle_chips:{title:"Reposo y chips",description:"Elija cu\xE1ndo pasa a reposo y el comportamiento de los chips."},interactions_search:{title:"Interacciones y b\xFAsqueda",description:"Ajuste el fijado de entidades y l\xEDmite de resultados."}},look_and_feel:{theme_layout:{title:"Tema y dise\xF1o",description:"Combine con el estilo de su dashboard."},controls_typography:{title:"Controles y tipograf\xEDa",description:"Ajuste tama\xF1o de botones y etiquetas."},collapsed_idle:{title:"Estados de reposo y contra\xEDdo",description:"Controle el contra\xEDdo de la tarjeta."}},actions:{title:"Acciones",description:"Cree chips de acci\xF3n. Arrastre para reordenar, pulse el l\xE1piz para configurar."}},subtitles:{idle_timeout:"Tiempo antes de reposo (ms). 0 para desactivar.",show_chip_row:'"Auto" oculta la fila si solo hay una entidad. "En men\xFA" mueve los chips. "En men\xFA en reposo" muestra los chips en l\xEDnea cuando est\xE1 activo pero los mueve al men\xFA cuando est\xE1 en reposo.',dim_chips:"Atenuar los chips en reposo para un aspecto m\xE1s limpio.",hold_to_pin:"Mantener pulsado para fijar en vez de pulsaci\xF3n corta.",always_show_group:"Los controles de agrupaci\xF3n r\xE1pida (+/-/estrella) estar\xE1n visibles por defecto al cargar la p\xE1gina. Todav\xEDa puedes cambiarlos manualmente mediante doble pulsaci\xF3n.",disable_autofocus:"Evitar que la b\xFAsqueda tome el foco autom\xE1ticamente.",search_within_filter:"Buscar dentro del filtro activo (Favoritos, etc.).",close_search_on_play:"Cerrar b\xFAsqueda al reproducir.",pin_search_headers:"Fijar encabezados de b\xFAsqueda al hacer scroll.",hide_search_headers_on_idle:"Ocultar encabezados de b\xFAsqueda en inactividad.",disable_mass:"Desactivar integraci\xF3n con Mass Queue.",swap_pause_stop:"Cambiar pausa por stop en dise\xF1o moderno.",adaptive_controls:"Permitir que los botones se adapten al espacio.",hide_menu_player:"Ocultar nombre de entidad cuando est\xE1 en el men\xFA.",adaptive_text:"Elegir qu\xE9 textos se adaptan al espacio.",collapse_expand:"Siempre contra\xEDdo activa el modo mini. Expandir al buscar expande temporalmente.",idle_screen:"Elegir pantalla a mostrar en reposo.",hide_controls:"Seleccionar controles a ocultar.",hide_search_chips:"Ocultar chips de filtro de b\xFAsqueda.",follow_active_entity:"La entidad de volumen seguir\xE1 a la activa.",search_limit_full:"M\xE1ximo de resultados (1-1000, defecto: 20).",default_search_filter_full:"Elige qu\xE9 filtro est\xE1 activo por defecto cuando se abre la pantalla de b\xFAsqueda.",default_search_favorites:"Iniciar b\xFAsqueda con favoritos activos",result_sorting_full:"Elegir orden de resultados.",card_height_full:"Dejar vac\xEDo para altura autom\xE1tica.",control_layout_full:"Elegir entre dise\xF1o antiguo o moderno.",artwork_extend:"Extender portada bajo los chips.",artwork_extend_label:"Extender portada",no_artwork_overrides:"Sin reemplazos de portada configurados.",entity_current_hint:"Use 'entity_id: current' para el reproductor actual.",service_data_note:"Los cambios se guardan al pulsar 'Guardar'.",jinja_template_hint:"Plantilla Jinja para entity_id.",jinja_template_vol_hint:"Plantilla para entidad de volumen.",not_available_alt_collapsed:"No disponible en modo contra\xEDdo.",not_available_collapsed:"No disponible si est\xE1 contra\xEDdo.",only_available_collapsed:"Solo disponible si est\xE1 contra\xEDdo.",only_available_modern:"Solo disponible con dise\xF1o Moderno.",image_url_helper:"Ingrese una URL directa a una imagen o una ruta de archivo local",selected_entity_helper:"Helper de texto de entrada que se actualizar\xE1 con el ID de la entidad del reproductor de medios seleccionado actualmente.",select_entity_helper:"Helper de texto de entrada del que leer el ID de la entidad. La tarjeta seleccionar\xE1 autom\xE1ticamente el chip correspondiente.",sync_entity_type:"Elija qu\xE9 ID de entidad sincronizar con el helper (por defecto la entidad de Music Assistant si est\xE1 configurada).",disable_auto_select:"Evita que el chip de esta entidad se seleccione autom\xE1ticamente cuando comienza la reproducci\xF3n.",search_view:"Elegir entre una lista est\xE1ndar o una cuadr\xEDcula de tarjetas para los resultados de la b\xFAsqueda.",search_card_columns:"Especifica cu\xE1ntas columnas usar en la vista de tarjetas. El artwork se adaptar\xE1 autom\xE1ticamente.",card_type:"Elija el modo de tarjeta. 'Por defecto' es el reproductor de medios est\xE1ndar. 'B\xFAsqueda dedicada' convierte la tarjeta en una interfaz de b\xFAsqueda permanente."},titles:{edit_entity:"Editar entidad",edit_action:"Editar acci\xF3n",service_data:"Datos del servicio",add_artwork_override:"A\xF1adir reemplazo"},labels:{dim_chips:"Atenuar chips en reposo",hold_to_pin:"Mantener para fijar",always_show_group:"Grupo r\xE1pido por defecto",disable_autofocus:"Desactivar autofoco",keep_filters:"Mantener filtros",dismiss_on_play:"Cerrar al reproducir",default_search_filter:"Filtro de b\xFAsqueda predeterminado",default_search_favorites:"Filtro de favoritos por defecto",pin_headers:"Fijar encabezados",hide_search_headers_on_idle:"Ocultar encabezados en inactividad",disable_mass:"Desactivar Mass Queue",match_theme:"Seguir tema",alt_progress:"Barra de progreso alternativa",display_timestamps:"Mostrar sellos de tiempo",swap_pause_stop:"Cambiar Pausa por Stop",adaptive_controls:"Tama\xF1o adaptativo",hide_active_entity:"Ocultar nombre de entidad activa",collapse_on_idle:"Contraer en reposo",hide_menu_player_toggle:"Ocultar reproductor del men\xFA",always_collapsed:"Siempre contra\xEDdo",expand_on_search:"Expandir al buscar",script_var:"Variable script (yamp_entity)",use_ma_template:"Usar plantilla MA",use_vol_template:"Usar plantilla Volumen",follow_active_entity:"Volumen sigue a entidad activa",use_url_path:"Usar URL o ruta",adaptive_text_elements:"Elementos de texto adaptativo",disable_auto_select:"Desactivar selecci\xF3n autom\xE1tica",card_type:"Tipo de tarjeta",no_artwork_option:"Sin imagen de portada"},fields:{artwork_fit:"Ajuste",artwork_position:"Posici\xF3n",artwork_hostname:"Host",match_field:"Campo",match_value:"Valor",size_percent:"Tama\xF1o (%)",object_fit:"Object Fit",idle_timeout:"Reposo (ms)",show_chip_row:"Mostrar chips",search_limit:"L\xEDmite de b\xFAsqueda",result_sorting:"Orden",vol_step:"Paso de volumen",card_height:"Altura (px)",control_layout:"Dise\xF1o",save_service_data:"Guardar",image_url:"URL imagen",fallback_image_url:"URL de respaldo",move_to_main:"Mover a chips principales",move_to_menu:"Mover al men\xFA",delete_action:"Borrar acci\xF3n",revert_service_data:"Deshacer cambios",test_action:"Probar acci\xF3n",volume_mode:"Modo volumen",idle_screen:"Pantalla reposo",name:"Nombre",hidden_controls:"Controles ocultos",ma_template:"Plantilla MA (Jinja)",hidden_chips:"Chips ocultos",vol_template:"Plantilla Volumen (Jinja)",icon:"Icono",action_type:"Tipo de acci\xF3n",menu_item:"Elemento de men\xFA",nav_path:"Ruta",service:"Servicio",service_data:"Datos",idle_image_entity:"Entidad imagen reposo",match_entity:"Entidad",ma_entity:"Entidad de Music Assistant",vol_entity:"Entidad de volumen",selected_entity_helper:"Helper de entidad seleccionada",sync_entity_type:"Tipo de entidad a sincronizar",placement:"Colocaci\xF3n",card_trigger:"Activador de la tarjeta",search_view:"Vista de resultados de b\xFAsqueda",search_card_columns:"Columnas de tarjetas"},action_types:{menu:"Abrir un elemento del men\xFA",service:"Llamar a un servicio",navigate:"Navegar",prev_entity:"Chip de entidad anterior",next_entity:"Chip de entidad siguiente",sync_selected_entity:"Sincronizar entidad seleccionada",select_entity:"Seleccionar entidad desde helper"},action_helpers:{sync_selected_entity:"Sincronizar entidad seleccionada \u2192",select_entity:"Seleccionar entidad \u2190",select_helper:"(seleccionar helper)"},sync_entity_options:{yamp_entity:"yamp_entity (Entidad de Music Assistant si est\xE1 configurada)",yamp_main_entity:"yamp_main_entity (Entidad principal del reproductor)",yamp_playback_entity:"yamp_playback_entity (Entidad de reproducci\xF3n activa actual)"},placements:{chip:"Chip de acci\xF3n",menu:"En el men\xFA",hidden:"Oculto (Toque en el arte)",not_triggerable:"No activable"},triggers:{none:"Ninguno",tap:"Toque",hold:"Mantener",double_tap:"Doble toque",swipe_left:"Deslizar a la izquierda",swipe_right:"Deslizar a la derecha"},search_view_options:{list:"Lista",card:"Tarjeta",card_minimal:"Tarjeta reducida"},card_type_options:{default:"Por defecto",search:"Buscar",group_players:"Agrupar"}},card:{sections:{details:"Detalles de reproducci\xF3n",menu:"Men\xFA y B\xFAsqueda",action_chips:"Chips de acci\xF3n"},media_controls:{shuffle:"Aleatorio",previous:"Anterior",play_pause:"Reproducir/Pausa",stop:"Detener",next:"Siguiente",repeat:"Repetir"},menu:{more_info:"M\xE1s info",search:"Buscar",source:"Fuente",transfer_queue:"Transferir cola",group_players:"Agrupar",select_entity:"Seleccionar",transfer_to:"Transferir a",no_players:"Sin reproductores MA."},grouping:{title:"Agrupar",sync_volume:"Sincronizar volumen",group_all:"Agrupar todos",ungroup_all:"Desagrupar todos",unavailable:"No disponible",no_players:"No agrupable.",master:"Maestro",joined:"Unido",available:"Disponible",current:"Actual",unjoin_from:"Desvincular de {master}",join_with:"Unirse a {master}"}},search:{favorites:"Favoritos",recently_played:"Reciente",next_up:"A continuaci\xF3n",recommendations:"Recomendaciones",radio_mode:"Modo Radio",play_similar:"Reproducir canciones similares",close:"Cerrar",no_results:"Sin resultados.",play_next:"Reprod. siguiente",replace_play:"Reemplazar y reproducir",replace:"Reemplazar cola",add_queue:"A\xF1adir al final",move_up:"Subir",move_down:"Bajar",move_next:"Pasar a siguiente",remove:"Quitar de cola",added:"\xA1A\xF1adido!",added_to_playlist:"\xA1A\xF1adido a la lista de reproducci\xF3n!",select_playlist:"Seleccionar lista de reproducci\xF3n para '{track}'",add_to_playlist:"A\xF1adir a la lista de reproducci\xF3n",select_track_for_playlist:"Seleccionar la canci\xF3n a a\xF1adir para '{track}' de {artist}",labels:{replace:"Remplazar",next:"Siguiente",replace_next:"Rempl. Sig.",add:"A\xF1adir",add_to_playlist:"A\xF1adir a la lista de reproducci\xF3n"},results:"resultados",result:"resultado",filters:{all:"Todo",artist:"Artista",album:"\xC1lbum",track:"Canci\xF3n",playlist:"Lista",radio:"Radio",music:"M\xFAsica",station:"Emisora",podcast:"P\xF3dcast",audiobook:"Audiolibro"},search_artist:"Buscar este artista",play_collection:"Reproducir esta colecci\xF3n",play_collection_error:"No se puede reproducir esta colecci\xF3n directamente",browse_album:"Explorar pistas de {album}",play_item:"Reproducir {item}"}},mo={common:{not_found:"Entit\xE9 non trouv\xE9e.",search:"Rechercher",power:"Alimentation",favorite:"Favori",loading:"Chargement...",no_results:"Aucun r\xE9sultat.",close:"Fermer",vol_up:"Monter le volume",vol_down:"Baisser le volume",media_player:"Lecteur Multim\xE9dia",edit_entity:"Modifier les param\xE8tres de l'entit\xE9",edit_action:"Modifier les param\xE8tres de l'action",mute:"Muet",unmute:"R\xE9tablir le son",seek:"Rechercher",volume:"Volume",play_now:"Lire maintenant",more_options:"Plus d'options",unavailable:"Indisponible",back:"Retour",cancel:"Annuler",reset_default:"R\xE9initialiser"},editor:{tabs:{entities:"Entit\xE9s",behavior:"Comportement",look_and_feel:"Apparence",artwork:"Illustrations",actions:"Actions"},placeholders:{search:"Rechercher de la musique..."},sections:{artwork:{general:{title:"Param\xE8tres G\xE9n\xE9raux",description:"Contr\xF4les globaux pour l'affichage des illustrations."},idle:{title:"Illustration au Repos",description:"Afficher une image statique lorsque rien n'est en lecture."},overrides:{title:"Remplacements d'Illustrations",description:"Les remplacements sont \xE9valu\xE9s de haut en bas. Glissez pour r\xE9ordonner."}},entities:{title:"Entit\xE9s*",description:"Ajoutez les lecteurs multim\xE9dias que vous souhaitez contr\xF4ler. Glissez pour r\xE9ordonner."},behavior:{idle_chips:{title:"Veille & Jetons",description:"Choisissez quand la carte passe en mode veille et comment les jetons se comportent."},interactions_search:{title:"Interactions & Recherche",description:"Affinez la fa\xE7on dont les entit\xE9s sont \xE9pingl\xE9es et le nombre de r\xE9sultats."}},look_and_feel:{theme_layout:{title:"Th\xE8me & Mise en page",description:"Adaptez au style de votre tableau de bord et contr\xF4lez l'empreinte globale."},controls_typography:{title:"Commandes & Typographie",description:"Ajustez la taille des boutons, les \xE9tiquettes et le texte adaptatif."},collapsed_idle:{title:"\xC9tats R\xE9duits & Veille",description:"Contr\xF4lez quand la carte se r\xE9duit et quelles vues s'affichent en veille."}},actions:{title:"Actions",description:"Cr\xE9ez les jetons d'action. Glissez pour r\xE9ordonner, cliquez sur le crayon pour configurer."}},subtitles:{idle_timeout:"Temps en millisecondes avant la mise en veille. 0 pour d\xE9sactiver.",show_chip_row:'"Auto" masque la barre de jetons si une seule entit\xE9 est configur\xE9e. "Dans le Menu" d\xE9place les jetons. "Dans le menu au repos" affiche les jetons en ligne lorsque actif mais les d\xE9place dans le menu au repos.',dim_chips:"Assombrir les jetons en mode veille pour un look plus \xE9pur\xE9.",hold_to_pin:"Appui long pour \xE9pingler au lieu d'un appui court.",always_show_group:"Les contr\xF4les de groupement rapide (+/-/\xE9toile) seront visibles par d\xE9faut au chargement de la page. Vous pouvez toujours les basculer manuellement via un double appui.",disable_autofocus:"Emp\xEAcher la recherche de prendre le focus automatiquement.",search_within_filter:"Rechercher dans le filtre actif actuel (Favoris, etc.).",close_search_on_play:"Fermer automatiquement la recherche \xE0 la lecture.",pin_search_headers:"Garder la recherche et les filtres fixes en haut.",hide_search_headers_on_idle:"Masquer la recherche et les filtres en mode veille.",disable_mass:"D\xE9sactiver l'int\xE9gration Mass Queue.",swap_pause_stop:"Remplacer le bouton pause par stop en mode moderne.",adaptive_controls:"Laisser les boutons s'adapter \xE0 l'espace disponible.",hide_menu_player:"Masquer l'\xE9tiquette de l'entit\xE9 en bas quand les jetons sont dans le menu.",adaptive_text:"Choisir quels textes doivent s'adapter \xE0 l'espace.",collapse_expand:"Toujours r\xE9duit cr\xE9e un mini lecteur. Agrandir \xE0 la Recherche agrandit temporairement.",idle_screen:"Choisir l'\xE9cran \xE0 afficher automatiquement en veille.",hide_controls:"S\xE9lectionner les commandes \xE0 masquer pour cette entit\xE9.",hide_search_chips:"Masquer des jetons de filtrage sp\xE9cifiques.",follow_active_entity:"L'entit\xE9 de volume suivra automatiquement l'entit\xE9 active.",search_limit_full:"Nombre maximum de r\xE9sultats (1-1000, d\xE9faut: 20).",default_search_filter_full:"Choisissez quel filtre est actif par d\xE9faut \xE0 l'ouverture de la recherche.",default_search_favorites:"D\xE9marrer la recherche avec les favoris actifs",result_sorting_full:"Choisir l'ordre des r\xE9sultats. Par d\xE9faut conserve l'ordre source.",card_height_full:"Laisser vide pour une hauteur automatique.",control_layout_full:"Choisir entre l'ancienne mise en page ou la moderne.",artwork_extend:"\xC9tendre l'illustration sous les lignes de jetons.",artwork_extend_label:"\xC9tendre l'illustration",no_artwork_overrides:"Aucun remplacement d'illustration configur\xE9.",entity_current_hint:"Utilisez 'entity_id: current' pour cibler le lecteur actuel.",service_data_note:"Les changements ne sont enregistr\xE9s qu'en cliquant sur 'Enregistrer'.",jinja_template_hint:"Entrez un mod\xE8le Jinja qui renvoie un entity_id.",jinja_template_vol_hint:"Mod\xE8le pour l'entit\xE9 de volume.",not_available_alt_collapsed:"Non disponible en mode 'Toujours r\xE9duit'.",not_available_collapsed:"Non disponible si 'Toujours r\xE9duit' est activ\xE9.",only_available_collapsed:"Uniquement disponible si 'Toujours r\xE9duit' est activ\xE9.",only_available_modern:"Uniquement disponible avec la mise en page Moderne.",image_url_helper:"Entrez une URL directe vers une image ou un chemin de fichier local",selected_entity_helper:"Helper de texte d'entr\xE9e qui sera mis \xE0 jour avec l'ID de l'entit\xE9 du lecteur multim\xE9dia actuellement s\xE9lectionn\xE9.",select_entity_helper:"Helper de texte d'entr\xE9e \xE0 partir duquel lire l'ID de l'entit\xE9. La carte s\xE9lectionnera automatiquement le jeton correspondant.",sync_entity_type:"Choisissez quel ID d'entit\xE9 synchroniser avec le helper (par d\xE9faut l'entit\xE9 Music Assistant si configur\xE9e).",disable_auto_select:"Emp\xEAche le jeton de cette entit\xE9 d'\xEAtre automatiquement s\xE9lectionn\xE9 au d\xE9but de la lecture.",search_view:"Choisissez entre une liste standard ou une grille de cartes pour les r\xE9sultats de recherche.",search_card_columns:"Sp\xE9cifiez le nombre de colonnes \xE0 utiliser dans la vue carte. L'illustration s'adaptera automatiquement.",card_type:"Choisissez le mode de carte. 'Par d\xE9faut' est le lecteur multim\xE9dia standard. 'Recherche d\xE9di\xE9e' fait de la carte une interface de recherche permanente."},titles:{edit_entity:"Modifier l'entit\xE9",edit_action:"Modifier l'action",service_data:"Donn\xE9es du service",add_artwork_override:"Ajouter un remplacement"},labels:{dim_chips:"Assombrir les jetons en veille",hold_to_pin:"Maintenir pour \xE9pingler",always_show_group:"Groupe rapide par d\xE9faut",disable_autofocus:"D\xE9sactiver l'autofocus",keep_filters:"Garder les filtres",dismiss_on_play:"Fermer en lecture",default_search_filter:"Filtre de recherche par d\xE9faut",default_search_favorites:"Filtre des favoris par d\xE9faut",pin_headers:"\xC9pingler les en-t\xEAtes",hide_search_headers_on_idle:"Masquer les en-t\xEAtes en veille",disable_mass:"D\xE9sactiver Mass Queue",match_theme:"Suivre le th\xE8me",alt_progress:"Barre de progression alternative",display_timestamps:"Afficher les horodatages",swap_pause_stop:"Remplacer Pause par Stop",adaptive_controls:"Taille adaptative",hide_active_entity:"Masquer l'\xE9tiquette active",collapse_on_idle:"R\xE9duire en veille",hide_menu_player_toggle:"Masquer le lecteur menu",always_collapsed:"Toujours r\xE9duit",expand_on_search:"Agrandir en recherche",script_var:"Variable script (yamp_entity)",use_ma_template:"Utiliser mod\xE8le MA",use_vol_template:"Utiliser mod\xE8le Volume",follow_active_entity:"Le volume suit l'entit\xE9 active",use_url_path:"Utiliser URL ou chemin",adaptive_text_elements:"\xC9l\xE9ments de texte adaptatif",disable_auto_select:"D\xE9sactiver la s\xE9lection automatique"},fields:{artwork_fit:"Ajustement",artwork_position:"Position",artwork_hostname:"H\xF4te",match_field:"Champ de correspondance",match_value:"Valeur de correspondance",size_percent:"Taille (%)",object_fit:"Object Fit",idle_timeout:"Veille (ms)",show_chip_row:"Afficher les jetons",search_limit:"Limite de r\xE9sultats",result_sorting:"Tri des r\xE9sultats",vol_step:"Pas du volume",card_height:"Hauteur (px)",control_layout:"Mise en page",save_service_data:"Enregistrer",image_url:"URL image",fallback_image_url:"URL de secours",move_to_main:"Mettre dans les jetons principaux",move_to_menu:"Mettre dans le menu",delete_action:"Supprimer l'action",revert_service_data:"Annuler les changements",test_action:"Tester l'action",volume_mode:"Mode volume",idle_screen:"\xC9cran de veille",name:"Nom",hidden_controls:"Commandes masqu\xE9es",ma_template:"Mod\xE8le MA (Jinja)",hidden_chips:"Jetons masqu\xE9s",vol_template:"Mod\xE8le Volume (Jinja)",icon:"Ic\xF4ne",action_type:"Type d'action",menu_item:"\xC9l\xE9ment du menu",nav_path:"Chemin navigation",service:"Service",service_data:"Donn\xE9es",idle_image_entity:"Entit\xE9 image veille",match_entity:"Entit\xE9 de correspondance",ma_entity:"Entit\xE9 Music Assistant",vol_entity:"Entit\xE9 de volume",selected_entity_helper:"Helper d'entit\xE9 s\xE9lectionn\xE9e",sync_entity_type:"Type d'entit\xE9 \xE0 synchroniser",placement:"Placement",card_trigger:"D\xE9clencheur de carte",search_view:"Vue des r\xE9sultats de recherche",search_card_columns:"Nombre de colonnes",card_type:"Type de carte",no_artwork_option:"Pas d'image de couverture"},action_types:{menu:"Ouvrir un \xE9l\xE9ment de menu",service:"Appeler un service",navigate:"Naviguer",prev_entity:"Puce de l'entit\xE9 pr\xE9c\xE9dente",next_entity:"Puce de l'entit\xE9 suivante",sync_selected_entity:"Synchroniser l'entit\xE9 s\xE9lectionn\xE9e",select_entity:"S\xE9lectionner l'entit\xE9 depuis le helper"},action_helpers:{sync_selected_entity:"Synchroniser l'entit\xE9 s\xE9lectionn\xE9e \u2192",select_entity:"S\xE9lectionner l'entit\xE9 \u2190",select_helper:"(s\xE9lectionner helper)"},sync_entity_options:{yamp_entity:"yamp_entity (Entit\xE9 Music Assistant si configur\xE9e)",yamp_main_entity:"yamp_main_entity (Entit\xE9 principale du lecteur)",yamp_playback_entity:"yamp_playback_entity (Entit\xE9 de lecture active actuelle)"},placements:{chip:"Puce d'action",menu:"Dans le menu",hidden:"Masqu\xE9 (Appui sur l'image)",not_triggerable:"Non d\xE9clenchable"},triggers:{none:"Aucun",tap:"Appui",hold:"Maintenir",double_tap:"Double appui",swipe_left:"Glisser vers la gauche",swipe_right:"Glisser vers la droite"},search_view_options:{list:"Liste",card:"Carte",card_minimal:"Carte minimale"},card_type_options:{default:"Par d\xE9faut",search:"Rechercher",group_players:"Grouper les lecteurs"}},card:{sections:{details:"D\xE9tails lecture",menu:"Menu & Recherche",action_chips:"Jetons d'action"},media_controls:{shuffle:"Al\xE9atoire",previous:"Pr\xE9c\xE9dent",play_pause:"Lecture/Pause",stop:"Arr\xEAt",next:"Suivant",repeat:"R\xE9p\xE9ter"},menu:{more_info:"Plus d'infos",search:"Rechercher",source:"Source",transfer_queue:"Transf\xE9rer la file",group_players:"Grouper les lecteurs",select_entity:"Choisir pour plus d'infos",transfer_to:"Transf\xE9rer vers",no_players:"Aucun lecteur MA disponible."},grouping:{title:"Grouper les lecteurs",sync_volume:"Synchroniser volume",group_all:"Grouper tout",ungroup_all:"D\xE9grouper tout",unavailable:"Lecteur indisponible",no_players:"Aucun lecteur groupable.",master:"Ma\xEEtre",joined:"Li\xE9",available:"Disponible",current:"Actuel",unjoin_from:"Se d\xE9solidariser de {master}",join_with:"Se joindre \xE0 {master}"}},search:{favorites:"Favoris",recently_played:"R\xE9cemment lus",next_up:"\xC0 suivre",recommendations:"Recommandations",radio_mode:"Mode Radio",play_similar:"Lire des chansons similaires",close:"Fermer la recherche",no_results:"Aucun r\xE9sultat.",play_next:"Lire apr\xE8s",replace_play:"Remplacer et lire",replace:"Remplacer file",add_queue:"Ajouter \xE0 la fin",move_up:"Monter",move_down:"Descendre",move_next:"Passer au suivant",remove:"Retirer de la file",added:"Ajout\xE9 \xE0 la file !",added_to_playlist:"Ajout\xE9 \xE0 la playlist !",select_playlist:"S\xE9lectionner une playlist pour '{track}'",add_to_playlist:"Ajouter \xE0 la playlist",select_track_for_playlist:"S\xE9lectionner le titre \xE0 ajouter pour '{track}' par {artist}",labels:{replace:"Remplacer",next:"Suivant",replace_next:"Rempl. Suivant",add:"Ajouter",add_to_playlist:"Ajouter \xE0 la playlist"},results:"r\xE9sultats",result:"r\xE9sultat",filters:{all:"Tout",artist:"Artiste",album:"Album",track:"Titre",playlist:"Playlist",radio:"Radio",music:"Musique",station:"Station",podcast:"Podcast",audiobook:"Livre audio"},search_artist:"Chercher cet artiste",play_collection:"Lire cette collection",play_collection_error:"Impossible de lire cette collection directement",browse_album:"Parcourir les titres de {album}",play_item:"Lire {item}"}},fo={common:{not_found:"Entit\xE0 non trovata.",search:"Cerca",power:"Accensione",favorite:"Preferito",loading:"Caricamento...",no_results:"Nessun risultato.",close:"Chiudi",vol_up:"Volume su",vol_down:"Volume gi\xF9",media_player:"Lettore multimediale",edit_entity:"Modifica impostazioni entit\xE0",edit_action:"Modifica impostazioni azione",mute:"Muto",unmute:"Riattiva audio",seek:"Cerca",volume:"Volume",play_now:"Riproduci ora",more_options:"Altre opzioni",unavailable:"Non disponibile",back:"Indietro",cancel:"Annulla",reset_default:"Ripristina predefiniti"},editor:{tabs:{entities:"Entit\xE0",behavior:"Comportamento",look_and_feel:"Aspetto",artwork:"Copertina",actions:"Azioni"},placeholders:{search:"Cerca musica..."},sections:{artwork:{general:{title:"Impostazioni generali",description:"Controlli globali per la copertina."},idle:{title:"Copertina in riposo",description:"Mostra un'immagine statica quando non c'\xE8 riproduzione."},overrides:{title:"Override copertina",description:"Gli override sono valutati dall'alto in basso."}},entities:{title:"Entit\xE0*",description:"Aggiungi i lettori da controllare."},behavior:{idle_chips:{title:"Riposo e chip",description:"Scegli quando andare in riposo."},interactions_search:{title:"Interazioni e ricerca",description:"Ajusta il fissaggio delle entit\xE0."}},look_and_feel:{theme_layout:{title:"Tema e layout",description:"Adatta allo stile del dashboard."},controls_typography:{title:"Controlli e tipografia",description:"Ajusta bottoni e etichette."},collapsed_idle:{title:"Stati contratto e riposo",description:"Controlla il contratto della scheda."}},actions:{title:"Azioni",description:"Crea chip azione."}},subtitles:{idle_timeout:"Tempo prima del riposo (ms). 0 per disabilitare.",show_chip_row:`"Auto" nasconde la riga se c'\xE8 una sola entit\xE0. "Nel menu" sposta i chip nel menu. "Nel menu in inattivit\xE0" mostra i chip in linea quando attivo ma li sposta nel menu quando inattivo.`,dim_chips:"Appanna i chip in riposo per un aspetto pi\xF9 pulito.",hold_to_pin:"Tieni premuto per fissare invece di un tocco breve.",always_show_group:"I controlli di raggruppamento rapido (+/-/stella) saranno visibili per impostazione predefinita al caricamento della pagina. Puoi comunque attivarli manualmente tramite doppio tocco.",disable_autofocus:"Evita che la ricerca prenda il focus automaticamente.",search_within_filter:"Cerca nel filtro attivo (Preferiti, ecc.).",close_search_on_play:"Chiudi ricerca alla riproduzione.",pin_search_headers:"Fissa le intestazioni di ricerca durante lo scorrimento.",hide_search_headers_on_idle:"Nascondi la ricerca e i filtri quando inattivo.",disable_mass:"Disabilita integrazione Mass Queue.",swap_pause_stop:"Sostituisci pausa con stop nel design moderno.",adaptive_controls:"Permetti ai pulsanti di adattarsi allo spazio.",hide_menu_player:"Nascondi nome entit\xE0 quando \xE8 nel menu.",adaptive_text:"Scegli quali testi si adattano allo spazio.",collapse_expand:"Sempre contratto attiva il modo mini. Espandi alla ricerca espande temporaneamente.",idle_screen:"Scegli schermata da mostrare in riposo.",hide_controls:"Seleziona controlli da nascondere.",hide_search_chips:"Nascondi chip di filtro ricerca.",follow_active_entity:"L'entit\xE0 volume seguir\xE0 quella attiva.",search_limit_full:"Massimo risultati (1-1000, default: 20).",default_search_filter_full:"Scegli quale filtro \xE8 attivo per impostazione predefinita all'apertura della ricerca.",default_search_favorites:"Inizia ricerca con preferiti attivi",result_sorting_full:"Scegli ordine risultati.",card_height_full:"Lascia vuoto per altezza automatica.",control_layout_full:"Scegli tra design vecchio o moderno.",artwork_extend:"Estendi copertina sotto i chip.",artwork_extend_label:"Estendi copertina",no_artwork_overrides:"Nessun override copertina configurato.",entity_current_hint:"Usa 'entity_id: current' per il lettore attuale.",service_data_note:"Le modifiche si salvano premendo 'Salva'.",jinja_template_hint:"Modello Jinja per entity_id.",jinja_template_vol_hint:"Modello per entit\xE0 volume.",not_available_alt_collapsed:"Non disponibile in modo contratto.",not_available_collapsed:"Non disponibile se contratto.",only_available_collapsed:"Solo disponibile se contratto.",only_available_modern:"Solo disponibile con layout Moderno.",image_url_helper:"Inserisci un URL diretto a un'immagine o un percorso file locale",selected_entity_helper:"Helper di testo di input che verr\xE0 aggiornato con l'ID dell'entit\xE0 del lettore multimediale attualmente selezionato.",select_entity_helper:"Helper di testo di input da cui leggere l'ID dell'entit\xE0. La scheda selezioner\xE0 automaticamente il chip corrispondente.",sync_entity_type:"Scegli quale ID entit\xE0 sincronizzare con l'helper (predefinito l'entit\xE0 Music Assistant se configurata).",disable_auto_select:"Evita che il chip di questa entit\xE0 venga selezionato automaticamente all'inizio della riproduzione.",search_view:"Scegli tra una lista standard o una griglia di schede per i risultati della ricerca.",search_card_columns:"Specifica quante colonne utilizzare nella vista a schede. La copertina si adatter\xE0 automaticamente.",card_type:"Scegli la modalit\xE0 della scheda. 'Predefinito' \xE8 il lettore multimediale standard. 'Ricerca dedicata' rende la scheda un'interfaccia di ricerca permanente."},titles:{edit_entity:"Modifica entit\xE0",edit_action:"Modifica azione",service_data:"Dati servizio",add_artwork_override:"Aggiungi override"},labels:{dim_chips:"Appanna chip in riposo",hold_to_pin:"Tieni premuto per fissare",always_show_group:"Gruppo rapido predefinito",disable_autofocus:"Disabilita autofocus",keep_filters:"Mantieni filtri",dismiss_on_play:"Chiudi alla riproduzione",default_search_filter:"Filtro di ricerca predefinito",default_search_favorites:"Filtro preferiti predefinito",pin_headers:"Fissa intestazioni",hide_search_headers_on_idle:"Nascondi intestazioni in inattivit\xE0",disable_mass:"Disabilita Mass Queue",match_theme:"Segui tema",alt_progress:"Barra progresso alternativa",display_timestamps:"Mostra timestamp",swap_pause_stop:"Sostituisci Pausa con Stop",adaptive_controls:"Dimensione adattativa",hide_active_entity:"Nascondi nome entit\xE0 attiva",collapse_on_idle:"Contrai in riposo",hide_menu_player_toggle:"Nascondi lettore menu",always_collapsed:"Sempre contratto",expand_on_search:"Espandi alla ricerca",script_var:"Variabile script (yamp_entity)",use_ma_template:"Usa modello MA",use_vol_template:"Usa modello Volume",follow_active_entity:"Volume segue entit\xE0 attiva",use_url_path:"Usa URL o percorso",adaptive_text_elements:"Elementi testo adattativo",disable_auto_select:"Disattiva selezione automatica",card_type:"Tipo di scheda"},fields:{artwork_fit:"Adattamento",artwork_position:"Posizione",artwork_hostname:"Host",match_field:"Campo",match_value:"Valore",size_percent:"Dimensione (%)",object_fit:"Object Fit",idle_timeout:"Riposo (ms)",show_chip_row:"Mostra chip",search_limit:"Limite ricerca",result_sorting:"Ordine",vol_step:"Passo volume",card_height:"Altezza (px)",control_layout:"Design",save_service_data:"Salva",image_url:"URL immagine",fallback_image_url:"URL fallback",move_to_main:"Sposta in chip principali",move_to_menu:"Sposta nel menu",delete_action:"Elimina azione",revert_service_data:"Annulla modifiche",test_action:"Prova azione",volume_mode:"Modo volume",idle_screen:"Schermo riposo",name:"Nome",hidden_controls:"Controlli nascosti",ma_template:"Modello MA (Jinja)",hidden_chips:"Chip nascosti",vol_template:"Modello Volume (Jinja)",icon:"Icona",action_type:"Tipo azione",menu_item:"Elemento menu",nav_path:"Percorso",service:"Servizio",service_data:"Dati",idle_image_entity:"Entit\xE0 immagine riposo",match_entity:"Entit\xE0",ma_entity:"Entit\xE0 Music Assistant",vol_entity:"Entit\xE0 di volume",selected_entity_helper:"Helper entit\xE0 selezionata",sync_entity_type:"Tipo di entit\xE0 da sincronizzare",placement:"Posizionamento",card_trigger:"Trigger della scheda",search_view:"Vista risultati ricerca",search_card_columns:"Colonne schede"},action_types:{menu:"Apri un elemento del menu",service:"Chiama un servizio",navigate:"Naviga",prev_entity:"Chip entit\xE0 precedente",next_entity:"Chip entit\xE0 successiva",sync_selected_entity:"Sincronizza entit\xE0 selezionata",select_entity:"Seleziona entit\xE0 dall'helper"},action_helpers:{sync_selected_entity:"Sincronizza entit\xE0 selezionata \u2192",select_entity:"Seleziona entit\xE0 \u2190",select_helper:"(seleziona helper)"},sync_entity_options:{yamp_entity:"yamp_entity (Entit\xE0 Music Assistant se configurata)",yamp_main_entity:"yamp_main_entity (Entit\xE0 principale del lettore)",yamp_playback_entity:"yamp_playback_entity (Entit\xE0 di riproduzione attiva attuale)"},placements:{chip:"Chip d'azione",menu:"Nel menu",hidden:"Nascosto (Tocco sull'immagine)",not_triggerable:"Non attivabile"},triggers:{none:"Nessuno",tap:"Tocco",hold:"Mantieni",double_tap:"Doppio tocco",swipe_left:"Scorri a sinistra",swipe_right:"Scorri a destra"},search_view_options:{list:"Lista",card:"Scheda",card_minimal:"Scheda minima"},card_type_options:{default:"Predefinito",search:"Cerca",group_players:"Raggruppa"}},card:{sections:{details:"Dettagli riproduzione",menu:"Menu e Ricerca",action_chips:"Chip azione"},media_controls:{shuffle:"Casuale",previous:"Precedente",play_pause:"Riproduci/Pausa",stop:"Ferma",next:"Successivo",repeat:"Ripeti"},menu:{more_info:"Pi\xF9 info",search:"Cerca",source:"Sorgente",transfer_queue:"Trasferisci coda",group_players:"Raggruppa",select_entity:"Seleziona",transfer_to:"Trasferisci a",no_players:"Senza lettori MA."},grouping:{title:"Raggruppa",sync_volume:"Sincronizza volume",group_all:"Raggruppa tutti",ungroup_all:"Separa tutti",unavailable:"Non disponibile",no_players:"Non raggruppabile.",master:"Master",joined:"Unito",available:"Disponibile",current:"Attuale",unjoin_from:"Scollegati da {master}",join_with:"Unisciti a {master}"}},search:{favorites:"Preferiti",recently_played:"Recenti",next_up:"A seguire",recommendations:"Raccomandazioni",radio_mode:"Modo Radio",play_similar:"Riproduci brani simili",close:"Chiudi",no_results:"Nessun risultato.",play_next:"Riprod. successivo",replace_play:"Sostituisci e riproduci",replace:"Sostituisci coda",add_queue:"Aggiungi alla fine",move_up:"Sposta su",move_down:"Sposta gi\xF9",move_next:"Passa al successivo",remove:"Rimuovi da coda",added:"Aggiunto!",added_to_playlist:"Aggiunto alla playlist!",select_playlist:"Seleziona playlist per '{track}'",add_to_playlist:"Aggiungi alla playlist",select_track_for_playlist:"Seleziona il brano da aggiungere per '{track}' di {artist}",labels:{replace:"Sostituisci",next:"Successivo",replace_next:"Sost. succ.",add:"Aggiungi",add_to_playlist:"Aggiungi alla playlist"},results:"risultati",result:"risultato",filters:{all:"Tutto",artist:"Artista",album:"Album",track:"Brano",playlist:"Playlist",radio:"Radio",music:"Musica",station:"Stazione",podcast:"Podcast",audiobook:"Audiolibro"},search_artist:"Cerca questo artista",play_collection:"Riproduci questa collezione",play_collection_error:"Impossibile riprodurre direttamente questa collezione",browse_album:"Sfoglia i brani di {album}",play_item:"Riproduci {item}"}},vo={common:{not_found:"Entiteit niet gevonden.",search:"Zoeken",power:"Aan/Uit",favorite:"Favoriet",loading:"Laden...",no_results:"Geen resultaten.",close:"Sluiten",vol_up:"Volume Omhoog",vol_down:"Volume Omlaag",media_player:"Mediaspeler",edit_entity:"Entiteitsinstellingen Bewerken",edit_action:"Actie-instellingen Bewerken",mute:"Dempen",unmute:"Dempen opheffen",seek:"Zoeken",volume:"Volume",play_now:"Nu Spelen",more_options:"Meer Opties",unavailable:"Niet beschikbaar",back:"Terug",cancel:"Annuleren",reset_default:"Herstellen naar standaard"},editor:{tabs:{entities:"Entiteiten",behavior:"Gedrag",look_and_feel:"Uiterlijk",artwork:"Artwork",actions:"Acties"},placeholders:{search:"Zoek muziek..."},sections:{artwork:{general:{title:"Algemene Instellingen",description:"Globale instellingen voor hoe artwork wordt weergegeven en opgehaald."},idle:{title:"Artwork bij Inactiviteit",description:"Toon een statische afbeelding of entiteits-snapshot wanneer er niets wordt afgespeeld."},overrides:{title:"Artwork Overschrijvingen",description:"Overschrijvingen worden van boven naar beneden ge\xEBvalueerd. Sleep om te sorteren."}},entities:{title:"Entiteiten*",description:"Voeg de mediaspelers toe die je wilt bedienen. Sleep entiteiten om de volgorde te wijzigen."},behavior:{idle_chips:{title:"Inactiviteit & Chips",description:"Kies wanneer de kaart inactief wordt en hoe entiteitschips zich gedragen."},interactions_search:{title:"Interacties & Zoeken",description:"Verfijn hoe entiteiten worden vastgezet en hoeveel resultaten er tegelijk worden getoond."}},look_and_feel:{theme_layout:{title:"Thema & Layout",description:"Stem af op de styling van het dashboard en beheer de totale voetafdruk."},controls_typography:{title:"Bediening & Typografie",description:"Pas knopgrootte, entiteitslabels en adaptieve tekst aan."},collapsed_idle:{title:"Ingeklapte & Inactieve Staten",description:"Beheer wanneer de kaart inklapt en welke weergaven getoond worden bij inactiviteit."}},actions:{title:"Acties",description:"Bouw de actiechips die in de kaart of het menu verschijnen. Sleep om te sorteren, klik op het potlood om te configureren."}},subtitles:{idle_timeout:"Tijd in milliseconden voordat de kaart naar de inactieve modus gaat. Stel in op 0 om inactiviteitsgedrag uit te schakelen.",show_chip_row:'"Auto" verbergt de chiprij wanneer er slechts \xE9\xE9n entiteit is geconfigureerd. "In Menu" verplaatst de chips naar het menu-overlay. "In menu bij inactiviteit" toont chips inline wanneer actief maar verplaatst ze naar het menu wanneer inactief.',dim_chips:"Wanneer de kaart inactief wordt met een afbeelding, dim dan de entiteits- en actiechips voor een strakker uiterlijk.",hold_to_pin:"Houd entiteitschips lang ingedrukt in plaats van kort om ze vast te zetten, om automatisch schakelen tijdens afspelen te voorkomen.",always_show_group:"Snelgroeperingsknoppen (+/-/ster) zijn standaard zichtbaar bij het laden van de pagina. Je kunt ze nog steeds handmatig in- of uitschakelen via dubbeltikken.",disable_autofocus:"Voorkom dat het zoekveld de focus steelt, zodat onscreen toetsenborden verborgen blijven.",search_within_filter:"Schakel dit in om te zoeken binnen het huidige actieve filter (Favorieten, Recent Afgespeeld, etc) in plaats van dit te wissen.",close_search_on_play:"Sluit het zoekscherm automatisch wanneer een nummer wordt afgespeeld.",pin_search_headers:"Houd de zoekinvoer en filters bovenaan vast tijdens het scrollen door resultaten.",hide_search_headers_on_idle:"Verberg zoekinvoer en filters wanneer inactief.",disable_mass:"Schakel de optionele Mass Queue integratie uit, zelfs als deze is ge\xEFnstalleerd.",swap_pause_stop:"Vervang de pauzeknop door stop bij gebruik van de moderne lay-out.",adaptive_controls:"Laat de afspeelknoppen groeien of krimpen om in de beschikbare ruimte te passen.",hide_menu_player:"Wanneer chips in het menu staan, verberg dan het entiteitslabel onderaan de kaart.",adaptive_text:"Kies welke tekstgroepen moeten schalen met de beschikbare ruimte (laat leeg om adaptieve tekst uit te schakelen).",collapse_expand:"Altijd Ingeklapt cre\xEBert de mini-spelermodus. Uitklappen bij Zoeken klapt tijdelijk uit tijdens het zoeken.",idle_screen:"Kies welk scherm automatisch wordt weergegeven wanneer de kaart inactief wordt.",hide_controls:"Selecteer welke knoppen je wilt verbergen voor deze entiteit (standaard worden ze allemaal getoond)",hide_search_chips:"Verberg specifieke zoekfilterchips voor deze entiteit",follow_active_entity:"Indien ingeschakeld, zal de volume-entiteit automatisch de actieve afspeel-entiteit volgen. Let op: dit overschrijft de geselecteerde volume-entiteit.",search_limit_full:"Maximaal aantal zoekresultaten om weer te geven (1-1000, standaard: 20)",default_search_filter_full:"Kies welk filter standaard actief is wanneer het zoekscherm wordt geopend.",default_search_favorites:"Start zoekopdracht met favorieten actief",result_sorting_full:"Kies hoe zoekresultaten worden gesorteerd. Standaard behoudt de bronvolgorde.",card_height_full:"Laat leeg voor automatische hoogte",control_layout_full:"Kies tussen de oude gelijkmatig verdeelde knoppen of de moderne Home Assistant lay-out.",artwork_extend:"Laat de artwork-achtergrond doorlopen onder de chip- en actierijen.",artwork_extend_label:"Artwork uitbreiden",no_artwork_overrides:"Geen artwork overschrijvingen geconfigureerd. Gebruik de plusknop hieronder om er een toe te voegen.",entity_current_hint:"Gebruik 'entity_id: current' om de momenteel geselecteerde mediaspeler op de kaart te targeten. Let op: de 'Test Actie' knop wordt uitgeschakeld bij gebruik van deze functie.",service_data_note:"Wijzigingen in de servicegegevens hieronder worden pas in de configuratie opgeslagen nadat op de knop 'Servicegegevens Opslaan' is geklikt!",jinja_template_hint:"Voer een Jinja-sjabloon in dat resulteert in een enkele entity_id. Voorbeeld voor het wisselen van MA op basis van een bronselectie:",jinja_template_vol_hint:"Voer een Jinja-sjabloon in dat resulteert in een entity_id (bijv. media_player.kantoor). Voorbeeld voor het wisselen van volume-entiteit op basis van een boolean:",not_available_alt_collapsed:"Niet beschikbaar met Alternatieve Voortgangsbalk of Altijd Ingeklapte modus",not_available_collapsed:"Niet beschikbaar wanneer Altijd Ingeklapt is ingeschakeld",only_available_collapsed:"Alleen beschikbaar wanneer Altijd Ingeklapt is ingeschakeld",only_available_modern:"Alleen beschikbaar met de Moderne lay-out",image_url_helper:"Voer een directe URL naar een afbeelding of een lokaal bestandspad in",selected_entity_helper:"Invoerteksthelper die wordt bijgewerkt met de momenteel geselecteerde media player-entiteits-ID.",select_entity_helper:"Invoerteksthelper waaruit het entiteits-ID wordt gelezen. De kaart selecteert automatisch de bijbehorende chip.",sync_entity_type:"Kies welk entiteits-ID moet worden gesynchroniseerd met de helper (standaard Music Assistant-entiteit indien geconfigureerd).",disable_auto_select:"Voorkomt dat de chip van deze entiteit automatisch wordt geselecteerd wanneer deze begint af te spelen.",search_view:"Kies tussen een standaardlijst of een raster van kaarten voor zoekresultaten.",search_card_columns:"Geef aan hoeveel kolommen er gebruikt moeten worden in de kaartweergave. De afbeelding wordt automatisch aangepast.",card_type:"Kies de kaartmodus. 'Standaard' is de standaard mediaspeler. 'Speciale zoekopdracht' maakt van de kaart een permanente zoekinterface."},titles:{edit_entity:"Entiteit Bewerken",edit_action:"Actie Bewerken",service_data:"Servicegegevens",add_artwork_override:"Artwork Overschrijving Toevoegen"},labels:{dim_chips:"Chips dimmen bij inactiviteit",hold_to_pin:"Ingedrukt houden om vast te zetten",always_show_group:"Snelgroepering standaard aan",disable_autofocus:"Zoek-autofocus uitschakelen",keep_filters:"Filters behouden bij zoeken",dismiss_on_play:"Zoeken sluiten bij afspelen",default_search_filter:"Standaard zoekfilter",default_search_favorites:"Standaard naar favorietenfilter",pin_headers:"Zoekkoppen vastzetten",hide_search_headers_on_idle:"Zoekkoppen verbergen bij inactiviteit",disable_mass:"Mass Queue uitschakelen",match_theme:"Thema matchen",alt_progress:"Alternatieve Voortgangsbalk",display_timestamps:"Tijdstempels Weergeven",swap_pause_stop:"Pauze vervangen door Stop",adaptive_controls:"Adaptieve Knoppen Grootte",hide_active_entity:"Label van Actieve Entiteit verbergen",collapse_on_idle:"Inklappen bij inactiviteit",hide_menu_player_toggle:"Menu-speler Verbergen",always_collapsed:"Altijd Ingeklapt",expand_on_search:"Uitklappen bij Zoeken",script_var:"Script Variabele (yamp_entity)",use_ma_template:"Sjabloon gebruiken voor Music Assistant Entiteit",use_vol_template:"Sjabloon gebruiken voor Volume Entiteit",follow_active_entity:"Volume Entiteit volgt Actieve Entiteit",use_url_path:"URL of Pad gebruiken",adaptive_text_elements:"Elementen voor Adaptieve Tekstgrootte",disable_auto_select:"Auto-selectie uitschakelen"},fields:{artwork_fit:"Artwork Passend Maken",artwork_position:"Artwork Positie",artwork_hostname:"Artwork Hostnaam",match_field:"Match Veld",match_value:"Match Waarde",size_percent:"Grootte (%)",object_fit:"Object Fit",idle_timeout:"Time-out voor Inactiviteit (ms)",show_chip_row:"Chiprij Tonen",search_limit:"Limiet Zoekresultaten",result_sorting:"Sortering Resultaten",vol_step:"Volume Stap (0.05 = 5%)",card_height:"Kaarthoogte (px)",control_layout:"Knoppen Lay-out",save_service_data:"Servicegegevens Opslaan",image_url:"Afbeelding URL",fallback_image_url:"Fallback Afbeelding URL",move_to_main:"Verplaats actie naar hoofdchips",move_to_menu:"Verplaats actie naar menu",delete_action:"Actie Verwijderen",revert_service_data:"Terugzetten naar Opgeslagen Gegevens",test_action:"Actie Testen",volume_mode:"Volume Modus",idle_screen:"Inactief Scherm",name:"Naam",hidden_controls:"Verborgen Knoppen",ma_template:"Music Assistant Entiteit Sjabloon (Jinja)",hidden_chips:"Verborgen Zoekfilterchips",vol_template:"Volume Entiteit Sjabloon (Jinja)",icon:"Icoon",action_type:"Actietype",menu_item:"Menu-item",nav_path:"Navigatiepad",service:"Service",service_data:"Servicegegevens",idle_image_entity:"Entiteit voor inactieve afbeelding",match_entity:"Match Entiteit",ma_entity:"Music Assistant-entiteit",vol_entity:"Volume-entiteit",selected_entity_helper:"Geselecteerde entiteitshelper",sync_entity_type:"Synchronisatie entiteitstype",placement:"Plaatsing",card_trigger:"Kaart trigger",search_view:"Zoekresultaten weergave",search_card_columns:"Aantal kolommen",card_type:"Kaarttype",no_artwork_option:"Geen artwork"},action_types:{menu:"Open een kaartmenu-item",service:"Roep een service aan",navigate:"Navigeren",prev_entity:"Vorige entiteit chip",next_entity:"Volgende entiteit chip",sync_selected_entity:"Synchroniseer geselecteerde entiteit",select_entity:"Selecteer entiteit uit helper"},action_helpers:{sync_selected_entity:"Geselecteerde entiteit synchroniseren \u2192",select_entity:"Entiteit selecteren \u2190",select_helper:"(selecteer helper)"},sync_entity_options:{yamp_entity:"yamp_entity (Music Assistant-entiteit indien geconfigureerd)",yamp_main_entity:"yamp_main_entity (Hoofd media player-entiteit)",yamp_playback_entity:"yamp_playback_entity (Huidige actieve afspeelentiteit)"},placements:{chip:"Actiechip",menu:"In menu",hidden:"Verborgen (Artwork-tik)",not_triggerable:"Niet triggerbaar"},triggers:{none:"Geen",tap:"Tik",hold:"Vasthouden",double_tap:"Dubbeltik",swipe_left:"Veeg naar links",swipe_right:"Veeg naar rechts"},search_view_options:{list:"Lijst",card:"Kaart",card_minimal:"Minimale kaart"},card_type_options:{default:"Standaard",search:"Zoeken",group_players:"Spelers Groeperen"}},card:{sections:{details:"Details van 'Nu Spelen'",menu:"Menu & Zoekschermen",action_chips:"Actie Chips"},media_controls:{shuffle:"Shuffle",previous:"Vorige",play_pause:"Afspelen/Pauzeren",stop:"Stop",next:"Volgende",repeat:"Herhalen"},menu:{more_info:"Meer Info",search:"Zoeken",source:"Bron",transfer_queue:"Wachtrij Overdragen",group_players:"Spelers Groeperen",select_entity:"Selecteer Entiteit voor Meer Info",transfer_to:"Wachtrij Overdragen Naar",no_players:"Geen andere Music Assistant spelers beschikbaar."},grouping:{title:"Spelers Groeperen",sync_volume:"Volume Synchroniseren",group_all:"Alles Groeperen",ungroup_all:"Alles Loskoppelen",unavailable:"Speler is niet beschikbaar",no_players:"Geen andere spelers beschikbaar die kunnen groeperen.",master:"Master",joined:"Gekoppeld",available:"Beschikbaar",current:"Huidig",unjoin_from:"Loskoppelen van {master}",join_with:"Koppelen met {master}"}},search:{favorites:"Favorieten",recently_played:"Recent Afgespeeld",next_up:"Volgende",recommendations:"Aanbevelingen",radio_mode:"Radiomodus",play_similar:"Vergelijkbare nummers afspelen",close:"Zoeken Sluiten",no_results:"Geen resultaten.",play_next:"Volgende afspelen",replace_play:"Huidige wachtrij vervangen en nu afspelen",replace:"Wachtrij vervangen",add_queue:"Toevoegen aan einde van de wachtrij",move_up:"Omhoog verplaatsen",move_down:"Omlaag verplaatsen",move_next:"Als volgende afspelen",remove:"Verwijderen uit wachtrij",added:"Toegevoegd aan wachtrij!",added_to_playlist:"Toegevoegd aan afspeellijst!",select_playlist:"Selecteer afspeellijst voor '{track}'",add_to_playlist:"Toevoegen aan afspeellijst",select_track_for_playlist:"Selecteer het nummer om toe te voegen voor '{track}' van {artist}",labels:{replace:"Vervangen",next:"Volgende",replace_next:"Vervang Volgende",add:"Toevoegen",add_to_playlist:"Toevoegen aan afspeellijst"},results:"resultaten",result:"resultaat",filters:{all:"Alles",artist:"Artiest",album:"Album",track:"Nummer",playlist:"Afspeellijst",radio:"Radio",music:"Muziek",station:"Zender",podcast:"Podcast",audiobook:"Luisterboek"},search_artist:"Zoek naar deze artiest",play_collection:"Speel deze collectie af",play_collection_error:"Kan deze collectie niet direct afspelen",browse_album:"Tracks van {album} doorzoeken",play_item:"{item} afspelen"}},yo={common:{not_found:"Entidade n\xE3o encontrada.",search:"Procurar",power:"Ligar/Desligar",favorite:"Favorito",loading:"A carregar...",no_results:"Sem resultados.",close:"Fechar",vol_up:"Aumentar volume",vol_down:"Diminuir volume",media_player:"Leitor multim\xE9dia",edit_entity:"Editar defini\xE7\xF5es da entidade",edit_action:"Editar defini\xE7\xF5es da a\xE7\xE3o",mute:"Silenciar",unmute:"Ativar som",seek:"Procurar",volume:"Volume",play_now:"Reproduzir agora",more_options:"Mais op\xE7\xF5es",unavailable:"Indispon\xEDvel",back:"Voltar",cancel:"Cancelar",reset_default:"Repor predefini\xE7\xF5es"},editor:{tabs:{entities:"Entidades",behavior:"Comportamento",look_and_feel:"Aspeto",artwork:"Capa",actions:"A\xE7\xF5es"},placeholders:{search:"Procurar m\xFAsica..."},sections:{artwork:{general:{title:"Defini\xE7\xF5es gerais",description:"Controlos globais para a capa."},idle:{title:"Capa em repouso",description:"Mostrar imagem est\xE1tica quando nada toca."},overrides:{title:"Substitui\xE7\xF5es de capa",description:"As substitui\xE7\xF5es s\xE3o avaliadas de cima para baixo."}},entities:{title:"Entidades*",description:"Adicione os leitores a controlar."},behavior:{idle_chips:{title:"Repouso e chips",description:"Escolha quando ir para repouso."},interactions_search:{title:"Intera\xE7\xF5es e procura",description:"Ajuste a fixa\xE7\xE3o de entidades."}},look_and_feel:{theme_layout:{title:"Tema e design",description:"Combine com o estilo do dashboard."},controls_typography:{title:"Controlos e tipografia",description:"Ajuste bot\xF5es e etiquetas."},collapsed_idle:{title:"Estados contra\xEDdo e repouso",description:"Controle o contra\xEDdo do cart\xE3o."}},actions:{title:"A\xE7\xF5es",description:"Crie chips de a\xE7\xE3o."}},subtitles:{idle_timeout:"Tempo antes de repouso (ms). 0 para desativar.",show_chip_row:'"Auto" oculta a linha se houver apenas uma entidade. "No menu" move os chips. "No menu em repouso" mostra os chips em linha quando ativo mas move-os para o menu quando em repouso.',dim_chips:"Escurecer chips em repouso para um aspeto mais limpo.",hold_to_pin:"Manter premido para fixar em vez de toque curto.",always_show_group:"Os controles de agrupamento r\xE1pido (+/-/estrela) estar\xE3o vis\xEDveis por padr\xE3o ao carregar a p\xE1gina. Voc\xEA ainda pode altern\xE1-los manualmente atrav\xE9s de um toque duplo.",disable_autofocus:"Evitar que a procura tome o foco automaticamente.",search_within_filter:"Procurar no filtro ativo (Favoritos, etc.).",close_search_on_play:"Fechar procura ao reproduzir.",pin_search_headers:"Fixar cabe\xE7alhos de procura ao fazer scroll.",hide_search_headers_on_idle:"Ocultar pesquisa e filtros quando inativo.",disable_mass:"Desativar integra\xE7\xE3o Mass Queue.",swap_pause_stop:"Substituir pausa por stop no design moderno.",adaptive_controls:"Permitir que os bot\xF5es se adaptem ao espa\xE7o.",hide_menu_player:"Ocultar nome da entidade quando no menu.",adaptive_text:"Escolher que textos se adaptam ao espa\xE7o.",collapse_expand:"Sempre contra\xEDdo ativa modo mini. Expandir ao procurar expande temporariamente.",idle_screen:"Escolher ecr\xE3 a mostrar em repouso.",hide_controls:"Selecionar controlos a ocultar.",hide_search_chips:"Ocultar chips de filtro de procura.",follow_active_entity:"A entidade de volume seguir\xE1 a ativa.",search_limit_full:"M\xE1ximo de resultados (1-1000, default: 20).",default_search_filter_full:"Escolha qual filtro est\xE1 ativo por padr\xE3o quando a tela de pesquisa \xE9 aberta.",default_search_favorites:"Iniciar pesquisa com favoritos ativos",result_sorting_full:"Escolher ordem dos resultados.",card_height_full:"Deixar vazio para altura autom\xE1tica.",control_layout_full:"Escolher entre design antigo ou moderno.",artwork_extend:"Estender capa sob os chips.",artwork_extend_label:"Estender capa",no_artwork_overrides:"Sem substitui\xE7\xF5es de capa configuradas.",entity_current_hint:"Use 'entity_id: current' para o leitor atual.",service_data_note:"As altera\xE7\xF5es s\xE3o guardadas ao premir 'Guardar'.",jinja_template_hint:"Modelo Jinja para entity_id.",jinja_template_vol_hint:"Modelo para entidade volume.",not_available_alt_collapsed:"N\xE3o dispon\xEDvel em modo contra\xEDdo.",not_available_collapsed:"N\xE3o dispon\xEDvel se contra\xEDdo.",only_available_collapsed:"Apenas dispon\xEDvel se contra\xEDdo.",only_available_modern:"Apenas dispon\xEDvel com layout Moderno.",image_url_helper:"Insira um URL direto para uma imagem ou um caminho de arquivo local",selected_entity_helper:"Helper de texto de entrada que ser\xE1 atualizado com o ID da entidade do reprodutor de m\xEDdia selecionado no momento.",select_entity_helper:"Helper de texto de entrada do qual ler o ID da entidade. O cart\xE3o selecionar\xE1 automaticamente o chip correspondente.",sync_entity_type:"Escolha qual ID de entidade sincronizar com o helper (padr\xE3o entidade Music Assistant se configurada).",disable_auto_select:"Impede que o chip desta entidade seja selecionado automaticamente quando a reprodu\xE7\xE3o \xE9 iniciada.",search_view:"Escolha entre uma lista padr\xE3o ou uma grade de cart\xF5es para os resultados da pesquisa.",search_card_columns:"Especifique quantas colunas usar na visualiza\xE7\xE3o de cart\xF5es. A capa ser\xE1 redimensionada automaticamente.",card_type:"Escolha o modo do cart\xE3o. 'Padr\xE3o' \xE9 o reprodutor de m\xEDdia padr\xE3o. 'Busca dedicada' torna o cart\xE3o uma interface de busca permanente."},titles:{edit_entity:"Editar entidade",edit_action:"Editar a\xE7\xE3o",service_data:"Dados do servi\xE7o",add_artwork_override:"Adicionar substitui\xE7\xE3o"},labels:{dim_chips:"Escurecer chips em repouso",hold_to_pin:"Manter para fixar",always_show_group:"Grupo r\xE1pido por padr\xE3o",disable_autofocus:"Desativar autofoco",keep_filters:"Manter filtros",dismiss_on_play:"Fechar ao reproduzir",default_search_filter:"Filtro de pesquisa padr\xE3o",default_search_favorites:"Filtro de favoritos padr\xE3o",pin_headers:"Fixar cabe\xE7alhos",hide_search_headers_on_idle:"Ocultar cabe\xE7alhos em inatividade",disable_mass:"Desativar Mass Queue",match_theme:"Seguir tema",alt_progress:"Barra de progresso alternativa",display_timestamps:"Mostrar carimbos de tempo",swap_pause_stop:"Substituir Pausa por Stop",adaptive_controls:"Tamanho adaptativo",hide_active_entity:"Ocultar nome da entidade ativa",collapse_on_idle:"Contrair em repouso",hide_menu_player_toggle:"Ocultar leitor do menu",always_collapsed:"Sempre contra\xEDdo",expand_on_search:"Expandir ao procurar",script_var:"Vari\xE1vel script (yamp_entity)",use_ma_template:"Usar modelo MA",use_vol_template:"Usar modelo Volume",follow_active_entity:"Volume segue a entidade ativa",use_url_path:"Usar URL ou caminho",adaptive_text_elements:"Elementos de texto adaptativo",disable_auto_select:"Desativar sele\xE7\xE3o autom\xE1tica",card_type:"Tipo de cart\xE3o"},fields:{artwork_fit:"Ajuste",artwork_position:"Posi\xE7\xE3o",artwork_hostname:"Host",match_field:"Campo",match_value:"Valor",size_percent:"Tamanho (%)",object_fit:"Object Fit",idle_timeout:"Repouso (ms)",show_chip_row:"Mostrar chips",search_limit:"Limite de procura",result_sorting:"Ordem",vol_step:"Passo de volume",card_height:"Altura (px)",control_layout:"Design",save_service_data:"Guardar",image_url:"URL imagem",fallback_image_url:"URL de reserva",move_to_main:"Mover para chips principais",move_to_menu:"Mover para o menu",delete_action:"Eliminar a\xE7\xE3o",revert_service_data:"Anular altera\xE7\xF5es",test_action:"Testar a\xE7\xE3o",volume_mode:"Modo volume",idle_screen:"Ecr\xE3 de repouso",name:"Nome",hidden_controls:"Controlos ocultos",ma_template:"Modelo MA (Jinja)",hidden_chips:"Chips ocultos",vol_template:"Modelo Volume (Jinja)",icon:"\xCDcone",action_type:"Tipo de a\xE7\xE3o",menu_item:"Item de menu",nav_path:"Caminho",service:"Servi\xE7o",service_data:"Dados",idle_image_entity:"Entidade imagem repouso",match_entity:"Entidade",ma_entity:"Entidade Music Assistant",vol_entity:"Entidade de volume",selected_entity_helper:"Helper de entidade selecionada",sync_entity_type:"Tipo de entidade a sincronizar",placement:"Posicionamento",card_trigger:"Gatilho do cart\xE3o",search_view:"Vista de resultados de pesquisa",search_card_columns:"Colunas de cart\xF5es"},action_types:{menu:"Abrir um item do menu",service:"Chamar um servi\xE7o",navigate:"Navegar",prev_entity:"Chip da entidade anterior",next_entity:"Chip da pr\xF3xima entidade",sync_selected_entity:"Sincronizar entidade selecionada",select_entity:"Selecionar entidade do helper"},action_helpers:{sync_selected_entity:"Sincronizar entidade selecionada \u2192",select_entity:"Selecionar entidade \u2190",select_helper:"(selecionar helper)"},sync_entity_options:{yamp_entity:"yamp_entity (Entidade Music Assistant se configurada)",yamp_main_entity:"yamp_main_entity (Entidade principal do reprodutor)",yamp_playback_entity:"yamp_playback_entity (Entidade de reprodu\xE7\xE3o ativa atual)"},placements:{chip:"Chip de a\xE7\xE3o",menu:"No menu",hidden:"Oculto (Toque no Artwork)",not_triggerable:"N\xE3o acion\xE1vel"},triggers:{none:"Nenhum",tap:"Toque",hold:"Manter premido",double_tap:"Toque duplo",swipe_left:"Deslizar para a esquerda",swipe_right:"Deslizar para a direita"},search_view_options:{list:"Lista",card:"Cart\xE3o",card_minimal:"Cart\xE3o minimalista"},card_type_options:{default:"Padr\xE3o",search:"Procurar",group_players:"Agrupar"}},card:{sections:{details:"Detalhes de reprodu\xE7\xE3o",menu:"Menu e Procura",action_chips:"Chips de a\xE7\xE3o"},media_controls:{shuffle:"Aleat\xF3rio",previous:"Anterior",play_pause:"Reproduzir/Pausa",stop:"Parar",next:"Seguinte",repeat:"Repetir"},menu:{more_info:"Mais info",search:"Procurar",source:"Fonte",transfer_queue:"Transferir fila",group_players:"Agrupar",select_entity:"Selecionar",transfer_to:"Transferir para",no_players:"Sem leitores MA."},grouping:{title:"Agrupar",sync_volume:"Sincronizar volume",group_all:"Agrupar todos",ungroup_all:"Separar todos",unavailable:"Indispon\xEDvel",no_players:"N\xE3o agrup\xE1vel.",master:"Mestre",joined:"Unido",available:"Dispon\xEDvel",current:"Atual",unjoin_from:"Desvincular de {master}",join_with:"Juntar-se a {master}"}},search:{favorites:"Favoritos",recently_played:"Recentes",next_up:"A seguir",recommendations:"Recomenda\xE7\xF5es",radio_mode:"Modo R\xE1dio",play_similar:"Tocar m\xFAsicas semelhantes",close:"Fechar",no_results:"Sem resultados.",play_next:"Reproduzir seguinte",replace_play:"Substituir e reproduzir",replace:"Substituir fila",add_queue:"Adicionar ao fim",move_up:"Subir",move_down:"Descer",move_next:"Passar para seguinte",remove:"Remover da fila",added:"Adicionado!",added_to_playlist:"Adicionado \xE0 playlist!",select_playlist:"Selecionar playlist para '{track}'",add_to_playlist:"Adicionar \xE0 playlist",select_track_for_playlist:"Selecionar a faixa a adicionar para '{track}' de {artist}",labels:{replace:"Substituir",next:"Seguinte",replace_next:"Subst. seg.",add:"Adicionar",add_to_playlist:"Adicionar \xE0 playlist"},results:"resultados",result:"resultado",filters:{all:"Tudo",artist:"Artista",album:"\xC1lbum",track:"Faixa",playlist:"Lista",radio:"R\xE1dio",music:"M\xFAsica",station:"Esta\xE7\xE3o",podcast:"Podcast",audiobook:"Audiolivro"},search_artist:"Procurar este artista",play_collection:"Reproduzir esta cole\xE7\xE3o",play_collection_error:"N\xE3o \xE9 poss\xEDvel reproduzir esta cole\xE7\xE3o diretamente",browse_album:"Explorar faixas de {album}",play_item:"Reproduzir {item}"}},go={common:{not_found:"Entita sa nena\u0161la.",search:"H\u013Eada\u0165",power:"Nap\xE1janie",favorite:"Ob\u013E\xFAben\xE9",loading:"Na\u010D\xEDtava sa...",no_results:"\u017Diadne v\xFDsledky.",close:"Zatvori\u0165",vol_up:"Zv\xFD\u0161i\u0165 hlasitos\u0165",vol_down:"Zn\xED\u017Ei\u0165 hlasitos\u0165",media_player:"Prehr\xE1va\u010D m\xE9di\xED",edit_entity:"Upravi\u0165 nastavenia entity",edit_action:"Upravi\u0165 nastavenia akcie",mute:"Stlmi\u0165",unmute:"Zru\u0161i\u0165 stlmenie",seek:"Posun\xFA\u0165",volume:"Hlasitos\u0165",play_now:"Prehra\u0165 teraz",more_options:"Viac mo\u017Enost\xED",unavailable:"Nedostupn\xE9",back:"Sp\xE4\u0165",cancel:"Zru\u0161i\u0165",reset_default:"Obnovi\u0165 predvolen\xE9"},editor:{tabs:{entities:"Entity",behavior:"Spr\xE1vanie",look_and_feel:"Vzh\u013Ead a dojem",artwork:"Grafika",actions:"Akcie"},placeholders:{search:"H\u013Eada\u0165 hudbu..."},sections:{artwork:{general:{title:"V\u0161eobecn\xE9 nastavenia",description:"Glob\xE1lne ovl\xE1danie toho, ako sa grafika zobrazuje a z\xEDskava."},idle:{title:"Grafika pri ne\u010Dinnosti",description:"Zobrazi\u0165 statick\xFD obr\xE1zok alebo sn\xEDmku entity, ke\u010F sa ni\u010D neprehr\xE1va."},overrides:{title:"Prep\xEDsania grafiky",description:"Prep\xEDsania sa vyhodnocuj\xFA zhora nadol. Poradie zmen\xEDte potiahnut\xEDm."}},entities:{title:"Entity*",description:"Pridajte prehr\xE1va\u010De m\xE9di\xED, ktor\xE9 chcete ovl\xE1da\u0165. Potiahnut\xEDm ent\xEDt zmen\xEDte poradie v riadku \u010Dipov."},behavior:{idle_chips:{title:"Ne\u010Dinnos\u0165 a \u010Dipy",description:"Vyberte, kedy karta prejde do ne\u010Dinnosti a ako sa spr\xE1vaj\xFA \u010Dipy ent\xEDt."},interactions_search:{title:"Interakcie a h\u013Eadanie",description:"Doladenie prip\xEDnania ent\xEDt a po\u010Dtu zobrazen\xFDch v\xFDsledkov."}},look_and_feel:{theme_layout:{title:"T\xE9ma a rozlo\u017Eenie",description:"Prisp\xF4sobte \u0161t\xFDl panelu a ovl\xE1dajte celkov\xFD vzh\u013Ead."},controls_typography:{title:"Ovl\xE1danie a typografia",description:"Nastavenie ve\u013Ekosti tla\u010Didiel, \u0161t\xEDtkov ent\xEDt a adapt\xEDvneho textu."},collapsed_idle:{title:"Zbalen\xE9 stavy a ne\u010Dinnos\u0165",description:"Ovl\xE1dajte, kedy sa karta zbal\xED a ktor\xE9 zobrazenia sa uk\xE1\u017Eu po\u010Das ne\u010Dinnosti."}},actions:{title:"Akcie",description:"Vytvorte ak\u010Dn\xE9 \u010Dipy, ktor\xE9 sa zobrazia na karte alebo v jej menu. Potiahnut\xEDm zmen\xEDte poradie, kliknut\xEDm na ceruzku akciu nakonfigurujete."}},subtitles:{idle_timeout:"\u010Cas v milisekund\xE1ch, k\xFDm karta prejde do re\u017Eimu ne\u010Dinnosti. Nastavte na 0 pre vypnutie.",show_chip_row:'"Auto" skryje riadok \u010Dipov, ak je nakonfigurovan\xE1 len jedna entita. "V menu" presunie \u010Dipy do ponuky menu. "V menu pri ne\u010Dinnosti" zobraz\xED \u010Dipy v riadku ke\u010F je akt\xEDvne, ale presunie ich do menu pri ne\u010Dinnosti.',dim_chips:"Ke\u010F karta prejde do re\u017Eimu ne\u010Dinnosti s obr\xE1zkom, stlmte \u010Dipy ent\xEDt a akci\xED pre \u010Distej\u0161\xED vzh\u013Ead.",hold_to_pin:"Dlh\xFDm stla\u010Den\xEDm \u010Dipov ent\xEDt ich pripnete, \u010D\xEDm zabr\xE1nite automatick\xE9mu prep\xEDnaniu po\u010Das prehr\xE1vania.",always_show_group:"Ovl\xE1dacie prvky r\xFDchleho zoskupovania (+/-/hviezdi\u010Dka) bud\xFA predvolene vidite\u013En\xE9 pri na\u010D\xEDtan\xED str\xE1nky. St\xE1le ich m\xF4\u017Eete manu\xE1lne prep\xEDna\u0165 dvojit\xFDm klepnut\xEDm.",disable_autofocus:"Zabr\xE1ni vyh\u013Ead\xE1vaciemu po\u013Eu prebra\u0165 zameranie, aby zostali kl\xE1vesnice na obrazovke skryt\xE9.",search_within_filter:"Povoli\u0165 vyh\u013Ead\xE1vanie v r\xE1mci aktu\xE1lneho akt\xEDvneho filtra (Ob\u013E\xFAben\xE9, Ned\xE1vno prehr\xE1van\xE9 at\u010F.) namiesto jeho vymazania.",close_search_on_play:"Automaticky zatvori\u0165 obrazovku vyh\u013Ead\xE1vania po spusten\xED skladby.",pin_search_headers:"Ponecha\u0165 pole vyh\u013Ead\xE1vania a filtre pevne navrchu po\u010Das pos\xFAvania v\xFDsledkov.",hide_search_headers_on_idle:"Skry\u0165 vyh\u013Ead\xE1vanie a filtre, ke\u010F je prehr\xE1va\u010D ne\u010Dinn\xFD.",disable_mass:"Deaktivova\u0165 volite\u013En\xFA integr\xE1ciu Mass Queue, aj ke\u010F je nain\u0161talovan\xE1.",swap_pause_stop:"Nahradi\u0165 tla\u010Didlo pauzy tla\u010Didlom zastavenia pri pou\u017Eit\xED modern\xE9ho rozlo\u017Eenia.",adaptive_controls:"Umo\u017Eni\u0165 tla\u010Didl\xE1m prehr\xE1vania meni\u0165 ve\u013Ekos\u0165 pod\u013Ea dostupn\xE9ho priestoru.",hide_menu_player:"Ke\u010F s\xFA \u010Dipy v menu, skry\u0165 n\xE1zov entity v spodnej \u010Dasti karty.",adaptive_text:"Vyberte skupiny textu, ktor\xE9 sa maj\xFA \u0161k\xE1lova\u0165 pod\u013Ea priestoru (nechajte pr\xE1zdne pre vypnutie).",collapse_expand:'"V\u017Edy zbalen\xE9" vytvor\xED re\u017Eim mini prehr\xE1va\u010Da. "Rozbali\u0165 pri h\u013Eadan\xED" kartu do\u010Dasne rozbal\xED pri vyh\u013Ead\xE1van\xED.',idle_screen:"Vyberte obrazovku, ktor\xE1 sa m\xE1 automaticky zobrazi\u0165 v re\u017Eime ne\u010Dinnosti.",hide_controls:"Vyberte ovl\xE1dacie prvky, ktor\xE9 chcete pre t\xFAto entitu skry\u0165 (\u0161tandardne s\xFA zobrazen\xE9 v\u0161etky).",hide_search_chips:"Skry\u0165 konkr\xE9tne \u010Dipy filtra vyh\u013Ead\xE1vania pre t\xFAto entitu.",follow_active_entity:"Ak je povolen\xE9, entita hlasitosti bude automaticky sledova\u0165 akt\xEDvny prehr\xE1va\u010D. Pozn\xE1mka: Toto prep\xED\u0161e vybran\xFA entitu hlasitosti.",search_limit_full:"Maxim\xE1lny po\u010Det v\xFDsledkov vyh\u013Ead\xE1vania (1-1000, predvolen\xE9: 20).",default_search_filter_full:"Vyberte, ktor\xFD filter bude predvolene akt\xEDvny pri otvoren\xED vyh\u013Ead\xE1vania.",default_search_favorites:"Spusti\u0165 vyh\u013Ead\xE1vanie s akt\xEDvnymi ob\u013E\xFAben\xFDmi",result_sorting_full:"Vyberte sp\xF4sob zoradenia v\xFDsledkov. Predvolen\xE9 ponech\xE1va poradie zo zdroja.",card_height_full:"Nechajte pr\xE1zdne pre automatick\xFA v\xFD\u0161ku.",control_layout_full:"Vyberte si medzi star\u0161\xEDm (rovnako ve\u013Ek\xE9 prvky) alebo modern\xFDm rozlo\u017Een\xEDm Home Assistant.",artwork_extend:"Umo\u017Eni\u0165 pozadiu grafiky pokra\u010Dova\u0165 pod riadkami \u010Dipov a akci\xED.",artwork_extend_label:"Roz\u0161\xEDri\u0165 grafiku",no_artwork_overrides:"Nie s\xFA nastaven\xE9 \u017Eiadne prep\xEDsania grafiky. Pridajte ich pomocou tla\u010Didla plus.",entity_current_hint:"Pou\u017Eite 'entity_id: current' na zacielenie aktu\xE1lne vybranej entity na karte. Pozn\xE1mka: Tla\u010Didlo 'Testova\u0165 akciu' bude v tomto pr\xEDpade neakt\xEDvne.",service_data_note:"Zmeny v servisn\xFDch \xFAdajoch sa neulo\u017Eia, k\xFDm nekliknete na tla\u010Didlo 'Ulo\u017Ei\u0165 servisn\xE9 \xFAdaje'!",jinja_template_hint:"Zadajte Jinja \u0161abl\xF3nu, ktor\xE1 vr\xE1ti jedno entity_id. Pr\xEDklad prep\xEDnania MA na z\xE1klade v\xFDberu zdroja:",jinja_template_vol_hint:"Zadajte Jinja \u0161abl\xF3nu, ktor\xE1 vr\xE1ti entity_id (napr. media_player.obyvacka). Pr\xEDklad prep\xEDnania hlasitosti pod\u013Ea stavu:",not_available_alt_collapsed:"Nedostupn\xE9 s alternat\xEDvnym indik\xE1torom priebehu alebo v re\u017Eime V\u017Edy zbalen\xE9.",not_available_collapsed:"Nedostupn\xE9, ke\u010F je zapnut\xE9 V\u017Edy zbalen\xE9.",only_available_collapsed:"Dostupn\xE9 len pri zapnutom re\u017Eime V\u017Edy zbalen\xE9.",only_available_modern:"Dostupn\xE9 len s modern\xFDm rozlo\u017Een\xEDm.",image_url_helper:"Zadajte priamu URL na obr\xE1zok alebo lok\xE1lnu cestu k s\xFAboru",selected_entity_helper:"Pomocn\xEDk pre vstupn\xFD text, ktor\xFD bude aktualizovan\xFD o ID aktu\xE1lne vybranej entity prehr\xE1va\u010Da m\xE9di\xED.",select_entity_helper:"Pomocn\xEDk pre vstupn\xFD text, z ktor\xE9ho sa \u010D\xEDta ID entity. Karta automaticky vyberie zodpovedaj\xFAci \u010Dip.",sync_entity_type:"Vyberte, ktor\xE9 ID entity sa m\xE1 synchronizova\u0165 s pomocn\xEDkom (predvolene entita Music Assistant, ak je nakonfigurovan\xE1).",disable_auto_select:"Zabr\xE1ni automatick\xE9mu v\xFDberu \u010Dipu tejto entity pri spusten\xED prehr\xE1vania.",search_view:"Vyberte si medzi \u0161tandardn\xFDm zoznamom alebo mrie\u017Ekou kariet pre v\xFDsledky vyh\u013Ead\xE1vania.",search_card_columns:"Zadajte, ko\u013Eko st\u013Apcov sa m\xE1 pou\u017Ei\u0165 v zobrazen\xED karty. Grafika sa automaticky prisp\xF4sob\xED.",card_type:"Vyberte re\u017Eim karty. 'Predvolen\xE9' je \u0161tandardn\xFD prehr\xE1va\u010D m\xE9di\xED. 'Vyhraden\xE9 vyh\u013Ead\xE1vanie' urob\xED z karty trval\xE9 rozhranie na vyh\u013Ead\xE1vanie."},titles:{edit_entity:"Upravi\u0165 entitu",edit_action:"Upravi\u0165 akciu",service_data:"Servisn\xE9 \xFAdaje",add_artwork_override:"Prida\u0165 prep\xEDsanie grafiky"},labels:{dim_chips:"Stlmi\u0165 \u010Dipy pri ne\u010Dinnosti",hold_to_pin:"Podr\u017Ea\u0165 pre pripnutie",always_show_group:"R\xFDchle zoskupovanie ako predvolen\xE9",disable_autofocus:"Vypn\xFA\u0165 automatick\xE9 zameranie h\u013Eadania",keep_filters:"Zachova\u0165 filtre pri h\u013Eadan\xED",dismiss_on_play:"Zavrie\u0165 h\u013Eadanie po spusten\xED",default_search_filter:"Predvolen\xFD filter vyh\u013Ead\xE1vania",default_search_favorites:"Predvolen\xFD filter ob\u013E\xFAben\xFDch",pin_headers:"Pripn\xFA\u0165 hlavi\u010Dky h\u013Eadania",hide_search_headers_on_idle:"Skry\u0165 hlavi\u010Dky pri ne\u010Dinnosti",disable_mass:"Deaktivova\u0165 Mass Queue",match_theme:"Pod\u013Ea t\xE9my",alt_progress:"Alternat\xEDvny indik\xE1tor priebehu",display_timestamps:"Zobrazi\u0165 \u010Dasov\xE9 \xFAdaje",swap_pause_stop:"Vymeni\u0165 pauzu za stop",adaptive_controls:"Adapt\xEDvna ve\u013Ekos\u0165 ovl\xE1dania",hide_active_entity:"Skry\u0165 \u0161t\xEDtok akt\xEDvnej entity",collapse_on_idle:"Zbali\u0165 pri ne\u010Dinnosti",hide_menu_player_toggle:"Skry\u0165 prehr\xE1va\u010D v menu",always_collapsed:"V\u017Edy zbalen\xE9",expand_on_search:"Rozbali\u0165 pri h\u013Eadan\xED",script_var:"Premenn\xE1 skriptu (yamp_entity)",use_ma_template:"Pou\u017Ei\u0165 \u0161abl\xF3nu pre Music Assistant",use_vol_template:"Pou\u017Ei\u0165 \u0161abl\xF3nu pre entitu hlasitosti",follow_active_entity:"Hlasitos\u0165 sleduje akt\xEDvnu entitu",use_url_path:"Pou\u017Ei\u0165 URL alebo cestu",adaptive_text_elements:"Prvky s adapt\xEDvnou ve\u013Ekos\u0165ou textu",disable_auto_select:"Zak\xE1za\u0165 automatick\xFD v\xFDber",card_type:"Typ karty"},fields:{artwork_fit:"Prisp\xF4sobenie grafiky",artwork_position:"Poz\xEDcia grafiky",artwork_hostname:"Hostname pre grafiku",match_field:"Pole pre zhodu",match_value:"Hodnota pre zhodu",size_percent:"Ve\u013Ekos\u0165 (%)",object_fit:"Prisp\xF4sobenie objektu (Fit)",idle_timeout:"\u010Cas ne\u010Dinnosti (ms)",show_chip_row:"Zobrazi\u0165 riadok \u010Dipov",search_limit:"Limit v\xFDsledkov h\u013Eadania",result_sorting:"Zoradenie v\xFDsledkov",vol_step:"Krok hlasitosti (0.05 = 5%)",card_height:"V\xFD\u0161ka karty (px)",control_layout:"Rozlo\u017Eenie ovl\xE1dania",save_service_data:"Ulo\u017Ei\u0165 servisn\xE9 \xFAdaje",image_url:"URL obr\xE1zka",fallback_image_url:"Z\xE1lo\u017En\xE1 URL obr\xE1zka",move_to_main:"Presun\xFA\u0165 do hlavn\xFDch \u010Dipov",move_to_menu:"Presun\xFA\u0165 do menu",delete_action:"Vymaza\u0165 akciu",revert_service_data:"Vr\xE1ti\u0165 ulo\u017Een\xE9 servisn\xE9 \xFAdaje",test_action:"Testova\u0165 akciu",volume_mode:"Re\u017Eim hlasitosti",idle_screen:"Obrazovka pri ne\u010Dinnosti",name:"N\xE1zov",hidden_controls:"Skryt\xE9 ovl\xE1dacie prvky",ma_template:"Jinja \u0161abl\xF3na pre Music Assistant",hidden_chips:"Skryt\xE9 \u010Dipy filtrov h\u013Eadania",vol_template:"Jinja \u0161abl\xF3na pre hlasitos\u0165",icon:"Ikona",action_type:"Typ akcie",menu_item:"Polo\u017Eka menu",nav_path:"Cesta navig\xE1cie",service:"Slu\u017Eba",service_data:"Servisn\xE9 \xFAdaje",idle_image_entity:"Entita obr\xE1zka pri ne\u010Dinnosti",match_entity:"Entita pre zhodu",ma_entity:"Entita Music Assistant",vol_entity:"Entita hlasitosti",selected_entity_helper:"Pomocn\xEDk vybratej entity",sync_entity_type:"Typ entity na synchroniz\xE1ciu",placement:"Umiestnenie",card_trigger:"Sp\xFA\u0161\u0165a\u010D karty",search_view:"Zobrazenie v\xFDsledkov vyh\u013Ead\xE1vania",search_card_columns:"St\u013Apce karty"},action_types:{menu:"Otvori\u0165 polo\u017Eku menu karty",service:"Zavola\u0165 slu\u017Ebu",navigate:"Navigova\u0165",prev_entity:"Predo\u0161l\xFD \u010Dip entity",next_entity:"\u010Eal\u0161\xED \u010Dip entity",sync_selected_entity:"Synchronizova\u0165 vybran\xFA entitu",select_entity:"Vybra\u0165 entitu z pomocn\xEDka"},action_helpers:{sync_selected_entity:"Synchronizova\u0165 vybran\xFA entitu \u2192",select_entity:"Vybra\u0165 entitu \u2190",select_helper:"(vybra\u0165 pomocn\xEDka)"},sync_entity_options:{yamp_entity:"yamp_entity (Entita Music Assistant, ak je nakonfigurovan\xE1)",yamp_main_entity:"yamp_main_entity (Hlavn\xE1 entita prehr\xE1va\u010Da m\xE9di\xED)",yamp_playback_entity:"yamp_playback_entity (Aktu\xE1lna akt\xEDvna entita prehr\xE1vania)"},placements:{chip:"Ak\u010Dn\xFD \u010Dip",menu:"V menu",hidden:"Skryt\xE9 (\u0164uknutie na grafiku)",not_triggerable:"Nespustite\u013En\xE9"},triggers:{none:"\u017Diadny",tap:"\u0164uknutie",hold:"Podr\u017Eanie",double_tap:"Dvojit\xE9 \u0165uknutie",swipe_left:"Potiahnutie do\u013Eava",swipe_right:"Potiahnutie doprava"},search_view_options:{list:"Zoznam",card:"Karta",card_minimal:"Minim\xE1lna karta"},card_type_options:{default:"Predvolen\xE9",search:"H\u013Eada\u0165",group_players:"Zoskupi\u0165 prehr\xE1va\u010De"}},card:{sections:{details:"Detaily prehr\xE1vania",menu:"Menu a vyh\u013Ead\xE1vanie",action_chips:"Ak\u010Dn\xE9 \u010Dipy"},media_controls:{shuffle:"N\xE1hodne",previous:"Predch\xE1dzaj\xFAce",play_pause:"Prehra\u0165/Pozastavi\u0165",stop:"Zastavi\u0165",next:"Nasleduj\xFAce",repeat:"Opakova\u0165"},menu:{more_info:"Viac inform\xE1ci\xED",search:"H\u013Eada\u0165",source:"Zdroj",transfer_queue:"Presun\xFA\u0165 frontu",group_players:"Zoskupi\u0165 prehr\xE1va\u010De",select_entity:"Vyberte entitu pre viac info",transfer_to:"Presun\xFA\u0165 frontu do",no_players:"\u017Diadne in\xE9 prehr\xE1va\u010De Music Assistant nie s\xFA k dispoz\xEDcii."},grouping:{title:"Zoskupi\u0165 prehr\xE1va\u010De",sync_volume:"Synchronizova\u0165 hlasitos\u0165",group_all:"Zoskupi\u0165 v\u0161etko",ungroup_all:"Zru\u0161i\u0165 zoskupenie v\u0161etk\xE9ho",unavailable:"Prehr\xE1va\u010D je nedostupn\xFD",no_players:"\u017Diadne in\xE9 prehr\xE1va\u010De schopn\xE9 zoskupenia nie s\xFA k dispoz\xEDcii.",master:"Hlavn\xFD (Master)",joined:"Pripojen\xFD",available:"Dostupn\xFD",current:"Aktu\xE1lny",unjoin_from:"Odpoji\u0165 od {master}",join_with:"Pripoji\u0165 k {master}"}},search:{favorites:"Ob\u013E\xFAben\xE9",recently_played:"Ned\xE1vno prehr\xE1van\xE9",next_up:"Nasleduj\xFAce",recommendations:"Odpor\xFA\u010Dania",radio_mode:"Re\u017Eim r\xE1dio",play_similar:"Prehra\u0165 podobn\xE9 skladby",close:"Zatvori\u0165 vyh\u013Ead\xE1vanie",no_results:"\u017Diadne v\xFDsledky.",play_next:"Prehra\u0165 ako nasleduj\xFAce",replace_play:"Nahradi\u0165 frontu a prehra\u0165 teraz",replace:"Nahradi\u0165 frontu",add_queue:"Prida\u0165 na koniec fronty",move_up:"Posun\xFA\u0165 nahor",move_down:"Posun\xFA\u0165 nadol",move_next:"Presun\xFA\u0165 na nasleduj\xFAce",remove:"Odstr\xE1ni\u0165 z fronty",added:"Pridan\xE9 do fronty!",added_to_playlist:"Pridan\xE9 do playlistu!",select_playlist:"Vybra\u0165 playlist pre '{track}'",add_to_playlist:"Prida\u0165 do playlistu",select_track_for_playlist:"Vybra\u0165 skladbu na pridanie pre '{track}' od {artist}",labels:{replace:"Nahradi\u0165",next:"Nasleduj\xFAce",replace_next:"Nahradi\u0165 nasleduj\xFAce",add:"Prida\u0165",add_to_playlist:"Prida\u0165 do playlistu"},results:"v\xFDsledkov",result:"v\xFDsledok",filters:{all:"V\u0161etko",artist:"Interpret",album:"Album",track:"Skladba",playlist:"Playlist",radio:"R\xE1dio",music:"Hudba",station:"Stanica",podcast:"Podcast",audiobook:"Audiokniha"},search_artist:"H\u013Eada\u0165 tohto interpreta",play_collection:"Prehra\u0165 t\xFAto kolekciu",play_collection_error:"T\xFAto kolekciu nie je mo\u017En\xE9 prehra\u0165 priamo",browse_album:"Preh\u013Ead\xE1va\u0165 skladby z {album}",play_item:"Prehra\u0165 {item}"}},bo={common:{not_found:"Entiteta ni najdena.",search:"I\u0161\u010Di",power:"Napajanje",favorite:"Priljubljeno",loading:"Nalaganje...",no_results:"Ni rezultatov.",close:"Zapri",vol_up:"Pove\u010Daj glasnost",vol_down:"Zmanj\u0161aj glasnost",media_player:"Predvajalnik predstavnosti",edit_entity:"Uredi nastavitve entitete",edit_action:"Uredi nastavitve dejanja",mute:"Uti\u0161aj",unmute:"Vklopi zvok",seek:"Previj",volume:"Glasnost",play_now:"Predvajaj zdaj",more_options:"Ve\u010D mo\u017Enosti",unavailable:"Ni na voljo",back:"Nazaj",cancel:"Prekli\u010Di",reset_default:"Ponastavi na privzeto"},editor:{tabs:{entities:"Entitete",behavior:"Vedenje",look_and_feel:"Videz in ob\u010Dutek",artwork:"Grafika",actions:"Dejanja"},placeholders:{search:"I\u0161\u010Di glasbo..."},sections:{artwork:{general:{title:"Splo\u0161ne nastavitve",description:"Globalni nadzor nad prikazom in pridobivanjem grafike."},idle:{title:"Grafika v mirovanju",description:"Prika\u017Ei stati\u010Dno sliko ali posnetek entitete, ko se ni\u010D ne predvaja."},overrides:{title:"Prepis grafike",description:"Prepisi se ocenjujejo od zgoraj navzdol. Povlecite za spremembo vrstnega reda."}},entities:{title:"Entitete*",description:"Dodajte predvajalnike, ki jih \u017Eelite upravljati. Povlecite entitete za spremembo vrstnega reda."},behavior:{idle_chips:{title:"Mirovanje in \u010Dipi",description:"Izberite, kdaj kartica preide v mirovanje in kako se obna\u0161ajo \u010Dipi entitet."},interactions_search:{title:"Interakcije in iskanje",description:"Nastavite pripenjanje entitet in \u0161tevilo prikazanih rezultatov."}},look_and_feel:{theme_layout:{title:"Tema in postavitev",description:"Ujemanje s slogom nadzorne plo\u0161\u010De in nadzor velikosti."},controls_typography:{title:"Kontrolniki in tipografija",description:"Prilagodite velikost gumbov, oznake entitet in prilagodljivo besedilo."},collapsed_idle:{title:"Strnjeno in mirovanje",description:"Nadzorujte, kdaj se kartica skr\u010Di in kaj se prika\u017Ee v mirovanju."}},actions:{title:"Dejanja",description:"Ustvarite \u010Dipe dejanj, ki se prika\u017Eejo na kartici ali v meniju."}},subtitles:{idle_timeout:"\u010Cas v milisekundah, preden kartica preide v mirovanje. Nastavite na 0 za izklop.",show_chip_row:'"Samodejno" skrije \u010Dipe, \u010De je nastavljena ena entiteta. "V meniju" jih premakne v meni. "V meniju med nedejavnostjo" prika\u017Ee \u010Dipe v vrstici, ko je aktivna, a jih premakne v meni med nedejavnostjo.',dim_chips:"Ko kartica preide v mirovanje s sliko, se \u010Dipi zatemnijo.",hold_to_pin:"Dolgi pritisk za pripenjanje entitet namesto kratkega.",always_show_group:"Kontrolni elementi za hitro zdru\u017Eevanje (+/-/zvezda) bodo privzeto vidni ob nalaganju strani. \u0160e vedno jih lahko ro\u010Dno preklopite z dvojnim tapom.",disable_autofocus:"Prepre\u010Di samodejni fokus iskalnega polja.",search_within_filter:"I\u0161\u010Di znotraj trenutnega filtra.",close_search_on_play:"Samodejno zapri iskanje ob predvajanju.",pin_search_headers:"Pripni iskalno polje in filtre na vrh.",hide_search_headers_on_idle:"Skrij iskalno polje in filtre med mirovanjem.",disable_mass:"Onemogo\u010Di integracijo Mass Queue.",swap_pause_stop:"Zamenjaj gumb pavze z gumbom zaustavitve med uporabo moderne postavitve.",adaptive_controls:"Prilagodi velikost gumbov glede na prostor.",hide_menu_player:"Skrij oznako entitete v meniju.",adaptive_text:"Izberi skupine besedila za prilagajanje velikosti.",collapse_expand:"Vedno skr\u010Deno ustvari mini predvajalnik.",idle_screen:"Izberi zaslon, prikazan v mirovanju.",hide_controls:"Izberi kontrolnike za skrivanje.",hide_search_chips:"Skrij dolo\u010Dene iskalne filtre.",follow_active_entity:"Entiteta glasnosti sledi aktivni entiteti. Opomba: To prepi\u0161e izbrano entiteto za glasnost.",search_limit_full:"Najve\u010Dje \u0161tevilo rezultatov (1\u20131000, privzeto: 20).",default_search_filter_full:"Izberite, kateri filter je privzeto aktiven ob odprtju iskanja.",default_search_favorites:"Za\u010Dni iskanje z aktivnimi priljubljenimi",result_sorting_full:"Izberi razvr\u0161\u010Danje rezultatov.",card_height_full:"Pustite prazno za samodejno vi\u0161ino.",control_layout_full:"Izberi med staro in moderno postavitvijo.",artwork_extend:"Raz\u0161iri ozadje grafike pod \u010Dipe.",artwork_extend_label:"Raz\u0161iri grafiko",no_artwork_overrides:"Ni nastavljenih prepisov grafike.",entity_current_hint:"Uporabi entity_id: current za trenutno izbrano entiteto.",service_data_note:"Spremembe se shranijo \u0161ele ob kliku na ikono shrani.",jinja_template_hint:"Vnesite Jinja predlogo, ki vrne en entity_id.",jinja_template_vol_hint:"Vnesite Jinja predlogo za entiteto glasnosti.",not_available_alt_collapsed:"Ni na voljo z alternativno vrstico napredka.",not_available_collapsed:"Ni na voljo v vedno skr\u010Denem na\u010Dinu.",only_available_collapsed:"Na voljo le v vedno skr\u010Denem na\u010Dinu.",only_available_modern:"Na voljo le v moderni postavitvi.",image_url_helper:"Vnesite neposredni URL do slike ali lokalno pot do datoteke",selected_entity_helper:"Pomo\u010Dnik za vnos besedila, ki bo posodobljen z ID-jem trenutno izbranega predvajalnika medijev.",select_entity_helper:"Pomo\u010Dnik za vnos besedila, iz katerega se bere ID entitete. Kartica bo samodejno izbrala ustrezni \u010Dip.",sync_entity_type:"Izberite, kateri ID entitete \u017Eelite sinhronizirati s pomo\u010Dnikom (privzeto entiteto Music Assistant, \u010De je nastavljena).",disable_auto_select:"Prepre\u010Di samodejno izbiro \u010Dipa te entitete ob za\u010Detku predvajanja.",search_view:"Izberite med standardnim seznamom ali mre\u017Eo kartic za rezultate iskanja.",search_card_columns:"Dolo\u010Dite \u0161tevilo stolpcev v pogledu kartic. Grafika se bo samodejno prilagodila.",card_type:"Izberite na\u010Din kartice. 'Privzeto' je standardni medijski predvajalnik. 'Namensko iskanje' spremeni kartico v trajen iskalni vmesnik."},titles:{edit_entity:"Uredi entiteto",edit_action:"Uredi dejanje",service_data:"Podatki storitve",add_artwork_override:"Dodaj prepis grafike"},labels:{dim_chips:"Zatemni \u010Dipe v mirovanju",hold_to_pin:"Dr\u017Ei za pripenjanje",always_show_group:"Hitro zdru\u017Eevanje kot privzeto",disable_autofocus:"Onemogo\u010Di samodejni fokus",keep_filters:"Ohrani filtre",dismiss_on_play:"Zapri iskanje ob predvajanju",default_search_filter:"Privzeti iskalni filter",default_search_favorites:"Privzeti filter priljubljenih",pin_headers:"Pripni glave iskanja",hide_search_headers_on_idle:"Skrij glave iskanja med mirovanjem",disable_mass:"Onemogo\u010Di Mass Queue",match_theme:"Ujemaj temo",alt_progress:"Alternativna vrstica napredka",display_timestamps:"Prika\u017Ei \u010Dasovne oznake",swap_pause_stop:"Zamenjaj pavzo z zaustavitvijo",adaptive_controls:"Prilagodljiva velikost gumbov",hide_active_entity:"Skrij oznako aktivne entitete",collapse_on_idle:"Skr\u010Di v mirovanju",hide_menu_player_toggle:"Skrij predvajalnik v meniju",always_collapsed:"Vedno skr\u010Deno",expand_on_search:"Raz\u0161iri ob iskanju",script_var:"Skriptna spremenljivka",use_ma_template:"Uporabi predlogo za entiteto Music Assistant",use_vol_template:"Uporabi predlogo za glasnost",follow_active_entity:"Glasnost sledi aktivni entiteti",use_url_path:"Uporabi URL ali pot",adaptive_text_elements:"Elementi prilagodljive velikosti besedila",disable_auto_select:"Onemogo\u010Di samodejno izbiro",card_type:"Vrsta kartice"},fields:{artwork_fit:"Prileganje grafike",artwork_position:"Polo\u017Eaj grafike",artwork_hostname:"Ime gostitelja grafike",match_field:"Polje ujemanja",match_value:"Vrednost ujemanja",size_percent:"Velikost (%)",object_fit:"Prileganje objekta",idle_timeout:"\u010Cas mirovanja (ms)",show_chip_row:"Prika\u017Ei vrstico \u010Dipov",search_limit:"Omejitev rezultatov iskanja",result_sorting:"Razvr\u0161\u010Danje rezultatov",vol_step:"Korak glasnosti (0.05 = 5 %)",card_height:"Vi\u0161ina kartice (px)",control_layout:"Postavitev kontrolnikov",save_service_data:"Shrani podatke storitve",image_url:"URL slike",fallback_image_url:"Rezervni URL slike",move_to_main:"Premakni dejanje na glavno vrstico",move_to_menu:"Premakni dejanje v meni",delete_action:"Izbri\u0161i dejanje",revert_service_data:"Povrni shranjene podatke",test_action:"Preizkusi dejanje",volume_mode:"Na\u010Din glasnosti",idle_screen:"Zaslon v mirovanju",name:"Ime",hidden_controls:"Skriti kontrolniki",ma_template:"Predloga Music Assistant (Jinja)",hidden_chips:"Skriti iskalni \u010Dipi",vol_template:"Predloga entitete glasnosti (Jinja)",icon:"Ikona",action_type:"Vrsta dejanja",menu_item:"Element menija",nav_path:"Navigacijska pot",service:"Storitev",service_data:"Podatki storitve",idle_image_entity:"Entiteta slike v mirovanju",match_entity:"Ujemajo\u010Da entiteta",ma_entity:"Entiteta Music Assistant",vol_entity:"Entiteta glasnosti",selected_entity_helper:"Pomo\u010Dnik izbrane entitete",sync_entity_type:"Vrsta entitete za sinhronizacijo",placement:"Namestitev",card_trigger:"Spro\u017Eilec kartice",search_view:"Pogled rezultatov iskanja",search_card_columns:"Stolpci kartic"},action_types:{menu:"Odpri element menija kartice",service:"Pokli\u010Di storitev",navigate:"Navigiraj",prev_entity:"Prej\u0161nji \u010Dip entitete",next_entity:"Naslednji \u010Dip entitete",sync_selected_entity:"Sinhroniziraj izbrano entiteto",select_entity:"Izberi entiteto iz pomo\u010Dnika"},action_helpers:{sync_selected_entity:"Sinhroniziraj izbrano entiteto \u2192",select_entity:"Izberi entiteto \u2190",select_helper:"(izberite pomo\u010Dnika)"},sync_entity_options:{yamp_entity:"yamp_entity (entiteta Music Assistant, \u010De je nastavljena)",yamp_main_entity:"yamp_main_entity (glavna entiteta predvajalnika medijev)",yamp_playback_entity:"yamp_playback_entity (trenutno aktivna entitea predvajanja)"},placements:{chip:"\u010Cip dejanja",menu:"V meniju",hidden:"Skrito (dotik grafike)",not_triggerable:"Ni mogo\u010De spro\u017Eiti"},triggers:{none:"Brez",tap:"Dotik",hold:"Pridr\u017Eanje",double_tap:"Dvojni dotik",swipe_left:"Podrsaj levo",swipe_right:"Podrsaj desno"},search_view_options:{list:"Seznam",card:"Kartica",card_minimal:"Minimalna kartica"},card_type_options:{default:"Privzeto",search:"I\u0161\u010Di",group_players:"Zdru\u017Ei predvajalnike"}},card:{sections:{details:"Podrobnosti predvajanja",menu:"Meni in iskanje",action_chips:"\u010Cipi dejanj"},media_controls:{shuffle:"Naklju\u010Dno",previous:"Prej\u0161nje",play_pause:"Predvajaj/Pavza",stop:"Ustavi",next:"Naslednje",repeat:"Ponovi"},menu:{more_info:"Ve\u010D informacij",search:"I\u0161\u010Di",source:"Vir",transfer_queue:"Prenesi \u010Dakalno vrsto",group_players:"Zdru\u017Ei predvajalnike",select_entity:"Izberi entiteto za ve\u010D informacij",transfer_to:"Prenesi \u010Dakalno vrsto na",no_players:"Ni drugih razpolo\u017Eljivih predvajalnikov Music Assistant."},grouping:{title:"Zdru\u017Ei predvajalnike",sync_volume:"Sinhroniziraj glasnost",group_all:"Zdru\u017Ei vse",ungroup_all:"Razdru\u017Ei vse",unavailable:"Predvajalnik ni na voljo",no_players:"Ni drugih predvajalnikov za zdru\u017Eevanje.",master:"Glavni",joined:"Pridru\u017Een",available:"Na voljo",current:"Trenutni",unjoin_from:"Odslopi od {master}",join_with:"Pridru\u017Ei se {master}"}},search:{favorites:"Priljubljeni",recently_played:"Nedavno predvajano",next_up:"Naslednje",recommendations:"Priporo\u010Dila",radio_mode:"Radijski na\u010Din",play_similar:"Predvajaj podobne pesmi",close:"Zapri iskanje",no_results:"Ni rezultatov.",play_next:"Predvajaj naslednje",replace_play:"Zamenjaj \u010Dakalno vrsto in predvajaj",replace:"Zamenjaj \u010Dakalno vrsto",add_queue:"Dodaj na konec \u010Dakalne vrste",move_up:"Premakni gor",move_down:"Premakni dol",move_next:"Premakni na naslednje",remove:"Odstrani iz \u010Dakalne vrste",added:"Dodano v \u010Dakalno vrsto!",added_to_playlist:"Dodano na seznam predvajanja!",select_playlist:"Izberite seznam predvajanja za '{track}'",add_to_playlist:"Dodaj na seznam predvajanja",select_track_for_playlist:"Izberite skladbo za dodajanje za '{track}' od {artist}",labels:{replace:"Zamenjaj",next:"Naslednje",replace_next:"Zamenjaj naslednje",add:"Dodaj",add_to_playlist:"Dodaj na seznam predvajanja"},results:"rezultati",result:"rezultat",filters:{all:"Vse",artist:"Izvajalec",album:"Album",track:"Skladba",playlist:"Seznam predvajanja",radio:"Radio",music:"Glasba",station:"Postaja",podcast:"Podcast",audiobook:"Zvo\u010Dna knjiga"},search_artist:"I\u0161\u010Di tega izvajalca",play_collection:"Predvajaj to zbirko",play_collection_error:"Te zbirke ni mogo\u010De predvajati neposredno",browse_album:"Prebrskaj skladbe iz {album}",play_item:"Predvajaj {item}"}};const Xi={en:ho,de:po,es:_o,fr:mo,it:fo,nl:vo,pt:yo,sk:go,sl:bo};function u(i,e="",t=""){const a=(localStorage.getItem("selectedLanguage")||document.querySelector("home-assistant")?.hass?.language||"en").replace(/['"]+/g,"").replace("-","_"),r=Xi[a]?a:a.split("_")[0];let s;const n=i.split("."),o=(l,c)=>{try{return c.reduce((h,d)=>h&&h[d]!==void 0?h[d]:void 0,l)}catch{return}};if(s=o(Xi[r],n),s===void 0&&r!=="en"&&(s=o(Xi.en,n)),s===void 0&&(s=i),typeof s!="string"&&(s=i),typeof e=="object"&&e!==null)for(const[l,c]of Object.entries(e))s=s.replaceAll(l,c);else e!==""&&t!==""&&(s=s.replaceAll(e,t));return s}function we(i,e){const t=i?.[e];return typeof t=="string"&&t.trim()!==""?t:null}async function xo(i,e,t){if(!e||typeof e!="string")return t;if(!e.includes("{{")&&!e.includes("{%"))return e;try{const a=(await i.callApi("POST","template",{template:e})||"").toString().trim();return a&&/^([a-z_]+)\.[A-Za-z0-9_]+$/.test(a)?a:t}catch{return t}}async function wo(i,e,t={}){if(!e||typeof e!="string")return e;if(!e.includes("{{")&&!e.includes("{%")){if(/%7B%7B|%7B%25/i.test(e))try{e=decodeURIComponent(e)}catch{}if(!e.includes("{{")&&!e.includes("{%"))return e}let a=e;t&&Object.keys(t).length>0&&(a=`${Object.entries(t).map(([r,s])=>`{% set ${r} = ${JSON.stringify(s)} %}`).join(" ")} ${e}`);try{return(await i.callApi("POST","template",{template:a})||"").toString().trim()}catch(r){return console.warn("yamp: Error resolving template:",e,r),e}}function ko(i,e,t={}){if(!e||typeof e!="string")return e;let a=e;if(/%7B%7B|%7B%25/i.test(a))try{a=decodeURIComponent(a)}catch{}if(!a.includes("{{")&&!a.includes("{%"))return a;let r=a,s=!0;return r=r.replace(/\{\{\s*(.*?)\s*\}\}/g,(n,o)=>{let l=o.trim(),c=!1;l.endsWith("| urlencode")?(c=!0,l=l.replace(/\|\s*urlencode$/,"").trim()):l.endsWith("|urlencode")&&(c=!0,l=l.replace(/\|urlencode$/,"").trim());let h=l.match(/^state_attr\(\s*(['"]?)([\w.]+)\1\s*,\s*(['"]?)([\w_]+)\3\s*\)$/);if(h){let p=h[2],m=t[p]!==void 0&&!h[1]?t[p]:p,f=h[4];const v=i?.states?.[m];if(v&&v.attributes&&v.attributes[f]!==void 0){let g=String(v.attributes[f]);return c?encodeURIComponent(g):g}return""}let d=l.match(/^states\(\s*(['"]?)([\w.]+)\1\s*\)$/);if(d){let p=d[2],m=t[p]!==void 0&&!d[1]?t[p]:p;const f=i?.states?.[m];if(f&&f.state!==void 0){let v=String(f.state);return c?encodeURIComponent(v):v}return""}if(/^[\w_]+$/.test(l)&&t[l]!==void 0){let p=String(t[l]);return c?encodeURIComponent(p):p}return s=!1,n}),!s||r.includes("{%")?null:r}function Eo(i,e){if(!i?.states||!e)return[];const t=[],a=i.states[e];if(!a)return[];const r=a.attributes?.device_id,s=a.attributes?.friendly_name||e;for(const[n,o]of Object.entries(i.states))if(n.startsWith("button.")&&o.attributes){const l=o.attributes.device_id,c=o.attributes.friendly_name||n;r&&l===r?t.push({entity_id:n,friendly_name:c,device_class:o.attributes.device_class,reason:"same_device"}):(c.toLowerCase().includes(s.toLowerCase())||s.toLowerCase().includes(c.toLowerCase()))&&t.push({entity_id:n,friendly_name:c,device_class:o.attributes.device_class,reason:"name_similarity"})}return t}function Ao(i,e){if(!i?.states||!e)return null;const t=i.states[e];return t&&t.attributes&&(t.attributes.media_content_id||t.attributes.media_content_type||t.attributes.media_album_name||t.attributes.media_artist||t.attributes.media_title)?t:null}function ht(i){return!i||!i.attributes?!1:i.attributes.app_id==="music_assistant"||i.attributes.mass_player_type!==void 0}function So(i){if(!i)return"";const e=i.media_type||i.media_class||i.media_content_type,t=i.name||i.title||i.media_title||"Unknown Title",a=i.artists?.[0],r=i.artist||a?.name||(typeof a=="string"?a:void 0)||i.media_artist||"Unknown Artist";if(e==="track"){const s=i.album||i.media_album_name;return s?u("search.browse_album","{album}",s):`${t} - ${r}`}return e==="album"?u("search.browse_album","{album}",t):t}function gr(i,e="",t=[],a=null){if(!i||!i.attributes)return null;const r=i.attributes,s=i.entity_id;r.app_id;let n=null,o=null;if(t&&Array.isArray(t)&&t.length){const l=(d,p)=>{if(d)return d[p]},c=[["media_title","media_title"],["media_artist","media_artist"],["media_album_name","media_album_name"],["media_content_id","media_content_id"],["media_channel","media_channel"],["app_name","app_name"],["media_content_type","media_content_type"],["entity_id","entity_id"],["entity_state","entity_state"]];let h=t.find(d=>c.some(([p,m])=>{const f=l(d,m);return f===void 0?!1:(p==="entity_id"?s:p==="entity_state"?i?.state:r[p])===f}));h||we(r,"entity_picture_local")||we(r,"entity_picture")||we(r,"album_art")||(h=t.find(d=>d?.missing_art_url),h?.missing_art_url&&(h={...h,image_url:h.missing_art_url})),h?.image_url&&(n=h.image_url,o=h?.size_percentage)}return n||(n=we(r,"entity_picture_local")||we(r,"entity_picture")||we(r,"album_art")||null),!n&&a&&(a==="smart"?r.media_title==="TV"||r.media_channel||r.app_id==="tv"||r.app_id==="androidtv"?n="data:image/svg+xml;base64,":n="data:image/svg+xml;base64,":typeof a=="string"&&(n=a)),n&&e&&!n.startsWith("http")&&(n=e+n),{url:n,sizePercentage:o}}function $o({idx:i,selected:e,playing:t,name:a,art:r,icon:s,pinned:n,holdToPin:o,maActive:l,onChipClick:c,onIconClick:h,onPinClick:d,onPointerDown:p,onPointerMove:m,onPointerUp:f,objectFit:v,quickGroupingState:g,onQuickGroupClick:w,onDoubleClick:k}){const I=v?`object-fit: ${v};`:"";return _`
    <button class="chip"
      ...
      <span class="chip-icon">
        ${r?_`<img class="chip-mini-art" src="${r}" style="${I}" onerror="this.style.display='none'" />`:_`<ha-icon .icon=${s} style="font-size:28px;"></ha-icon>`}
      </span>
      ...
      ${br({idx:i,quickGroupingState:g,onQuickGroupClick:w})}
    </button>
  `}function Io({idx:i,selected:e,playing:t,groupName:a,art:r,icon:s,pinned:n,holdToPin:o,maActive:l,onChipClick:c,onIconClick:h,onPinClick:d,onPointerDown:p,onPointerMove:m,onPointerUp:f,objectFit:v,quickGroupingState:g,onQuickGroupClick:w,onDoubleClick:k}){const I=v?`object-fit: ${v};`:"";return _`
  ...
  `}function br({idx:i,quickGroupingState:e,onQuickGroupClick:t}){if(!e||!e.isGroupable)return y;const{isPrimary:a,isBusy:r,grouped:s,tooltip:n}=e;return _`
  ...
  `}function Co({onPin:i,onHoldEnd:e,holdTime:t=600,moveThreshold:a=8}){let r=null,s=null,n=null,o=!1;return{pointerDown:(l,c)=>{s=l.clientX,n=l.clientY,o=!1,r=setTimeout(()=>{o||(i(c,l),e&&e(c))},t)},pointerMove:(l,c)=>{if(r&&s!==null&&n!==null){const h=Math.abs(l.clientX-s),d=Math.abs(l.clientY-n);(h>a||d>a)&&(o=!0,clearTimeout(r),r=null)}},pointerUp:(l,c)=>{r&&(clearTimeout(r),r=null),s=null,n=null,o=!1}}}function xr({groupedSortedEntityIds:i,entityIds:e,selectedEntityId:t,pinnedIndex:a,holdToPin:r,getChipName:s,getActualGroupMaster:n,getIsChipPlaying:o,getChipArt:l,getIsMaActive:c,isIdle:h,hass:d,artworkHostname:p="",mediaArtworkOverrides:m=[],fallbackArtwork:f=null,onChipClick:v,onIconClick:g,onPointerClick:w,onPinClick:k,onPointerDown:I,onPointerMove:E,onPointerUp:U,quickGroupingMode:B,getQuickGroupingState:F,onQuickGroupClick:D,onDoubleClick:N}){return!i||!i.length?y:_`
    ${i.map(L=>{if(L.length>1){const M=n(L),q=e.indexOf(M),H=d?.states?.[M],te=typeof o=="function"?o(M,t===M):H?.state==="playing",ie=typeof l=="function"?l(M):gr(H,p,m,f),Z=ie?.url,ne=ie?.objectFit,oe=H?.attributes?.icon||"mdi:cast",$e=typeof c=="function"?c(M):!1;return Io({idx:q,selected:t===M,playing:te,groupName:s(M)+(L.length>1?` [${L.length}]`:""),art:Z,icon:oe,pinned:a===q,holdToPin:r,maActive:$e,onChipClick:v,onIconClick:g,onPinClick:k,onPointerDown:_e=>I(_e,q),onPointerMove:_e=>E(_e,q),onPointerUp:_e=>U(_e,q),objectFit:ne,quickGroupingState:B&&typeof F=="function"?F(M):null,onQuickGroupClick:D,onDoubleClick:N})}else{const M=L[0],q=e.indexOf(M),H=d?.states?.[M],te=typeof o=="function"?o(M,t===M):H?.state==="playing",ie=typeof l=="function"?l(M):gr(H,p,m,f),Z=ie?.url,ne=ie?.objectFit,oe=t===M?!h&&Z:te&&Z,$e=H?.attributes?.icon||"mdi:cast",_e=typeof c=="function"?c(M):!1;return $o({idx:q,selected:t===M,playing:te,name:s(M),art:oe,icon:$e,pinned:a===q,holdToPin:r,maActive:_e,onChipClick:v,onPinClick:k,onPointerDown:ae=>I(ae,q),onPointerMove:ae=>E(ae,q),onPointerUp:ae=>U(ae,q),objectFit:ne,quickGroupingState:B&&typeof F=="function"?F(M):null,onQuickGroupClick:D,onDoubleClick:N})}})}
  `}function To({actions:i,onActionChipClick:e}){return i?.length?_`
    <div class="action-chip-row">
      ${i.map((t,a)=>_`
          <button class="action-chip" @click=${()=>e(a)}>
            ${t.icon?_`<ha-icon .icon=${t.icon} style="font-size: 22px; margin-right: ${t.name?"8px":"0"};"></ha-icon>`:y}
            ${t.name||""}
          </button>
        `)}
    </div>
  `:y}function Mo({stateObj:i,showStop:e,shuffleActive:t,repeatActive:a,onControlClick:r,supportsFeature:s,showFavorite:n,favoriteActive:o,hiddenControls:l={},adaptiveControls:c=!1,controlLayout:h="classic",swapPauseForStop:d=!1}){if(!i)return y;const p=1,m=16,f=32,v=32768,g=262144,w=128,k=256,I=16384,E=h==="modern"?"modern":"classic";let U=!l.previous&&s(i,m),B=!l.play_pause&&(s(i,p)||s(i,I));const F=!l.stop&&e;let D=F,N=!l.next&&s(i,f),L=!l.shuffle&&s(i,v),M=!l.repeat&&s(i,g),q=!l.favorite&&n,H=!l.power&&(s(i,k)||s(i,w));const te=E==="modern"&&d&&F,ie=i.state==="playing",Z=te&&ie;E==="modern"&&(D=!1,q=!1,H=!1);const ne=Ji(i,s,n,l,e,E),oe=c?"controls-row adaptive":"controls-row",$e=E==="modern"?`${oe} modern`:oe;let _e=c?`--yamp-control-count:${Math.max(ne,1)};`:y;if(c){const ae=ne<=3?{icon:56,minWidth:78,maxWidth:150,minHeight:78,padding:14,gap:14}:ne===4?{icon:48,minWidth:68,maxWidth:130,minHeight:68,padding:12,gap:12}:ne===5?{icon:42,minWidth:58,maxWidth:110,minHeight:58,padding:10,gap:10}:ne===6?{icon:36,minWidth:50,maxWidth:96,minHeight:52,padding:8,gap:8}:{icon:32,minWidth:44,maxWidth:88,minHeight:48,padding:6,gap:6};_e+=[`--yamp-control-gap:${ae.gap}px`,`--yamp-control-min-width:${ae.minWidth}px`,`--yamp-control-max-width:${ae.maxWidth}px`,`--yamp-control-min-height:${ae.minHeight}px`,`--yamp-control-padding:${ae.padding}px`,`--yamp-control-icon-size:${ae.icon}px`].join(";")}return E==="modern"?_`
      <div class=${$e} style=${_e}>
        <div class="controls-left">
          ${L?_`
            <button class="modern-button small${t?" active":""}" @click=${()=>r("shuffle")} title="${u("card.media_controls.shuffle")}">
              <ha-icon .icon=${"mdi:shuffle"}></ha-icon>
            </button>
          `:y}
          ${U?_`
            <button class="modern-button medium" @click=${()=>r("prev")} title="${u("card.media_controls.previous")}">
        ...
        <div class="controls-right">
          ${N?_`
            <button class="modern-button medium" @click=${()=>r("next")} title="${u("card.media_controls.next")}">
              <ha-icon .icon=${"mdi:skip-next"}></ha-icon>
            </button>
          `:y}
          ${M?_`
            <button class="modern-button small${a?" active":""}" @click=${()=>r("repeat")} title="${u("card.media_controls.repeat")}">
  ...
  `}function Ji(i,e,t=!1,a={},r=!1,s="classic"){const n=s==="modern"?"modern":"classic";let o=0;return!a.previous&&e(i,16)&&o++,a.play_pause||o++,n!=="modern"&&!a.stop&&r&&o++,!a.next&&e(i,32)&&o++,!a.shuffle&&e(i,32768)&&o++,!a.repeat&&e(i,262144)&&o++,n!=="modern"&&!a.favorite&&t&&o++,n!=="modern"&&!a.power&&(e(i,256)||e(i,128))&&o++,o}function Fo({isRemoteVolumeEntity:i,showSlider:e,vol:t,isMuted:a,supportsMute:r,onVolumeDragStart:s,onVolumeDragEnd:n,onVolumeChange:o,onVolumeStep:l,onMuteToggle:c,moreInfoMenu:h,leadingControlTemplate:d=y,reserveLeadingControlSpace:p=!1,showRightPlaceholder:m=!1,rightSlotTemplate:f=y,hideVolume:v=!1}){const g=d!==y&&d!==void 0&&d!==null,w=(k,I)=>(r?I:k===0)||k===0?"mdi:volume-off":k<.2?"mdi:volume-low":k<.5?"mdi:volume-medium":"mdi:volume-high";return _`
    <div class="volume-row ${e&&!i?"has-slider":""}">
      <div class="volume-left">
        ${g?d:p?_`<div class="volume-leading-placeholder"></div>`:y}
        ${!v&&!i?_`
          <button 
            class="volume-icon-btn" 
            @click=${c} 
            title=${u((r?a:t===0)?"common.unmute":"common.mute")}
          >
  ...
  `}function wr(i){if(i==null||isNaN(i))return"0:00";const e=Math.floor(i/60),t=Math.floor(i%60);return`${e}:${t<10?"0":""}${t}`}function di({progress:i,seekEnabled:e,onSeek:t,collapsed:a,accent:r,height:s=6,style:n="",displayTimestamps:o=!1,currentTime:l=0,duration:c=0}){const h=r||"var(--custom-accent, #ff9800)";return a?_`
      <div
    ...
    <div class="progress-bar-container" style="${n}">
      ...
      ${o?_`
        <div class="timestamps-container">
           <span>${wr(l)}</span>
           <span>-${wr(Math.max(0,c-l))}</span>
        </div>
      `:y}
    </div>
  `}const z=Object.freeze({MEDIA_BACKGROUND:0,MEDIA_OVERLAY:0,FLOATING_ELEMENT:1,STICKY_CHIPS:1,ACCENT_FOREGROUND:1,FLOATING_CONTROLS:1,OVERLAY_BASE:2,MODAL_BACKDROP:2,MODAL_TOAST:2,SEARCH_SLIDE_OUT:1,SEARCH_SUCCESS:1}),kr=Ft`
  --card-bg: #fff;
  --primary-text: #222;
  --secondary-text: #666;
...
`,jo=[{mode:"replace",icon:"mdi:playlist-remove",label:u("search.replace")},{mode:"next",icon:"mdi:playlist-play",label:u("search.play_next")},{mode:"replace_next",icon:"mdi:playlist-music",label:u("search.replace_play")},{mode:"add",icon:"mdi:playlist-plus",label:u("search.add_queue")},{mode:"add_to_playlist",icon:"mdi:plus",label:u("search.add_to_playlist")}],Rt=["artist","album","track","playlist","radio","podcast","audiobook"];function Ar(i){return i&&(i.media_class==="track"||i.media_content_type==="track")}function Sr(i){return i&&(i.media_class==="radio"||i.media_content_type==="radio")}const Ue=(i,{cap:e,floor:t}={})=>{const a=Number(i);if(!Number.isFinite(a)||a<=0)return;let r=a;return typeof t=="number"&&(r=Math.max(t,r)),typeof e=="number"&&(r=Math.min(e,r)),r},$r=3e4;let zt=null,ea=0;async function ui(i){const e=Date.now();if(zt&&e-ea<$r)return zt;try{return zt=(await i.callApi("GET","config/config_entries/entry")).find(t=>t.domain==="music_assistant"&&t.state==="loaded")?.entry_id||null,ea=e,zt}catch(t){return console.error("yamp: Failed to resolve Music Assistant config entry",t),zt=null,ea=e,null}}let Lt=null,ta=0;async function ia(i){const e=Date.now();if(Lt&&e-ta<$r)return Lt;try{return Lt=(await i.callApi("GET","config/config_entries/entry")).find(t=>t.domain==="mass_queue"&&t.state==="loaded")?.entry_id||null,ta=e,Lt}catch(t){return console.error("yamp: Failed to resolve mass_queue config entry",t),Lt=null,ta=e,null}}function pt(i){return i?{title:i.name,media_content_id:i.uri,media_content_type:i.media_type,media_class:i.media_type,item_id:i.item_id,thumbnail:i.image,...i.artists&&{artist:i.artists.map(e=>e.name).join(", ")},...i.album&&{album:i.album.name,album_uri:i.album.uri},is_browsable:i.media_type==="artist"||i.media_type==="album"||i.media_type==="playlist"||i.media_type==="track",is_editable:i.is_editable===!0}:null}function Ir({item:i,onPlay:e,onOptionsToggle:t,upcomingFilterActive:a=!1,isMusicAssistant:r=!1,massQueueAvailable:s=!1,searchView:n="list",isInline:o=!1,onMoveUp:l,onMoveDown:c,onMoveNext:h,onRemove:d,minimal:p=!1,hideActions:m=!1}){if(m)return y;const f=!!(a&&i.queue_item_id&&r&&s),v=o?"entity-options-search-buttons":n==="card"?"card-overlay-buttons":"search-sheet-buttons",g=o?"entity-options-search-play":n==="card"?"search-sheet-play icon-only":"search-sheet-play",w=o?"entity-options-search-queue":n==="card"?"search-sheet-queue icon-only":"search-sheet-queue";return _`
    <div class="${v}">
      ${f&&o?_`
  ...
  `}function Do({item:i,activeSearchRowMenuId:e,onPlayOption:t,onOptionsToggle:a,searchView:r="list",isQueueItem:s=!1,massQueueAvailable:n=!1,onMoveUp:o,onMoveDown:l,onMoveNext:c,onRemove:h,hideActions:d=!1}){if(d)return y;const p=e!=null&&i.media_content_id!=null&&e===i.media_content_id;return _`
    <div class="search-row-slide-out ${p?"active":""}">
      ...
      `:_`
        <button class="slide-out-button" @click=${()=>t(i,"replace")} title="${u("search.labels.replace")}">
          ${r==="card"?y:_`<ha-icon icon="mdi:playlist-remove"></ha-icon>`}${u("search.labels.replace")}
        </button>
        <button class="slide-out-button" @click=${()=>t(i,"next")} title="${u("search.labels.next")}">
          ${r==="card"?y:_`<ha-icon icon="mdi:playlist-play"></ha-icon>`}${u("search.labels.next")}
        </button>
        <button class="slide-out-button" @click=${()=>t(i,"replace_next")} title="${u("search.labels.replace_next")}">
          ${r==="card"?y:_`<ha-icon icon="mdi:playlist-music"></ha-icon>`}${u("search.labels.replace_next")}
        </button>
        <button class="slide-out-button" @click=${()=>t(i,"add")} title="${u("search.labels.add")}">
          ${r==="card"?y:_`<ha-icon icon="mdi:playlist-plus"></ha-icon>`}${u("search.labels.add")}
        </button>
        ${Ar(i)&&n?_`
          <button class="slide-out-button" @click=${()=>t(i,"add_to_playlist")} title="${u("search.labels.add_to_playlist")}">
            ${r==="card"?y:_`<ha-icon icon="mdi:plus"></ha-icon>`}${u("search.labels.add_to_playlist")}
          </button>
        `:y}
      `}
  ...
  `}function Oo({item:i,onClose:e,onPlayOption:t,massQueueAvailable:a=!1}){return i?_`
    <div class="entity-options-overlay entity-options-overlay-opening" @click=${e}>
      <div class="entity-options-container entity-options-sheet-opening" @click=${r=>r.stopPropagation()}>
        <div class="entity-options-sheet">
          ...
          ${jo.filter(r=>r.mode==="add_to_playlist"?Ar(i)&&a:!0).map(r=>_`
  ...
  `:y}async function Cr(i,e,t,a=null,r={},s=20){const n=await ui(i);if(n)try{if(r.favorites){const d=a&&a!=="all"?[a]:Rt,p=[];return await Promise.all(d.map(async m=>{try{const f={type:"call_service",domain:"music_assistant",service:"get_library",service_data:{config_entry_id:n,media_type:m,favorite:!0,search:t},return_response:!0},v=Ue(s);v!==void 0&&(f.service_data.limit=v),r.orderBy&&r.orderBy!=="default"&&(f.service_data.order_by=r.orderBy),((await i.connection.sendMessagePromise(f))?.response?.items||[]).forEach(g=>{const w=pt(g);w&&p.push(w)})}catch(f){console.error("yamp: Error searching favorites for type",m,f)}})),{results:p,usedMusicAssistant:!0}}if((!t||t.trim()==="")&&a&&a!=="all"&&!r.favorites){if(!Rt.includes(a))return console.warn(`yamp: Unsupported media type for browsing: ${a}. Skipping get_library call.`),{results:[],usedMusicAssistant:!0};try{const d={type:"call_service",domain:"music_assistant",service:"get_library",service_data:{config_entry_id:n,media_type:a},return_response:!0},p=Ue(s);p!==void 0&&(d.service_data.limit=p),r.orderBy&&r.orderBy!=="default"&&(d.service_data.order_by=r.orderBy);const m=(await i.connection.sendMessagePromise(d))?.response?.items||[],f=[];return m.forEach(v=>{const g=pt(v);g&&f.push(g)}),{results:f,usedMusicAssistant:!0}}catch(d){return console.error("yamp: Error browsing library for type",a,d),{results:[],usedMusicAssistant:!0}}}const o={name:t,config_entry_id:n},l=Ue(s,{cap:a==="all"?8:void 0});l!==void 0&&(o.limit=l),a&&a!=="all"&&(o.media_type=a),r.artist&&(o.artist=r.artist),r.album&&(o.album=r.album);const c={type:"call_service",domain:"music_assistant",service:"search",service_data:o,return_response:!0},h=(await i.connection.sendMessagePromise(c))?.response;if(h){const d=[];return Object.entries(h).forEach(([p,m])=>{Array.isArray(m)&&m.forEach(f=>{const v=pt(f);v&&d.push(v)})}),{results:d,usedMusicAssistant:!0}}}catch(o){console.error("yamp: Error in searchMedia:",o)}return{results:await zo(i,e,t,a,r),usedMusicAssistant:!1}}async function Ro(i,e,t=null,a=20,r={}){const s=await ui(i);if(!s)return{results:[],usedMusicAssistant:!1};const n=typeof r.onChunk=="function"?r.onChunk:null,o=async(l,c={})=>{const h={type:"call_service",domain:"music_assistant",service:"get_library",service_data:{config_entry_id:s,media_type:l,order_by:"last_played_desc"},return_response:!0},d=Ue(a,c);return d!==void 0&&(h.service_data.limit=d),((await i.connection.sendMessagePromise(h))?.response?.items||[]).map(pt).filter(Boolean)};try{if(t==="all"){const c=[];return await Promise.all(Rt.map(async h=>{const d=await o(h,{cap:5});d.length&&(c.push(...d),n&&n(d,h))})),{results:c,usedMusicAssistant:!0}}const l=await o(t||"track");return l.length&&n&&n(l,t||"track"),{results:l,usedMusicAssistant:!0}}catch(l){return console.error("yamp: Error getting recently played from Music Assistant:",l),{results:[],usedMusicAssistant:!1}}}async function Tr(i,e,t=null,a=20,r={}){const s=await ui(i);if(!s)return{results:[],usedMusicAssistant:!1};const n=typeof r.onChunk=="function"?r.onChunk:null,o=async l=>{const c={type:"call_service",domain:"music_assistant",service:"get_library",service_data:{config_entry_id:s,media_type:l,favorite:!0},return_response:!0},h=Ue(a,{cap:l==="all"?8:void 0});h!==void 0&&(c.service_data.limit=h),r.orderBy&&r.orderBy!=="default"&&(c.service_data.order_by=r.orderBy);try{return((await i.connection.sendMessagePromise(c))?.response?.items||[]).map(pt).filter(Boolean)}catch(d){return console.error("yamp: Error loading favorites for type",l,d),[]}};try{if(t&&t!=="all"){const c=await o(t);return c.length&&n&&n(c,t),{results:c,usedMusicAssistant:!0}}const l=[];return await Promise.all(Rt.map(async c=>{const h=await o(c);h.length&&(l.push(...h),n&&n(h,c))})),{results:l,usedMusicAssistant:!0}}catch(l){return console.error("yamp: Error loading favorites",l),{results:[],usedMusicAssistant:!1}}}async function zo(i,e,t,a,r={}){const s={entity_id:e,search_query:t};a&&a!=="all"&&(s.media_content_type=a);const n={type:"call_service",domain:"media_player",service:"search_media",service_data:s,return_response:!0},o=await i.connection.sendMessagePromise(n);return o?.response?.[e]?.result||o?.result||[]}function Lo(i,e,t){return i.callService("media_player","play_media",{entity_id:e,media_content_type:t.media_content_type,media_content_id:t.media_content_id})}async function No(i,e,t=null,a=null,r=null,s=100){if(!e)return!1;try{const n=await ui(i);if(!n)return!1;let o=t;if(!o){const l=Object.values(i.states).find(c=>ht(c)&&c.entity_id.startsWith("media_player."));if(l)o=l.entity_id;else return!1}if(a||r){try{const l={name:a||r,config_entry_id:n,media_type:"track"},c=Ue(s);c!==void 0&&(l.limit=c),r&&(l.artist=r);const h={type:"call_service",domain:"music_assistant",service:"search",service_data:l,return_response:!0},d=(await i.connection.sendMessagePromise(h))?.response;let p=[];if(Array.isArray(d)?p=d:d&&typeof d=="object"&&Object.values(d).forEach(m=>{Array.isArray(m)&&p.push(...m)}),p.length){const m=(e.split("/").pop()||"").trim(),f=p.find(w=>w?.uri===e),v=!f&&/^\d+$/.test(m)?p.find(w=>typeof w?.uri=="string"&&w.uri.endsWith(`/${m}`)):null,g=f||v||null;if(g&&typeof g.favorite=="boolean")return!!g.favorite}}catch{}if(a)try{const l={type:"call_service",domain:"music_assistant",service:"get_library",service_data:{config_entry_id:n,media_type:"track",favorite:!0,search:a.trim()},return_response:!0},c=Ue(s);if(c!==void 0&&(l.service_data.limit=c),((await i.connection.sendMessagePromise(l))?.response?.items||[]).some(h=>h.uri===e))return!0}catch{}}try{const l={type:"call_service",domain:"music_assistant",service:"get_library",service_data:{config_entry_id:n,media_type:"track",favorite:!0},return_response:!0},c=Ue(s,{floor:100});return c!==void 0&&(l.service_data.limit=c),((await i.connection.sendMessagePromise(l))?.response?.items||[]).some(h=>h.uri===e)}catch{}return!1}catch{return!1}}/*! js-yaml 4.1.1 https://github.com/nodeca/js-yaml @license MIT */function Mr(i){return typeof i>"u"||i===null}function qo(i){return typeof i=="object"&&i!==null}function Uo(i){return Array.isArray(i)?i:Mr(i)?[]:[i]}function Bo(i,e){var t,a,r,s;if(e)for(s=Object.keys(e),t=0,a=s.length;t<a;t+=1)r=s[t],i[r]=e[r];return i}function Ho(i,e){var t="",a;for(a=0;a<e;a+=1)t+=i;return t}function Go(i){return i===0&&Number.NEGATIVE_INFINITY===1/i}var Vo=Mr,Qo=qo,Wo=Uo,Yo=Ho,Zo=Go,Ko=Bo,ee={isNothing:Vo,isObject:Qo,toArray:Wo,repeat:Yo,isNegativeZero:Zo,extend:Ko};function Fr(i,e){var t="",a=i.reason||"(unknown reason)";return i.mark?(i.mark.name&&(t+='in "'+i.mark.name+'" '),t+="("+(i.mark.line+1)+":"+(i.mark.column+1)+")",!e&&i.mark.snippet&&(t+=`

`+i.mark.snippet),a+" "+t):a}function Nt(i,e){Error.call(this),this.name="YAMLException",this.reason=i,this.mark=e,this.message=Fr(this,!1),Error.captureStackTrace?Error.captureStackTrace(this,this.constructor):this.stack=new Error().stack||""}Nt.prototype=Object.create(Error.prototype),Nt.prototype.constructor=Nt,Nt.prototype.toString=function(e){return this.name+": "+Fr(this,e)};var he=Nt;function aa(i,e,t,a,r){var s="",n="",o=Math.floor(r/2)-1;return a-e>o&&(s=" ... ",e=a-o+s.length),t-a>o&&(n=" ...",t=a+o-n.length),{str:s+i.slice(e,t).replace(/\t/g,"\u2192")+n,pos:a-e+s.length}}function ra(i,e){return ee.repeat(" ",e-i.length)+i}function Xo(i,e){if(e=Object.create(e||null),!i.buffer)return null;e.maxLength||(e.maxLength=79),typeof e.indent!="number"&&(e.indent=1),typeof e.linesBefore!="number"&&(e.linesBefore=3),typeof e.linesAfter!="number"&&(e.linesAfter=2);for(var t=/\r?\n|\r|\0/g,a=[0],r=[],s,n=-1;s=t.exec(i.buffer);)r.push(s.index),a.push(s.index+s[0].length),i.position<=s.index&&n<0&&(n=a.length-2);n<0&&(n=a.length-1);var o="",l,c,h=Math.min(i.line+e.linesAfter,r.length).toString().length,d=e.maxLength-(e.indent+h+3);for(l=1;l<=e.linesBefore&&!(n-l<0);l++)c=aa(i.buffer,a[n-l],r[n-l],i.position-(a[n]-a[n-l]),d),o=ee.repeat(" ",e.indent)+ra((i.line-l+1).toString(),h)+" | "+c.str+`
`+o;for(c=aa(i.buffer,a[n],r[n],i.position,d),o+=ee.repeat(" ",e.indent)+ra((i.line+1).toString(),h)+" | "+c.str+`
`,o+=ee.repeat("-",e.indent+h+3+c.pos)+`^
`,l=1;l<=e.linesAfter&&!(n+l>=r.length);l++)c=aa(i.buffer,a[n+l],r[n+l],i.position-(a[n]-a[n+l]),d),o+=ee.repeat(" ",e.indent)+ra((i.line+l+1).toString(),h)+" | "+c.str+`
`;return o.replace(/\n$/,"")}var Jo=Xo,el=["kind","multi","resolve","construct","instanceOf","predicate","represent","representName","defaultStyle","styleAliases"],tl=["scalar","sequence","mapping"];function il(i){var e={};return i!==null&&Object.keys(i).forEach(function(t){i[t].forEach(function(a){e[String(a)]=t})}),e}function al(i,e){if(e=e||{},Object.keys(e).forEach(function(t){if(el.indexOf(t)===-1)throw new he('Unknown option "'+t+'" is met in definition of "'+i+'" YAML type.')}),this.options=e,this.tag=i,this.kind=e.kind||null,this.resolve=e.resolve||function(){return!0},this.construct=e.construct||function(t){return t},this.instanceOf=e.instanceOf||null,this.predicate=e.predicate||null,this.represent=e.represent||null,this.representName=e.representName||null,this.defaultStyle=e.defaultStyle||null,this.multi=e.multi||!1,this.styleAliases=il(e.styleAliases||null),tl.indexOf(this.kind)===-1)throw new he('Unknown kind "'+this.kind+'" is specified for "'+i+'" YAML type.')}var re=al;function Pr(i,e){var t=[];return i[e].forEach(function(a){var r=t.length;t.forEach(function(s,n){s.tag===a.tag&&s.kind===a.kind&&s.multi===a.multi&&(r=n)}),t[r]=a}),t}function rl(){var i={scalar:{},sequence:{},mapping:{},fallback:{},multi:{scalar:[],sequence:[],mapping:[],fallback:[]}},e,t;function a(r){r.multi?(i.multi[r.kind].push(r),i.multi.fallback.push(r)):i[r.kind][r.tag]=i.fallback[r.tag]=r}for(e=0,t=arguments.length;e<t;e+=1)arguments[e].forEach(a);return i}function sa(i){return this.extend(i)}sa.prototype.extend=function(e){var t=[],a=[];if(e instanceof re)a.push(e);else if(Array.isArray(e))a=a.concat(e);else if(e&&(Array.isArray(e.implicit)||Array.isArray(e.explicit)))e.implicit&&(t=t.concat(e.implicit)),e.explicit&&(a=a.concat(e.explicit));else throw new he("Schema.extend argument should be a Type, [ Type ], or a schema definition ({ implicit: [...], explicit: [...] })");t.forEach(function(s){if(!(s instanceof re))throw new he("Specified list of YAML types (or a single Type object) contains a non-Type object.");if(s.loadKind&&s.loadKind!=="scalar")throw new he("There is a non-scalar type in the implicit list of a schema. Implicit resolving of such types is not supported.");if(s.multi)throw new he("There is a multi type in the implicit list of a schema. Multi tags can only be listed as explicit.")}),a.forEach(function(s){if(!(s instanceof re))throw new he("Specified list of YAML types (or a single Type object) contains a non-Type object.")});var r=Object.create(sa.prototype);return r.implicit=(this.implicit||[]).concat(t),r.explicit=(this.explicit||[]).concat(a),r.compiledImplicit=Pr(r,"implicit"),r.compiledExplicit=Pr(r,"explicit"),r.compiledTypeMap=rl(r.compiledImplicit,r.compiledExplicit),r};var jr=sa,Dr=new re("tag:yaml.org,2002:str",{kind:"scalar",construct:function(i){return i!==null?i:""}}),Or=new re("tag:yaml.org,2002:seq",{kind:"sequence",construct:function(i){return i!==null?i:[]}}),Rr=new re("tag:yaml.org,2002:map",{kind:"mapping",construct:function(i){return i!==null?i:{}}}),zr=new jr({explicit:[Dr,Or,Rr]});function sl(i){if(i===null)return!0;var e=i.length;return e===1&&i==="~"||e===4&&(i==="null"||i==="Null"||i==="NULL")}function nl(){return null}function ol(i){return i===null}var Lr=new re("tag:yaml.org,2002:null",{kind:"scalar",resolve:sl,construct:nl,predicate:ol,represent:{canonical:function(){return"~"},lowercase:function(){return"null"},uppercase:function(){return"NULL"},camelcase:function(){return"Null"},empty:function(){return""}},defaultStyle:"lowercase"});function ll(i){if(i===null)return!1;var e=i.length;return e===4&&(i==="true"||i==="True"||i==="TRUE")||e===5&&(i==="false"||i==="False"||i==="FALSE")}function cl(i){return i==="true"||i==="True"||i==="TRUE"}function dl(i){return Object.prototype.toString.call(i)==="[object Boolean]"}var Nr=new re("tag:yaml.org,2002:bool",{kind:"scalar",resolve:ll,construct:cl,predicate:dl,represent:{lowercase:function(i){return i?"true":"false"},uppercase:function(i){return i?"TRUE":"FALSE"},camelcase:function(i){return i?"True":"False"}},defaultStyle:"lowercase"});function ul(i){return 48<=i&&i<=57||65<=i&&i<=70||97<=i&&i<=102}function hl(i){return 48<=i&&i<=55}function pl(i){return 48<=i&&i<=57}function _l(i){if(i===null)return!1;var e=i.length,t=0,a=!1,r;if(!e)return!1;if(r=i[t],(r==="-"||r==="+")&&(r=i[++t]),r==="0"){if(t+1===e)return!0;if(r=i[++t],r==="b"){for(t++;t<e;t++)if(r=i[t],r!=="_"){if(r!=="0"&&r!=="1")return!1;a=!0}return a&&r!=="_"}if(r==="x"){for(t++;t<e;t++)if(r=i[t],r!=="_"){if(!ul(i.charCodeAt(t)))return!1;a=!0}return a&&r!=="_"}if(r==="o"){for(t++;t<e;t++)if(r=i[t],r!=="_"){if(!hl(i.charCodeAt(t)))return!1;a=!0}return a&&r!=="_"}}if(r==="_")return!1;for(;t<e;t++)if(r=i[t],r!=="_"){if(!pl(i.charCodeAt(t)))return!1;a=!0}return!(!a||r==="_")}function ml(i){var e=i,t=1,a;if(e.indexOf("_")!==-1&&(e=e.replace(/_/g,"")),a=e[0],(a==="-"||a==="+")&&(a==="-"&&(t=-1),e=e.slice(1),a=e[0]),e==="0")return 0;if(a==="0"){if(e[1]==="b")return t*parseInt(e.slice(2),2);if(e[1]==="x")return t*parseInt(e.slice(2),16);if(e[1]==="o")return t*parseInt(e.slice(2),8)}return t*parseInt(e,10)}function fl(i){return Object.prototype.toString.call(i)==="[object Number]"&&i%1===0&&!ee.isNegativeZero(i)}var qr=new re("tag:yaml.org,2002:int",{kind:"scalar",resolve:_l,construct:ml,predicate:fl,represent:{binary:function(i){return i>=0?"0b"+i.toString(2):"-0b"+i.toString(2).slice(1)},octal:function(i){return i>=0?"0o"+i.toString(8):"-0o"+i.toString(8).slice(1)},decimal:function(i){return i.toString(10)},hexadecimal:function(i){return i>=0?"0x"+i.toString(16).toUpperCase():"-0x"+i.toString(16).toUpperCase().slice(1)}},defaultStyle:"decimal",styleAliases:{binary:[2,"bin"],octal:[8,"oct"],decimal:[10,"dec"],hexadecimal:[16,"hex"]}}),vl=new RegExp("^(?:[-+]?(?:[0-9][0-9_]*)(?:\\.[0-9_]*)?(?:[eE][-+]?[0-9]+)?|\\.[0-9_]+(?:[eE][-+]?[0-9]+)?|[-+]?\\.(?:inf|Inf|INF)|\\.(?:nan|NaN|NAN))$");function yl(i){return!(i===null||!vl.test(i)||i[i.length-1]==="_")}function gl(i){var e,t;return e=i.replace(/_/g,"").toLowerCase(),t=e[0]==="-"?-1:1,"+-".indexOf(e[0])>=0&&(e=e.slice(1)),e===".inf"?t===1?Number.POSITIVE_INFINITY:Number.NEGATIVE_INFINITY:e===".nan"?NaN:t*parseFloat(e,10)}var bl=/^[-+]?[0-9]+e/;function xl(i,e){var t;if(isNaN(i))switch(e){case"lowercase":return".nan";case"uppercase":return".NAN";case"camelcase":return".NaN"}else if(Number.POSITIVE_INFINITY===i)switch(e){case"lowercase":return".inf";case"uppercase":return".INF";case"camelcase":return".Inf"}else if(Number.NEGATIVE_INFINITY===i)switch(e){case"lowercase":return"-.inf";case"uppercase":return"-.INF";case"camelcase":return"-.Inf"}else if(ee.isNegativeZero(i))return"-0.0";return t=i.toString(10),bl.test(t)?t.replace("e",".e"):t}function wl(i){return Object.prototype.toString.call(i)==="[object Number]"&&(i%1!==0||ee.isNegativeZero(i))}var Ur=new re("tag:yaml.org,2002:float",{kind:"scalar",resolve:yl,construct:gl,predicate:wl,represent:xl,defaultStyle:"lowercase"}),Br=zr.extend({implicit:[Lr,Nr,qr,Ur]}),Hr=Br,Gr=new RegExp("^([0-9][0-9][0-9][0-9])-([0-9][0-9])-([0-9][0-9])$"),Vr=new RegExp("^([0-9][0-9][0-9][0-9])-([0-9][0-9]?)-([0-9][0-9]?)(?:[Tt]|[ \\t]+)([0-9][0-9]?):([0-9][0-9]):([0-9][0-9])(?:\\.([0-9]*))?(?:[ \\t]*(Z|([-+])([0-9][0-9]?)(?::([0-9][0-9]))?))?$");function kl(i){return i===null?!1:Gr.exec(i)!==null||Vr.exec(i)!==null}function El(i){var e,t,a,r,s,n,o,l=0,c=null,h,d,p;if(e=Gr.exec(i),e===null&&(e=Vr.exec(i)),e===null)throw new Error("Date resolve error");if(t=+e[1],a=+e[2]-1,r=+e[3],!e[4])return new Date(Date.UTC(t,a,r));if(s=+e[4],n=+e[5],o=+e[6],e[7]){for(l=e[7].slice(0,3);l.length<3;)l+="0";l=+l}return e[9]&&(h=+e[10],d=+(e[11]||0),c=(h*60+d)*6e4,e[9]==="-"&&(c=-c)),p=new Date(Date.UTC(t,a,r,s,n,o,l)),c&&p.setTime(p.getTime()-c),p}function Al(i){return i.toISOString()}var Qr=new re("tag:yaml.org,2002:timestamp",{kind:"scalar",resolve:kl,construct:El,instanceOf:Date,represent:Al});function Sl(i){return i==="<<"||i===null}var Wr=new re("tag:yaml.org,2002:merge",{kind:"scalar",resolve:Sl}),na=`ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=
\r`;function $l(i){if(i===null)return!1;var e,t,a=0,r=i.length,s=na;for(t=0;t<r;t++)if(e=s.indexOf(i.charAt(t)),!(e>64)){if(e<0)return!1;a+=6}return a%8===0}function Il(i){var e,t,a=i.replace(/[\r\n=]/g,""),r=a.length,s=na,n=0,o=[];for(e=0;e<r;e++)e%4===0&&e&&(o.push(n>>16&255),o.push(n>>8&255),o.push(n&255)),n=n<<6|s.indexOf(a.charAt(e));return t=r%4*6,t===0?(o.push(n>>16&255),o.push(n>>8&255),o.push(n&255)):t===18?(o.push(n>>10&255),o.push(n>>2&255)):t===12&&o.push(n>>4&255),new Uint8Array(o)}function Cl(i){var e="",t=0,a,r,s=i.length,n=na;for(a=0;a<s;a++)a%3===0&&a&&(e+=n[t>>18&63],e+=n[t>>12&63],e+=n[t>>6&63],e+=n[t&63]),t=(t<<8)+i[a];return r=s%3,r===0?(e+=n[t>>18&63],e+=n[t>>12&63],e+=n[t>>6&63],e+=n[t&63]):r===2?(e+=n[t>>10&63],e+=n[t>>4&63],e+=n[t<<2&63],e+=n[64]):r===1&&(e+=n[t>>2&63],e+=n[t<<4&63],e+=n[64],e+=n[64]),e}function Tl(i){return Object.prototype.toString.call(i)==="[object Uint8Array]"}var Yr=new re("tag:yaml.org,2002:binary",{kind:"scalar",resolve:$l,construct:Il,predicate:Tl,represent:Cl}),Ml=Object.prototype.hasOwnProperty,Fl=Object.prototype.toString;function Pl(i){if(i===null)return!0;var e=[],t,a,r,s,n,o=i;for(t=0,a=o.length;t<a;t+=1){if(r=o[t],n=!1,Fl.call(r)!=="[object Object]")return!1;for(s in r)if(Ml.call(r,s))if(!n)n=!0;else return!1;if(!n)return!1;if(e.indexOf(s)===-1)e.push(s);else return!1}return!0}function jl(i){return i!==null?i:[]}var Zr=new re("tag:yaml.org,2002:omap",{kind:"sequence",resolve:Pl,construct:jl}),Dl=Object.prototype.toString;function Ol(i){if(i===null)return!0;var e,t,a,r,s,n=i;for(s=new Array(n.length),e=0,t=n.length;e<t;e+=1){if(a=n[e],Dl.call(a)!=="[object Object]"||(r=Object.keys(a),r.length!==1))return!1;s[e]=[r[0],a[r[0]]]}return!0}function Rl(i){if(i===null)return[];var e,t,a,r,s,n=i;for(s=new Array(n.length),e=0,t=n.length;e<t;e+=1)a=n[e],r=Object.keys(a),s[e]=[r[0],a[r[0]]];return s}var Kr=new re("tag:yaml.org,2002:pairs",{kind:"sequence",resolve:Ol,construct:Rl}),zl=Object.prototype.hasOwnProperty;function Ll(i){if(i===null)return!0;var e,t=i;for(e in t)if(zl.call(t,e)&&t[e]!==null)return!1;return!0}function Nl(i){return i!==null?i:{}}var Xr=new re("tag:yaml.org,2002:set",{kind:"mapping",resolve:Ll,construct:Nl}),oa=Hr.extend({implicit:[Qr,Wr],explicit:[Yr,Zr,Kr,Xr]}),Be=Object.prototype.hasOwnProperty,hi=1,Jr=2,es=3,pi=4,la=1,ql=2,ts=3,Ul=/[\x00-\x08\x0B\x0C\x0E-\x1F\x7F-\x84\x86-\x9F\uFFFE\uFFFF]|[\uD800-\uDBFF](?![\uDC00-\uDFFF])|(?:[^\uD800-\uDBFF]|^)[\uDC00-\uDFFF]/,Bl=/[\x85\u2028\u2029]/,Hl=/[,\[\]\{\}]/,is=/^(?:!|!!|![a-z\-]+!)$/i,as=/^(?:!|[^,\[\]\{\}])(?:%[0-9a-f]{2}|[0-9a-z\-#;\/\?:@&=\+\$,_\.!~\*'\(\)\[\]])*$/i;function rs(i){return Object.prototype.toString.call(i)}function Ie(i){return i===10||i===13}function st(i){return i===9||i===32}function fe(i){return i===9||i===32||i===10||i===13}function _t(i){return i===44||i===91||i===93||i===123||i===125}function Gl(i){var e;return 48<=i&&i<=57?i-48:(e=i|32,97<=e&&e<=102?e-97+10:-1)}function Vl(i){return i===120?2:i===117?4:i===85?8:0}function Ql(i){return 48<=i&&i<=57?i-48:-1}function ss(i){return i===48?"\0":i===97?"\x07":i===98?"\b":i===116||i===9?"	":i===110?`
`:i===118?"\v":i===102?"\f":i===114?"\r":i===101?"\x1B":i===32?" ":i===34?'"':i===47?"/":i===92?"\\":i===78?"\x85":i===95?"\xA0":i===76?"\u2028":i===80?"\u2029":""}function Wl(i){return i<=65535?String.fromCharCode(i):String.fromCharCode((i-65536>>10)+55296,(i-65536&1023)+56320)}function ns(i,e,t){e==="__proto__"?Object.defineProperty(i,e,{configurable:!0,enumerable:!0,writable:!0,value:t}):i[e]=t}for(var os=new Array(256),ls=new Array(256),mt=0;mt<256;mt++)os[mt]=ss(mt)?1:0,ls[mt]=ss(mt);function Yl(i,e){this.input=i,this.filename=e.filename||null,this.schema=e.schema||oa,this.onWarning=e.onWarning||null,this.legacy=e.legacy||!1,this.json=e.json||!1,this.listener=e.listener||null,this.implicitTypes=this.schema.compiledImplicit,this.typeMap=this.schema.compiledTypeMap,this.length=i.length,this.position=0,this.line=0,this.lineStart=0,this.lineIndent=0,this.firstTabInLine=-1,this.documents=[]}function cs(i,e){var t={name:i.filename,buffer:i.input.slice(0,-1),position:i.position,line:i.line,column:i.position-i.lineStart};return t.snippet=Jo(t),new he(e,t)}function A(i,e){throw cs(i,e)}function _i(i,e){i.onWarning&&i.onWarning.call(null,cs(i,e))}var ds={YAML:function(e,t,a){var r,s,n;e.version!==null&&A(e,"duplication of %YAML directive"),a.length!==1&&A(e,"YAML directive accepts exactly one argument"),r=/^([0-9]+)\.([0-9]+)$/.exec(a[0]),r===null&&A(e,"ill-formed argument of the YAML directive"),s=parseInt(r[1],10),n=parseInt(r[2],10),s!==1&&A(e,"unacceptable YAML version of the document"),e.version=a[0],e.checkLineBreaks=n<2,n!==1&&n!==2&&_i(e,"unsupported YAML version of the document")},TAG:function(e,t,a){var r,s;a.length!==2&&A(e,"TAG directive accepts exactly two arguments"),r=a[0],s=a[1],is.test(r)||A(e,"ill-formed tag handle (first argument) of the TAG directive"),Be.call(e.tagMap,r)&&A(e,'there is a previously declared suffix for "'+r+'" tag handle'),as.test(s)||A(e,"ill-formed tag prefix (second argument) of the TAG directive");try{s=decodeURIComponent(s)}catch{A(e,"tag prefix is malformed: "+s)}e.tagMap[r]=s}};function He(i,e,t,a){var r,s,n,o;if(e<t){if(o=i.input.slice(e,t),a)for(r=0,s=o.length;r<s;r+=1)n=o.charCodeAt(r),n===9||32<=n&&n<=1114111||A(i,"expected valid JSON character");else Ul.test(o)&&A(i,"the stream contains non-printable characters");i.result+=o}}function us(i,e,t,a){var r,s,n,o;for(ee.isObject(t)||A(i,"cannot merge mappings; the provided source object is unacceptable"),r=Object.keys(t),n=0,o=r.length;n<o;n+=1)s=r[n],Be.call(e,s)||(ns(e,s,t[s]),a[s]=!0)}function ft(i,e,t,a,r,s,n,o,l){var c,h;if(Array.isArray(r))for(r=Array.prototype.slice.call(r),c=0,h=r.length;c<h;c+=1)Array.isArray(r[c])&&A(i,"nested arrays are not supported inside keys"),typeof r=="object"&&rs(r[c])==="[object Object]"&&(r[c]="[object Object]");if(typeof r=="object"&&rs(r)==="[object Object]"&&(r="[object Object]"),r=String(r),e===null&&(e={}),a==="tag:yaml.org,2002:merge")if(Array.isArray(s))for(c=0,h=s.length;c<h;c+=1)us(i,e,s[c],t);else us(i,e,s,t);else!i.json&&!Be.call(t,r)&&Be.call(e,r)&&(i.line=n||i.line,i.lineStart=o||i.lineStart,i.position=l||i.position,A(i,"duplicated mapping key")),ns(e,r,s),delete t[r];return e}function ca(i){var e;e=i.input.charCodeAt(i.position),e===10?i.position++:e===13?(i.position++,i.input.charCodeAt(i.position)===10&&i.position++):A(i,"a line break is expected"),i.line+=1,i.lineStart=i.position,i.firstTabInLine=-1}function K(i,e,t){for(var a=0,r=i.input.charCodeAt(i.position);r!==0;){for(;st(r);)r===9&&i.firstTabInLine===-1&&(i.firstTabInLine=i.position),r=i.input.charCodeAt(++i.position);if(e&&r===35)do r=i.input.charCodeAt(++i.position);while(r!==10&&r!==13&&r!==0);if(Ie(r))for(ca(i),r=i.input.charCodeAt(i.position),a++,i.lineIndent=0;r===32;)i.lineIndent++,r=i.input.charCodeAt(++i.position);else break}return t!==-1&&a!==0&&i.lineIndent<t&&_i(i,"deficient indentation"),a}function mi(i){var e=i.position,t;return t=i.input.charCodeAt(e),!!((t===45||t===46)&&t===i.input.charCodeAt(e+1)&&t===i.input.charCodeAt(e+2)&&(e+=3,t=i.input.charCodeAt(e),t===0||fe(t)))}function da(i,e){e===1?i.result+=" ":e>1&&(i.result+=ee.repeat(`
`,e-1))}function Zl(i,e,t){var a,r,s,n,o,l,c,h,d=i.kind,p=i.result,m;if(m=i.input.charCodeAt(i.position),fe(m)||_t(m)||m===35||m===38||m===42||m===33||m===124||m===62||m===39||m===34||m===37||m===64||m===96||(m===63||m===45)&&(r=i.input.charCodeAt(i.position+1),fe(r)||t&&_t(r)))return!1;for(i.kind="scalar",i.result="",s=n=i.position,o=!1;m!==0;){if(m===58){if(r=i.input.charCodeAt(i.position+1),fe(r)||t&&_t(r))break}else if(m===35){if(a=i.input.charCodeAt(i.position-1),fe(a))break}else{if(i.position===i.lineStart&&mi(i)||t&&_t(m))break;if(Ie(m))if(l=i.line,c=i.lineStart,h=i.lineIndent,K(i,!1,-1),i.lineIndent>=e){o=!0,m=i.input.charCodeAt(i.position);continue}else{i.position=n,i.line=l,i.lineStart=c,i.lineIndent=h;break}}o&&(He(i,s,n,!1),da(i,i.line-l),s=n=i.position,o=!1),st(m)||(n=i.position+1),m=i.input.charCodeAt(++i.position)}return He(i,s,n,!1),i.result?!0:(i.kind=d,i.result=p,!1)}function Kl(i,e){var t,a,r;if(t=i.input.charCodeAt(i.position),t!==39)return!1;for(i.kind="scalar",i.result="",i.position++,a=r=i.position;(t=i.input.charCodeAt(i.position))!==0;)if(t===39)if(He(i,a,i.position,!0),t=i.input.charCodeAt(++i.position),t===39)a=i.position,i.position++,r=i.position;else return!0;else Ie(t)?(He(i,a,r,!0),da(i,K(i,!1,e)),a=r=i.position):i.position===i.lineStart&&mi(i)?A(i,"unexpected end of the document within a single quoted scalar"):(i.position++,r=i.position);A(i,"unexpected end of the stream within a single quoted scalar")}function Xl(i,e){var t,a,r,s,n,o;if(o=i.input.charCodeAt(i.position),o!==34)return!1;for(i.kind="scalar",i.result="",i.position++,t=a=i.position;(o=i.input.charCodeAt(i.position))!==0;){if(o===34)return He(i,t,i.position,!0),i.position++,!0;if(o===92){if(He(i,t,i.position,!0),o=i.input.charCodeAt(++i.position),Ie(o))K(i,!1,e);else if(o<256&&os[o])i.result+=ls[o],i.position++;else if((n=Vl(o))>0){for(r=n,s=0;r>0;r--)o=i.input.charCodeAt(++i.position),(n=Gl(o))>=0?s=(s<<4)+n:A(i,"expected hexadecimal character");i.result+=Wl(s),i.position++}else A(i,"unknown escape sequence");t=a=i.position}else Ie(o)?(He(i,t,a,!0),da(i,K(i,!1,e)),t=a=i.position):i.position===i.lineStart&&mi(i)?A(i,"unexpected end of the document within a double quoted scalar"):(i.position++,a=i.position)}A(i,"unexpected end of the stream within a double quoted scalar")}function Jl(i,e){var t=!0,a,r,s,n=i.tag,o,l=i.anchor,c,h,d,p,m,f=Object.create(null),v,g,w,k;if(k=i.input.charCodeAt(i.position),k===91)h=93,m=!1,o=[];else if(k===123)h=125,m=!0,o={};else return!1;for(i.anchor!==null&&(i.anchorMap[i.anchor]=o),k=i.input.charCodeAt(++i.position);k!==0;){if(K(i,!0,e),k=i.input.charCodeAt(i.position),k===h)return i.position++,i.tag=n,i.anchor=l,i.kind=m?"mapping":"sequence",i.result=o,!0;t?k===44&&A(i,"expected the node content, but found ','"):A(i,"missed comma between flow collection entries"),g=v=w=null,d=p=!1,k===63&&(c=i.input.charCodeAt(i.position+1),fe(c)&&(d=p=!0,i.position++,K(i,!0,e))),a=i.line,r=i.lineStart,s=i.position,vt(i,e,hi,!1,!0),g=i.tag,v=i.result,K(i,!0,e),k=i.input.charCodeAt(i.position),(p||i.line===a)&&k===58&&(d=!0,k=i.input.charCodeAt(++i.position),K(i,!0,e),vt(i,e,hi,!1,!0),w=i.result),m?ft(i,o,f,g,v,w,a,r,s):d?o.push(ft(i,null,f,g,v,w,a,r,s)):o.push(v),K(i,!0,e),k=i.input.charCodeAt(i.position),k===44?(t=!0,k=i.input.charCodeAt(++i.position)):t=!1}A(i,"unexpected end of the stream within a flow collection")}function ec(i,e){var t,a,r=la,s=!1,n=!1,o=e,l=0,c=!1,h,d;if(d=i.input.charCodeAt(i.position),d===124)a=!1;else if(d===62)a=!0;else return!1;for(i.kind="scalar",i.result="";d!==0;)if(d=i.input.charCodeAt(++i.position),d===43||d===45)la===r?r=d===43?ts:ql:A(i,"repeat of a chomping mode identifier");else if((h=Ql(d))>=0)h===0?A(i,"bad explicit indentation width of a block scalar; it cannot be less than one"):n?A(i,"repeat of an indentation width identifier"):(o=e+h-1,n=!0);else break;if(st(d)){do d=i.input.charCodeAt(++i.position);while(st(d));if(d===35)do d=i.input.charCodeAt(++i.position);while(!Ie(d)&&d!==0)}for(;d!==0;){for(ca(i),i.lineIndent=0,d=i.input.charCodeAt(i.position);(!n||i.lineIndent<o)&&d===32;)i.lineIndent++,d=i.input.charCodeAt(++i.position);if(!n&&i.lineIndent>o&&(o=i.lineIndent),Ie(d)){l++;continue}if(i.lineIndent<o){r===ts?i.result+=ee.repeat(`
`,s?1+l:l):r===la&&s&&(i.result+=`
`);break}for(a?st(d)?(c=!0,i.result+=ee.repeat(`
`,s?1+l:l)):c?(c=!1,i.result+=ee.repeat(`
`,l+1)):l===0?s&&(i.result+=" "):i.result+=ee.repeat(`
`,l):i.result+=ee.repeat(`
`,s?1+l:l),s=!0,n=!0,l=0,t=i.position;!Ie(d)&&d!==0;)d=i.input.charCodeAt(++i.position);He(i,t,i.position,!1)}return!0}function hs(i,e){var t,a=i.tag,r=i.anchor,s=[],n,o=!1,l;if(i.firstTabInLine!==-1)return!1;for(i.anchor!==null&&(i.anchorMap[i.anchor]=s),l=i.input.charCodeAt(i.position);l!==0&&(i.firstTabInLine!==-1&&(i.position=i.firstTabInLine,A(i,"tab characters must not be used in indentation")),!(l!==45||(n=i.input.charCodeAt(i.position+1),!fe(n))));){if(o=!0,i.position++,K(i,!0,-1)&&i.lineIndent<=e){s.push(null),l=i.input.charCodeAt(i.position);continue}if(t=i.line,vt(i,e,es,!1,!0),s.push(i.result),K(i,!0,-1),l=i.input.charCodeAt(i.position),(i.line===t||i.lineIndent>e)&&l!==0)A(i,"bad indentation of a sequence entry");else if(i.lineIndent<e)break}return o?(i.tag=a,i.anchor=r,i.kind="sequence",i.result=s,!0):!1}function tc(i,e,t){var a,r,s,n,o,l,c=i.tag,h=i.anchor,d={},p=Object.create(null),m=null,f=null,v=null,g=!1,w=!1,k;if(i.firstTabInLine!==-1)return!1;for(i.anchor!==null&&(i.anchorMap[i.anchor]=d),k=i.input.charCodeAt(i.position);k!==0;){if(!g&&i.firstTabInLine!==-1&&(i.position=i.firstTabInLine,A(i,"tab characters must not be used in indentation")),a=i.input.charCodeAt(i.position+1),s=i.line,(k===63||k===58)&&fe(a))k===63?(g&&(ft(i,d,p,m,f,null,n,o,l),m=f=v=null),w=!0,g=!0,r=!0):g?(g=!1,r=!0):A(i,"incomplete explicit mapping pair; a key node is missed; or followed by a non-tabulated empty line"),i.position+=1,k=a;else{if(n=i.line,o=i.lineStart,l=i.position,!vt(i,t,Jr,!1,!0))break;if(i.line===s){for(k=i.input.charCodeAt(i.position);st(k);)k=i.input.charCodeAt(++i.position);if(k===58)k=i.input.charCodeAt(++i.position),fe(k)||A(i,"a whitespace character is expected after the key-value separator within a block mapping"),g&&(ft(i,d,p,m,f,null,n,o,l),m=f=v=null),w=!0,g=!1,r=!1,m=i.tag,f=i.result;else if(w)A(i,"can not read an implicit mapping pair; a colon is missed");else return i.tag=c,i.anchor=h,!0}else if(w)A(i,"can not read a block mapping entry; a multiline key may not be an implicit key");else return i.tag=c,i.anchor=h,!0}if((i.line===s||i.lineIndent>e)&&(g&&(n=i.line,o=i.lineStart,l=i.position),vt(i,e,pi,!0,r)&&(g?f=i.result:v=i.result),g||(ft(i,d,p,m,f,v,n,o,l),m=f=v=null),K(i,!0,-1),k=i.input.charCodeAt(i.position)),(i.line===s||i.lineIndent>e)&&k!==0)A(i,"bad indentation of a mapping entry");else if(i.lineIndent<e)break}return g&&ft(i,d,p,m,f,null,n,o,l),w&&(i.tag=c,i.anchor=h,i.kind="mapping",i.result=d),w}function ic(i){var e,t=!1,a=!1,r,s,n;if(n=i.input.charCodeAt(i.position),n!==33)return!1;if(i.tag!==null&&A(i,"duplication of a tag property"),n=i.input.charCodeAt(++i.position),n===60?(t=!0,n=i.input.charCodeAt(++i.position)):n===33?(a=!0,r="!!",n=i.input.charCodeAt(++i.position)):r="!",e=i.position,t){do n=i.input.charCodeAt(++i.position);while(n!==0&&n!==62);i.position<i.length?(s=i.input.slice(e,i.position),n=i.input.charCodeAt(++i.position)):A(i,"unexpected end of the stream within a verbatim tag")}else{for(;n!==0&&!fe(n);)n===33&&(a?A(i,"tag suffix cannot contain exclamation marks"):(r=i.input.slice(e-1,i.position+1),is.test(r)||A(i,"named tag handle cannot contain such characters"),a=!0,e=i.position+1)),n=i.input.charCodeAt(++i.position);s=i.input.slice(e,i.position),Hl.test(s)&&A(i,"tag suffix cannot contain flow indicator characters")}s&&!as.test(s)&&A(i,"tag name cannot contain such characters: "+s);try{s=decodeURIComponent(s)}catch{A(i,"tag name is malformed: "+s)}return t?i.tag=s:Be.call(i.tagMap,r)?i.tag=i.tagMap[r]+s:r==="!"?i.tag="!"+s:r==="!!"?i.tag="tag:yaml.org,2002:"+s:A(i,'undeclared tag handle "'+r+'"'),!0}function ac(i){var e,t;if(t=i.input.charCodeAt(i.position),t!==38)return!1;for(i.anchor!==null&&A(i,"duplication of an anchor property"),t=i.input.charCodeAt(++i.position),e=i.position;t!==0&&!fe(t)&&!_t(t);)t=i.input.charCodeAt(++i.position);return i.position===e&&A(i,"name of an anchor node must contain at least one character"),i.anchor=i.input.slice(e,i.position),!0}function rc(i){var e,t,a;if(a=i.input.charCodeAt(i.position),a!==42)return!1;for(a=i.input.charCodeAt(++i.position),e=i.position;a!==0&&!fe(a)&&!_t(a);)a=i.input.charCodeAt(++i.position);return i.position===e&&A(i,"name of an alias node must contain at least one character"),t=i.input.slice(e,i.position),Be.call(i.anchorMap,t)||A(i,'unidentified alias "'+t+'"'),i.result=i.anchorMap[t],K(i,!0,-1),!0}function vt(i,e,t,a,r){var s,n,o,l=1,c=!1,h=!1,d,p,m,f,v,g;if(i.listener!==null&&i.listener("open",i),i.tag=null,i.anchor=null,i.kind=null,i.result=null,s=n=o=pi===t||es===t,a&&K(i,!0,-1)&&(c=!0,i.lineIndent>e?l=1:i.lineIndent===e?l=0:i.lineIndent<e&&(l=-1)),l===1)for(;ic(i)||ac(i);)K(i,!0,-1)?(c=!0,o=s,i.lineIndent>e?l=1:i.lineIndent===e?l=0:i.lineIndent<e&&(l=-1)):o=!1;if(o&&(o=c||r),(l===1||pi===t)&&(hi===t||Jr===t?v=e:v=e+1,g=i.position-i.lineStart,l===1?o&&(hs(i,g)||tc(i,g,v))||Jl(i,v)?h=!0:(n&&ec(i,v)||Kl(i,v)||Xl(i,v)?h=!0:rc(i)?(h=!0,(i.tag!==null||i.anchor!==null)&&A(i,"alias node should not have any properties")):Zl(i,v,hi===t)&&(h=!0,i.tag===null&&(i.tag="?")),i.anchor!==null&&(i.anchorMap[i.anchor]=i.result)):l===0&&(h=o&&hs(i,g))),i.tag===null)i.anchor!==null&&(i.anchorMap[i.anchor]=i.result);else if(i.tag==="?"){for(i.result!==null&&i.kind!=="scalar"&&A(i,'unacceptable node kind for !<?> tag; it should be "scalar", not "'+i.kind+'"'),d=0,p=i.implicitTypes.length;d<p;d+=1)if(f=i.implicitTypes[d],f.resolve(i.result)){i.result=f.construct(i.result),i.tag=f.tag,i.anchor!==null&&(i.anchorMap[i.anchor]=i.result);break}}else if(i.tag!=="!"){if(Be.call(i.typeMap[i.kind||"fallback"],i.tag))f=i.typeMap[i.kind||"fallback"][i.tag];else for(f=null,m=i.typeMap.multi[i.kind||"fallback"],d=0,p=m.length;d<p;d+=1)if(i.tag.slice(0,m[d].tag.length)===m[d].tag){f=m[d];break}f||A(i,"unknown tag !<"+i.tag+">"),i.result!==null&&f.kind!==i.kind&&A(i,"unacceptable node kind for !<"+i.tag+'> tag; it should be "'+f.kind+'", not "'+i.kind+'"'),f.resolve(i.result,i.tag)?(i.result=f.construct(i.result,i.tag),i.anchor!==null&&(i.anchorMap[i.anchor]=i.result)):A(i,"cannot resolve a node with !<"+i.tag+"> explicit tag")}return i.listener!==null&&i.listener("close",i),i.tag!==null||i.anchor!==null||h}function sc(i){var e=i.position,t,a,r,s=!1,n;for(i.version=null,i.checkLineBreaks=i.legacy,i.tagMap=Object.create(null),i.anchorMap=Object.create(null);(n=i.input.charCodeAt(i.position))!==0&&(K(i,!0,-1),n=i.input.charCodeAt(i.position),!(i.lineIndent>0||n!==37));){for(s=!0,n=i.input.charCodeAt(++i.position),t=i.position;n!==0&&!fe(n);)n=i.input.charCodeAt(++i.position);for(a=i.input.slice(t,i.position),r=[],a.length<1&&A(i,"directive name must not be less than one character in length");n!==0;){for(;st(n);)n=i.input.charCodeAt(++i.position);if(n===35){do n=i.input.charCodeAt(++i.position);while(n!==0&&!Ie(n));break}if(Ie(n))break;for(t=i.position;n!==0&&!fe(n);)n=i.input.charCodeAt(++i.position);r.push(i.input.slice(t,i.position))}n!==0&&ca(i),Be.call(ds,a)?ds[a](i,a,r):_i(i,'unknown document directive "'+a+'"')}if(K(i,!0,-1),i.lineIndent===0&&i.input.charCodeAt(i.position)===45&&i.input.charCodeAt(i.position+1)===45&&i.input.charCodeAt(i.position+2)===45?(i.position+=3,K(i,!0,-1)):s&&A(i,"directives end mark is expected"),vt(i,i.lineIndent-1,pi,!1,!0),K(i,!0,-1),i.checkLineBreaks&&Bl.test(i.input.slice(e,i.position))&&_i(i,"non-ASCII line breaks are interpreted as content"),i.documents.push(i.result),i.position===i.lineStart&&mi(i)){i.input.charCodeAt(i.position)===46&&(i.position+=3,K(i,!0,-1));return}if(i.position<i.length-1)A(i,"end of the stream or a document separator is expected");else return}function ps(i,e){i=String(i),e=e||{},i.length!==0&&(i.charCodeAt(i.length-1)!==10&&i.charCodeAt(i.length-1)!==13&&(i+=`
`),i.charCodeAt(0)===65279&&(i=i.slice(1)));var t=new Yl(i,e),a=i.indexOf("\0");for(a!==-1&&(t.position=a,A(t,"null byte is not allowed in input")),t.input+="\0";t.input.charCodeAt(t.position)===32;)t.lineIndent+=1,t.position+=1;for(;t.position<t.length-1;)sc(t);return t.documents}function nc(i,e,t){e!==null&&typeof e=="object"&&typeof t>"u"&&(t=e,e=null);var a=ps(i,t);if(typeof e!="function")return a;for(var r=0,s=a.length;r<s;r+=1)e(a[r])}function oc(i,e){var t=ps(i,e);if(t.length!==0){if(t.length===1)return t[0];throw new he("expected a single document in the stream, but found more")}}var lc=nc,cc=oc,_s={loadAll:lc,load:cc},ms=Object.prototype.toString,fs=Object.prototype.hasOwnProperty,ua=65279,dc=9,qt=10,uc=13,hc=32,pc=33,_c=34,ha=35,mc=37,fc=38,vc=39,yc=42,vs=44,gc=45,fi=58,bc=61,xc=62,wc=63,kc=64,ys=91,gs=93,Ec=96,bs=123,Ac=124,xs=125,ce={};ce[0]="\\0",ce[7]="\\a",ce[8]="\\b",ce[9]="\\t",ce[10]="\\n",ce[11]="\\v",ce[12]="\\f",ce[13]="\\r",ce[27]="\\e",ce[34]='\\"',ce[92]="\\\\",ce[133]="\\N",ce[160]="\\_",ce[8232]="\\L",ce[8233]="\\P";var Sc=["y","Y","yes","Yes","YES","on","On","ON","n","N","no","No","NO","off","Off","OFF"],$c=/^[-+]?[0-9_]+(?::[0-9_]+)+(?:\.[0-9_]*)?$/;function Ic(i,e){var t,a,r,s,n,o,l;if(e===null)return{};for(t={},a=Object.keys(e),r=0,s=a.length;r<s;r+=1)n=a[r],o=String(e[n]),n.slice(0,2)==="!!"&&(n="tag:yaml.org,2002:"+n.slice(2)),l=i.compiledTypeMap.fallback[n],l&&fs.call(l.styleAliases,o)&&(o=l.styleAliases[o]),t[n]=o;return t}function Cc(i){var e,t,a;if(e=i.toString(16).toUpperCase(),i<=255)t="x",a=2;else if(i<=65535)t="u",a=4;else if(i<=4294967295)t="U",a=8;else throw new he("code point within a string may not be greater than 0xFFFFFFFF");return"\\"+t+ee.repeat("0",a-e.length)+e}var Tc=1,Ut=2;function Mc(i){this.schema=i.schema||oa,this.indent=Math.max(1,i.indent||2),this.noArrayIndent=i.noArrayIndent||!1,this.skipInvalid=i.skipInvalid||!1,this.flowLevel=ee.isNothing(i.flowLevel)?-1:i.flowLevel,this.styleMap=Ic(this.schema,i.styles||null),this.sortKeys=i.sortKeys||!1,this.lineWidth=i.lineWidth||80,this.noRefs=i.noRefs||!1,this.noCompatMode=i.noCompatMode||!1,this.condenseFlow=i.condenseFlow||!1,this.quotingType=i.quotingType==='"'?Ut:Tc,this.forceQuotes=i.forceQuotes||!1,this.replacer=typeof i.replacer=="function"?i.replacer:null,this.implicitTypes=this.schema.compiledImplicit,this.explicitTypes=this.schema.compiledExplicit,this.tag=null,this.result="",this.duplicates=[],this.usedDuplicates=null}function ws(i,e){for(var t=ee.repeat(" ",e),a=0,r=-1,s="",n,o=i.length;a<o;)r=i.indexOf(`
`,a),r===-1?(n=i.slice(a),a=o):(n=i.slice(a,r+1),a=r+1),n.length&&n!==`
`&&(s+=t),s+=n;return s}function pa(i,e){return`
`+ee.repeat(" ",i.indent*e)}function Fc(i,e){var t,a,r;for(t=0,a=i.implicitTypes.length;t<a;t+=1)if(r=i.implicitTypes[t],r.resolve(e))return!0;return!1}function vi(i){return i===hc||i===dc}function Bt(i){return 32<=i&&i<=126||161<=i&&i<=55295&&i!==8232&&i!==8233||57344<=i&&i<=65533&&i!==ua||65536<=i&&i<=1114111}function ks(i){return Bt(i)&&i!==ua&&i!==uc&&i!==qt}function Es(i,e,t){var a=ks(i),r=a&&!vi(i);return(t?a:a&&i!==vs&&i!==ys&&i!==gs&&i!==bs&&i!==xs)&&i!==ha&&!(e===fi&&!r)||ks(e)&&!vi(e)&&i===ha||e===fi&&r}function Pc(i){return Bt(i)&&i!==ua&&!vi(i)&&i!==gc&&i!==wc&&i!==fi&&i!==vs&&i!==ys&&i!==gs&&i!==bs&&i!==xs&&i!==ha&&i!==fc&&i!==yc&&i!==pc&&i!==Ac&&i!==bc&&i!==xc&&i!==vc&&i!==_c&&i!==mc&&i!==kc&&i!==Ec}function jc(i){return!vi(i)&&i!==fi}function Ht(i,e){var t=i.charCodeAt(e),a;return t>=55296&&t<=56319&&e+1<i.length&&(a=i.charCodeAt(e+1),a>=56320&&a<=57343)?(t-55296)*1024+a-56320+65536:t}function As(i){var e=/^\n* /;return e.test(i)}var Ss=1,_a=2,$s=3,Is=4,yt=5;function Dc(i,e,t,a,r,s,n,o){var l,c=0,h=null,d=!1,p=!1,m=a!==-1,f=-1,v=Pc(Ht(i,0))&&jc(Ht(i,i.length-1));if(e||n)for(l=0;l<i.length;c>=65536?l+=2:l++){if(c=Ht(i,l),!Bt(c))return yt;v=v&&Es(c,h,o),h=c}else{for(l=0;l<i.length;c>=65536?l+=2:l++){if(c=Ht(i,l),c===qt)d=!0,m&&(p=p||l-f-1>a&&i[f+1]!==" ",f=l);else if(!Bt(c))return yt;v=v&&Es(c,h,o),h=c}p=p||m&&l-f-1>a&&i[f+1]!==" "}return!d&&!p?v&&!n&&!r(i)?Ss:s===Ut?yt:_a:t>9&&As(i)?yt:n?s===Ut?yt:_a:p?Is:$s}function Oc(i,e,t,a,r){i.dump=(function(){if(e.length===0)return i.quotingType===Ut?'""':"''";if(!i.noCompatMode&&(Sc.indexOf(e)!==-1||$c.test(e)))return i.quotingType===Ut?'"'+e+'"':"'"+e+"'";var s=i.indent*Math.max(1,t),n=i.lineWidth===-1?-1:Math.max(Math.min(i.lineWidth,40),i.lineWidth-s),o=a||i.flowLevel>-1&&t>=i.flowLevel;function l(c){return Fc(i,c)}switch(Dc(e,o,i.indent,n,l,i.quotingType,i.forceQuotes&&!a,r)){case Ss:return e;case _a:return"'"+e.replace(/'/g,"''")+"'";case $s:return"|"+Cs(e,i.indent)+Ts(ws(e,s));case Is:return">"+Cs(e,i.indent)+Ts(ws(Rc(e,n),s));case yt:return'"'+zc(e)+'"';default:throw new he("impossible error: invalid scalar style")}})()}function Cs(i,e){var t=As(i)?String(e):"",a=i[i.length-1]===`
`,r=a&&(i[i.length-2]===`
`||i===`
`),s=r?"+":a?"":"-";return t+s+`
`}function Ts(i){return i[i.length-1]===`
`?i.slice(0,-1):i}function Rc(i,e){for(var t=/(\n+)([^\n]*)/g,a=(function(){var c=i.indexOf(`
`);return c=c!==-1?c:i.length,t.lastIndex=c,Ms(i.slice(0,c),e)})(),r=i[0]===`
`||i[0]===" ",s,n;n=t.exec(i);){var o=n[1],l=n[2];s=l[0]===" ",a+=o+(!r&&!s&&l!==""?`
`:"")+Ms(l,e),r=s}return a}function Ms(i,e){if(i===""||i[0]===" ")return i;for(var t=/ [^ ]/g,a,r=0,s,n=0,o=0,l="";a=t.exec(i);)o=a.index,o-r>e&&(s=n>r?n:o,l+=`
`+i.slice(r,s),r=s+1),n=o;return l+=`
`,i.length-r>e&&n>r?l+=i.slice(r,n)+`
`+i.slice(n+1):l+=i.slice(r),l.slice(1)}function zc(i){for(var e="",t=0,a,r=0;r<i.length;t>=65536?r+=2:r++)t=Ht(i,r),a=ce[t],!a&&Bt(t)?(e+=i[r],t>=65536&&(e+=i[r+1])):e+=a||Cc(t);return e}function Lc(i,e,t){var a="",r=i.tag,s,n,o;for(s=0,n=t.length;s<n;s+=1)o=t[s],i.replacer&&(o=i.replacer.call(t,String(s),o)),(Fe(i,e,o,!1,!1)||typeof o>"u"&&Fe(i,e,null,!1,!1))&&(a!==""&&(a+=","+(i.condenseFlow?"":" ")),a+=i.dump);i.tag=r,i.dump="["+a+"]"}function Fs(i,e,t,a){var r="",s=i.tag,n,o,l;for(n=0,o=t.length;n<o;n+=1)l=t[n],i.replacer&&(l=i.replacer.call(t,String(n),l)),(Fe(i,e+1,l,!0,!0,!1,!0)||typeof l>"u"&&Fe(i,e+1,null,!0,!0,!1,!0))&&((!a||r!=="")&&(r+=pa(i,e)),i.dump&&qt===i.dump.charCodeAt(0)?r+="-":r+="- ",r+=i.dump);i.tag=s,i.dump=r||"[]"}function Nc(i,e,t){var a="",r=i.tag,s=Object.keys(t),n,o,l,c,h;for(n=0,o=s.length;n<o;n+=1)h="",a!==""&&(h+=", "),i.condenseFlow&&(h+='"'),l=s[n],c=t[l],i.replacer&&(c=i.replacer.call(t,l,c)),Fe(i,e,l,!1,!1)&&(i.dump.length>1024&&(h+="? "),h+=i.dump+(i.condenseFlow?'"':"")+":"+(i.condenseFlow?"":" "),Fe(i,e,c,!1,!1)&&(h+=i.dump,a+=h));i.tag=r,i.dump="{"+a+"}"}function qc(i,e,t,a){var r="",s=i.tag,n=Object.keys(t),o,l,c,h,d,p;if(i.sortKeys===!0)n.sort();else if(typeof i.sortKeys=="function")n.sort(i.sortKeys);else if(i.sortKeys)throw new he("sortKeys must be a boolean or a function");for(o=0,l=n.length;o<l;o+=1)p="",(!a||r!=="")&&(p+=pa(i,e)),c=n[o],h=t[c],i.replacer&&(h=i.replacer.call(t,c,h)),Fe(i,e+1,c,!0,!0,!0)&&(d=i.tag!==null&&i.tag!=="?"||i.dump&&i.dump.length>1024,d&&(i.dump&&qt===i.dump.charCodeAt(0)?p+="?":p+="? "),p+=i.dump,d&&(p+=pa(i,e)),Fe(i,e+1,h,!0,d)&&(i.dump&&qt===i.dump.charCodeAt(0)?p+=":":p+=": ",p+=i.dump,r+=p));i.tag=s,i.dump=r||"{}"}function Ps(i,e,t){var a,r,s,n,o,l;for(r=t?i.explicitTypes:i.implicitTypes,s=0,n=r.length;s<n;s+=1)if(o=r[s],(o.instanceOf||o.predicate)&&(!o.instanceOf||typeof e=="object"&&e instanceof o.instanceOf)&&(!o.predicate||o.predicate(e))){if(t?o.multi&&o.representName?i.tag=o.representName(e):i.tag=o.tag:i.tag="?",o.represent){if(l=i.styleMap[o.tag]||o.defaultStyle,ms.call(o.represent)==="[object Function]")a=o.represent(e,l);else if(fs.call(o.represent,l))a=o.represent[l](e,l);else throw new he("!<"+o.tag+'> tag resolver accepts not "'+l+'" style');i.dump=a}return!0}return!1}function Fe(i,e,t,a,r,s,n){i.tag=null,i.dump=t,Ps(i,t,!1)||Ps(i,t,!0);var o=ms.call(i.dump),l=a,c;a&&(a=i.flowLevel<0||i.flowLevel>e);var h=o==="[object Object]"||o==="[object Array]",d,p;if(h&&(d=i.duplicates.indexOf(t),p=d!==-1),(i.tag!==null&&i.tag!=="?"||p||i.indent!==2&&e>0)&&(r=!1),p&&i.usedDuplicates[d])i.dump="*ref_"+d;else{if(h&&p&&!i.usedDuplicates[d]&&(i.usedDuplicates[d]=!0),o==="[object Object]")a&&Object.keys(i.dump).length!==0?(qc(i,e,i.dump,r),p&&(i.dump="&ref_"+d+i.dump)):(Nc(i,e,i.dump),p&&(i.dump="&ref_"+d+" "+i.dump));else if(o==="[object Array]")a&&i.dump.length!==0?(i.noArrayIndent&&!n&&e>0?Fs(i,e-1,i.dump,r):Fs(i,e,i.dump,r),p&&(i.dump="&ref_"+d+i.dump)):(Lc(i,e,i.dump),p&&(i.dump="&ref_"+d+" "+i.dump));else if(o==="[object String]")i.tag!=="?"&&Oc(i,i.dump,e,s,l);else{if(o==="[object Undefined]")return!1;if(i.skipInvalid)return!1;throw new he("unacceptable kind of an object to dump "+o)}i.tag!==null&&i.tag!=="?"&&(c=encodeURI(i.tag[0]==="!"?i.tag.slice(1):i.tag).replace(/!/g,"%21"),i.tag[0]==="!"?c="!"+c:c.slice(0,18)==="tag:yaml.org,2002:"?c="!!"+c.slice(18):c="!<"+c+">",i.dump=c+" "+i.dump)}return!0}function Uc(i,e){var t=[],a=[],r,s;for(ma(i,t,a),r=0,s=a.length;r<s;r+=1)e.duplicates.push(t[a[r]]);e.usedDuplicates=new Array(s)}function ma(i,e,t){var a,r,s;if(i!==null&&typeof i=="object")if(r=e.indexOf(i),r!==-1)t.indexOf(r)===-1&&t.push(r);else if(e.push(i),Array.isArray(i))for(r=0,s=i.length;r<s;r+=1)ma(i[r],e,t);else for(a=Object.keys(i),r=0,s=a.length;r<s;r+=1)ma(i[a[r]],e,t)}function Bc(i,e){e=e||{};var t=new Mc(e);t.noRefs||Uc(i,t);var a=i;return t.replacer&&(a=t.replacer.call({"":a},"",a)),Fe(t,0,a,!0,!0)?t.dump+`
`:""}var Hc=Bc,Gc={dump:Hc};function fa(i,e){return function(){throw new Error("Function yaml."+i+" is removed in js-yaml 4. Use yaml."+e+" instead, which is now safe by default.")}}var Vc=re,Qc=jr,Wc=zr,Yc=Br,Zc=Hr,Kc=oa,Xc=_s.load,Jc=_s.loadAll,ed=Gc.dump,td=he,id={binary:Yr,float:Ur,map:Rr,null:Lr,pairs:Kr,set:Xr,timestamp:Qr,bool:Nr,int:qr,merge:Wr,omap:Zr,seq:Or,str:Dr},ad=fa("safeLoad","load"),rd=fa("safeLoadAll","loadAll"),sd=fa("safeDump","dump"),gt={Type:Vc,Schema:Qc,FAILSAFE_SCHEMA:Wc,JSON_SCHEMA:Yc,CORE_SCHEMA:Zc,DEFAULT_SCHEMA:Kc,load:Xc,loadAll:Jc,dump:ed,YAMLException:td,types:id,safeLoad:ad,safeLoadAll:rd,safeDump:sd};const va=8,nd=128,od=256,ld=4096,js=524288;/**!
 * Sortable 1.15.7
 * @author	RubaXa   <trash@rubaxa.org>
 * @author	owenm    <owen23355@gmail.com>
 * @license MIT
 */function cd(i,e,t){return(e=pd(e))in i?Object.defineProperty(i,e,{value:t,enumerable:!0,configurable:!0,writable:!0}):i[e]=t,i}function Pe(){return Pe=Object.assign?Object.assign.bind():function(i){for(var e=1;e<arguments.length;e++){var t=arguments[e];for(var a in t)({}).hasOwnProperty.call(t,a)&&(i[a]=t[a])}return i},Pe.apply(null,arguments)}function Ds(i,e){var t=Object.keys(i);if(Object.getOwnPropertySymbols){var a=Object.getOwnPropertySymbols(i);e&&(a=a.filter(function(r){return Object.getOwnPropertyDescriptor(i,r).enumerable})),t.push.apply(t,a)}return t}function Ce(i){for(var e=1;e<arguments.length;e++){var t=arguments[e]!=null?arguments[e]:{};e%2?Ds(Object(t),!0).forEach(function(a){cd(i,a,t[a])}):Object.getOwnPropertyDescriptors?Object.defineProperties(i,Object.getOwnPropertyDescriptors(t)):Ds(Object(t)).forEach(function(a){Object.defineProperty(i,a,Object.getOwnPropertyDescriptor(t,a))})}return i}function dd(i,e){if(i==null)return{};var t,a,r=ud(i,e);if(Object.getOwnPropertySymbols){var s=Object.getOwnPropertySymbols(i);for(a=0;a<s.length;a++)t=s[a],e.indexOf(t)===-1&&{}.propertyIsEnumerable.call(i,t)&&(r[t]=i[t])}return r}function ud(i,e){if(i==null)return{};var t={};for(var a in i)if({}.hasOwnProperty.call(i,a)){if(e.indexOf(a)!==-1)continue;t[a]=i[a]}return t}function hd(i,e){if(typeof i!="object"||!i)return i;var t=i[Symbol.toPrimitive];if(t!==void 0){var a=t.call(i,e);if(typeof a!="object")return a;throw new TypeError("@@toPrimitive must return a primitive value.")}return(e==="string"?String:Number)(i)}function pd(i){var e=hd(i,"string");return typeof e=="symbol"?e:e+""}function ya(i){"@babel/helpers - typeof";return ya=typeof Symbol=="function"&&typeof Symbol.iterator=="symbol"?function(e){return typeof e}:function(e){return e&&typeof Symbol=="function"&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e},ya(i)}var _d="1.15.7";function je(i){if(typeof window<"u"&&window.navigator)return!!navigator.userAgent.match(i)}var De=je(/(?:Trident.*rv[ :]?11\.|msie|iemobile|Windows Phone)/i),Gt=je(/Edge/i),Os=je(/firefox/i),Vt=je(/safari/i)&&!je(/chrome/i)&&!je(/android/i),ga=je(/iP(ad|od|hone)/i),Rs=je(/chrome/i)&&je(/android/i),zs={capture:!1,passive:!1};function j(i,e,t){i.addEventListener(e,t,!De&&zs)}function P(i,e,t){i.removeEventListener(e,t,!De&&zs)}function yi(i,e){if(e){if(e[0]===">"&&(e=e.substring(1)),i)try{if(i.matches)return i.matches(e);if(i.msMatchesSelector)return i.msMatchesSelector(e);if(i.webkitMatchesSelector)return i.webkitMatchesSelector(e)}catch{return!1}return!1}}function Ls(i){return i.host&&i!==document&&i.host.nodeType&&i.host!==i?i.host:i.parentNode}function Ae(i,e,t,a){if(i){t=t||document;do{if(e!=null&&(e[0]===">"?i.parentNode===t&&yi(i,e):yi(i,e))||a&&i===t)return i;if(i===t)break}while(i=Ls(i))}return null}var Ns=/\s+/g;function be(i,e,t){if(i&&e)if(i.classList)i.classList[t?"add":"remove"](e);else{var a=(" "+i.className+" ").replace(Ns," ").replace(" "+e+" "," ");i.className=(a+(t?" "+e:"")).replace(Ns," ")}}function S(i,e,t){var a=i&&i.style;if(a){if(t===void 0)return document.defaultView&&document.defaultView.getComputedStyle?t=document.defaultView.getComputedStyle(i,""):i.currentStyle&&(t=i.currentStyle),e===void 0?t:t[e];!(e in a)&&e.indexOf("webkit")===-1&&(e="-webkit-"+e),a[e]=t+(typeof t=="string"?"":"px")}}function bt(i,e){var t="";if(typeof i=="string")t=i;else do{var a=S(i,"transform");a&&a!=="none"&&(t=a+" "+t)}while(!e&&(i=i.parentNode));var r=window.DOMMatrix||window.WebKitCSSMatrix||window.CSSMatrix||window.MSCSSMatrix;return r&&new r(t)}function qs(i,e,t){if(i){var a=i.getElementsByTagName(e),r=0,s=a.length;if(t)for(;r<s;r++)t(a[r],r);return a}return[]}function Te(){var i=document.scrollingElement;return i||document.documentElement}function X(i,e,t,a,r){if(!(!i.getBoundingClientRect&&i!==window)){var s,n,o,l,c,h,d;if(i!==window&&i.parentNode&&i!==Te()?(s=i.getBoundingClientRect(),n=s.top,o=s.left,l=s.bottom,c=s.right,h=s.height,d=s.width):(n=0,o=0,l=window.innerHeight,c=window.innerWidth,h=window.innerHeight,d=window.innerWidth),(e||t)&&i!==window&&(r=r||i.parentNode,!De))do if(r&&r.getBoundingClientRect&&(S(r,"transform")!=="none"||t&&S(r,"position")!=="static")){var p=r.getBoundingClientRect();n-=p.top+parseInt(S(r,"border-top-width")),o-=p.left+parseInt(S(r,"border-left-width")),l=n+s.height,c=o+s.width;break}while(r=r.parentNode);if(a&&i!==window){var m=bt(r||i),f=m&&m.a,v=m&&m.d;m&&(n/=v,o/=f,d/=f,h/=v,l=n+h,c=o+d)}return{top:n,left:o,bottom:l,right:c,width:d,height:h}}}function Us(i,e,t){for(var a=Ge(i,!0),r=X(i)[e];a;){var s=X(a)[t],n=void 0;if(n=r>=s,!n)return a;if(a===Te())break;a=Ge(a,!1)}return!1}function xt(i,e,t,a){for(var r=0,s=0,n=i.children;s<n.length;){if(n[s].style.display!=="none"&&n[s]!==$.ghost&&(a||n[s]!==$.dragged)&&Ae(n[s],t.draggable,i,!1)){if(r===e)return n[s];r++}s++}return null}function ba(i,e){for(var t=i.lastElementChild;t&&(t===$.ghost||S(t,"display")==="none"||e&&!yi(t,e));)t=t.previousElementSibling;return t||null}function ke(i,e){var t=0;if(!i||!i.parentNode)return-1;for(;i=i.previousElementSibling;)i.nodeName.toUpperCase()!=="TEMPLATE"&&i!==$.clone&&(!e||yi(i,e))&&t++;return t}function Bs(i){var e=0,t=0,a=Te();if(i)do{var r=bt(i),s=r.a,n=r.d;e+=i.scrollLeft*s,t+=i.scrollTop*n}while(i!==a&&(i=i.parentNode));return[e,t]}function md(i,e){for(var t in i)if(i.hasOwnProperty(t)){for(var a in e)if(e.hasOwnProperty(a)&&e[a]===i[t][a])return Number(t)}return-1}function Ge(i,e){if(!i||!i.getBoundingClientRect)return Te();var t=i,a=!1;do if(t.clientWidth<t.scrollWidth||t.clientHeight<t.scrollHeight){var r=S(t);if(t.clientWidth<t.scrollWidth&&(r.overflowX=="auto"||r.overflowX=="scroll")||t.clientHeight<t.scrollHeight&&(r.overflowY=="auto"||r.overflowY=="scroll")){if(!t.getBoundingClientRect||t===document.body)return Te();if(a||e)return t;a=!0}}while(t=t.parentNode);return Te()}function fd(i,e){if(i&&e)for(var t in e)e.hasOwnProperty(t)&&(i[t]=e[t]);return i}function xa(i,e){return Math.round(i.top)===Math.round(e.top)&&Math.round(i.left)===Math.round(e.left)&&Math.round(i.height)===Math.round(e.height)&&Math.round(i.width)===Math.round(e.width)}var Qt;function Hs(i,e){return function(){if(!Qt){var t=arguments,a=this;t.length===1?i.call(a,t[0]):i.apply(a,t),Qt=setTimeout(function(){Qt=void 0},e)}}}function vd(){clearTimeout(Qt),Qt=void 0}function Gs(i,e,t){i.scrollLeft+=e,i.scrollTop+=t}function Vs(i){var e=window.Polymer,t=window.jQuery||window.Zepto;return e&&e.dom?e.dom(i).cloneNode(!0):t?t(i).clone(!0)[0]:i.cloneNode(!0)}function Qs(i,e,t){var a={};return Array.from(i.children).forEach(function(r){var s,n,o,l;if(!(!Ae(r,e.draggable,i,!1)||r.animated||r===t)){var c=X(r);a.left=Math.min((s=a.left)!==null&&s!==void 0?s:1/0,c.left),a.top=Math.min((n=a.top)!==null&&n!==void 0?n:1/0,c.top),a.right=Math.max((o=a.right)!==null&&o!==void 0?o:-1/0,c.right),a.bottom=Math.max((l=a.bottom)!==null&&l!==void 0?l:-1/0,c.bottom)}}),a.width=a.right-a.left,a.height=a.bottom-a.top,a.x=a.left,a.y=a.top,a}var ve="Sortable"+new Date().getTime();function yd(){var i=[],e;return{captureAnimationState:function(){if(i=[],!!this.options.animation){var a=[].slice.call(this.el.children);a.forEach(function(r){if(!(S(r,"display")==="none"||r===$.ghost)){i.push({target:r,rect:X(r)});var s=Ce({},i[i.length-1].rect);if(r.thisAnimationDuration){var n=bt(r,!0);n&&(s.top-=n.f,s.left-=n.e)}r.fromRect=s}})}},addAnimationState:function(a){i.push(a)},removeAnimationState:function(a){i.splice(md(i,{target:a}),1)},animateAll:function(a){var r=this;if(!this.options.animation){clearTimeout(e),typeof a=="function"&&a();return}var s=!1,n=0;i.forEach(function(o){var l=0,c=o.target,h=c.fromRect,d=X(c),p=c.prevFromRect,m=c.prevToRect,f=o.rect,v=bt(c,!0);v&&(d.top-=v.f,d.left-=v.e),c.toRect=d,c.thisAnimationDuration&&xa(p,d)&&!xa(h,d)&&(f.top-d.top)/(f.left-d.left)===(h.top-d.top)/(h.left-d.left)&&(l=bd(f,p,m,r.options)),xa(d,h)||(c.prevFromRect=h,c.prevToRect=d,l||(l=r.options.animation),r.animate(c,f,d,l)),l&&(s=!0,n=Math.max(n,l),clearTimeout(c.animationResetTimer),c.animationResetTimer=setTimeout(function(){c.animationTime=0,c.prevFromRect=null,c.fromRect=null,c.prevToRect=null,c.thisAnimationDuration=null},l),c.thisAnimationDuration=l)}),clearTimeout(e),s?e=setTimeout(function(){typeof a=="function"&&a()},n):typeof a=="function"&&a(),i=[]},animate:function(a,r,s,n){if(n){S(a,"transition",""),S(a,"transform","");var o=bt(this.el),l=o&&o.a,c=o&&o.d,h=(r.left-s.left)/(l||1),d=(r.top-s.top)/(c||1);a.animatingX=!!h,a.animatingY=!!d,S(a,"transform","translate3d("+h+"px,"+d+"px,0)"),this.forRepaintDummy=gd(a),S(a,"transition","transform "+n+"ms"+(this.options.easing?" "+this.options.easing:"")),S(a,"transform","translate3d(0,0,0)"),typeof a.animated=="number"&&clearTimeout(a.animated),a.animated=setTimeout(function(){S(a,"transition",""),S(a,"transform",""),a.animated=!1,a.animatingX=!1,a.animatingY=!1},n)}}}}function gd(i){return i.offsetWidth}function bd(i,e,t,a){return Math.sqrt(Math.pow(e.top-i.top,2)+Math.pow(e.left-i.left,2))/Math.sqrt(Math.pow(e.top-t.top,2)+Math.pow(e.left-t.left,2))*a.animation}var wt=[],wa={initializeByDefault:!0},Wt={mount:function(e){for(var t in wa)wa.hasOwnProperty(t)&&!(t in e)&&(e[t]=wa[t]);wt.forEach(function(a){if(a.pluginName===e.pluginName)throw"Sortable: Cannot mount plugin ".concat(e.pluginName," more than once")}),wt.push(e)},pluginEvent:function(e,t,a){var r=this;this.eventCanceled=!1,a.cancel=function(){r.eventCanceled=!0};var s=e+"Global";wt.forEach(function(n){t[n.pluginName]&&(t[n.pluginName][s]&&t[n.pluginName][s](Ce({sortable:t},a)),t.options[n.pluginName]&&t[n.pluginName][e]&&t[n.pluginName][e](Ce({sortable:t},a)))})},initializePlugins:function(e,t,a,r){wt.forEach(function(o){var l=o.pluginName;if(!(!e.options[l]&&!o.initializeByDefault)){var c=new o(e,t,e.options);c.sortable=e,c.options=e.options,e[l]=c,Pe(a,c.defaults)}});for(var s in e.options)if(e.options.hasOwnProperty(s)){var n=this.modifyOption(e,s,e.options[s]);typeof n<"u"&&(e.options[s]=n)}},getEventProperties:function(e,t){var a={};return wt.forEach(function(r){typeof r.eventProperties=="function"&&Pe(a,r.eventProperties.call(t[r.pluginName],e))}),a},modifyOption:function(e,t,a){var r;return wt.forEach(function(s){e[s.pluginName]&&s.optionListeners&&typeof s.optionListeners[t]=="function"&&(r=s.optionListeners[t].call(e[s.pluginName],a))}),r}};function xd(i){var e=i.sortable,t=i.rootEl,a=i.name,r=i.targetEl,s=i.cloneEl,n=i.toEl,o=i.fromEl,l=i.oldIndex,c=i.newIndex,h=i.oldDraggableIndex,d=i.newDraggableIndex,p=i.originalEvent,m=i.putSortable,f=i.extraEventProperties;if(e=e||t&&t[ve],!!e){var v,g=e.options,w="on"+a.charAt(0).toUpperCase()+a.substr(1);window.CustomEvent&&!De&&!Gt?v=new CustomEvent(a,{bubbles:!0,cancelable:!0}):(v=document.createEvent("Event"),v.initEvent(a,!0,!0)),v.to=n||t,v.from=o||t,v.item=r||t,v.clone=s,v.oldIndex=l,v.newIndex=c,v.oldDraggableIndex=h,v.newDraggableIndex=d,v.originalEvent=p,v.pullMode=m?m.lastPutMode:void 0;var k=Ce(Ce({},f),Wt.getEventProperties(a,e));for(var I in k)v[I]=k[I];t&&t.dispatchEvent(v),g[w]&&g[w].call(e,v)}}var wd=["evt"],ye=function(e,t){var a=arguments.length>2&&arguments[2]!==void 0?arguments[2]:{},r=a.evt,s=dd(a,wd);Wt.pluginEvent.bind($)(e,t,Ce({dragEl:x,parentEl:Y,ghostEl:T,rootEl:V,nextEl:nt,lastDownEl:gi,cloneEl:W,cloneHidden:Ve,dragStarted:Zt,putSortable:se,activeSortable:$.active,originalEvent:r,oldIndex:kt,oldDraggableIndex:Yt,newIndex:xe,newDraggableIndex:Qe,hideGhostForTarget:en,unhideGhostForTarget:tn,cloneNowHidden:function(){Ve=!0},cloneNowShown:function(){Ve=!1},dispatchSortableEvent:function(o){pe({sortable:t,name:o,originalEvent:r})}},s))};function pe(i){xd(Ce({putSortable:se,cloneEl:W,targetEl:x,rootEl:V,oldIndex:kt,oldDraggableIndex:Yt,newIndex:xe,newDraggableIndex:Qe},i))}var x,Y,T,V,nt,gi,W,Ve,kt,xe,Yt,Qe,bi,se,Et=!1,xi=!1,wi=[],ot,Se,ka,Ea,Ws,Ys,Zt,At,Kt,Xt=!1,ki=!1,Ei,de,Aa=[],Sa=!1,Ai=[],Si=typeof document<"u",$i=ga,Zs=Gt||De?"cssFloat":"float",kd=Si&&!Rs&&!ga&&"draggable"in document.createElement("div"),Ks=(function(){if(Si){if(De)return!1;var i=document.createElement("x");return i.style.cssText="pointer-events:auto",i.style.pointerEvents==="auto"}})(),Xs=function(e,t){var a=S(e),r=parseInt(a.width)-parseInt(a.paddingLeft)-parseInt(a.paddingRight)-parseInt(a.borderLeftWidth)-parseInt(a.borderRightWidth),s=xt(e,0,t),n=xt(e,1,t),o=s&&S(s),l=n&&S(n),c=o&&parseInt(o.marginLeft)+parseInt(o.marginRight)+X(s).width,h=l&&parseInt(l.marginLeft)+parseInt(l.marginRight)+X(n).width;if(a.display==="flex")return a.flexDirection==="column"||a.flexDirection==="column-reverse"?"vertical":"horizontal";if(a.display==="grid")return a.gridTemplateColumns.split(" ").length<=1?"vertical":"horizontal";if(s&&o.float&&o.float!=="none"){var d=o.float==="left"?"left":"right";return n&&(l.clear==="both"||l.clear===d)?"vertical":"horizontal"}return s&&(o.display==="block"||o.display==="flex"||o.display==="table"||o.display==="grid"||c>=r&&a[Zs]==="none"||n&&a[Zs]==="none"&&c+h>r)?"vertical":"horizontal"},Ed=function(e,t,a){var r=a?e.left:e.top,s=a?e.right:e.bottom,n=a?e.width:e.height,o=a?t.left:t.top,l=a?t.right:t.bottom,c=a?t.width:t.height;return r===o||s===l||r+n/2===o+c/2},Ad=function(e,t){var a;return wi.some(function(r){var s=r[ve].options.emptyInsertThreshold;if(!(!s||ba(r))){var n=X(r),o=e>=n.left-s&&e<=n.right+s,l=t>=n.top-s&&t<=n.bottom+s;if(o&&l)return a=r}}),a},Js=function(e){function t(s,n){return function(o,l,c,h){var d=o.options.group.name&&l.options.group.name&&o.options.group.name===l.options.group.name;if(s==null&&(n||d))return!0;if(s==null||s===!1)return!1;if(n&&s==="clone")return s;if(typeof s=="function")return t(s(o,l,c,h),n)(o,l,c,h);var p=(n?o:l).options.group.name;return s===!0||typeof s=="string"&&s===p||s.join&&s.indexOf(p)>-1}}var a={},r=e.group;(!r||ya(r)!="object")&&(r={name:r}),a.name=r.name,a.checkPull=t(r.pull,!0),a.checkPut=t(r.put),a.revertClone=r.revertClone,e.group=a},en=function(){!Ks&&T&&S(T,"display","none")},tn=function(){!Ks&&T&&S(T,"display","")};Si&&!Rs&&document.addEventListener("click",function(i){if(xi)return i.preventDefault(),i.stopPropagation&&i.stopPropagation(),i.stopImmediatePropagation&&i.stopImmediatePropagation(),xi=!1,!1},!0);var lt=function(e){if(x){e=e.touches?e.touches[0]:e;var t=Ad(e.clientX,e.clientY);if(t){var a={};for(var r in e)e.hasOwnProperty(r)&&(a[r]=e[r]);a.target=a.rootEl=t,a.preventDefault=void 0,a.stopPropagation=void 0,t[ve]._onDragOver(a)}}},Sd=function(e){x&&x.parentNode[ve]._isOutsideThisEl(e.target)};function $(i,e){if(!(i&&i.nodeType&&i.nodeType===1))throw"Sortable: `el` must be an HTMLElement, not ".concat({}.toString.call(i));this.el=i,this.options=e=Pe({},e),i[ve]=this;var t={group:null,sort:!0,disabled:!1,store:null,handle:null,draggable:/^[uo]l$/i.test(i.nodeName)?">li":">*",swapThreshold:1,invertSwap:!1,invertedSwapThreshold:null,removeCloneOnHide:!0,direction:function(){return Xs(i,this.options)},ghostClass:"sortable-ghost",chosenClass:"sortable-chosen",dragClass:"sortable-drag",ignore:"a, img",filter:null,preventOnFilter:!0,animation:0,easing:null,setData:function(n,o){n.setData("Text",o.textContent)},dropBubble:!1,dragoverBubble:!1,dataIdAttr:"data-id",delay:0,delayOnTouchOnly:!1,touchStartThreshold:(Number.parseInt?Number:window).parseInt(window.devicePixelRatio,10)||1,forceFallback:!1,fallbackClass:"sortable-fallback",fallbackOnBody:!1,fallbackTolerance:0,fallbackOffset:{x:0,y:0},supportPointer:$.supportPointer!==!1&&"PointerEvent"in window&&(!Vt||ga),emptyInsertThreshold:5};Wt.initializePlugins(this,i,t);for(var a in t)!(a in e)&&(e[a]=t[a]);Js(e);for(var r in this)r.charAt(0)==="_"&&typeof this[r]=="function"&&(this[r]=this[r].bind(this));this.nativeDraggable=e.forceFallback?!1:kd,this.nativeDraggable&&(this.options.touchStartThreshold=1),e.supportPointer?j(i,"pointerdown",this._onTapStart):(j(i,"mousedown",this._onTapStart),j(i,"touchstart",this._onTapStart)),this.nativeDraggable&&(j(i,"dragover",this),j(i,"dragenter",this)),wi.push(this.el),e.store&&e.store.get&&this.sort(e.store.get(this)||[]),Pe(this,yd())}$.prototype={constructor:$,_isOutsideThisEl:function(e){!this.el.contains(e)&&e!==this.el&&(At=null)},_getDirection:function(e,t){return typeof this.options.direction=="function"?this.options.direction.call(this,e,t,x):this.options.direction},_onTapStart:function(e){if(e.cancelable){var t=this,a=this.el,r=this.options,s=r.preventOnFilter,n=e.type,o=e.touches&&e.touches[0]||e.pointerType&&e.pointerType==="touch"&&e,l=(o||e).target,c=e.target.shadowRoot&&(e.path&&e.path[0]||e.composedPath&&e.composedPath()[0])||l,h=r.filter;if(jd(a),!x&&!(/mousedown|pointerdown/.test(n)&&e.button!==0||r.disabled)&&!c.isContentEditable&&!(!this.nativeDraggable&&Vt&&l&&l.tagName.toUpperCase()==="SELECT")&&(l=Ae(l,r.draggable,a,!1),!(l&&l.animated)&&gi!==l)){if(kt=ke(l),Yt=ke(l,r.draggable),typeof h=="function"){if(h.call(this,e,l,this)){pe({sortable:t,rootEl:c,name:"filter",targetEl:l,toEl:a,fromEl:a}),ye("filter",t,{evt:e}),s&&e.preventDefault();return}}else if(h&&(h=h.split(",").some(function(d){if(d=Ae(c,d.trim(),a,!1),d)return pe({sortable:t,rootEl:d,name:"filter",targetEl:l,fromEl:a,toEl:a}),ye("filter",t,{evt:e}),!0}),h)){s&&e.preventDefault();return}r.handle&&!Ae(c,r.handle,a,!1)||this._prepareDragStart(e,o,l)}}},_prepareDragStart:function(e,t,a){var r=this,s=r.el,n=r.options,o=s.ownerDocument,l;if(a&&!x&&a.parentNode===s){var c=X(a);if(V=s,x=a,Y=x.parentNode,nt=x.nextSibling,gi=a,bi=n.group,$.dragged=x,ot={target:x,clientX:(t||e).clientX,clientY:(t||e).clientY},Ws=ot.clientX-c.left,Ys=ot.clientY-c.top,this._lastX=(t||e).clientX,this._lastY=(t||e).clientY,x.style["will-change"]="all",l=function(){if(ye("delayEnded",r,{evt:e}),$.eventCanceled){r._onDrop();return}r._disableDelayedDragEvents(),!Os&&r.nativeDraggable&&(x.draggable=!0),r._triggerDragStart(e,t),pe({sortable:r,name:"choose",originalEvent:e}),be(x,n.chosenClass,!0)},n.ignore.split(",").forEach(function(h){qs(x,h.trim(),$a)}),j(o,"dragover",lt),j(o,"mousemove",lt),j(o,"touchmove",lt),n.supportPointer?(j(o,"pointerup",r._onDrop),!this.nativeDraggable&&j(o,"pointercancel",r._onDrop)):(j(o,"mouseup",r._onDrop),j(o,"touchend",r._onDrop),j(o,"touchcancel",r._onDrop)),Os&&this.nativeDraggable&&(this.options.touchStartThreshold=4,x.draggable=!0),ye("delayStart",this,{evt:e}),n.delay&&(!n.delayOnTouchOnly||t)&&(!this.nativeDraggable||!(Gt||De))){if($.eventCanceled){this._onDrop();return}n.supportPointer?(j(o,"pointerup",r._disableDelayedDrag),j(o,"pointercancel",r._disableDelayedDrag)):(j(o,"mouseup",r._disableDelayedDrag),j(o,"touchend",r._disableDelayedDrag),j(o,"touchcancel",r._disableDelayedDrag)),j(o,"mousemove",r._delayedDragTouchMoveHandler),j(o,"touchmove",r._delayedDragTouchMoveHandler),n.supportPointer&&j(o,"pointermove",r._delayedDragTouchMoveHandler),r._dragStartTimer=setTimeout(l,n.delay)}else l()}},_delayedDragTouchMoveHandler:function(e){var t=e.touches?e.touches[0]:e;Math.max(Math.abs(t.clientX-this._lastX),Math.abs(t.clientY-this._lastY))>=Math.floor(this.options.touchStartThreshold/(this.nativeDraggable&&window.devicePixelRatio||1))&&this._disableDelayedDrag()},_disableDelayedDrag:function(){x&&$a(x),clearTimeout(this._dragStartTimer),this._disableDelayedDragEvents()},_disableDelayedDragEvents:function(){var e=this.el.ownerDocument;P(e,"mouseup",this._disableDelayedDrag),P(e,"touchend",this._disableDelayedDrag),P(e,"touchcancel",this._disableDelayedDrag),P(e,"pointerup",this._disableDelayedDrag),P(e,"pointercancel",this._disableDelayedDrag),P(e,"mousemove",this._delayedDragTouchMoveHandler),P(e,"touchmove",this._delayedDragTouchMoveHandler),P(e,"pointermove",this._delayedDragTouchMoveHandler)},_triggerDragStart:function(e,t){t=t||e.pointerType=="touch"&&e,!this.nativeDraggable||t?this.options.supportPointer?j(document,"pointermove",this._onTouchMove):t?j(document,"touchmove",this._onTouchMove):j(document,"mousemove",this._onTouchMove):(j(x,"dragend",this),j(V,"dragstart",this._onDragStart));try{document.selection?Ci(function(){document.selection.empty()}):window.getSelection().removeAllRanges()}catch{}},_dragStarted:function(e,t){if(Et=!1,V&&x){ye("dragStarted",this,{evt:t}),this.nativeDraggable&&j(document,"dragover",Sd);var a=this.options;!e&&be(x,a.dragClass,!1),be(x,a.ghostClass,!0),$.active=this,e&&this._appendGhost(),pe({sortable:this,name:"start",originalEvent:t})}else this._nulling()},_emulateDragOver:function(){if(Se){this._lastX=Se.clientX,this._lastY=Se.clientY,en();for(var e=document.elementFromPoint(Se.clientX,Se.clientY),t=e;e&&e.shadowRoot&&(e=e.shadowRoot.elementFromPoint(Se.clientX,Se.clientY),e!==t);)t=e;if(x.parentNode[ve]._isOutsideThisEl(e),t)do{if(t[ve]){var a=void 0;if(a=t[ve]._onDragOver({clientX:Se.clientX,clientY:Se.clientY,target:e,rootEl:t}),a&&!this.options.dragoverBubble)break}e=t}while(t=Ls(t));tn()}},_onTouchMove:function(e){if(ot){var t=this.options,a=t.fallbackTolerance,r=t.fallbackOffset,s=e.touches?e.touches[0]:e,n=T&&bt(T,!0),o=T&&n&&n.a,l=T&&n&&n.d,c=$i&&de&&Bs(de),h=(s.clientX-ot.clientX+r.x)/(o||1)+(c?c[0]-Aa[0]:0)/(o||1),d=(s.clientY-ot.clientY+r.y)/(l||1)+(c?c[1]-Aa[1]:0)/(l||1);if(!$.active&&!Et){if(a&&Math.max(Math.abs(s.clientX-this._lastX),Math.abs(s.clientY-this._lastY))<a)return;this._onDragStart(e,!0)}if(T){n?(n.e+=h-(ka||0),n.f+=d-(Ea||0)):n={a:1,b:0,c:0,d:1,e:h,f:d};var p="matrix(".concat(n.a,",").concat(n.b,",").concat(n.c,",").concat(n.d,",").concat(n.e,",").concat(n.f,")");S(T,"webkitTransform",p),S(T,"mozTransform",p),S(T,"msTransform",p),S(T,"transform",p),ka=h,Ea=d,Se=s}e.cancelable&&e.preventDefault()}},_appendGhost:function(){if(!T){var e=this.options.fallbackOnBody?document.body:V,t=X(x,!0,$i,!0,e),a=this.options;if($i){for(de=e;S(de,"position")==="static"&&S(de,"transform")==="none"&&de!==document;)de=de.parentNode;de!==document.body&&de!==document.documentElement?(de===document&&(de=Te()),t.top+=de.scrollTop,t.left+=de.scrollLeft):de=Te(),Aa=Bs(de)}T=x.cloneNode(!0),be(T,a.ghostClass,!1),be(T,a.fallbackClass,!0),be(T,a.dragClass,!0),S(T,"transition",""),S(T,"transform",""),S(T,"box-sizing","border-box"),S(T,"margin",0),S(T,"top",t.top),S(T,"left",t.left),S(T,"width",t.width),S(T,"height",t.height),S(T,"opacity","0.8"),S(T,"position",$i?"absolute":"fixed"),S(T,"zIndex","100000"),S(T,"pointerEvents","none"),$.ghost=T,e.appendChild(T),S(T,"transform-origin",Ws/parseInt(T.style.width)*100+"% "+Ys/parseInt(T.style.height)*100+"%")}},_onDragStart:function(e,t){var a=this,r=e.dataTransfer,s=a.options;if(ye("dragStart",this,{evt:e}),$.eventCanceled){this._onDrop();return}ye("setupClone",this),$.eventCanceled||(W=Vs(x),W.removeAttribute("id"),W.draggable=!1,W.style["will-change"]="",this._hideClone(),be(W,this.options.chosenClass,!1),$.clone=W),a.cloneId=Ci(function(){ye("clone",a),!$.eventCanceled&&(a.options.removeCloneOnHide||V.insertBefore(W,x),a._hideClone(),pe({sortable:a,name:"clone"}))}),!t&&be(x,s.dragClass,!0),t?(xi=!0,a._loopId=setInterval(a._emulateDragOver,50)):(P(document,"mouseup",a._onDrop),P(document,"touchend",a._onDrop),P(document,"touchcancel",a._onDrop),r&&(r.effectAllowed="move",s.setData&&s.setData.call(a,r,x)),j(document,"drop",a),S(x,"transform","translateZ(0)")),Et=!0,a._dragStartId=Ci(a._dragStarted.bind(a,t,e)),j(document,"selectstart",a),Zt=!0,window.getSelection().removeAllRanges(),Vt&&S(document.body,"user-select","none")},_onDragOver:function(e){var t=this.el,a=e.target,r,s,n,o=this.options,l=o.group,c=$.active,h=bi===l,d=o.sort,p=se||c,m,f=this,v=!1;if(Sa)return;function g(oe,$e){ye(oe,f,Ce({evt:e,isOwner:h,axis:m?"vertical":"horizontal",revert:n,dragRect:r,targetRect:s,canSort:d,fromSortable:p,target:a,completed:k,onMove:function(ae,Re){return Ii(V,t,x,r,ae,X(ae),e,Re)},changed:I},$e))}function w(){g("dragOverAnimationCapture"),f.captureAnimationState(),f!==p&&p.captureAnimationState()}function k(oe){return g("dragOverCompleted",{insertion:oe}),oe&&(h?c._hideClone():c._showClone(f),f!==p&&(be(x,se?se.options.ghostClass:c.options.ghostClass,!1),be(x,o.ghostClass,!0)),se!==f&&f!==$.active?se=f:f===$.active&&se&&(se=null),p===f&&(f._ignoreWhileAnimating=a),f.animateAll(function(){g("dragOverAnimationComplete"),f._ignoreWhileAnimating=null}),f!==p&&(p.animateAll(),p._ignoreWhileAnimating=null)),(a===x&&!x.animated||a===t&&!a.animated)&&(At=null),!o.dragoverBubble&&!e.rootEl&&a!==document&&(x.parentNode[ve]._isOutsideThisEl(e.target),!oe&&lt(e)),!o.dragoverBubble&&e.stopPropagation&&e.stopPropagation(),v=!0}function I(){xe=ke(x),Qe=ke(x,o.draggable),pe({sortable:f,name:"change",toEl:t,newIndex:xe,newDraggableIndex:Qe,originalEvent:e})}if(e.preventDefault!==void 0&&e.cancelable&&e.preventDefault(),a=Ae(a,o.draggable,t,!0),g("dragOver"),$.eventCanceled)return v;if(x.contains(e.target)||a.animated&&a.animatingX&&a.animatingY||f._ignoreWhileAnimating===a)return k(!1);if(xi=!1,c&&!o.disabled&&(h?d||(n=Y!==V):se===this||(this.lastPutMode=bi.checkPull(this,c,x,e))&&l.checkPut(this,c,x,e))){if(m=this._getDirection(e,a)==="vertical",r=X(x),g("dragOverValid"),$.eventCanceled)return v;if(n)return Y=V,w(),this._hideClone(),g("revert"),$.eventCanceled||(nt?V.insertBefore(x,nt):V.appendChild(x)),k(!0);var E=ba(t,o.draggable);if(!E||Td(e,m,this)&&!E.animated){if(E===x)return k(!1);if(E&&t===e.target&&(a=E),a&&(s=X(a)),Ii(V,t,x,r,a,s,e,!!a)!==!1)return w(),E&&E.nextSibling?t.insertBefore(x,E.nextSibling):t.appendChild(x),Y=t,I(),k(!0)}else if(E&&Cd(e,m,this)){var U=xt(t,0,o,!0);if(U===x)return k(!1);if(a=U,s=X(a),Ii(V,t,x,r,a,s,e,!1)!==!1)return w(),t.insertBefore(x,U),Y=t,I(),k(!0)}else if(a.parentNode===t){s=X(a);var B=0,F,D=x.parentNode!==t,N=!Ed(x.animated&&x.toRect||r,a.animated&&a.toRect||s,m),L=m?"top":"left",M=Us(a,"top","top")||Us(x,"top","top"),q=M?M.scrollTop:void 0;At!==a&&(F=s[L],Xt=!1,ki=!N&&o.invertSwap||D),B=Md(e,a,s,m,N?1:o.swapThreshold,o.invertedSwapThreshold==null?o.swapThreshold:o.invertedSwapThreshold,ki,At===a);var H;if(B!==0){var te=ke(x);do te-=B,H=Y.children[te];while(H&&(S(H,"display")==="none"||H===T))}if(B===0||H===a)return k(!1);At=a,Kt=B;var ie=a.nextElementSibling,Z=!1;Z=B===1;var ne=Ii(V,t,x,r,a,s,e,Z);if(ne!==!1)return(ne===1||ne===-1)&&(Z=ne===1),Sa=!0,setTimeout(Id,30),w(),Z&&!ie?t.appendChild(x):a.parentNode.insertBefore(x,Z?ie:a),M&&Gs(M,0,q-M.scrollTop),Y=x.parentNode,F!==void 0&&!ki&&(Ei=Math.abs(F-X(a)[L])),I(),k(!0)}if(t.contains(x))return k(!1)}return!1},_ignoreWhileAnimating:null,_offMoveEvents:function(){P(document,"mousemove",this._onTouchMove),P(document,"touchmove",this._onTouchMove),P(document,"pointermove",this._onTouchMove),P(document,"dragover",lt),P(document,"mousemove",lt),P(document,"touchmove",lt)},_offUpEvents:function(){var e=this.el.ownerDocument;P(e,"mouseup",this._onDrop),P(e,"touchend",this._onDrop),P(e,"pointerup",this._onDrop),P(e,"pointercancel",this._onDrop),P(e,"touchcancel",this._onDrop),P(document,"selectstart",this)},_onDrop:function(e){var t=this.el,a=this.options;if(xe=ke(x),Qe=ke(x,a.draggable),ye("drop",this,{evt:e}),Y=x&&x.parentNode,xe=ke(x),Qe=ke(x,a.draggable),$.eventCanceled){this._nulling();return}Et=!1,ki=!1,Xt=!1,clearInterval(this._loopId),clearTimeout(this._dragStartTimer),Ia(this.cloneId),Ia(this._dragStartId),this.nativeDraggable&&(P(document,"drop",this),P(t,"dragstart",this._onDragStart)),this._offMoveEvents(),this._offUpEvents(),Vt&&S(document.body,"user-select",""),S(x,"transform",""),e&&(Zt&&(e.cancelable&&e.preventDefault(),!a.dropBubble&&e.stopPropagation()),T&&T.parentNode&&T.parentNode.removeChild(T),(V===Y||se&&se.lastPutMode!=="clone")&&W&&W.parentNode&&W.parentNode.removeChild(W),x&&(this.nativeDraggable&&P(x,"dragend",this),$a(x),x.style["will-change"]="",Zt&&!Et&&be(x,se?se.options.ghostClass:this.options.ghostClass,!1),be(x,this.options.chosenClass,!1),pe({sortable:this,name:"unchoose",toEl:Y,newIndex:null,newDraggableIndex:null,originalEvent:e}),V!==Y?(xe>=0&&(pe({rootEl:Y,name:"add",toEl:Y,fromEl:V,originalEvent:e}),pe({sortable:this,name:"remove",toEl:Y,originalEvent:e}),pe({rootEl:Y,name:"sort",toEl:Y,fromEl:V,originalEvent:e}),pe({sortable:this,name:"sort",toEl:Y,originalEvent:e})),se&&se.save()):xe!==kt&&xe>=0&&(pe({sortable:this,name:"update",toEl:Y,originalEvent:e}),pe({sortable:this,name:"sort",toEl:Y,originalEvent:e})),$.active&&((xe==null||xe===-1)&&(xe=kt,Qe=Yt),pe({sortable:this,name:"end",toEl:Y,originalEvent:e}),this.save()))),this._nulling()},_nulling:function(){ye("nulling",this),V=x=Y=T=nt=W=gi=Ve=ot=Se=Zt=xe=Qe=kt=Yt=At=Kt=se=bi=$.dragged=$.ghost=$.clone=$.active=null;var e=this.el;Ai.forEach(function(t){e.contains(t)&&(t.checked=!0)}),Ai.length=ka=Ea=0},handleEvent:function(e){switch(e.type){case"drop":case"dragend":this._onDrop(e);break;case"dragenter":case"dragover":x&&(this._onDragOver(e),$d(e));break;case"selectstart":e.preventDefault();break}},toArray:function(){for(var e=[],t,a=this.el.children,r=0,s=a.length,n=this.options;r<s;r++)t=a[r],Ae(t,n.draggable,this.el,!1)&&e.push(t.getAttribute(n.dataIdAttr)||Pd(t));return e},sort:function(e,t){var a={},r=this.el;this.toArray().forEach(function(s,n){var o=r.children[n];Ae(o,this.options.draggable,r,!1)&&(a[s]=o)},this),t&&this.captureAnimationState(),e.forEach(function(s){a[s]&&(r.removeChild(a[s]),r.appendChild(a[s]))}),t&&this.animateAll()},save:function(){var e=this.options.store;e&&e.set&&e.set(this)},closest:function(e,t){return Ae(e,t||this.options.draggable,this.el,!1)},option:function(e,t){var a=this.options;if(t===void 0)return a[e];var r=Wt.modifyOption(this,e,t);typeof r<"u"?a[e]=r:a[e]=t,e==="group"&&Js(a)},destroy:function(){ye("destroy",this);var e=this.el;e[ve]=null,P(e,"mousedown",this._onTapStart),P(e,"touchstart",this._onTapStart),P(e,"pointerdown",this._onTapStart),this.nativeDraggable&&(P(e,"dragover",this),P(e,"dragenter",this)),Array.prototype.forEach.call(e.querySelectorAll("[draggable]"),function(t){t.removeAttribute("draggable")}),this._onDrop(),this._disableDelayedDragEvents(),wi.splice(wi.indexOf(this.el),1),this.el=e=null},_hideClone:function(){if(!Ve){if(ye("hideClone",this),$.eventCanceled)return;S(W,"display","none"),this.options.removeCloneOnHide&&W.parentNode&&W.parentNode.removeChild(W),Ve=!0}},_showClone:function(e){if(e.lastPutMode!=="clone"){this._hideClone();return}if(Ve){if(ye("showClone",this),$.eventCanceled)return;x.parentNode==V&&!this.options.group.revertClone?V.insertBefore(W,x):nt?V.insertBefore(W,nt):V.appendChild(W),this.options.group.revertClone&&this.animate(x,W),S(W,"display",""),Ve=!1}}};function $d(i){i.dataTransfer&&(i.dataTransfer.dropEffect="move"),i.cancelable&&i.preventDefault()}function Ii(i,e,t,a,r,s,n,o){var l,c=i[ve],h=c.options.onMove,d;return window.CustomEvent&&!De&&!Gt?l=new CustomEvent("move",{bubbles:!0,cancelable:!0}):(l=document.createEvent("Event"),l.initEvent("move",!0,!0)),l.to=e,l.from=i,l.dragged=t,l.draggedRect=a,l.related=r||e,l.relatedRect=s||X(e),l.willInsertAfter=o,l.originalEvent=n,i.dispatchEvent(l),h&&(d=h.call(c,l,n)),d}function $a(i){i.draggable=!1}function Id(){Sa=!1}function Cd(i,e,t){var a=X(xt(t.el,0,t.options,!0)),r=Qs(t.el,t.options,T),s=10;return e?i.clientX<r.left-s||i.clientY<a.top&&i.clientX<a.right:i.clientY<r.top-s||i.clientY<a.bottom&&i.clientX<a.left}function Td(i,e,t){var a=X(ba(t.el,t.options.draggable)),r=Qs(t.el,t.options,T),s=10;return e?i.clientX>r.right+s||i.clientY>a.bottom&&i.clientX>a.left:i.clientY>r.bottom+s||i.clientX>a.right&&i.clientY>a.top}function Md(i,e,t,a,r,s,n,o){var l=a?i.clientY:i.clientX,c=a?t.height:t.width,h=a?t.top:t.left,d=a?t.bottom:t.right,p=!1;if(!n){if(o&&Ei<c*r){if(!Xt&&(Kt===1?l>h+c*s/2:l<d-c*s/2)&&(Xt=!0),Xt)p=!0;else if(Kt===1?l<h+Ei:l>d-Ei)return-Kt}else if(l>h+c*(1-r)/2&&l<d-c*(1-r)/2)return Fd(e)}return p=p||n,p&&(l<h+c*s/2||l>d-c*s/2)?l>h+c/2?1:-1:0}function Fd(i){return ke(x)<ke(i)?1:-1}function Pd(i){for(var e=i.tagName+i.className+i.src+i.href+i.textContent,t=e.length,a=0;t--;)a+=e.charCodeAt(t);return a.toString(36)}function jd(i){Ai.length=0;for(var e=i.getElementsByTagName("input"),t=e.length;t--;){var a=e[t];a.checked&&Ai.push(a)}}function Ci(i){return setTimeout(i,0)}function Ia(i){return clearTimeout(i)}Si&&j(document,"touchmove",function(i){($.active||Et)&&i.cancelable&&i.preventDefault()}),$.utils={on:j,off:P,css:S,find:qs,is:function(e,t){return!!Ae(e,t,e,!1)},extend:fd,throttle:Hs,closest:Ae,toggleClass:be,clone:Vs,index:ke,nextTick:Ci,cancelNextTick:Ia,detectDirection:Xs,getChild:xt,expando:ve},$.get=function(i){return i[ve]},$.mount=function(){for(var i=arguments.length,e=new Array(i),t=0;t<i;t++)e[t]=arguments[t];e[0].constructor===Array&&(e=e[0]),e.forEach(function(a){if(!a.prototype||!a.prototype.constructor)throw"Sortable: Mounted plugin must be a constructor function, not ".concat({}.toString.call(a));a.utils&&($.utils=Ce(Ce({},$.utils),a.utils)),Wt.mount(a)})},$.create=function(i,e){return new $(i,e)},$.version=_d;var J=[],Jt,Ca,Ta=!1,Ma,Fa,Ti,ei;function Dd(){function i(){this.defaults={scroll:!0,forceAutoScrollFallback:!1,scrollSensitivity:30,scrollSpeed:10,bubbleScroll:!0};for(var e in this)e.charAt(0)==="_"&&typeof this[e]=="function"&&(this[e]=this[e].bind(this))}return i.prototype={dragStarted:function(t){var a=t.originalEvent;this.sortable.nativeDraggable?j(document,"dragover",this._handleAutoScroll):this.options.supportPointer?j(document,"pointermove",this._handleFallbackAutoScroll):a.touches?j(document,"touchmove",this._handleFallbackAutoScroll):j(document,"mousemove",this._handleFallbackAutoScroll)},dragOverCompleted:function(t){var a=t.originalEvent;!this.options.dragOverBubble&&!a.rootEl&&this._handleAutoScroll(a)},drop:function(){this.sortable.nativeDraggable?P(document,"dragover",this._handleAutoScroll):(P(document,"pointermove",this._handleFallbackAutoScroll),P(document,"touchmove",this._handleFallbackAutoScroll),P(document,"mousemove",this._handleFallbackAutoScroll)),an(),Mi(),vd()},nulling:function(){Ti=Ca=Jt=Ta=ei=Ma=Fa=null,J.length=0},_handleFallbackAutoScroll:function(t){this._handleAutoScroll(t,!0)},_handleAutoScroll:function(t,a){var r=this,s=(t.touches?t.touches[0]:t).clientX,n=(t.touches?t.touches[0]:t).clientY,o=document.elementFromPoint(s,n);if(Ti=t,a||this.options.forceAutoScrollFallback||Gt||De||Vt){Pa(t,this.options,o,a);var l=Ge(o,!0);Ta&&(!ei||s!==Ma||n!==Fa)&&(ei&&an(),ei=setInterval(function(){var c=Ge(document.elementFromPoint(s,n),!0);c!==l&&(l=c,Mi()),Pa(t,r.options,c,a)},10),Ma=s,Fa=n)}else{if(!this.options.bubbleScroll||Ge(o,!0)===Te()){Mi();return}Pa(t,this.options,Ge(o,!1),!1)}}},Pe(i,{pluginName:"scroll",initializeByDefault:!0})}function Mi(){J.forEach(function(i){clearInterval(i.pid)}),J=[]}function an(){clearInterval(ei)}var Pa=Hs(function(i,e,t,a){if(e.scroll){var r=(i.touches?i.touches[0]:i).clientX,s=(i.touches?i.touches[0]:i).clientY,n=e.scrollSensitivity,o=e.scrollSpeed,l=Te(),c=!1,h;Ca!==t&&(Ca=t,Mi(),Jt=e.scroll,h=e.scrollFn,Jt===!0&&(Jt=Ge(t,!0)));var d=0,p=Jt;do{var m=p,f=X(m),v=f.top,g=f.bottom,w=f.left,k=f.right,I=f.width,E=f.height,U=void 0,B=void 0,F=m.scrollWidth,D=m.scrollHeight,N=S(m),L=m.scrollLeft,M=m.scrollTop;m===l?(U=I<F&&(N.overflowX==="auto"||N.overflowX==="scroll"||N.overflowX==="visible"),B=E<D&&(N.overflowY==="auto"||N.overflowY==="scroll"||N.overflowY==="visible")):(U=I<F&&(N.overflowX==="auto"||N.overflowX==="scroll"),B=E<D&&(N.overflowY==="auto"||N.overflowY==="scroll"));var q=U&&(Math.abs(k-r)<=n&&L+I<F)-(Math.abs(w-r)<=n&&!!L),H=B&&(Math.abs(g-s)<=n&&M+E<D)-(Math.abs(v-s)<=n&&!!M);if(!J[d])for(var te=0;te<=d;te++)J[te]||(J[te]={});(J[d].vx!=q||J[d].vy!=H||J[d].el!==m)&&(J[d].el=m,J[d].vx=q,J[d].vy=H,clearInterval(J[d].pid),(q!=0||H!=0)&&(c=!0,J[d].pid=setInterval(function(){a&&this.layer===0&&$.active._onTouchMove(Ti);var ie=J[this.layer].vy?J[this.layer].vy*o:0,Z=J[this.layer].vx?J[this.layer].vx*o:0;typeof h=="function"&&h.call($.dragged.parentNode[ve],Z,ie,i,Ti,J[this.layer].el)!=="continue"||Gs(J[this.layer].el,Z,ie)}.bind({layer:d}),24))),d++}while(e.bubbleScroll&&p!==l&&(p=Ge(p,!1)));Ta=c}},30),rn=function(e){var t=e.originalEvent,a=e.putSortable,r=e.dragEl,s=e.activeSortable,n=e.dispatchSortableEvent,o=e.hideGhostForTarget,l=e.unhideGhostForTarget;if(t){var c=a||s;o();var h=t.changedTouches&&t.changedTouches.length?t.changedTouches[0]:t,d=document.elementFromPoint(h.clientX,h.clientY);l(),c&&!c.el.contains(d)&&(n("spill"),this.onSpill({dragEl:r,putSortable:a}))}};function ja(){}ja.prototype={startIndex:null,dragStart:function(e){var t=e.oldDraggableIndex;this.startIndex=t},onSpill:function(e){var t=e.dragEl,a=e.putSortable;this.sortable.captureAnimationState(),a&&a.captureAnimationState();var r=xt(this.sortable.el,this.startIndex,this.options);r?this.sortable.el.insertBefore(t,r):this.sortable.el.appendChild(t),this.sortable.animateAll(),a&&a.animateAll()},drop:rn},Pe(ja,{pluginName:"revertOnSpill"});function Da(){}Da.prototype={onSpill:function(e){var t=e.dragEl,a=e.putSortable,r=a||this.sortable;r.captureAnimationState(),t.parentNode&&t.parentNode.removeChild(t),r.animateAll()},drop:rn},Pe(Da,{pluginName:"removeOnSpill"}),$.mount(new Dd),$.mount(Da,ja);class Od extends rt{static get properties(){return{disabled:{type:Boolean},handleSelector:{type:String},draggableSelector:{type:String}}}static get styles(){return Ft`
      :host {
        display: block;
      }
      .sortable-fallback {
    ...
    `}_getAdaptiveTextTargetsValue(){return Array.isArray(this._config?.adaptive_text_targets)?this._config.adaptive_text_targets.filter(e=>Oa.includes(e)):this._config?.adaptive_text===!0?[...Oa]:[]}_onAdaptiveTextTargetsChanged(e){const t=Array.isArray(e)?e.filter(a=>Oa.includes(a)):[];this._updateConfig("adaptive_text_targets",t)}_looksLikeTemplate(e){if(typeof e!="string")return!1;const t=e.trim();return t.includes("{{")||t.includes("{%")}_isEntityId(e){return typeof e=="string"&&/^[a-z_]+\.[a-zA-Z0-9_]+$/.test(e.trim())}setConfig(e){const t=(e.entities??[]).map(a=>typeof a=="string"?{entity_id:a}:a);this._config={...e,entities:t},this._artworkOverrides=this._normalizeArtworkOverrides(e.media_artwork_overrides)}_updateConfig(e,t){const a={...this._config,[e]:t};this._config=a,this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:a},bubbles:!0,composed:!0}))}_addArtworkOverride(){const e=[...this._artworkOverrides??[]];e.push({match_type:"media_title",match_value:"",image_url:"",size_percentage:void 0,object_fit:void 0}),this._writeArtworkOverrides(e)}_removeArtworkOverride(e){const t=[...this._artworkOverrides??[]];e<0||e>=t.length||(t.splice(e,1),this._writeArtworkOverrides(t))}_onArtworkMatchTypeChange(e,t){if(!t)return;const a=[...this._artworkOverrides??[]];if(!a[e])return;const r={...a[e],match_type:t};t==="missing_art"&&(r.match_value=""),a[e]=r,this._writeArtworkOverrides(a)}_onArtworkMatchValueChange(e,t){const a=[...this._artworkOverrides??[]];a[e]&&(a[e]={...a[e],match_value:t},this._writeArtworkOverrides(a))}_onArtworkImageUrlChange(e,t){const a=[...this._artworkOverrides??[]];a[e]&&(a[e]={...a[e],image_url:t},this._writeArtworkOverrides(a))}_onArtworkSizePercentageChange(e,t){const a=[...this._artworkOverrides??[]];if(a[e]){if(t==="")a[e]={...a[e],size_percentage:void 0};else{const r=Number(t);if(Number.isFinite(r))a[e]={...a[e],size_percentage:r};else return}this._writeArtworkOverrides(a)}}_onArtworkObjectFitChange(e,t){const a=[...this._artworkOverrides??[]];if(!a[e])return;const r=t==="default"?void 0:t;a[e]={...a[e],object_fit:r},this._writeArtworkOverrides(a)}_onArtworkMoved(e){const{oldIndex:t,newIndex:a}=e.detail??{},r=[...this._artworkOverrides??[]];if(t===void 0||a===void 0||t<0||a<0||t>=r.length||a>=r.length)return;const[s]=r.splice(t,1);r.splice(a,0,s),this._writeArtworkOverrides(r)}_updateEntityProperty(e,t){const a=[...this._config.entities??[]],r=this._entityEditorIndex;a[r]&&(a[r]={...a[r],[e]:t},this._updateConfig("entities",a))}_updateActionProperty(e,t){const a=[...this._config.actions??[]],r=this._actionEditorIndex;if(a[r]){e==="card_trigger"&&t&&t!=="none"&&a.forEach((n,o)=>{o!==r&&n.card_trigger===t&&(a[o]={...n,card_trigger:"none"})});const s={...a[r],[e]:t};e==="in_menu"&&delete s.placement,a[r]=s,this._updateConfig("actions",a)}}_deriveActionMode(e){if(!e)return"service";if(e.action==="prev_entity")return"prev_entity";if(e.action==="next_entity")return"next_entity";if(e.action==="select_entity")return"select_entity";if(e.action==="sync_selected_entity"||e.sync_entity_helper)return"sync_selected_entity";if(typeof e.menu_item=="string"&&e.menu_item.trim()!=="")return"menu";const t=typeof e.navigation_path=="string"?e.navigation_path.trim():"";return e.action==="navigate"||t?"navigate":"service"}static get styles(){return Ft`
      ...
      `}render(){if(!this._config)return _``;const e=this._entityEditorIndex!==null,t=this._actionEditorIndex!==null;return _`
        <div class="tabs">
          ${["entities","behavior","look_and_feel","artwork","actions"].map(a=>{const r=u(`editor.tabs.${a}`);return _`
              <button
          ...
          <div class="form-row form-row-multi-column">
            <div class="grow-children">
              <ha-selector
                ...
                .selector=${{select:{mode:"dropdown",options:[{value:"cover",label:"Cover (default)"},{value:"contain",label:"Contain"},{value:"fill",label:"Fill"},{value:"scale-down",label:"Scale Down"},{value:"scaled-contain",label:"Scaled Contain"},{value:"scaled-contain-alternate",label:"Scaled Contain Alternate"},{value:"none",label:"None"},{value:"no_artwork",label:u("editor.fields.no_artwork_option")}]}}}
                        ...
                        <div class="form-row-multi-column" style="gap:12px; flex-wrap:wrap; align-items:flex-start;">
                          ...
                          <div class="grow-children" style="flex:1.5;">
                            <ha-selector
                              ...
                              .selector=${{select:{mode:"dropdown",options:[{value:"default",label:"Default"},{value:"cover",label:"Cover"},{value:"contain",label:"Contain"},{value:"fill",label:"Fill"},{value:"scale-down",label:"Scale Down"},{value:"scaled-contain",label:"Scaled Contain"},{value:"scaled-contain-alternate",label:"Scaled Contain Alternate"},{value:"none",label:"None"},{value:"no_artwork",label:u("editor.fields.no_artwork_option")}]}}}
      ...
      `}_renderVisualTab(){const e=this._config.volume_mode==="stepper"?_`
        ...
        <div class="form-row">
          <div class="full-width">
            ...
            <ha-selector
              .hass=${this.hass}
              .selector=${{select:{multiple:!0,options:sn}}}
...
{% endif %}</pre>
    ...
    `:_`
      ...
      ${(()=>{const r=e?.entity_id,s=r?this.hass?.states?.[r]:void 0,n=s?ht(s):!1,o=e?.music_assistant_entity,l=this._looksLikeTemplate?.(o),c=typeof o=="string"&&!l?o:void 0,h=c?this.hass?.states?.[c]:void 0,d=h?ht(h):!1;return n||d?_`
          <div class="form-row">
            <ha-selector
              .hass=${this.hass}
...
{% endif %}</pre>
      ...
      <div class="entity-options-menu ${a?"chips-in-menu":""} entity-options-scroll" style="display:flex; flex-direction:column;">
        <button class="entity-options-item" @click=${()=>{const r=this._getResolvedEntitiesForCurrentChip();r.length===1?(this._openMoreInfoForEntity(r[0]),this._showEntityOptions=!1):this._showResolvedEntities=!0,this.requestUpdate()}}>${u("card.menu.more_info")}</button>
    ...
    `}_renderGroupingMenuOption(){if(this.entityIds.length<=1)return y;const e=this.entityIds.reduce((n,o,l)=>{const c=this._getGroupingEntityId(l),h=this.hass.states[c];return n+(this._isGroupCapable(h)?1:0)},0),t=this._getGroupingEntityId(this._selectedIndex),a=this.hass.states[t],r=this.currentEntityId,s=this._getGroupKey(r)!==r;return e>1&&this._isGroupCapable(a)&&!s?_`
      ...
      `;const f=[...n].sort((v,g)=>{if(s){if(v.id===e)return-1;if(g.id===e)return 1}else{if(v.id===l)return-1;if(g.id===l)return 1}return v.isBusy===g.isBusy?0:v.isBusy?1:-1});return _`
      ...
      <div style="display:flex; align-items:center; gap:8px; margin-bottom:12px;">
        ...
        <button class="entity-options-item"
          ...
          ${u(s?"card.grouping.ungroup_all":"card.grouping.group_all")}
        </button>
      </div>
      <div class="group-list-scroll">
        ...
        `:f.map(v=>{const g=v.id,w=v.groupId,k=(Array.isArray(r?.attributes?.group_members)?r.attributes.group_members:[]).includes(w),I=this.getChipName(g),E=v.isBusy,U=v.busyLabel,B=this.entityIds.indexOf(g),F=this._getVolumeEntityForGrouping(B)||w,D=this.hass.states[F],N=F?.startsWith&&F.startsWith("remote."),L=Number(D?.attributes?.volume_level||0),M=g===e,q=!M;let H=u(s?M?"card.grouping.master":k?"card.grouping.joined":"card.grouping.available":g===l?"card.grouping.current":"card.grouping.available");return E&&(H=U||"Unavailable"),_`
                ...
                ${N?_`
                  ...
                  `:_`
                    <input
                      ...
                      step="0.01"
                      .value=${L}
                      @change=${te=>this._onGroupVolumeChange(g,F,te)}
                      title="Volume"
          ...
          <div style="display:flex;flex-direction:column;gap:8px;">
            ${e.map(t=>_`
              <button
                ...
                ${t.state?_`<div style="margin-left:auto;font-size:0.82em;opacity:0.7;text-transform:capitalize;">${t.state}</div>`:y}
              </button>
            `)}
          </div>
        `:_`
    ...
    `}updated(e){if(this._updateHostAttributes(),this._idleImageTemplate&&e.has("hass")&&(this._idleImageTemplateNeedsResolve=!0),(e.has("_selectedIndex")||e.has("hass"))&&this._updateTransferQueueAvailability({refresh:!1}),this.hass&&this._hasMassQueueIntegration===null&&!this._checkingMassQueueIntegration&&(this._checkingMassQueueIntegration=!0,this._isMassQueueIntegrationAvailable(this.hass).then(r=>{this._hasMassQueueIntegration=r,r&&(this._massQueueAvailable=this._massQueueAvailable||r)}).catch(()=>{this._hasMassQueueIntegration=!1}).finally(()=>{this._checkingMassQueueIntegration=!1,this.requestUpdate()})),this.hass&&this.entityIds){if(this._upcomingFilterActive){const o=this.currentActivePlaybackEntityId;if(o){const l=this.hass.states[o]?.attributes?.media_title;if(l&&l!==this._lastMediaTitle&&(this._lastMediaTitle=l,this._upcomingFilterActive)){const c=Date.now();this._latestManualShiftTime&&c-this._latestManualShiftTime<4e3||this._advanceQueueInUI(null,!1),this._refreshQueue({delayMs:2e4})}}}const r=Date.now();for(let o=0;o<this.entityIds.length;o++){const l=this.entityIds[o],c=this.entityObjs[o];if(!c)continue;const h=c.entity_id,d=this._getActualResolvedMaEntityForState(o),p=this.hass.states[h]?.state,m=this._playerStateCache[h];if(p==="playing"?(this._playTimestamps[h]=r,this._lastActiveEntityIdByChip[o]=h):m==="playing"&&p!=="playing"&&(this._playTimestamps[h]=r),this._playerStateCache[h]=p,d&&d!==h){const v=this.hass.states[d]?.state,g=this._playerStateCache[d];v==="playing"?(this._playTimestamps[d]=r,this._lastActiveEntityIdByChip[o]=d):g==="playing"&&v!=="playing"&&(this._playTimestamps[d]=r),this._playerStateCache[d]=v}const f=this._getEntityForPurpose(o,"sorting");f&&this.hass.states[f]?.state==="playing"&&(this._playTimestamps[l]=r)}if(this._manualSelect&&this._pinnedIndex===null&&this._manualSelectPlayingSet){for(const o of[...this._manualSelectPlayingSet]){const l=this.hass.states[o];this._isEntityPlaying(l)||this._manualSelectPlayingSet.delete(o)}for(const o of this.entityIds){const l=this.hass.states[o];if(this._isEntityPlaying(l)&&!this._manualSelectPlayingSet.has(o)){this._manualSelect=!1,this._manualSelectPlayingSet=null;break}}}if(this._updateIdleState(),!this._manualSelect&&!this.isAnyMenuOpen){const o=this.sortedEntityIds;if(o.length>0){let l=o[0];const c=l?(this.groupedSortedEntityIds||[]).find(f=>f.includes(l)):null;if(c&&c.length>1){const f=this._getActualGroupMaster(c);f&&(l=f)}const h=this.entityIds.indexOf(l),d=h>=0?this._getEntityForPurpose(h,"sorting"):null,p=d?this.hass.states[d]:null,m=this._isCurrentEntityPlaying();this._isEntityPlaying(p)&&this.entityIds[this._selectedIndex]!==l&&(!this._idleTimeout||!this._hasSeenPlayback)&&!m&&!this.entityObjs[h]?.disable_auto_select&&(this._selectedIndex=h)}}const s=this.entityIds[this._selectedIndex],n=s?(this.groupedSortedEntityIds||[]).find(o=>o.includes(s)):null;if(n&&n.length>1){const o=this._getActualGroupMaster(n);if(o&&o!==s){const l=this.entityIds.indexOf(o);l>=0&&!this.entityObjs[l]?.disable_auto_select&&(this._selectedIndex=l,this._lastGroupingMasterId=o)}}this._ensureResolvedMaForIndex(this._selectedIndex),this._ensureResolvedVolForIndex(this._selectedIndex),this._updateSelectedEntityHelper(),this._handleSelectEntityFromHelper()}super.updated?.(e),this._progressTimer&&(clearInterval(this._progressTimer),this._progressTimer=null);const t=this.currentActivePlaybackStateObj||this.currentPlaybackStateObj||this.currentStateObj;if(this._isEntityPlaying(t)&&t.attributes.media_duration&&(this._progressTimer=setInterval(()=>{this.requestUpdate()},500)),this._alwaysCollapsed&&this._expandOnSearch&&this._showSearchInSheet){this._prevCollapsed!==!1&&(this._prevCollapsed=!1,this._notifyResize());return}const a=this._alwaysCollapsed?!0:this._collapseOnIdle?this._isIdle:!1;if(this._prevCollapsed!==a&&(this._prevCollapsed=a,this._notifyResize()),this._addGrabScroll(".chip-row"),this._addGrabScroll(".action-chip-row"),this._addGrabScroll(".search-filter-chips"),this._addVerticalGrabScroll(".floating-source-index"),this._lastRenderedCollapsed&&!this._lastRenderedHideControls){const r=this.renderRoot?.querySelector(".card-lower-content");if(r){const s=r.offsetHeight;if(s&&s>0){const n=Number(this.config?.card_height);Number.isFinite(n)&&n>0?(!this._collapsedBaselineHeight||s<this._collapsedBaselineHeight-1)&&(this._collapsedBaselineHeight=s):this._collapsedBaselineHeight=s}}}this._showSearchInSheet&&(this._alwaysCollapsed&&this._expandOnSearch,setTimeout(()=>{const r=()=>{const o=this.renderRoot.querySelector("#search-input-box");return o?(o.focus(),this._searchInputAutoFocused=!0,!0):!1};!this._disableSearchAutofocus&&!this._searchInputAutoFocused&&(r()||setTimeout(()=>{this._showSearchInSheet&&!this._disableSearchAutofocus&&!this._searchInputAutoFocused&&r()},200));const s=this._getVisibleSearchFilterClasses().join(",");if((!this._searchLoading||s)&&this._lastSearchChipClasses!==s){const o=this.renderRoot.querySelector(".search-filter-chips");o&&(o.scrollLeft=0);const l=this.renderRoot.querySelector(".entity-options-overlay");l&&(l.scrollTop=0);const c=this.renderRoot.querySelector(".entity-options-sheet");c&&(c.scrollTop=0),this._lastSearchChipClasses=s}const n=this.renderRoot.querySelector("#search-filter-chip-row");n&&(n.scrollWidth>n.clientWidth+2?n.style.justifyContent="flex-start":n.style.justifyContent="center")},200)),this._showSourceList&&setTimeout(()=>{const r=this.renderRoot.querySelector(".entity-options-overlay");r&&(r.scrollTop=0)},0)}_toggleSourceMenu(){this._showSourceMenu=!this._showSourceMenu,this._showSourceMenu?(this._manualSelect=!0,setTimeout(()=>{this._shouldDropdownOpenUp=!0,this.requestUpdate(),this._addSourceDropdownOutsideHandler()},0)):(this._manualSelect=!1,this._removeSourceDropdownOutsideHandler())}_addSourceDropdownOutsideHandler(){this._sourceDropdownOutsideHandler||(this._sourceDropdownOutsideHandler=e=>{const t=this.renderRoot.querySelector(".source-dropdown"),a=this.renderRoot.querySelector(".source-menu-btn"),r=e.composedPath?e.composedPath():[];t&&r.includes(t)||a&&r.includes(a)||(this._showSourceMenu=!1,this._manualSelect=!1,this._removeSourceDropdownOutsideHandler(),this.requestUpdate())},window.addEventListener("mousedown",this._sourceDropdownOutsideHandler,!0),window.addEventListener("touchstart",this._sourceDropdownOutsideHandler,!0))}_removeSourceDropdownOutsideHandler(){this._sourceDropdownOutsideHandler&&(window.removeEventListener("mousedown",this._sourceDropdownOutsideHandler,!0),window.removeEventListener("touchstart",this._sourceDropdownOutsideHandler,!0),this._sourceDropdownOutsideHandler=null)}_selectSource(e){const t=this.currentEntityId;!t||!e||(this.hass.callService("media_player","select_source",{entity_id:t,source:e}),this._closeEntityOptions())}_onPinClick(e){e.stopPropagation(),this._manualSelect=!1,this._pinnedIndex=null,this._manualSelectPlayingSet=null}_onChipClick(e){if(this._holdToPin&&this._justPinned){this._justPinned=!1;return}if(this._selectedIndex=e,this._lastActiveEntityId=null,clearTimeout(this._manualSelectTimeout),this._holdToPin)if(this._pinnedIndex!==null)this._manualSelect=!0;else{this._manualSelect=!0,this._manualSelectPlayingSet=new Set;for(const t of this.entityIds){const a=this.hass?.states?.[t];this._isEntityPlaying(a)&&this._manualSelectPlayingSet.add(t)}}else this._manualSelect=!0,this._pinnedIndex=e;this.requestUpdate()}_pinChip(e){this._justPinned=!0,clearTimeout(this._manualSelectTimeout),this._manualSelectPlayingSet=null,this._pinnedIndex=e,this._manualSelect=!0,this.requestUpdate()}async _onActionChipClick(e){const t=this.config.actions[e];t&&await this._handleAction(t)}async _handleAction(e){if(!e)return;if(e.menu_item){switch(this._quickMenuInvoke=!0,e.menu_item){case"more-info":this._openMoreInfo(),this._showEntityOptions=!1,this.requestUpdate();break;case"group-players":this._showEntityOptions=!0,this._showGrouping=!0,this.requestUpdate();break;case"search":this._openQuickSearchOverlay();break;case"search-recently-played":this._showEntityOptions=!0,this._showSearchSheetInOptions("recently-played"),setTimeout(()=>{this._notifyResize()},0);break;case"search-next-up":this._showEntityOptions=!0,this._showSearchSheetInOptions("next-up"),setTimeout(()=>{this._notifyResize()},0);break;case"source":this._showEntityOptions=!0,this._showSourceList=!0,this._showGrouping=!1,this.requestUpdate();break;case"transfer-queue":this._showEntityOptions=!0,this._openTransferQueue();break}return}if(typeof e.navigation_path=="string"&&e.navigation_path.trim()!==""||e.action==="navigate"){let s=(typeof e.navigation_path=="string"?e.navigation_path:e.path||"").trim();const n=e.navigation_new_tab===!0,o={current:this.currentActivePlaybackEntityId||this.currentEntityId||""};let l=null;n&&(l=ko(this.hass,s,o)),l!=null?this._handleNavigate(l,n):(s=await wo(this.hass,s,o),this._handleNavigate(s,n));return}if(e.action==="prev_entity"||e.action==="next_entity"){const s=this.sortedEntityIds;if(s&&s.length>0){const n=this.entityIds[this._selectedIndex],o=s.indexOf(n);if(o!==-1){let l=o;if(e.action==="prev_entity"?l=Math.max(0,o-1):l=Math.min(s.length-1,o+1),l!==o){const c=s[l],h=this.entityIds.indexOf(c);h!==-1&&h!==this._selectedIndex&&this._onChipClick(h)}}}return}if(!e.service)return;const[t,a]=e.service.split(".");let r={...e.service_data||{}};if(t==="script"&&e.script_variable===!0){const s=this.currentEntityId,n=this._getSearchEntityId(this._selectedIndex),o=await this._resolveTemplateAtActionTime(n,s),l=this.currentActivePlaybackEntityId||this._getPlaybackEntityId(this._selectedIndex),c=await this._resolveTemplateAtActionTime(l,s);(r.entity_id==="current"||r.entity_id==="$current"||r.entity_id==="this")&&delete r.entity_id,r.yamp_entity=o||s,r.yamp_main_entity=s,r.yamp_playback_entity=c}else if(!(t==="script"&&e.script_variable===!0)&&(r.entity_id==="current"||r.entity_id==="$current"||r.entity_id==="this"||!r.entity_id))if(t==="music_assistant"){const s=this._getSearchEntityId(this._selectedIndex);r.entity_id=await this._resolveTemplateAtActionTime(s,this.currentEntityId)}else if(t==="media_player"){const s=this.currentActivePlaybackEntityId||this._getPlaybackEntityId(this._selectedIndex);r.entity_id=await this._resolveTemplateAtActionTime(s,this.currentEntityId)}else r.entity_id=this.currentEntityId;this.hass.callService(t,a,r)}_onTapAreaPointerDown(e){this.isAnyMenuOpen||e.composedPath().some(t=>t.tagName==="BUTTON"||t.tagName==="HA-ICON"||t.tagName==="INPUT"||t.classList&&t.classList.contains("clickable-artist")||t.classList&&t.classList.contains("details"))||(this._gestureActive=!0,this._gestureStartTime=Date.now(),this._gestureStartX=e.clientX,this._gestureStartY=e.clientY,this._gestureHoldTriggered=!1,this._gestureTapArea=e.currentTarget,this._cardTriggers?.hold&&(this._gestureHoldTimer=setTimeout(()=>{this._gestureActive&&(this._gestureHoldTriggered=!0,this._showGestureFeedback("hold",this._gestureStartX,this._gestureStartY),this._handleAction(this._cardTriggers.hold))},cn)))}_onTapAreaPointerMove(e){if(!this._gestureActive)return;const t=Math.abs(e.clientX-this._gestureStartX),a=Math.abs(e.clientY-this._gestureStartY);(t>St||a>St)&&clearTimeout(this._gestureHoldTimer)}_onTapAreaPointerUp(e){if(!this._gestureActive||(this._gestureActive=!1,clearTimeout(this._gestureHoldTimer),this._gestureHoldTriggered)||Date.now()-this._gestureStartTime>cn)return;const t=e.clientX-this._gestureStartX,a=e.clientY-this._gestureStartY,r=Math.abs(t),s=Math.abs(a);if(r>=un&&s<un){clearTimeout(this._tapTimer);const h=e.clientX,d=e.clientY;if(t<0&&this._cardTriggers?.swipe_left){this._showGestureFeedback("swipe_left",h,d),this._handleAction(this._cardTriggers.swipe_left);return}else if(t>0&&this._cardTriggers?.swipe_right){this._showGestureFeedback("swipe_right",h,d),this._handleAction(this._cardTriggers.swipe_right);return}}if(r>St||s>St)return;const n=Date.now(),o=n-(this._lastTapTime||0);this._lastTapTime=n;const l=e.clientX,c=e.clientY;o<dn?(clearTimeout(this._tapTimer),this._cardTriggers?.double_tap&&(this._showGestureFeedback("double_tap",l,c),this._handleAction(this._cardTriggers.double_tap))):this._tapTimer=setTimeout(()=>{this._cardTriggers?.tap&&(this._showGestureFeedback("tap",l,c),this._handleAction(this._cardTriggers.tap))},Hd)}_showGestureFeedback(e,t,a){const r=this._gestureTapArea||this.shadowRoot?.querySelector(".card-artwork-spacer")||this.shadowRoot?.querySelector(".collapsed-artwork-container");if(!r)return;const s=r.getBoundingClientRect(),n=t-s.left,o=a-s.top,l=document.createElement("div");l.className=`gesture-ripple ${e}`,l.style.left=`${n}px`,l.style.top=`${o}px`;let c=r.querySelector(".gesture-feedback-container");c||(c=document.createElement("div"),c.className="gesture-feedback-container",r.appendChild(c)),l.addEventListener("animationend",()=>l.remove()),c.appendChild(l)}_onMenuActionClick(e){const t=this.config.actions?.[e];t&&(t.menu_item||(this._quickMenuInvoke=!0),this._onActionChipClick(e),t.menu_item||this._dismissWithAnimation())}_getActionLabel(e){if(!e)return"";if(typeof e.name=="string"&&e.name.trim()!=="")return e.name.trim();const t=!!e.icon;return e.menu_item?t?"":{search:"Search","search-recently-played":"Recently Played","search-next-up":"Next Up",source:"Source","more-info":"More Info","group-players":"Group Players","transfer-queue":"Transfer Queue"}[e.menu_item]??e.menu_item:typeof e.navigation_path=="string"&&e.navigation_path.trim()!==""||e.action==="navigate"?t?"":"Navigate":e.service?t?"":e.service:t?"":"Action"}async _onControlClick(e){const t=this._getEntityForPurpose(this._selectedIndex,"playback_control");if(!t)return;const a=this.hass?.states?.[t]||this.currentStateObj;switch(e){case"play_pause":this._isEntityPlaying(a)?(this.hass.callService("media_player","media_pause",{entity_id:t}),this._lastPlayingEntityIdByChip||(this._lastPlayingEntityIdByChip={}),this._lastPlayingEntityIdByChip[this._selectedIndex]=t,this._pauseTimestamps||(this._pauseTimestamps={}),this._pauseTimestamps[this._selectedIndex]=Date.now(),this._controlFocusEntityId=t,this._optimisticPlayback={entity_id:t,state:"paused",ts:Date.now()},this.requestUpdate(),setTimeout(()=>{this._optimisticPlayback=null,this.requestUpdate()},1200)):(this.hass.callService("media_player","media_play",{entity_id:t}),this._lastPlayingEntityIdByChip&&delete this._lastPlayingEntityIdByChip[this._selectedIndex],this._pauseTimestamps&&delete this._pauseTimestamps[this._selectedIndex],this._controlFocusEntityId=t,this._optimisticPlayback={entity_id:t,state:"playing",ts:Date.now()},this.requestUpdate(),setTimeout(()=>{this._optimisticPlayback=null,this.requestUpdate()},1200));break;case"next":this._advanceQueueInUI(null,!0),this.hass.callService("media_player","media_next_track",{entity_id:t});break;case"prev":this.hass.callService("media_player","media_previous_track",{entity_id:t});break;case"stop":if(this.hass.callService("media_player","media_stop",{entity_id:t}),a){const r=t;this._optimisticPlayback={entity_id:r,state:"idle",ts:Date.now()},this.requestUpdate(),setTimeout(()=>{this._optimisticPlayback=null,this.requestUpdate()},1200)}break;case"shuffle":{const r=!!a.attributes.shuffle;this.hass.callService("media_player","shuffle_set",{entity_id:t,shuffle:!r});break}case"repeat":{let r=a.attributes.repeat||"off",s;r==="off"?s="all":r==="all"?s="one":s="off",this.hass.callService("media_player","repeat_set",{entity_id:t,repeat:s});break}case"power":{const r=this.currentEntityId,s=(this.hass?.states?.[r]||a)?.state==="off"?"turn_on":"turn_off";this.hass.callService("media_player",s,{entity_id:r});const n=this.entityObjs[this._selectedIndex];if(n&&n.sync_power){const o=this._getVolumeEntity(this._selectedIndex);o&&o!==n.entity_id&&this.hass.callService("media_player",s,{entity_id:o})}break}case"favorite":{const r=this._getFavoriteButtonEntity(),s=this.hass?.states?.[t]?.attributes?.media_content_id,n=this._isCurrentTrackFavorited(),o=await this._isMassQueueIntegrationAvailable(this.hass);if(n&&o){const l=this._getMusicAssistantState()?.entity_id;if(l)try{const c={type:"call_service",domain:"mass_queue",service:"unfavorite_current_item",service_data:{entity:l}};await this.hass.connection.sendMessagePromise(c),s&&(this._favoriteStatusCache||(this._favoriteStatusCache={}),this._favoriteStatusCache[s]={isFavorited:!1}),this._searchResultsByType&&Object.keys(this._searchResultsByType).forEach(h=>{(h.includes("_favorites")||h==="favorites")&&delete this._searchResultsByType[h]}),this._checkingFavorites=null,this.requestUpdate()}catch(c){console.error("yamp: Failed to unfavorite current item:",c)}}else r&&(this.hass.callService("button","press",{entity_id:r}),s&&(this._favoriteStatusCache||(this._favoriteStatusCache={}),this._favoriteStatusCache[s]={isFavorited:!0},this._checkingFavorites=null,this._searchResultsByType&&Object.keys(this._searchResultsByType).forEach(l=>{(l.includes("_favorites")||l==="favorites")&&delete this._searchResultsByType[l]}),this.requestUpdate()));break}}}async _onVolumeChange(e){const t=this._selectedIndex,a=this._getGroupingEntityId(t),r=await this._resolveTemplateAtActionTime(a,this.currentEntityId),s=this.hass.states[r],n=Number(e.target.value),o=this.entityObjs[t];if(!(typeof o.group_volume!="boolean"||o.group_volume)||this._quickGroupingMode){this.hass.callService("media_player","volume_set",{entity_id:this._getVolumeEntity(t),volume_level:n});return}if(this._isCurrentlyGrouped(s)){const l=this.entityObjs[t].entity_id,c=[...new Set([l,...s.attributes.group_members])],h=typeof this._groupBaseVolume=="number"?this._groupBaseVolume:Number(this.currentVolumeStateObj?.attributes.volume_level||0),d=n-h;for(const p of c){for(const g of this.entityObjs){let w;if(g.music_assistant_entity)if(typeof g.music_assistant_entity=="string"&&(g.music_assistant_entity.includes("{{")||g.music_assistant_entity.includes("{%")))try{w=await this._resolveTemplateAtActionTime(g.music_assistant_entity,g.entity_id)}catch{w=g.entity_id}else w=g.music_assistant_entity;else w=g.entity_id;if(w===p)break}const m=p,f=this.hass.states[m];if(!f)continue;let v=Number(f.attributes.volume_level||0)+d;v=Math.max(0,Math.min(1,v)),v=Math.round(v*1e4)/1e4,this.hass.callService("media_player","volume_set",{entity_id:m,volume_level:v})}this._groupBaseVolume=n}else{const l=this._getVolumeEntity(t);this.hass.callService("media_player","volume_set",{entity_id:l,volume_level:n})}}async _onVolumeStep(e){const t=this._selectedIndex,a=this._getVolumeEntity(t);if(!a)return;const r=a.startsWith&&a.startsWith("remote."),s=this.currentVolumeStateObj;if(!s)return;if(r){this.hass.callService("remote","send_command",{entity_id:a,command:e>0?"volume_up":"volume_down"});return}const n=this._getGroupingEntityId(t),o=await this._resolveTemplateAtActionTime(n,this.currentEntityId),l=this.hass.states[o];if(this._isCurrentlyGrouped(l)){const c=this.entityObjs[t].entity_id,h=[...new Set([c,...l.attributes.group_members])],d=this._volumeStep*e;for(const p of h){for(const g of this.entityObjs){let w;if(g.music_assistant_entity)if(typeof g.music_assistant_entity=="string"&&(g.music_assistant_entity.includes("{{")||g.music_assistant_entity.includes("{%")))try{w=await this._resolveTemplateAtActionTime(g.music_assistant_entity,g.entity_id)}catch{w=g.entity_id}else w=g.music_assistant_entity;else w=g.entity_id;if(w===p)break}const m=p,f=this.hass.states[m];if(!f)continue;let v=Number(f.attributes.volume_level||0)+d;v=Math.max(0,Math.min(1,v)),v=Math.round(v*1e4)/1e4,this.hass.callService("media_player","volume_set",{entity_id:m,volume_level:v})}}else{let c=Number(s.attributes.volume_level||0);c+=this._volumeStep*e,c=Math.max(0,Math.min(1,c)),c=Math.round(c*1e4)/1e4,this.hass.callService("media_player","volume_set",{entity_id:a,volume_level:c})}}async _onMuteToggle(){const e=this._selectedIndex,t=this._getVolumeEntity(e);if(!t)return;const a=t.startsWith&&t.startsWith("remote."),r=this.currentVolumeStateObj;if(!r)return;const s=r.attributes.is_volume_muted??!1,n=r.attributes.volume_level??0;if(a){s?this.hass.callService("media_player","volume_set",{entity_id:t,volume_level:.5}):this.hass.callService("media_player","volume_set",{entity_id:t,volume_level:0});return}if(!this._supportsFeature(r,va)){if(n>0)this._previousVolume=n,this.hass.callService("media_player","volume_set",{entity_id:t,volume_level:0});else{const h=this._previousVolume??.5;this.hass.callService("media_player","volume_set",{entity_id:t,volume_level:h}),this._previousVolume=null}return}let o,l,c;try{o=this._getGroupingEntityId(e),l=await this._resolveTemplateAtActionTime(o,this.currentEntityId),c=this.hass.states[l]}catch(h){console.error("yamp: Error in grouping detection:",h)}if(this._isCurrentlyGrouped(c)){const h=this.entityObjs[e].entity_id,d=[...new Set([h,...c.attributes.group_members])];for(const p of d){const m=p,f=this.hass.states[m];f&&this._supportsFeature(f,va)?this.hass.callService("media_player","volume_mute",{entity_id:m,is_volume_muted:!s}):(f?.attributes?.volume_level??0)>0?this.hass.callService("media_player","volume_set",{entity_id:m,volume_level:0}):this.hass.callService("media_player","volume_set",{entity_id:m,volume_level:.5})}}else this.hass.callService("media_player","volume_mute",{entity_id:t,is_volume_muted:!s})}_onVolumeDragStart(e){if(!this.hass)return;const t=this.currentVolumeStateObj;this._groupBaseVolume=t?Number(t.attributes.volume_level||0):0}_onVolumeDragEnd(e){this._groupBaseVolume=null}_onGroupVolumeChange(e,t,a){const r=Number(a.target.value);this.hass.callService("media_player","volume_set",{entity_id:t,volume_level:r}),this.requestUpdate()}_onGroupVolumeStep(e,t){this.hass.callService("remote","send_command",{entity_id:e,command:t>0?"volume_up":"volume_down"}),this.requestUpdate()}_onSourceChange(e){const t=this.currentEntityId,a=e.target.value;!t||!a||this.hass.callService("media_player","select_source",{entity_id:t,source:a})}_openMoreInfo(){this.dispatchEvent(new CustomEvent("hass-more-info",{detail:{entityId:this.currentEntityId},bubbles:!0,composed:!0}))}async _onProgressBarClick(e){try{e.stopPropagation();const t=this.currentEntityId,a=this._getActualResolvedMaEntityForState(this._selectedIndex),r=t?this.hass?.states?.[t]:null,s=a?this.hass?.states?.[a]:null;let n;if(this._controlFocusEntityId&&(this._controlFocusEntityId===a||this._controlFocusEntityId===t))n=this._controlFocusEntityId;else if(this._isEntityPlaying(s))n=a;else if(this._isEntityPlaying(r))n=t;else{const p=this._lastPlayingEntityIdByChip?.[this._selectedIndex];if(p&&(p===a||p===t))n=p;else{const m=this._getPlaybackEntityId(this._selectedIndex);n=await this._resolveTemplateAtActionTime(m,this.currentEntityId)}}const o=this.hass?.states?.[n]||this.currentStateObj;if(!n||!o||!o.attributes){console.warn("YAMP: Cannot seek - invalid target or state",n,o);return}const l=o.attributes.media_duration;if(!l)return;const c=e.target.getBoundingClientRect(),h=(e.clientX-c.left)/c.width,d=Math.floor(h*l);this._seekAnchor={position:d,timestamp:Date.now(),trackId:o.attributes.media_content_id||o.attributes.media_title},this._seekConvergenceLock=Date.now()+2e3,this._seekOffset=null,this.requestUpdate(),this.hass.callService("media_player","media_seek",{entity_id:n,seek_position:d})}catch(t){console.error("YAMP: Error in _onProgressBarClick",t)}}_resetSearchContext(){this._searchResultsByType={},this._favoritesFilterActive=!1,this._recentlyPlayedFilterActive=!1,this._upcomingFilterActive=!1,this._recommendationsFilterActive=!1,this._initialFavoritesLoaded=!1,this._loadingSearchRowMenuId=null,this._errorSearchRowMenuId=null}_showSearchSuccessToast(e=null,t=null){this._showQueueSuccessMessage=!0,e&&(this._successSearchRowMenuId=e),t&&(this._successSearchRowType=t),this.requestUpdate(),this._successToastHandle&&clearTimeout(this._successToastHandle),this._successToastHandle=setTimeout(()=>{this._showQueueSuccessMessage=!1,this._successSearchRowMenuId=null,this._successSearchRowType=null,this._successToastHandle=null,this.requestUpdate()},nn)}render(){if(!this.hass||!this.config)return y;const e=this.config.card_height,t=typeof e=="string"?e:Number(e),a=typeof t=="number"&&Number.isFinite(t)&&t>0||typeof t=="string"&&t.trim()!=="",r=this._collapsedBaselineHeight||220,s=this.entityObjs.length===1,n=s&&this.config.always_collapsed===!0&&this.config.expand_on_search!==!0,o=this.config.pin_search_headers===!0&&!n,l=!(this.config.hide_search_headers_on_idle===!0&&this._isIdle);if(this.shadowRoot&&this.shadowRoot.host){this.shadowRoot.host.setAttribute("data-match-theme",String(this.config.match_theme===!0)),this.shadowRoot.host.setAttribute("data-always-collapsed",String(this.config.always_collapsed===!0)),this.shadowRoot.host.setAttribute("data-card-type",this.config.card_type||"default");const b=this.config.always_collapsed===!0&&this.config.pin_search_headers===!0&&this.config.expand_on_search===!0;this.shadowRoot.host.setAttribute("data-hide-menu-player",String(this.config.hide_menu_player===!0||b)),this.shadowRoot.host.setAttribute("data-extend-artwork",String(this.config.extend_artwork===!0)),this.shadowRoot.host.setAttribute("data-control-layout",this._controlLayout),this.shadowRoot.host.setAttribute("data-pin-search-headers",String(o)),a?this.shadowRoot.host.setAttribute("data-has-custom-height","true"):this.shadowRoot.host.removeAttribute("data-has-custom-height")}const c=this.config.show_chip_row||"auto",h=this.entityObjs.length>1,d=(c==="in_menu"||c==="in_menu_on_idle"&&this._isIdle)&&h,p=c!=="in_menu"&&(h||c==="always"),m=c==="in_menu_on_idle"&&this._isIdle&&h,f=c==="in_menu_on_idle"&&h&&!this._showSearchInSheet,v=(this.config.actions??[]).map((b,O)=>({action:b,idx:O})).filter(({action:b})=>b?.action!=="sync_selected_entity"&&b?.action!=="select_entity"),g=b=>b?.placement?b.placement:b?.in_menu==="hidden"?"hidden":b?.in_menu===!0?"menu":"chip",w=v.filter(({action:b})=>g(b)==="chip"),k=v.filter(({action:b})=>g(b)==="menu"),I=v.find(({action:b})=>b?.card_trigger==="tap"),E=v.find(({action:b})=>b?.card_trigger==="hold"),U=v.find(({action:b})=>b?.card_trigger==="double_tap"),B=v.find(({action:b})=>b?.card_trigger==="swipe_left"),F=v.find(({action:b})=>b?.card_trigger==="swipe_right");this._cardTriggers={tap:I?.action,hold:E?.action,double_tap:U?.action,swipe_left:B?.action,swipe_right:F?.action};const D=this.currentActivePlaybackStateObj||this.currentPlaybackStateObj||this.currentStateObj,N=this.getChipName(this.currentEntityId);if(!D)return _`<div class="details">${u("common.not_found")}</div>`;const L=this._getHiddenControlsForCurrentEntity(),M=!!this._getFavoriteButtonEntity()&&!L.favorite,q=this._isCurrentTrackFavorited(),H=!L.power&&(this._supportsFeature(D,od)||this._supportsFeature(D,nd)),te=this._controlLayout==="modern"&&H,ie=this._controlLayout==="modern"&&M;let Z=y;te?Z=_`
        ...
        >
          <ha-icon
            style=${q?"color: var(--custom-accent);":y}
            .icon=${q?"mdi:heart":"mdi:heart-outline"}
          ></ha-icon>
        </button>
      `:y,oe=D.attributes.source_list||[],$e=new Set(oe.map(b=>b&&b[0]?b[0].toUpperCase():"")),_e="ABCDEFGHIJKLMNOPQRSTUVWXYZ".split("");this._idleImageTemplate&&this._idleImageTemplateNeedsResolve&&!this._resolvingIdleImageTemplate&&this._isIdle&&this._resolveIdleImageTemplate();const ae=this._idleImageTemplate?this._idleImageTemplateResult:this.config.idle_image,Re=this._normalizeImageSourceValue(ae);let ze=null;if(Re&&this._isIdle)if(this.hass.states[Re]){const b=this.hass.states[Re];ze=b.attributes.entity_picture_local||b.attributes.entity_picture||(b.state&&b.startsWith("http")?b.state:null)}else(Re.startsWith("http")||Re.startsWith("/"))&&(ze=Re);const za=!!ze,We=this._isIdle,hn=this._isIdle,pn=this._artworkObjectFit==="scaled-contain"||this._artworkObjectFit==="scaled-contain-alternate",La=this.config.extend_artwork===!0||m||pn,Na=this.currentStateObj;this.currentPlaybackStateObj,this._optimisticPlayback?.entity_id,this._getResolvedPlaybackEntityIdSync(this._selectedIndex);const $t=this._getActualResolvedMaEntityForState(this._selectedIndex),_n=$t?this.hass?.states?.[$t]:null,mn=this._lastMainState,qa=this._lastMaState;this._lastMainState=Na?.state,this._lastMaState=_n?.state;const me=this._selectedIndex;if(qa==="playing"&&this._lastMaState!=="playing"){const b=Math.max(Number(this._idleTimeoutMs||this.config?.idle_timeout_ms||6e4),500);this._playbackLingerByIdx[me]={entityId:$t,until:Date.now()+b}}if(qa==="playing"&&this._lastMaState==="paused"&&this._lastPlayingEntityIdByChip?.[me]===$t||mn==="playing"&&this._lastMainState==="paused"&&this._lastPlayingEntityIdByChip?.[me]===Na?.entity_id){const b=this._lastPlayingEntityIdByChip[me],O=Math.max(Number(this._idleTimeoutMs||this.config?.idle_timeout_ms||6e4),500);this._playbackLingerByIdx[me]={entityId:b,until:Date.now()+O}}this._lastMaState==="playing"&&this._playbackLingerByIdx?.[me]&&delete this._playbackLingerByIdx[me];const fn=this.config.entities[me]?.music_assistant_entity,vn=this._getEntityForPurpose(me,"ma_resolve"),It=this._lastPlayingEntityIdByChip?.[me],yn=this._maResolveCache?.[me]?.id,gn=!!(It&&(It===yn||It===vn||It===fn||It===$t));this._lastMainState==="playing"&&this._playbackLingerByIdx?.[me]&&!gn&&delete this._playbackLingerByIdx[me];const Ua=this._getEntityForPurpose(this._selectedIndex,"playback_control"),Ye=this.hass?.states?.[Ua],Ct=Ye,bn=Ua;Ct?.state,this._optimisticPlayback&&this._optimisticPlayback.entity_id===bn&&this._optimisticPlayback.state;const xn=!!Ct?.attributes?.shuffle,wn=Ct?.attributes?.repeat&&Ct?.attributes?.repeat!=="off",Ze=this._idleTimeoutMs===0?this._isEntityPlaying(Ye):!this._isIdle&&this._isEntityPlaying(Ye),Fi=this.currentStateObj,Pi=this._getArtworkUrl(Fi),ji=this._getArtworkUrl(Ye);(this._idleTimeoutMs===0?Ze&&(Pi?.url||ji?.url):!this._isIdle&&Ze&&(Pi?.url||ji?.url))&&(Pi?.url||ji?.url);const Ee=this._idleTimeoutMs===0?!0:Ze,ge=Ct||Fi,Ke=Ee&&ge?.attributes?.media_title||"",Ba=Ee&&(ge?.attributes?.media_artist||ge?.attributes?.media_series_title||ge?.attributes?.app_name)||"";this._lastTitleLength=Ke?Ke.length:0,this._adaptiveText&&this._updateAdaptiveTextScale(!0);let ct=ge?.attributes?.media_position||0;const Tt=ge?.attributes?.media_duration||0;let ai=ct;if(Ze&&ge){const b=ge.attributes?.media_position_updated_at?Date.parse(ge.attributes.media_position_updated_at):ge.last_changed?Date.parse(ge.last_changed):Date.now(),O=(Date.now()-b)/1e3;ai+=O}const kn=ge?.attributes?.media_content_id||ge?.attributes?.media_title,Ha=Date.now();if(this._seekAnchor&&this._seekAnchor.trackId===kn){let b=this._seekAnchor.position;Ze&&(b+=(Ha-this._seekAnchor.timestamp)/1e3);const O=this._seekConvergenceLock&&Ha<this._seekConvergenceLock,G=Math.abs(ai-b);!O&&G<2?(this._seekAnchor=null,this._seekConvergenceLock=null,ct=ai):ct=b}else this._seekAnchor=null,this._seekConvergenceLock=null,ct=ai;const Ga=Tt?Math.min(1,ct/Tt):0,Di=this._getVolumeEntity(me),En=Di&&Di.startsWith&&Di.startsWith("remote."),An=Number(this.currentVolumeStateObj?.attributes.volume_level||0),Sn=this.config.volume_mode!=="stepper";let Q;this._alwaysCollapsed&&this._expandOnSearch&&this._showSearchInSheet?Q=!1:Q=this._alwaysCollapsed?!0:this._collapseOnIdle?this._isIdle:!1;const Me=Q&&this._alwaysCollapsed&&a?Math.max(0,t-r):0,$n=Q&&p?48:0,In=Q&&w.length>0?40:0,Cn=$n+In,Oi=48,Le=Math.max(0,Me-Cn),ri=Me>0?Math.min(240,102+Le*.75):102,Va=Le>0?Math.min(Le*.45,96):0,Tn=Le>0?Math.round(Oi+Va):Oi,Mn=Q?Tn:Oi,Ri=Le>0?Math.max(0,Le-Va):0;let zi=!1;const Qa=350,Fn=(Q?a?t:this._collapsedBaselineHeight||220:Qa)>=Qa,Wa=this.config.hide_menu_player===!0?!1:!Q||Fn,Pn=Ri>=48,Li=Me>0?Math.max(100,Math.round(ri+24+Math.min(40,Me*.12))):null,jn=Pn?0:Li??0;let Ya=this.offsetWidth||(this.shadowRoot?.host?.offsetWidth??0);const Ni=Ya>380?Math.min(1.6,1+(Ya-380)/520):1,qi=Me>0?Math.min(1.45,1+Le/180):1,Za=qi>1||Ni>1?Math.min(1.6,Math.max(qi,Ni)):1,Ka=Math.min(1.5,Math.max(qi*.92,Ni*.92));this.shadowRoot&&this.shadowRoot.host&&(Me>0&&(Li!=null&&this.shadowRoot.host.style.setProperty("--yamp-collapsed-details-offset",`${Li}px`),this.shadowRoot.host.style.setProperty("--yamp-collapsed-controls-offset",`${jn}px`),this.shadowRoot.host.style.setProperty("--yamp-collapsed-title-scale",Za.toFixed(3)),this.shadowRoot.host.style.setProperty("--yamp-collapsed-artist-scale",Ka.toFixed(3))),this.shadowRoot.host.style.setProperty("--yamp-collapsed-title-scale",Za.toFixed(3)),this.shadowRoot.host.style.setProperty("--yamp-collapsed-artist-scale",Ka.toFixed(3)),Me>0&&a||(this.shadowRoot.host.style.removeProperty("--yamp-collapsed-controls-offset"),this.shadowRoot.host.style.removeProperty("--yamp-collapsed-details-offset")),Wa?this.shadowRoot.host.removeAttribute("data-hide-persistent-controls"):this.shadowRoot.host.setAttribute("data-hide-persistent-controls","true"));let le=null,Ui=null,Xa=this._artworkObjectFit;if(!this._isIdle){const b=this._getArtworkUrl(Ye),O=this._getArtworkUrl(Fi),G=b?.url?b:O;le=G?.url||null,Ui=G?.sizePercentage,G?.objectFit&&(Xa=G.objectFit)}zi=Q&&!le&&!ze&&Le>=40,Q&&le&&le!==this._lastArtworkUrl&&(this._extractDominantColor(le).then(b=>{this._collapsedArtDominantColor=b,this.requestUpdate()}),this._lastArtworkUrl=le);const Ja=We?Q?this._collapsedBaselineHeight||220:325:null;this._lastRenderedCollapsed=Q,this._lastRenderedHideControls=We;const Xe=Xa||this._artworkObjectFit,Mt=Xe==="scaled-contain-alternate",si=(Xe==="scaled-contain"||Mt)&&!Q&&!this._alwaysCollapsed,Dn=(Xe==="scaled-contain"||Mt)&&(c==="in_menu"||s&&c!=="always");let Bi=this._getBackgroundSizeForFit(Xe);Ui&&(Bi=`${Ui}%`);const er=ze||Mt?ze?`url('${ze}')`:"none":le?`url('${le}')`:"none",tr=er!=="none",On=le&&(Q||si&&Xe==="scaled-contain")?"blur(18px) brightness(0.7) saturate(1.15)":"none",ir=[`background-image: ${er}`,`background-size: ${si?"cover":Bi}`,`background-position: ${this.config.artwork_position||"top center"}`,"background-repeat: no-repeat",`filter: ${On}`].join("; ");return this.shadowRoot&&this.shadowRoot.host&&(this.shadowRoot.host.style.setProperty("--yamp-artwork-fit",Xe),this.shadowRoot.host.style.setProperty("--yamp-artwork-bg-size",Bi)),_`
        <ha-card class="yamp-card" style=${a&&(!Q||this._alwaysCollapsed)?`height:${t}px;`:y}>
          <div
            data-match-theme="${String(this.config.match_theme===!0)}"
            data-artwork-fit="${Xe}"
            class=${uo({"yamp-card-inner":!0,"dim-idle":hn,"no-chip-dim":this.config.dim_chips_on_idle===!1})}
          >
            ${La&&tr?_`
              <div class="full-bleed-artwork-bg" style="${ir}"></div>
              ${za||Mt?y:_`<div class="full-bleed-artwork-fade"></div>`}
            `:y}
            ${m?_`${this._renderInlineActionRow(w)}${this._renderInlineChipRow(p,m)}`:_`${this._renderInlineChipRow(p,m)}${this._renderInlineActionRow(w)}`}
            <div class="card-lower-content-container" style="${Ja?`min-height:${Ja}px;`:""}">
              <div class="card-lower-content-bg"
                style="${(()=>{const b=[];return La&&tr?b.push("background-image: none","filter: none"):b.push(ir),b.push(`min-height: ${Q?We?`${this._collapsedBaselineHeight||220}px`:"0px":"350px"}`),b.push("transition: min-height 0.4s cubic-bezier(0.6,0,0.4,1), background 0.4s"),b.join("; ")})()}"
              ></div>
              ${za||Mt?y:_`<div class="card-lower-fade"></div>`}
              <div class="card-lower-content${Q?" collapsed transitioning":" transitioning"}${Q&&le?" has-artwork":""}" style="${We?Q?`min-height: ${this._collapsedBaselineHeight||220}px;`:"min-height: 350px;":""}">
                ${Q&&le&&this._isValidArtworkUrl(le)?_`
                  <div
                    ...
                    style="${[`background: linear-gradient(120deg, ${this._collapsedArtDominantColor}bb 60%, transparent 100%)`,Me>0?`width:${Math.round(ri+8)}px`:"",this._cardTriggers.tap||this._cardTriggers.hold||this._cardTriggers.double_tap||this._cardTriggers.swipe_left||this._cardTriggers.swipe_right?"cursor:pointer; pointer-events:auto;":""].filter(Boolean).join("; ")}"
                  >
                    <img
                      class="collapsed-artwork"
                      src="${le}" 
                      style="${[this._getCollapsedArtworkStyle(),Me>0?`width:${Math.round(ri)}px; height:${Math.round(ri)}px;`:""].filter(Boolean).join(" ")}" 
                      onload="this.style.display='block'"
                      onerror="this.style.display='none'" />
                  </div>
                `:y}
                ${zi||!Q?_`
                  <div class="card-artwork-spacer${zi?" show-placeholder":""}"
                    @pointerdown=${b=>this._onTapAreaPointerDown(b)}
                    @pointermove=${b=>this._onTapAreaPointerMove(b)}
                    @pointerup=${b=>this._onTapAreaPointerUp(b)}
                    @pointercancel=${()=>{this._gestureActive=!1,clearTimeout(this._gestureHoldTimer)}}
                  ...
                  >
                    ${si&&le?_`
                      <div style="position: absolute; ${Dn?"top: 20px; right: 0; bottom: 0; left: 0;":"inset: 0;"} display: flex; align-items: center; justify-content: center; pointer-events: none;">
                        <img 
                          class="inset-artwork"
                          src="${le}" 
                ...
                <div class="details" style="${(()=>{const b=[];return this._showEntityOptions&&(b.push("visibility:hidden"),b.push("opacity:0")),b.push(`min-height:${Mn}px`),Ee||b.push("opacity:0"),b.join(";")})()}">
                  ...
                  `:_`
                    <div class="title track-options-title" @click=${b=>{Ee&&Ke&&(b.stopPropagation(),this._showMediaTitleOptions=!0)}} style="${Ee&&Ke?"cursor: pointer;":""}" title="${Ee&&Ke?"Show track options":""}">
                      ${Ee&&Ke?Ke:_`&nbsp;`}
                    </div>
                  `}
                  <div
                      class="artist ${Ee&&D.attributes.media_artist?"clickable-artist":""}"
                      @click=${()=>{Ee&&D.attributes.media_artist&&this._searchArtistFromNowPlaying()}}
                      title=${Ee&&D.attributes.media_artist?u("search.search_artist"):""}
                    >${Ee&&Ba?Ba:_`&nbsp;`}</div>
                </div>
                ${!Q&&!this._alternateProgressBar?di(Ze&&Tt?{progress:Ga,seekEnabled:!0,onSeek:b=>this._onProgressBarClick(b),collapsed:!1,style:this._showEntityOptions?"visibility:hidden; opacity:0":"",displayTimestamps:this._displayTimestamps,currentTime:ct,duration:Tt}:{progress:0,seekEnabled:!1,collapsed:!1,style:"visibility:hidden; opacity:0",displayTimestamps:this._displayTimestamps,currentTime:0,duration:0}):y}
                ${Q||this._alternateProgressBar?di(Ze&&Tt?{progress:Ga,collapsed:!0,style:this._showEntityOptions?"visibility:hidden; opacity:0":""}:{progress:0,collapsed:!0,style:"visibility:hidden; opacity:0"}):y}
                ${!We&&Ri>0?_`
                  <div class="collapsed-flex-spacer" style="flex: 1 0 ${Math.round(Ri)}px;"></div>
                `:y}
                <div style="${We||this._showEntityOptions?"visibility:hidden; opacity:0; pointer-events:none;":""}">
                    ${Mo({stateObj:Ye,showStop:this._shouldShowStopButton(Ye),shuffleActive:xn,repeatActive:wn,onControlClick:b=>this._onControlClick(b),supportsFeature:(b,O)=>this._supportsFeature(b,O),showFavorite:M,favoriteActive:q,hiddenControls:L,adaptiveControls:this._adaptiveControls,controlLayout:this._controlLayout,swapPauseForStop:this._controlLayout==="modern"&&this._swapPauseForStop})}

                    ${Fo({isRemoteVolumeEntity:En,showSlider:Sn,vol:An,isMuted:this.currentVolumeStateObj?.attributes?.is_volume_muted??!1,supportsMute:this.currentVolumeStateObj?this._supportsFeature(this.currentVolumeStateObj,va):!1,onVolumeDragStart:b=>this._onVolumeDragStart(b),onVolumeDragEnd:b=>this._onVolumeDragEnd(b),onVolumeChange:b=>this._onVolumeChange(b),onVolumeStep:b=>this._onVolumeStep(b),onMuteToggle:()=>this._onMuteToggle(),leadingControlTemplate:Z,reserveLeadingControlSpace:this._controlLayout==="modern",showRightPlaceholder:this._controlLayout==="modern",rightSlotTemplate:ne,hideVolume:this.config.volume_mode==="hidden",moreInfoMenu:_`
        ...
        <div class="entity-options-container entity-options-container-opening">
          <div class="entity-options-sheet${d||f?" chips-mode":""} entity-options-sheet-opening" 
            ...
            `:y}
              ...
              <div class="entity-options-search" style = "margin-top:12px;" >
                ...
                ${u("common.cancel")}
                  ...
                  `:y}
                  <!--FILTER CHIPS-->
               ${l?(()=>{const b=this._getVisibleSearchFilterClasses(),O=this._searchMediaClassFilter||"all";return this._searchHierarchy.length>0||b.length<2&&!this._usingMusicAssistant?y:_`
                    ...
                    `})():y}
                  ${this._searchLoading?_`<div class="entity-options-search-loading">${u("common.loading")}</div>`:y}
                  ${this._searchError?_`<div class="entity-options-search-error">${this._searchError}</div>`:y}
            ...
            <div class="entity-options-search-results ${this.config.search_view==="card"||this.config.search_view==="card_minimal"?"search-results-card-view":"list-view"}" 
              ...
              ${(()=>{this._searchMediaClassFilter;const b=this._getDisplaySearchResults(),O=this.config.search_view==="card"||this.config.search_view==="card_minimal",G=this.config.search_view==="card_minimal",Je=Math.max(15,this._searchTotalRows||b.length),Ne=[...b,...Array.from({length:Math.max(0,Je-b.length)},()=>null)];return this._searchAttempted&&b.length===0&&!this._searchLoading?_`<div class="entity-options-search-empty">${u("common.no_results")}</div>`:Ne.map(C=>C?_`
                            ...
                            <div class="entity-options-search-result ${O?"search-result-card":""} ${G?"minimal":""} ${C._justMoved?"just-moved":""} ${C.media_content_id!=null&&this._activeSearchRowMenuId===C.media_content_id?"menu-active":""}">
                               <div class="search-sheet-thumb-container"
                                ...
                                `:_`
                                 ...
                                 `}
                                 ${(()=>{const ue=this._isSelectionFlow;return O?Ir({item:C,onPlay:R=>this._playMediaFromSearch(R),onOptionsToggle:R=>{this._activeSearchRowMenuId=R?.media_content_id||null,this.requestUpdate()},upcomingFilterActive:!!this._upcomingFilterActive,isMusicAssistant:this._isMusicAssistantEntity(),massQueueAvailable:this._massQueueAvailable,searchView:"card",minimal:G,hideActions:ue}):y})()}
                               </div>
                                ${G?y:_`
                                <div class="search-sheet-info">
                                 <span class="${this._isClickableSearchResult(C)?"clickable-search-result":""} ${O?"search-sheet-title":""}"
                                  ...
                                  <span class="search-sheet-subtitle ${this._isClickableSearchResult(C)?"clickable-search-result":""}"
                                        @touchstart=${ue=>this._handleSearchResultTouch(C,ue)}
                                        @click=${()=>this._handleSearchResultClick(C)}>
                                   ${(()=>{const ue=C.media_class==="track",R=this._searchMediaClassFilter==="track"||this._searchMediaClassFilter==="album",Hi=!!this._recentlyPlayedFilterActive,Rn=!!this._upcomingFilterActive,zn=!!this._recommendationsFilterActive;return ue&&C.artist&&C.album?`${C.artist} - ${C.album}`:(R||Hi||Rn||zn)&&C.artist?C.artist:C.media_class?C.media_class.charAt(0).toUpperCase()+C.media_class.slice(1):""})()}
                                 </span>
                                 ${(()=>{const ue=this._isSelectionFlow;return O&&!Sr(C)&&!ue?_`
              ...
              `:this._showGrouping?this._renderGroupingSheet():_`
                ...
                <div class="floating-source-index">
                  ${_e.map((b,O)=>{const G=$e.has(b),Je=this._hoveredSourceLetterIndex;let Ne="";if(G&&Je!==null&&Je!==void 0){const C=Math.abs(Je-O);C===0?Ne="max":C===1?Ne="large":C===2&&(Ne="med")}return _`
                      <button
                        class="source-index-letter"
                        ?disabled=${!G}
                        data-scale=${Ne}
                        @mouseenter=${G?()=>{this._hoveredSourceLetterIndex=O,this.requestUpdate()}:y}
                        @mouseleave=${()=>{this._hoveredSourceLetterIndex=null,this.requestUpdate()}}
                        @click=${G?()=>this._scrollToSourceLetter(b):y}
                      >
                        ${b}
                      </button>
                    `})}
...
`}
            ...
            ${Wa?_`
              <div class="persistent-media-controls" @click=${b=>b.stopPropagation()}>
                ...
                ${(()=>{const b=this._selectedIndex,O=this._getVolumeEntity(b);if(!O)return y;const G=O.startsWith&&O.startsWith("remote."),Je=this.currentVolumeStateObj,Ne=Number(Je?.attributes?.volume_level??0),C=G?null:`${Math.round((Ne||0)*100)}%`;return this.config.volume_mode==="hidden"?y:_`
                    <div class="persistent-volume-stepper">
                      <button class="stepper-btn" @click=${()=>this._onVolumeStep(-1)} title="${u("common.vol_down")}">–</button>
                      ${C?_`<span class="stepper-value">${C}</span>`:y}
