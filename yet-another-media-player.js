        ...
        <div class="controls-center">
          ${M?_`
            <button
              ...
              title="${V?h("card.media_controls.stop"):h("card.media_controls.play_pause")||"Play/Pause"}"
            >
        ...
        <div class="entity-options-container entity-options-container-opening">
          <div class="entity-options-sheet${d||f?" chips-mode":""} entity-options-sheet-opening" 
            ...
            <div class="entity-options-search-results ${this.config.search_view==="card"?"search-results-card-view":"list-view"}" 
              ...
              ${(()=>{this._searchMediaClassFilter;const y=this._getDisplaySearchResults(),R=Math.max(15,this._searchTotalRows||y.length),G=[...y,...Array.from({length:Math.max(0,R-y.length)},()=>null)];return this._searchAttempted&&y.length===0&&!this._searchLoading?_`<div class="entity-options-search-empty">${h("common.no_results")}</div>`:G.map(N=>N?_`
