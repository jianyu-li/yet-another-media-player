...
var _templateObject$9, _templateObject2$8, _templateObject3$7, _templateObject4$5, _templateObject5$5, _templateObject6$5, _templateObject7$5, _templateObject8$4, _templateObject9$4, _templateObject0$4, _templateObject1$4;
...
var _templateObject$7, _templateObject2$6, _templateObject3$5, _templateObject4$4, _templateObject5$4, _templateObject6$4, _templateObject7$4, _templateObject8$3, _templateObject9$3, _templateObject0$3, _templateObject1$3, _templateObject10$3, _templateObject11$2, _templateObject12$2, _templateObject13$2;
...
var _templateObject$6, _templateObject2$5, _templateObject3$4, _templateObject4$3, _templateObject5$3, _templateObject6$3, _templateObject7$3;
function renderVolumeRow(_ref) {
  ...
  return x(_templateObject$6 || (_templateObject$6 = _taggedTemplateLiteral(["\n    <div class=\"volume-row\">\n      <div class=\"volume-controls\">\n        ", "\n        ", "\n      </div>\n      ", "\n      ", "\n    </div>\n  "])), hasLeadingControl ? leadingControlTemplate : reserveLeadingControlSpace ? x(_templateObject2$5 || (_templateObject2$5 = _taggedTemplateLiteral(["<div class=\"volume-leading-placeholder\"></div>"]))) : E, !hideVolume ? x(_templateObject3$4 || (_templateObject3$4 = _taggedTemplateLiteral(["\n          <button \n            class=\"volume-icon-btn\" \n            @click=", " \n            title=", "\n          >\n            <ha-icon icon=", "></ha-icon>\n          </button>\n\n          ", "\n        "])), onMuteToggle, (supportsMute ? isMuted : vol === 0) ? "Unmute" : "Mute", getVolumeIcon(vol, isMuted), isRemoteVolumeEntity ? x(_templateObject4$3 || (_templateObject4$3 = _taggedTemplateLiteral(["\n                <div class=\"vol-stepper\">\n                  <button class=\"button\" @click=", " title=\"Vol Down\">\u2013</button>\n                  <button class=\"button\" @click=", " title=\"Vol Up\">+</button>\n                </div>\n              "])), () => onVolumeStep(-1), () => onVolumeStep(1)) : showSlider ? x(_templateObject5$3 || (_templateObject5$3 = _taggedTemplateLiteral(["\n                <div class=\"volume-slider-container\">\n                  <input\n                    class=\"vol-slider\"\n                    type=\"range\"\n                    min=\"0\"\n                    max=\"1\"\n                    step=\"0.01\"\n                    .value=", "\n                    @mousedown=", "\n                    @touchstart=", "\n                    @change=", "\n                    @mouseup=", "\n                    @touchend=", "\n                    title=\"Volume\"\n                  />\n                </div>\n              "])), vol, onVolumeDragStart, onVolumeDragStart, onVolumeChange, onVolumeDragEnd, onVolumeDragEnd) : x(_templateObject6$3 || (_templateObject6$3 = _taggedTemplateLiteral(["\n                <div class=\"vol-stepper-container\">\n                  <div class=\"vol-stepper\">\n                    <button class=\"button\" @click=", " title=\"Vol Down\">\u2013</button>\n                    <span>", "%</span>\n                    <button class=\"button\" @click=", " title=\"Vol Up\">+</button>\n                  </div>\n                </div>\n              "])), () => onVolumeStep(-1), Math.round(vol * 100), () => onVolumeStep(1))) : E, showRightPlaceholder ? x(_templateObject7$3 || (_templateObject7$3 = _taggedTemplateLiteral(["\n        <div class=\"volume-placeholder\">\n          ", "\n        </div>\n      "])), rightSlotTemplate || E) : E, moreInfoMenu);
}
