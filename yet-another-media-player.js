 ...
 */const ao=to(class extends io{constructor(i){if(super(i),i.type!==eo.ATTRIBUTE||i.name!=="class"||i.strings?.length>2)throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(i){return" "+Object.keys(i).filter((e=>i[e])).join(" ")+" "}update(i,[e]){if(this.st===void 0){this.st=new Set,i.strings!==void 0&&(this.nt=new Set(i.strings.join(" ").split(/\s/).filter((a=>a!==""))));for(const a in e)e[a]&&!this.nt?.has(a)&&this.st.add(a);return this.render(e)}const t=i.element.classList;for(const a of this.st)a in e||(t.remove(a),this.st.delete(a));for(const a in e){const s=!!e[a];s===this.st.has(a)||this.nt?.has(a)||(s?(t.add(a),this.st.add(a)):(t.remove(a),this.st.delete(a)))}return Xe}});function xe(i,e){const t=i?.[e];return typeof t=="string"&&t.trim()!==""?t:null}async function so(i,e,t){if(!e||typeof e!="string")return t;if(!e.includes("{{")&&!e.includes("{%"))return e;try{const a=(await i.callApi("POST","template",{template:e})||"").toString().trim();return a&&/^([a-z_]+)\.[A-Za-z0-9_]+$/.test(a)?a:t}catch{return t}}async function ro(i,e,t={}){if(!e||typeof e!="string")return e;if(!e.includes("{{")&&!e.includes("{%")){if(/%7B%7B|%7B%25/i.test(e))try{e=decodeURIComponent(e)}catch{}if(!e.includes("{{")&&!e.includes("{%"))return e}let a=e;t&&Object.keys(t).length>0&&(a=`${Object.entries(t).map(([s,r])=>`{% set ${s} = ${JSON.stringify(r)} %}`).join(" ")} ${e}`);try{return(await i.callApi("POST","template",{template:a})||"").toString().trim()}catch(s){return console.warn("yamp: Error resolving template:",e,s),e}}function no(i,e,t={}){if(!e||typeof e!="string")return e;let a=e;if(/%7B%7B|%7B%25/i.test(a))try{a=decodeURIComponent(a)}catch{}if(!a.includes("{{")&&!a.includes("{%"))return a;let s=a,r=!0;return s=s.replace(/\{\{\s*(.*?)\s*\}\}/g,(n,o)=>{let l=o.trim(),c=!1;l.endsWith("| urlencode")?(c=!0,l=l.replace(/\|\s*urlencode$/,"").trim()):l.endsWith("|urlencode")&&(c=!0,l=l.replace(/\|urlencode$/,"").trim());let u=l.match(/^state_attr\(\s*(['"]?)([\w.]+)\1\s*,\s*(['"]?)([\w_]+)\3\s*\)$/);if(u){let p=u[2],_=t[p]!==void 0&&!u[1]?t[p]:p,f=u[4];const g=i?.states?.[_];if(g&&g.attributes&&g.attributes[f]!==void 0){let y=String(g.attributes[f]);return c?encodeURIComponent(y):y}return""}let d=l.match(/^states\(\s*(['"]?)([\w.]+)\1\s*\)$/);if(d){let p=d[2],_=t[p]!==void 0&&!d[1]?t[p]:p;const f=i?.states?.[_];if(f&&f.state!==void 0){let g=String(f.state);return c?encodeURIComponent(g):g}return""}if(/^[\w_]+$/.test(l)&&t[l]!==void 0){let p=String(t[l]);return c?encodeURIComponent(p):p}return r=!1,n}),!r||s.includes("{%")?null:s}function oo(i,e){if(!i?.states||!e)return[];const t=[],a=i.states[e];if(!a)return[];const s=a.attributes?.device_id,r=a.attributes?.friendly_name||e;for(const[n,o]of Object.entries(i.states))if(n.startsWith("button.")&&o.attributes){const l=o.attributes.device_id,c=o.attributes.friendly_name||n;s&&l===s?t.push({entity_id:n,friendly_name:c,device_class:o.attributes.device_class,reason:"same_device"}):(c.toLowerCase().includes(r.toLowerCase())||r.toLowerCase().includes(c.toLowerCase()))&&t.push({entity_id:n,friendly_name:c,device_class:o.attributes.device_class,reason:"name_similarity"})}return t}function lo(i,e){if(!i?.states||!e)return null;const t=i.states[e];return t&&t.attributes&&(t.attributes.media_content_id||t.attributes.media_content_type||t.attributes.media_album_name||t.attributes.media_artist||t.attributes.media_title)?t:null}function lt(i){return!i||!i.attributes?!1:i.attributes.app_id==="music_assistant"||i.attributes.mass_player_type!==void 0}function co(i){if(!i)return"";const e=i.media_type||i.media_class||i.media_content_type,t=i.name||i.title||i.media_title||"Unknown Title",a=i.artists?.[0],s=i.artist||a?.name||(typeof a=="string"?a:void 0)||i.media_artist||"Unknown Artist";return e==="track"?`${t} - ${s}`:e==="album"?`${t} - ${s}`:t}function ms(i,e="",t=[],a=null){if(!i||!i.attributes)return null;const s=i.attributes,r=i.entity_id;s.app_id;let n=null,o=null;if(t&&Array.isArray(t)&&t.length){const l=(d,p)=>{if(d)return d[p]},c=[["media_title","media_title"],["media_artist","media_artist"],["media_album_name","media_album_name"],["media_content_id","media_content_id"],["media_channel","media_channel"],["app_name","app_name"],["media_content_type","media_content_type"],["entity_id","entity_id"],["entity_state","entity_state"]];let u=t.find(d=>c.some(([p,_])=>{const f=l(d,_);return f===void 0?!1:(p==="entity_id"?r:p==="entity_state"?i?.state:s[p])===f}));u||xe(s,"entity_picture_local")||xe(s,"entity_picture")||xe(s,"album_art")||(u=t.find(d=>d?.missing_art_url),u?.missing_art_url&&(u={...u,image_url:u.missing_art_url})),u?.image_url&&(n=u.image_url,o=u?.size_percentage)}return n||(n=xe(s,"entity_picture_local")||xe(s,"entity_picture")||xe(s,"album_art")||null),!n&&a&&(a==="smart"?s.media_title==="TV"||s.media_channel||s.app_id==="tv"||s.app_id==="androidtv"?n="data:image/svg+xml;base64,":n="data:image/svg+xml;base64,":typeof a=="string"&&(n=a)),n&&e&&!n.startsWith("http")&&(n=e+n),{url:n,sizePercentage:o}}function uo({idx:i,selected:e,playing:t,name:a,art:s,icon:r,pinned:n,holdToPin:o,maActive:l,onChipClick:c,onIconClick:u,onPinClick:d,onPointerDown:p,onPointerMove:_,onPointerUp:f,objectFit:g,quickGroupingState:y,onQuickGroupClick:k,onDoubleClick:x}){const M=g?`object-fit: ${g};`:"";return m`
  ...
  `}function ho({idx:i,selected:e,playing:t,groupName:a,art:s,icon:r,pinned:n,holdToPin:o,maActive:l,onChipClick:c,onIconClick:u,onPinClick:d,onPointerDown:p,onPointerMove:_,onPointerUp:f,objectFit:g,quickGroupingState:y,onQuickGroupClick:k,onDoubleClick:x}){const M=g?`object-fit: ${g};`:"";return m`
  ...
  `}function fs({idx:i,quickGroupingState:e,onQuickGroupClick:t}){if(!e||!e.isGroupable)return v;const{isPrimary:a,isBusy:s,grouped:r,tooltip:n}=e;return m`
  ...
  `}const L=Object.freeze({MEDIA_BACKGROUND:0,MEDIA_OVERLAY:0,FLOATING_ELEMENT:1,STICKY_CHIPS:1,ACCENT_FOREGROUND:1,FLOATING_CONTROLS:1,OVERLAY_BASE:2,MODAL_BACKDROP:2,MODAL_TOAST:2,SEARCH_SLIDE_OUT:1,SEARCH_SUCCESS:1}),So=Ui`
    ...
    <div class="search-row-slide-out ${d?"active":""}">
      ...
      `:m`
        <button class="slide-out-button" @click=${()=>t(i,"replace")} title="${h("search.labels.replace")}">
          ${s==="card"?v:m`<ha-icon icon="mdi:playlist-remove"></ha-icon>`}${h("search.labels.replace")}
        </button>
        <button class="slide-out-button" @click=${()=>t(i,"next")} title="${h("search.labels.next")}">
          ${s==="card"?v:m`<ha-icon icon="mdi:playlist-play"></ha-icon>`}${h("search.labels.next")}
        </button>
        <button class="slide-out-button" @click=${()=>t(i,"replace_next")} title="${h("search.labels.replace_next")}">
          ${s==="card"?v:m`<ha-icon icon="mdi:playlist-music"></ha-icon>`}${h("search.labels.replace_next")}
        </button>
        <button class="slide-out-button" @click=${()=>t(i,"add")} title="${h("search.labels.add")}">
          ${s==="card"?v:m`<ha-icon icon="mdi:playlist-plus"></ha-icon>`}${h("search.labels.add")}
        </button>
        ${ys(i)&&n?m`
          <button class="slide-out-button" @click=${()=>t(i,"add_to_playlist")} title="${h("search.labels.add_to_playlist")}">
            ${s==="card"?v:m`<ha-icon icon="mdi:plus"></ha-icon>`}${h("search.labels.add_to_playlist")}
          </button>
        `:v}
      `}
...
{% endif %}</pre>
          ...
          ${t.map(({action:s,idx:r})=>{const n=this._getActionLabel(s);return m`
              ...
              >
                ${s.icon?m`
                  ...
                  ></ha-icon>
                `:v}
                ${n?m`<span class="menu-action-label">${n}</span>`:v}
              </button>
            `})}
        `:v}
      </div>
    ...
    `:v}_renderInlineActionRow(e){return!e||!e.length?v:m`
    ...
    `}_renderGroupingMenuOption(){if(this.entityIds.length<=1)return v;const e=this.entityIds.reduce((n,o,l)=>{const c=this._getGroupingEntityId(l),u=this.hass.states[c];return n+(this._isGroupCapable(u)?1:0)},0),t=this._getGroupingEntityId(this._selectedIndex),a=this.hass.states[t],s=this.currentEntityId,r=this._getGroupKey(s)!==s;return e>1&&this._isGroupCapable(a)&&!r?m`
      ...
      <div class="group-list-scroll">
        ...
        `:f.map(g=>{const y=g.id,k=g.groupId,x=(Array.isArray(s?.attributes?.group_members)?s.attributes.group_members:[]).includes(k),M=this.getChipName(y),E=g.isBusy,G=g.busyLabel,O=this.entityIds.indexOf(y),j=this._getVolumeEntityForGrouping(O)||k,N=this.hass.states[j],z=j?.startsWith&&j.startsWith("remote."),B=Number(N?.attributes?.volume_level||0),C=y===e,q=!C;let H=h(r?C?"card.grouping.master":x?"card.grouping.joined":"card.grouping.available":y===l?"card.grouping.current":"card.grouping.available");return E&&(H=G||"Unavailable"),m`
          ...
          <div style="display:flex;flex-direction:column;gap:8px;">
            ${e.map(t=>m`
              <button
                ...
                ${t.state?m`<div style="margin-left:auto;font-size:0.82em;opacity:0.7;text-transform:capitalize;">${t.state}</div>`:v}
              </button>
            `)}
          </div>
        `:m`
        ...
        <ha-card class="yamp-card" style=${a&&(!Q||this._alwaysCollapsed)?`height:${t}px;`:v}>
          ...
          >
            ${Pa&&Ka?m`
              ...
              ${Da?v:m`<div class="full-bleed-artwork-fade"></div>`}
            `:v}
            ...
            <div class="card-lower-content-container" style="${Ya?`min-height:${Ya}px;`:""}">
              <div class="card-lower-content-bg"
                style="${(()=>{const b=[];return Pa&&Ka?b.push("background-image: none","filter: none"):b.push(Xa),b.push(`min-height: ${Q?Qe?`${this._collapsedBaselineHeight||220}px`:"0px":"350px"}`),b.push("transition: min-height 0.4s cubic-bezier(0.6,0,0.4,1), background 0.4s"),b.join("; ")})()}"
              ></div>
              ${Da?v:m`<div class="card-lower-fade"></div>`}
              <div class="card-lower-content${Q?" collapsed transitioning":" transitioning"}${Q&&le?" has-artwork":""}" style="${Qe?Q?`min-height: ${this._collapsedBaselineHeight||220}px;`:"min-height: 350px;":""}">
                ...
                ${Q||this._alternateProgressBar?ni(Ye&&St?{progress:qa,collapsed:!0,accent:this._customAccent,style:this._showEntityOptions?"visibility:hidden":""}:{progress:0,collapsed:!0,accent:this._customAccent,style:"visibility:hidden"}):v}
                ${!Qe&&ji>0?m`
            ...
            ${Qe&&!this._showEntityOptions?m`
              <div class="more-info-menu" style="position: absolute; right: 18px; bottom: 18px; z-index: ${L.FLOATING_ELEMENT};">
                <button class="more-info-btn" @click=${async()=>await this._openEntityOptions()}>
                  <span class="more-info-icon">&#9776;</span>
                </button>
              </div>
            ...
            ${d&&!this._showEntityOptions&&!this._hideActiveEntityLabel?m`
              <div class="in-menu-active-label">${z}</div>
            `:v}
          </div>
        </div>
        ...
        <div class="entity-options-container entity-options-container-opening">
          <div class="entity-options-sheet${d||f?" chips-mode":""} entity-options-sheet-opening" 
            ...
            `:v}
              ...
              <div class="entity-options-search" style = "margin-top:12px;" >
                ${this._searchHierarchy.length>0?m`
                  ...
                  `:l?m`<div class="entity-options-search-skeleton"></div>`:v}
                  ${l?m`
                ...
                ${h("common.cancel")}
                  ...
                  `:v}
                  <!--FILTER CHIPS-->
               ${l?(()=>{const b=this._getVisibleSearchFilterClasses(),R=this._searchMediaClassFilter||"all";return this._searchHierarchy.length>0||b.length<2&&!this._usingMusicAssistant?v:m`
                      <div class="chip-row search-filter-chips" id="search-filter-chip-row" style="margin-bottom:12px; justify-content: center; align-items: center;">
                        ...
                        ${b.map(U=>m`
                          <button
                            ...
                            style="
                              width: 72px;
                              background: ${R===U?this._customAccent:"#282828"};
                              opacity: ${R===U?"1":"0.8"};
                              font-weight: ${R===U?"bold":"normal"};
                            "
                            ?selected=${R===U}
                            @click=${()=>this._doSearch(U)}
                          >
                            ${h(`search.filters.${U}`)}
                          </button>
                        `)}
                    ...
                    `})():v}
                  ${this._searchLoading?m`<div class="entity-options-search-loading">${h("common.loading")}</div>`:v}
                  ${this._searchError?m`<div class="entity-options-search-error">${this._searchError}</div>`:v}
            ...
            <div class="entity-options-search-results ${this.config.search_view==="card"?"search-results-card-view":"list-view"}" 
              ...
              ${(()=>{this._searchMediaClassFilter;const b=this._getDisplaySearchResults(),R=Math.max(15,this._searchTotalRows||b.length),U=[...b,...Array.from({length:Math.max(0,R-b.length)},()=>null)];return this._searchAttempted&&b.length===0&&!this._searchLoading?m`<div class="entity-options-search-empty">${h("common.no_results")}</div>`:U.map(P=>P?m`
              ...
              `:this._showGrouping?this._renderGroupingSheet():m`
                ...
                <div class="floating-source-index">
                  ${pe.map((b,R)=>{const U=Ae.has(b),P=this._hoveredSourceLetterIndex;let T="";if(U&&P!==null&&P!==void 0){const Se=Math.abs(P-R);Se===0?T="max":Se===1?T="large":Se===2&&(T="med")}return m`
                      <button
                        class="source-index-letter"
                        ?disabled=${!U}
                        data-scale=${T}
                        @mouseenter=${U?()=>{this._hoveredSourceLetterIndex=R,this.requestUpdate()}:v}
                        @mouseleave=${()=>{this._hoveredSourceLetterIndex=null,this.requestUpdate()}}
                        @click=${U?()=>this._scrollToSourceLetter(b):v}
                      >
                        ${b}
                      </button>
                    `})}
...
`}
            ...
            ${Ha?m`
              <div class="persistent-media-controls" @click=${b=>b.stopPropagation()}>
                <div class="persistent-controls-artwork">
                  ${(()=>{const b=this.currentPlaybackStateObj,R=this.currentStateObj,U=this._getArtworkUrl(b)||this._getArtworkUrl(R);return U?.url&&this._isValidArtworkUrl(U.url)?m`
                      <img src="${U.url}" alt="Album Art" class="persistent-artwork" onerror="this.style.display='none'">
                    `:m`
                ...
                ${(()=>{const b=this._selectedIndex,R=this._getVolumeEntity(b);if(!R)return v;const U=R.startsWith&&R.startsWith("remote."),P=this.currentVolumeStateObj,T=Number(P?.attributes?.volume_level??0),Se=U?null:`${Math.round((T||0)*100)}%`;return this.config.volume_mode==="hidden"?v:m`
                    <div class="persistent-volume-stepper">
                      <button class="stepper-btn" @click=${()=>this._onVolumeStep(-1)} title="${h("common.vol_down")}">–</button>
                      ${Se?m`<span class="stepper-value">${Se}</span>`:v}
        ...
        `:v}
          ${this._searchActiveOptionsItem?Co({item:this._searchActiveOptionsItem,onClose:()=>{this._searchActiveOptionsItem=null,this.requestUpdate()},onPlayOption:(b,R)=>this._performSearchOptionAction(b,R),massQueueAvailable:this._massQueueAvailable}):v}
