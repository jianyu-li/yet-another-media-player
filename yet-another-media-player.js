 ...
 */const Jn=Kn(class extends Xn{constructor(i){if(super(i),i.type!==Zn.ATTRIBUTE||i.name!=="class"||i.strings?.length>2)throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(i){return" "+Object.keys(i).filter((e=>i[e])).join(" ")+" "}update(i,[e]){if(this.st===void 0){this.st=new Set,i.strings!==void 0&&(this.nt=new Set(i.strings.join(" ").split(/\s/).filter((a=>a!==""))));for(const a in e)e[a]&&!this.nt?.has(a)&&this.st.add(a);return this.render(e)}const t=i.element.classList;for(const a of this.st)a in e||(t.remove(a),this.st.delete(a));for(const a in e){const s=!!e[a];s===this.st.has(a)||this.nt?.has(a)||(s?(t.add(a),this.st.add(a)):(t.remove(a),this.st.delete(a)))}return Xe}});function we(i,e){const t=i?.[e];return typeof t=="string"&&t.trim()!==""?t:null}async function eo(i,e,t){if(!e||typeof e!="string")return t;if(!e.includes("{{")&&!e.includes("{%"))return e;try{const a=(await i.callApi("POST","template",{template:e})||"").toString().trim();return a&&/^([a-z_]+)\.[A-Za-z0-9_]+$/.test(a)?a:t}catch{return t}}async function to(i,e,t={}){if(!e||typeof e!="string")return e;if(!e.includes("{{")&&!e.includes("{%")){if(/%7B%7B|%7B%25/i.test(e))try{e=decodeURIComponent(e)}catch{}if(!e.includes("{{")&&!e.includes("{%"))return e}let a=e;t&&Object.keys(t).length>0&&(a=`${Object.entries(t).map(([s,r])=>`{% set ${s} = ${JSON.stringify(r)} %}`).join(" ")} ${e}`);try{return(await i.callApi("POST","template",{template:a})||"").toString().trim()}catch(s){return console.warn("yamp: Error resolving template:",e,s),e}}function io(i,e,t={}){if(!e||typeof e!="string")return e;let a=e;if(/%7B%7B|%7B%25/i.test(a))try{a=decodeURIComponent(a)}catch{}if(!a.includes("{{")&&!a.includes("{%"))return a;let s=a,r=!0;return s=s.replace(/\{\{\s*(.*?)\s*\}\}/g,(n,o)=>{let l=o.trim(),c=!1;l.endsWith("| urlencode")?(c=!0,l=l.replace(/\|\s*urlencode$/,"").trim()):l.endsWith("|urlencode")&&(c=!0,l=l.replace(/\|urlencode$/,"").trim());let u=l.match(/^state_attr\(\s*(['"]?)([\w.]+)\1\s*,\s*(['"]?)([\w_]+)\3\s*\)$/);if(u){let p=u[2],_=t[p]!==void 0&&!u[1]?t[p]:p,g=u[4];const y=i?.states?.[_];if(y&&y.attributes&&y.attributes[g]!==void 0){let v=String(y.attributes[g]);return c?encodeURIComponent(v):v}return""}let d=l.match(/^states\(\s*(['"]?)([\w.]+)\1\s*\)$/);if(d){let p=d[2],_=t[p]!==void 0&&!d[1]?t[p]:p;const g=i?.states?.[_];if(g&&g.state!==void 0){let y=String(g.state);return c?encodeURIComponent(y):y}return""}if(/^[\w_]+$/.test(l)&&t[l]!==void 0){let p=String(t[l]);return c?encodeURIComponent(p):p}return r=!1,n}),!r||s.includes("{%")?null:s}function ao(i,e){if(!i?.states||!e)return[];const t=[],a=i.states[e];if(!a)return[];const s=a.attributes?.device_id,r=a.attributes?.friendly_name||e;for(const[n,o]of Object.entries(i.states))if(n.startsWith("button.")&&o.attributes){const l=o.attributes.device_id,c=o.attributes.friendly_name||n;s&&l===s?t.push({entity_id:n,friendly_name:c,device_class:o.attributes.device_class,reason:"same_device"}):(c.toLowerCase().includes(r.toLowerCase())||r.toLowerCase().includes(c.toLowerCase()))&&t.push({entity_id:n,friendly_name:c,device_class:o.attributes.device_class,reason:"name_similarity"})}return t}function so(i,e){if(!i?.states||!e)return null;const t=i.states[e];return t&&t.attributes&&(t.attributes.media_content_id||t.attributes.media_content_type||t.attributes.media_album_name||t.attributes.media_artist||t.attributes.media_title)?t:null}function tt(i){return!i||!i.attributes?!1:i.attributes.app_id==="music_assistant"||i.attributes.mass_player_type!==void 0}function ro(i){if(!i)return"";const e=i.media_type||i.media_class||i.media_content_type,t=i.name||i.title||i.media_title||"Unknown Title",a=i.artists?.[0],s=i.artist||a?.name||(typeof a=="string"?a:void 0)||i.media_artist||"Unknown Artist";return e==="track"?`${t} - ${s}`:e==="album"?`${t} - ${s}`:t}function fs(i,e="",t=[],a=null){if(!i||!i.attributes)return null;const s=i.attributes,r=i.entity_id;s.app_id;let n=null,o=null;if(t&&Array.isArray(t)&&t.length){const l=(d,p)=>{if(d)return d[p]},c=[["media_title","media_title"],["media_artist","media_artist"],["media_album_name","media_album_name"],["media_content_id","media_content_id"],["media_channel","media_channel"],["app_name","app_name"],["media_content_type","media_content_type"],["entity_id","entity_id"],["entity_state","entity_state"]];let u=t.find(d=>c.some(([p,_])=>{const g=l(d,_);return g===void 0?!1:(p==="entity_id"?r:p==="entity_state"?i?.state:s[p])===g}));u||we(s,"entity_picture_local")||we(s,"entity_picture")||we(s,"album_art")||(u=t.find(d=>d?.missing_art_url),u?.missing_art_url&&(u={...u,image_url:u.missing_art_url})),u?.image_url&&(n=u.image_url,o=u?.size_percentage)}return n||(n=we(s,"entity_picture_local")||we(s,"entity_picture")||we(s,"album_art")||null),!n&&a&&(a==="smart"?s.media_title==="TV"||s.media_channel||s.app_id==="tv"||s.app_id==="androidtv"?n="data:image/svg+xml;base64,":n="data:image/svg+xml;base64,":typeof a=="string"&&(n=a)),n&&e&&!n.startsWith("http")&&(n=e+n),{url:n,sizePercentage:o}}function no({idx:i,selected:e,playing:t,name:a,art:s,icon:r,pinned:n,holdToPin:o,maActive:l,onChipClick:c,onIconClick:u,onPinClick:d,onPointerDown:p,onPointerMove:_,onPointerUp:g,objectFit:y,quickGroupingState:v,onQuickGroupClick:k,onDoubleClick:x}){const j=y?`object-fit: ${y};`:"";return m`
  ...
  `}function oo({idx:i,selected:e,playing:t,groupName:a,art:s,icon:r,pinned:n,holdToPin:o,maActive:l,onChipClick:c,onIconClick:u,onPinClick:d,onPointerDown:p,onPointerMove:_,onPointerUp:g,objectFit:y,quickGroupingState:v,onQuickGroupClick:k,onDoubleClick:x}){const j=y?`object-fit: ${y};`:"";return m`
  ...
  `}function lo({onPin:i,onHoldEnd:e,holdTime:t=600,moveThreshold:a=8}){let s=null,r=null,n=null,o=!1;return{pointerDown:(l,c)=>{r=l.clientX,n=l.clientY,o=!1,s=setTimeout(()=>{o||(i(c,l),e&&e(c))},t)},pointerMove:(l,c)=>{if(s&&r!==null&&n!==null){const u=Math.abs(l.clientX-r),d=Math.abs(l.clientY-n);(u>a||d>a)&&(o=!0,clearTimeout(s),s=null)}},pointerUp:(l,c)=>{s&&(clearTimeout(s),s=null),r=null,n=null,o=!1}}}function gs({groupedSortedEntityIds:i,entityIds:e,selectedEntityId:t,pinnedIndex:a,holdToPin:s,getChipName:r,getActualGroupMaster:n,getIsChipPlaying:o,getChipArt:l,getIsMaActive:c,isIdle:u,hass:d,artworkHostname:p="",mediaArtworkOverrides:_=[],fallbackArtwork:g=null,onChipClick:y,onIconClick:v,onPointerClick:k,onPinClick:x,onPointerDown:j,onPointerMove:E,onPointerUp:G,quickGroupingMode:B,getQuickGroupingState:z,onQuickGroupClick:L,onDoubleClick:N}){return!i||!i.length?b:m`
    ${i.map(T=>{if(T.length>1){const M=n(T),q=e.indexOf(M),H=d?.states?.[M],te=typeof o=="function"?o(M,t===M):H?.state==="playing",ae=typeof l=="function"?l(M):fs(H,p,_,g),Z=ae?.url,oe=ae?.objectFit,le=H?.attributes?.icon||"mdi:cast",Se=typeof c=="function"?c(M):!1;return oo({idx:q,selected:t===M,playing:te,groupName:r(M)+(T.length>1?` [${T.length}]`:""),art:Z,icon:le,pinned:a===q,holdToPin:s,maActive:Se,onChipClick:y,onIconClick:v,onPinClick:x,onPointerDown:_e=>j(_e,q),onPointerMove:_e=>E(_e,q),onPointerUp:_e=>G(_e,q),objectFit:oe,quickGroupingState:B&&typeof z=="function"?z(M):null,onQuickGroupClick:L,onDoubleClick:N})}else{const M=T[0],q=e.indexOf(M),H=d?.states?.[M],te=typeof o=="function"?o(M,t===M):H?.state==="playing",ae=typeof l=="function"?l(M):fs(H,p,_,g),Z=ae?.url,oe=ae?.objectFit,le=t===M?!u&&Z:te&&Z,Se=H?.attributes?.icon||"mdi:cast",_e=typeof c=="function"?c(M):!1;return no({idx:q,selected:t===M,playing:te,name:r(M),art:le,icon:Se,pinned:a===q,holdToPin:s,maActive:_e,onChipClick:y,onPinClick:x,onPointerDown:se=>j(se,q),onPointerMove:se=>E(se,q),onPointerUp:se=>G(se,q),objectFit:oe,quickGroupingState:B&&typeof z=="function"?z(M):null,onQuickGroupClick:L,onDoubleClick:N})}})}
  ...
  `}const U=Object.freeze({MEDIA_BACKGROUND:0,MEDIA_OVERLAY:0,FLOATING_ELEMENT:1,STICKY_CHIPS:1,ACCENT_FOREGROUND:1,FLOATING_CONTROLS:1,OVERLAY_BASE:2,MODAL_BACKDROP:2,MODAL_TOAST:2,SEARCH_SLIDE_OUT:1,SEARCH_SUCCESS:1}),wo=Gi`
...
`,ko=[{mode:"replace",icon:"mdi:playlist-remove",label:h("search.replace")},{mode:"next",icon:"mdi:playlist-play",label:h("search.play_next")},{mode:"replace_next",icon:"mdi:playlist-music",label:h("search.replace_play")},{mode:"add",icon:"mdi:playlist-plus",label:h("search.add_queue")}],Le=(i,{cap:e,floor:t}={})=>{const a=Number(i);if(!Number.isFinite(a)||a<=0)return;let s=a;return typeof t=="number"&&(s=Math.max(t,s)),typeof e=="number"&&(s=Math.min(e,s)),s},ys=3e4;let Tt=null,Xi=0;async function ni(i){const e=Date.now();if(Tt&&e-Xi<ys)return Tt;try{return Tt=(await i.callApi("GET","config/config_entries/entry")).find(t=>t.domain==="music_assistant"&&t.state==="loaded")?.entry_id||null,Xi=e,Tt}catch(t){return console.error("yamp: Failed to resolve Music Assistant config entry",t),Tt=null,Xi=e,null}}let Mt=null,Ji=0;async function Eo(i){const e=Date.now();if(Mt&&e-Ji<ys)return Mt;try{return Mt=(await i.callApi("GET","config/config_entries/entry")).find(t=>t.domain==="mass_queue"&&t.state==="loaded")?.entry_id||null,Ji=e,Mt}catch(t){return console.error("yamp: Failed to resolve mass_queue config entry",t),Mt=null,Ji=e,null}}function Ft(i){return i?{title:i.name,media_content_id:i.uri,media_content_type:i.media_type,media_class:i.media_type,thumbnail:i.image,...i.artists&&{artist:i.artists.map(e=>e.name).join(", ")},...i.album&&{album:i.album.name},is_browsable:i.media_type==="artist"||i.media_type==="album"}:null}function oi({item:i,onPlay:e,onOptionsToggle:t,upcomingFilterActive:a=!1,isMusicAssistant:s=!1,massQueueAvailable:r=!1,searchView:n="list",isInline:o=!1,onMoveUp:l,onMoveDown:c,onMoveNext:u,onRemove:d}){const p=!!(a&&i.queue_item_id&&s&&r),_=o?"entity-options-search-buttons":n==="card"?"card-overlay-buttons":"search-sheet-buttons",g=o?"entity-options-search-play":n==="card"?"search-sheet-play icon-only":"search-sheet-play",y=o?"entity-options-search-queue":n==="card"?"search-sheet-queue icon-only":"search-sheet-queue";return m`
  ...
  `}function Ao({open:i,query:e,onQueryInput:t,onSearch:a,onClose:s,loading:r,results:n,onPlay:o,onQueue:l,error:c,showQueueSuccess:u,matchTheme:d=!1,upcomingFilterActive:p=!1,disableAutofocus:_=!1,activeSearchRowMenuId:g,successSearchRowMenuId:y,onOptionsToggle:v,onPlayOption:k,onResultClick:x,searchView:j="list",searchCardColumns:E=4,massQueueAvailable:G=!1,onMoveUp:B,onMoveDown:z,onMoveNext:L,onRemove:N}){return i?m`
    <div class="search-sheet" data-match-theme="${d}" data-card-view="${j==="card"}">
      ...
      <div class="search-sheet-results ${j==="card"?"search-results-card-view":"list-view"}">
        ${(n||[]).length===0&&!r?m`<div class="search-sheet-empty">${h("common.no_results")}</div>`:(n||[]).map(T=>{const M=tt(T.media_content_id);return m`
                <div class="search-sheet-result ${j==="card"?"search-result-card":""}">
                  <div class="search-sheet-thumb-container" 
                       data-clickable="${j==="card"}"
                       @click=${j==="card"?()=>o(T):null}>
                    ...
                    `}
                    ${j==="card"?oi({item:T,onPlay:o,onOptionsToggle:v,upcomingFilterActive:p,isMusicAssistant:M,massQueueAvailable:G,searchView:"card",onMoveUp:B,onMoveDown:z,onMoveNext:L,onRemove:N}):b}
                  </div>
                  ...
                  ${j!=="card"?oi({item:T,onPlay:o,onOptionsToggle:v,upcomingFilterActive:p,isMusicAssistant:M,massQueueAvailable:G,searchView:"list",isInline:!0,onMoveUp:B,onMoveDown:z,onMoveNext:L,onRemove:N}):b}
                  
                  ${bs({item:T,activeSearchRowMenuId:g,successSearchRowMenuId:y,onPlayOption:k,onOptionsToggle:v,searchView:j,isQueueItem:M&&T.queue_item_id&&p&&G,onMoveUp:B,onMoveDown:z,onMoveNext:L,onRemove:N})}
                </div>
              `})}
      </div>
    </div>
...
`;return o.replace(/\n$/,"")}var Bo=Uo,Go=["kind","multi","resolve","construct","instanceOf","predicate","represent","representName","defaultStyle","styleAliases"],Ho=["scalar","sequence","mapping"];function Vo(i){var e={};return i!==null&&Object.keys(i).forEach(function(t){i[t].forEach(function(a){e[String(a)]=t})}),e}function Qo(i,e){if(e=e||{},Object.keys(e).forEach(function(t){if(Go.indexOf(t)===-1)throw new he('Unknown option "'+t+'" is met in definition of "'+i+'" YAML type.')}),this.options=e,this.tag=i,this.kind=e.kind||null,this.resolve=e.resolve||function(){return!0},this.construct=e.construct||function(t){return t},this.instanceOf=e.instanceOf||null,this.predicate=e.predicate||null,this.represent=e.represent||null,this.representName=e.representName||null,this.defaultStyle=e.defaultStyle||null,this.multi=e.multi||!1,this.styleAliases=Vo(e.styleAliases||null),Ho.indexOf(this.kind)===-1)throw new he('Unknown kind "'+this.kind+'" is specified for "'+i+'" YAML type.')}var re=Qo;function As(i,e){var t=[];return i[e].forEach(function(a){var s=t.length;t.forEach(function(r,n){r.tag===a.tag&&r.kind===a.kind&&r.multi===a.multi&&(s=n)}),t[s]=a}),t}function Wo(){var i={scalar:{},sequence:{},mapping:{},fallback:{},multi:{scalar:[],sequence:[],mapping:[],fallback:[]}},e,t;function a(s){s.multi?(i.multi[s.kind].push(s),i.multi.fallback.push(s)):i[s.kind][s.tag]=i.fallback[s.tag]=s}for(e=0,t=arguments.length;e<t;e+=1)arguments[e].forEach(a);return i}function ia(i){return this.extend(i)}ia.prototype.extend=function(e){var t=[],a=[];if(e instanceof re)a.push(e);else if(Array.isArray(e))a=a.concat(e);else if(e&&(Array.isArray(e.implicit)||Array.isArray(e.explicit)))e.implicit&&(t=t.concat(e.implicit)),e.explicit&&(a=a.concat(e.explicit));else throw new he("Schema.extend argument should be a Type, [ Type ], or a schema definition ({ implicit: [...], explicit: [...] })");t.forEach(function(r){if(!(r instanceof re))throw new he("Specified list of YAML types (or a single Type object) contains a non-Type object.");if(r.loadKind&&r.loadKind!=="scalar")throw new he("There is a non-scalar type in the implicit list of a schema. Implicit resolving of such types is not supported.");if(r.multi)throw new he("There is a multi type in the implicit list of a schema. Multi tags can only be listed as explicit.")}),a.forEach(function(r){if(!(r instanceof re))throw new he("Specified list of YAML types (or a single Type object) contains a non-Type object.")});var s=Object.create(ia.prototype);return s.implicit=(this.implicit||[]).concat(t),s.explicit=(this.explicit||[]).concat(a),s.compiledImplicit=As(s,"implicit"),s.compiledExplicit=As(s,"explicit"),s.compiledTypeMap=Wo(s.compiledImplicit,s.compiledExplicit),s};var Ss=ia,$s=new re("tag:yaml.org,2002:str",{kind:"scalar",construct:function(i){return i!==null?i:""}}),Is=new re("tag:yaml.org,2002:seq",{kind:"sequence",construct:function(i){return i!==null?i:[]}}),Cs=new re("tag:yaml.org,2002:map",{kind:"mapping",construct:function(i){return i!==null?i:{}}}),Ts=new Ss({explicit:[$s,Is,Cs]});function Yo(i){if(i===null)return!0;var e=i.length;return e===1&&i==="~"||e===4&&(i==="null"||i==="Null"||i==="NULL")}function Zo(){return null}function Ko(i){return i===null}var Ms=new re("tag:yaml.org,2002:null",{kind:"scalar",resolve:Yo,construct:Zo,predicate:Ko,represent:{canonical:function(){return"~"},lowercase:function(){return"null"},uppercase:function(){return"NULL"},camelcase:function(){return"Null"},empty:function(){return""}},defaultStyle:"lowercase"});function Xo(i){if(i===null)return!1;var e=i.length;return e===4&&(i==="true"||i==="True"||i==="TRUE")||e===5&&(i==="false"||i==="False"||i==="FALSE")}function Jo(i){return i==="true"||i==="True"||i==="TRUE"}function el(i){return Object.prototype.toString.call(i)==="[object Boolean]"}var Fs=new re("tag:yaml.org,2002:bool",{kind:"scalar",resolve:Xo,construct:Jo,predicate:el,represent:{lowercase:function(i){return i?"true":"false"},uppercase:function(i){return i?"TRUE":"FALSE"},camelcase:function(i){return i?"True":"False"}},defaultStyle:"lowercase"});function tl(i){return 48<=i&&i<=57||65<=i&&i<=70||97<=i&&i<=102}function il(i){return 48<=i&&i<=55}function al(i){return 48<=i&&i<=57}function sl(i){if(i===null)return!1;var e=i.length,t=0,a=!1,s;if(!e)return!1;if(s=i[t],(s==="-"||s==="+")&&(s=i[++t]),s==="0"){if(t+1===e)return!0;if(s=i[++t],s==="b"){for(t++;t<e;t++)if(s=i[t],s!=="_"){if(s!=="0"&&s!=="1")return!1;a=!0}return a&&s!=="_"}if(s==="x"){for(t++;t<e;t++)if(s=i[t],s!=="_"){if(!tl(i.charCodeAt(t)))return!1;a=!0}return a&&s!=="_"}if(s==="o"){for(t++;t<e;t++)if(s=i[t],s!=="_"){if(!il(i.charCodeAt(t)))return!1;a=!0}return a&&s!=="_"}}if(s==="_")return!1;for(;t<e;t++)if(s=i[t],s!=="_"){if(!al(i.charCodeAt(t)))return!1;a=!0}return!(!a||s==="_")}function rl(i){var e=i,t=1,a;if(e.indexOf("_")!==-1&&(e=e.replace(/_/g,"")),a=e[0],(a==="-"||a==="+")&&(a==="-"&&(t=-1),e=e.slice(1),a=e[0]),e==="0")return 0;if(a==="0"){if(e[1]==="b")return t*parseInt(e.slice(2),2);if(e[1]==="x")return t*parseInt(e.slice(2),16);if(e[1]==="o")return t*parseInt(e.slice(2),8)}return t*parseInt(e,10)}function nl(i){return Object.prototype.toString.call(i)==="[object Number]"&&i%1===0&&!ee.isNegativeZero(i)}var Ps=new re("tag:yaml.org,2002:int",{kind:"scalar",resolve:sl,construct:rl,predicate:nl,represent:{binary:function(i){return i>=0?"0b"+i.toString(2):"-0b"+i.toString(2).slice(1)},octal:function(i){return i>=0?"0o"+i.toString(8):"-0o"+i.toString(8).slice(1)},decimal:function(i){return i.toString(10)},hexadecimal:function(i){return i>=0?"0x"+i.toString(16).toUpperCase():"-0x"+i.toString(16).toUpperCase().slice(1)}},defaultStyle:"decimal",styleAliases:{binary:[2,"bin"],octal:[8,"oct"],decimal:[10,"dec"],hexadecimal:[16,"hex"]}}),ol=new RegExp("^(?:[-+]?(?:[0-9][0-9_]*)(?:\\.[0-9_]*)?(?:[eE][-+]?[0-9]+)?|\\.[0-9_]+(?:[eE][-+]?[0-9]+)?|[-+]?\\.(?:inf|Inf|INF)|\\.(?:nan|NaN|NAN))$");function ll(i){return!(i===null||!ol.test(i)||i[i.length-1]==="_")}function cl(i){var e,t;return e=i.replace(/_/g,"").toLowerCase(),t=e[0]==="-"?-1:1,"+-".indexOf(e[0])>=0&&(e=e.slice(1)),e===".inf"?t===1?Number.POSITIVE_INFINITY:Number.NEGATIVE_INFINITY:e===".nan"?NaN:t*parseFloat(e,10)}var dl=/^[-+]?[0-9]+e/;function ul(i,e){var t;if(isNaN(i))switch(e){case"lowercase":return".nan";case"uppercase":return".NAN";case"camelcase":return".NaN"}else if(Number.POSITIVE_INFINITY===i)switch(e){case"lowercase":return".inf";case"uppercase":return".INF";case"camelcase":return".Inf"}else if(Number.NEGATIVE_INFINITY===i)switch(e){case"lowercase":return"-.inf";case"uppercase":return"-.INF";case"camelcase":return"-.Inf"}else if(ee.isNegativeZero(i))return"-0.0";return t=i.toString(10),dl.test(t)?t.replace("e",".e"):t}function hl(i){return Object.prototype.toString.call(i)==="[object Number]"&&(i%1!==0||ee.isNegativeZero(i))}var Ds=new re("tag:yaml.org,2002:float",{kind:"scalar",resolve:ll,construct:cl,predicate:hl,represent:ul,defaultStyle:"lowercase"}),js=Ts.extend({implicit:[Ms,Fs,Ps,Ds]}),Os=js,Rs=new RegExp("^([0-9][0-9][0-9][0-9])-([0-9][0-9])-([0-9][0-9])$"),zs=new RegExp("^([0-9][0-9][0-9][0-9])-([0-9][0-9]?)-([0-9][0-9]?)(?:[Tt]|[ \\t]+)([0-9][0-9]?):([0-9][0-9]):([0-9][0-9])(?:\\.([0-9]*))?(?:[ \\t]*(Z|([-+])([0-9][0-9]?)(?::([0-9][0-9]))?))?$");function pl(i){return i===null?!1:Rs.exec(i)!==null||zs.exec(i)!==null}function _l(i){var e,t,a,s,r,n,o,l=0,c=null,u,d,p;if(e=Rs.exec(i),e===null&&(e=zs.exec(i)),e===null)throw new Error("Date resolve error");if(t=+e[1],a=+e[2]-1,s=+e[3],!e[4])return new Date(Date.UTC(t,a,s));if(r=+e[4],n=+e[5],o=+e[6],e[7]){for(l=e[7].slice(0,3);l.length<3;)l+="0";l=+l}return e[9]&&(u=+e[10],d=+(e[11]||0),c=(u*60+d)*6e4,e[9]==="-"&&(c=-c)),p=new Date(Date.UTC(t,a,s,r,n,o,l)),c&&p.setTime(p.getTime()-c),p}function ml(i){return i.toISOString()}var Ls=new re("tag:yaml.org,2002:timestamp",{kind:"scalar",resolve:pl,construct:_l,instanceOf:Date,represent:ml});function fl(i){return i==="<<"||i===null}var Ns=new re("tag:yaml.org,2002:merge",{kind:"scalar",resolve:fl}),aa=`ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=
\r`;function gl(i){if(i===null)return!1;var e,t,a=0,s=i.length,r=aa;for(t=0;t<s;t++)if(e=r.indexOf(i.charAt(t)),!(e>64)){if(e<0)return!1;a+=6}return a%8===0}function vl(i){var e,t,a=i.replace(/[\r\n=]/g,""),s=a.length,r=aa,n=0,o=[];for(e=0;e<s;e++)e%4===0&&e&&(o.push(n>>16&255),o.push(n>>8&255),o.push(n&255)),n=n<<6|r.indexOf(a.charAt(e));return t=s%4*6,t===0?(o.push(n>>16&255),o.push(n>>8&255),o.push(n&255)):t===18?(o.push(n>>10&255),o.push(n>>2&255)):t===12&&o.push(n>>4&255),new Uint8Array(o)}function yl(i){var e="",t=0,a,s,r=i.length,n=aa;for(a=0;a<r;a++)a%3===0&&a&&(e+=n[t>>18&63],e+=n[t>>12&63],e+=n[t>>6&63],e+=n[t&63]),t=(t<<8)+i[a];return s=r%3,s===0?(e+=n[t>>18&63],e+=n[t>>12&63],e+=n[t>>6&63],e+=n[t&63]):s===2?(e+=n[t>>10&63],e+=n[t>>4&63],e+=n[t<<2&63],e+=n[64]):s===1&&(e+=n[t>>2&63],e+=n[t<<4&63],e+=n[64],e+=n[64]),e}function bl(i){return Object.prototype.toString.call(i)==="[object Uint8Array]"}var qs=new re("tag:yaml.org,2002:binary",{kind:"scalar",resolve:gl,construct:vl,predicate:bl,represent:yl}),xl=Object.prototype.hasOwnProperty,wl=Object.prototype.toString;function kl(i){if(i===null)return!0;var e=[],t,a,s,r,n,o=i;for(t=0,a=o.length;t<a;t+=1){if(s=o[t],n=!1,wl.call(s)!=="[object Object]")return!1;for(r in s)if(xl.call(s,r))if(!n)n=!0;else return!1;if(!n)return!1;if(e.indexOf(r)===-1)e.push(r);else return!1}return!0}function El(i){return i!==null?i:[]}var Us=new re("tag:yaml.org,2002:omap",{kind:"sequence",resolve:kl,construct:El}),Al=Object.prototype.toString;function Sl(i){if(i===null)return!0;var e,t,a,s,r,n=i;for(r=new Array(n.length),e=0,t=n.length;e<t;e+=1){if(a=n[e],Al.call(a)!=="[object Object]"||(s=Object.keys(a),s.length!==1))return!1;r[e]=[s[0],a[s[0]]]}return!0}function $l(i){if(i===null)return[];var e,t,a,s,r,n=i;for(r=new Array(n.length),e=0,t=n.length;e<t;e+=1)a=n[e],s=Object.keys(a),r[e]=[s[0],a[s[0]]];return r}var Bs=new re("tag:yaml.org,2002:pairs",{kind:"sequence",resolve:Sl,construct:$l}),Il=Object.prototype.hasOwnProperty;function Cl(i){if(i===null)return!0;var e,t=i;for(e in t)if(Il.call(t,e)&&t[e]!==null)return!1;return!0}function Tl(i){return i!==null?i:{}}var Gs=new re("tag:yaml.org,2002:set",{kind:"mapping",resolve:Cl,construct:Tl}),sa=Os.extend({implicit:[Ls,Ns],explicit:[qs,Us,Bs,Gs]}),Ne=Object.prototype.hasOwnProperty,li=1,Hs=2,Vs=3,ci=4,ra=1,Ml=2,Qs=3,Fl=/[\x00-\x08\x0B\x0C\x0E-\x1F\x7F-\x84\x86-\x9F\uFFFE\uFFFF]|[\uD800-\uDBFF](?![\uDC00-\uDFFF])|(?:[^\uD800-\uDBFF]|^)[\uDC00-\uDFFF]/,Pl=/[\x85\u2028\u2029]/,Dl=/[,\[\]\{\}]/,Ws=/^(?:!|!!|![a-z\-]+!)$/i,Ys=/^(?:!|[^,\[\]\{\}])(?:%[0-9a-f]{2}|[0-9a-z\-#;\/\?:@&=\+\$,_\.!~\*'\(\)\[\]])*$/i;function Zs(i){return Object.prototype.toString.call(i)}function $e(i){return i===10||i===13}function it(i){return i===9||i===32}function fe(i){return i===9||i===32||i===10||i===13}function ct(i){return i===44||i===91||i===93||i===123||i===125}function jl(i){var e;return 48<=i&&i<=57?i-48:(e=i|32,97<=e&&e<=102?e-97+10:-1)}function Ol(i){return i===120?2:i===117?4:i===85?8:0}function Rl(i){return 48<=i&&i<=57?i-48:-1}function Ks(i){return i===48?"\0":i===97?"\x07":i===98?"\b":i===116||i===9?"	":i===110?`
`:i===118?"\v":i===102?"\f":i===114?"\r":i===101?"\x1B":i===32?" ":i===34?'"':i===47?"/":i===92?"\\":i===78?"\x85":i===95?"\xA0":i===76?"\u2028":i===80?"\u2029":""}function zl(i){return i<=65535?String.fromCharCode(i):String.fromCharCode((i-65536>>10)+55296,(i-65536&1023)+56320)}function Xs(i,e,t){e==="__proto__"?Object.defineProperty(i,e,{configurable:!0,enumerable:!0,writable:!0,value:t}):i[e]=t}for(var Js=new Array(256),er=new Array(256),dt=0;dt<256;dt++)Js[dt]=Ks(dt)?1:0,er[dt]=Ks(dt);function Ll(i,e){this.input=i,this.filename=e.filename||null,this.schema=e.schema||sa,this.onWarning=e.onWarning||null,this.legacy=e.legacy||!1,this.json=e.json||!1,this.listener=e.listener||null,this.implicitTypes=this.schema.compiledImplicit,this.typeMap=this.schema.compiledTypeMap,this.length=i.length,this.position=0,this.line=0,this.lineStart=0,this.lineIndent=0,this.firstTabInLine=-1,this.documents=[]}function tr(i,e){var t={name:i.filename,buffer:i.input.slice(0,-1),position:i.position,line:i.line,column:i.position-i.lineStart};return t.snippet=Bo(t),new he(e,t)}function S(i,e){throw tr(i,e)}function di(i,e){i.onWarning&&i.onWarning.call(null,tr(i,e))}var ir={YAML:function(e,t,a){var s,r,n;e.version!==null&&S(e,"duplication of %YAML directive"),a.length!==1&&S(e,"YAML directive accepts exactly one argument"),s=/^([0-9]+)\.([0-9]+)$/.exec(a[0]),s===null&&S(e,"ill-formed argument of the YAML directive"),r=parseInt(s[1],10),n=parseInt(s[2],10),r!==1&&S(e,"unacceptable YAML version of the document"),e.version=a[0],e.checkLineBreaks=n<2,n!==1&&n!==2&&di(e,"unsupported YAML version of the document")},TAG:function(e,t,a){var s,r;a.length!==2&&S(e,"TAG directive accepts exactly two arguments"),s=a[0],r=a[1],Ws.test(s)||S(e,"ill-formed tag handle (first argument) of the TAG directive"),Ne.call(e.tagMap,s)&&S(e,'there is a previously declared suffix for "'+s+'" tag handle'),Ys.test(r)||S(e,"ill-formed tag prefix (second argument) of the TAG directive");try{r=decodeURIComponent(r)}catch{S(e,"tag prefix is malformed: "+r)}e.tagMap[s]=r}};function qe(i,e,t,a){var s,r,n,o;if(e<t){if(o=i.input.slice(e,t),a)for(s=0,r=o.length;s<r;s+=1)n=o.charCodeAt(s),n===9||32<=n&&n<=1114111||S(i,"expected valid JSON character");else Fl.test(o)&&S(i,"the stream contains non-printable characters");i.result+=o}}function ar(i,e,t,a){var s,r,n,o;for(ee.isObject(t)||S(i,"cannot merge mappings; the provided source object is unacceptable"),s=Object.keys(t),n=0,o=s.length;n<o;n+=1)r=s[n],Ne.call(e,r)||(Xs(e,r,t[r]),a[r]=!0)}function ut(i,e,t,a,s,r,n,o,l){var c,u;if(Array.isArray(s))for(s=Array.prototype.slice.call(s),c=0,u=s.length;c<u;c+=1)Array.isArray(s[c])&&S(i,"nested arrays are not supported inside keys"),typeof s=="object"&&Zs(s[c])==="[object Object]"&&(s[c]="[object Object]");if(typeof s=="object"&&Zs(s)==="[object Object]"&&(s="[object Object]"),s=String(s),e===null&&(e={}),a==="tag:yaml.org,2002:merge")if(Array.isArray(r))for(c=0,u=r.length;c<u;c+=1)ar(i,e,r[c],t);else ar(i,e,r,t);else!i.json&&!Ne.call(t,s)&&Ne.call(e,s)&&(i.line=n||i.line,i.lineStart=o||i.lineStart,i.position=l||i.position,S(i,"duplicated mapping key")),Xs(e,s,r),delete t[s];return e}function na(i){var e;e=i.input.charCodeAt(i.position),e===10?i.position++:e===13?(i.position++,i.input.charCodeAt(i.position)===10&&i.position++):S(i,"a line break is expected"),i.line+=1,i.lineStart=i.position,i.firstTabInLine=-1}function K(i,e,t){for(var a=0,s=i.input.charCodeAt(i.position);s!==0;){for(;it(s);)s===9&&i.firstTabInLine===-1&&(i.firstTabInLine=i.position),s=i.input.charCodeAt(++i.position);if(e&&s===35)do s=i.input.charCodeAt(++i.position);while(s!==10&&s!==13&&s!==0);if($e(s))for(na(i),s=i.input.charCodeAt(i.position),a++,i.lineIndent=0;s===32;)i.lineIndent++,s=i.input.charCodeAt(++i.position);else break}return t!==-1&&a!==0&&i.lineIndent<t&&di(i,"deficient indentation"),a}function ui(i){var e=i.position,t;return t=i.input.charCodeAt(e),!!((t===45||t===46)&&t===i.input.charCodeAt(e+1)&&t===i.input.charCodeAt(e+2)&&(e+=3,t=i.input.charCodeAt(e),t===0||fe(t)))}function oa(i,e){e===1?i.result+=" ":e>1&&(i.result+=ee.repeat(`
`,e-1))}function Nl(i,e,t){var a,s,r,n,o,l,c,u,d=i.kind,p=i.result,_;if(_=i.input.charCodeAt(i.position),fe(_)||ct(_)||_===35||_===38||_===42||_===33||_===124||_===62||_===39||_===34||_===37||_===64||_===96||(_===63||_===45)&&(s=i.input.charCodeAt(i.position+1),fe(s)||t&&ct(s)))return!1;for(i.kind="scalar",i.result="",r=n=i.position,o=!1;_!==0;){if(_===58){if(s=i.input.charCodeAt(i.position+1),fe(s)||t&&ct(s))break}else if(_===35){if(a=i.input.charCodeAt(i.position-1),fe(a))break}else{if(i.position===i.lineStart&&ui(i)||t&&ct(_))break;if($e(_))if(l=i.line,c=i.lineStart,u=i.lineIndent,K(i,!1,-1),i.lineIndent>=e){o=!0,_=i.input.charCodeAt(i.position);continue}else{i.position=n,i.line=l,i.lineStart=c,i.lineIndent=u;break}}o&&(qe(i,r,n,!1),oa(i,i.line-l),r=n=i.position,o=!1),it(_)||(n=i.position+1),_=i.input.charCodeAt(++i.position)}return qe(i,r,n,!1),i.result?!0:(i.kind=d,i.result=p,!1)}function ql(i,e){var t,a,s;if(t=i.input.charCodeAt(i.position),t!==39)return!1;for(i.kind="scalar",i.result="",i.position++,a=s=i.position;(t=i.input.charCodeAt(i.position))!==0;)if(t===39)if(qe(i,a,i.position,!0),t=i.input.charCodeAt(++i.position),t===39)a=i.position,i.position++,s=i.position;else return!0;else $e(t)?(qe(i,a,s,!0),oa(i,K(i,!1,e)),a=s=i.position):i.position===i.lineStart&&ui(i)?S(i,"unexpected end of the document within a single quoted scalar"):(i.position++,s=i.position);S(i,"unexpected end of the stream within a single quoted scalar")}function Ul(i,e){var t,a,s,r,n,o;if(o=i.input.charCodeAt(i.position),o!==34)return!1;for(i.kind="scalar",i.result="",i.position++,t=a=i.position;(o=i.input.charCodeAt(i.position))!==0;){if(o===34)return qe(i,t,i.position,!0),i.position++,!0;if(o===92){if(qe(i,t,i.position,!0),o=i.input.charCodeAt(++i.position),$e(o))K(i,!1,e);else if(o<256&&Js[o])i.result+=er[o],i.position++;else if((n=Ol(o))>0){for(s=n,r=0;s>0;s--)o=i.input.charCodeAt(++i.position),(n=jl(o))>=0?r=(r<<4)+n:S(i,"expected hexadecimal character");i.result+=zl(r),i.position++}else S(i,"unknown escape sequence");t=a=i.position}else $e(o)?(qe(i,t,a,!0),oa(i,K(i,!1,e)),t=a=i.position):i.position===i.lineStart&&ui(i)?S(i,"unexpected end of the document within a double quoted scalar"):(i.position++,a=i.position)}S(i,"unexpected end of the stream within a double quoted scalar")}function Bl(i,e){var t=!0,a,s,r,n=i.tag,o,l=i.anchor,c,u,d,p,_,g=Object.create(null),y,v,k,x;if(x=i.input.charCodeAt(i.position),x===91)u=93,_=!1,o=[];else if(x===123)u=125,_=!0,o={};else return!1;for(i.anchor!==null&&(i.anchorMap[i.anchor]=o),x=i.input.charCodeAt(++i.position);x!==0;){if(K(i,!0,e),x=i.input.charCodeAt(i.position),x===u)return i.position++,i.tag=n,i.anchor=l,i.kind=_?"mapping":"sequence",i.result=o,!0;t?x===44&&S(i,"expected the node content, but found ','"):S(i,"missed comma between flow collection entries"),v=y=k=null,d=p=!1,x===63&&(c=i.input.charCodeAt(i.position+1),fe(c)&&(d=p=!0,i.position++,K(i,!0,e))),a=i.line,s=i.lineStart,r=i.position,ht(i,e,li,!1,!0),v=i.tag,y=i.result,K(i,!0,e),x=i.input.charCodeAt(i.position),(p||i.line===a)&&x===58&&(d=!0,x=i.input.charCodeAt(++i.position),K(i,!0,e),ht(i,e,li,!1,!0),k=i.result),_?ut(i,o,g,v,y,k,a,s,r):d?o.push(ut(i,null,g,v,y,k,a,s,r)):o.push(y),K(i,!0,e),x=i.input.charCodeAt(i.position),x===44?(t=!0,x=i.input.charCodeAt(++i.position)):t=!1}S(i,"unexpected end of the stream within a flow collection")}function Gl(i,e){var t,a,s=ra,r=!1,n=!1,o=e,l=0,c=!1,u,d;if(d=i.input.charCodeAt(i.position),d===124)a=!1;else if(d===62)a=!0;else return!1;for(i.kind="scalar",i.result="";d!==0;)if(d=i.input.charCodeAt(++i.position),d===43||d===45)ra===s?s=d===43?Qs:Ml:S(i,"repeat of a chomping mode identifier");else if((u=Rl(d))>=0)u===0?S(i,"bad explicit indentation width of a block scalar; it cannot be less than one"):n?S(i,"repeat of an indentation width identifier"):(o=e+u-1,n=!0);else break;if(it(d)){do d=i.input.charCodeAt(++i.position);while(it(d));if(d===35)do d=i.input.charCodeAt(++i.position);while(!$e(d)&&d!==0)}for(;d!==0;){for(na(i),i.lineIndent=0,d=i.input.charCodeAt(i.position);(!n||i.lineIndent<o)&&d===32;)i.lineIndent++,d=i.input.charCodeAt(++i.position);if(!n&&i.lineIndent>o&&(o=i.lineIndent),$e(d)){l++;continue}if(i.lineIndent<o){s===Qs?i.result+=ee.repeat(`
...
`,r?1+l:l),r=!0,n=!0,l=0,t=i.position;!$e(d)&&d!==0;)d=i.input.charCodeAt(++i.position);qe(i,t,i.position,!1)}return!0}function sr(i,e){var t,a=i.tag,s=i.anchor,r=[],n,o=!1,l;if(i.firstTabInLine!==-1)return!1;for(i.anchor!==null&&(i.anchorMap[i.anchor]=r),l=i.input.charCodeAt(i.position);l!==0&&(i.firstTabInLine!==-1&&(i.position=i.firstTabInLine,S(i,"tab characters must not be used in indentation")),!(l!==45||(n=i.input.charCodeAt(i.position+1),!fe(n))));){if(o=!0,i.position++,K(i,!0,-1)&&i.lineIndent<=e){r.push(null),l=i.input.charCodeAt(i.position);continue}if(t=i.line,ht(i,e,Vs,!1,!0),r.push(i.result),K(i,!0,-1),l=i.input.charCodeAt(i.position),(i.line===t||i.lineIndent>e)&&l!==0)S(i,"bad indentation of a sequence entry");else if(i.lineIndent<e)break}return o?(i.tag=a,i.anchor=s,i.kind="sequence",i.result=r,!0):!1}function Hl(i,e,t){var a,s,r,n,o,l,c=i.tag,u=i.anchor,d={},p=Object.create(null),_=null,g=null,y=null,v=!1,k=!1,x;if(i.firstTabInLine!==-1)return!1;for(i.anchor!==null&&(i.anchorMap[i.anchor]=d),x=i.input.charCodeAt(i.position);x!==0;){if(!v&&i.firstTabInLine!==-1&&(i.position=i.firstTabInLine,S(i,"tab characters must not be used in indentation")),a=i.input.charCodeAt(i.position+1),r=i.line,(x===63||x===58)&&fe(a))x===63?(v&&(ut(i,d,p,_,g,null,n,o,l),_=g=y=null),k=!0,v=!0,s=!0):v?(v=!1,s=!0):S(i,"incomplete explicit mapping pair; a key node is missed; or followed by a non-tabulated empty line"),i.position+=1,x=a;else{if(n=i.line,o=i.lineStart,l=i.position,!ht(i,t,Hs,!1,!0))break;if(i.line===r){for(x=i.input.charCodeAt(i.position);it(x);)x=i.input.charCodeAt(++i.position);if(x===58)x=i.input.charCodeAt(++i.position),fe(x)||S(i,"a whitespace character is expected after the key-value separator within a block mapping"),v&&(ut(i,d,p,_,g,null,n,o,l),_=g=y=null),k=!0,v=!1,s=!1,_=i.tag,g=i.result;else if(k)S(i,"can not read an implicit mapping pair; a colon is missed");else return i.tag=c,i.anchor=u,!0}else if(k)S(i,"can not read a block mapping entry; a multiline key may not be an implicit key");else return i.tag=c,i.anchor=u,!0}if((i.line===r||i.lineIndent>e)&&(v&&(n=i.line,o=i.lineStart,l=i.position),ht(i,e,ci,!0,s)&&(v?g=i.result:y=i.result),v||(ut(i,d,p,_,g,y,n,o,l),_=g=y=null),K(i,!0,-1),x=i.input.charCodeAt(i.position)),(i.line===r||i.lineIndent>e)&&x!==0)S(i,"bad indentation of a mapping entry");else if(i.lineIndent<e)break}return v&&ut(i,d,p,_,g,null,n,o,l),k&&(i.tag=c,i.anchor=u,i.kind="mapping",i.result=d),k}function Vl(i){var e,t=!1,a=!1,s,r,n;if(n=i.input.charCodeAt(i.position),n!==33)return!1;if(i.tag!==null&&S(i,"duplication of a tag property"),n=i.input.charCodeAt(++i.position),n===60?(t=!0,n=i.input.charCodeAt(++i.position)):n===33?(a=!0,s="!!",n=i.input.charCodeAt(++i.position)):s="!",e=i.position,t){do n=i.input.charCodeAt(++i.position);while(n!==0&&n!==62);i.position<i.length?(r=i.input.slice(e,i.position),n=i.input.charCodeAt(++i.position)):S(i,"unexpected end of the stream within a verbatim tag")}else{for(;n!==0&&!fe(n);)n===33&&(a?S(i,"tag suffix cannot contain exclamation marks"):(s=i.input.slice(e-1,i.position+1),Ws.test(s)||S(i,"named tag handle cannot contain such characters"),a=!0,e=i.position+1)),n=i.input.charCodeAt(++i.position);r=i.input.slice(e,i.position),Dl.test(r)&&S(i,"tag suffix cannot contain flow indicator characters")}r&&!Ys.test(r)&&S(i,"tag name cannot contain such characters: "+r);try{r=decodeURIComponent(r)}catch{S(i,"tag name is malformed: "+r)}return t?i.tag=r:Ne.call(i.tagMap,s)?i.tag=i.tagMap[s]+r:s==="!"?i.tag="!"+r:s==="!!"?i.tag="tag:yaml.org,2002:"+r:S(i,'undeclared tag handle "'+s+'"'),!0}function Ql(i){var e,t;if(t=i.input.charCodeAt(i.position),t!==38)return!1;for(i.anchor!==null&&S(i,"duplication of an anchor property"),t=i.input.charCodeAt(++i.position),e=i.position;t!==0&&!fe(t)&&!ct(t);)t=i.input.charCodeAt(++i.position);return i.position===e&&S(i,"name of an anchor node must contain at least one character"),i.anchor=i.input.slice(e,i.position),!0}function Wl(i){var e,t,a;if(a=i.input.charCodeAt(i.position),a!==42)return!1;for(a=i.input.charCodeAt(++i.position),e=i.position;a!==0&&!fe(a)&&!ct(a);)a=i.input.charCodeAt(++i.position);return i.position===e&&S(i,"name of an alias node must contain at least one character"),t=i.input.slice(e,i.position),Ne.call(i.anchorMap,t)||S(i,'unidentified alias "'+t+'"'),i.result=i.anchorMap[t],K(i,!0,-1),!0}function ht(i,e,t,a,s){var r,n,o,l=1,c=!1,u=!1,d,p,_,g,y,v;if(i.listener!==null&&i.listener("open",i),i.tag=null,i.anchor=null,i.kind=null,i.result=null,r=n=o=ci===t||Vs===t,a&&K(i,!0,-1)&&(c=!0,i.lineIndent>e?l=1:i.lineIndent===e?l=0:i.lineIndent<e&&(l=-1)),l===1)for(;Vl(i)||Ql(i);)K(i,!0,-1)?(c=!0,o=r,i.lineIndent>e?l=1:i.lineIndent===e?l=0:i.lineIndent<e&&(l=-1)):o=!1;if(o&&(o=c||s),(l===1||ci===t)&&(li===t||Hs===t?y=e:y=e+1,v=i.position-i.lineStart,l===1?o&&(sr(i,v)||Hl(i,v,y))||Bl(i,y)?u=!0:(n&&Gl(i,y)||ql(i,y)||Ul(i,y)?u=!0:Wl(i)?(u=!0,(i.tag!==null||i.anchor!==null)&&S(i,"alias node should not have any properties")):Nl(i,y,li===t)&&(u=!0,i.tag===null&&(i.tag="?")),i.anchor!==null&&(i.anchorMap[i.anchor]=i.result)):l===0&&(u=o&&sr(i,v))),i.tag===null)i.anchor!==null&&(i.anchorMap[i.anchor]=i.result);else if(i.tag==="?"){for(i.result!==null&&i.kind!=="scalar"&&S(i,'unacceptable node kind for !<?> tag; it should be "scalar", not "'+i.kind+'"'),d=0,p=i.implicitTypes.length;d<p;d+=1)if(g=i.implicitTypes[d],g.resolve(i.result)){i.result=g.construct(i.result),i.tag=g.tag,i.anchor!==null&&(i.anchorMap[i.anchor]=i.result);break}}else if(i.tag!=="!"){if(Ne.call(i.typeMap[i.kind||"fallback"],i.tag))g=i.typeMap[i.kind||"fallback"][i.tag];else for(g=null,_=i.typeMap.multi[i.kind||"fallback"],d=0,p=_.length;d<p;d+=1)if(i.tag.slice(0,_[d].tag.length)===_[d].tag){g=_[d];break}g||S(i,"unknown tag !<"+i.tag+">"),i.result!==null&&g.kind!==i.kind&&S(i,"unacceptable node kind for !<"+i.tag+'> tag; it should be "'+g.kind+'", not "'+i.kind+'"'),g.resolve(i.result,i.tag)?(i.result=g.construct(i.result,i.tag),i.anchor!==null&&(i.anchorMap[i.anchor]=i.result)):S(i,"cannot resolve a node with !<"+i.tag+"> explicit tag")}return i.listener!==null&&i.listener("close",i),i.tag!==null||i.anchor!==null||u}function Yl(i){var e=i.position,t,a,s,r=!1,n;for(i.version=null,i.checkLineBreaks=i.legacy,i.tagMap=Object.create(null),i.anchorMap=Object.create(null);(n=i.input.charCodeAt(i.position))!==0&&(K(i,!0,-1),n=i.input.charCodeAt(i.position),!(i.lineIndent>0||n!==37));){for(r=!0,n=i.input.charCodeAt(++i.position),t=i.position;n!==0&&!fe(n);)n=i.input.charCodeAt(++i.position);for(a=i.input.slice(t,i.position),s=[],a.length<1&&S(i,"directive name must not be less than one character in length");n!==0;){for(;it(n);)n=i.input.charCodeAt(++i.position);if(n===35){do n=i.input.charCodeAt(++i.position);while(n!==0&&!$e(n));break}if($e(n))break;for(t=i.position;n!==0&&!fe(n);)n=i.input.charCodeAt(++i.position);s.push(i.input.slice(t,i.position))}n!==0&&na(i),Ne.call(ir,a)?ir[a](i,a,s):di(i,'unknown document directive "'+a+'"')}if(K(i,!0,-1),i.lineIndent===0&&i.input.charCodeAt(i.position)===45&&i.input.charCodeAt(i.position+1)===45&&i.input.charCodeAt(i.position+2)===45?(i.position+=3,K(i,!0,-1)):r&&S(i,"directives end mark is expected"),ht(i,i.lineIndent-1,ci,!1,!0),K(i,!0,-1),i.checkLineBreaks&&Pl.test(i.input.slice(e,i.position))&&di(i,"non-ASCII line breaks are interpreted as content"),i.documents.push(i.result),i.position===i.lineStart&&ui(i)){i.input.charCodeAt(i.position)===46&&(i.position+=3,K(i,!0,-1));return}if(i.position<i.length-1)S(i,"end of the stream or a document separator is expected");else return}function rr(i,e){i=String(i),e=e||{},i.length!==0&&(i.charCodeAt(i.length-1)!==10&&i.charCodeAt(i.length-1)!==13&&(i+=`
...
{% endif %}</pre>
    ...
    `}_renderGroupingMenuOption(){if(this.entityIds.length<=1)return b;const e=this.entityIds.reduce((n,o,l)=>{const c=this._getGroupingEntityId(l),u=this.hass.states[c];return n+(this._isGroupCapable(u)?1:0)},0),t=this._getGroupingEntityId(this._selectedIndex),a=this.hass.states[t],s=this.currentEntityId,r=this._getGroupKey(s)!==s;return e>1&&this._isGroupCapable(a)&&!r?m`
      ...
      `;const g=[...n].sort((y,v)=>{if(r){if(y.id===e)return-1;if(v.id===e)return 1}else{if(y.id===l)return-1;if(v.id===l)return 1}return y.isBusy===v.isBusy?0:y.isBusy?1:-1});return m`
      ...
      <div class="group-list-scroll">
        ...
        `:g.map(y=>{const v=y.id,k=y.groupId,x=(Array.isArray(s?.attributes?.group_members)?s.attributes.group_members:[]).includes(k),j=this.getChipName(v),E=y.isBusy,G=y.busyLabel,B=this.entityIds.indexOf(v),z=this._getVolumeEntityForGrouping(B)||k,L=this.hass.states[z],N=z?.startsWith&&z.startsWith("remote."),T=Number(L?.attributes?.volume_level||0),M=v===e,q=!M;let H=h(r?M?"card.grouping.master":x?"card.grouping.joined":"card.grouping.available":v===l?"card.grouping.current":"card.grouping.available");return E&&(H=G||"Unavailable"),m`
    ...
    `}updated(e){if(this._idleImageTemplate&&e.has("hass")&&(this._idleImageTemplateNeedsResolve=!0),(e.has("_selectedIndex")||e.has("hass"))&&this._updateTransferQueueAvailability({refresh:!1}),this.hass&&this._hasMassQueueIntegration===null&&!this._checkingMassQueueIntegration&&(this._checkingMassQueueIntegration=!0,this._isMassQueueIntegrationAvailable(this.hass).then(s=>{this._hasMassQueueIntegration=s,s&&(this._massQueueAvailable=this._massQueueAvailable||s)}).catch(()=>{this._hasMassQueueIntegration=!1}).finally(()=>{this._checkingMassQueueIntegration=!1,this.requestUpdate()})),this.hass&&this.entityIds){if(this._upcomingFilterActive){const o=this.currentActivePlaybackEntityId;if(o){const l=this.hass.states[o]?.attributes?.media_title;if(l&&l!==this._lastMediaTitle){this._lastMediaTitle=l,this._searchLoading=!0,this.requestUpdate();const c=`${this._searchMediaClassFilter||"all"}_upcoming`;delete this._searchResultsByType[c],setTimeout(()=>{this._doSearch(this._searchMediaClassFilter==="all"?null:this._searchMediaClassFilter)},4e3)}}}const s=Date.now();for(let o=0;o<this.entityIds.length;o++){const l=this.entityIds[o],c=this.entityObjs[o];if(!c)continue;const u=c.entity_id,d=this._getActualResolvedMaEntityForState(o),p=this.hass.states[u]?.state,_=this._playerStateCache[u];if(p==="playing"?(this._playTimestamps[u]=s,this._lastActiveEntityIdByChip[o]=u):_==="playing"&&p!=="playing"&&(this._playTimestamps[u]=s),this._playerStateCache[u]=p,d&&d!==u){const y=this.hass.states[d]?.state,v=this._playerStateCache[d];y==="playing"?(this._playTimestamps[d]=s,this._lastActiveEntityIdByChip[o]=d):v==="playing"&&y!=="playing"&&(this._playTimestamps[d]=s),this._playerStateCache[d]=y}const g=this._getEntityForPurpose(o,"sorting");g&&this.hass.states[g]?.state==="playing"&&(this._playTimestamps[l]=s)}if(this._manualSelect&&this._pinnedIndex===null&&this._manualSelectPlayingSet){for(const o of[...this._manualSelectPlayingSet]){const l=this.hass.states[o];this._isEntityPlaying(l)||this._manualSelectPlayingSet.delete(o)}for(const o of this.entityIds){const l=this.hass.states[o];if(this._isEntityPlaying(l)&&!this._manualSelectPlayingSet.has(o)){this._manualSelect=!1,this._manualSelectPlayingSet=null;break}}}if(this._updateIdleState(),!this._manualSelect&&!this.isAnyMenuOpen){const o=this.sortedEntityIds;if(o.length>0){let l=o[0];const c=l?(this.groupedSortedEntityIds||[]).find(g=>g.includes(l)):null;if(c&&c.length>1){const g=this._getActualGroupMaster(c);g&&(l=g)}const u=this.entityIds.indexOf(l),d=u>=0?this._getEntityForPurpose(u,"sorting"):null,p=d?this.hass.states[d]:null,_=this._isCurrentEntityPlaying();this._isEntityPlaying(p)&&this.entityIds[this._selectedIndex]!==l&&(!this._idleTimeout||!this._hasSeenPlayback)&&!_&&!this.entityObjs[u]?.disable_auto_select&&(this._selectedIndex=u)}}const r=this.entityIds[this._selectedIndex],n=r?(this.groupedSortedEntityIds||[]).find(o=>o.includes(r)):null;if(n&&n.length>1){const o=this._getActualGroupMaster(n);if(o&&o!==r){const l=this.entityIds.indexOf(o);l>=0&&!this.entityObjs[l]?.disable_auto_select&&(this._selectedIndex=l,this._lastGroupingMasterId=o)}}this._ensureResolvedMaForIndex(this._selectedIndex),this._ensureResolvedVolForIndex(this._selectedIndex),this._updateSelectedEntityHelper()}super.updated?.(e),this._progressTimer&&(clearInterval(this._progressTimer),this._progressTimer=null);const t=this.currentActivePlaybackStateObj||this.currentPlaybackStateObj||this.currentStateObj;if(this._isEntityPlaying(t)&&t.attributes.media_duration&&(this._progressTimer=setInterval(()=>{this.requestUpdate()},500)),this._alwaysCollapsed&&this._expandOnSearch&&(this._searchOpen||this._showSearchInSheet)){this._prevCollapsed!==!1&&(this._prevCollapsed=!1,this._notifyResize());return}const a=this._alwaysCollapsed?!0:this._collapseOnIdle?this._isIdle:!1;if(this._prevCollapsed!==a&&(this._prevCollapsed=a,this._notifyResize()),this._addGrabScroll(".chip-row"),this._addGrabScroll(".action-chip-row"),this._addGrabScroll(".search-filter-chips"),this._addVerticalGrabScroll(".floating-source-index"),this._lastRenderedCollapsed&&!this._lastRenderedHideControls){const s=this.renderRoot?.querySelector(".card-lower-content");if(s){const r=s.offsetHeight;if(r&&r>0){const n=Number(this.config?.card_height);Number.isFinite(n)&&n>0?(!this._collapsedBaselineHeight||r<this._collapsedBaselineHeight-1)&&(this._collapsedBaselineHeight=r):this._collapsedBaselineHeight=r}}}this._showSearchInSheet&&(this._alwaysCollapsed&&this._expandOnSearch,setTimeout(()=>{const s=()=>{const o=this.renderRoot.querySelector("#search-input-box");return o?(o.focus(),this._searchInputAutoFocused=!0,!0):!1};!this._disableSearchAutofocus&&!this._searchInputAutoFocused&&(s()||setTimeout(()=>{this._showSearchInSheet&&!this._disableSearchAutofocus&&!this._searchInputAutoFocused&&s()},200));const r=this._getVisibleSearchFilterClasses().join(",");if((!this._searchLoading||r)&&this._lastSearchChipClasses!==r){const o=this.renderRoot.querySelector(".search-filter-chips");o&&(o.scrollLeft=0);const l=this.renderRoot.querySelector(".entity-options-overlay");l&&(l.scrollTop=0);const c=this.renderRoot.querySelector(".entity-options-sheet");c&&(c.scrollTop=0),this._lastSearchChipClasses=r}const n=this.renderRoot.querySelector("#search-filter-chip-row");n&&(n.scrollWidth>n.clientWidth+2?n.style.justifyContent="flex-start":n.style.justifyContent="center")},200)),this._showSourceList&&setTimeout(()=>{const s=this.renderRoot.querySelector(".entity-options-overlay");s&&(s.scrollTop=0)},0)}_toggleSourceMenu(){this._showSourceMenu=!this._showSourceMenu,this._showSourceMenu?(this._manualSelect=!0,setTimeout(()=>{this._shouldDropdownOpenUp=!0,this.requestUpdate(),this._addSourceDropdownOutsideHandler()},0)):(this._manualSelect=!1,this._removeSourceDropdownOutsideHandler())}_addSourceDropdownOutsideHandler(){this._sourceDropdownOutsideHandler||(this._sourceDropdownOutsideHandler=e=>{const t=this.renderRoot.querySelector(".source-dropdown"),a=this.renderRoot.querySelector(".source-menu-btn"),s=e.composedPath?e.composedPath():[];t&&s.includes(t)||a&&s.includes(a)||(this._showSourceMenu=!1,this._manualSelect=!1,this._removeSourceDropdownOutsideHandler(),this.requestUpdate())},window.addEventListener("mousedown",this._sourceDropdownOutsideHandler,!0),window.addEventListener("touchstart",this._sourceDropdownOutsideHandler,!0))}_removeSourceDropdownOutsideHandler(){this._sourceDropdownOutsideHandler&&(window.removeEventListener("mousedown",this._sourceDropdownOutsideHandler,!0),window.removeEventListener("touchstart",this._sourceDropdownOutsideHandler,!0),this._sourceDropdownOutsideHandler=null)}_selectSource(e){const t=this.currentEntityId;!t||!e||(this.hass.callService("media_player","select_source",{entity_id:t,source:e}),this._closeEntityOptions())}_onPinClick(e){e.stopPropagation(),this._manualSelect=!1,this._pinnedIndex=null,this._manualSelectPlayingSet=null}_onChipClick(e){if(this._holdToPin&&this._justPinned){this._justPinned=!1;return}if(this._selectedIndex=e,this._lastActiveEntityId=null,clearTimeout(this._manualSelectTimeout),this._holdToPin)if(this._pinnedIndex!==null)this._manualSelect=!0;else{this._manualSelect=!0,this._manualSelectPlayingSet=new Set;for(const t of this.entityIds){const a=this.hass?.states?.[t];this._isEntityPlaying(a)&&this._manualSelectPlayingSet.add(t)}}else this._manualSelect=!0,this._pinnedIndex=e;this.requestUpdate()}_pinChip(e){this._justPinned=!0,clearTimeout(this._manualSelectTimeout),this._manualSelectPlayingSet=null,this._pinnedIndex=e,this._manualSelect=!0,this.requestUpdate()}async _onActionChipClick(e){const t=this.config.actions[e];t&&await this._handleAction(t)}async _handleAction(e){if(!e)return;if(e.menu_item){switch(this._quickMenuInvoke=!0,e.menu_item){case"more-info":this._openMoreInfo(),this._showEntityOptions=!1,this.requestUpdate();break;case"group-players":this._showEntityOptions=!0,this._showGrouping=!0,this.requestUpdate();break;case"search":this._openQuickSearchOverlay();break;case"search-recently-played":this._showEntityOptions=!0,this._showSearchSheetInOptions("recently-played"),setTimeout(()=>{this._notifyResize()},0);break;case"search-next-up":this._showEntityOptions=!0,this._showSearchSheetInOptions("next-up"),setTimeout(()=>{this._notifyResize()},0);break;case"source":this._showEntityOptions=!0,this._showSourceList=!0,this._showGrouping=!1,this.requestUpdate();break;case"transfer-queue":this._showEntityOptions=!0,this._openTransferQueue();break}return}if(typeof e.navigation_path=="string"&&e.navigation_path.trim()!==""||e.action==="navigate"){let r=(typeof e.navigation_path=="string"?e.navigation_path:e.path||"").trim();const n=e.navigation_new_tab===!0,o={current:this.currentActivePlaybackEntityId||this.currentEntityId||""};let l=null;n&&(l=io(this.hass,r,o)),l!=null?this._handleNavigate(l,n):(r=await to(this.hass,r,o),this._handleNavigate(r,n));return}if(!e.service)return;const[t,a]=e.service.split(".");let s={...e.service_data||{}};if(t==="script"&&e.script_variable===!0){const r=this.currentEntityId,n=this._getSearchEntityId(this._selectedIndex),o=await this._resolveTemplateAtActionTime(n,r),l=this.currentActivePlaybackEntityId||this._getPlaybackEntityId(this._selectedIndex),c=await this._resolveTemplateAtActionTime(l,r);(s.entity_id==="current"||s.entity_id==="$current"||s.entity_id==="this")&&delete s.entity_id,s.yamp_entity=o||r,s.yamp_main_entity=r,s.yamp_playback_entity=c}else if(!(t==="script"&&e.script_variable===!0)&&(s.entity_id==="current"||s.entity_id==="$current"||s.entity_id==="this"||!s.entity_id))if(t==="music_assistant"){const r=this._getSearchEntityId(this._selectedIndex);s.entity_id=await this._resolveTemplateAtActionTime(r,this.currentEntityId)}else if(t==="media_player"){const r=this.currentActivePlaybackEntityId||this._getPlaybackEntityId(this._selectedIndex);s.entity_id=await this._resolveTemplateAtActionTime(r,this.currentEntityId)}else s.entity_id=this.currentEntityId;this.hass.callService(t,a,s)}_onTapAreaPointerDown(e){this.isAnyMenuOpen||e.composedPath().some(t=>t.tagName==="BUTTON"||t.tagName==="HA-ICON"||t.tagName==="INPUT"||t.classList&&t.classList.contains("clickable-artist")||t.classList&&t.classList.contains("details"))||(this._gestureActive=!0,this._gestureStartTime=Date.now(),this._gestureStartX=e.clientX,this._gestureStartY=e.clientY,this._gestureHoldTriggered=!1,this._gestureTapArea=e.currentTarget,this._cardTriggers?.hold&&(this._gestureHoldTimer=setTimeout(()=>{this._gestureActive&&(this._gestureHoldTriggered=!0,this._showGestureFeedback("hold",this._gestureStartX,this._gestureStartY),this._handleAction(this._cardTriggers.hold))},Jr)))}_onTapAreaPointerMove(e){if(!this._gestureActive)return;const t=Math.abs(e.clientX-this._gestureStartX),a=Math.abs(e.clientY-this._gestureStartY);(t>xt||a>xt)&&clearTimeout(this._gestureHoldTimer)}_onTapAreaPointerUp(e){if(!this._gestureActive||(this._gestureActive=!1,clearTimeout(this._gestureHoldTimer),this._gestureHoldTriggered)||Date.now()-this._gestureStartTime>Jr)return;const t=e.clientX-this._gestureStartX,a=e.clientY-this._gestureStartY,s=Math.abs(t),r=Math.abs(a);if(s>=tn&&r<tn){clearTimeout(this._tapTimer);const u=e.clientX,d=e.clientY;if(t<0&&this._cardTriggers?.swipe_left){this._showGestureFeedback("swipe_left",u,d),this._handleAction(this._cardTriggers.swipe_left);return}else if(t>0&&this._cardTriggers?.swipe_right){this._showGestureFeedback("swipe_right",u,d),this._handleAction(this._cardTriggers.swipe_right);return}}if(s>xt||r>xt)return;const n=Date.now(),o=n-(this._lastTapTime||0);this._lastTapTime=n;const l=e.clientX,c=e.clientY;o<en?(clearTimeout(this._tapTimer),this._cardTriggers?.double_tap&&(this._showGestureFeedback("double_tap",l,c),this._handleAction(this._cardTriggers.double_tap))):this._tapTimer=setTimeout(()=>{this._cardTriggers?.tap&&(this._showGestureFeedback("tap",l,c),this._handleAction(this._cardTriggers.tap))},Fd)}_showGestureFeedback(e,t,a){const s=this._gestureTapArea||this.shadowRoot?.querySelector(".card-artwork-spacer")||this.shadowRoot?.querySelector(".collapsed-artwork-container");if(!s)return;const r=s.getBoundingClientRect(),n=t-r.left,o=a-r.top,l=document.createElement("div");l.className=`gesture-ripple ${e}`,l.style.left=`${n}px`,l.style.top=`${o}px`;let c=s.querySelector(".gesture-feedback-container");c||(c=document.createElement("div"),c.className="gesture-feedback-container",s.appendChild(c)),l.addEventListener("animationend",()=>l.remove()),c.appendChild(l)}_onMenuActionClick(e){const t=this.config.actions?.[e];t&&(t.menu_item||(this._quickMenuInvoke=!0),this._onActionChipClick(e),t.menu_item||this._dismissWithAnimation())}_getActionLabel(e){if(!e)return"";if(typeof e.name=="string"&&e.name.trim()!=="")return e.name.trim();const t=!!e.icon;return e.menu_item?t?"":{search:"Search","search-recently-played":"Recently Played","search-next-up":"Next Up",source:"Source","more-info":"More Info","group-players":"Group Players","transfer-queue":"Transfer Queue"}[e.menu_item]??e.menu_item:typeof e.navigation_path=="string"&&e.navigation_path.trim()!==""||e.action==="navigate"?t?"":"Navigate":e.service?t?"":e.service:t?"":"Action"}async _onControlClick(e){const t=this._getEntityForPurpose(this._selectedIndex,"playback_control");if(!t)return;const a=this.hass?.states?.[t]||this.currentStateObj;switch(e){case"play_pause":this._isEntityPlaying(a)?(this.hass.callService("media_player","media_pause",{entity_id:t}),this._lastPlayingEntityIdByChip||(this._lastPlayingEntityIdByChip={}),this._lastPlayingEntityIdByChip[this._selectedIndex]=t,this._pauseTimestamps||(this._pauseTimestamps={}),this._pauseTimestamps[this._selectedIndex]=Date.now(),this._controlFocusEntityId=t,this._optimisticPlayback={entity_id:t,state:"paused",ts:Date.now()},this.requestUpdate(),setTimeout(()=>{this._optimisticPlayback=null,this.requestUpdate()},1200)):(this.hass.callService("media_player","media_play",{entity_id:t}),this._lastPlayingEntityIdByChip&&delete this._lastPlayingEntityIdByChip[this._selectedIndex],this._pauseTimestamps&&delete this._pauseTimestamps[this._selectedIndex],this._controlFocusEntityId=t,this._optimisticPlayback={entity_id:t,state:"playing",ts:Date.now()},this.requestUpdate(),setTimeout(()=>{this._optimisticPlayback=null,this.requestUpdate()},1200));break;case"next":this.hass.callService("media_player","media_next_track",{entity_id:t});break;case"prev":this.hass.callService("media_player","media_previous_track",{entity_id:t});break;case"stop":if(this.hass.callService("media_player","media_stop",{entity_id:t}),a){const s=t;this._optimisticPlayback={entity_id:s,state:"idle",ts:Date.now()},this.requestUpdate(),setTimeout(()=>{this._optimisticPlayback=null,this.requestUpdate()},1200)}break;case"shuffle":{const s=!!a.attributes.shuffle;this.hass.callService("media_player","shuffle_set",{entity_id:t,shuffle:!s});break}case"repeat":{let s=a.attributes.repeat||"off",r;s==="off"?r="all":s==="all"?r="one":r="off",this.hass.callService("media_player","repeat_set",{entity_id:t,repeat:r});break}case"power":{const s=this.currentEntityId,r=(this.hass?.states?.[s]||a)?.state==="off"?"turn_on":"turn_off";this.hass.callService("media_player",r,{entity_id:s});const n=this.entityObjs[this._selectedIndex];if(n&&n.sync_power){const o=this._getVolumeEntity(this._selectedIndex);o&&o!==n.entity_id&&this.hass.callService("media_player",r,{entity_id:o})}break}case"favorite":{const s=this._getFavoriteButtonEntity(),r=this.hass?.states?.[t]?.attributes?.media_content_id,n=this._isCurrentTrackFavorited(),o=await this._isMassQueueIntegrationAvailable(this.hass);if(n&&o){const l=this._getMusicAssistantState()?.entity_id;if(l)try{const c={type:"call_service",domain:"mass_queue",service:"unfavorite_current_item",service_data:{entity:l}};await this.hass.connection.sendMessagePromise(c),r&&(this._favoriteStatusCache||(this._favoriteStatusCache={}),this._favoriteStatusCache[r]={isFavorited:!1}),this._searchResultsByType&&Object.keys(this._searchResultsByType).forEach(u=>{(u.includes("_favorites")||u==="favorites")&&delete this._searchResultsByType[u]}),this._checkingFavorites=null,this.requestUpdate()}catch(c){console.error("yamp: Failed to unfavorite current item:",c)}}else s&&(this.hass.callService("button","press",{entity_id:s}),r&&(this._favoriteStatusCache||(this._favoriteStatusCache={}),this._favoriteStatusCache[r]={isFavorited:!0},this._checkingFavorites=null,this._searchResultsByType&&Object.keys(this._searchResultsByType).forEach(l=>{(l.includes("_favorites")||l==="favorites")&&delete this._searchResultsByType[l]}),this.requestUpdate()));break}}}async _onVolumeChange(e){const t=this._selectedIndex,a=this._getGroupingEntityId(t),s=await this._resolveTemplateAtActionTime(a,this.currentEntityId),r=this.hass.states[s],n=Number(e.target.value),o=this.entityObjs[t];if(!(typeof o.group_volume!="boolean"||o.group_volume)||this._quickGroupingMode){this.hass.callService("media_player","volume_set",{entity_id:this._getVolumeEntity(t),volume_level:n});return}if(this._isCurrentlyGrouped(r)){const l=this.entityObjs[t].entity_id,c=[...new Set([l,...r.attributes.group_members])],u=typeof this._groupBaseVolume=="number"?this._groupBaseVolume:Number(this.currentVolumeStateObj?.attributes.volume_level||0),d=n-u;for(const p of c){for(const v of this.entityObjs){let k;if(v.music_assistant_entity)if(typeof v.music_assistant_entity=="string"&&(v.music_assistant_entity.includes("{{")||v.music_assistant_entity.includes("{%")))try{k=await this._resolveTemplateAtActionTime(v.music_assistant_entity,v.entity_id)}catch{k=v.entity_id}else k=v.music_assistant_entity;else k=v.entity_id;if(k===p)break}const _=p,g=this.hass.states[_];if(!g)continue;let y=Number(g.attributes.volume_level||0)+d;y=Math.max(0,Math.min(1,y)),y=Math.round(y*1e4)/1e4,this.hass.callService("media_player","volume_set",{entity_id:_,volume_level:y})}this._groupBaseVolume=n}else{const l=this._getVolumeEntity(t);this.hass.callService("media_player","volume_set",{entity_id:l,volume_level:n})}}async _onVolumeStep(e){const t=this._selectedIndex,a=this._getVolumeEntity(t);if(!a)return;const s=a.startsWith&&a.startsWith("remote."),r=this.currentVolumeStateObj;if(!r)return;if(s){this.hass.callService("remote","send_command",{entity_id:a,command:e>0?"volume_up":"volume_down"});return}const n=this._getGroupingEntityId(t),o=await this._resolveTemplateAtActionTime(n,this.currentEntityId),l=this.hass.states[o];if(this._isCurrentlyGrouped(l)){const c=this.entityObjs[t].entity_id,u=[...new Set([c,...l.attributes.group_members])],d=this._volumeStep*e;for(const p of u){for(const v of this.entityObjs){let k;if(v.music_assistant_entity)if(typeof v.music_assistant_entity=="string"&&(v.music_assistant_entity.includes("{{")||v.music_assistant_entity.includes("{%")))try{k=await this._resolveTemplateAtActionTime(v.music_assistant_entity,v.entity_id)}catch{k=v.entity_id}else k=v.music_assistant_entity;else k=v.entity_id;if(k===p)break}const _=p,g=this.hass.states[_];if(!g)continue;let y=Number(g.attributes.volume_level||0)+d;y=Math.max(0,Math.min(1,y)),y=Math.round(y*1e4)/1e4,this.hass.callService("media_player","volume_set",{entity_id:_,volume_level:y})}}else{let c=Number(r.attributes.volume_level||0);c+=this._volumeStep*e,c=Math.max(0,Math.min(1,c)),c=Math.round(c*1e4)/1e4,this.hass.callService("media_player","volume_set",{entity_id:a,volume_level:c})}}async _onMuteToggle(){const e=this._selectedIndex,t=this._getVolumeEntity(e);if(!t)return;const a=t.startsWith&&t.startsWith("remote."),s=this.currentVolumeStateObj;if(!s)return;const r=s.attributes.is_volume_muted??!1,n=s.attributes.volume_level??0;if(a){r?this.hass.callService("media_player","volume_set",{entity_id:t,volume_level:.5}):this.hass.callService("media_player","volume_set",{entity_id:t,volume_level:0});return}if(!this._supportsFeature(s,_a)){if(n>0)this._previousVolume=n,this.hass.callService("media_player","volume_set",{entity_id:t,volume_level:0});else{const u=this._previousVolume??.5;this.hass.callService("media_player","volume_set",{entity_id:t,volume_level:u}),this._previousVolume=null}return}let o,l,c;try{o=this._getGroupingEntityId(e),l=await this._resolveTemplateAtActionTime(o,this.currentEntityId),c=this.hass.states[l]}catch(u){console.error("yamp: Error in grouping detection:",u)}if(this._isCurrentlyGrouped(c)){const u=this.entityObjs[e].entity_id,d=[...new Set([u,...c.attributes.group_members])];for(const p of d){const _=p,g=this.hass.states[_];g&&this._supportsFeature(g,_a)?this.hass.callService("media_player","volume_mute",{entity_id:_,is_volume_muted:!r}):(g?.attributes?.volume_level??0)>0?this.hass.callService("media_player","volume_set",{entity_id:_,volume_level:0}):this.hass.callService("media_player","volume_set",{entity_id:_,volume_level:.5})}}else this.hass.callService("media_player","volume_mute",{entity_id:t,is_volume_muted:!r})}_onVolumeDragStart(e){if(!this.hass)return;const t=this.currentVolumeStateObj;this._groupBaseVolume=t?Number(t.attributes.volume_level||0):0}_onVolumeDragEnd(e){this._groupBaseVolume=null}_onGroupVolumeChange(e,t,a){const s=Number(a.target.value);this.hass.callService("media_player","volume_set",{entity_id:t,volume_level:s}),this.requestUpdate()}_onGroupVolumeStep(e,t){this.hass.callService("remote","send_command",{entity_id:e,command:t>0?"volume_up":"volume_down"}),this.requestUpdate()}_onSourceChange(e){const t=this.currentEntityId,a=e.target.value;!t||!a||this.hass.callService("media_player","select_source",{entity_id:t,source:a})}_openMoreInfo(){this.dispatchEvent(new CustomEvent("hass-more-info",{detail:{entityId:this.currentEntityId},bubbles:!0,composed:!0}))}async _onProgressBarClick(e){try{e.stopPropagation();const t=this.currentEntityId,a=this._getActualResolvedMaEntityForState(this._selectedIndex),s=t?this.hass?.states?.[t]:null,r=a?this.hass?.states?.[a]:null;let n;if(this._controlFocusEntityId&&(this._controlFocusEntityId===a||this._controlFocusEntityId===t))n=this._controlFocusEntityId;else if(this._isEntityPlaying(r))n=a;else if(this._isEntityPlaying(s))n=t;else{const p=this._lastPlayingEntityIdByChip?.[this._selectedIndex];if(p&&(p===a||p===t))n=p;else{const _=this._getPlaybackEntityId(this._selectedIndex);n=await this._resolveTemplateAtActionTime(_,this.currentEntityId)}}const o=this.hass?.states?.[n]||this.currentStateObj;if(!n||!o||!o.attributes){console.warn("YAMP: Cannot seek - invalid target or state",n,o);return}const l=o.attributes.media_duration;if(!l)return;const c=e.target.getBoundingClientRect(),u=(e.clientX-c.left)/c.width,d=Math.floor(u*l);this._seekAnchor={position:d,timestamp:Date.now(),trackId:o.attributes.media_content_id||o.attributes.media_title},this._seekConvergenceLock=Date.now()+2e3,this._seekOffset=null,this.requestUpdate(),this.hass.callService("media_player","media_seek",{entity_id:n,seek_position:d})}catch(t){console.error("YAMP: Error in _onProgressBarClick",t)}}render(){if(!this.hass||!this.config)return b;const e=this.config.card_height,t=typeof e=="string"?e:Number(e),a=typeof t=="number"&&Number.isFinite(t)&&t>0||typeof t=="string"&&t.trim()!=="",s=this._collapsedBaselineHeight||220,r=this.entityObjs.length===1,n=r&&this.config.always_collapsed===!0&&this.config.expand_on_search!==!0,o=this.config.pin_search_headers===!0&&!n,l=!(this.config.hide_search_headers_on_idle===!0&&this._isIdle);if(this.shadowRoot&&this.shadowRoot.host){this.shadowRoot.host.setAttribute("data-match-theme",String(this.config.match_theme===!0)),this.shadowRoot.host.setAttribute("data-always-collapsed",String(this.config.always_collapsed===!0));const f=this.config.always_collapsed===!0&&this.config.pin_search_headers===!0&&this.config.expand_on_search===!0;this.shadowRoot.host.setAttribute("data-hide-menu-player",String(this.config.hide_menu_player===!0||f)),this.shadowRoot.host.setAttribute("data-extend-artwork",String(this.config.extend_artwork===!0)),this.shadowRoot.host.setAttribute("data-control-layout",this._controlLayout),this.shadowRoot.host.setAttribute("data-pin-search-headers",String(o)),a?this.shadowRoot.host.setAttribute("data-has-custom-height","true"):this.shadowRoot.host.removeAttribute("data-has-custom-height")}const c=this.config.show_chip_row||"auto",u=this.entityObjs.length>1,d=(c==="in_menu"||c==="in_menu_on_idle"&&this._isIdle)&&u,p=c!=="in_menu"&&(u||c==="always"),_=c==="in_menu_on_idle"&&this._isIdle&&u,g=c==="in_menu_on_idle"&&u,y=(this.config.actions??[]).map((f,A)=>({action:f,idx:A})).filter(({action:f})=>f?.action!=="sync_selected_entity"),v=f=>f?.placement?f.placement:f?.in_menu==="hidden"?"hidden":f?.in_menu===!0?"menu":"chip",k=y.filter(({action:f})=>v(f)==="chip"),x=y.filter(({action:f})=>v(f)==="menu"),j=y.find(({action:f})=>f?.card_trigger==="tap"),E=y.find(({action:f})=>f?.card_trigger==="hold"),G=y.find(({action:f})=>f?.card_trigger==="double_tap"),B=y.find(({action:f})=>f?.card_trigger==="swipe_left"),z=y.find(({action:f})=>f?.card_trigger==="swipe_right");this._cardTriggers={tap:j?.action,hold:E?.action,double_tap:G?.action,swipe_left:B?.action,swipe_right:z?.action};const L=this.currentActivePlaybackStateObj||this.currentPlaybackStateObj||this.currentStateObj,N=this.getChipName(this.currentEntityId);if(!L)return m`<div class="details">${h("common.not_found")}</div>`;const T=this._getHiddenControlsForCurrentEntity(),M=!!this._getFavoriteButtonEntity()&&!T.favorite,q=this._isCurrentTrackFavorited(),H=!T.power&&(this._supportsFeature(L,Kc)||this._supportsFeature(L,Zc)),te=this._controlLayout==="modern"&&H,ae=this._controlLayout==="modern"&&M;let Z=b;te?Z=m`
      ...
      `:b,le=L.attributes.source_list||[],Se=new Set(le.map(f=>f&&f[0]?f[0].toUpperCase():"")),_e="ABCDEFGHIJKLMNOPQRSTUVWXYZ".split("");this._idleImageTemplate&&this._idleImageTemplateNeedsResolve&&!this._resolvingIdleImageTemplate&&this._isIdle&&this._resolveIdleImageTemplate();const se=this._idleImageTemplate?this._idleImageTemplateResult:this.config.idle_image,je=this._normalizeImageSourceValue(se);let Ve=null;if(je&&this._isIdle)if(this.hass.states[je]){const f=this.hass.states[je];Ve=f.attributes.entity_picture_local||f.attributes.entity_picture||(f.state&&f.startsWith("http")?f.state:null)}else(je.startsWith("http")||je.startsWith("/"))&&(Ve=je);const ja=!!Ve,Qe=this._isIdle,an=this._isIdle,sn=this._artworkObjectFit==="scaled-contain",Oa=this.config.extend_artwork===!0||_||sn,Ra=this.currentStateObj;this.currentPlaybackStateObj,this._optimisticPlayback?.entity_id,this._getResolvedPlaybackEntityIdSync(this._selectedIndex);const wt=this._getActualResolvedMaEntityForState(this._selectedIndex),rn=wt?this.hass?.states?.[wt]:null,nn=this._lastMainState,za=this._lastMaState;this._lastMainState=Ra?.state,this._lastMaState=rn?.state;const me=this._selectedIndex;if(za==="playing"&&this._lastMaState!=="playing"){const f=Math.max(Number(this._idleTimeoutMs||this.config?.idle_timeout_ms||6e4),500);this._playbackLingerByIdx[me]={entityId:wt,until:Date.now()+f}}if(za==="playing"&&this._lastMaState==="paused"&&this._lastPlayingEntityIdByChip?.[me]===wt||nn==="playing"&&this._lastMainState==="paused"&&this._lastPlayingEntityIdByChip?.[me]===Ra?.entity_id){const f=this._lastPlayingEntityIdByChip[me],A=Math.max(Number(this._idleTimeoutMs||this.config?.idle_timeout_ms||6e4),500);this._playbackLingerByIdx[me]={entityId:f,until:Date.now()+A}}this._lastMaState==="playing"&&this._playbackLingerByIdx?.[me]&&delete this._playbackLingerByIdx[me];const on=this.config.entities[me]?.music_assistant_entity,ln=this._getEntityForPurpose(me,"ma_resolve"),kt=this._lastPlayingEntityIdByChip?.[me],cn=this._maResolveCache?.[me]?.id,dn=!!(kt&&(kt===cn||kt===ln||kt===on||kt===wt));this._lastMainState==="playing"&&this._playbackLingerByIdx?.[me]&&!dn&&delete this._playbackLingerByIdx[me];const La=this._getEntityForPurpose(this._selectedIndex,"playback_control"),We=this.hass?.states?.[La],Et=We,un=La;Et?.state,this._optimisticPlayback&&this._optimisticPlayback.entity_id===un&&this._optimisticPlayback.state;const hn=!!Et?.attributes?.shuffle,pn=Et?.attributes?.repeat&&Et?.attributes?.repeat!=="off",Ye=this._idleTimeoutMs===0?this._isEntityPlaying(We):!this._isIdle&&this._isEntityPlaying(We),Ii=this.currentStateObj,Ci=this._getArtworkUrl(Ii),Ti=this._getArtworkUrl(We);(this._idleTimeoutMs===0?Ye&&(Ci?.url||Ti?.url):!this._isIdle&&Ye&&(Ci?.url||Ti?.url))&&(Ci?.url||Ti?.url);const Oe=this._idleTimeoutMs===0?!0:Ye,ye=Et||Ii,Zt=Oe&&ye?.attributes?.media_title||"",Na=Oe&&(ye?.attributes?.media_artist||ye?.attributes?.media_series_title||ye?.attributes?.app_name)||"";this._lastTitleLength=Zt?Zt.length:0,this._adaptiveText&&this._updateAdaptiveTextScale(!0);let nt=ye?.attributes?.media_position||0;const At=ye?.attributes?.media_duration||0;let Kt=nt;if(Ye&&ye){const f=ye.attributes?.media_position_updated_at?Date.parse(ye.attributes.media_position_updated_at):ye.last_changed?Date.parse(ye.last_changed):Date.now(),A=(Date.now()-f)/1e3;Kt+=A}const _n=ye?.attributes?.media_content_id||ye?.attributes?.media_title,qa=Date.now();if(this._seekAnchor&&this._seekAnchor.trackId===_n){let f=this._seekAnchor.position;Ye&&(f+=(qa-this._seekAnchor.timestamp)/1e3);const A=this._seekConvergenceLock&&qa<this._seekConvergenceLock,P=Math.abs(Kt-f);!A&&P<2?(this._seekAnchor=null,this._seekConvergenceLock=null,nt=Kt):nt=f}else this._seekAnchor=null,this._seekConvergenceLock=null,nt=Kt;const Ua=At?Math.min(1,nt/At):0,Mi=this._getVolumeEntity(me),mn=Mi&&Mi.startsWith&&Mi.startsWith("remote."),fn=Number(this.currentVolumeStateObj?.attributes.volume_level||0),gn=this.config.volume_mode!=="stepper";let Q;this._alwaysCollapsed&&this._expandOnSearch&&(this._searchOpen||this._showSearchInSheet)?Q=!1:Q=this._alwaysCollapsed?!0:this._collapseOnIdle?this._isIdle:!1;const Te=Q&&this._alwaysCollapsed&&a?Math.max(0,t-s):0,vn=Q&&p?48:0,yn=Q&&k.length>0?40:0,bn=vn+yn,Fi=48,Re=Math.max(0,Te-bn),Xt=Te>0?Math.min(240,102+Re*.75):102,Ba=Re>0?Math.min(Re*.45,96):0,xn=Re>0?Math.round(Fi+Ba):Fi,wn=Q?xn:Fi,Pi=Re>0?Math.max(0,Re-Ba):0;let Di=!1;const Ga=350,kn=(Q?a?t:this._collapsedBaselineHeight||220:Ga)>=Ga,Ha=this.config.hide_menu_player===!0?!1:!Q||kn,En=Pi>=48,ji=Te>0?Math.max(100,Math.round(Xt+24+Math.min(40,Te*.12))):null,An=En?0:ji??0;let Va=this.offsetWidth||(this.shadowRoot?.host?.offsetWidth??0);const Oi=Va>380?Math.min(1.6,1+(Va-380)/520):1,Ri=Te>0?Math.min(1.45,1+Re/180):1,Qa=Ri>1||Oi>1?Math.min(1.6,Math.max(Ri,Oi)):1,Wa=Math.min(1.5,Math.max(Ri*.92,Oi*.92));this.shadowRoot&&this.shadowRoot.host&&(Te>0&&(ji!=null&&this.shadowRoot.host.style.setProperty("--yamp-collapsed-details-offset",`${ji}px`),this.shadowRoot.host.style.setProperty("--yamp-collapsed-controls-offset",`${An}px`),this.shadowRoot.host.style.setProperty("--yamp-collapsed-title-scale",Qa.toFixed(3)),this.shadowRoot.host.style.setProperty("--yamp-collapsed-artist-scale",Wa.toFixed(3))),this.shadowRoot.host.style.setProperty("--yamp-collapsed-title-scale",Qa.toFixed(3)),this.shadowRoot.host.style.setProperty("--yamp-collapsed-artist-scale",Wa.toFixed(3)),Te>0&&a||(this.shadowRoot.host.style.removeProperty("--yamp-collapsed-controls-offset"),this.shadowRoot.host.style.removeProperty("--yamp-collapsed-details-offset")),Ha?this.shadowRoot.host.removeAttribute("data-hide-persistent-controls"):this.shadowRoot.host.setAttribute("data-hide-persistent-controls","true"));let ce=null,zi=null,Ya=this._artworkObjectFit;if(!this._isIdle){const f=this._getArtworkUrl(We),A=this._getArtworkUrl(Ii),P=f?.url?f:A;ce=P?.url||null,zi=P?.sizePercentage,P?.objectFit&&(Ya=P.objectFit)}Di=Q&&!ce&&!Ve&&Re>=40,Q&&ce&&ce!==this._lastArtworkUrl&&(this._extractDominantColor(ce).then(f=>{this._collapsedArtDominantColor=f,this.requestUpdate()}),this._lastArtworkUrl=ce);const Za=Qe?Q?this._collapsedBaselineHeight||220:325:null;this._lastRenderedCollapsed=Q,this._lastRenderedHideControls=Qe;const Jt=Ya||this._artworkObjectFit,ei=Jt==="scaled-contain"&&!Q&&!this._alwaysCollapsed,Sn=Jt==="scaled-contain"&&(c==="in_menu"||r&&c!=="always");let Li=this._getBackgroundSizeForFit(Jt);zi&&(Li=`${zi}%`);const Ka=Ve?`url('${Ve}')`:ce?`url('${ce}')`:"none",Xa=Ka!=="none",$n=ce&&(Q||ei)?"blur(18px) brightness(0.7) saturate(1.15)":"none",Ja=[`background-image: ${Ka}`,`background-size: ${ei?"cover":Li}`,`background-position: ${this.config.artwork_position||"top center"}`,"background-repeat: no-repeat",`filter: ${$n}`].join("; ");return this.shadowRoot&&this.shadowRoot.host&&(this.shadowRoot.host.style.setProperty("--yamp-artwork-fit",Jt),this.shadowRoot.host.style.setProperty("--yamp-artwork-bg-size",Li)),m`
          ...
          >
            ...
            <div class="card-lower-content-container" style="${Za?`min-height:${Za}px;`:""}">
              <div class="card-lower-content-bg"
                style="${(()=>{const f=[];return Oa&&Xa?f.push("background-image: none","filter: none"):f.push(Ja),f.push(`min-height: ${Q?Qe?`${this._collapsedBaselineHeight||220}px`:"0px":"350px"}`),f.push("transition: min-height 0.4s cubic-bezier(0.6,0,0.4,1), background 0.4s"),f.join("; ")})()}"
              ></div>
              ${ja?b:m`<div class="card-lower-fade"></div>`}
              <div class="card-lower-content${Q?" collapsed transitioning":" transitioning"}${Q&&ce?" has-artwork":""}" style="${Qe?Q?`min-height: ${this._collapsedBaselineHeight||220}px;`:"min-height: 350px;":""}">
                ${Q&&ce&&this._isValidArtworkUrl(ce)?m`
                  <div
                    class="collapsed-artwork-container"
                    @pointerdown=${f=>this._onTapAreaPointerDown(f)}
                    @pointermove=${f=>this._onTapAreaPointerMove(f)}
                    @pointerup=${f=>this._onTapAreaPointerUp(f)}
                ...
                `:b}
                <div class="details" style="${(()=>{const f=[];return this._showEntityOptions&&f.push("visibility:hidden"),f.push(`min-height:${wn}px`),Oe||f.push("opacity:0"),f.join(";")})()}">
                  <div class="title">
                    ${Oe&&Zt?Zt:m`&nbsp;`}
                  </div>
                  <div
                ...
                <div style="${Qe||this._showEntityOptions?"visibility:hidden; pointer-events:none;":""}">
                    ${bo({stateObj:We,showStop:this._shouldShowStopButton(We),shuffleActive:hn,repeatActive:pn,onControlClick:f=>this._onControlClick(f),supportsFeature:(f,A)=>this._supportsFeature(f,A),showFavorite:M,favoriteActive:q,hiddenControls:T,adaptiveControls:this._adaptiveControls,controlLayout:this._controlLayout,swapPauseForStop:this._controlLayout==="modern"&&this._swapPauseForStop})}

                    ${xo({isRemoteVolumeEntity:mn,showSlider:gn,vol:fn,isMuted:this.currentVolumeStateObj?.attributes?.is_volume_muted??!1,supportsMute:this.currentVolumeStateObj?this._supportsFeature(this.currentVolumeStateObj,_a):!1,onVolumeDragStart:f=>this._onVolumeDragStart(f),onVolumeDragEnd:f=>this._onVolumeDragEnd(f),onVolumeChange:f=>this._onVolumeChange(f),onVolumeStep:f=>this._onVolumeStep(f),onMuteToggle:()=>this._onMuteToggle(),leadingControlTemplate:Z,reserveLeadingControlSpace:this._controlLayout==="modern",showRightPlaceholder:this._controlLayout==="modern",rightSlotTemplate:oe,hideVolume:this.config.volume_mode==="hidden",moreInfoMenu:m`
      ...
      <div class="entity-options-overlay entity-options-overlay-opening" @click=${f=>this._closeEntityOptions(f)}>
        <div class="entity-options-container entity-options-container-opening">
          <div class="entity-options-sheet${d||g?" chips-mode":""} entity-options-sheet-opening" 
               @click=${f=>f.stopPropagation()}
               data-pin-search-headers="${o}">
            ${d||g?m`
                <div class="entity-options-chips-wrapper" style="${g&&!d?"visibility:hidden;pointer-events:none;":""}" @click=${f=>f.stopPropagation()}>
                <div class="chip-row entity-options-chips-strip">
                  ${gs({groupedSortedEntityIds:this.groupedSortedEntityIds,entityIds:this.entityIds,selectedEntityId:this.currentEntityId,pinnedIndex:this._pinnedIndex,holdToPin:this._holdToPin,getChipName:f=>this.getChipName(f),getActualGroupMaster:f=>this._getActualGroupMaster(f),getIsChipPlaying:(f,A)=>{const P=this._findEntityObjByAnyId(f)?.entity_id||f,F=this.entityIds.indexOf(P);if(F<0)return!1;const $=this._getEntityForPurpose(F,"playback_control"),ie=this.hass?.states?.[$];return this._isEntityPlaying(ie)},getChipArt:f=>{const A=this._findEntityObjByAnyId(f)?.entity_id||f,P=this.entityIds.indexOf(A);if(P<0)return null;const F=this._getEntityForPurpose(P,"playback_control"),$=this.hass?.states?.[F],ie=this.hass?.states?.[A],Ni=this._getArtworkUrl($),qi=this._getArtworkUrl(ie);return Ni||qi},getIsMaActive:f=>{const A=this._findEntityObjByAnyId(f)?.entity_id||f,P=this.entityIds.indexOf(A);if(P<0)return!1;const F=this.entityObjs[P];if(!F?.music_assistant_entity)return!1;const $=this._getEntityForPurpose(P,"playback_control"),ie=this.hass?.states?.[$];return $===this._resolveEntity(F.music_assistant_entity,F.entity_id,P)&&this._isEntityPlaying(ie)},isIdle:this._isIdle,hass:this.hass,artworkHostname:this.config?.artwork_hostname||"",mediaArtworkOverrides:this.config?.media_artwork_overrides||[],fallbackArtwork:this.config?.fallback_artwork||null,onChipClick:f=>this._onChipClick(f),onIconClick:(f,A)=>{const P=this.entityIds[f],F=this.groupedSortedEntityIds.find($=>$.includes(P));F&&F.length>1&&(this._selectedIndex=f,this._showEntityOptions=!0,this._showGrouping=!0,this.requestUpdate())},onPinClick:(f,A)=>{A.stopPropagation(),this._onPinClick(A)},onPointerDown:(f,A)=>this._handleChipPointerDown(f,A),onPointerMove:(f,A)=>this._handleChipPointerMove(f,A),onPointerUp:(f,A)=>this._handleChipPointerUp(f,A),quickGroupingMode:this._quickGroupingMode,getQuickGroupingState:f=>{const A=this.currentEntityId,P=this.entityIds.indexOf(A),F=P>=0?this._getGroupingEntityId(P):A,$=F?this.hass.states[F]:null,ie=this._getGroupKey(this.currentEntityId);return this._getGroupPlayerState(f,A,null,$,ie)},onQuickGroupClick:(f,A)=>{const P=this.entityIds[f];P&&this._toggleGroup(P)},onDoubleClick:f=>{f.stopPropagation(),this._quickGroupingMode=!this._quickGroupingMode,this.requestUpdate()}})}
                </div>
              </div>
            `:b}
              ${!this._showGrouping&&!this._showSourceList&&!this._showSearchInSheet&&!this._showResolvedEntities&&!this._showTransferQueue?this._renderMainMenu(le,x,d):this._showGrouping?this._renderGroupingSheet():this._showTransferQueue?this._renderTransferQueueSheet():this._showResolvedEntities?this._renderResolvedEntitiesSheet():this._showSearchInSheet?m`
                ...
                ${this._searchHierarchy.length>0?m`
                  ...
                  <div class="entity-options-search-row">
                      <input
                        ...
                        @input=${f=>{this._searchQuery=f.target.value,this.requestUpdate()}}
                        @keydown=${f=>{f.key==="Enter"?(f.preventDefault(),this._handleSearchSubmit()):f.key==="Escape"&&(f.preventDefault(),this._hideSearchSheetInOptions())}}
                        placeholder="${h("editor.placeholders.search")}"
              ...
              ${h("common.cancel")}
                  ...
                  `:b}
                  <!--FILTER CHIPS-->
               ${l?(()=>{const f=this._getVisibleSearchFilterClasses(),A=this._searchMediaClassFilter||"all";return this._searchHierarchy.length>0||f.length<2&&!this._usingMusicAssistant?b:m`
                      <div class="chip-row search-filter-chips" id="search-filter-chip-row" style="margin-bottom:12px; justify-content: center; align-items: center;">
                        ...
                        ${f.map(P=>m`
                          <button
                            ...
                            style="
                              width: 72px;
                              background: ${A===P?this._customAccent:"#282828"};
                              opacity: ${A===P?"1":"0.8"};
                              font-weight: ${A===P?"bold":"normal"};
                            "
                            ?selected=${A===P}
                            @click=${()=>this._doSearch(P)}
                          >
                            ${h(`search.filters.${P}`)}
                          </button>
                        `)}
            ...
            <div class="entity-options-search-results ${this.config.search_view==="card"?"search-results-card-view":"list-view"}" 
              ...
              ${(()=>{this._searchMediaClassFilter;const f=this._getDisplaySearchResults(),A=Math.max(15,this._searchTotalRows||f.length),P=[...f,...Array.from({length:Math.max(0,A-f.length)},()=>null)];return this._searchAttempted&&f.length===0&&!this._searchLoading?m`<div class="entity-options-search-empty" style="color: white;">No results.</div>`:P.map(F=>F?m`
                               ...
                               <div class="search-sheet-info">
                                <span class="${this._isClickableSearchResult(F)?"clickable-search-result":""} ${this.config.search_view==="card"?"search-sheet-title":""}"
                                 ...
                                 <span class="search-sheet-subtitle">
                                  ${(()=>{const $=this._searchMediaClassFilter==="track"||this._searchMediaClassFilter==="album",ie=!!this._recentlyPlayedFilterActive,Ni=!!this._upcomingFilterActive,qi=!!this._recommendationsFilterActive;return($||ie||Ni||qi)&&F.artist?F.artist:F.media_class?F.media_class.charAt(0).toUpperCase()+F.media_class.slice(1):""})()}
                                </span>
                ...
                <div class="entity-options-scroll source-list-centering-wrapper">
                  <div class="source-list-sheet">
                    <div class="source-list-scroll">
                      ${le.map(f=>m`
                        <div class="entity-options-item" data-source-name="${f}" @click=${()=>this._selectSource(f)}>${f}</div>
                      `)}
                    </div>
                  </div>
                </div>
                <div class="floating-source-index">
                  ${_e.map((f,A)=>{const P=Se.has(f),F=this._hoveredSourceLetterIndex;let $="";if(P&&F!==null&&F!==void 0){const ie=Math.abs(F-A);ie===0?$="max":ie===1?$="large":ie===2&&($="med")}return m`
                      <button
                        class="source-index-letter"
                        ?disabled=${!P}
                        data-scale=${$}
                        @mouseenter=${P?()=>{this._hoveredSourceLetterIndex=A,this.requestUpdate()}:b}
                        @mouseleave=${()=>{this._hoveredSourceLetterIndex=null,this.requestUpdate()}}
                        @click=${P?()=>this._scrollToSourceLetter(f):b}
                      >
                        ${f}
                      </button>
                    `})}
...
`}
            ...
            ${Ha?m`
              <div class="persistent-media-controls" @click=${f=>f.stopPropagation()}>
                <div class="persistent-controls-artwork">
                  ${(()=>{const f=this.currentPlaybackStateObj,A=this.currentStateObj,P=this._getArtworkUrl(f)||this._getArtworkUrl(A);return P?.url&&this._isValidArtworkUrl(P.url)?m`
                      <img src="${P.url}" alt="Album Art" class="persistent-artwork" onerror="this.style.display='none'">
                    `:m`
                ...
                ${(()=>{const f=this._selectedIndex,A=this._getVolumeEntity(f);if(!A)return b;const P=A.startsWith&&A.startsWith("remote."),F=this.currentVolumeStateObj,$=Number(F?.attributes?.volume_level??0),ie=P?null:`${Math.round(($||0)*100)}%`;return this.config.volume_mode==="hidden"?b:m`
                    <div class="persistent-volume-stepper">
                      <button class="stepper-btn" @click=${()=>this._onVolumeStep(-1)} title="${h("common.vol_down")}">–</button>
                      ${ie?m`<span class="stepper-value">${ie}</span>`:b}
