          ...
          >
            ...
            <div class="card-lower-content-container" style="${Ja?`min-height:${Ja}px;`:""}">
              <div class="card-lower-content-bg"
                style="${(()=>{const b=[];return La&&tr?b.push("background-image: none","filter: none"):b.push(ir),b.push(`min-height: ${Q?Ze?`${this._collapsedBaselineHeight||220}px`:"0px":"350px"}`),b.push("transition: min-height 0.4s cubic-bezier(0.6,0,0.4,1), background 0.4s"),b.join("; ")})()}"
              ></div>
              ${za||Pt?v:_`<div class="card-lower-fade"></div>`}
              <div class="card-lower-content${Q?" collapsed transitioning":" transitioning"}${Q&&le?" has-artwork":""}" style="${Ze?Q?`min-height: ${this._collapsedBaselineHeight||220}px;`:"min-height: 350px;":""}">
                ...
                ${this.config.details_alignment!=="none"?_`
                  <div class="details" style="${(()=>{const b=[];return this._showEntityOptions&&(b.push("visibility:hidden"),b.push("opacity:0")),b.push(`min-height:${Fn}px`),Ee||b.push("opacity:0"),b.join(";")})()}">
                    ...
                    `:_`
                      <div class="title track-options-title" @click=${b=>{Ee&&Je&&(b.stopPropagation(),this._showMediaTitleOptions=!0)}} style="${Ee&&Je?"cursor: pointer;":""}" title="${Ee&&Je?"Show track options":""}">
                        ${Ee&&Je?Je:_`&nbsp;`}
                      </div>
                    `}
                    <div
        ...
        <div class="entity-options-container entity-options-container-opening">
          <div class="entity-options-sheet${u||f?" chips-mode":""} entity-options-sheet-opening" 
            ...
            <div class="entity-options-search-results ${this.config.search_view==="card"||this.config.search_view==="card_minimal"?"search-results-card-view":"list-view"}" 
              ...
              ${(()=>{this._searchMediaClassFilter;const b=this._getDisplaySearchResults(),R=this.config.search_view==="card"||this.config.search_view==="card_minimal",G=this.config.search_view==="card_minimal",tt=Math.max(15,this._searchTotalRows||b.length),Ne=[...b,...Array.from({length:Math.max(0,tt-b.length)},()=>null)];return this._searchAttempted&&b.length===0&&!this._searchLoading?_`<div class="entity-options-search-empty">${d("common.no_results")}</div>`:Ne.map(C=>C?_`
              ...
              `:this._showGrouping?this._renderGroupingSheet():_`
                ...
                <div class="floating-source-index">
                  ${_e.map((b,R)=>{const G=$e.has(b),tt=this._hoveredSourceLetterIndex;let Ne="";if(G&&tt!==null&&tt!==void 0){const C=Math.abs(tt-R);C===0?Ne="max":C===1?Ne="large":C===2&&(Ne="med")}return _`
                      <button
...
`}
            ...
            ${Wa?_`
              <div class="persistent-media-controls" @click=${b=>b.stopPropagation()}>
                ...
                ${(()=>{const b=this._selectedIndex,R=this._getVolumeEntity(b);if(!R)return v;const G=R.startsWith&&R.startsWith("remote."),tt=this.currentVolumeStateObj,Ne=Number(tt?.attributes?.volume_level??0),C=G?null:`${Math.round((Ne||0)*100)}%`;return this.config.volume_mode==="hidden"?v:_`
