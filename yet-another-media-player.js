 ...
 */const io=eo(class extends to{constructor(i){if(super(i),i.type!==Jn.ATTRIBUTE||i.name!=="class"||i.strings?.length>2)throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(i){return" "+Object.keys(i).filter((e=>i[e])).join(" ")+" "}update(i,[e]){if(this.st===void 0){this.st=new Set,i.strings!==void 0&&(this.nt=new Set(i.strings.join(" ").split(/\s/).filter((a=>a!==""))));for(const a in e)e[a]&&!this.nt?.has(a)&&this.st.add(a);return this.render(e)}const t=i.element.classList;for(const a of this.st)a in e||(t.remove(a),this.st.delete(a));for(const a in e){const s=!!e[a];s===this.st.has(a)||this.nt?.has(a)||(s?(t.add(a),this.st.add(a)):(t.remove(a),this.st.delete(a)))}return Xe}});function xe(i,e){const t=i?.[e];return typeof t=="string"&&t.trim()!==""?t:null}async function ao(i,e,t){if(!e||typeof e!="string")return t;if(!e.includes("{{")&&!e.includes("{%"))return e;try{const a=(await i.callApi("POST","template",{template:e})||"").toString().trim();return a&&/^([a-z_]+)\.[A-Za-z0-9_]+$/.test(a)?a:t}catch{return t}}async function so(i,e,t={}){if(!e||typeof e!="string")return e;if(!e.includes("{{")&&!e.includes("{%")){if(/%7B%7B|%7B%25/i.test(e))try{e=decodeURIComponent(e)}catch{}if(!e.includes("{{")&&!e.includes("{%"))return e}let a=e;t&&Object.keys(t).length>0&&(a=`${Object.entries(t).map(([s,r])=>`{% set ${s} = ${JSON.stringify(r)} %}`).join(" ")} ${e}`);try{return(await i.callApi("POST","template",{template:a})||"").toString().trim()}catch(s){return console.warn("yamp: Error resolving template:",e,s),e}}function ro(i,e,t={}){if(!e||typeof e!="string")return e;let a=e;if(/%7B%7B|%7B%25/i.test(a))try{a=decodeURIComponent(a)}catch{}if(!a.includes("{{")&&!a.includes("{%"))return a;let s=a,r=!0;return s=s.replace(/\{\{\s*(.*?)\s*\}\}/g,(n,o)=>{let l=o.trim(),c=!1;l.endsWith("| urlencode")?(c=!0,l=l.replace(/\|\s*urlencode$/,"").trim()):l.endsWith("|urlencode")&&(c=!0,l=l.replace(/\|urlencode$/,"").trim());let u=l.match(/^state_attr\(\s*(['"]?)([\w.]+)\1\s*,\s*(['"]?)([\w_]+)\3\s*\)$/);if(u){let p=u[2],_=t[p]!==void 0&&!u[1]?t[p]:p,f=u[4];const g=i?.states?.[_];if(g&&g.attributes&&g.attributes[f]!==void 0){let b=String(g.attributes[f]);return c?encodeURIComponent(b):b}return""}let d=l.match(/^states\(\s*(['"]?)([\w.]+)\1\s*\)$/);if(d){let p=d[2],_=t[p]!==void 0&&!d[1]?t[p]:p;const f=i?.states?.[_];if(f&&f.state!==void 0){let g=String(f.state);return c?encodeURIComponent(g):g}return""}if(/^[\w_]+$/.test(l)&&t[l]!==void 0){let p=String(t[l]);return c?encodeURIComponent(p):p}return r=!1,n}),!r||s.includes("{%")?null:s}function no(i,e){if(!i?.states||!e)return[];const t=[],a=i.states[e];if(!a)return[];const s=a.attributes?.device_id,r=a.attributes?.friendly_name||e;for(const[n,o]of Object.entries(i.states))if(n.startsWith("button.")&&o.attributes){const l=o.attributes.device_id,c=o.attributes.friendly_name||n;s&&l===s?t.push({entity_id:n,friendly_name:c,device_class:o.attributes.device_class,reason:"same_device"}):(c.toLowerCase().includes(r.toLowerCase())||r.toLowerCase().includes(c.toLowerCase()))&&t.push({entity_id:n,friendly_name:c,device_class:o.attributes.device_class,reason:"name_similarity"})}return t}function oo(i,e){if(!i?.states||!e)return null;const t=i.states[e];return t&&t.attributes&&(t.attributes.media_content_id||t.attributes.media_content_type||t.attributes.media_album_name||t.attributes.media_artist||t.attributes.media_title)?t:null}function tt(i){return!i||!i.attributes?!1:i.attributes.app_id==="music_assistant"||i.attributes.mass_player_type!==void 0}function lo(i){if(!i)return"";const e=i.media_type||i.media_class||i.media_content_type,t=i.name||i.title||i.media_title||"Unknown Title",a=i.artists?.[0],s=i.artist||a?.name||(typeof a=="string"?a:void 0)||i.media_artist||"Unknown Artist";return e==="track"?`${t} - ${s}`:e==="album"?`${t} - ${s}`:t}function fs(i,e="",t=[],a=null){if(!i||!i.attributes)return null;const s=i.attributes,r=i.entity_id;s.app_id;let n=null,o=null;if(t&&Array.isArray(t)&&t.length){const l=(d,p)=>{if(d)return d[p]},c=[["media_title","media_title"],["media_artist","media_artist"],["media_album_name","media_album_name"],["media_content_id","media_content_id"],["media_channel","media_channel"],["app_name","app_name"],["media_content_type","media_content_type"],["entity_id","entity_id"],["entity_state","entity_state"]];let u=t.find(d=>c.some(([p,_])=>{const f=l(d,_);return f===void 0?!1:(p==="entity_id"?r:p==="entity_state"?i?.state:s[p])===f}));u||xe(s,"entity_picture_local")||xe(s,"entity_picture")||xe(s,"album_art")||(u=t.find(d=>d?.missing_art_url),u?.missing_art_url&&(u={...u,image_url:u.missing_art_url})),u?.image_url&&(n=u.image_url,o=u?.size_percentage)}return n||(n=xe(s,"entity_picture_local")||xe(s,"entity_picture")||xe(s,"album_art")||null),!n&&a&&(a==="smart"?s.media_title==="TV"||s.media_channel||s.app_id==="tv"||s.app_id==="androidtv"?n="data:image/svg+xml;base64,":n="data:image/svg+xml;base64,":typeof a=="string"&&(n=a)),n&&e&&!n.startsWith("http")&&(n=e+n),{url:n,sizePercentage:o}}function co({idx:i,selected:e,playing:t,name:a,art:s,icon:r,pinned:n,holdToPin:o,maActive:l,onChipClick:c,onIconClick:u,onPinClick:d,onPointerDown:p,onPointerMove:_,onPointerUp:f,objectFit:g,quickGroupingState:b,onQuickGroupClick:k,onDoubleClick:x}){const T=g?`object-fit: ${g};`:"";return m`
  ...
  `}function uo({idx:i,selected:e,playing:t,groupName:a,art:s,icon:r,pinned:n,holdToPin:o,maActive:l,onChipClick:c,onIconClick:u,onPinClick:d,onPointerDown:p,onPointerMove:_,onPointerUp:f,objectFit:g,quickGroupingState:b,onQuickGroupClick:k,onDoubleClick:x}){const T=g?`object-fit: ${g};`:"";return m`
  ...
  `}const U=Object.freeze({MEDIA_BACKGROUND:0,MEDIA_OVERLAY:0,FLOATING_ELEMENT:1,STICKY_CHIPS:1,ACCENT_FOREGROUND:1,FLOATING_CONTROLS:1,OVERLAY_BASE:2,MODAL_BACKDROP:2,MODAL_TOAST:2,SEARCH_SLIDE_OUT:1,SEARCH_SUCCESS:1}),Ao=Bi`
...
`,So=[{mode:"replace",icon:"mdi:playlist-remove",label:h("search.replace")},{mode:"next",icon:"mdi:playlist-play",label:h("search.play_next")},{mode:"replace_next",icon:"mdi:playlist-music",label:h("search.replace_play")},{mode:"add",icon:"mdi:playlist-plus",label:h("search.add_queue")},{mode:"add_to_playlist",icon:"mdi:plus",label:h("search.add_to_playlist")}],Mt=["artist","album","track","playlist","radio","podcast","audiobook"],Ne=(i,{cap:e,floor:t}={})=>{const a=Number(i);if(!Number.isFinite(a)||a<=0)return;let s=a;return typeof t=="number"&&(s=Math.max(t,s)),typeof e=="number"&&(s=Math.min(e,s)),s},bs=3e4;let Ft=null,Ki=0;async function oi(i){const e=Date.now();if(Ft&&e-Ki<bs)return Ft;try{return Ft=(await i.callApi("GET","config/config_entries/entry")).find(t=>t.domain==="music_assistant"&&t.state==="loaded")?.entry_id||null,Ki=e,Ft}catch(t){return console.error("yamp: Failed to resolve Music Assistant config entry",t),Ft=null,Ki=e,null}}let Dt=null,Xi=0;async function Ji(i){const e=Date.now();if(Dt&&e-Xi<bs)return Dt;try{return Dt=(await i.callApi("GET","config/config_entries/entry")).find(t=>t.domain==="mass_queue"&&t.state==="loaded")?.entry_id||null,Xi=e,Dt}catch(t){return console.error("yamp: Failed to resolve mass_queue config entry",t),Dt=null,Xi=e,null}}function ct(i){return i?{title:i.name,media_content_id:i.uri,media_content_type:i.media_type,media_class:i.media_type,thumbnail:i.image,...i.artists&&{artist:i.artists.map(e=>e.name).join(", ")},...i.album&&{album:i.album.name},is_browsable:i.media_type==="artist"||i.media_type==="album"||i.media_type==="playlist",is_editable:i.is_editable===!0}:null}function li({item:i,onPlay:e,onOptionsToggle:t,upcomingFilterActive:a=!1,isMusicAssistant:s=!1,massQueueAvailable:r=!1,searchView:n="list",isInline:o=!1,onMoveUp:l,onMoveDown:c,onMoveNext:u,onRemove:d}){const p=!!(a&&i.queue_item_id&&s&&r),_=o?"entity-options-search-buttons":n==="card"?"card-overlay-buttons":"search-sheet-buttons",f=o?"entity-options-search-play":n==="card"?"search-sheet-play icon-only":"search-sheet-play",g=o?"entity-options-search-queue":n==="card"?"search-sheet-queue icon-only":"search-sheet-queue";return m`
  ...
  `}function $o({open:i,query:e,onQueryInput:t,onSearch:a,onClose:s,loading:r,results:n,onPlay:o,onQueue:l,error:c,showQueueSuccess:u,matchTheme:d=!1,upcomingFilterActive:p=!1,disableAutofocus:_=!1,activeSearchRowMenuId:f,successSearchRowMenuId:g,successSearchRowType:b,onOptionsToggle:k,onPlayOption:x,onResultClick:T,searchView:E="list",searchCardColumns:H=4,massQueueAvailable:M=!1,onMoveUp:D,onMoveDown:z,onMoveNext:R,onRemove:B}){return i?m`
    <div class="search-sheet" data-match-theme="${d}" data-card-view="${E==="card"}">
      ...
      <div class="search-sheet-results ${E==="card"?"search-results-card-view":"list-view"}">
        ${(n||[]).length===0&&!r?m`<div class="search-sheet-empty">${h("common.no_results")}</div>`:(n||[]).map(A=>{const L=tt(A.media_content_id),q=A.is_browsable&&(A.media_class!=="playlist"||M);return m`
                <div class="search-sheet-result ${E==="card"?"search-result-card":""}">
                  <div class="search-sheet-thumb-container" 
                    ...
                    `}
                    ${E==="card"?li({item:A,onPlay:o,onOptionsToggle:k,upcomingFilterActive:p,isMusicAssistant:L,massQueueAvailable:M,searchView:"card",onMoveUp:D,onMoveDown:z,onMoveNext:R,onRemove:B}):y}
                  </div>
                  ...
                  ${E!=="card"?li({item:A,onPlay:o,onOptionsToggle:k,upcomingFilterActive:p,isMusicAssistant:L,massQueueAvailable:M,searchView:"list",isInline:!0,onMoveUp:D,onMoveDown:z,onMoveNext:R,onRemove:B}):y}
                  
                  ${xs({item:A,activeSearchRowMenuId:f,successSearchRowMenuId:g,successSearchRowType:b,onPlayOption:x,onOptionsToggle:k,searchView:E,isQueueItem:L&&A.queue_item_id&&p&&M,massQueueAvailable:M,onMoveUp:D,onMoveDown:z,onMoveNext:R,onRemove:B})}
                </div>
              `})}
      </div>
    </div>
  `:y}function Io({item:i,onClose:e,onPlayOption:t,massQueueAvailable:a=!1}){return i?m`
    <div class="entity-options-overlay entity-options-overlay-opening" @click=${e}>
      <div class="entity-options-container entity-options-sheet-opening" @click=${s=>s.stopPropagation()}>
        <div class="entity-options-sheet">
          ...
          ${So.filter(s=>s.mode==="add_to_playlist"?(i.media_class==="track"||i.media_content_type==="track")&&a:!0).map(s=>m`
...
`,r?1+l:l),r=!0,n=!0,l=0,t=i.position;!$e(d)&&d!==0;)d=i.input.charCodeAt(++i.position);Ue(i,t,i.position,!1)}return!0}function rr(i,e){var t,a=i.tag,s=i.anchor,r=[],n,o=!1,l;if(i.firstTabInLine!==-1)return!1;for(i.anchor!==null&&(i.anchorMap[i.anchor]=r),l=i.input.charCodeAt(i.position);l!==0&&(i.firstTabInLine!==-1&&(i.position=i.firstTabInLine,S(i,"tab characters must not be used in indentation")),!(l!==45||(n=i.input.charCodeAt(i.position+1),!me(n))));){if(o=!0,i.position++,X(i,!0,-1)&&i.lineIndent<=e){r.push(null),l=i.input.charCodeAt(i.position);continue}if(t=i.line,pt(i,e,Qs,!1,!0),r.push(i.result),X(i,!0,-1),l=i.input.charCodeAt(i.position),(i.line===t||i.lineIndent>e)&&l!==0)S(i,"bad indentation of a sequence entry");else if(i.lineIndent<e)break}return o?(i.tag=a,i.anchor=s,i.kind="sequence",i.result=r,!0):!1}function Ql(i,e,t){var a,s,r,n,o,l,c=i.tag,u=i.anchor,d={},p=Object.create(null),_=null,f=null,g=null,b=!1,k=!1,x;if(i.firstTabInLine!==-1)return!1;for(i.anchor!==null&&(i.anchorMap[i.anchor]=d),x=i.input.charCodeAt(i.position);x!==0;){if(!b&&i.firstTabInLine!==-1&&(i.position=i.firstTabInLine,S(i,"tab characters must not be used in indentation")),a=i.input.charCodeAt(i.position+1),r=i.line,(x===63||x===58)&&me(a))x===63?(b&&(ht(i,d,p,_,f,null,n,o,l),_=f=g=null),k=!0,b=!0,s=!0):b?(b=!1,s=!0):S(i,"incomplete explicit mapping pair; a key node is missed; or followed by a non-tabulated empty line"),i.position+=1,x=a;else{if(n=i.line,o=i.lineStart,l=i.position,!pt(i,t,Vs,!1,!0))break;if(i.line===r){for(x=i.input.charCodeAt(i.position);it(x);)x=i.input.charCodeAt(++i.position);if(x===58)x=i.input.charCodeAt(++i.position),me(x)||S(i,"a whitespace character is expected after the key-value separator within a block mapping"),b&&(ht(i,d,p,_,f,null,n,o,l),_=f=g=null),k=!0,b=!1,s=!1,_=i.tag,f=i.result;else if(k)S(i,"can not read an implicit mapping pair; a colon is missed");else return i.tag=c,i.anchor=u,!0}else if(k)S(i,"can not read a block mapping entry; a multiline key may not be an implicit key");else return i.tag=c,i.anchor=u,!0}if((i.line===r||i.lineIndent>e)&&(b&&(n=i.line,o=i.lineStart,l=i.position),pt(i,e,di,!0,s)&&(b?f=i.result:g=i.result),b||(ht(i,d,p,_,f,g,n,o,l),_=f=g=null),X(i,!0,-1),x=i.input.charCodeAt(i.position)),(i.line===r||i.lineIndent>e)&&x!==0)S(i,"bad indentation of a mapping entry");else if(i.lineIndent<e)break}return b&&ht(i,d,p,_,f,null,n,o,l),k&&(i.tag=c,i.anchor=u,i.kind="mapping",i.result=d),k}function Wl(i){var e,t=!1,a=!1,s,r,n;if(n=i.input.charCodeAt(i.position),n!==33)return!1;if(i.tag!==null&&S(i,"duplication of a tag property"),n=i.input.charCodeAt(++i.position),n===60?(t=!0,n=i.input.charCodeAt(++i.position)):n===33?(a=!0,s="!!",n=i.input.charCodeAt(++i.position)):s="!",e=i.position,t){do n=i.input.charCodeAt(++i.position);while(n!==0&&n!==62);i.position<i.length?(r=i.input.slice(e,i.position),n=i.input.charCodeAt(++i.position)):S(i,"unexpected end of the stream within a verbatim tag")}else{for(;n!==0&&!me(n);)n===33&&(a?S(i,"tag suffix cannot contain exclamation marks"):(s=i.input.slice(e-1,i.position+1),Ys.test(s)||S(i,"named tag handle cannot contain such characters"),a=!0,e=i.position+1)),n=i.input.charCodeAt(++i.position);r=i.input.slice(e,i.position),Ol.test(r)&&S(i,"tag suffix cannot contain flow indicator characters")}r&&!Zs.test(r)&&S(i,"tag name cannot contain such characters: "+r);try{r=decodeURIComponent(r)}catch{S(i,"tag name is malformed: "+r)}return t?i.tag=r:qe.call(i.tagMap,s)?i.tag=i.tagMap[s]+r:s==="!"?i.tag="!"+r:s==="!!"?i.tag="tag:yaml.org,2002:"+r:S(i,'undeclared tag handle "'+s+'"'),!0}function Yl(i){var e,t;if(t=i.input.charCodeAt(i.position),t!==38)return!1;for(i.anchor!==null&&S(i,"duplication of an anchor property"),t=i.input.charCodeAt(++i.position),e=i.position;t!==0&&!me(t)&&!dt(t);)t=i.input.charCodeAt(++i.position);return i.position===e&&S(i,"name of an anchor node must contain at least one character"),i.anchor=i.input.slice(e,i.position),!0}function Zl(i){var e,t,a;if(a=i.input.charCodeAt(i.position),a!==42)return!1;for(a=i.input.charCodeAt(++i.position),e=i.position;a!==0&&!me(a)&&!dt(a);)a=i.input.charCodeAt(++i.position);return i.position===e&&S(i,"name of an alias node must contain at least one character"),t=i.input.slice(e,i.position),qe.call(i.anchorMap,t)||S(i,'unidentified alias "'+t+'"'),i.result=i.anchorMap[t],X(i,!0,-1),!0}function pt(i,e,t,a,s){var r,n,o,l=1,c=!1,u=!1,d,p,_,f,g,b;if(i.listener!==null&&i.listener("open",i),i.tag=null,i.anchor=null,i.kind=null,i.result=null,r=n=o=di===t||Qs===t,a&&X(i,!0,-1)&&(c=!0,i.lineIndent>e?l=1:i.lineIndent===e?l=0:i.lineIndent<e&&(l=-1)),l===1)for(;Wl(i)||Yl(i);)X(i,!0,-1)?(c=!0,o=r,i.lineIndent>e?l=1:i.lineIndent===e?l=0:i.lineIndent<e&&(l=-1)):o=!1;if(o&&(o=c||s),(l===1||di===t)&&(ci===t||Vs===t?g=e:g=e+1,b=i.position-i.lineStart,l===1?o&&(rr(i,b)||Ql(i,b,g))||Hl(i,g)?u=!0:(n&&Vl(i,g)||Bl(i,g)||Gl(i,g)?u=!0:Zl(i)?(u=!0,(i.tag!==null||i.anchor!==null)&&S(i,"alias node should not have any properties")):Ul(i,g,ci===t)&&(u=!0,i.tag===null&&(i.tag="?")),i.anchor!==null&&(i.anchorMap[i.anchor]=i.result)):l===0&&(u=o&&rr(i,b))),i.tag===null)i.anchor!==null&&(i.anchorMap[i.anchor]=i.result);else if(i.tag==="?"){for(i.result!==null&&i.kind!=="scalar"&&S(i,'unacceptable node kind for !<?> tag; it should be "scalar", not "'+i.kind+'"'),d=0,p=i.implicitTypes.length;d<p;d+=1)if(f=i.implicitTypes[d],f.resolve(i.result)){i.result=f.construct(i.result),i.tag=f.tag,i.anchor!==null&&(i.anchorMap[i.anchor]=i.result);break}}else if(i.tag!=="!"){if(qe.call(i.typeMap[i.kind||"fallback"],i.tag))f=i.typeMap[i.kind||"fallback"][i.tag];else for(f=null,_=i.typeMap.multi[i.kind||"fallback"],d=0,p=_.length;d<p;d+=1)if(i.tag.slice(0,_[d].tag.length)===_[d].tag){f=_[d];break}f||S(i,"unknown tag !<"+i.tag+">"),i.result!==null&&f.kind!==i.kind&&S(i,"unacceptable node kind for !<"+i.tag+'> tag; it should be "'+f.kind+'", not "'+i.kind+'"'),f.resolve(i.result,i.tag)?(i.result=f.construct(i.result,i.tag),i.anchor!==null&&(i.anchorMap[i.anchor]=i.result)):S(i,"cannot resolve a node with !<"+i.tag+"> explicit tag")}return i.listener!==null&&i.listener("close",i),i.tag!==null||i.anchor!==null||u}function Kl(i){var e=i.position,t,a,s,r=!1,n;for(i.version=null,i.checkLineBreaks=i.legacy,i.tagMap=Object.create(null),i.anchorMap=Object.create(null);(n=i.input.charCodeAt(i.position))!==0&&(X(i,!0,-1),n=i.input.charCodeAt(i.position),!(i.lineIndent>0||n!==37));){for(r=!0,n=i.input.charCodeAt(++i.position),t=i.position;n!==0&&!me(n);)n=i.input.charCodeAt(++i.position);for(a=i.input.slice(t,i.position),s=[],a.length<1&&S(i,"directive name must not be less than one character in length");n!==0;){for(;it(n);)n=i.input.charCodeAt(++i.position);if(n===35){do n=i.input.charCodeAt(++i.position);while(n!==0&&!$e(n));break}if($e(n))break;for(t=i.position;n!==0&&!me(n);)n=i.input.charCodeAt(++i.position);s.push(i.input.slice(t,i.position))}n!==0&&na(i),qe.call(ar,a)?ar[a](i,a,s):ui(i,'unknown document directive "'+a+'"')}if(X(i,!0,-1),i.lineIndent===0&&i.input.charCodeAt(i.position)===45&&i.input.charCodeAt(i.position+1)===45&&i.input.charCodeAt(i.position+2)===45?(i.position+=3,X(i,!0,-1)):r&&S(i,"directives end mark is expected"),pt(i,i.lineIndent-1,di,!1,!0),X(i,!0,-1),i.checkLineBreaks&&Pl.test(i.input.slice(e,i.position))&&ui(i,"non-ASCII line breaks are interpreted as content"),i.documents.push(i.result),i.position===i.lineStart&&hi(i)){i.input.charCodeAt(i.position)===46&&(i.position+=3,X(i,!0,-1));return}if(i.position<i.length-1)S(i,"end of the stream or a document separator is expected");else return}function nr(i,e){i=String(i),e=e||{},i.length!==0&&(i.charCodeAt(i.length-1)!==10&&i.charCodeAt(i.length-1)!==13&&(i+=`
`),i.charCodeAt(0)===65279&&(i=i.slice(1)));var t=new ql(i,e),a=i.indexOf("\0");for(a!==-1&&(t.position=a,S(t,"null byte is not allowed in input")),t.input+="\0";t.input.charCodeAt(t.position)===32;)t.lineIndent+=1,t.position+=1;for(;t.position<t.length-1;)Kl(t);return t.documents}function Xl(i,e,t){e!==null&&typeof e=="object"&&typeof t>"u"&&(t=e,e=null);var a=nr(i,t);if(typeof e!="function")return a;for(var s=0,r=a.length;s<r;s+=1)e(a[s])}function Jl(i,e){var t=nr(i,e);if(t.length!==0){if(t.length===1)return t[0];throw new ue("expected a single document in the stream, but found more")}}var ec=Xl,tc=Jl,or={loadAll:ec,load:tc},lr=Object.prototype.toString,cr=Object.prototype.hasOwnProperty,la=65279,ic=9,Pt=10,ac=13,sc=32,rc=33,nc=34,ca=35,oc=37,lc=38,cc=39,dc=42,dr=44,uc=45,pi=58,hc=61,pc=62,_c=63,mc=64,ur=91,hr=93,fc=96,pr=123,gc=124,_r=125,ce={};ce[0]="\\0",ce[7]="\\a",ce[8]="\\b",ce[9]="\\t",ce[10]="\\n",ce[11]="\\v",ce[12]="\\f",ce[13]="\\r",ce[27]="\\e",ce[34]='\\"',ce[92]="\\\\",ce[133]="\\N",ce[160]="\\_",ce[8232]="\\L",ce[8233]="\\P";var vc=["y","Y","yes","Yes","YES","on","On","ON","n","N","no","No","NO","off","Off","OFF"],yc=/^[-+]?[0-9_]+(?::[0-9_]+)+(?:\.[0-9_]*)?$/;function bc(i,e){var t,a,s,r,n,o,l;if(e===null)return{};for(t={},a=Object.keys(e),s=0,r=a.length;s<r;s+=1)n=a[s],o=String(e[n]),n.slice(0,2)==="!!"&&(n="tag:yaml.org,2002:"+n.slice(2)),l=i.compiledTypeMap.fallback[n],l&&cr.call(l.styleAliases,o)&&(o=l.styleAliases[o]),t[n]=o;return t}function xc(i){var e,t,a;if(e=i.toString(16).toUpperCase(),i<=255)t="x",a=2;else if(i<=65535)t="u",a=4;else if(i<=4294967295)t="U",a=8;else throw new ue("code point within a string may not be greater than 0xFFFFFFFF");return"\\"+t+te.repeat("0",a-e.length)+e}var wc=1,Ot=2;function kc(i){this.schema=i.schema||sa,this.indent=Math.max(1,i.indent||2),this.noArrayIndent=i.noArrayIndent||!1,this.skipInvalid=i.skipInvalid||!1,this.flowLevel=te.isNothing(i.flowLevel)?-1:i.flowLevel,this.styleMap=bc(this.schema,i.styles||null),this.sortKeys=i.sortKeys||!1,this.lineWidth=i.lineWidth||80,this.noRefs=i.noRefs||!1,this.noCompatMode=i.noCompatMode||!1,this.condenseFlow=i.condenseFlow||!1,this.quotingType=i.quotingType==='"'?Ot:wc,this.forceQuotes=i.forceQuotes||!1,this.replacer=typeof i.replacer=="function"?i.replacer:null,this.implicitTypes=this.schema.compiledImplicit,this.explicitTypes=this.schema.compiledExplicit,this.tag=null,this.result="",this.duplicates=[],this.usedDuplicates=null}function mr(i,e){for(var t=te.repeat(" ",e),a=0,s=-1,r="",n,o=i.length;a<o;)s=i.indexOf(`
`,a),s===-1?(n=i.slice(a),a=o):(n=i.slice(a,s+1),a=s+1),n.length&&n!==`
`&&(r+=t),r+=n;return r}function da(i,e){return`
`+te.repeat(" ",i.indent*e)}function Ec(i,e){var t,a,s;for(t=0,a=i.implicitTypes.length;t<a;t+=1)if(s=i.implicitTypes[t],s.resolve(e))return!0;return!1}function _i(i){return i===sc||i===ic}function Rt(i){return 32<=i&&i<=126||161<=i&&i<=55295&&i!==8232&&i!==8233||57344<=i&&i<=65533&&i!==la||65536<=i&&i<=1114111}function fr(i){return Rt(i)&&i!==la&&i!==ac&&i!==Pt}function gr(i,e,t){var a=fr(i),s=a&&!_i(i);return(t?a:a&&i!==dr&&i!==ur&&i!==hr&&i!==pr&&i!==_r)&&i!==ca&&!(e===pi&&!s)||fr(e)&&!_i(e)&&i===ca||e===pi&&s}function Ac(i){return Rt(i)&&i!==la&&!_i(i)&&i!==uc&&i!==_c&&i!==pi&&i!==dr&&i!==ur&&i!==hr&&i!==pr&&i!==_r&&i!==ca&&i!==lc&&i!==dc&&i!==rc&&i!==gc&&i!==hc&&i!==pc&&i!==cc&&i!==nc&&i!==oc&&i!==mc&&i!==fc}function Sc(i){return!_i(i)&&i!==pi}function zt(i,e){var t=i.charCodeAt(e),a;return t>=55296&&t<=56319&&e+1<i.length&&(a=i.charCodeAt(e+1),a>=56320&&a<=57343)?(t-55296)*1024+a-56320+65536:t}function vr(i){var e=/^\n* /;return e.test(i)}var yr=1,ua=2,br=3,xr=4,_t=5;function $c(i,e,t,a,s,r,n,o){var l,c=0,u=null,d=!1,p=!1,_=a!==-1,f=-1,g=Ac(zt(i,0))&&Sc(zt(i,i.length-1));if(e||n)for(l=0;l<i.length;c>=65536?l+=2:l++){if(c=zt(i,l),!Rt(c))return _t;g=g&&gr(c,u,o),u=c}else{for(l=0;l<i.length;c>=65536?l+=2:l++){if(c=zt(i,l),c===Pt)d=!0,_&&(p=p||l-f-1>a&&i[f+1]!==" ",f=l);else if(!Rt(c))return _t;g=g&&gr(c,u,o),u=c}p=p||_&&l-f-1>a&&i[f+1]!==" "}return!d&&!p?g&&!n&&!s(i)?yr:r===Ot?_t:ua:t>9&&vr(i)?_t:n?r===Ot?_t:ua:p?xr:br}function Ic(i,e,t,a,s){i.dump=(function(){if(e.length===0)return i.quotingType===Ot?'""':"''";if(!i.noCompatMode&&(vc.indexOf(e)!==-1||yc.test(e)))return i.quotingType===Ot?'"'+e+'"':"'"+e+"'";var r=i.indent*Math.max(1,t),n=i.lineWidth===-1?-1:Math.max(Math.min(i.lineWidth,40),i.lineWidth-r),o=a||i.flowLevel>-1&&t>=i.flowLevel;function l(c){return Ec(i,c)}switch($c(e,o,i.indent,n,l,i.quotingType,i.forceQuotes&&!a,s)){case yr:return e;case ua:return"'"+e.replace(/'/g,"''")+"'";case br:return"|"+wr(e,i.indent)+kr(mr(e,r));case xr:return">"+wr(e,i.indent)+kr(mr(Cc(e,n),r));case _t:return'"'+Tc(e)+'"';default:throw new ue("impossible error: invalid scalar style")}})()}function wr(i,e){var t=vr(i)?String(e):"",a=i[i.length-1]===`
`,s=a&&(i[i.length-2]===`
`||i===`
`),r=s?"+":a?"":"-";return t+r+`
...
{% endif %}</pre>
    ...
    `:y}_renderInlineActionRow(e){return!e||!e.length?y:m`
      <div style="${this._showEntityOptions?"visibility: hidden; pointer-events: none;":""}">
        ${po({actions:e.map(({action:t})=>t),onActionChipClick:t=>{const a=e[t];a&&this._onActionChipClick(a.idx)}})}
      </div>
    `}_renderGroupingMenuOption(){if(this.entityIds.length<=1)return y;const e=this.entityIds.reduce((n,o,l)=>{const c=this._getGroupingEntityId(l),u=this.hass.states[c];return n+(this._isGroupCapable(u)?1:0)},0),t=this._getGroupingEntityId(this._selectedIndex),a=this.hass.states[t],s=this.currentEntityId,r=this._getGroupKey(s)!==s;return e>1&&this._isGroupCapable(a)&&!r?m`
      ...
      <div class="group-list-scroll">
        ...
        `:f.map(g=>{const b=g.id,k=g.groupId,x=(Array.isArray(s?.attributes?.group_members)?s.attributes.group_members:[]).includes(k),T=this.getChipName(b),E=g.isBusy,H=g.busyLabel,M=this.entityIds.indexOf(b),D=this._getVolumeEntityForGrouping(M)||k,z=this.hass.states[D],R=D?.startsWith&&D.startsWith("remote."),B=Number(z?.attributes?.volume_level||0),A=b===e,L=!A;let q=h(r?A?"card.grouping.master":x?"card.grouping.joined":"card.grouping.available":b===l?"card.grouping.current":"card.grouping.available");return E&&(q=H||"Unavailable"),m`
    ...
    `}updated(e){if(this._idleImageTemplate&&e.has("hass")&&(this._idleImageTemplateNeedsResolve=!0),(e.has("_selectedIndex")||e.has("hass"))&&this._updateTransferQueueAvailability({refresh:!1}),this.hass&&this._hasMassQueueIntegration===null&&!this._checkingMassQueueIntegration&&(this._checkingMassQueueIntegration=!0,this._isMassQueueIntegrationAvailable(this.hass).then(s=>{this._hasMassQueueIntegration=s,s&&(this._massQueueAvailable=this._massQueueAvailable||s)}).catch(()=>{this._hasMassQueueIntegration=!1}).finally(()=>{this._checkingMassQueueIntegration=!1,this.requestUpdate()})),this.hass&&this.entityIds){if(this._upcomingFilterActive){const o=this.currentActivePlaybackEntityId;if(o){const l=this.hass.states[o]?.attributes?.media_title;if(l&&l!==this._lastMediaTitle){this._lastMediaTitle=l,this._searchLoading=!0,this.requestUpdate();const c=`${this._searchMediaClassFilter||"all"}_upcoming`;delete this._searchResultsByType[c],setTimeout(()=>{this._doSearch(this._searchMediaClassFilter==="all"?null:this._searchMediaClassFilter)},4e3)}}}const s=Date.now();for(let o=0;o<this.entityIds.length;o++){const l=this.entityIds[o],c=this.entityObjs[o];if(!c)continue;const u=c.entity_id,d=this._getActualResolvedMaEntityForState(o),p=this.hass.states[u]?.state,_=this._playerStateCache[u];if(p==="playing"?(this._playTimestamps[u]=s,this._lastActiveEntityIdByChip[o]=u):_==="playing"&&p!=="playing"&&(this._playTimestamps[u]=s),this._playerStateCache[u]=p,d&&d!==u){const g=this.hass.states[d]?.state,b=this._playerStateCache[d];g==="playing"?(this._playTimestamps[d]=s,this._lastActiveEntityIdByChip[o]=d):b==="playing"&&g!=="playing"&&(this._playTimestamps[d]=s),this._playerStateCache[d]=g}const f=this._getEntityForPurpose(o,"sorting");f&&this.hass.states[f]?.state==="playing"&&(this._playTimestamps[l]=s)}if(this._manualSelect&&this._pinnedIndex===null&&this._manualSelectPlayingSet){for(const o of[...this._manualSelectPlayingSet]){const l=this.hass.states[o];this._isEntityPlaying(l)||this._manualSelectPlayingSet.delete(o)}for(const o of this.entityIds){const l=this.hass.states[o];if(this._isEntityPlaying(l)&&!this._manualSelectPlayingSet.has(o)){this._manualSelect=!1,this._manualSelectPlayingSet=null;break}}}if(this._updateIdleState(),!this._manualSelect&&!this.isAnyMenuOpen){const o=this.sortedEntityIds;if(o.length>0){let l=o[0];const c=l?(this.groupedSortedEntityIds||[]).find(f=>f.includes(l)):null;if(c&&c.length>1){const f=this._getActualGroupMaster(c);f&&(l=f)}const u=this.entityIds.indexOf(l),d=u>=0?this._getEntityForPurpose(u,"sorting"):null,p=d?this.hass.states[d]:null,_=this._isCurrentEntityPlaying();this._isEntityPlaying(p)&&this.entityIds[this._selectedIndex]!==l&&(!this._idleTimeout||!this._hasSeenPlayback)&&!_&&!this.entityObjs[u]?.disable_auto_select&&(this._selectedIndex=u)}}const r=this.entityIds[this._selectedIndex],n=r?(this.groupedSortedEntityIds||[]).find(o=>o.includes(r)):null;if(n&&n.length>1){const o=this._getActualGroupMaster(n);if(o&&o!==r){const l=this.entityIds.indexOf(o);l>=0&&!this.entityObjs[l]?.disable_auto_select&&(this._selectedIndex=l,this._lastGroupingMasterId=o)}}this._ensureResolvedMaForIndex(this._selectedIndex),this._ensureResolvedVolForIndex(this._selectedIndex),this._updateSelectedEntityHelper()}super.updated?.(e),this._progressTimer&&(clearInterval(this._progressTimer),this._progressTimer=null);const t=this.currentActivePlaybackStateObj||this.currentPlaybackStateObj||this.currentStateObj;if(this._isEntityPlaying(t)&&t.attributes.media_duration&&(this._progressTimer=setInterval(()=>{this.requestUpdate()},500)),this._alwaysCollapsed&&this._expandOnSearch&&(this._searchOpen||this._showSearchInSheet)){this._prevCollapsed!==!1&&(this._prevCollapsed=!1,this._notifyResize());return}const a=this._alwaysCollapsed?!0:this._collapseOnIdle?this._isIdle:!1;if(this._prevCollapsed!==a&&(this._prevCollapsed=a,this._notifyResize()),this._addGrabScroll(".chip-row"),this._addGrabScroll(".action-chip-row"),this._addGrabScroll(".search-filter-chips"),this._addVerticalGrabScroll(".floating-source-index"),this._lastRenderedCollapsed&&!this._lastRenderedHideControls){const s=this.renderRoot?.querySelector(".card-lower-content");if(s){const r=s.offsetHeight;if(r&&r>0){const n=Number(this.config?.card_height);Number.isFinite(n)&&n>0?(!this._collapsedBaselineHeight||r<this._collapsedBaselineHeight-1)&&(this._collapsedBaselineHeight=r):this._collapsedBaselineHeight=r}}}this._showSearchInSheet&&(this._alwaysCollapsed&&this._expandOnSearch,setTimeout(()=>{const s=()=>{const o=this.renderRoot.querySelector("#search-input-box");return o?(o.focus(),this._searchInputAutoFocused=!0,!0):!1};!this._disableSearchAutofocus&&!this._searchInputAutoFocused&&(s()||setTimeout(()=>{this._showSearchInSheet&&!this._disableSearchAutofocus&&!this._searchInputAutoFocused&&s()},200));const r=this._getVisibleSearchFilterClasses().join(",");if((!this._searchLoading||r)&&this._lastSearchChipClasses!==r){const o=this.renderRoot.querySelector(".search-filter-chips");o&&(o.scrollLeft=0);const l=this.renderRoot.querySelector(".entity-options-overlay");l&&(l.scrollTop=0);const c=this.renderRoot.querySelector(".entity-options-sheet");c&&(c.scrollTop=0),this._lastSearchChipClasses=r}const n=this.renderRoot.querySelector("#search-filter-chip-row");n&&(n.scrollWidth>n.clientWidth+2?n.style.justifyContent="flex-start":n.style.justifyContent="center")},200)),this._showSourceList&&setTimeout(()=>{const s=this.renderRoot.querySelector(".entity-options-overlay");s&&(s.scrollTop=0)},0)}_toggleSourceMenu(){this._showSourceMenu=!this._showSourceMenu,this._showSourceMenu?(this._manualSelect=!0,setTimeout(()=>{this._shouldDropdownOpenUp=!0,this.requestUpdate(),this._addSourceDropdownOutsideHandler()},0)):(this._manualSelect=!1,this._removeSourceDropdownOutsideHandler())}_addSourceDropdownOutsideHandler(){this._sourceDropdownOutsideHandler||(this._sourceDropdownOutsideHandler=e=>{const t=this.renderRoot.querySelector(".source-dropdown"),a=this.renderRoot.querySelector(".source-menu-btn"),s=e.composedPath?e.composedPath():[];t&&s.includes(t)||a&&s.includes(a)||(this._showSourceMenu=!1,this._manualSelect=!1,this._removeSourceDropdownOutsideHandler(),this.requestUpdate())},window.addEventListener("mousedown",this._sourceDropdownOutsideHandler,!0),window.addEventListener("touchstart",this._sourceDropdownOutsideHandler,!0))}_removeSourceDropdownOutsideHandler(){this._sourceDropdownOutsideHandler&&(window.removeEventListener("mousedown",this._sourceDropdownOutsideHandler,!0),window.removeEventListener("touchstart",this._sourceDropdownOutsideHandler,!0),this._sourceDropdownOutsideHandler=null)}_selectSource(e){const t=this.currentEntityId;!t||!e||(this.hass.callService("media_player","select_source",{entity_id:t,source:e}),this._closeEntityOptions())}_onPinClick(e){e.stopPropagation(),this._manualSelect=!1,this._pinnedIndex=null,this._manualSelectPlayingSet=null}_onChipClick(e){if(this._holdToPin&&this._justPinned){this._justPinned=!1;return}if(this._selectedIndex=e,this._lastActiveEntityId=null,clearTimeout(this._manualSelectTimeout),this._holdToPin)if(this._pinnedIndex!==null)this._manualSelect=!0;else{this._manualSelect=!0,this._manualSelectPlayingSet=new Set;for(const t of this.entityIds){const a=this.hass?.states?.[t];this._isEntityPlaying(a)&&this._manualSelectPlayingSet.add(t)}}else this._manualSelect=!0,this._pinnedIndex=e;this.requestUpdate()}_pinChip(e){this._justPinned=!0,clearTimeout(this._manualSelectTimeout),this._manualSelectPlayingSet=null,this._pinnedIndex=e,this._manualSelect=!0,this.requestUpdate()}async _onActionChipClick(e){const t=this.config.actions[e];t&&await this._handleAction(t)}async _handleAction(e){if(!e)return;if(e.menu_item){switch(this._quickMenuInvoke=!0,e.menu_item){case"more-info":this._openMoreInfo(),this._showEntityOptions=!1,this.requestUpdate();break;case"group-players":this._showEntityOptions=!0,this._showGrouping=!0,this.requestUpdate();break;case"search":this._openQuickSearchOverlay();break;case"search-recently-played":this._showEntityOptions=!0,this._showSearchSheetInOptions("recently-played"),setTimeout(()=>{this._notifyResize()},0);break;case"search-next-up":this._showEntityOptions=!0,this._showSearchSheetInOptions("next-up"),setTimeout(()=>{this._notifyResize()},0);break;case"source":this._showEntityOptions=!0,this._showSourceList=!0,this._showGrouping=!1,this.requestUpdate();break;case"transfer-queue":this._showEntityOptions=!0,this._openTransferQueue();break}return}if(typeof e.navigation_path=="string"&&e.navigation_path.trim()!==""||e.action==="navigate"){let r=(typeof e.navigation_path=="string"?e.navigation_path:e.path||"").trim();const n=e.navigation_new_tab===!0,o={current:this.currentActivePlaybackEntityId||this.currentEntityId||""};let l=null;n&&(l=ro(this.hass,r,o)),l!=null?this._handleNavigate(l,n):(r=await so(this.hass,r,o),this._handleNavigate(r,n));return}if(e.action==="prev_entity"||e.action==="next_entity"){const r=this.sortedEntityIds;if(r&&r.length>0){const n=this.entityIds[this._selectedIndex],o=r.indexOf(n);if(o!==-1){let l=o;if(e.action==="prev_entity"?l=Math.max(0,o-1):l=Math.min(r.length-1,o+1),l!==o){const c=r[l],u=this.entityIds.indexOf(c);u!==-1&&u!==this._selectedIndex&&this._onChipClick(u)}}}return}if(!e.service)return;const[t,a]=e.service.split(".");let s={...e.service_data||{}};if(t==="script"&&e.script_variable===!0){const r=this.currentEntityId,n=this._getSearchEntityId(this._selectedIndex),o=await this._resolveTemplateAtActionTime(n,r),l=this.currentActivePlaybackEntityId||this._getPlaybackEntityId(this._selectedIndex),c=await this._resolveTemplateAtActionTime(l,r);(s.entity_id==="current"||s.entity_id==="$current"||s.entity_id==="this")&&delete s.entity_id,s.yamp_entity=o||r,s.yamp_main_entity=r,s.yamp_playback_entity=c}else if(!(t==="script"&&e.script_variable===!0)&&(s.entity_id==="current"||s.entity_id==="$current"||s.entity_id==="this"||!s.entity_id))if(t==="music_assistant"){const r=this._getSearchEntityId(this._selectedIndex);s.entity_id=await this._resolveTemplateAtActionTime(r,this.currentEntityId)}else if(t==="media_player"){const r=this.currentActivePlaybackEntityId||this._getPlaybackEntityId(this._selectedIndex);s.entity_id=await this._resolveTemplateAtActionTime(r,this.currentEntityId)}else s.entity_id=this.currentEntityId;this.hass.callService(t,a,s)}_onTapAreaPointerDown(e){this.isAnyMenuOpen||e.composedPath().some(t=>t.tagName==="BUTTON"||t.tagName==="HA-ICON"||t.tagName==="INPUT"||t.classList&&t.classList.contains("clickable-artist")||t.classList&&t.classList.contains("details"))||(this._gestureActive=!0,this._gestureStartTime=Date.now(),this._gestureStartX=e.clientX,this._gestureStartY=e.clientY,this._gestureHoldTriggered=!1,this._gestureTapArea=e.currentTarget,this._cardTriggers?.hold&&(this._gestureHoldTimer=setTimeout(()=>{this._gestureActive&&(this._gestureHoldTriggered=!0,this._showGestureFeedback("hold",this._gestureStartX,this._gestureStartY),this._handleAction(this._cardTriggers.hold))},en)))}_onTapAreaPointerMove(e){if(!this._gestureActive)return;const t=Math.abs(e.clientX-this._gestureStartX),a=Math.abs(e.clientY-this._gestureStartY);(t>wt||a>wt)&&clearTimeout(this._gestureHoldTimer)}_onTapAreaPointerUp(e){if(!this._gestureActive||(this._gestureActive=!1,clearTimeout(this._gestureHoldTimer),this._gestureHoldTriggered)||Date.now()-this._gestureStartTime>en)return;const t=e.clientX-this._gestureStartX,a=e.clientY-this._gestureStartY,s=Math.abs(t),r=Math.abs(a);if(s>=an&&r<an){clearTimeout(this._tapTimer);const u=e.clientX,d=e.clientY;if(t<0&&this._cardTriggers?.swipe_left){this._showGestureFeedback("swipe_left",u,d),this._handleAction(this._cardTriggers.swipe_left);return}else if(t>0&&this._cardTriggers?.swipe_right){this._showGestureFeedback("swipe_right",u,d),this._handleAction(this._cardTriggers.swipe_right);return}}if(s>wt||r>wt)return;const n=Date.now(),o=n-(this._lastTapTime||0);this._lastTapTime=n;const l=e.clientX,c=e.clientY;o<tn?(clearTimeout(this._tapTimer),this._cardTriggers?.double_tap&&(this._showGestureFeedback("double_tap",l,c),this._handleAction(this._cardTriggers.double_tap))):this._tapTimer=setTimeout(()=>{this._cardTriggers?.tap&&(this._showGestureFeedback("tap",l,c),this._handleAction(this._cardTriggers.tap))},Pd)}_showGestureFeedback(e,t,a){const s=this._gestureTapArea||this.shadowRoot?.querySelector(".card-artwork-spacer")||this.shadowRoot?.querySelector(".collapsed-artwork-container");if(!s)return;const r=s.getBoundingClientRect(),n=t-r.left,o=a-r.top,l=document.createElement("div");l.className=`gesture-ripple ${e}`,l.style.left=`${n}px`,l.style.top=`${o}px`;let c=s.querySelector(".gesture-feedback-container");c||(c=document.createElement("div"),c.className="gesture-feedback-container",s.appendChild(c)),l.addEventListener("animationend",()=>l.remove()),c.appendChild(l)}_onMenuActionClick(e){const t=this.config.actions?.[e];t&&(t.menu_item||(this._quickMenuInvoke=!0),this._onActionChipClick(e),t.menu_item||this._dismissWithAnimation())}_getActionLabel(e){if(!e)return"";if(typeof e.name=="string"&&e.name.trim()!=="")return e.name.trim();const t=!!e.icon;return e.menu_item?t?"":{search:"Search","search-recently-played":"Recently Played","search-next-up":"Next Up",source:"Source","more-info":"More Info","group-players":"Group Players","transfer-queue":"Transfer Queue"}[e.menu_item]??e.menu_item:typeof e.navigation_path=="string"&&e.navigation_path.trim()!==""||e.action==="navigate"?t?"":"Navigate":e.service?t?"":e.service:t?"":"Action"}async _onControlClick(e){const t=this._getEntityForPurpose(this._selectedIndex,"playback_control");if(!t)return;const a=this.hass?.states?.[t]||this.currentStateObj;switch(e){case"play_pause":this._isEntityPlaying(a)?(this.hass.callService("media_player","media_pause",{entity_id:t}),this._lastPlayingEntityIdByChip||(this._lastPlayingEntityIdByChip={}),this._lastPlayingEntityIdByChip[this._selectedIndex]=t,this._pauseTimestamps||(this._pauseTimestamps={}),this._pauseTimestamps[this._selectedIndex]=Date.now(),this._controlFocusEntityId=t,this._optimisticPlayback={entity_id:t,state:"paused",ts:Date.now()},this.requestUpdate(),setTimeout(()=>{this._optimisticPlayback=null,this.requestUpdate()},1200)):(this.hass.callService("media_player","media_play",{entity_id:t}),this._lastPlayingEntityIdByChip&&delete this._lastPlayingEntityIdByChip[this._selectedIndex],this._pauseTimestamps&&delete this._pauseTimestamps[this._selectedIndex],this._controlFocusEntityId=t,this._optimisticPlayback={entity_id:t,state:"playing",ts:Date.now()},this.requestUpdate(),setTimeout(()=>{this._optimisticPlayback=null,this.requestUpdate()},1200));break;case"next":this.hass.callService("media_player","media_next_track",{entity_id:t});break;case"prev":this.hass.callService("media_player","media_previous_track",{entity_id:t});break;case"stop":if(this.hass.callService("media_player","media_stop",{entity_id:t}),a){const s=t;this._optimisticPlayback={entity_id:s,state:"idle",ts:Date.now()},this.requestUpdate(),setTimeout(()=>{this._optimisticPlayback=null,this.requestUpdate()},1200)}break;case"shuffle":{const s=!!a.attributes.shuffle;this.hass.callService("media_player","shuffle_set",{entity_id:t,shuffle:!s});break}case"repeat":{let s=a.attributes.repeat||"off",r;s==="off"?r="all":s==="all"?r="one":r="off",this.hass.callService("media_player","repeat_set",{entity_id:t,repeat:r});break}case"power":{const s=this.currentEntityId,r=(this.hass?.states?.[s]||a)?.state==="off"?"turn_on":"turn_off";this.hass.callService("media_player",r,{entity_id:s});const n=this.entityObjs[this._selectedIndex];if(n&&n.sync_power){const o=this._getVolumeEntity(this._selectedIndex);o&&o!==n.entity_id&&this.hass.callService("media_player",r,{entity_id:o})}break}case"favorite":{const s=this._getFavoriteButtonEntity(),r=this.hass?.states?.[t]?.attributes?.media_content_id,n=this._isCurrentTrackFavorited(),o=await this._isMassQueueIntegrationAvailable(this.hass);if(n&&o){const l=this._getMusicAssistantState()?.entity_id;if(l)try{const c={type:"call_service",domain:"mass_queue",service:"unfavorite_current_item",service_data:{entity:l}};await this.hass.connection.sendMessagePromise(c),r&&(this._favoriteStatusCache||(this._favoriteStatusCache={}),this._favoriteStatusCache[r]={isFavorited:!1}),this._searchResultsByType&&Object.keys(this._searchResultsByType).forEach(u=>{(u.includes("_favorites")||u==="favorites")&&delete this._searchResultsByType[u]}),this._checkingFavorites=null,this.requestUpdate()}catch(c){console.error("yamp: Failed to unfavorite current item:",c)}}else s&&(this.hass.callService("button","press",{entity_id:s}),r&&(this._favoriteStatusCache||(this._favoriteStatusCache={}),this._favoriteStatusCache[r]={isFavorited:!0},this._checkingFavorites=null,this._searchResultsByType&&Object.keys(this._searchResultsByType).forEach(l=>{(l.includes("_favorites")||l==="favorites")&&delete this._searchResultsByType[l]}),this.requestUpdate()));break}}}async _onVolumeChange(e){const t=this._selectedIndex,a=this._getGroupingEntityId(t),s=await this._resolveTemplateAtActionTime(a,this.currentEntityId),r=this.hass.states[s],n=Number(e.target.value),o=this.entityObjs[t];if(!(typeof o.group_volume!="boolean"||o.group_volume)||this._quickGroupingMode){this.hass.callService("media_player","volume_set",{entity_id:this._getVolumeEntity(t),volume_level:n});return}if(this._isCurrentlyGrouped(r)){const l=this.entityObjs[t].entity_id,c=[...new Set([l,...r.attributes.group_members])],u=typeof this._groupBaseVolume=="number"?this._groupBaseVolume:Number(this.currentVolumeStateObj?.attributes.volume_level||0),d=n-u;for(const p of c){for(const b of this.entityObjs){let k;if(b.music_assistant_entity)if(typeof b.music_assistant_entity=="string"&&(b.music_assistant_entity.includes("{{")||b.music_assistant_entity.includes("{%")))try{k=await this._resolveTemplateAtActionTime(b.music_assistant_entity,b.entity_id)}catch{k=b.entity_id}else k=b.music_assistant_entity;else k=b.entity_id;if(k===p)break}const _=p,f=this.hass.states[_];if(!f)continue;let g=Number(f.attributes.volume_level||0)+d;g=Math.max(0,Math.min(1,g)),g=Math.round(g*1e4)/1e4,this.hass.callService("media_player","volume_set",{entity_id:_,volume_level:g})}this._groupBaseVolume=n}else{const l=this._getVolumeEntity(t);this.hass.callService("media_player","volume_set",{entity_id:l,volume_level:n})}}async _onVolumeStep(e){const t=this._selectedIndex,a=this._getVolumeEntity(t);if(!a)return;const s=a.startsWith&&a.startsWith("remote."),r=this.currentVolumeStateObj;if(!r)return;if(s){this.hass.callService("remote","send_command",{entity_id:a,command:e>0?"volume_up":"volume_down"});return}const n=this._getGroupingEntityId(t),o=await this._resolveTemplateAtActionTime(n,this.currentEntityId),l=this.hass.states[o];if(this._isCurrentlyGrouped(l)){const c=this.entityObjs[t].entity_id,u=[...new Set([c,...l.attributes.group_members])],d=this._volumeStep*e;for(const p of u){for(const b of this.entityObjs){let k;if(b.music_assistant_entity)if(typeof b.music_assistant_entity=="string"&&(b.music_assistant_entity.includes("{{")||b.music_assistant_entity.includes("{%")))try{k=await this._resolveTemplateAtActionTime(b.music_assistant_entity,b.entity_id)}catch{k=b.entity_id}else k=b.music_assistant_entity;else k=b.entity_id;if(k===p)break}const _=p,f=this.hass.states[_];if(!f)continue;let g=Number(f.attributes.volume_level||0)+d;g=Math.max(0,Math.min(1,g)),g=Math.round(g*1e4)/1e4,this.hass.callService("media_player","volume_set",{entity_id:_,volume_level:g})}}else{let c=Number(r.attributes.volume_level||0);c+=this._volumeStep*e,c=Math.max(0,Math.min(1,c)),c=Math.round(c*1e4)/1e4,this.hass.callService("media_player","volume_set",{entity_id:a,volume_level:c})}}async _onMuteToggle(){const e=this._selectedIndex,t=this._getVolumeEntity(e);if(!t)return;const a=t.startsWith&&t.startsWith("remote."),s=this.currentVolumeStateObj;if(!s)return;const r=s.attributes.is_volume_muted??!1,n=s.attributes.volume_level??0;if(a){r?this.hass.callService("media_player","volume_set",{entity_id:t,volume_level:.5}):this.hass.callService("media_player","volume_set",{entity_id:t,volume_level:0});return}if(!this._supportsFeature(s,_a)){if(n>0)this._previousVolume=n,this.hass.callService("media_player","volume_set",{entity_id:t,volume_level:0});else{const u=this._previousVolume??.5;this.hass.callService("media_player","volume_set",{entity_id:t,volume_level:u}),this._previousVolume=null}return}let o,l,c;try{o=this._getGroupingEntityId(e),l=await this._resolveTemplateAtActionTime(o,this.currentEntityId),c=this.hass.states[l]}catch(u){console.error("yamp: Error in grouping detection:",u)}if(this._isCurrentlyGrouped(c)){const u=this.entityObjs[e].entity_id,d=[...new Set([u,...c.attributes.group_members])];for(const p of d){const _=p,f=this.hass.states[_];f&&this._supportsFeature(f,_a)?this.hass.callService("media_player","volume_mute",{entity_id:_,is_volume_muted:!r}):(f?.attributes?.volume_level??0)>0?this.hass.callService("media_player","volume_set",{entity_id:_,volume_level:0}):this.hass.callService("media_player","volume_set",{entity_id:_,volume_level:.5})}}else this.hass.callService("media_player","volume_mute",{entity_id:t,is_volume_muted:!r})}_onVolumeDragStart(e){if(!this.hass)return;const t=this.currentVolumeStateObj;this._groupBaseVolume=t?Number(t.attributes.volume_level||0):0}_onVolumeDragEnd(e){this._groupBaseVolume=null}_onGroupVolumeChange(e,t,a){const s=Number(a.target.value);this.hass.callService("media_player","volume_set",{entity_id:t,volume_level:s}),this.requestUpdate()}_onGroupVolumeStep(e,t){this.hass.callService("remote","send_command",{entity_id:e,command:t>0?"volume_up":"volume_down"}),this.requestUpdate()}_onSourceChange(e){const t=this.currentEntityId,a=e.target.value;!t||!a||this.hass.callService("media_player","select_source",{entity_id:t,source:a})}_openMoreInfo(){this.dispatchEvent(new CustomEvent("hass-more-info",{detail:{entityId:this.currentEntityId},bubbles:!0,composed:!0}))}async _onProgressBarClick(e){try{e.stopPropagation();const t=this.currentEntityId,a=this._getActualResolvedMaEntityForState(this._selectedIndex),s=t?this.hass?.states?.[t]:null,r=a?this.hass?.states?.[a]:null;let n;if(this._controlFocusEntityId&&(this._controlFocusEntityId===a||this._controlFocusEntityId===t))n=this._controlFocusEntityId;else if(this._isEntityPlaying(r))n=a;else if(this._isEntityPlaying(s))n=t;else{const p=this._lastPlayingEntityIdByChip?.[this._selectedIndex];if(p&&(p===a||p===t))n=p;else{const _=this._getPlaybackEntityId(this._selectedIndex);n=await this._resolveTemplateAtActionTime(_,this.currentEntityId)}}const o=this.hass?.states?.[n]||this.currentStateObj;if(!n||!o||!o.attributes){console.warn("YAMP: Cannot seek - invalid target or state",n,o);return}const l=o.attributes.media_duration;if(!l)return;const c=e.target.getBoundingClientRect(),u=(e.clientX-c.left)/c.width,d=Math.floor(u*l);this._seekAnchor={position:d,timestamp:Date.now(),trackId:o.attributes.media_content_id||o.attributes.media_title},this._seekConvergenceLock=Date.now()+2e3,this._seekOffset=null,this.requestUpdate(),this.hass.callService("media_player","media_seek",{entity_id:n,seek_position:d})}catch(t){console.error("YAMP: Error in _onProgressBarClick",t)}}render(){if(!this.hass||!this.config)return y;const e=this.config.card_height,t=typeof e=="string"?e:Number(e),a=typeof t=="number"&&Number.isFinite(t)&&t>0||typeof t=="string"&&t.trim()!=="",s=this._collapsedBaselineHeight||220,r=this.entityObjs.length===1,n=r&&this.config.always_collapsed===!0&&this.config.expand_on_search!==!0,o=this.config.pin_search_headers===!0&&!n,l=!(this.config.hide_search_headers_on_idle===!0&&this._isIdle);if(this.shadowRoot&&this.shadowRoot.host){this.shadowRoot.host.setAttribute("data-match-theme",String(this.config.match_theme===!0)),this.shadowRoot.host.setAttribute("data-always-collapsed",String(this.config.always_collapsed===!0));const v=this.config.always_collapsed===!0&&this.config.pin_search_headers===!0&&this.config.expand_on_search===!0;this.shadowRoot.host.setAttribute("data-hide-menu-player",String(this.config.hide_menu_player===!0||v)),this.shadowRoot.host.setAttribute("data-extend-artwork",String(this.config.extend_artwork===!0)),this.shadowRoot.host.setAttribute("data-control-layout",this._controlLayout),this.shadowRoot.host.setAttribute("data-pin-search-headers",String(o)),a?this.shadowRoot.host.setAttribute("data-has-custom-height","true"):this.shadowRoot.host.removeAttribute("data-has-custom-height")}const c=this.config.show_chip_row||"auto",u=this.entityObjs.length>1,d=(c==="in_menu"||c==="in_menu_on_idle"&&this._isIdle)&&u,p=c!=="in_menu"&&(u||c==="always"),_=c==="in_menu_on_idle"&&this._isIdle&&u,f=c==="in_menu_on_idle"&&u,g=(this.config.actions??[]).map((v,P)=>({action:v,idx:P})).filter(({action:v})=>v?.action!=="sync_selected_entity"),b=v=>v?.placement?v.placement:v?.in_menu==="hidden"?"hidden":v?.in_menu===!0?"menu":"chip",k=g.filter(({action:v})=>b(v)==="chip"),x=g.filter(({action:v})=>b(v)==="menu"),T=g.find(({action:v})=>v?.card_trigger==="tap"),E=g.find(({action:v})=>v?.card_trigger==="hold"),H=g.find(({action:v})=>v?.card_trigger==="double_tap"),M=g.find(({action:v})=>v?.card_trigger==="swipe_left"),D=g.find(({action:v})=>v?.card_trigger==="swipe_right");this._cardTriggers={tap:T?.action,hold:E?.action,double_tap:H?.action,swipe_left:M?.action,swipe_right:D?.action};const z=this.currentActivePlaybackStateObj||this.currentPlaybackStateObj||this.currentStateObj,R=this.getChipName(this.currentEntityId);if(!z)return m`<div class="details">${h("common.not_found")}</div>`;const B=this._getHiddenControlsForCurrentEntity(),A=!!this._getFavoriteButtonEntity()&&!B.favorite,L=this._isCurrentTrackFavorited(),q=!B.power&&(this._supportsFeature(z,Jc)||this._supportsFeature(z,Xc)),Z=this._controlLayout==="modern"&&q,ie=this._controlLayout==="modern"&&A;let K=y;Z?K=m`
      ...
      `:y,oe=z.attributes.source_list||[],Ae=new Set(oe.map(v=>v&&v[0]?v[0].toUpperCase():"")),pe="ABCDEFGHIJKLMNOPQRSTUVWXYZ".split("");this._idleImageTemplate&&this._idleImageTemplateNeedsResolve&&!this._resolvingIdleImageTemplate&&this._isIdle&&this._resolveIdleImageTemplate();const ae=this._idleImageTemplate?this._idleImageTemplateResult:this.config.idle_image,Oe=this._normalizeImageSourceValue(ae);let Ve=null;if(Oe&&this._isIdle)if(this.hass.states[Oe]){const v=this.hass.states[Oe];Ve=v.attributes.entity_picture_local||v.attributes.entity_picture||(v.state&&v.startsWith("http")?v.state:null)}else(Oe.startsWith("http")||Oe.startsWith("/"))&&(Ve=Oe);const Pa=!!Ve,Qe=this._isIdle,sn=this._isIdle,rn=this._artworkObjectFit==="scaled-contain",Oa=this.config.extend_artwork===!0||_||rn,Ra=this.currentStateObj;this.currentPlaybackStateObj,this._optimisticPlayback?.entity_id,this._getResolvedPlaybackEntityIdSync(this._selectedIndex);const kt=this._getActualResolvedMaEntityForState(this._selectedIndex),nn=kt?this.hass?.states?.[kt]:null,on=this._lastMainState,za=this._lastMaState;this._lastMainState=Ra?.state,this._lastMaState=nn?.state;const _e=this._selectedIndex;if(za==="playing"&&this._lastMaState!=="playing"){const v=Math.max(Number(this._idleTimeoutMs||this.config?.idle_timeout_ms||6e4),500);this._playbackLingerByIdx[_e]={entityId:kt,until:Date.now()+v}}if(za==="playing"&&this._lastMaState==="paused"&&this._lastPlayingEntityIdByChip?.[_e]===kt||on==="playing"&&this._lastMainState==="paused"&&this._lastPlayingEntityIdByChip?.[_e]===Ra?.entity_id){const v=this._lastPlayingEntityIdByChip[_e],P=Math.max(Number(this._idleTimeoutMs||this.config?.idle_timeout_ms||6e4),500);this._playbackLingerByIdx[_e]={entityId:v,until:Date.now()+P}}this._lastMaState==="playing"&&this._playbackLingerByIdx?.[_e]&&delete this._playbackLingerByIdx[_e];const ln=this.config.entities[_e]?.music_assistant_entity,cn=this._getEntityForPurpose(_e,"ma_resolve"),Et=this._lastPlayingEntityIdByChip?.[_e],dn=this._maResolveCache?.[_e]?.id,un=!!(Et&&(Et===dn||Et===cn||Et===ln||Et===kt));this._lastMainState==="playing"&&this._playbackLingerByIdx?.[_e]&&!un&&delete this._playbackLingerByIdx[_e];const La=this._getEntityForPurpose(this._selectedIndex,"playback_control"),We=this.hass?.states?.[La],At=We,hn=La;At?.state,this._optimisticPlayback&&this._optimisticPlayback.entity_id===hn&&this._optimisticPlayback.state;const pn=!!At?.attributes?.shuffle,_n=At?.attributes?.repeat&&At?.attributes?.repeat!=="off",Ye=this._idleTimeoutMs===0?this._isEntityPlaying(We):!this._isIdle&&this._isEntityPlaying(We),Ci=this.currentStateObj,Ti=this._getArtworkUrl(Ci),Mi=this._getArtworkUrl(We);(this._idleTimeoutMs===0?Ye&&(Ti?.url||Mi?.url):!this._isIdle&&Ye&&(Ti?.url||Mi?.url))&&(Ti?.url||Mi?.url);const Re=this._idleTimeoutMs===0?!0:Ye,ve=At||Ci,Kt=Re&&ve?.attributes?.media_title||"",Na=Re&&(ve?.attributes?.media_artist||ve?.attributes?.media_series_title||ve?.attributes?.app_name)||"";this._lastTitleLength=Kt?Kt.length:0,this._adaptiveText&&this._updateAdaptiveTextScale(!0);let nt=ve?.attributes?.media_position||0;const St=ve?.attributes?.media_duration||0;let Xt=nt;if(Ye&&ve){const v=ve.attributes?.media_position_updated_at?Date.parse(ve.attributes.media_position_updated_at):ve.last_changed?Date.parse(ve.last_changed):Date.now(),P=(Date.now()-v)/1e3;Xt+=P}const mn=ve?.attributes?.media_content_id||ve?.attributes?.media_title,qa=Date.now();if(this._seekAnchor&&this._seekAnchor.trackId===mn){let v=this._seekAnchor.position;Ye&&(v+=(qa-this._seekAnchor.timestamp)/1e3);const P=this._seekConvergenceLock&&qa<this._seekConvergenceLock,G=Math.abs(Xt-v);!P&&G<2?(this._seekAnchor=null,this._seekConvergenceLock=null,nt=Xt):nt=v}else this._seekAnchor=null,this._seekConvergenceLock=null,nt=Xt;const Ua=St?Math.min(1,nt/St):0,Fi=this._getVolumeEntity(_e),fn=Fi&&Fi.startsWith&&Fi.startsWith("remote."),gn=Number(this.currentVolumeStateObj?.attributes.volume_level||0),vn=this.config.volume_mode!=="stepper";let Q;this._alwaysCollapsed&&this._expandOnSearch&&(this._searchOpen||this._showSearchInSheet)?Q=!1:Q=this._alwaysCollapsed?!0:this._collapseOnIdle?this._isIdle:!1;const Te=Q&&this._alwaysCollapsed&&a?Math.max(0,t-s):0,yn=Q&&p?48:0,bn=Q&&k.length>0?40:0,xn=yn+bn,Di=48,ze=Math.max(0,Te-xn),Jt=Te>0?Math.min(240,102+ze*.75):102,Ba=ze>0?Math.min(ze*.45,96):0,wn=ze>0?Math.round(Di+Ba):Di,kn=Q?wn:Di,ji=ze>0?Math.max(0,ze-Ba):0;let Pi=!1;const Ga=350,En=(Q?a?t:this._collapsedBaselineHeight||220:Ga)>=Ga,Ha=this.config.hide_menu_player===!0?!1:!Q||En,An=ji>=48,Oi=Te>0?Math.max(100,Math.round(Jt+24+Math.min(40,Te*.12))):null,Sn=An?0:Oi??0;let Va=this.offsetWidth||(this.shadowRoot?.host?.offsetWidth??0);const Ri=Va>380?Math.min(1.6,1+(Va-380)/520):1,zi=Te>0?Math.min(1.45,1+ze/180):1,Qa=zi>1||Ri>1?Math.min(1.6,Math.max(zi,Ri)):1,Wa=Math.min(1.5,Math.max(zi*.92,Ri*.92));this.shadowRoot&&this.shadowRoot.host&&(Te>0&&(Oi!=null&&this.shadowRoot.host.style.setProperty("--yamp-collapsed-details-offset",`${Oi}px`),this.shadowRoot.host.style.setProperty("--yamp-collapsed-controls-offset",`${Sn}px`),this.shadowRoot.host.style.setProperty("--yamp-collapsed-title-scale",Qa.toFixed(3)),this.shadowRoot.host.style.setProperty("--yamp-collapsed-artist-scale",Wa.toFixed(3))),this.shadowRoot.host.style.setProperty("--yamp-collapsed-title-scale",Qa.toFixed(3)),this.shadowRoot.host.style.setProperty("--yamp-collapsed-artist-scale",Wa.toFixed(3)),Te>0&&a||(this.shadowRoot.host.style.removeProperty("--yamp-collapsed-controls-offset"),this.shadowRoot.host.style.removeProperty("--yamp-collapsed-details-offset")),Ha?this.shadowRoot.host.removeAttribute("data-hide-persistent-controls"):this.shadowRoot.host.setAttribute("data-hide-persistent-controls","true"));let le=null,Li=null,Ya=this._artworkObjectFit;if(!this._isIdle){const v=this._getArtworkUrl(We),P=this._getArtworkUrl(Ci),G=v?.url?v:P;le=G?.url||null,Li=G?.sizePercentage,G?.objectFit&&(Ya=G.objectFit)}Pi=Q&&!le&&!Ve&&ze>=40,Q&&le&&le!==this._lastArtworkUrl&&(this._extractDominantColor(le).then(v=>{this._collapsedArtDominantColor=v,this.requestUpdate()}),this._lastArtworkUrl=le);const Za=Qe?Q?this._collapsedBaselineHeight||220:325:null;this._lastRenderedCollapsed=Q,this._lastRenderedHideControls=Qe;const ei=Ya||this._artworkObjectFit,ti=ei==="scaled-contain"&&!Q&&!this._alwaysCollapsed,$n=ei==="scaled-contain"&&(c==="in_menu"||r&&c!=="always");let Ni=this._getBackgroundSizeForFit(ei);Li&&(Ni=`${Li}%`);const Ka=Ve?`url('${Ve}')`:le?`url('${le}')`:"none",Xa=Ka!=="none",In=le&&(Q||ti)?"blur(18px) brightness(0.7) saturate(1.15)":"none",Ja=[`background-image: ${Ka}`,`background-size: ${ti?"cover":Ni}`,`background-position: ${this.config.artwork_position||"top center"}`,"background-repeat: no-repeat",`filter: ${In}`].join("; ");return this.shadowRoot&&this.shadowRoot.host&&(this.shadowRoot.host.style.setProperty("--yamp-artwork-fit",ei),this.shadowRoot.host.style.setProperty("--yamp-artwork-bg-size",Ni)),m`
        <ha-card class="yamp-card" style=${a&&(!Q||this._alwaysCollapsed)?`height:${t}px;`:y}>
          <div
            data-match-theme="${String(this.config.match_theme===!0)}"
            class=${io({"yamp-card-inner":!0,"dim-idle":sn,"no-chip-dim":this.config.dim_chips_on_idle===!1})}
          >
            ${Oa&&Xa?m`
            ...
            <div class="card-lower-content-container" style="${Za?`min-height:${Za}px;`:""}">
              ...
              <div class="card-lower-content${Q?" collapsed transitioning":" transitioning"}${Q&&le?" has-artwork":""}" style="${Qe?Q?`min-height: ${this._collapsedBaselineHeight||220}px;`:"min-height: 350px;":""}">
                ...
                ${Pi||!Q?m`
                  ...
                  >
                    ${ti&&le?m`
                      <div style="position: absolute; ${$n?"top: 20px; right: 0; bottom: 0; left: 0;":"inset: 0;"} display: flex; align-items: center; justify-content: center; pointer-events: none;">
                        <img 
                          src="${le}" 
                ...
                `:y}
                <div class="details" style="${(()=>{const v=[];return this._showEntityOptions&&v.push("visibility:hidden"),v.push(`min-height:${kn}px`),Re||v.push("opacity:0"),v.join(";")})()}">
                  <div class="title">
                    ${Re&&Kt?Kt:m`&nbsp;`}
                  </div>
                  <div
                ...
                <div style="${Qe||this._showEntityOptions?"visibility:hidden; pointer-events:none;":""}">
                    ${ko({stateObj:We,showStop:this._shouldShowStopButton(We),shuffleActive:pn,repeatActive:_n,onControlClick:v=>this._onControlClick(v),supportsFeature:(v,P)=>this._supportsFeature(v,P),showFavorite:A,favoriteActive:L,hiddenControls:B,adaptiveControls:this._adaptiveControls,controlLayout:this._controlLayout,swapPauseForStop:this._controlLayout==="modern"&&this._swapPauseForStop})}

                    ${Eo({isRemoteVolumeEntity:fn,showSlider:vn,vol:gn,isMuted:this.currentVolumeStateObj?.attributes?.is_volume_muted??!1,supportsMute:this.currentVolumeStateObj?this._supportsFeature(this.currentVolumeStateObj,_a):!1,onVolumeDragStart:v=>this._onVolumeDragStart(v),onVolumeDragEnd:v=>this._onVolumeDragEnd(v),onVolumeChange:v=>this._onVolumeChange(v),onVolumeStep:v=>this._onVolumeStep(v),onMuteToggle:()=>this._onMuteToggle(),leadingControlTemplate:K,reserveLeadingControlSpace:this._controlLayout==="modern",showRightPlaceholder:this._controlLayout==="modern",rightSlotTemplate:ne,hideVolume:this.config.volume_mode==="hidden",moreInfoMenu:m`
            ...
            <div class="entity-options-search-results ${this.config.search_view==="card"?"search-results-card-view":"list-view"}" 
              ...
              ${(()=>{this._searchMediaClassFilter;const v=this._getDisplaySearchResults(),P=Math.max(15,this._searchTotalRows||v.length),G=[...v,...Array.from({length:Math.max(0,P-v.length)},()=>null)];return this._searchAttempted&&v.length===0&&!this._searchLoading?m`<div class="entity-options-search-empty">${h("common.no_results")}</div>`:G.map(N=>N?m`
                            ...
                            <div class="entity-options-search-result ${this.config.search_view==="card"?"search-result-card":""} ${N._justMoved?"just-moved":""} ${N.media_content_id!=null&&this._activeSearchRowMenuId===N.media_content_id?"menu-active":""}">
                               <div class="search-sheet-thumb-container"
                                ...
                                `}
                                ${this.config.search_view==="card"?li({item:N,onPlay:F=>this._playMediaFromSearch(F),onOptionsToggle:F=>{this._activeSearchRowMenuId=F?.media_content_id||null,this.requestUpdate()},upcomingFilterActive:!!this._upcomingFilterActive,isMusicAssistant:this._isMusicAssistantEntity(),massQueueAvailable:this._massQueueAvailable,searchView:"card"}):y}
                               </div>
                               <div class="search-sheet-info">
                                <span class="${this._isClickableSearchResult(N)?"clickable-search-result":""} ${this.config.search_view==="card"?"search-sheet-title":""}"
                                      @touchstart=${F=>this._handleSearchResultTouch(N,F)}
                                      @click=${()=>this._handleSearchResultClick(N)}
                                      title=${this._getSearchResultClickTitle(N)}>
                                  ${N.title}
                                </span>
                                 <span class="search-sheet-subtitle">
                                  ${(()=>{const F=this._searchMediaClassFilter==="track"||this._searchMediaClassFilter==="album",Se=!!this._recentlyPlayedFilterActive,Cn=!!this._upcomingFilterActive,Tn=!!this._recommendationsFilterActive;return(F||Se||Cn||Tn)&&N.artist?N.artist:N.media_class?N.media_class.charAt(0).toUpperCase()+N.media_class.slice(1):""})()}
                                </span>
                                ${this.config.search_view==="card"?m`
                                  <div class="card-menu-button" @click=${F=>{F.preventDefault(),F.stopPropagation(),this._activeSearchRowMenuId=N.media_content_id,this.requestUpdate()}}>
                                    <ha-icon icon="mdi:dots-vertical"></ha-icon>
                                  </div>
                                `:y}
                              </div>
              ...
              `:this._showGrouping?this._renderGroupingSheet():m`
                ...
                <div class="floating-source-index">
                  ${pe.map((v,P)=>{const G=Ae.has(v),N=this._hoveredSourceLetterIndex;let F="";if(G&&N!==null&&N!==void 0){const Se=Math.abs(N-P);Se===0?F="max":Se===1?F="large":Se===2&&(F="med")}return m`
                      <button
...
`}
            ...
            ${Ha?m`
              <div class="persistent-media-controls" @click=${v=>v.stopPropagation()}>
                ...
                ${(()=>{const v=this._selectedIndex,P=this._getVolumeEntity(v);if(!P)return y;const G=P.startsWith&&P.startsWith("remote."),N=this.currentVolumeStateObj,F=Number(N?.attributes?.volume_level??0),Se=G?null:`${Math.round((F||0)*100)}%`;return this.config.volume_mode==="hidden"?y:m`
        ...
        `:y}
          ${this._searchActiveOptionsItem?Io({item:this._searchActiveOptionsItem,onClose:()=>{this._searchActiveOptionsItem=null,this.requestUpdate()},onPlayOption:(v,P)=>this._performSearchOptionAction(v,P),massQueueAvailable:this._massQueueAvailable}):y}
