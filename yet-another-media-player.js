 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */const{I:Rl}=zl,Pr=i=>i,Ol=i=>i.strings===void 0,zr=()=>document.createComment(""),si=(i,e,t)=>{const a=i._$AA.parentNode,s=e===void 0?i._$AB:e._$AA;if(t===void 0){const r=a.insertBefore(zr(),s),n=a.insertBefore(zr(),s);t=new Rl(r,n,i,i.options)}else{const r=t._$AB.nextSibling,n=t._$AM,o=n!==i;if(o){let l;t._$AQ?.(i),t._$AM=i,t._$AP!==void 0&&(l=i._$AU)!==n._$AU&&t._$AP(l)}if(r!==s||o){let l=t._$AA;for(;l!==r;){const c=Pr(l).nextSibling;Pr(a).insertBefore(l,s),l=c}}}return t},ct=(i,e,t=i)=>(i._$AI(e,t),i),Ll={},ql=(i,e=Ll)=>i._$AH=e,Nl=i=>i._$AH,Na=i=>{i._$AR(),i._$AA.remove()};/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const ri=(i,e)=>{const t=i._$AN;if(t===void 0)return!1;for(const a of t)a._$AO?.(e,!1),ri(a,e);return!0},Li=i=>{let e,t;do{if((e=i._$AM)===void 0)break;t=e._$AN,t.delete(i),i=e}while(t?.size===0)},jr=i=>{for(let e;e=i._$AM;i=e){let t=e._$AN;if(t===void 0)e._$AN=t=new Set;else if(t.has(i))break;t.add(i),Bl(e)}};function Vl(i){this._$AN!==void 0?(Li(this),this._$AM=i,jr(this)):this._$AM=i}function Ul(i,e=!1,t=0){const a=this._$AH,s=this._$AN;if(s!==void 0&&s.size!==0)if(e)if(Array.isArray(a))for(let r=t;r<a.length;r++)ri(a[r],!1),Li(a[r]);else a!=null&&(ri(a,!1),Li(a));else ri(this,i)}const Bl=i=>{i.type==Oi.CHILD&&(i._$AP??=Ul,i._$AQ??=Vl)};class Hl extends qa{constructor(){super(...arguments),this._$AN=void 0}_$AT(e,t,a){super._$AT(e,t,a),jr(this),this.isConnected=e._$AU}_$AO(e,t=!0){e!==this.isConnected&&(this.isConnected=e,e?this.reconnected?.():this.disconnected?.()),t&&(ri(this,e),Li(this))}setValue(e){if(Ol(this._$Ct))this._$Ct._$AI(e,this);else{const t=[...this._$Ct._$AH];t[this._$Ci]=e,this._$Ct._$AI(t,this,0)}}disconnected(){}reconnected(){}}/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Dr=(i,e,t)=>{const a=new Map;for(let s=e;s<=t;s++)a.set(i[s],s);return a},Gl=La(class extends qa{constructor(i){if(super(i),i.type!==Oi.CHILD)throw Error("repeat() can only be used in text expressions")}dt(i,e,t){let a;t===void 0?t=e:e!==void 0&&(a=e);const s=[],r=[];let n=0;for(const o of i)s[n]=a?a(o,n):n,r[n]=t(o,n),n++;return{values:r,keys:s}}render(i,e,t){return this.dt(i,e,t).values}update(i,[e,t,a]){const s=Nl(i),{values:r,keys:n}=this.dt(e,t,a);if(!Array.isArray(s))return this.ut=n,r;const o=this.ut??=[],l=[];let c,d,h=0,p=s.length-1,_=0,m=r.length-1;for(;h<=p&&_<=m;)if(s[h]===null)h++;else if(s[p]===null)p--;else if(o[h]===n[_])l[_]=ct(s[h],r[_]),h++,_++;else if(o[p]===n[m])l[m]=ct(s[p],r[m]),p--,m--;else if(o[h]===n[m])l[m]=ct(s[h],r[m]),si(i,l[m+1],s[h]),h++,m--;else if(o[p]===n[_])l[_]=ct(s[p],r[_]),si(i,s[h],s[p]),p--,_++;else if(c===void 0&&(c=Dr(n,_,m),d=Dr(o,h,p)),c.has(o[h]))if(c.has(o[p])){const f=d.get(n[_]),y=f!==void 0?s[f]:null;if(y===null){const b=si(i,s[h]);ct(b,r[_]),l[_]=b}else l[_]=ct(y,r[_]),si(i,s[h],y),s[f]=null;_++}else Na(s[p]),p--;else Na(s[h]),h++;for(;_<=m;){const f=si(i,l[m+1]);ct(f,r[_]),l[_++]=f}for(;h<=p;){const f=s[h++];f!==null&&Na(f)}return this.ut=n,ql(i,l),qe}});/**
 * @license
...
${i.mark.snippet}`),`${i.reason} ${t}`):i.reason}var di=class extends Error{constructor(e,t){super();ce(this,"reason");ce(this,"mark");this.name="YAMLException",this.reason=e,this.mark=t,this.message=yn(this,!1),Error.captureStackTrace&&Error.captureStackTrace(this,this.constructor)}toString(e){return`${this.name}: ${yn(this,e)}`}};function Ji(i,e,t,a=""){let s=0,r=0;for(let o=0;o<e;o++){const l=i.charCodeAt(o);l===10?(s++,r=o+1):l===13&&(s++,i.charCodeAt(o+1)===10&&o++,r=o+1)}const n={name:a,buffer:i,position:e,line:s,column:e-r};throw n.snippet=Xd(n),new di(t,n)}var eu=-1;function vn(i){switch(i){case 48:return"\0";case 97:return"\x07";case 98:return"\b";case 116:return"	";case 9:return"	";case 110:return`
        ...
        >
          <div>
            <ha-selector
              ...
              .selector=${{select:{mode:"dropdown",options:Object.keys(ni).map(s=>({value:s,label:u(`editor.templates.${s}.label`)}))}}}
              .value=${e}
        ...
        <ha-card class="yamp-card" 
          ...
          >
            ${ka&&cr?g`
              ...
              ${Ys||Xt||this._isIdle?v:g`<div class="full-bleed-artwork-fade"></div>`}
            `:v}
            ${!wt&&!le&&!ue?g`
            ...
            <div class="card-lower-content-container" style="${nr?`min-height:${nr}px;`:""}">
              ...
              ></div>
              ${Ys||Xt||this._isIdle?v:g`<div class="card-lower-fade"></div>`}
            ...
            ${rr?g`
              <div class="persistent-media-controls" @click=${x=>x.stopPropagation()}>
                <div class="persistent-controls-artwork">
                  ${(()=>{const x=we;return x?.url&&li(x.url)?g`
