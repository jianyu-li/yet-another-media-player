...
class YetAnotherMediaPlayerEditor extends i$1 {
  ...
  _renderVisualTab() {
    var _this$_config$volume_, _this$_config$match_t, _this$_config$alterna, _this$_config$card_he, _this$_config$control, _this$_config$adaptiv, _this$_config$hide_ac, _this$_config$volume_2, _this$_config$collaps, _this$_config$hide_me, _this$_config$always_, _this$_config$expand_, _this$_config$idle_sc;
