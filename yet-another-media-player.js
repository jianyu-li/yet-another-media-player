...
var _templateObject$9, _templateObject2$8, _templateObject3$6, _templateObject4$5, _templateObject5$5, _templateObject6$4, _templateObject7$4, _templateObject8$4, _templateObject9$4, _templateObject0$4, _templateObject1$3;
...
function renderGroupChip(_ref3) {
  ...
  }) : x(_templateObject8$4 || (_templateObject8$4 = _taggedTemplateLiteral(["<ha-icon .icon=", "\n                          style=\"font-size:28px;cursor:pointer;\"\n                          @click=", "></ha-icon>"])), icon, e => {
    e.stopPropagation();
    if (onIconClick) {
      onIconClick(idx, e);
    }
  }), groupName, pinned ? x(_templateObject9$4 || (_templateObject9$4 = _taggedTemplateLiteral(["\n            <span class=\"chip-pin-inside\" @click=", " title=\"Unpin\">\n              <ha-icon .icon=", "></ha-icon>\n            </span>\n          "])), e => {
    e.stopPropagation();
    onPinClick(idx, e);
  }, "mdi:pin") : x(_templateObject0$4 || (_templateObject0$4 = _taggedTemplateLiteral(["<span class=\"chip-pin-spacer\"></span>"]))));
}
...
function renderChipRow(_ref5) {
  ...
  return x(_templateObject1$3 || (_templateObject1$3 = _taggedTemplateLiteral(["\n    ", "\n  "])), groupedSortedEntityIds.map(group => {
...
function renderActionChipRow(_ref) {
  ...
  return x(_templateObject$8 || (_templateObject$8 = _taggedTemplateLiteral(["\n    <div class=\"action-chip-row\">\n      ", "\n    </div>\n  "])), actions.map((a, idx) => x(_templateObject2$7 || (_templateObject2$7 = _taggedTemplateLiteral(["\n          <button class=\"action-chip\" @click=", ">\n            ", "\n            ", "\n          </button>\n        "])), () => onActionChipClick(idx), a.icon ? x(_templateObject3$5 || (_templateObject3$5 = _taggedTemplateLiteral(["<ha-icon .icon=", " style=\"font-size: 22px; margin-right: ", ";\"></ha-icon>"])), a.icon, a.name ? '8px' : '0') : E, a.name || "")));
}

var _templateObject$7, _templateObject2$6, _templateObject3$4, _templateObject4$4, _templateObject5$4, _templateObject6$3, _templateObject7$3, _templateObject8$3, _templateObject9$3, _templateObject0$3, _templateObject1$2, _templateObject10$2, _templateObject11$2, _templateObject12$2, _templateObject13$2;
...
var _templateObject$6, _templateObject2$5, _templateObject3$3, _templateObject4$3, _templateObject5$3;
function renderVolumeRow(_ref) {
  ...
  return x(_templateObject$6 || (_templateObject$6 = _taggedTemplateLiteral(["\n    <div class=\"volume-row\">\n      ", "\n      ", "\n      ", "\n    </div>\n  "])), isRemoteVolumeEntity ? x(_templateObject2$5 || (_templateObject2$5 = _taggedTemplateLiteral(["\n            <div class=\"vol-stepper\">\n              <button class=\"button\" @click=", " title=\"Vol Down\">\u2013</button>\n              <button class=\"button\" @click=", " title=\"Vol Up\">+</button>\n            </div>\n          "])), () => onVolumeStep(-1), () => onVolumeStep(1)) : showSlider ? x(_templateObject3$3 || (_templateObject3$3 = _taggedTemplateLiteral(["\n            <div class=\"volume-controls\">\n              ", "\n              <button \n                class=\"volume-icon-btn\" \n                @click=", " \n                title=", "\n              >\n                <ha-icon icon=", "></ha-icon>\n              </button>\n              <div class=\"volume-slider-container\">\n                <input\n                  class=\"vol-slider\"\n                  type=\"range\"\n                  min=\"0\"\n                  max=\"1\"\n                  step=\"0.01\"\n                  .value=", "\n                  @mousedown=", "\n                  @touchstart=", "\n                  @change=", "\n                  @mouseup=", "\n                  @touchend=", "\n                  title=\"Volume\"\n                />\n              </div>\n            </div>\n          "])), leadingControlTemplate || E, onMuteToggle, (supportsMute ? isMuted : vol === 0) ? "Unmute" : "Mute", getVolumeIcon(vol, isMuted), vol, onVolumeDragStart, onVolumeDragStart, onVolumeChange, onVolumeDragEnd, onVolumeDragEnd) : x(_templateObject4$3 || (_templateObject4$3 = _taggedTemplateLiteral(["\n            <div class=\"vol-stepper\">\n              <button class=\"button\" @click=", " title=\"Vol Down\">\u2013</button>\n              <span>", "%</span>\n              <button class=\"button\" @click=", " title=\"Vol Up\">+</button>\n            </div>\n          "])), () => onVolumeStep(-1), Math.round(vol * 100), () => onVolumeStep(1)), showRightPlaceholder ? x(_templateObject5$3 || (_templateObject5$3 = _taggedTemplateLiteral(["\n        <div class=\"volume-placeholder\">\n          ", "\n        </div>\n      "])), rightSlotTemplate || E) : E, moreInfoMenu);
}
  ...
  if (configEntryId) {
    try {
      ...
      if (response) {
        ...
        const flatResults = [];
        Object.entries(response).forEach(_ref2 => {
          let [mediaType, items] = _ref2;
  ...
  try {
    ...
    if (!targetEntityId) {
      ...
      const maEntity = states.find(state => {
        ...
        return ((_state$attributes = state.attributes) === null || _state$attributes === void 0 ? void 0 : _state$attributes.app_id) === 'music_assistant' && state.entity_id.startsWith('media_player.');
      });
      if (maEntity) {
...
class YampSortable extends i$1 {
...
var _templateObject$1, _templateObject2$1, _templateObject3$1, _templateObject4$1, _templateObject5$1, _templateObject6$1, _templateObject7$1, _templateObject8$1, _templateObject9$1, _templateObject0$1, _templateObject1$1, _templateObject10$1, _templateObject11$1, _templateObject12$1, _templateObject13$1, _templateObject14$1, _templateObject15$1, _templateObject16$1, _templateObject17$1, _templateObject18$1, _templateObject19$1, _templateObject20$1, _templateObject21$1, _templateObject22$1, _templateObject23$1, _templateObject24$1, _templateObject25$1, _templateObject26$1, _templateObject27$1, _templateObject28$1, _templateObject29$1, _templateObject30$1, _templateObject31$1, _templateObject32$1, _templateObject33$1, _templateObject34$1, _templateObject35$1, _templateObject36$1, _templateObject37$1, _templateObject38$1, _templateObject39$1, _templateObject40$1, _templateObject41$1, _templateObject42$1, _templateObject43$1, _templateObject44$1, _templateObject45$1;
...
class YetAnotherMediaPlayerEditor extends i$1 {
  ...
  render() {
    ...
    return x(_templateObject3$1 || (_templateObject3$1 = _taggedTemplateLiteral(["\n        <div class=\"tabs\">\n          ", "\n        </div>\n        <div class=\"tab-content\">\n          ", "\n        </div>\n      "])), ["Entities", "Behavior", "Look and Feel", "Artwork", "Actions"].map(name => x(_templateObject4$1 || (_templateObject4$1 = _taggedTemplateLiteral(["\n            <button\n              class=\"tab\" ", "\n              @click=", "\n              ?selected=", "\n            >", "</button>\n          "])), this._activeTab === name ? 'selected' : '', () => {
  ...
  _renderEntitiesTab() {
    ...
    if (!this._config) return x(_templateObject11$1 || (_templateObject11$1 = _taggedTemplateLiteral([""])));
    ...
    return x(_templateObject12$1 || (_templateObject12$1 = _taggedTemplateLiteral(["\n        <div class=\"entity-group\">\n          <div class=\"entity-group-header section-header\">\n            <div class=\"entity-group-title section-title\">Entities*</div>\n            <div class=\"section-description\">Add the media players you want to control. Drag entities to reorder the chip row.</div>\n          </div>\n          <div class=\"form-row\">\n            <yamp-sortable @item-moved=", ">\n              <div class=\"sortable-container\">\n                ", "\n              </div>\n            </yamp-sortable>\n          </div>\n        </div>\n      "])), e => this._onEntityMoved(e), entities.map((ent, idx) => {
      var _this$_config$entitie4, _this$_config$entitie5;
      return x(_templateObject13$1 || (_templateObject13$1 = _taggedTemplateLiteral(["\n                  <div class=\"entity-row-inner ", "\" data-index=\"", "\">\n                    <div class=\"handle ", "\">\n                      <ha-icon icon=\"mdi:drag\"></ha-icon>\n                    </div>\n                    <div class=\"grow-children\">\n                      ", "\n                    </div>\n                    <div class=\"entity-row-actions\">\n                      <ha-icon\n                        class=\"icon-button ", "\"\n                        icon=\"mdi:pencil\"\n                        title=\"Edit Entity Settings\"\n                        @click=", "\n                      ></ha-icon>\n                    </div>\n                  </div>\n                "])), idx < entities.length - 1 ? 'sortable-item' : '', idx, idx === entities.length - 1 ? 'handle-disabled' : '', idx === entities.length - 1 && !ent.entity_id ? x(_templateObject14$1 || (_templateObject14$1 = _taggedTemplateLiteral(["\n                            <ha-entity-picker\n                              .hass=", "\n                              .value=", "\n                              .includeDomains=", "\n                              .excludeEntities=", "\n                              clearable\n                              @value-changed=", "\n                            ></ha-entity-picker>\n                          "])), this.hass, ent.entity_id, ["media_player"], (_this$_config$entitie4 = (_this$_config$entitie5 = this._config.entities) === null || _this$_config$entitie5 === void 0 ? void 0 : _this$_config$entitie5.map(e => e.entity_id)) !== null && _this$_config$entitie4 !== void 0 ? _this$_config$entitie4 : [], e => this._onEntityChanged(idx, e.detail.value)) : x(_templateObject15$1 || (_templateObject15$1 = _taggedTemplateLiteral(["\n                            <ha-selector\n                              .hass=", "\n                              .selector=", "\n                              .value=", "\n                              clearable\n                              @value-changed=", "\n                            ></ha-selector>\n                          "])), this.hass, {
        entity: {
          domain: "media_player"
        }
      }, ent.entity_id, e => this._onEntityChanged(idx, e.detail.value)), !ent.entity_id ? "icon-button-disabled" : "", () => this._onEditEntity(idx));
    }));
  }
  _renderBehaviorTab() {
    ...
    }, (_this$_config$idle_ti = this._config.idle_timeout_ms) !== null && _this$_config$idle_ti !== void 0 ? _this$_config$idle_ti : 60000, e => this._updateConfig("idle_timeout_ms", e.detail.value), () => this._updateConfig("idle_timeout_ms", 60000), this.hass, {
      select: {
        mode: "dropdown",
        options: [{
          value: "auto",
    ...
    }, (_this$_config$search_ = this._config.search_results_limit) !== null && _this$_config$search_ !== void 0 ? _this$_config$search_ : 20, e => this._updateConfig("search_results_limit", e.detail.value), searchLimitWarningActive ? x(_templateObject17$1 || (_templateObject17$1 = _taggedTemplateLiteral(["\n                  <div class=\"config-subtitle warning\">\n                    Warning: requesting higher results can cause performance issues.\n                  </div>\n                "]))) : E, () => this._updateConfig("search_results_limit", 20), this.hass, {
      select: {
        mode: "dropdown",
        options: [{
          value: "default",
    ...
    }, (_this$_config$search_2 = this._config.search_results_sort) !== null && _this$_config$search_2 !== void 0 ? _this$_config$search_2 : "default", e => this._updateConfig("search_results_sort", e.detail.value));
  }
  _renderVisualTab() {
    var _this$_config$volume_, _this$_config$match_t, _this$_config$alterna, _this$_config$card_he, _this$_config$control, _this$_config$control2, _this$_config$swap_pa, _this$_config$adaptiv, _this$_config$hide_ac, _this$_config$volume_2, _this$_config$collaps, _this$_config$hide_me, _this$_config$always_, _this$_config$expand_, _this$_config$idle_sc;
    const renderVolumeStep = this._config.volume_mode === "stepper" ? x(_templateObject18$1 || (_templateObject18$1 = _taggedTemplateLiteral(["\n          <div class=\"form-row form-row-multi-column\">\n            <div class=\"grow-children\">\n              <ha-selector\n                .hass=", "\n                .selector=", "\n                .value=", "\n                label=\"Volume Step (0.05 = 5%)\"\n                @value-changed=", "\n              ></ha-selector>\n            </div>\n            <ha-icon\n              class=\"icon-button\"\n              icon=\"mdi:restore\"\n              title=\"Reset to default\"\n              @click=", "\n            ></ha-icon>\n          </div>\n        "])), this.hass, {
      number: {
        min: 0.01,
        max: 1,
        step: 0.01,
    ...
    }, () => this._updateConfig("card_height", undefined), this.hass, {
      select: {
        mode: "dropdown",
        options: [{
          value: "classic",
    ...
    }, (_this$_config$control = this._config.control_layout) !== null && _this$_config$control !== void 0 ? _this$_config$control : "classic", e => this._updateConfig("control_layout", e.detail.value), ((_this$_config$control2 = this._config.control_layout) !== null && _this$_config$control2 !== void 0 ? _this$_config$control2 : "classic") === "modern" ? x(_templateObject20$1 || (_templateObject20$1 = _taggedTemplateLiteral(["\n            <div class=\"form-row\">\n              <div>\n                <ha-switch\n                  .checked=", "\n                  @change=", "\n                ></ha-switch>\n                <span>Swap Play/Pause with Stop</span>\n              </div>\n              <div class=\"config-subtitle\">Replace the central play/pause button with stop while using the modern layout.</div>\n            </div>\n          "])), (_this$_config$swap_pa = this._config.swap_pause_for_stop) !== null && _this$_config$swap_pa !== void 0 ? _this$_config$swap_pa : false, e => this._updateConfig("swap_pause_for_stop", e.target.checked)) : E, (_this$_config$adaptiv = this._config.adaptive_controls) !== null && _this$_config$adaptiv !== void 0 ? _this$_config$adaptiv : false, e => this._updateConfig("adaptive_controls", e.target.checked), (_this$_config$hide_ac = this._config.hide_active_entity_label) !== null && _this$_config$hide_ac !== void 0 ? _this$_config$hide_ac : false, e => this._updateConfig("hide_active_entity_label", e.target.checked), this.hass, {
      select: {
        multiple: true,
    ...
    }, (_this$_config$volume_2 = this._config.volume_mode) !== null && _this$_config$volume_2 !== void 0 ? _this$_config$volume_2 : "slider", e => this._updateConfig("volume_mode", e.detail.value), renderVolumeStep, (_this$_config$collaps = this._config.collapse_on_idle) !== null && _this$_config$collaps !== void 0 ? _this$_config$collaps : false, e => this._updateConfig("collapse_on_idle", e.target.checked), !this._config.always_collapsed ? x(_templateObject21$1 || (_templateObject21$1 = _taggedTemplateLiteral(["\n              <div>\n                <ha-switch\n                  id=\"hide-menu-player-toggle\"\n                  .checked=", "\n                  @change=", "\n                ></ha-switch>\n                <span>Hide Menu Player</span>\n              </div>\n            "])), (_this$_config$hide_me = this._config.hide_menu_player) !== null && _this$_config$hide_me !== void 0 ? _this$_config$hide_me : false, e => this._updateConfig("hide_menu_player", e.target.checked)) : E, (_this$_config$always_ = this._config.always_collapsed) !== null && _this$_config$always_ !== void 0 ? _this$_config$always_ : false, e => this._updateConfig("always_collapsed", e.target.checked), this._config.always_collapsed ? x(_templateObject22$1 || (_templateObject22$1 = _taggedTemplateLiteral(["\n              <div>\n                <ha-switch\n                  id=\"expand-on-search-toggle\"\n                  .checked=", "\n                  @change=", "\n                ></ha-switch>\n                <span>Expand on Search</span>\n              </div>\n            "])), (_this$_config$expand_ = this._config.expand_on_search) !== null && _this$_config$expand_ !== void 0 ? _this$_config$expand_ : false, e => this._updateConfig("expand_on_search", e.target.checked)) : E, this.hass, {
      select: {
        mode: "dropdown",
        options: [{
          value: "default",
    ...
    }, (_this$_config$idle_sc = this._config.idle_screen) !== null && _this$_config$idle_sc !== void 0 ? _this$_config$idle_sc : "default", e => this._updateConfig("idle_screen", e.detail.value));
  }
  _renderActionsTab() {
    ...
    return x(_templateObject23$1 || (_templateObject23$1 = _taggedTemplateLiteral(["\n        <div class=\"action-group config-section\">\n          <div class=\"action-group-header section-header\">\n            <div class=\"action-group-title section-title\">Actions</div>\n            <div class=\"section-description\">Build the action chips that appear in the card or its menu. Drag to reorder, click the pencil to configure each action.</div>\n          </div>\n          <div class=\"form-row\">\n            <yamp-sortable @item-moved=", ">\n              <div class=\"sortable-container\">\n                ", "\n              </div>\n            </yamp-sortable>\n          </div>\n          <div class=\"add-action-button-wrapper\">\n            <ha-icon\n              class=\"icon-button\"\n              icon=\"mdi:plus\"\n              title=\"Add Action\"\n              @click=", "\n            ></ha-icon>\n          </div>\n        </div>\n      "])), e => this._onActionMoved(e), actions.map((act, idx) => {
      ...
      })(), true, a => this._onActionChanged(idx, a.target.value), () => this._onEditAction(idx), act !== null && act !== void 0 && act.in_menu ? "active" : "", act !== null && act !== void 0 && act.in_menu ? "mdi:menu" : "mdi:view-grid-outline", act !== null && act !== void 0 && act.in_menu ? "Move action to main chips" : "Move action into menu", act !== null && act !== void 0 && act.in_menu ? "Move action to main chips" : "Move action into menu", () => this._toggleActionInMenu(idx), () => this._removeAction(idx));
    }), () => {
  ...
  _renderEntityEditor(entity) {
    var _this$hass2, _entity$entity_id, _entity$name, _this$_useTemplate, _entity$music_assista, _entity$music_assista2, _this$_useTemplate2, _this$_useTemplate3, _entity$music_assista3, _entity$music_assista4, _entity$group_volume, _entity$follow_active, _entity$follow_active2, _this$_useVolTemplate, _entity$follow_active3, _this$_useVolTemplate2, _entity$volume_entity, _entity$volume_entity2, _entity$entity_id2, _entity$follow_active4, _entity$sync_power;
    ...
    return x(_templateObject27$1 || (_templateObject27$1 = _taggedTemplateLiteral(["\n        <div class=\"entity-editor-header\">\n          <ha-icon\n            class=\"icon-button\"\n            icon=\"mdi:chevron-left\"\n            @click=", ">\n          </ha-icon>\n          <div class=\"entity-editor-title\">Edit Entity</div>\n        </div>\n\n        <div class=\"form-row\">\n          <ha-selector\n            .hass=", "\n            .selector=", "\n            .value=", "\n          \n            disabled\n          ></ha-selector>\n        </div>\n\n        <div class=\"form-row\">\n          <ha-textfield\n            class=\"full-width\"\n            label=\"Name\"\n            .value=", "\n            @input=", "\n          ></ha-textfield>\n        </div>\n\n        <div class=\"form-row\">\n          <ha-selector\n            .hass=", "\n            .selector=", "\n            .value=", "\n            .required=", "\n            .invalid=", "\n            label=\"Hidden Controls\"\n            helper=\"Select which controls to hide for this entity (all are shown by default)\"\n            @value-changed=", "\n          ></ha-selector>\n        </div>\n\n        ", "\n\n \n\n        <div class=\"form-row form-row-multi-column\">\n          <div>\n            <ha-switch\n              id=\"ma-template-toggle\"\n              .checked=", "\n              @change=", "\n            ></ha-switch>\n            <label for=\"ma-template-toggle\">Use template for Music Assistant Entity</label>\n          </div>\n        </div>\n\n        ", "\n\n \n\n        ", "\n\n        <div class=\"form-row form-row-multi-column\">\n          <div>\n            <ha-switch\n              id=\"follow-active-toggle\"\n              .checked=", "\n              @change=", "\n            ></ha-switch>\n            <label for=\"follow-active-toggle\">Volume Entity Follows Active Entity</label>\n          </div>\n          ", "\n        </div>\n\n        ", "\n\n        ", "\n\n        ", "\n        </div>\n      "])), this._onBackFromEntityEditor, this.hass, {
    ...
    }, Array.isArray(entity === null || entity === void 0 ? void 0 : entity.hidden_controls) ? entity.hidden_controls : [], false, false, e => this._updateEntityProperty("hidden_controls", e.detail.value), ((_this$_useTemplate = this._useTemplate) !== null && _this$_useTemplate !== void 0 ? _this$_useTemplate : this._looksLikeTemplate(entity === null || entity === void 0 ? void 0 : entity.music_assistant_entity)) ? x(_templateObject28$1 || (_templateObject28$1 = _taggedTemplateLiteral(["\n      <div class=\"form-row\">\n        <div class=", ">\n          <ha-code-editor\n            id=\"ma-template-editor\"\n            label=\"Music Assistant Entity Template (Jinja)\"\n            .hass=", "\n            mode=\"jinja2\"\n            autocomplete-entities\n            .value=", "\n            @value-changed=", "\n          ></ha-code-editor>\n          <div class=\"help-text\">\n            <ha-icon icon=\"mdi:information-outline\"></ha-icon>\n            Enter a Jinja template that resolves to a single entity_id. Example switching MA based on a source selector:\n            <pre style=\"margin:6px 0; white-space:pre-wrap;\">{% if is_state('input_select.kitchen_stream_source','Music Stream 1') %}\n  media_player.picore_house\n{% else %}\n  media_player.ma_wiim_mini\n{% endif %}</pre>\n           </pre>\n          </div>\n        </div>\n      </div>\n    "])), this._yamlError && ((_entity$music_assista = entity === null || entity === void 0 ? void 0 : entity.music_assistant_entity) !== null && _entity$music_assista !== void 0 ? _entity$music_assista : "").trim() !== "" ? "code-editor-wrapper error" : "code-editor-wrapper", this.hass, (_entity$music_assista2 = entity === null || entity === void 0 ? void 0 : entity.music_assistant_entity) !== null && _entity$music_assista2 !== void 0 ? _entity$music_assista2 : "", e => this._updateEntityProperty("music_assistant_entity", e.detail.value)) : E, (_this$_useTemplate2 = this._useTemplate) !== null && _this$_useTemplate2 !== void 0 ? _this$_useTemplate2 : this._looksLikeTemplate(entity === null || entity === void 0 ? void 0 : entity.music_assistant_entity), e => {
      this._useTemplate = e.target.checked;
    }, ((_this$_useTemplate3 = this._useTemplate) !== null && _this$_useTemplate3 !== void 0 ? _this$_useTemplate3 : this._looksLikeTemplate(entity === null || entity === void 0 ? void 0 : entity.music_assistant_entity)) ? x(_templateObject29$1 || (_templateObject29$1 = _taggedTemplateLiteral(["\n      <div class=\"form-row\">\n        <div class=", ">\n          <ha-code-editor\n            id=\"ma-template-editor\"\n            label=\"Music Assistant Entity Template (Jinja)\"\n            .hass=", "\n            mode=\"jinja2\"\n            autocomplete-entities\n            .value=", "\n            @value-changed=", "\n          ></ha-code-editor>\n          <div class=\"help-text\">\n            <ha-icon icon=\"mdi:information-outline\"></ha-icon>\n            Enter a Jinja template that resolves to a single entity_id. Example switching MA based on a source selector:\n            <pre style=\"margin:6px 0; white-space:pre-wrap;\">{% if is_state('input_select.kitchen_stream_source','Music Stream 1') %}\n  media_player.picore_house\n{% else %}\n  media_player.ma_wiim_mini\n{% endif %}</pre>\n           </pre>\n          </div>\n        </div>\n      </div>\n    "])), this._yamlError && ((_entity$music_assista3 = entity === null || entity === void 0 ? void 0 : entity.music_assistant_entity) !== null && _entity$music_assista3 !== void 0 ? _entity$music_assista3 : "").trim() !== "" ? "code-editor-wrapper error" : "code-editor-wrapper", this.hass, (_entity$music_assista4 = entity === null || entity === void 0 ? void 0 : entity.music_assistant_entity) !== null && _entity$music_assista4 !== void 0 ? _entity$music_assista4 : "", e => this._updateEntityProperty("music_assistant_entity", e.detail.value)) : x(_templateObject30$1 || (_templateObject30$1 = _taggedTemplateLiteral(["\n      <div class=\"form-row\">\n        <ha-entity-picker\n          .hass=", "\n          .value=", "\n          .includeDomains=", "\n          label=\"Music Assistant Entity (optional)\"\n          helper=\"Pick a Music Assistant player for search.\"\n          clearable\n          @value-changed=", "\n        ></ha-entity-picker>\n      </div>\n      ", "\n    "])), this.hass, this._isEntityId(entity === null || entity === void 0 ? void 0 : entity.music_assistant_entity) ? entity.music_assistant_entity : "", ["media_player"], e => this._updateEntityProperty("music_assistant_entity", e.detail.value), ((_this$hass3, _mainState$attributes, _this$_looksLikeTempl, _this$hass4, _maState$attributes) => {
      ...
      }, Array.isArray(entity === null || entity === void 0 ? void 0 : entity.hidden_filter_chips) ? entity.hidden_filter_chips : [], false, false, e => this._updateEntityProperty("hidden_filter_chips", e.detail.value));
    })()), showGroupVolume ? x(_templateObject32$1 || (_templateObject32$1 = _taggedTemplateLiteral(["\n          <div class=\"form-row\">\n            <ha-switch\n              id=\"group-volume-toggle\"\n              .checked=", "\n              @change=", "\n            ></ha-switch>\n            <label for=\"group-volume-toggle\">Group Volume</label>\n          </div>\n        "])), (_entity$group_volume = entity === null || entity === void 0 ? void 0 : entity.group_volume) !== null && _entity$group_volume !== void 0 ? _entity$group_volume : true, e => this._updateEntityProperty("group_volume", e.target.checked)) : E, (_entity$follow_active = entity === null || entity === void 0 ? void 0 : entity.follow_active_volume) !== null && _entity$follow_active !== void 0 ? _entity$follow_active : false, e => this._updateEntityProperty("follow_active_volume", e.target.checked), !((_entity$follow_active2 = entity === null || entity === void 0 ? void 0 : entity.follow_active_volume) !== null && _entity$follow_active2 !== void 0 ? _entity$follow_active2 : false) ? x(_templateObject33$1 || (_templateObject33$1 = _taggedTemplateLiteral(["\n            <div>\n              <ha-switch\n                id=\"vol-template-toggle\"\n                .checked=", "\n                @change=", "\n              ></ha-switch>\n              <label for=\"vol-template-toggle\">Use template for Volume Entity</label>\n            </div>\n          "])), (_this$_useVolTemplate = this._useVolTemplate) !== null && _this$_useVolTemplate !== void 0 ? _this$_useVolTemplate : this._looksLikeTemplate(entity === null || entity === void 0 ? void 0 : entity.volume_entity), e => {
      this._useVolTemplate = e.target.checked;
    }) : E, !((_entity$follow_active3 = entity === null || entity === void 0 ? void 0 : entity.follow_active_volume) !== null && _entity$follow_active3 !== void 0 ? _entity$follow_active3 : false) ? x(_templateObject34$1 || (_templateObject34$1 = _taggedTemplateLiteral(["\n          ", "\n        "])), ((_this$_useVolTemplate2 = this._useVolTemplate) !== null && _this$_useVolTemplate2 !== void 0 ? _this$_useVolTemplate2 : this._looksLikeTemplate(entity === null || entity === void 0 ? void 0 : entity.volume_entity)) ? x(_templateObject35$1 || (_templateObject35$1 = _taggedTemplateLiteral(["\n                <div class=\"form-row\">\n                  <div class=", ">\n                    <ha-code-editor\n                      id=\"vol-template-editor\"\n                      label=\"Volume Entity Template (Jinja)\"\n                      .hass=", "\n                      mode=\"jinja2\"\n                      autocomplete-entities\n                      .value=", "\n                      @value-changed=", "\n                    ></ha-code-editor>\n                    <div class=\"help-text\">\n                      <ha-icon icon=\"mdi:information-outline\"></ha-icon>\n                      Enter a Jinja template that resolves to an entity_id (e.g. <code>media_player.office_homepod</code> or <code>remote.soundbar</code>).\n                      Example switching volume entity based on a boolean:\n                      <pre style=\"margin:6px 0; white-space:pre-wrap;\">{% if is_state('input_boolean.tv_volume','on') %}\n  remote.soundbar\n{% else %}\n  media_player.office_homepod\n{% endif %}</pre>\n                    </div>\n                  </div>\n                </div>\n              "])), this._yamlError && ((_entity$volume_entity = entity === null || entity === void 0 ? void 0 : entity.volume_entity) !== null && _entity$volume_entity !== void 0 ? _entity$volume_entity : "").trim() !== "" ? "code-editor-wrapper error" : "code-editor-wrapper", this.hass, (_entity$volume_entity2 = entity === null || entity === void 0 ? void 0 : entity.volume_entity) !== null && _entity$volume_entity2 !== void 0 ? _entity$volume_entity2 : "", e => this._updateEntityProperty("volume_entity", e.detail.value)) : x(_templateObject36$1 || (_templateObject36$1 = _taggedTemplateLiteral(["\n                <div class=\"form-row\">\n                  <ha-entity-picker\n                    .hass=", "\n                    .value=", "\n                    .includeDomains=", "\n                    label=\"Volume Entity\"\n                    clearable\n                    @value-changed=", "\n                  ></ha-entity-picker>\n                </div>\n              "])), this.hass, this._isEntityId(entity === null || entity === void 0 ? void 0 : entity.volume_entity) ? entity.volume_entity : (_entity$entity_id2 = entity === null || entity === void 0 ? void 0 : entity.entity_id) !== null && _entity$entity_id2 !== void 0 ? _entity$entity_id2 : "", ["media_player", "remote"], e => {
      const value = e.detail.value;
    ...
    })) : E, entity !== null && entity !== void 0 && entity.volume_entity && entity.volume_entity !== entity.entity_id && !((_entity$follow_active4 = entity === null || entity === void 0 ? void 0 : entity.follow_active_volume) !== null && _entity$follow_active4 !== void 0 ? _entity$follow_active4 : false) ? x(_templateObject37$1 || (_templateObject37$1 = _taggedTemplateLiteral(["\n              <div class=\"form-row form-row-multi-column\">\n                <div>\n                  <ha-switch\n                    id=\"sync-power-toggle\"\n                    .checked=", "\n                    @change=", "\n                  ></ha-switch>\n                  <label for=\"sync-power-toggle\">Sync Power</label>\n                </div>\n              </div>\n            "])), (_entity$sync_power = entity === null || entity === void 0 ? void 0 : entity.sync_power) !== null && _entity$sync_power !== void 0 ? _entity$sync_power : false, e => this._updateEntityProperty("sync_power", e.target.checked)) : E, entity !== null && entity !== void 0 && entity.follow_active_volume ? x(_templateObject38$1 || (_templateObject38$1 = _taggedTemplateLiteral(["\n          <div class=\"form-row\">\n            <div class=\"help-text\">\n              <ha-icon icon=\"mdi:information-outline\"></ha-icon>\n              When enabled, the volume entity will automatically follow the active playback entity. Note: This overrides the selected volume entity.\n              <br><br>\n             \n            </div>\n          </div>\n        "]))) : E);
  }
  _renderActionEditor(action) {
    var _this$_actionMode, _action$name, _action$icon, _this$_actionMode2, _action$menu_item, _action$navigation_pa, _action$navigation_ne, _action$service, _this$_serviceItems, _action$script_variab;
    ...
    return x(_templateObject39$1 || (_templateObject39$1 = _taggedTemplateLiteral(["\n        <div class=\"action-editor-header\">\n          <ha-icon\n            class=\"icon-button\"\n            icon=\"mdi:chevron-left\"\n            @click=", ">\n          </ha-icon>\n          <div class=\"action-editor-title\">Edit Action</div>\n        </div>\n\n        <div class=\"form-row\">\n          <ha-textfield\n            class=\"full-width\"\n            label=\"Name\"\n            placeholder=\"(Icon Only)\"\n            .value=", "\n            @input=", "\n          ></ha-textfield>\n        </div>\n\n        <div class=\"form-row\">\n          <ha-icon-picker\n            label=\"Icon\"\n            .hass=", "\n            .value=", "\n            @value-changed=", "\n          ></ha-icon-picker>\n        </div>\n\n        <div class=\"form-row\">\n          <ha-selector\n            .hass=", "\n            label=\"Action Type\"\n            .selector=", "\n            .value=", "\n            @value-changed=", "\n          ></ha-selector>\n        </div>\n        \n        ", " \n        ", "\n        ", "\n      </div>"])), this._onBackFromActionEditor, (_action$name = action === null || action === void 0 ? void 0 : action.name) !== null && _action$name !== void 0 ? _action$name : "", e => this._updateActionProperty("name", e.target.value), this.hass, (_action$icon = action === null || action === void 0 ? void 0 : action.icon) !== null && _action$icon !== void 0 ? _action$icon : "", e => this._updateActionProperty("icon", e.detail.value), this.hass, {
      select: {
        mode: "dropdown",
        options: [{
          value: "menu",
    ...
    }, actionMode === "menu" ? x(_templateObject40$1 || (_templateObject40$1 = _taggedTemplateLiteral(["\n          <div class=\"form-row\">\n            <ha-selector\n              .hass=", "\n              label=\"Menu Item\"\n              .selector=", "\n              .value=", "\n              @value-changed=", "\n            ></ha-selector>\n          </div>\n        "])), this.hass, {
      select: {
        mode: "dropdown",
        options: [{
          value: "",
    ...
    }, (_action$menu_item = action === null || action === void 0 ? void 0 : action.menu_item) !== null && _action$menu_item !== void 0 ? _action$menu_item : "", e => this._updateActionProperty("menu_item", e.detail.value || undefined)) : E, actionMode === "navigate" ? x(_templateObject41$1 || (_templateObject41$1 = _taggedTemplateLiteral(["\n          <div class=\"form-row\">\n            <ha-textfield\n              class=\"full-width\"\n              label=\"Navigation Path\"\n              placeholder=\"/lovelace/music or #popup\"\n              .value=", "\n              @input=", "\n            ></ha-textfield>\n          </div>\n          <div class=\"form-row form-row-multi-column\">\n            <div>\n              <ha-switch\n                id=\"navigation-new-tab-toggle\"\n                .checked=", "\n                @change=", "\n              ></ha-switch>\n              <label for=\"navigation-new-tab-toggle\">Open External URLs in New Tab</label>\n            </div>\n          </div>\n          <div class=\"form-row\">\n            <div class=\"config-subtitle\">Supports dashboard paths, URLs, and anchors (e.g., <code>/lovelace/music</code> or <code>#pop-up-menu</code>).</div>\n          </div>\n        "])), (_action$navigation_pa = action === null || action === void 0 ? void 0 : action.navigation_path) !== null && _action$navigation_pa !== void 0 ? _action$navigation_pa : "", e => {
      this._updateActionProperty("navigation_path", e.target.value);
      this._updateActionProperty("action", "navigate");
    }, (_action$navigation_ne = action === null || action === void 0 ? void 0 : action.navigation_new_tab) !== null && _action$navigation_ne !== void 0 ? _action$navigation_ne : false, e => this._updateActionProperty("navigation_new_tab", e.target.checked)) : E, actionMode === 'service' ? x(_templateObject42$1 || (_templateObject42$1 = _taggedTemplateLiteral(["\n          <div class=\"form-row\">\n            <ha-combo-box\n              label=\"Service\"\n              .hass=", "\n              .value=", "\n              .items=", "\n              item-value-path=\"value\"\n              item-label-path=\"label\"\n              required\n              @value-changed=", "\n            ></ha-combo-box>\n          </div>\n\n          ", "\n\n          ", "\n        "])), this.hass, (_action$service = action.service) !== null && _action$service !== void 0 ? _action$service : "", (_this$_serviceItems = this._serviceItems) !== null && _this$_serviceItems !== void 0 ? _this$_serviceItems : [], e => this._updateActionProperty("service", e.detail.value), typeof action.service === "string" && action.service.startsWith("script.") ? x(_templateObject43$1 || (_templateObject43$1 = _taggedTemplateLiteral(["\n            <div class=\"form-row form-row-multi-column\">\n              <div>\n                <ha-switch\n                  id=\"script-variable-toggle\"\n                  .checked=", "\n                  @change=", "\n                ></ha-switch>\n                <span>Script Variable (yamp_entity)</span>\n              </div>\n            </div>\n          "])), (_action$script_variab = action === null || action === void 0 ? void 0 : action.script_variable) !== null && _action$script_variab !== void 0 ? _action$script_variab : false, e => this._updateActionProperty("script_variable", e.target.checked)) : E, action.service ? x(_templateObject44$1 || (_templateObject44$1 = _taggedTemplateLiteral(["\n            <div class=\"help-text\">\n              <ha-icon\n                icon=\"mdi:information-outline\"\n              ></ha-icon>\n\n              Use <code>entity_id: current</code> to target the card's currently selected\n              media player entity. The <ha-icon icon=\"mdi:play-circle-outline\"></ha-icon> button\n              below does not work if you use this feature.\n\n            </div>\n            <div class=\"help-text\">\n              <ha-icon\n                icon=\"mdi:information-outline\"\n              ></ha-icon>\n            Changes to the service data below are not committed to the config until \n            <ha-icon icon=\"mdi:content-save\"></ha-icon> is clicked!\n            </div>\n            <div class=\"form-row\">\n              <div class=\"service-data-editor-header\">\n                <div class=\"service-data-editor-title\">Service Data</div>\n                <div class=\"service-data-editor-actions\">\n                  <ha-icon\n                    class=\"icon-button ", "\"\n                    icon=\"mdi:content-save\"\n                    title=\"Save Service Data\"\n                    @click=", "\n                  ></ha-icon>\n                  <ha-icon\n                    class=\"icon-button ", "\"\n                    icon=\"mdi:backup-restore\"\n                    title=\"Revert to Saved Service Data\"\n                    @click=", "\n                  ></ha-icon>\n                  <ha-icon\n\n                    class=\"icon-button ", "\"\n\n                    icon=\"mdi:play-circle-outline\"\n                    title=\"Test Action\"\n                    @click=", "\n                  ></ha-icon>              \n                </div>\n            </div>\n            <div class=", ">\n              <ha-code-editor\n                id=\"service-data-editor\"\n                label=\"Service Data\"\n                autocomplete-entities\n                autocomplete-icons\n                .hass=", "\n                mode=\"yaml\"\n                .value=", "\n                @value-changed=", "\n              ></ha-code-editor>\n              ", "\n            </div>\n          "])), !this._yamlModified ? "icon-button-disabled" : "", this._saveYamlEditor, !this._yamlModified ? "icon-button-disabled" : "", this._revertYamlEditor, this._yamlError || this._yamlDraftUsesCurrentEntity() || !(action !== null && action !== void 0 && action.service) ? "icon-button-disabled" : "", this._testServiceCall, this._yamlError && this._yamlDraft.trim() !== "" ? "code-editor-wrapper error" : "code-editor-wrapper", this.hass, action !== null && action !== void 0 && action.service_data ? jsYaml.dump(action.service_data) : "", e => {
    ...
    }, this._yamlError && this._yamlDraft.trim() !== "" ? x(_templateObject45$1 || (_templateObject45$1 = _taggedTemplateLiteral(["<div class=\"yaml-error-message\">", "</div>"])), this._yamlError) : E) : E) : E);
  }
  _onEntityChanged(index, newValue) {
    var _this$_config$entitie6;
    const original = (_this$_config$entitie6 = this._config.entities) !== null && _this$_config$entitie6 !== void 0 ? _this$_config$entitie6 : [];
  ...
  _onActionChanged(index, newValue) {
    ...
    const original = (_this$_config$actions5 = this._config.actions) !== null && _this$_config$actions5 !== void 0 ? _this$_config$actions5 : [];
    const updated = [...original];
    updated[index] = _objectSpread2$1(_objectSpread2$1({}, updated[index]), {}, {
      name: newValue
    });
  ...
  _onEditEntity(index) {
    var _this$_config$entitie7;
    this._entityEditorIndex = index;
    const ent = (_this$_config$entitie7 = this._config.entities) === null || _this$_config$entitie7 === void 0 ? void 0 : _this$_config$entitie7[index];
  ...
  _onEditAction(index) {
    ...
    const action = (_this$_config$actions6 = this._config.actions) === null || _this$_config$actions6 === void 0 ? void 0 : _this$_config$actions6[index];
  ...
  _removeAction(index) {
    ...
    const actions = [...((_this$_config$actions7 = this._config.actions) !== null && _this$_config$actions7 !== void 0 ? _this$_config$actions7 : [])];
  ...
  _revertYamlEditor() {
    ...
    const currentAction = (_this$_config$actions9 = this._config.actions) === null || _this$_config$actions9 === void 0 ? void 0 : _this$_config$actions9[this._actionEditorIndex];
  ...
  async _testServiceCall() {
    var _this$_yamlDraft, _this$_config$actions0;
    ...
    const action = (_this$_config$actions0 = this._config.actions) === null || _this$_config$actions0 === void 0 ? void 0 : _this$_config$actions0[this._actionEditorIndex];
...
class YetAnotherMediaPlayerCard extends i$1 {
  ...
  _getFavoriteButtonEntity() {
    var _this$hass, _activeState$attribut;
    ...
    if (!activeState || ((_activeState$attribut = activeState.attributes) === null || _activeState$attribut === void 0 ? void 0 : _activeState$attribut.app_id) !== 'music_assistant') {
      return null;
    }
  ...
  _getSearchResultsCountLabel() {
    ...
    return "".concat(count, " ").concat(noun);
  }
  async _doSearch() {
    var _this$config4;
  ...
  _snapshotPlaybackState(entityIds) {
    ...
    entityIds.forEach(id => {
      var _this$hass3, _stateObj$state, _stateObj$attributes$, _stateObj$attributes2, _stateObj$attributes$2, _stateObj$attributes3;
      const stateObj = id ? (_this$hass3 = this.hass) === null || _this$hass3 === void 0 || (_this$hass3 = _this$hass3.states) === null || _this$hass3 === void 0 ? void 0 : _this$hass3[id] : null;
      snapshot[id] = {
  ...
  async _waitForPlaybackChange(snapshot, entityIds) {
    ...
    while (Date.now() - start < timeout) {
      ...
      for (const id of entityIds) {
        var _this$hass4, _stateObj$attributes$3, _stateObj$attributes4, _stateObj$attributes$4, _stateObj$attributes5;
        if (!id) continue;
        const stateObj = (_this$hass4 = this.hass) === null || _this$hass4 === void 0 || (_this$hass4 = _this$hass4.states) === null || _this$hass4 === void 0 ? void 0 : _this$hass4[id];
  ...
  async _searchPlaylistTracks(playlistName) {
    ...
    this._searchBreadcrumb = "Tracks in ".concat(playlistName);
  ...
  _isClickableSearchResult(item) {
    ...
    if (item.media_class === 'album' && (this._searchHierarchy.length === 0 || this._searchHierarchy.length > 0 && this._searchHierarchy[this._searchHierarchy.length - 1].type === 'artist')) {
      return true;
    }
  ...
  _looksLikeMusicAssistantState(state) {
    var _state$attributes, _state$attributes2, _state$attributes3;
    if (!state) return false;
    return ((_state$attributes = state.attributes) === null || _state$attributes === void 0 ? void 0 : _state$attributes.app_id) === "music_assistant" || !!((_state$attributes2 = state.attributes) !== null && _state$attributes2 !== void 0 && _state$attributes2.mass_player_id) || !!((_state$attributes3 = state.attributes) !== null && _state$attributes3 !== void 0 && _state$attributes3.active_queue);
  }
  _getTransferQueueTargets() {
    var _this$hass5;
    if (!((_this$hass5 = this.hass) !== null && _this$hass5 !== void 0 && (_this$hass5 = _this$hass5.services) !== null && _this$hass5 !== void 0 && (_this$hass5 = _this$hass5.music_assistant) !== null && _this$hass5 !== void 0 && _this$hass5.transfer_queue)) return [];
    ...
    for (let idx = 0; idx < this.entityObjs.length; idx++) {
      var _this$hass6, _this$hass7, _mainState$attributes, _maState$attributes8, _displayState$attribu;
      const obj = this.entityObjs[idx];
      if (!obj) continue;
      const maEntityId = this._getActualResolvedMaEntityForState(idx);
      if (!maEntityId || seen.has(maEntityId)) continue;
      const maState = (_this$hass6 = this.hass) === null || _this$hass6 === void 0 || (_this$hass6 = _this$hass6.states) === null || _this$hass6 === void 0 ? void 0 : _this$hass6[maEntityId];
      const mainState = (_this$hass7 = this.hass) === null || _this$hass7 === void 0 || (_this$hass7 = _this$hass7.states) === null || _this$hass7 === void 0 ? void 0 : _this$hass7[obj.entity_id];
      ...
      if (entityId) {
        try {
          ...
          if (Array.isArray(queueInfo === null || queueInfo === void 0 ? void 0 : queueInfo.results) && queueInfo.results.length > 0) {
            hasQueue = true;
          } else if (maState.state === "playing" || maState.state === "paused" || (_maState$attributes9 = maState.attributes) !== null && _maState$attributes9 !== void 0 && _maState$attributes9.media_content_id) {
            hasQueue = true;
          }
        } catch (error) {
  ...
  _buildTransferQueuePayload(sourceId, targetId) {
    var _this$hass8;
    const serviceMeta = (_this$hass8 = this.hass) === null || _this$hass8 === void 0 || (_this$hass8 = _this$hass8.services) === null || _this$hass8 === void 0 || (_this$hass8 = _this$hass8.music_assistant) === null || _this$hass8 === void 0 ? void 0 : _this$hass8.transfer_queue;
  ...
  async _showPlaylistTracks(playlistItem) {
    try {
      ...
      this._searchBreadcrumb = "Tracks in ".concat(playlistItem.title);
  ...
  get entityObjs() {
    return this.config.entities.map(e => {
      ...
      if (typeof e === "object" && typeof e.group_volume !== "undefined") {
        ...
        const state = (_this$hass9 = this.hass) === null || _this$hass9 === void 0 || (_this$hass9 = _this$hass9.states) === null || _this$hass9 === void 0 ? void 0 : _this$hass9[entity_id];
  ...
  _getActivePlaybackEntityForIndex(idx) {
    var _this$hass0, _this$hass1;
    const obj = this.entityObjs[idx];
    if (!obj) return null;
    const mainId = obj.entity_id;
    const maId = this._resolveEntity(obj.music_assistant_entity, obj.entity_id, idx);
    const mainState = mainId ? (_this$hass0 = this.hass) === null || _this$hass0 === void 0 || (_this$hass0 = _this$hass0.states) === null || _this$hass0 === void 0 ? void 0 : _this$hass0[mainId] : null;
    const maState = maId ? (_this$hass1 = this.hass) === null || _this$hass1 === void 0 || (_this$hass1 = _this$hass1.states) === null || _this$hass1 === void 0 ? void 0 : _this$hass1[maId] : null;
  ...
  _getActivePlaybackEntityIdInternal(mainId, maId, mainState, maState) {
    ...
    if ((maState === null || maState === void 0 ? void 0 : maState.state) === "playing") {
      ...
      if (this._lastPlayingEntityIdByChip) {
        var _this$_pauseTimestamp;
        const pauseTime = (_this$_pauseTimestamp = this._pauseTimestamps) === null || _this$_pauseTimestamp === void 0 ? void 0 : _this$_pauseTimestamp[this._selectedIndex];
    ...
    if ((maState === null || maState === void 0 ? void 0 : maState.state) === "paused" && ((_this$_lastPlayingEnt3 = this._lastPlayingEntityIdByChip) === null || _this$_lastPlayingEnt3 === void 0 ? void 0 : _this$_lastPlayingEnt3[this._selectedIndex]) === maId) {
    ...
    if (this._isIdle) {
      ...
      const lastActiveEntity = this._lastActiveEntityId || ((_this$_lastPlayingEnt4 = this._lastPlayingEntityIdByChip) === null || _this$_lastPlayingEnt4 === void 0 ? void 0 : _this$_lastPlayingEnt4[this._selectedIndex]);
    ...
    if ((mainState === null || mainState === void 0 ? void 0 : mainState.state) === "playing") {
      var _this$_lastPlayingEnt5, _this$_playbackLinger3;
      // Check if we have a paused entity that should take priority (regardless of idle_timeout_ms)
      const pausedEntity = (_this$_lastPlayingEnt5 = this._lastPlayingEntityIdByChip) === null || _this$_lastPlayingEnt5 === void 0 ? void 0 : _this$_lastPlayingEnt5[this._selectedIndex];
      if (pausedEntity && (pausedEntity === maId || pausedEntity === mainId)) {
        return pausedEntity;
      }

      // Check if we have an active linger that should take priority
      const activeLinger = (_this$_playbackLinger3 = this._playbackLingerByIdx) === null || _this$_playbackLinger3 === void 0 ? void 0 : _this$_playbackLinger3[this._selectedIndex];
      ...
      if ((maState === null || maState === void 0 ? void 0 : maState.state) !== "playing" && this._lastPlayingEntityIdByChip) {
        delete this._lastPlayingEntityIdByChip[this._selectedIndex];
      }
    ...
    if (this._idleTimeoutMs === 0) {
      var _this$_lastPlayingEnt6;
      // First check if we have a paused entity tracked for this chip
      const pausedEntity = (_this$_lastPlayingEnt6 = this._lastPlayingEntityIdByChip) === null || _this$_lastPlayingEnt6 === void 0 ? void 0 : _this$_lastPlayingEnt6[this._selectedIndex];
      if (pausedEntity && (pausedEntity === maId || pausedEntity === mainId)) {
        return pausedEntity;
      }
      ...
      const pausedEntity = (_this$_lastPlayingEnt7 = this._lastPlayingEntityIdByChip) === null || _this$_lastPlayingEnt7 === void 0 ? void 0 : _this$_lastPlayingEnt7[this._selectedIndex];
      if (pausedEntity && (pausedEntity === maId || pausedEntity === mainId)) {
        return pausedEntity;
      }
  ...
  get currentActivePlaybackEntityId() {
    ...
    const cacheKey = "".concat(this._selectedIndex, "-").concat((_this$hass15 = this.hass) === null || _this$hass15 === void 0 || (_this$hass15 = _this$hass15.states) === null || _this$hass15 === void 0 || (_this$hass15 = _this$hass15[this.currentEntityId]) === null || _this$hass15 === void 0 ? void 0 : _this$hass15.state, "-").concat((_this$hass16 = this.hass) === null || _this$hass16 === void 0 || (_this$hass16 = _this$hass16.states) === null || _this$hass16 === void 0 || (_this$hass16 = _this$hass16[this._getSearchEntityId(this._selectedIndex)]) === null || _this$hass16 === void 0 ? void 0 : _this$hass16.state);
  ...
  get currentActivePlaybackStateObj() {
    ...
    return id ? (_this$hass17 = this.hass) === null || _this$hass17 === void 0 || (_this$hass17 = _this$hass17.states) === null || _this$hass17 === void 0 ? void 0 : _this$hass17[id] : null;
  }
      ...
      case "favorite":
        {
          ...
          if (favoriteButtonEntity) {
            var _this$hass21, _maState$attributes0;
            ...
            if (maState !== null && maState !== void 0 && (_maState$attributes0 = maState.attributes) !== null && _maState$attributes0 !== void 0 && _maState$attributes0.media_content_id) {
              // Initialize cache if needed
              if (!this._favoriteStatusCache) {
                this._favoriteStatusCache = {};
              }
  ...
  async _onVolumeStep(direction) {
    ...
    const groupingEntity = await this._resolveTemplateAtActionTime(groupingEntityTemplate, this.currentEntityId);
    const state = this.hass.states[groupingEntity];
    if (Array.isArray(state === null || state === void 0 || (_state$attributes7 = state.attributes) === null || _state$attributes7 === void 0 ? void 0 : _state$attributes7.group_members) && state.attributes.group_members.length) {
  ...
  async _onMuteToggle() {
    var _stateObj$attributes$5, _stateObj$attributes$6, _state;
    const idx = this._selectedIndex;
    const entity = this._getVolumeEntity(idx);
    if (!entity) return;
    const isRemoteVolumeEntity = entity.startsWith && entity.startsWith("remote.");
  ...
  async _onProgressBarClick(e) {
    ...
    if (this._controlFocusEntityId && (this._controlFocusEntityId === maId || this._controlFocusEntityId === mainId)) {
      ...
      var _this$_lastPlayingEnt8;
      // When neither is playing, prefer the last playing entity for better resume behavior
      const lastPlayingForChip = (_this$_lastPlayingEnt8 = this._lastPlayingEntityIdByChip) === null || _this$_lastPlayingEnt8 === void 0 ? void 0 : _this$_lastPlayingEnt8[this._selectedIndex];
  ...
  render() {
    ...
    const powerVolumeButton = showModernPowerButton ? x(_templateObject2 || (_templateObject2 = _taggedTemplateLiteral(["\n        <button\n          class=\"volume-icon-btn favorite-volume-btn", "\"\n          @click=", "\n          title=\"Power\"\n        >\n          <ha-icon .icon=", "></ha-icon>\n        </button>\n      "])), (stateObj === null || stateObj === void 0 ? void 0 : stateObj.state) !== "off" ? " active" : "", () => this._onControlClick("power"), "mdi:power") : E;
    const rightSlotTemplate = showModernFavoriteButton ? x(_templateObject3 || (_templateObject3 = _taggedTemplateLiteral(["\n        <button\n          class=\"volume-icon-btn favorite-volume-btn", "\"\n          @click=", "\n          title=\"Favorite\"\n        >\n          <ha-icon\n            style=", "\n            .icon=", "\n          ></ha-icon>\n        </button>\n      "])), favoriteActive ? " active" : "", () => this._onControlClick("favorite"), favoriteActive ? "color: var(--custom-accent);" : E, favoriteActive ? "mdi:heart" : "mdi:heart-outline") : E;
    ...
    if (this._lastMaState === "playing" && (_this$_playbackLinger4 = this._playbackLingerByIdx) !== null && _this$_playbackLinger4 !== void 0 && _this$_playbackLinger4[idx]) {
      delete this._playbackLingerByIdx[idx];
    }
    ...
    const lastControlled = (_this$_lastPlayingEnt1 = this._lastPlayingEntityIdByChip) === null || _this$_lastPlayingEnt1 === void 0 ? void 0 : _this$_lastPlayingEnt1[idx];
    ...
    if (this._lastMainState === "playing" && (_this$_playbackLinger5 = this._playbackLingerByIdx) !== null && _this$_playbackLinger5 !== void 0 && _this$_playbackLinger5[idx] && !isLastControlledMa) {
      delete this._playbackLingerByIdx[idx];
    }
    ...
    return x(_templateObject4 || (_templateObject4 = _taggedTemplateLiteral(["\n        <ha-card class=\"yamp-card\" style=", ">\n          <div\n            data-match-theme=\"", "\"\n            class=\"yamp-card-inner ", "\"\n          >\n            ", "\n            ", "\n            ", "\n            <div class=\"card-lower-content-container\" style=\"", "\">\n              <div class=\"card-lower-content-bg\"\n                style=\"", "\"\n              ></div>\n              ", "\n              <div class=\"card-lower-content", "", "\" style=\"", "\">\n                ", "\n                ", "\n                <div class=\"details\" style=\"", "\">\n                  <div class=\"title\">\n                    ", "\n                  </div>\n                  ", "\n                </div>\n                ", "\n                ", "\n                ", "\n                ", "\n            ", "\n            ", "\n          </div>\n        </div>\n      </div>\n      ", "\n          ", "\n        </ha-card>\n      "])), hasCustomCardHeight ? "height:".concat(customCardHeight, "px;") : E, String(this.config.match_theme === true), shouldDimIdle ? 'dim-idle' : '', artworkFullBleed && hasBackgroundImage ? x(_templateObject5 || (_templateObject5 = _taggedTemplateLiteral(["\n              <div class=\"full-bleed-artwork-bg\" style=\"", "\"></div>\n              ", "\n            "])), sharedBackgroundStyle, !dimIdleFrame ? x(_templateObject6 || (_templateObject6 = _taggedTemplateLiteral(["<div class=\"full-bleed-artwork-fade\"></div>"]))) : E) : E, showChipsInline ? x(_templateObject7 || (_templateObject7 = _taggedTemplateLiteral(["\n                <div class=\"chip-row\">\n                  ", "\n                </div>\n            "])), renderChipRow({
      ...
      getChipArt: id => {
        var _this$hass28, _this$hass29, _ref0;
        const obj = this._findEntityObjByAnyId(id);
        const mainId = (obj === null || obj === void 0 ? void 0 : obj.entity_id) || id;
        const idx = this.entityIds.indexOf(mainId);
    ...
    })(), shouldShowDetails ? title : "", shouldShowDetails && artist ? x(_templateObject10 || (_templateObject10 = _taggedTemplateLiteral(["\n                    <div\n                      class=\"artist ", "\"\n                      @click=", "\n                      title=", "\n                    >", "</div>\n                  "])), stateObj.attributes.media_artist ? 'clickable-artist' : '', () => {
      ...
      accent: this._customAccent,
      style: this._showEntityOptions ? "visibility:hidden" : ""
    }) : E, !hideControlsNow && controlSpacerSize > 0 ? x(_templateObject11 || (_templateObject11 = _taggedTemplateLiteral(["\n                  <div class=\"collapsed-flex-spacer\" style=\"flex: 1 0 ", "px;\"></div>\n                "])), Math.round(controlSpacerSize)) : E, !hideControlsNow ? x(_templateObject12 || (_templateObject12 = _taggedTemplateLiteral(["\n                  <div style=\"", "\">\n                    ", "\n\n                    ", "\n                  </div>\n                "])), this._showEntityOptions ? 'visibility:hidden' : '', renderControlsRow({
      ...
      rightSlotTemplate,
      moreInfoMenu: x(_templateObject13 || (_templateObject13 = _taggedTemplateLiteral(["\n                        <div class=\"more-info-menu\">\n                          <button class=\"more-info-btn\" @click=", ">\n                            <span class=\"more-info-icon\">&#9776;</span>\n                          </button>\n                        </div>\n                      "])), async () => await this._openEntityOptions())
    })) : E, hideControlsNow && !this._showEntityOptions ? x(_templateObject14 || (_templateObject14 = _taggedTemplateLiteral(["\n              <div class=\"more-info-menu\" style=\"position: absolute; right: 18px; bottom: 18px; z-index: 10;\">\n                <button class=\"more-info-btn\" @click=", ">\n                  <span class=\"more-info-icon\">&#9776;</span>\n                </button>\n              </div>\n            "])), async () => await this._openEntityOptions()) : E, showChipsInMenu && !this._showEntityOptions && !this._hideActiveEntityLabel ? x(_templateObject15 || (_templateObject15 = _taggedTemplateLiteral(["\n              <div class=\"in-menu-active-label\">", "</div>\n            "])), activeChipName) : E, this._showEntityOptions ? x(_templateObject16 || (_templateObject16 = _taggedTemplateLiteral(["\n      <div class=\"entity-options-overlay entity-options-overlay-opening\" @click=", ">\n        <div class=\"entity-options-container entity-options-container-opening\">\n          <div class=\"entity-options-sheet", " entity-options-sheet-opening\" @click=", ">\n            ", "\n              ", "\n              </div>\n            </div>\n            <!-- Persistent Media Controls Section - Outside Scrollable Area -->\n            ", "\n          </div>\n        "])), e => this._closeEntityOptions(e), showChipsInMenu ? ' chips-mode' : '', e => e.stopPropagation(), showChipsInMenu ? x(_templateObject17 || (_templateObject17 = _taggedTemplateLiteral(["\n                <div class=\"entity-options-chips-wrapper\" @click=", ">\n                <div class=\"chip-row entity-options-chips-strip\">\n                  ", "\n                </div>\n              </div>\n            "])), e => e.stopPropagation(), renderChipRow({
      groupedSortedEntityIds: this.groupedSortedEntityIds,
      entityIds: this.entityIds,
      selectedEntityId: this.currentEntityId,
      pinnedIndex: this._pinnedIndex,
      ...
      getChipArt: id => {
        var _this$hass32, _this$hass33, _ref10;
        const obj = this._findEntityObjByAnyId(id);
        const mainId = (obj === null || obj === void 0 ? void 0 : obj.entity_id) || id;
        const idx = this.entityIds.indexOf(mainId);
        if (idx < 0) return null;
    ...
    }, Array.isArray((_this$currentStateObj = this.currentStateObj) === null || _this$currentStateObj === void 0 || (_this$currentStateObj = _this$currentStateObj.attributes) === null || _this$currentStateObj === void 0 ? void 0 : _this$currentStateObj.source_list) && this.currentStateObj.attributes.source_list.length > 0 ? x(_templateObject19 || (_templateObject19 = _taggedTemplateLiteral(["\n                      <button class=\"entity-options-item\" @click=", ">Source</button>\n                    "])), () => this._openSourceList()) : E, this._canShowTransferQueueOption() ? x(_templateObject20 || (_templateObject20 = _taggedTemplateLiteral(["\n                    <button class=\"entity-options-item\" @click=", ">Transfer Queue</button>\n                  "])), () => this._openTransferQueue()) : E, (() => {
      ...
      return E;
    })(), menuOnlyActions.length ? x(_templateObject22 || (_templateObject22 = _taggedTemplateLiteral(["\n                    ", "\n                  "])), menuOnlyActions.map(_ref11 => {
      let {
        action,
        idx
      } = _ref11;
      const label = this._getActionLabel(action);
      return x(_templateObject23 || (_templateObject23 = _taggedTemplateLiteral(["\n                        <button\n                          class=\"entity-options-item menu-action-item\"\n                          @click=", "\n                        >\n                          ", "\n                          ", "\n                        </button>\n                      "])), () => this._onMenuActionClick(idx), action.icon ? x(_templateObject24 || (_templateObject24 = _taggedTemplateLiteral(["\n                            <ha-icon\n                              class=\"menu-action-icon\"\n                              .icon=", "\n                            ></ha-icon>\n                          "])), action.icon) : E, label ? x(_templateObject25 || (_templateObject25 = _taggedTemplateLiteral(["<span class=\"menu-action-label\">", "</span>"])), label) : E);
    })) : E) : this._showTransferQueue ? x(_templateObject26 || (_templateObject26 = _taggedTemplateLiteral(["\n                <button class=\"entity-options-item close-item\" @click=", ">\n                  Back\n                </button>\n                <div class=\"entity-options-divider\"></div>\n                <div class=\"entity-options-title\" style=\"margin-bottom:12px;\">Transfer Queue To</div>\n                ", "\n                ", "\n              "])), () => {
      if (this._quickMenuInvoke) {
        this._dismissWithAnimation();
      } else {
      ...
      if (!targets.length) {
        return x(_templateObject27 || (_templateObject27 = _taggedTemplateLiteral(["<div style=\"padding: 12px; opacity: 0.75;\">No other Music Assistant players available.</div>"])));
      }
      return x(_templateObject28 || (_templateObject28 = _taggedTemplateLiteral(["\n                      <div style=\"display:flex;flex-direction:column;gap:8px;\">\n                        ", "\n                      </div>\n                    "])), targets.map(target => x(_templateObject29 || (_templateObject29 = _taggedTemplateLiteral(["\n                          <button\n                            class=\"entity-options-item\"\n                            ?disabled=", "\n                            @click=", "\n                            style=\"display:flex;align-items:center;justify-content:flex-start;gap:12px;", "\">\n                            <ha-icon .icon=", " style=\"margin-right:4px;\"></ha-icon>\n                            <div style=\"display:flex;flex-direction:column;align-items:flex-start;\">\n                              <div>", "</div>\n                              <div style=\"font-size:0.82em;opacity:0.7;\">", "</div>\n                            </div>\n                            ", "\n                          </button>\n                        "])), this._transferQueuePendingTarget === target.maEntityId, () => this._transferQueueTo(target), this._transferQueuePendingTarget === target.maEntityId ? 'opacity:0.6;' : '', target.icon, target.name, target.subtitle, target.state ? x(_templateObject30 || (_templateObject30 = _taggedTemplateLiteral(["<div style=\"margin-left:auto;font-size:0.82em;opacity:0.7;text-transform:capitalize;\">", "</div>"])), target.state) : E)));
    })(), this._transferQueueStatus ? x(_templateObject31 || (_templateObject31 = _taggedTemplateLiteral(["\n                  <div style=\"\n                    margin-top: 14px;\n                    padding: 10px 12px;\n                    border-radius: 8px;\n                    font-weight: 600;\n                    text-align: center;\n                    background: ", ";\n                    color: ", ";\n                  \">\n                    ", "\n                  </div>\n                "])), this._transferQueueStatus.type === 'error' ? 'rgba(244, 67, 54, 0.18)' : 'rgba(76, 175, 80, 0.18)', this._transferQueueStatus.type === 'error' ? '#ff8a80' : '#8bc34a', this._transferQueueStatus.message) : E) : this._showResolvedEntities ? x(_templateObject32 || (_templateObject32 = _taggedTemplateLiteral(["\n                <button class=\"entity-options-item close-item\" @click=", ">\n                  Back\n                </button>\n                <div class=\"entity-options-divider\"></div>\n                <div class=\"entity-options-resolved-entities\" style=\"margin-top:12px;\">\n                  <div class=\"entity-options-title\">Select Entity for More Info</div>\n                  <div class=\"entity-options-resolved-entities-list\">\n                    ", "\n                  </div>\n                </div>\n              "])), () => {
      this._showResolvedEntities = false;
      this.requestUpdate();
    }, this._getResolvedEntitiesForCurrentChip().map(entityId => {
      var _this$hass35, _state$attributes8, _state$attributes9;
      ...
      const name = (state === null || state === void 0 || (_state$attributes8 = state.attributes) === null || _state$attributes8 === void 0 ? void 0 : _state$attributes8.friendly_name) || entityId;
      const icon = (state === null || state === void 0 || (_state$attributes9 = state.attributes) === null || _state$attributes9 === void 0 ? void 0 : _state$attributes9.icon) || "mdi:help-circle";
      ...
      return x(_templateObject37 || (_templateObject37 = _taggedTemplateLiteral(["\n                      <div class=\"chip-row search-filter-chips\" id=\"search-filter-chip-row\" style=\"margin-bottom:12px; justify-content: center; align-items: center;\">\n                        <button\n                          class=\"chip\"\n                          style=\"\n                            width: 72px;\n                            background: ", ";\n                            opacity: ", ";\n                            font-weight: ", ";\n                          \"\n                          ?selected=", "\n                          @click=", "\n                        >All</button>\n                        ", "\n                      </div>\n                    "])), filter === 'all' ? this._customAccent : '#282828', filter === 'all' ? '1' : '0.8', filter === 'all' ? 'bold' : 'normal', filter === 'all', () => this._doSearch(), classes.map(c => x(_templateObject38 || (_templateObject38 = _taggedTemplateLiteral(["\n                          <button\n                            class=\"chip\"\n                            style=\"\n                              width: 72px;\n                              background: ", ";\n                              opacity: ", ";\n                              font-weight: ", ";\n                            \"\n                            ?selected=", "\n                            @click=", "\n                          >\n                            ", "\n                          </button>\n                        "])), filter === c ? this._customAccent : '#282828', filter === c ? '1' : '0.8', filter === c ? 'bold' : 'normal', filter === c, () => this._doSearch(c), c.charAt(0).toUpperCase() + c.slice(1))));
    })(), this._searchLoading ? x(_templateObject39 || (_templateObject39 = _taggedTemplateLiteral(["<div class=\"entity-options-search-loading\">Loading...</div>"]))) : E, this._searchError ? x(_templateObject40 || (_templateObject40 = _taggedTemplateLiteral(["<div class=\"entity-options-search-error\">", "</div>"])), this._searchError) : E, this._usingMusicAssistant && !this._searchLoading ? x(_templateObject41 || (_templateObject41 = _taggedTemplateLiteral(["\n                    <div style=\"display: flex; align-items: center; margin-bottom: 2px; margin-top: 4px; padding-left: 3px; width: 100%; gap: 8px;\">\n                      <div style=\"display: flex; align-items: center; flex-wrap: wrap; flex: 1; min-width: 0;\">\n                        <button\n                          class=\"button", "\"\n                          style=\"\n                            background: none;\n                            border: none;\n                            font-size: 1.2em;\n                            cursor: ", ";\n                            padding: 4px 8px;\n                            border-radius: 50%;\n                            transition: all 0.2s ease;\n                            margin-right: 8px;\n                            display: flex;\n                            align-items: center;\n                            opacity: ", ";\n                          \"\n                          @click=", "\n                          title=\"Favorites\"\n                        >\n                                                  <ha-icon .icon=", "></ha-icon>\n                          ", "\n                      </button>\n                      <button\n                          class=\"button", "\"\n                          style=\"\n                            background: none;\n                            border: none;\n                            font-size: 1.2em;\n                            cursor: ", ";\n                            padding: 4px 8px;\n                            border-radius: 50%;\n                            transition: all 0.2s ease;\n                            margin-right: 8px;\n                            display: flex;\n                            align-items: center;\n                            opacity: ", ";\n                          \"\n                          @click=", "\n                          title=\"Recently Played\"\n                        >\n                          <ha-icon .icon=", "></ha-icon>\n                          ", "\n                      </button>\n                      ", "\n                      ", "\n                      ", "\n                    </div>\n                  "])), this._initialFavoritesLoaded || this._favoritesFilterActive ? ' active' : '', this._searchAttempted ? 'pointer' : 'default', this._searchAttempted ? '1' : '0.5', this._searchAttempted ? () => {
      this._toggleFavoritesFilter();
    } : () => {}, this._initialFavoritesLoaded || this._favoritesFilterActive ? 'mdi:cards-heart' : 'mdi:cards-heart-outline', this._initialFavoritesLoaded || this._favoritesFilterActive ? x(_templateObject42 || (_templateObject42 = _taggedTemplateLiteral(["\n                            <span style=\"margin-left:6px;font-size:0.82em;font-weight:600;color:rgba(255,255,255,0.85);white-space:nowrap;\">\n                              Favorites\n                            </span>\n                          "]))) : E, this._recentlyPlayedFilterActive ? ' active' : '', this._searchAttempted ? 'pointer' : 'default', this._searchAttempted ? '1' : '0.5', this._searchAttempted ? () => {
      this._toggleRecentlyPlayedFilter();
    } : () => {}, this._recentlyPlayedFilterActive ? 'mdi:clock' : 'mdi:clock-outline', this._recentlyPlayedFilterActive ? x(_templateObject43 || (_templateObject43 = _taggedTemplateLiteral(["\n                            <span style=\"margin-left:6px;font-size:0.82em;font-weight:600;color:rgba(255,255,255,0.85);white-space:nowrap;\">\n                              Recently Played\n                            </span>\n                          "]))) : E, this._isMusicAssistantEntity() ? x(_templateObject44 || (_templateObject44 = _taggedTemplateLiteral(["\n                        <button\n                            class=\"button", "\"\n                            style=\"\n                              background: none;\n                              border: none;\n                              font-size: 1.2em;\n                              cursor: ", ";\n                              padding: 4px 8px;\n                              border-radius: 50%;\n                              transition: all 0.2s ease;\n                              margin-right: 8px;\n                              display: flex;\n                              align-items: center;\n                              opacity: ", ";\n                            \"\n                            @click=", "\n                            title=\"Next Up\"\n                          >\n                            <ha-icon .icon=", "></ha-icon>\n                            ", "\n                        </button>\n                        ", "\n                      "])), this._upcomingFilterActive ? ' active' : '', this._searchAttempted ? 'pointer' : 'default', this._searchAttempted ? '1' : '0.5', this._searchAttempted ? () => {
      this._toggleUpcomingFilter();
    } : () => {}, this._upcomingFilterActive ? 'mdi:playlist-music' : 'mdi:playlist-music-outline', this._upcomingFilterActive ? x(_templateObject45 || (_templateObject45 = _taggedTemplateLiteral(["\n                              <span style=\"margin-left:6px;font-size:0.82em;font-weight:600;color:rgba(255,255,255,0.85);white-space:nowrap;\">\n                                Next Up\n                              </span>\n                            "]))) : E, this._hasMassQueueIntegration ? x(_templateObject46 || (_templateObject46 = _taggedTemplateLiteral(["\n                          <button\n                              class=\"button", "\"\n                              style=\"\n                                background: none;\n                                border: none;\n                                font-size: 1.2em;\n                                cursor: ", ";\n                                padding: 4px 8px;\n                                border-radius: 50%;\n                                transition: all 0.2s ease;\n                                margin-right: 8px;\n                                display: flex;\n                                align-items: center;\n                                opacity: ", ";\n                              \"\n                              @click=", "\n                              title=\"Recommendations\"\n                            >\n                              <ha-icon .icon=", "></ha-icon>\n                              ", "\n                          </button>\n                        "])), this._recommendationsFilterActive ? ' active' : '', this._searchAttempted ? 'pointer' : 'default', this._searchAttempted ? '1' : '0.5', this._searchAttempted ? () => {
      this._toggleRecommendationsFilter();
    } : () => {}, this._recommendationsFilterActive ? 'mdi:lightbulb-on' : 'mdi:lightbulb-on-outline', this._recommendationsFilterActive ? x(_templateObject47 || (_templateObject47 = _taggedTemplateLiteral(["\n                                <span style=\"margin-left:6px;font-size:0.82em;font-weight:600;color:rgba(255,255,255,0.85);white-space:nowrap;\">\n                                  Recommendations\n                                </span>\n                              "]))) : E) : E) : E, this._shouldShowSearchSortToggle() ? x(_templateObject48 || (_templateObject48 = _taggedTemplateLiteral(["\n                        <button\n                          class=\"button\"\n                          style=\"\n                            background: none;\n                            border: none;\n                            font-size: 1.2em;\n                            cursor: ", ";\n                            padding: 4px 8px;\n                            border-radius: 50%;\n                            transition: all 0.2s ease;\n                            margin-right: 8px;\n                            display: flex;\n                            align-items: center;\n                            opacity: ", ";\n                          \"\n                          @click=", "\n                          title=", "\n                        >\n                          <ha-icon .icon=", "></ha-icon>\n                        </button>\n                      "])), this._searchAttempted ? 'pointer' : 'default', this._searchAttempted ? '1' : '0.5', this._searchAttempted ? () => this._toggleSearchResultsSortDirection() : () => {}, this._getSearchSortToggleTitle(), this._getSearchSortToggleIcon()) : E, this._shouldShowSearchResultsCount() ? x(_templateObject49 || (_templateObject49 = _taggedTemplateLiteral(["\n                        <span style=\"margin-left:auto;padding-left:8px;font-size:0.85em;font-style:italic;color:rgba(255,255,255,0.75);white-space:nowrap;text-align:right;flex-shrink:0;\">\n                          ", "\n                        </span>\n                      "])), this._getSearchResultsCountLabel()) : E) : E, (() => {
      this._searchMediaClassFilter || "all";
      ...
      return this._searchAttempted && currentResults.length === 0 && !this._searchLoading ? x(_templateObject50 || (_templateObject50 = _taggedTemplateLiteral(["<div class=\"entity-options-search-empty\" style=\"color: white;\">No results.</div>"]))) : paddedResults.map(item => item ? x(_templateObject51 || (_templateObject51 = _taggedTemplateLiteral(["\n                            <!-- EXISTING non\u2011placeholder row markup -->\n                            <div class=\"entity-options-search-result ", "\">\n                              ", "\n                              <div style=\"flex:1; display:flex; flex-direction:column; justify-content:center;\">\n                                <span class=\"", "\"\n                                      @touchstart=", "\n                                      @click=", "\n                                      title=", ">\n                                  ", "\n                                </span>\n                                <span style=\"font-size:0.86em; color:#bbb; line-height:1.16; margin-top:2px;\">\n                                  ", "\n                                </span>\n                              </div>\n                              <div class=\"entity-options-search-buttons\">\n                                <button class=\"entity-options-search-play\" @click=", " title=\"Play Now\">\n                                  \u25B6\n                                </button>\n                                ", "\n                              </div>\n                            </div>\n                          "])), item._justMoved ? 'just-moved' : '', item.thumbnail && this._isValidArtworkUrl(item.thumbnail) && !String(item.thumbnail).includes('imageproxy') ? x(_templateObject52 || (_templateObject52 = _taggedTemplateLiteral(["\n                                <img\n                                  class=\"entity-options-search-thumb\"\n                                  src=", "\n                                  alt=", "\n                                  style=\"height:38px;width:38px;object-fit:var(--yamp-artwork-fit, cover);border-radius:5px;margin-right:12px;\"\n                                  onerror=\"this.style.display='none'\"\n                                />\n                              "])), item.thumbnail, item.title) : x(_templateObject53 || (_templateObject53 = _taggedTemplateLiteral(["\n                                <div class=\"entity-options-search-thumb-placeholder\" \n                                     style=\"height:38px;width:38px;border-radius:5px;margin-right:12px;background:rgba(255,255,255,0.1);display:flex;align-items:center;justify-content:center;\">\n                                  <ha-icon icon=\"mdi:music\" style=\"color:rgba(255,255,255,0.6);font-size:16px;\"></ha-icon>\n                                </div>\n                              "]))), this._isClickableSearchResult(item) ? 'clickable-search-result' : '', e => this._handleSearchResultTouch(item, e), () => this._handleSearchResultClick(item), this._getSearchResultClickTitle(item), item.title, (() => {
      ...
      })(), () => this._playMediaFromSearch(item), !(this._upcomingFilterActive && item.queue_item_id && this._isMusicAssistantEntity() && this._massQueueAvailable) ? x(_templateObject54 || (_templateObject54 = _taggedTemplateLiteral(["\n                                  <button class=\"entity-options-search-queue\" @click=", " title=\"Add to Queue\">\n                                    <ha-icon icon=\"mdi:playlist-play\"></ha-icon>\n                                  </button>\n                                "])), e => {
        e.preventDefault();
        e.stopPropagation();
        this._queueMediaFromSearch(item);
      }) : x(_templateObject55 || (_templateObject55 = _taggedTemplateLiteral(["\n                                  <!-- Queue reordering buttons for upcoming items (only for Music Assistant entities with working mass_queue) -->\n                                  ", "\n                                "])), this._upcomingFilterActive && item.queue_item_id && this._isMusicAssistantEntity() && this._massQueueAvailable ? x(_templateObject56 || (_templateObject56 = _taggedTemplateLiteral(["\n                                    <div class=\"queue-controls\">\n                                      <button class=\"queue-btn queue-btn-up\" @click=", " title=\"Move Up\">\n                                        <ha-icon icon=\"mdi:arrow-up\"></ha-icon>\n                                      </button>\n                                      <button class=\"queue-btn queue-btn-down\" @click=", " title=\"Move Down\">\n                                        <ha-icon icon=\"mdi:arrow-down\"></ha-icon>\n                                      </button>\n                                      <button class=\"queue-btn queue-btn-next\" @click=", " title=\"Move to Next\">\n                                        <ha-icon icon=\"mdi:format-vertical-align-top\"></ha-icon>\n                                      </button>\n                                      <button class=\"queue-btn queue-btn-remove\" @click=", " title=\"Remove from Queue\">\n                                        <ha-icon icon=\"mdi:close\"></ha-icon>\n                                      </button>\n                                    </div>\n                                  "])), e => {
        e.preventDefault();
        e.stopPropagation();
        ...
        e.stopPropagation();
        this._queueMediaFromSearch(item);
      }))) : x(_templateObject58 || (_templateObject58 = _taggedTemplateLiteral(["\n                            <!-- placeholder row keeps height -->\n                            <div class=\"entity-options-search-result placeholder\"></div>\n                          "]))));
    })()) : this._showGrouping ? x(_templateObject59 || (_templateObject59 = _taggedTemplateLiteral(["\n                <div class=\"grouping-header\">\n                  <button class=\"entity-options-item close-item\" @click=", ">\n                    Back\n                  </button>\n                </div>\n                ", "\n              "])), () => {
      if (this._quickMenuInvoke) {
        this._dismissWithAnimation();
      } else {
        this._closeGrouping();
      ...
      return x(_templateObject61 || (_templateObject61 = _taggedTemplateLiteral(["\n                      <div class=\"entity-options-title\" style=\"margin-bottom:8px;\">Group Players</div>\n                      <div style=\"display:flex; align-items:center; gap:8px; margin-bottom:12px;\">\n                        ", "\n                        <button class=\"entity-options-item\"\n                          @click=", "\n                          style=\"flex:0 0 auto; min-width:140px; text-align:center; margin-left:auto;\">\n                          ", "\n                        </button>\n                      </div>\n                      <div class=\"group-list-scroll\">\n                        ", "\n                      </div>\n                    "])), groupedAny ? x(_templateObject62 || (_templateObject62 = _taggedTemplateLiteral(["\n                          <button class=\"entity-options-item\"\n                            @click=", "\n                            style=\"flex:0 0 auto; min-width:140px; text-align:center;\">\n                            Sync Volume\n                          </button>\n                        "])), () => this._syncGroupVolume()) : E, () => groupedAny ? this._ungroupAll() : this._groupAll(), groupedAny ? "Ungroup All" : "Group All", sortedGroupIds.length === 0 ? x(_templateObject63 || (_templateObject63 = _taggedTemplateLiteral(["\n                          <div class=\"entity-options-item\" style=\"padding:12px; opacity:0.75; text-align:center;\">\n                            No group-capable players.\n                          </div>\n                        "]))) : sortedGroupIds.map(item => {
      ...
      return artwork !== null && artwork !== void 0 && artwork.url && this._isValidArtworkUrl(artwork.url) ? x(_templateObject73 || (_templateObject73 = _taggedTemplateLiteral(["\n                      <img src=\"", "\" alt=\"Album Art\" class=\"persistent-artwork\" onerror=\"this.style.display='none'\">\n                    "])), artwork.url) : x(_templateObject74 || (_templateObject74 = _taggedTemplateLiteral(["\n                      <div class=\"persistent-artwork-placeholder\">\n                        <ha-icon icon=\"mdi:music\"></ha-icon>\n                      </div>\n                    "])));
      ...
      return x(_templateObject75 || (_templateObject75 = _taggedTemplateLiteral(["\n                    <div class=\"persistent-volume-stepper\">\n                      <button class=\"stepper-btn\" @click=", " title=\"Volume Down\">\u2013</button>\n                      ", "\n                      <button class=\"stepper-btn\" @click=", " title=\"Volume Up\">+</button>\n                    </div>\n                  "])), () => this._onVolumeStep(-1), percentLabel ? x(_templateObject76 || (_templateObject76 = _taggedTemplateLiteral(["<span class=\"stepper-value\">", "</span>"])), percentLabel) : E, () => this._onVolumeStep(1));
    })()) : E) : E, this._searchOpen ? renderSearchSheet({
  ...
  _updateIdleState() {
    ...
    const mainId = this.currentEntityId;
    const maId = this._getActualResolvedMaEntityForState(this._selectedIndex);
    const mainState = mainId ? (_this$hass36 = this.hass) === null || _this$hass36 === void 0 || (_this$hass36 = _this$hass36.states) === null || _this$hass36 === void 0 ? void 0 : _this$hass36[mainId] : null;
    const maState = maId ? (_this$hass37 = this.hass) === null || _this$hass37 === void 0 || (_this$hass37 = _this$hass37.states) === null || _this$hass37 === void 0 ? void 0 : _this$hass37[maId] : null;
