...
class YetAnotherMediaPlayerEditor extends i$2 {
  ...
  _renderBehaviorTab() {
    ...
    }, (_this$_config$search_ = this._config.search_results_limit) !== null && _this$_config$search_ !== void 0 ? _this$_config$search_ : 20, e => this._updateConfig("search_results_limit", e.detail.value), searchLimitWarningActive ? x(_templateObject16$1 || (_templateObject16$1 = _taggedTemplateLiteral(["\n                  <div class=\"config-subtitle warning\">\n                    Warning: requesting higher results can cause performance issues.\n                  </div>\n                "]))) : E, () => this._updateConfig("search_results_limit", 20), this.hass, {
      select: {
        mode: "dropdown",
        options: [{
          value: "default",
  ...
  _renderActionEditor(action) {
    ...
    }, actionMode === "menu" ? x(_templateObject35$1 || (_templateObject35$1 = _taggedTemplateLiteral(["\n          <div class=\"form-row\">\n            <ha-selector\n              .hass=", "\n              label=\"Menu Item\"\n              .selector=", "\n              .value=", "\n              @value-changed=", "\n            ></ha-selector>\n          </div>\n        "])), this.hass, {
      select: {
        mode: "dropdown",
        options: [{
          value: "",
    ...
    }, this._yamlError && this._yamlDraft.trim() !== "" ? x(_templateObject40$1 || (_templateObject40$1 = _taggedTemplateLiteral(["<div class=\"yaml-error-message\">", "</div>"])), this._yamlError) : E) : E) : E);
  }
