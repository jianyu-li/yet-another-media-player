 ...
 */const eo=Xn(class extends Jn{constructor(i){if(super(i),i.type!==Kn.ATTRIBUTE||i.name!=="class"||i.strings?.length>2)throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(i){return" "+Object.keys(i).filter((e=>i[e])).join(" ")+" "}update(i,[e]){if(this.st===void 0){this.st=new Set,i.strings!==void 0&&(this.nt=new Set(i.strings.join(" ").split(/\s/).filter((a=>a!==""))));for(const a in e)e[a]&&!this.nt?.has(a)&&this.st.add(a);return this.render(e)}const t=i.element.classList;for(const a of this.st)a in e||(t.remove(a),this.st.delete(a));for(const a in e){const s=!!e[a];s===this.st.has(a)||this.nt?.has(a)||(s?(t.add(a),this.st.add(a)):(t.remove(a),this.st.delete(a)))}return Xe}});function xe(i,e){const t=i?.[e];return typeof t=="string"&&t.trim()!==""?t:null}async function to(i,e,t){if(!e||typeof e!="string")return t;if(!e.includes("{{")&&!e.includes("{%"))return e;try{const a=(await i.callApi("POST","template",{template:e})||"").toString().trim();return a&&/^([a-z_]+)\.[A-Za-z0-9_]+$/.test(a)?a:t}catch{return t}}async function io(i,e,t={}){if(!e||typeof e!="string")return e;if(!e.includes("{{")&&!e.includes("{%")){if(/%7B%7B|%7B%25/i.test(e))try{e=decodeURIComponent(e)}catch{}if(!e.includes("{{")&&!e.includes("{%"))return e}let a=e;t&&Object.keys(t).length>0&&(a=`${Object.entries(t).map(([s,r])=>`{% set ${s} = ${JSON.stringify(r)} %}`).join(" ")} ${e}`);try{return(await i.callApi("POST","template",{template:a})||"").toString().trim()}catch(s){return console.warn("yamp: Error resolving template:",e,s),e}}function ao(i,e,t={}){if(!e||typeof e!="string")return e;let a=e;if(/%7B%7B|%7B%25/i.test(a))try{a=decodeURIComponent(a)}catch{}if(!a.includes("{{")&&!a.includes("{%"))return a;let s=a,r=!0;return s=s.replace(/\{\{\s*(.*?)\s*\}\}/g,(n,o)=>{let l=o.trim(),c=!1;l.endsWith("| urlencode")?(c=!0,l=l.replace(/\|\s*urlencode$/,"").trim()):l.endsWith("|urlencode")&&(c=!0,l=l.replace(/\|urlencode$/,"").trim());let u=l.match(/^state_attr\(\s*(['"]?)([\w.]+)\1\s*,\s*(['"]?)([\w_]+)\3\s*\)$/);if(u){let p=u[2],_=t[p]!==void 0&&!u[1]?t[p]:p,f=u[4];const g=i?.states?.[_];if(g&&g.attributes&&g.attributes[f]!==void 0){let y=String(g.attributes[f]);return c?encodeURIComponent(y):y}return""}let d=l.match(/^states\(\s*(['"]?)([\w.]+)\1\s*\)$/);if(d){let p=d[2],_=t[p]!==void 0&&!d[1]?t[p]:p;const f=i?.states?.[_];if(f&&f.state!==void 0){let g=String(f.state);return c?encodeURIComponent(g):g}return""}if(/^[\w_]+$/.test(l)&&t[l]!==void 0){let p=String(t[l]);return c?encodeURIComponent(p):p}return r=!1,n}),!r||s.includes("{%")?null:s}function so(i,e){if(!i?.states||!e)return[];const t=[],a=i.states[e];if(!a)return[];const s=a.attributes?.device_id,r=a.attributes?.friendly_name||e;for(const[n,o]of Object.entries(i.states))if(n.startsWith("button.")&&o.attributes){const l=o.attributes.device_id,c=o.attributes.friendly_name||n;s&&l===s?t.push({entity_id:n,friendly_name:c,device_class:o.attributes.device_class,reason:"same_device"}):(c.toLowerCase().includes(r.toLowerCase())||r.toLowerCase().includes(c.toLowerCase()))&&t.push({entity_id:n,friendly_name:c,device_class:o.attributes.device_class,reason:"name_similarity"})}return t}function ro(i,e){if(!i?.states||!e)return null;const t=i.states[e];return t&&t.attributes&&(t.attributes.media_content_id||t.attributes.media_content_type||t.attributes.media_album_name||t.attributes.media_artist||t.attributes.media_title)?t:null}function tt(i){return!i||!i.attributes?!1:i.attributes.app_id==="music_assistant"||i.attributes.mass_player_type!==void 0}function no(i){if(!i)return"";const e=i.media_type||i.media_class||i.media_content_type,t=i.name||i.title||i.media_title||"Unknown Title",a=i.artists?.[0],s=i.artist||a?.name||(typeof a=="string"?a:void 0)||i.media_artist||"Unknown Artist";return e==="track"?`${t} - ${s}`:e==="album"?`${t} - ${s}`:t}function _s(i,e="",t=[],a=null){if(!i||!i.attributes)return null;const s=i.attributes,r=i.entity_id;s.app_id;let n=null,o=null;if(t&&Array.isArray(t)&&t.length){const l=(d,p)=>{if(d)return d[p]},c=[["media_title","media_title"],["media_artist","media_artist"],["media_album_name","media_album_name"],["media_content_id","media_content_id"],["media_channel","media_channel"],["app_name","app_name"],["media_content_type","media_content_type"],["entity_id","entity_id"],["entity_state","entity_state"]];let u=t.find(d=>c.some(([p,_])=>{const f=l(d,_);return f===void 0?!1:(p==="entity_id"?r:p==="entity_state"?i?.state:s[p])===f}));u||xe(s,"entity_picture_local")||xe(s,"entity_picture")||xe(s,"album_art")||(u=t.find(d=>d?.missing_art_url),u?.missing_art_url&&(u={...u,image_url:u.missing_art_url})),u?.image_url&&(n=u.image_url,o=u?.size_percentage)}return n||(n=xe(s,"entity_picture_local")||xe(s,"entity_picture")||xe(s,"album_art")||null),!n&&a&&(a==="smart"?s.media_title==="TV"||s.media_channel||s.app_id==="tv"||s.app_id==="androidtv"?n="data:image/svg+xml;base64,":n="data:image/svg+xml;base64,":typeof a=="string"&&(n=a)),n&&e&&!n.startsWith("http")&&(n=e+n),{url:n,sizePercentage:o}}function oo({idx:i,selected:e,playing:t,name:a,art:s,icon:r,pinned:n,holdToPin:o,maActive:l,onChipClick:c,onIconClick:u,onPinClick:d,onPointerDown:p,onPointerMove:_,onPointerUp:f,objectFit:g,quickGroupingState:y,onQuickGroupClick:k,onDoubleClick:x}){const M=g?`object-fit: ${g};`:"";return m`
  ...
  `}function co({onPin:i,onHoldEnd:e,holdTime:t=600,moveThreshold:a=8}){let s=null,r=null,n=null,o=!1;return{pointerDown:(l,c)=>{r=l.clientX,n=l.clientY,o=!1,s=setTimeout(()=>{o||(i(c,l),e&&e(c))},t)},pointerMove:(l,c)=>{if(s&&r!==null&&n!==null){const u=Math.abs(l.clientX-r),d=Math.abs(l.clientY-n);(u>a||d>a)&&(o=!0,clearTimeout(s),s=null)}},pointerUp:(l,c)=>{s&&(clearTimeout(s),s=null),r=null,n=null,o=!1}}}function fs({groupedSortedEntityIds:i,entityIds:e,selectedEntityId:t,pinnedIndex:a,holdToPin:s,getChipName:r,getActualGroupMaster:n,getIsChipPlaying:o,getChipArt:l,getIsMaActive:c,isIdle:u,hass:d,artworkHostname:p="",mediaArtworkOverrides:_=[],fallbackArtwork:f=null,onChipClick:g,onIconClick:y,onPointerClick:k,onPinClick:x,onPointerDown:M,onPointerMove:E,onPointerUp:G,quickGroupingMode:U,getQuickGroupingState:O,onQuickGroupClick:z,onDoubleClick:N}){return!i||!i.length?b:m`
    ${i.map(C=>{if(C.length>1){const I=n(C),R=e.indexOf(I),B=d?.states?.[I],te=typeof o=="function"?o(I,t===I):B?.state==="playing",ie=typeof l=="function"?l(I):_s(B,p,_,f),Z=ie?.url,ne=ie?.objectFit,oe=B?.attributes?.icon||"mdi:cast",Ae=typeof c=="function"?c(I):!1;return lo({idx:R,selected:t===I,playing:te,groupName:r(I)+(C.length>1?` [${C.length}]`:""),art:Z,icon:oe,pinned:a===R,holdToPin:s,maActive:Ae,onChipClick:g,onIconClick:y,onPinClick:x,onPointerDown:pe=>M(pe,R),onPointerMove:pe=>E(pe,R),onPointerUp:pe=>G(pe,R),objectFit:ne,quickGroupingState:U&&typeof O=="function"?O(I):null,onQuickGroupClick:z,onDoubleClick:N})}else{const I=C[0],R=e.indexOf(I),B=d?.states?.[I],te=typeof o=="function"?o(I,t===I):B?.state==="playing",ie=typeof l=="function"?l(I):_s(B,p,_,f),Z=ie?.url,ne=ie?.objectFit,oe=t===I?!u&&Z:te&&Z,Ae=B?.attributes?.icon||"mdi:cast",pe=typeof c=="function"?c(I):!1;return oo({idx:R,selected:t===I,playing:te,name:r(I),art:oe,icon:Ae,pinned:a===R,holdToPin:s,maActive:pe,onChipClick:g,onPinClick:x,onPointerDown:ae=>M(ae,R),onPointerMove:ae=>E(ae,R),onPointerUp:ae=>G(ae,R),objectFit:ne,quickGroupingState:U&&typeof O=="function"?O(I):null,onQuickGroupClick:z,onDoubleClick:N})}})}
        ...
        ${(n||[]).length===0&&!r?m`<div class="search-sheet-empty">${h("common.no_results")}</div>`:(n||[]).map(C=>{const I=tt(C.media_content_id),R=C.is_browsable&&(C.media_class!=="playlist"||G);return m`
                <div class="search-sheet-result ${M==="card"?"search-result-card":""}">
                  <div class="search-sheet-thumb-container" 
                    ...
                    `}
                    ${M==="card"?oi({item:C,onPlay:o,onOptionsToggle:y,upcomingFilterActive:p,isMusicAssistant:I,massQueueAvailable:G,searchView:"card",onMoveUp:U,onMoveDown:O,onMoveNext:z,onRemove:N}):b}
                  </div>
                  ...
                  ${M!=="card"?oi({item:C,onPlay:o,onOptionsToggle:y,upcomingFilterActive:p,isMusicAssistant:I,massQueueAvailable:G,searchView:"list",isInline:!0,onMoveUp:U,onMoveDown:O,onMoveNext:z,onRemove:N}):b}
                  
                  ${ys({item:C,activeSearchRowMenuId:f,successSearchRowMenuId:g,onPlayOption:k,onOptionsToggle:y,searchView:M,isQueueItem:I&&C.queue_item_id&&p&&G,onMoveUp:U,onMoveDown:O,onMoveNext:z,onRemove:N})}
                </div>
              `})}
      </div>
    </div>
        ...
        <div class="entity-options-container entity-options-container-opening">
          <div class="entity-options-sheet${d||f?" chips-mode":""} entity-options-sheet-opening" 
                      ...
                      <div class="chip-row search-filter-chips" id="search-filter-chip-row" style="margin-bottom:12px; justify-content: center; align-items: center;">
                        ...
                        ${v.map(H=>m`
                          <button
                            ...
                            style="
                              width: 72px;
                              background: ${D===H?this._customAccent:"#282828"};
                              opacity: ${D===H?"1":"0.8"};
                              font-weight: ${D===H?"bold":"normal"};
                            "
                            ?selected=${D===H}
            ...
            <div class="entity-options-search-results ${this.config.search_view==="card"?"search-results-card-view":"list-view"}" 
              ...
              ${(()=>{this._searchMediaClassFilter;const v=this._getDisplaySearchResults(),D=Math.max(15,this._searchTotalRows||v.length),H=[...v,...Array.from({length:Math.max(0,D-v.length)},()=>null)];return this._searchAttempted&&v.length===0&&!this._searchLoading?m`<div class="entity-options-search-empty" style="color: white;">No results.</div>`:H.map(L=>L?m`
                            ...
                            <div class="entity-options-search-result ${this.config.search_view==="card"?"search-result-card":""} ${L._justMoved?"just-moved":""} ${L.media_content_id!=null&&this._activeSearchRowMenuId===L.media_content_id?"menu-active":""}">
                               <div class="search-sheet-thumb-container"
                                ...
                                `}
                                ${this.config.search_view==="card"?oi({item:L,onPlay:F=>this._playMediaFromSearch(F),onOptionsToggle:F=>{this._activeSearchRowMenuId=F?.media_content_id||null,this.requestUpdate()},upcomingFilterActive:!!this._upcomingFilterActive,isMusicAssistant:this._isMusicAssistantEntity(),massQueueAvailable:this._massQueueAvailable,searchView:"card"}):b}
                               </div>
                               <div class="search-sheet-info">
                                <span class="${this._isClickableSearchResult(L)?"clickable-search-result":""} ${this.config.search_view==="card"?"search-sheet-title":""}"
                                 ...
                                 <span class="search-sheet-subtitle">
                                  ${(()=>{const F=this._searchMediaClassFilter==="track"||this._searchMediaClassFilter==="album",Se=!!this._recentlyPlayedFilterActive,$n=!!this._upcomingFilterActive,In=!!this._recommendationsFilterActive;return(F||Se||$n||In)&&L.artist?L.artist:L.media_class?L.media_class.charAt(0).toUpperCase()+L.media_class.slice(1):""})()}
                                </span>
              ...
              `:this._showGrouping?this._renderGroupingSheet():m`
                ...
                <div class="floating-source-index">
                  ${pe.map((v,D)=>{const H=Ae.has(v),L=this._hoveredSourceLetterIndex;let F="";if(H&&L!==null&&L!==void 0){const Se=Math.abs(L-D);Se===0?F="max":Se===1?F="large":Se===2&&(F="med")}return m`
                      <button
                        class="source-index-letter"
                        ?disabled=${!H}
                        data-scale=${F}
                        @mouseenter=${H?()=>{this._hoveredSourceLetterIndex=D,this.requestUpdate()}:b}
            ...
            ${Ba?m`
              <div class="persistent-media-controls" @click=${v=>v.stopPropagation()}>
                <div class="persistent-controls-artwork">
                  ${(()=>{const v=this.currentPlaybackStateObj,D=this.currentStateObj,H=this._getArtworkUrl(v)||this._getArtworkUrl(D);return H?.url&&this._isValidArtworkUrl(H.url)?m`
                ...
                ${(()=>{const v=this._selectedIndex,D=this._getVolumeEntity(v);if(!D)return b;const H=D.startsWith&&D.startsWith("remote."),L=this.currentVolumeStateObj,F=Number(L?.attributes?.volume_level??0),Se=H?null:`${Math.round((F||0)*100)}%`;return this.config.volume_mode==="hidden"?b:m`
