 ...
 */const so=io(class extends ao{constructor(i){if(super(i),i.type!==to.ATTRIBUTE||i.name!=="class"||i.strings?.length>2)throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(i){return" "+Object.keys(i).filter((e=>i[e])).join(" ")+" "}update(i,[e]){if(this.st===void 0){this.st=new Set,i.strings!==void 0&&(this.nt=new Set(i.strings.join(" ").split(/\s/).filter((a=>a!==""))));for(const a in e)e[a]&&!this.nt?.has(a)&&this.st.add(a);return this.render(e)}const t=i.element.classList;for(const a of this.st)a in e||(t.remove(a),this.st.delete(a));for(const a in e){const s=!!e[a];s===this.st.has(a)||this.nt?.has(a)||(s?(t.add(a),this.st.add(a)):(t.remove(a),this.st.delete(a)))}return Xe}});function xe(i,e){const t=i?.[e];return typeof t=="string"&&t.trim()!==""?t:null}async function ro(i,e,t){if(!e||typeof e!="string")return t;if(!e.includes("{{")&&!e.includes("{%"))return e;try{const a=(await i.callApi("POST","template",{template:e})||"").toString().trim();return a&&/^([a-z_]+)\.[A-Za-z0-9_]+$/.test(a)?a:t}catch{return t}}async function no(i,e,t={}){if(!e||typeof e!="string")return e;if(!e.includes("{{")&&!e.includes("{%")){if(/%7B%7B|%7B%25/i.test(e))try{e=decodeURIComponent(e)}catch{}if(!e.includes("{{")&&!e.includes("{%"))return e}let a=e;t&&Object.keys(t).length>0&&(a=`${Object.entries(t).map(([s,r])=>`{% set ${s} = ${JSON.stringify(r)} %}`).join(" ")} ${e}`);try{return(await i.callApi("POST","template",{template:a})||"").toString().trim()}catch(s){return console.warn("yamp: Error resolving template:",e,s),e}}function oo(i,e,t={}){if(!e||typeof e!="string")return e;let a=e;if(/%7B%7B|%7B%25/i.test(a))try{a=decodeURIComponent(a)}catch{}if(!a.includes("{{")&&!a.includes("{%"))return a;let s=a,r=!0;return s=s.replace(/\{\{\s*(.*?)\s*\}\}/g,(n,o)=>{let l=o.trim(),c=!1;l.endsWith("| urlencode")?(c=!0,l=l.replace(/\|\s*urlencode$/,"").trim()):l.endsWith("|urlencode")&&(c=!0,l=l.replace(/\|urlencode$/,"").trim());let u=l.match(/^state_attr\(\s*(['"]?)([\w.]+)\1\s*,\s*(['"]?)([\w_]+)\3\s*\)$/);if(u){let p=u[2],_=t[p]!==void 0&&!u[1]?t[p]:p,f=u[4];const g=i?.states?.[_];if(g&&g.attributes&&g.attributes[f]!==void 0){let b=String(g.attributes[f]);return c?encodeURIComponent(b):b}return""}let d=l.match(/^states\(\s*(['"]?)([\w.]+)\1\s*\)$/);if(d){let p=d[2],_=t[p]!==void 0&&!d[1]?t[p]:p;const f=i?.states?.[_];if(f&&f.state!==void 0){let g=String(f.state);return c?encodeURIComponent(g):g}return""}if(/^[\w_]+$/.test(l)&&t[l]!==void 0){let p=String(t[l]);return c?encodeURIComponent(p):p}return r=!1,n}),!r||s.includes("{%")?null:s}function lo(i,e){if(!i?.states||!e)return[];const t=[],a=i.states[e];if(!a)return[];const s=a.attributes?.device_id,r=a.attributes?.friendly_name||e;for(const[n,o]of Object.entries(i.states))if(n.startsWith("button.")&&o.attributes){const l=o.attributes.device_id,c=o.attributes.friendly_name||n;s&&l===s?t.push({entity_id:n,friendly_name:c,device_class:o.attributes.device_class,reason:"same_device"}):(c.toLowerCase().includes(r.toLowerCase())||r.toLowerCase().includes(c.toLowerCase()))&&t.push({entity_id:n,friendly_name:c,device_class:o.attributes.device_class,reason:"name_similarity"})}return t}function co(i,e){if(!i?.states||!e)return null;const t=i.states[e];return t&&t.attributes&&(t.attributes.media_content_id||t.attributes.media_content_type||t.attributes.media_album_name||t.attributes.media_artist||t.attributes.media_title)?t:null}function tt(i){return!i||!i.attributes?!1:i.attributes.app_id==="music_assistant"||i.attributes.mass_player_type!==void 0}function uo(i){if(!i)return"";const e=i.media_type||i.media_class||i.media_content_type,t=i.name||i.title||i.media_title||"Unknown Title",a=i.artists?.[0],s=i.artist||a?.name||(typeof a=="string"?a:void 0)||i.media_artist||"Unknown Artist";return e==="track"?`${t} - ${s}`:e==="album"?`${t} - ${s}`:t}function fs(i,e="",t=[],a=null){if(!i||!i.attributes)return null;const s=i.attributes,r=i.entity_id;s.app_id;let n=null,o=null;if(t&&Array.isArray(t)&&t.length){const l=(d,p)=>{if(d)return d[p]},c=[["media_title","media_title"],["media_artist","media_artist"],["media_album_name","media_album_name"],["media_content_id","media_content_id"],["media_channel","media_channel"],["app_name","app_name"],["media_content_type","media_content_type"],["entity_id","entity_id"],["entity_state","entity_state"]];let u=t.find(d=>c.some(([p,_])=>{const f=l(d,_);return f===void 0?!1:(p==="entity_id"?r:p==="entity_state"?i?.state:s[p])===f}));u||xe(s,"entity_picture_local")||xe(s,"entity_picture")||xe(s,"album_art")||(u=t.find(d=>d?.missing_art_url),u?.missing_art_url&&(u={...u,image_url:u.missing_art_url})),u?.image_url&&(n=u.image_url,o=u?.size_percentage)}return n||(n=xe(s,"entity_picture_local")||xe(s,"entity_picture")||xe(s,"album_art")||null),!n&&a&&(a==="smart"?s.media_title==="TV"||s.media_channel||s.app_id==="tv"||s.app_id==="androidtv"?n="data:image/svg+xml;base64,":n="data:image/svg+xml;base64,":typeof a=="string"&&(n=a)),n&&e&&!n.startsWith("http")&&(n=e+n),{url:n,sizePercentage:o}}function ho({idx:i,selected:e,playing:t,name:a,art:s,icon:r,pinned:n,holdToPin:o,maActive:l,onChipClick:c,onIconClick:u,onPinClick:d,onPointerDown:p,onPointerMove:_,onPointerUp:f,objectFit:g,quickGroupingState:b,onQuickGroupClick:k,onDoubleClick:x}){const j=g?`object-fit: ${g};`:"";return m`
    <button class="chip"
      ...
      <span class="chip-icon">
        ${s?m`<img class="chip-mini-art" src="${s}" style="${j}" onerror="this.style.display='none'" />`:m`<ha-icon .icon=${r} style="font-size:28px;"></ha-icon>`}
      </span>
  ...
  `}function po({idx:i,selected:e,playing:t,groupName:a,art:s,icon:r,pinned:n,holdToPin:o,maActive:l,onChipClick:c,onIconClick:u,onPinClick:d,onPointerDown:p,onPointerMove:_,onPointerUp:f,objectFit:g,quickGroupingState:b,onQuickGroupClick:k,onDoubleClick:x}){const j=g?`object-fit: ${g};`:"";return m`
  ...
  `}function _o({onPin:i,onHoldEnd:e,holdTime:t=600,moveThreshold:a=8}){let s=null,r=null,n=null,o=!1;return{pointerDown:(l,c)=>{r=l.clientX,n=l.clientY,o=!1,s=setTimeout(()=>{o||(i(c,l),e&&e(c))},t)},pointerMove:(l,c)=>{if(s&&r!==null&&n!==null){const u=Math.abs(l.clientX-r),d=Math.abs(l.clientY-n);(u>a||d>a)&&(o=!0,clearTimeout(s),s=null)}},pointerUp:(l,c)=>{s&&(clearTimeout(s),s=null),r=null,n=null,o=!1}}}function vs({groupedSortedEntityIds:i,entityIds:e,selectedEntityId:t,pinnedIndex:a,holdToPin:s,getChipName:r,getActualGroupMaster:n,getIsChipPlaying:o,getChipArt:l,getIsMaActive:c,isIdle:u,hass:d,artworkHostname:p="",mediaArtworkOverrides:_=[],fallbackArtwork:f=null,onChipClick:g,onIconClick:b,onPointerClick:k,onPinClick:x,onPointerDown:j,onPointerMove:E,onPointerUp:R,quickGroupingMode:z,getQuickGroupingState:M,onQuickGroupClick:N,onDoubleClick:L}){return!i||!i.length?y:m`
    ${i.map(B=>{if(B.length>1){const C=n(B),S=e.indexOf(C),G=d?.states?.[C],Q=typeof o=="function"?o(C,t===C):G?.state==="playing",X=typeof l=="function"?l(C):fs(G,p,_,f),K=X?.url,ne=X?.objectFit,oe=G?.attributes?.icon||"mdi:cast",Ae=typeof c=="function"?c(C):!1;return po({idx:S,selected:t===C,playing:Q,groupName:r(C)+(B.length>1?` [${B.length}]`:""),art:K,icon:oe,pinned:a===S,holdToPin:s,maActive:Ae,onChipClick:g,onIconClick:b,onPinClick:x,onPointerDown:pe=>j(pe,S),onPointerMove:pe=>E(pe,S),onPointerUp:pe=>R(pe,S),objectFit:ne,quickGroupingState:z&&typeof M=="function"?M(C):null,onQuickGroupClick:N,onDoubleClick:L})}else{const C=B[0],S=e.indexOf(C),G=d?.states?.[C],Q=typeof o=="function"?o(C,t===C):G?.state==="playing",X=typeof l=="function"?l(C):fs(G,p,_,f),K=X?.url,ne=X?.objectFit,oe=t===C?!u&&K:Q&&K,Ae=G?.attributes?.icon||"mdi:cast",pe=typeof c=="function"?c(C):!1;return ho({idx:S,selected:t===C,playing:Q,name:r(C),art:oe,icon:Ae,pinned:a===S,holdToPin:s,maActive:pe,onChipClick:g,onPinClick:x,onPointerDown:ae=>j(ae,S),onPointerMove:ae=>E(ae,S),onPointerUp:ae=>R(ae,S),objectFit:ne,quickGroupingState:z&&typeof M=="function"?M(C):null,onQuickGroupClick:N,onDoubleClick:L})}})}
...
`,Io=[{mode:"replace",icon:"mdi:playlist-remove",label:h("search.replace")},{mode:"next",icon:"mdi:playlist-play",label:h("search.play_next")},{mode:"replace_next",icon:"mdi:playlist-music",label:h("search.replace_play")},{mode:"add",icon:"mdi:playlist-plus",label:h("search.add_queue")},{mode:"add_to_playlist",icon:"mdi:plus",label:h("search.add_to_playlist")}],Mt=["artist","album","track","playlist","radio","podcast","audiobook"];function bs(i){return i&&(i.media_class==="track"||i.media_content_type==="track")}const Ne=(i,{cap:e,floor:t}={})=>{const a=Number(i);if(!Number.isFinite(a)||a<=0)return;let s=a;return typeof t=="number"&&(s=Math.max(t,s)),typeof e=="number"&&(s=Math.min(e,s)),s},xs=3e4;let Ft=null,Ki=0;async function oi(i){const e=Date.now();if(Ft&&e-Ki<xs)return Ft;try{return Ft=(await i.callApi("GET","config/config_entries/entry")).find(t=>t.domain==="music_assistant"&&t.state==="loaded")?.entry_id||null,Ki=e,Ft}catch(t){return console.error("yamp: Failed to resolve Music Assistant config entry",t),Ft=null,Ki=e,null}}let jt=null,Xi=0;async function Ji(i){const e=Date.now();if(jt&&e-Xi<xs)return jt;try{return jt=(await i.callApi("GET","config/config_entries/entry")).find(t=>t.domain==="mass_queue"&&t.state==="loaded")?.entry_id||null,Xi=e,jt}catch(t){return console.error("yamp: Failed to resolve mass_queue config entry",t),jt=null,Xi=e,null}}function ct(i){return i?{title:i.name,media_content_id:i.uri,media_content_type:i.media_type,media_class:i.media_type,item_id:i.item_id,thumbnail:i.image,...i.artists&&{artist:i.artists.map(e=>e.name).join(", ")},...i.album&&{album:i.album.name},is_browsable:i.media_type==="artist"||i.media_type==="album"||i.media_type==="playlist",is_editable:i.is_editable===!0}:null}function li({item:i,onPlay:e,onOptionsToggle:t,upcomingFilterActive:a=!1,isMusicAssistant:s=!1,massQueueAvailable:r=!1,searchView:n="list",isInline:o=!1,onMoveUp:l,onMoveDown:c,onMoveNext:u,onRemove:d}){const p=!!(a&&i.queue_item_id&&s&&r),_=o?"entity-options-search-buttons":n==="card"?"card-overlay-buttons":"search-sheet-buttons",f=o?"entity-options-search-play":n==="card"?"search-sheet-play icon-only":"search-sheet-play",g=o?"entity-options-search-queue":n==="card"?"search-sheet-queue icon-only":"search-sheet-queue";return m`
  ...
  `}function Co({open:i,query:e,onQueryInput:t,onSearch:a,onClose:s,loading:r,results:n,onPlay:o,onQueue:l,error:c,showQueueSuccess:u,matchTheme:d=!1,upcomingFilterActive:p=!1,disableAutofocus:_=!1,loadingSearchRowMenuId:f,activeSearchRowMenuId:g,successSearchRowMenuId:b,successSearchRowType:k,onOptionsToggle:x,onPlayOption:j,onResultClick:E,searchView:R="list",searchCardColumns:z=4,massQueueAvailable:M=!1,onMoveUp:N,onMoveDown:L,onMoveNext:B,onRemove:C}){return i?m`
    <div class="search-sheet" data-match-theme="${d}" data-card-view="${R==="card"}">
      ...
      <div class="search-sheet-results ${R==="card"?"search-results-card-view":"list-view"}">
        ${(n||[]).length===0&&!r?m`<div class="search-sheet-empty">${h("common.no_results")}</div>`:(n||[]).map(S=>{const G=tt(S.media_content_id),Q=S.is_browsable&&(S.media_class!=="playlist"||M);return m`
                <div class="search-sheet-result ${R==="card"?"search-result-card":""}">
                  <div class="search-sheet-thumb-container" 
                       data-clickable="${R==="card"}"
                       @click=${R==="card"?()=>o(S):null}>
                    ${S.thumbnail&&!String(S.thumbnail).includes("imageproxy")?m`
                      <img
                    ...
                    `}
                    ${R==="card"?li({item:S,onPlay:o,onOptionsToggle:x,upcomingFilterActive:p,isMusicAssistant:G,massQueueAvailable:M,searchView:"card",onMoveUp:N,onMoveDown:L,onMoveNext:B,onRemove:C}):y}
                  </div>
                  <div class="search-sheet-info">
                    ...
                    `:y}
                    ${R==="card"?m`
                      <div class="card-menu-button" @click=${X=>{X.preventDefault(),X.stopPropagation(),x(S)}}>
                        <ha-icon icon="mdi:dots-vertical"></ha-icon>
                      </div>
                    `:y}
                  </div>
                  ${R!=="card"?li({item:S,onPlay:o,onOptionsToggle:x,upcomingFilterActive:p,isMusicAssistant:G,massQueueAvailable:M,searchView:"list",isInline:!0,onMoveUp:N,onMoveDown:L,onMoveNext:B,onRemove:C}):y}
                  
                  ${ws({item:S,activeSearchRowMenuId:g,onPlayOption:j,onOptionsToggle:x,searchView:R,isQueueItem:G&&S.queue_item_id&&p&&M,massQueueAvailable:M,onMoveUp:N,onMoveDown:L,onMoveNext:B,onRemove:C})}

                  ${f===S.media_content_id?m`
                  ...
                  ${b===S.media_content_id?m`
                    <div class="search-row-success-overlay">
                      <span>✅</span>
                      <span>${h(k==="playlist"?"search.added_to_playlist":"search.added")}</span>
                    </div>
                  `:y}
                </div>
              `})}
...
`,e-1))}function Gl(i,e,t){var a,s,r,n,o,l,c,u,d=i.kind,p=i.result,_;if(_=i.input.charCodeAt(i.position),me(_)||dt(_)||_===35||_===38||_===42||_===33||_===124||_===62||_===39||_===34||_===37||_===64||_===96||(_===63||_===45)&&(s=i.input.charCodeAt(i.position+1),me(s)||t&&dt(s)))return!1;for(i.kind="scalar",i.result="",r=n=i.position,o=!1;_!==0;){if(_===58){if(s=i.input.charCodeAt(i.position+1),me(s)||t&&dt(s))break}else if(_===35){if(a=i.input.charCodeAt(i.position-1),me(a))break}else{if(i.position===i.lineStart&&hi(i)||t&&dt(_))break;if($e(_))if(l=i.line,c=i.lineStart,u=i.lineIndent,J(i,!1,-1),i.lineIndent>=e){o=!0,_=i.input.charCodeAt(i.position);continue}else{i.position=n,i.line=l,i.lineStart=c,i.lineIndent=u;break}}o&&(Ue(i,r,n,!1),oa(i,i.line-l),r=n=i.position,o=!1),it(_)||(n=i.position+1),_=i.input.charCodeAt(++i.position)}return Ue(i,r,n,!1),i.result?!0:(i.kind=d,i.result=p,!1)}function Hl(i,e){var t,a,s;if(t=i.input.charCodeAt(i.position),t!==39)return!1;for(i.kind="scalar",i.result="",i.position++,a=s=i.position;(t=i.input.charCodeAt(i.position))!==0;)if(t===39)if(Ue(i,a,i.position,!0),t=i.input.charCodeAt(++i.position),t===39)a=i.position,i.position++,s=i.position;else return!0;else $e(t)?(Ue(i,a,s,!0),oa(i,J(i,!1,e)),a=s=i.position):i.position===i.lineStart&&hi(i)?A(i,"unexpected end of the document within a single quoted scalar"):(i.position++,s=i.position);A(i,"unexpected end of the stream within a single quoted scalar")}function Vl(i,e){var t,a,s,r,n,o;if(o=i.input.charCodeAt(i.position),o!==34)return!1;for(i.kind="scalar",i.result="",i.position++,t=a=i.position;(o=i.input.charCodeAt(i.position))!==0;){if(o===34)return Ue(i,t,i.position,!0),i.position++,!0;if(o===92){if(Ue(i,t,i.position,!0),o=i.input.charCodeAt(++i.position),$e(o))J(i,!1,e);else if(o<256&&tr[o])i.result+=ir[o],i.position++;else if((n=Nl(o))>0){for(s=n,r=0;s>0;s--)o=i.input.charCodeAt(++i.position),(n=Ll(o))>=0?r=(r<<4)+n:A(i,"expected hexadecimal character");i.result+=Ul(r),i.position++}else A(i,"unknown escape sequence");t=a=i.position}else $e(o)?(Ue(i,t,a,!0),oa(i,J(i,!1,e)),t=a=i.position):i.position===i.lineStart&&hi(i)?A(i,"unexpected end of the document within a double quoted scalar"):(i.position++,a=i.position)}A(i,"unexpected end of the stream within a double quoted scalar")}function Ql(i,e){var t=!0,a,s,r,n=i.tag,o,l=i.anchor,c,u,d,p,_,f=Object.create(null),g,b,k,x;if(x=i.input.charCodeAt(i.position),x===91)u=93,_=!1,o=[];else if(x===123)u=125,_=!0,o={};else return!1;for(i.anchor!==null&&(i.anchorMap[i.anchor]=o),x=i.input.charCodeAt(++i.position);x!==0;){if(J(i,!0,e),x=i.input.charCodeAt(i.position),x===u)return i.position++,i.tag=n,i.anchor=l,i.kind=_?"mapping":"sequence",i.result=o,!0;t?x===44&&A(i,"expected the node content, but found ','"):A(i,"missed comma between flow collection entries"),b=g=k=null,d=p=!1,x===63&&(c=i.input.charCodeAt(i.position+1),me(c)&&(d=p=!0,i.position++,J(i,!0,e))),a=i.line,s=i.lineStart,r=i.position,pt(i,e,ci,!1,!0),b=i.tag,g=i.result,J(i,!0,e),x=i.input.charCodeAt(i.position),(p||i.line===a)&&x===58&&(d=!0,x=i.input.charCodeAt(++i.position),J(i,!0,e),pt(i,e,ci,!1,!0),k=i.result),_?ht(i,o,f,b,g,k,a,s,r):d?o.push(ht(i,null,f,b,g,k,a,s,r)):o.push(g),J(i,!0,e),x=i.input.charCodeAt(i.position),x===44?(t=!0,x=i.input.charCodeAt(++i.position)):t=!1}A(i,"unexpected end of the stream within a flow collection")}function Wl(i,e){var t,a,s=ra,r=!1,n=!1,o=e,l=0,c=!1,u,d;if(d=i.input.charCodeAt(i.position),d===124)a=!1;else if(d===62)a=!0;else return!1;for(i.kind="scalar",i.result="";d!==0;)if(d=i.input.charCodeAt(++i.position),d===43||d===45)ra===s?s=d===43?Ys:Pl:A(i,"repeat of a chomping mode identifier");else if((u=ql(d))>=0)u===0?A(i,"bad explicit indentation width of a block scalar; it cannot be less than one"):n?A(i,"repeat of an indentation width identifier"):(o=e+u-1,n=!0);else break;if(it(d)){do d=i.input.charCodeAt(++i.position);while(it(d));if(d===35)do d=i.input.charCodeAt(++i.position);while(!$e(d)&&d!==0)}for(;d!==0;){for(na(i),i.lineIndent=0,d=i.input.charCodeAt(i.position);(!n||i.lineIndent<o)&&d===32;)i.lineIndent++,d=i.input.charCodeAt(++i.position);if(!n&&i.lineIndent>o&&(o=i.lineIndent),$e(d)){l++;continue}if(i.lineIndent<o){s===Ys?i.result+=ie.repeat(`
...
{% endif %}</pre>
    ...
    `}_renderGroupingMenuOption(){if(this.entityIds.length<=1)return y;const e=this.entityIds.reduce((n,o,l)=>{const c=this._getGroupingEntityId(l),u=this.hass.states[c];return n+(this._isGroupCapable(u)?1:0)},0),t=this._getGroupingEntityId(this._selectedIndex),a=this.hass.states[t],s=this.currentEntityId,r=this._getGroupKey(s)!==s;return e>1&&this._isGroupCapable(a)&&!r?m`
      ...
      <div class="group-list-scroll">
        ...
        `:f.map(g=>{const b=g.id,k=g.groupId,x=(Array.isArray(s?.attributes?.group_members)?s.attributes.group_members:[]).includes(k),j=this.getChipName(b),E=g.isBusy,R=g.busyLabel,z=this.entityIds.indexOf(b),M=this._getVolumeEntityForGrouping(z)||k,N=this.hass.states[M],L=M?.startsWith&&M.startsWith("remote."),B=Number(N?.attributes?.volume_level||0),C=b===e,S=!C;let G=h(r?C?"card.grouping.master":x?"card.grouping.joined":"card.grouping.available":b===l?"card.grouping.current":"card.grouping.available");return E&&(G=R||"Unavailable"),m`
            ...
            ">
              <div style="flex:1; min-width:120px;">
                <div style="font-weight:600; text-align:left;">${j}</div>
              ...
              <div style="flex:1.8;display:flex;align-items:center;gap:4px;margin:0 6px; min-width:160px;">
                ${L?m`
                    <div class="vol-stepper" style="display:flex;align-items:center;gap:4px;">
                      <button @click=${()=>this._onGroupVolumeStep(M,-1)} title="Vol Down" style="background:none;border:none;padding:0;width:28px;height:28px;display:flex;align-items:center;justify-content:center;color:inherit;">
                        <ha-icon icon="mdi:minus"></ha-icon>
                      </button>
                      <button @click=${()=>this._onGroupVolumeStep(M,1)} title="Vol Up" style="background:none;border:none;padding:0;width:28px;height:28px;display:flex;align-items:center;justify-content:center;color:inherit;">
                  ...
                  `:m`
                    <input
                      ...
                      step="0.01"
                      .value=${B}
                      @change=${Q=>this._onGroupVolumeChange(b,M,Q)}
                      title="Volume"
          ...
          >
            ...
            <div class="card-lower-content-container" style="${Za?`min-height:${Za}px;`:""}">
              <div class="card-lower-content-bg"
                style="${(()=>{const v=[];return Oa&&Xa?v.push("background-image: none","filter: none"):v.push(Ja),v.push(`min-height: ${W?Qe?`${this._collapsedBaselineHeight||220}px`:"0px":"350px"}`),v.push("transition: min-height 0.4s cubic-bezier(0.6,0,0.4,1), background 0.4s"),v.join("; ")})()}"
              ></div>
              ...
              <div class="card-lower-content${W?" collapsed transitioning":" transitioning"}${W&&le?" has-artwork":""}" style="${Qe?W?`min-height: ${this._collapsedBaselineHeight||220}px;`:"min-height: 350px;":""}">
                ${W&&le&&this._isValidArtworkUrl(le)?m`
                  <div
                ...
                <div class="details" style="${(()=>{const v=[];return this._showEntityOptions&&v.push("visibility:hidden"),v.push(`min-height:${An}px`),Re||v.push("opacity:0"),v.join(";")})()}">
                  ...
                  <div
                      class="artist ${Re&&N.attributes.media_artist?"clickable-artist":""}"
                      @click=${()=>{Re&&N.attributes.media_artist&&this._searchArtistFromNowPlaying()}}
                      title=${Re&&N.attributes.media_artist?h("search.search_artist"):""}
                    >${Re&&Na?Na:m`&nbsp;`}</div>
                </div>
                ...
                ${W||this._alternateProgressBar?ni(Ye&&St?{progress:Ua,collapsed:!0,accent:this._customAccent,style:this._showEntityOptions?"visibility:hidden":""}:{progress:0,collapsed:!0,accent:this._customAccent,style:"visibility:hidden"}):y}
                ${!Qe&&Di>0?m`
        ...
        <div class="entity-options-container entity-options-container-opening">
          <div class="entity-options-sheet${d||f?" chips-mode":""} entity-options-sheet-opening" 
            ...
            <div class="entity-options-search-results ${this.config.search_view==="card"?"search-results-card-view":"list-view"}" 
              ...
              ${(()=>{this._searchMediaClassFilter;const v=this._getDisplaySearchResults(),P=Math.max(15,this._searchTotalRows||v.length),H=[...v,...Array.from({length:Math.max(0,P-v.length)},()=>null)];return this._searchAttempted&&v.length===0&&!this._searchLoading?m`<div class="entity-options-search-empty">${h("common.no_results")}</div>`:H.map(q=>q?m`
                            <!-- EXISTING non‑placeholder row markup -->
                            <div class="entity-options-search-result ${this.config.search_view==="card"?"search-result-card":""} ${q._justMoved?"just-moved":""} ${q.media_content_id!=null&&this._activeSearchRowMenuId===q.media_content_id?"menu-active":""}">
                               <div class="search-sheet-thumb-container"
                                    data-clickable="${this.config.search_view==="card"}"
                                    @click=${this.config.search_view==="card"?()=>this._playMediaFromSearch(q):null}>
                                ${q.thumbnail&&this._isValidArtworkUrl(q.thumbnail)&&!String(q.thumbnail).includes("imageproxy")?m`
                                   <img
                                ...
                                `}
                                ${this.config.search_view==="card"?li({item:q,onPlay:F=>this._playMediaFromSearch(F),onOptionsToggle:F=>{this._activeSearchRowMenuId=F?.media_content_id||null,this.requestUpdate()},upcomingFilterActive:!!this._upcomingFilterActive,isMusicAssistant:this._isMusicAssistantEntity(),massQueueAvailable:this._massQueueAvailable,searchView:"card"}):y}
                               </div>
                               <div class="search-sheet-info">
                                <span class="${this._isClickableSearchResult(q)?"clickable-search-result":""} ${this.config.search_view==="card"?"search-sheet-title":""}"
                                      @touchstart=${F=>this._handleSearchResultTouch(q,F)}
                                      @click=${()=>this._handleSearchResultClick(q)}
                                      title=${this._getSearchResultClickTitle(q)}>
                                  ${q.title}
                                </span>
                                 <span class="search-sheet-subtitle">
                                  ${(()=>{const F=this._searchMediaClassFilter==="track"||this._searchMediaClassFilter==="album",Se=!!this._recentlyPlayedFilterActive,Mn=!!this._upcomingFilterActive,Fn=!!this._recommendationsFilterActive;return(F||Se||Mn||Fn)&&q.artist?q.artist:q.media_class?q.media_class.charAt(0).toUpperCase()+q.media_class.slice(1):""})()}
                                </span>
                                ${this.config.search_view==="card"?m`
                                  <div class="card-menu-button" @click=${F=>{F.preventDefault(),F.stopPropagation(),this._activeSearchRowMenuId=q.media_content_id,this.requestUpdate()}}>
                                    <ha-icon icon="mdi:dots-vertical"></ha-icon>
                                  </div>
                                `:y}
                              </div>
                              ${this.config.search_view!=="card"?li({item:q,onPlay:F=>this._playMediaFromSearch(F),onOptionsToggle:F=>{this._activeSearchRowMenuId=F?.media_content_id||null,this.requestUpdate()},upcomingFilterActive:!!this._upcomingFilterActive,isMusicAssistant:this._isMusicAssistantEntity(),massQueueAvailable:this._massQueueAvailable,searchView:"list",isInline:!0,onMoveUp:F=>this._moveQueueItemUp(F.queue_item_id),onMoveDown:F=>this._moveQueueItemDown(F.queue_item_id),onMoveNext:F=>this._moveQueueItemNext(F.queue_item_id),onRemove:F=>this._removeQueueItem(F.queue_item_id)}):y}

                                ${ws({item:q,activeSearchRowMenuId:this._activeSearchRowMenuId,loadingSearchRowMenuId:this._loadingSearchRowMenuId,onPlayOption:(F,Se)=>this._performSearchOptionAction(F,Se),onOptionsToggle:F=>{this._activeSearchRowMenuId=F?.media_content_id||null,this.requestUpdate()},searchView:this.config.search_view,isQueueItem:this._isMusicAssistantEntity()&&q.queue_item_id&&!!this._upcomingFilterActive&&this._massQueueAvailable,massQueueAvailable:this._massQueueAvailable,onMoveUp:F=>this._moveQueueItemUp(F.queue_item_id),onMoveDown:F=>this._moveQueueItemDown(F.queue_item_id),onMoveNext:F=>this._moveQueueItemNext(F.queue_item_id),onRemove:F=>this._removeQueueItem(F.queue_item_id)})}

                        ${this._loadingSearchRowMenuId===q.media_content_id?m`
                          <div class="search-row-loading-overlay">
                            <ha-icon icon="mdi:loading" class="spin"></ha-icon>
                            <span>${h("common.loading")}</span>
                          </div>
                        ...
                        ${this._successSearchRowMenuId===q.media_content_id?m`
                          <div class="search-row-success-overlay">
                            <span>✅</span>
              ...
              `:this._showGrouping?this._renderGroupingSheet():m`
                ...
                <div class="floating-source-index">
                  ${pe.map((v,P)=>{const H=Ae.has(v),q=this._hoveredSourceLetterIndex;let F="";if(H&&q!==null&&q!==void 0){const Se=Math.abs(q-P);Se===0?F="max":Se===1?F="large":Se===2&&(F="med")}return m`
                      <button
...
`}
            ...
            ${Ha?m`
              <div class="persistent-media-controls" @click=${v=>v.stopPropagation()}>
                ...
                ${(()=>{const v=this._selectedIndex,P=this._getVolumeEntity(v);if(!P)return y;const H=P.startsWith&&P.startsWith("remote."),q=this.currentVolumeStateObj,F=Number(q?.attributes?.volume_level??0),Se=H?null:`${Math.round((F||0)*100)}%`;return this.config.volume_mode==="hidden"?y:m`
