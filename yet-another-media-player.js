...
var _templateObject$9, _templateObject2$8, _templateObject3$7, _templateObject4$5, _templateObject5$5, _templateObject6$5, _templateObject7$5, _templateObject8$5, _templateObject9$4, _templateObject0$4, _templateObject1$4;
...
function renderGroupChip(_ref3) {
  ...
  }, art ? x(_templateObject7$5 || (_templateObject7$5 = _taggedTemplateLiteral(["<img class=\"chip-mini-art\"\n                      src=\"", "\"\n                      style=\"cursor:pointer;", "\"\n                      onerror=\"this.style.display='none'\"\n                      @click=", "/>"])), art, artStyle, e => {
    e.stopPropagation();
    if (onIconClick) {
      onIconClick(idx, e);
    }
  }) : x(_templateObject8$5 || (_templateObject8$5 = _taggedTemplateLiteral(["<ha-icon .icon=", "\n                          style=\"font-size:28px;cursor:pointer;\"\n                          @click=", "></ha-icon>"])), icon, e => {
    e.stopPropagation();
    if (onIconClick) {
      onIconClick(idx, e);
    }
...
var _templateObject$1, _templateObject2$1, _templateObject3$1, _templateObject4$1, _templateObject5$1, _templateObject6$1, _templateObject7$1, _templateObject8$1, _templateObject9$1, _templateObject0$1, _templateObject1$1, _templateObject10$1, _templateObject11$1, _templateObject12$1, _templateObject13$1, _templateObject14$1, _templateObject15$1, _templateObject16$1, _templateObject17$1, _templateObject18$1, _templateObject19$1, _templateObject20$1, _templateObject21$1, _templateObject22$1, _templateObject23$1, _templateObject24$1, _templateObject25$1, _templateObject26$1, _templateObject27$1, _templateObject28$1, _templateObject29$1, _templateObject30$1, _templateObject31$1, _templateObject32$1, _templateObject33$1, _templateObject34$1, _templateObject35$1, _templateObject36$1, _templateObject37$1, _templateObject38$1, _templateObject39$1, _templateObject40$1, _templateObject41$1, _templateObject42$1, _templateObject43$1;
...
class YetAnotherMediaPlayerEditor extends i$2 {
  ...
  _renderArtworkTab() {
    ...
    }, this._useIdleImageUrl ? x(_templateObject7$1 || (_templateObject7$1 = _taggedTemplateLiteral(["\n                <ha-textfield\n                  class=\"full-width\"\n                  placeholder=\"e.g., https://example.com/image.jpg or /local/custom/image.jpg\"\n                  .value=", "\n                  @input=", "\n                  helper=\"Enter a direct URL to an image or a local file path\"\n                  .helperPersistent=", "\n                ></ha-textfield>\n              "])), (_this$_config$idle_im = this._config.idle_image) !== null && _this$_config$idle_im !== void 0 ? _this$_config$idle_im : "", e => this._updateConfig("idle_image", e.target.value), true) : x(_templateObject8$1 || (_templateObject8$1 = _taggedTemplateLiteral(["\n                <ha-generic-picker\n                  class=\"full-width\"\n                  .hass=", "\n                  .value=", "\n                  .label=", "\n                  .valueRenderer=", "\n                  .rowRenderer=", "\n                  .getItems=", "\n                  @value-changed=", "\n                  allow-custom-value\n                ></ha-generic-picker>\n              "])), this.hass, (_this$_config$idle_im2 = this._config.idle_image) !== null && _this$_config$idle_im2 !== void 0 ? _this$_config$idle_im2 : "", "Idle Image Entity", v => this._entityValueRenderer(v), item => this._entityRowRenderer(item), this._getEntityItems(["camera", "image"]), e => this._updateConfig("idle_image", e.detail.value)), e => this._onArtworkMoved(e), overrides.length ? overrides.map((rule, idx) => {
    ...
    }) : x(_templateObject11$1 || (_templateObject11$1 = _taggedTemplateLiteral(["<div class=\"config-subtitle\" style=\"padding:12px 0;text-align:center;\">No artwork overrides configured. Use the plus button below to add one.</div>"]))), this._addArtworkOverride);
  }
  _renderActiveTab() {
  ...
  _renderEntitiesTab() {
    ...
    return x(_templateObject13$1 || (_templateObject13$1 = _taggedTemplateLiteral(["\n        <div class=\"entity-group\">\n          <div class=\"entity-group-header section-header\">\n            <div class=\"entity-group-title section-title\">Entities*</div>\n            <div class=\"section-description\">Add the media players you want to control. Drag entities to reorder the chip row.</div>\n          </div>\n          <div class=\"form-row\">\n            <yamp-sortable @item-moved=", ">\n              <div class=\"sortable-container\">\n                ", "\n              </div>\n            </yamp-sortable>\n          </div>\n        </div>\n      "])), e => this._onEntityMoved(e), entities.map((ent, idx) => {
      ...
      return x(_templateObject14$1 || (_templateObject14$1 = _taggedTemplateLiteral(["\n                  <div class=\"entity-row-inner ", "\" data-index=\"", "\">\n                    <div class=\"handle ", "\">\n                      <ha-icon icon=\"mdi:drag\"></ha-icon>\n                    </div>\n                    <div class=\"grow-children\">\n                      ", "\n                    </div>\n                    <div class=\"entity-row-actions\">\n                      <ha-icon\n                        class=\"icon-button ", "\"\n                        icon=\"mdi:pencil\"\n                        title=\"Edit Entity Settings\"\n                        @click=", "\n                      ></ha-icon>\n                    </div>\n                  </div>\n                "])), idx < entities.length - 1 ? 'sortable-item' : '', idx, idx === entities.length - 1 ? 'handle-disabled' : '', idx === entities.length - 1 && !ent.entity_id ? x(_templateObject15$1 || (_templateObject15$1 = _taggedTemplateLiteral(["\n                            <ha-generic-picker\n                              class=\"full-width\"\n                              style=\"display: block; width: 100%;\"\n                              .hass=", "\n                              .value=", "\n                              .label=", "\n                              .valueRenderer=", "\n                              .rowRenderer=", "\n                              .getItems=", "\n                              @value-changed=", "\n                              allow-custom-value\n                            ></ha-generic-picker>\n                          "])), this.hass, ent.entity_id || "", "Media Player", v => this._entityValueRenderer(v), item => this._entityRowRenderer(item), this._getEntityItems(["media_player"], (_this$_config$entitie4 = (_this$_config$entitie5 = this._config.entities) === null || _this$_config$entitie5 === void 0 ? void 0 : _this$_config$entitie5.map(e => e.entity_id)) !== null && _this$_config$entitie4 !== void 0 ? _this$_config$entitie4 : []), e => this._onEntityChanged(idx, e.detail.value)) : x(_templateObject16$1 || (_templateObject16$1 = _taggedTemplateLiteral(["\n                            <ha-generic-picker\n                              class=\"full-width\"\n                              style=\"display: block; width: 100%;\"\n                              .hass=", "\n                              .value=", "\n                              .label=", "\n                              .valueRenderer=", "\n                              .rowRenderer=", "\n                              .getItems=", "\n                              @value-changed=", "\n                              allow-custom-value\n                            ></ha-generic-picker>\n                          "])), this.hass, ent.entity_id || "", "Media Player", v => this._entityValueRenderer(v), item => this._entityRowRenderer(item), this._getEntityItems(["media_player"]), e => this._onEntityChanged(idx, e.detail.value)), !ent.entity_id ? "icon-button-disabled" : "", () => this._onEditEntity(idx));
    }));
  }
  _renderBehaviorTab() {
    ...
    }, (_this$_config$search_ = this._config.search_results_limit) !== null && _this$_config$search_ !== void 0 ? _this$_config$search_ : 20, e => this._updateConfig("search_results_limit", e.detail.value), searchLimitWarningActive ? x(_templateObject18$1 || (_templateObject18$1 = _taggedTemplateLiteral(["\n                  <div class=\"config-subtitle warning\">\n                    Warning: requesting higher results can cause performance issues.\n                  </div>\n                "]))) : E, () => this._updateConfig("search_results_limit", 20), this.hass, {
      select: {
        mode: "dropdown",
        options: [{
          value: "default",
  ...
  _renderVisualTab() {
    ...
    const renderVolumeStep = this._config.volume_mode === "stepper" ? x(_templateObject19$1 || (_templateObject19$1 = _taggedTemplateLiteral(["\n          <div class=\"form-row form-row-multi-column\">\n            <div class=\"grow-children\">\n              <ha-selector\n                .hass=", "\n                .selector=", "\n                .value=", "\n                label=\"Volume Step (0.05 = 5%)\"\n                @value-changed=", "\n              ></ha-selector>\n            </div>\n            <ha-icon\n              class=\"icon-button\"\n              icon=\"mdi:restore\"\n              title=\"Reset to default\"\n              @click=", "\n            ></ha-icon>\n          </div>\n        "])), this.hass, {
      number: {
        min: 0.01,
        max: 1,
        step: 0.01,
  ...
  _renderActionsTab() {
    ...
    return x(_templateObject21$1 || (_templateObject21$1 = _taggedTemplateLiteral(["\n        <div class=\"action-group config-section\">\n          <div class=\"action-group-header section-header\">\n            <div class=\"action-group-title section-title\">Actions</div>\n            <div class=\"section-description\">Build the action chips that appear in the card or its menu. Drag to reorder, click the pencil to configure each action.</div>\n          </div>\n          <div class=\"form-row\">\n            <yamp-sortable @item-moved=", ">\n              <div class=\"sortable-container\">\n                ", "\n              </div>\n            </yamp-sortable>\n          </div>\n          <div class=\"add-action-button-wrapper\">\n            <ha-icon\n              class=\"icon-button\"\n              icon=\"mdi:plus\"\n              title=\"Add Action\"\n              @click=", "\n            ></ha-icon>\n          </div>\n        </div>\n      "])), e => this._onActionMoved(e), actions.map((act, idx) => {
      var _act$name;
      return x(_templateObject22$1 || (_templateObject22$1 = _taggedTemplateLiteral(["\n                  <div class=\"action-row-inner sortable-item\">\n                    <div class=\"handle action-handle\">\n                      <ha-icon icon=\"mdi:drag\"></ha-icon>\n                    </div>\n                    ", "\n                    <div class=\"grow-children\">\n                      <ha-textfield\n                        placeholder=\"(Icon Only)\"\n                        .value=", "\n                        .helper=", "\n                        .helperPersistent=", "\n                        @input=", "\n                      ></ha-textfield>\n                    </div>\n                    <div class=\"action-row-actions\">\n                      <ha-icon\n                        class=\"icon-button icon-button-compact\"\n                        icon=\"mdi:pencil\"\n                        title=\"Edit Action Settings\"\n                        @click=", "\n                      ></ha-icon>\n                      <ha-icon\n                        class=\"icon-button icon-button-compact icon-button-toggle ", "\"\n                        icon=\"", "\"\n                        title=\"", "\"\n                        role=\"button\"\n                        aria-label=\"", "\"\n                        @click=", "\n                      ></ha-icon>\n                      <ha-icon\n                        class=\"icon-button icon-button-compact\"\n                        icon=\"mdi:trash-can\"\n                        title=\"Delete Action\"\n                        @click=", "\n                      ></ha-icon>\n                    </div>\n                  </div>\n                "])), act !== null && act !== void 0 && act.icon ? x(_templateObject23$1 || (_templateObject23$1 = _taggedTemplateLiteral(["\n                      <ha-icon class=\"action-icon\" icon=\"", "\"></ha-icon>\n                    "])), act === null || act === void 0 ? void 0 : act.icon) : x(_templateObject24$1 || (_templateObject24$1 = _taggedTemplateLiteral(["<span class=\"action-icon-placeholder\"></span>"]))), (_act$name = act === null || act === void 0 ? void 0 : act.name) !== null && _act$name !== void 0 ? _act$name : "", (() => {
  ...
  _renderEntityEditor(entity) {
    ...
    })) : E, entity !== null && entity !== void 0 && entity.volume_entity && entity.volume_entity !== entity.entity_id && !((_entity$follow_active4 = entity === null || entity === void 0 ? void 0 : entity.follow_active_volume) !== null && _entity$follow_active4 !== void 0 ? _entity$follow_active4 : false) ? x(_templateObject35$1 || (_templateObject35$1 = _taggedTemplateLiteral(["\n              <div class=\"form-row form-row-multi-column\">\n                <div>\n                  <ha-switch\n                    id=\"sync-power-toggle\"\n                    .checked=", "\n                    @change=", "\n                  ></ha-switch>\n                  <label for=\"sync-power-toggle\">Sync Power</label>\n                </div>\n              </div>\n            "])), (_entity$sync_power = entity === null || entity === void 0 ? void 0 : entity.sync_power) !== null && _entity$sync_power !== void 0 ? _entity$sync_power : false, e => this._updateEntityProperty("sync_power", e.target.checked)) : E, entity !== null && entity !== void 0 && entity.follow_active_volume ? x(_templateObject36$1 || (_templateObject36$1 = _taggedTemplateLiteral(["\n          <div class=\"form-row\">\n            <div class=\"help-text\">\n              <ha-icon icon=\"mdi:information-outline\"></ha-icon>\n              When enabled, the volume entity will automatically follow the active playback entity. Note: This overrides the selected volume entity.\n              <br><br>\n             \n            </div>\n          </div>\n        "]))) : E);
  }
  _renderActionEditor(action) {
    var _this$_actionMode, _action$name, _action$icon, _this$_actionMode2, _action$menu_item, _action$navigation_pa, _action$navigation_ne, _action$service, _action$script_variab;
    ...
    }, this._yamlError && this._yamlDraft.trim() !== "" ? x(_templateObject43$1 || (_templateObject43$1 = _taggedTemplateLiteral(["<div class=\"yaml-error-message\">", "</div>"])), this._yamlError) : E) : E) : E);
  }
