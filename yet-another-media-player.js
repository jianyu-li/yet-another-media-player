...
`,$o=[{mode:"replace",icon:"mdi:playlist-remove",label:h("search.replace")},{mode:"next",icon:"mdi:playlist-play",label:h("search.play_next")},{mode:"replace_next",icon:"mdi:playlist-music",label:h("search.replace_play")},{mode:"add",icon:"mdi:playlist-plus",label:h("search.add_queue")},{mode:"add_to_playlist",icon:"mdi:plus",label:h("search.add_to_playlist")}],Mt=["artist","album","track","playlist","radio","podcast","audiobook"];function bs(i){return i&&(i.media_class==="track"||i.media_content_type==="track")}const Ne=(i,{cap:e,floor:t}={})=>{const a=Number(i);if(!Number.isFinite(a)||a<=0)return;let s=a;return typeof t=="number"&&(s=Math.max(t,s)),typeof e=="number"&&(s=Math.min(e,s)),s},xs=3e4;let Ft=null,Ki=0;async function oi(i){const e=Date.now();if(Ft&&e-Ki<xs)return Ft;try{return Ft=(await i.callApi("GET","config/config_entries/entry")).find(t=>t.domain==="music_assistant"&&t.state==="loaded")?.entry_id||null,Ki=e,Ft}catch(t){return console.error("yamp: Failed to resolve Music Assistant config entry",t),Ft=null,Ki=e,null}}let Dt=null,Xi=0;async function Ji(i){const e=Date.now();if(Dt&&e-Xi<xs)return Dt;try{return Dt=(await i.callApi("GET","config/config_entries/entry")).find(t=>t.domain==="mass_queue"&&t.state==="loaded")?.entry_id||null,Xi=e,Dt}catch(t){return console.error("yamp: Failed to resolve mass_queue config entry",t),Dt=null,Xi=e,null}}function ct(i){return i?{title:i.name,media_content_id:i.uri,media_content_type:i.media_type,media_class:i.media_type,item_id:i.item_id,thumbnail:i.image,...i.artists&&{artist:i.artists.map(e=>e.name).join(", ")},...i.album&&{album:i.album.name},is_browsable:i.media_type==="artist"||i.media_type==="album"||i.media_type==="playlist",is_editable:i.is_editable===!0}:null}function li({item:i,onPlay:e,onOptionsToggle:t,upcomingFilterActive:a=!1,isMusicAssistant:s=!1,massQueueAvailable:r=!1,searchView:n="list",isInline:o=!1,onMoveUp:l,onMoveDown:c,onMoveNext:u,onRemove:d}){const p=!!(a&&i.queue_item_id&&s&&r),_=o?"entity-options-search-buttons":n==="card"?"card-overlay-buttons":"search-sheet-buttons",f=o?"entity-options-search-play":n==="card"?"search-sheet-play icon-only":"search-sheet-play",g=o?"entity-options-search-queue":n==="card"?"search-sheet-queue icon-only":"search-sheet-queue";return m`
  ...
  `}function ws({item:i,activeSearchRowMenuId:e,successSearchRowMenuId:t,successSearchRowType:a,onPlayOption:s,onOptionsToggle:r,searchView:n="list",isQueueItem:o=!1,massQueueAvailable:l=!1,onMoveUp:c,onMoveDown:u,onMoveNext:d,onRemove:p}){const _=e!=null&&i.media_content_id!=null&&e===i.media_content_id,f=t===i.media_content_id;return m`
  ...
  `}function Io({open:i,query:e,onQueryInput:t,onSearch:a,onClose:s,loading:r,results:n,onPlay:o,onQueue:l,error:c,showQueueSuccess:u,matchTheme:d=!1,upcomingFilterActive:p=!1,disableAutofocus:_=!1,activeSearchRowMenuId:f,successSearchRowMenuId:g,successSearchRowType:b,onOptionsToggle:k,onPlayOption:x,onResultClick:T,searchView:E="list",searchCardColumns:G=4,massQueueAvailable:F=!1,onMoveUp:D,onMoveDown:z,onMoveNext:R,onRemove:B}){return i?m`
      ...
      <div class="search-sheet-results ${E==="card"?"search-results-card-view":"list-view"}">
        ${(n||[]).length===0&&!r?m`<div class="search-sheet-empty">${h("common.no_results")}</div>`:(n||[]).map(A=>{const L=tt(A.media_content_id),q=A.is_browsable&&(A.media_class!=="playlist"||F);return m`
                <div class="search-sheet-result ${E==="card"?"search-result-card":""}">
                  ...
                  ${ws({item:A,activeSearchRowMenuId:f,successSearchRowMenuId:g,successSearchRowType:b,onPlayOption:x,onOptionsToggle:k,searchView:E,isQueueItem:L&&A.queue_item_id&&p&&F,massQueueAvailable:F,onMoveUp:D,onMoveDown:z,onMoveNext:R,onRemove:B})}
                </div>
              `})}
      </div>
    </div>
    ...
    <div class="entity-options-overlay entity-options-overlay-opening" @click=${e}>
      <div class="entity-options-container entity-options-sheet-opening" @click=${s=>s.stopPropagation()}>
        <div class="entity-options-sheet">
          ...
          ${$o.filter(s=>s.mode==="add_to_playlist"?bs(i)&&a:!0).map(s=>m`
...
`,r?1+l:l),r=!0,n=!0,l=0,t=i.position;!$e(d)&&d!==0;)d=i.input.charCodeAt(++i.position);Ue(i,t,i.position,!1)}return!0}function nr(i,e){var t,a=i.tag,s=i.anchor,r=[],n,o=!1,l;if(i.firstTabInLine!==-1)return!1;for(i.anchor!==null&&(i.anchorMap[i.anchor]=r),l=i.input.charCodeAt(i.position);l!==0&&(i.firstTabInLine!==-1&&(i.position=i.firstTabInLine,S(i,"tab characters must not be used in indentation")),!(l!==45||(n=i.input.charCodeAt(i.position+1),!me(n))));){if(o=!0,i.position++,X(i,!0,-1)&&i.lineIndent<=e){r.push(null),l=i.input.charCodeAt(i.position);continue}if(t=i.line,pt(i,e,Ws,!1,!0),r.push(i.result),X(i,!0,-1),l=i.input.charCodeAt(i.position),(i.line===t||i.lineIndent>e)&&l!==0)S(i,"bad indentation of a sequence entry");else if(i.lineIndent<e)break}return o?(i.tag=a,i.anchor=s,i.kind="sequence",i.result=r,!0):!1}function Wl(i,e,t){var a,s,r,n,o,l,c=i.tag,u=i.anchor,d={},p=Object.create(null),_=null,f=null,g=null,b=!1,k=!1,x;if(i.firstTabInLine!==-1)return!1;for(i.anchor!==null&&(i.anchorMap[i.anchor]=d),x=i.input.charCodeAt(i.position);x!==0;){if(!b&&i.firstTabInLine!==-1&&(i.position=i.firstTabInLine,S(i,"tab characters must not be used in indentation")),a=i.input.charCodeAt(i.position+1),r=i.line,(x===63||x===58)&&me(a))x===63?(b&&(ht(i,d,p,_,f,null,n,o,l),_=f=g=null),k=!0,b=!0,s=!0):b?(b=!1,s=!0):S(i,"incomplete explicit mapping pair; a key node is missed; or followed by a non-tabulated empty line"),i.position+=1,x=a;else{if(n=i.line,o=i.lineStart,l=i.position,!pt(i,t,Qs,!1,!0))break;if(i.line===r){for(x=i.input.charCodeAt(i.position);it(x);)x=i.input.charCodeAt(++i.position);if(x===58)x=i.input.charCodeAt(++i.position),me(x)||S(i,"a whitespace character is expected after the key-value separator within a block mapping"),b&&(ht(i,d,p,_,f,null,n,o,l),_=f=g=null),k=!0,b=!1,s=!1,_=i.tag,f=i.result;else if(k)S(i,"can not read an implicit mapping pair; a colon is missed");else return i.tag=c,i.anchor=u,!0}else if(k)S(i,"can not read a block mapping entry; a multiline key may not be an implicit key");else return i.tag=c,i.anchor=u,!0}if((i.line===r||i.lineIndent>e)&&(b&&(n=i.line,o=i.lineStart,l=i.position),pt(i,e,di,!0,s)&&(b?f=i.result:g=i.result),b||(ht(i,d,p,_,f,g,n,o,l),_=f=g=null),X(i,!0,-1),x=i.input.charCodeAt(i.position)),(i.line===r||i.lineIndent>e)&&x!==0)S(i,"bad indentation of a mapping entry");else if(i.lineIndent<e)break}return b&&ht(i,d,p,_,f,null,n,o,l),k&&(i.tag=c,i.anchor=u,i.kind="mapping",i.result=d),k}function Yl(i){var e,t=!1,a=!1,s,r,n;if(n=i.input.charCodeAt(i.position),n!==33)return!1;if(i.tag!==null&&S(i,"duplication of a tag property"),n=i.input.charCodeAt(++i.position),n===60?(t=!0,n=i.input.charCodeAt(++i.position)):n===33?(a=!0,s="!!",n=i.input.charCodeAt(++i.position)):s="!",e=i.position,t){do n=i.input.charCodeAt(++i.position);while(n!==0&&n!==62);i.position<i.length?(r=i.input.slice(e,i.position),n=i.input.charCodeAt(++i.position)):S(i,"unexpected end of the stream within a verbatim tag")}else{for(;n!==0&&!me(n);)n===33&&(a?S(i,"tag suffix cannot contain exclamation marks"):(s=i.input.slice(e-1,i.position+1),Zs.test(s)||S(i,"named tag handle cannot contain such characters"),a=!0,e=i.position+1)),n=i.input.charCodeAt(++i.position);r=i.input.slice(e,i.position),Rl.test(r)&&S(i,"tag suffix cannot contain flow indicator characters")}r&&!Ks.test(r)&&S(i,"tag name cannot contain such characters: "+r);try{r=decodeURIComponent(r)}catch{S(i,"tag name is malformed: "+r)}return t?i.tag=r:qe.call(i.tagMap,s)?i.tag=i.tagMap[s]+r:s==="!"?i.tag="!"+r:s==="!!"?i.tag="tag:yaml.org,2002:"+r:S(i,'undeclared tag handle "'+s+'"'),!0}function Zl(i){var e,t;if(t=i.input.charCodeAt(i.position),t!==38)return!1;for(i.anchor!==null&&S(i,"duplication of an anchor property"),t=i.input.charCodeAt(++i.position),e=i.position;t!==0&&!me(t)&&!dt(t);)t=i.input.charCodeAt(++i.position);return i.position===e&&S(i,"name of an anchor node must contain at least one character"),i.anchor=i.input.slice(e,i.position),!0}function Kl(i){var e,t,a;if(a=i.input.charCodeAt(i.position),a!==42)return!1;for(a=i.input.charCodeAt(++i.position),e=i.position;a!==0&&!me(a)&&!dt(a);)a=i.input.charCodeAt(++i.position);return i.position===e&&S(i,"name of an alias node must contain at least one character"),t=i.input.slice(e,i.position),qe.call(i.anchorMap,t)||S(i,'unidentified alias "'+t+'"'),i.result=i.anchorMap[t],X(i,!0,-1),!0}function pt(i,e,t,a,s){var r,n,o,l=1,c=!1,u=!1,d,p,_,f,g,b;if(i.listener!==null&&i.listener("open",i),i.tag=null,i.anchor=null,i.kind=null,i.result=null,r=n=o=di===t||Ws===t,a&&X(i,!0,-1)&&(c=!0,i.lineIndent>e?l=1:i.lineIndent===e?l=0:i.lineIndent<e&&(l=-1)),l===1)for(;Yl(i)||Zl(i);)X(i,!0,-1)?(c=!0,o=r,i.lineIndent>e?l=1:i.lineIndent===e?l=0:i.lineIndent<e&&(l=-1)):o=!1;if(o&&(o=c||s),(l===1||di===t)&&(ci===t||Qs===t?g=e:g=e+1,b=i.position-i.lineStart,l===1?o&&(nr(i,b)||Wl(i,b,g))||Vl(i,g)?u=!0:(n&&Ql(i,g)||Hl(i,g)||Gl(i,g)?u=!0:Kl(i)?(u=!0,(i.tag!==null||i.anchor!==null)&&S(i,"alias node should not have any properties")):Bl(i,g,ci===t)&&(u=!0,i.tag===null&&(i.tag="?")),i.anchor!==null&&(i.anchorMap[i.anchor]=i.result)):l===0&&(u=o&&nr(i,b))),i.tag===null)i.anchor!==null&&(i.anchorMap[i.anchor]=i.result);else if(i.tag==="?"){for(i.result!==null&&i.kind!=="scalar"&&S(i,'unacceptable node kind for !<?> tag; it should be "scalar", not "'+i.kind+'"'),d=0,p=i.implicitTypes.length;d<p;d+=1)if(f=i.implicitTypes[d],f.resolve(i.result)){i.result=f.construct(i.result),i.tag=f.tag,i.anchor!==null&&(i.anchorMap[i.anchor]=i.result);break}}else if(i.tag!=="!"){if(qe.call(i.typeMap[i.kind||"fallback"],i.tag))f=i.typeMap[i.kind||"fallback"][i.tag];else for(f=null,_=i.typeMap.multi[i.kind||"fallback"],d=0,p=_.length;d<p;d+=1)if(i.tag.slice(0,_[d].tag.length)===_[d].tag){f=_[d];break}f||S(i,"unknown tag !<"+i.tag+">"),i.result!==null&&f.kind!==i.kind&&S(i,"unacceptable node kind for !<"+i.tag+'> tag; it should be "'+f.kind+'", not "'+i.kind+'"'),f.resolve(i.result,i.tag)?(i.result=f.construct(i.result,i.tag),i.anchor!==null&&(i.anchorMap[i.anchor]=i.result)):S(i,"cannot resolve a node with !<"+i.tag+"> explicit tag")}return i.listener!==null&&i.listener("close",i),i.tag!==null||i.anchor!==null||u}function Xl(i){var e=i.position,t,a,s,r=!1,n;for(i.version=null,i.checkLineBreaks=i.legacy,i.tagMap=Object.create(null),i.anchorMap=Object.create(null);(n=i.input.charCodeAt(i.position))!==0&&(X(i,!0,-1),n=i.input.charCodeAt(i.position),!(i.lineIndent>0||n!==37));){for(r=!0,n=i.input.charCodeAt(++i.position),t=i.position;n!==0&&!me(n);)n=i.input.charCodeAt(++i.position);for(a=i.input.slice(t,i.position),s=[],a.length<1&&S(i,"directive name must not be less than one character in length");n!==0;){for(;it(n);)n=i.input.charCodeAt(++i.position);if(n===35){do n=i.input.charCodeAt(++i.position);while(n!==0&&!$e(n));break}if($e(n))break;for(t=i.position;n!==0&&!me(n);)n=i.input.charCodeAt(++i.position);s.push(i.input.slice(t,i.position))}n!==0&&na(i),qe.call(sr,a)?sr[a](i,a,s):ui(i,'unknown document directive "'+a+'"')}if(X(i,!0,-1),i.lineIndent===0&&i.input.charCodeAt(i.position)===45&&i.input.charCodeAt(i.position+1)===45&&i.input.charCodeAt(i.position+2)===45?(i.position+=3,X(i,!0,-1)):r&&S(i,"directives end mark is expected"),pt(i,i.lineIndent-1,di,!1,!0),X(i,!0,-1),i.checkLineBreaks&&Ol.test(i.input.slice(e,i.position))&&ui(i,"non-ASCII line breaks are interpreted as content"),i.documents.push(i.result),i.position===i.lineStart&&hi(i)){i.input.charCodeAt(i.position)===46&&(i.position+=3,X(i,!0,-1));return}if(i.position<i.length-1)S(i,"end of the stream or a document separator is expected");else return}function or(i,e){i=String(i),e=e||{},i.length!==0&&(i.charCodeAt(i.length-1)!==10&&i.charCodeAt(i.length-1)!==13&&(i+=`
`),i.charCodeAt(0)===65279&&(i=i.slice(1)));var t=new Ul(i,e),a=i.indexOf("\0");for(a!==-1&&(t.position=a,S(t,"null byte is not allowed in input")),t.input+="\0";t.input.charCodeAt(t.position)===32;)t.lineIndent+=1,t.position+=1;for(;t.position<t.length-1;)Xl(t);return t.documents}function Jl(i,e,t){e!==null&&typeof e=="object"&&typeof t>"u"&&(t=e,e=null);var a=or(i,t);if(typeof e!="function")return a;for(var s=0,r=a.length;s<r;s+=1)e(a[s])}function ec(i,e){var t=or(i,e);if(t.length!==0){if(t.length===1)return t[0];throw new ue("expected a single document in the stream, but found more")}}var tc=Jl,ic=ec,lr={loadAll:tc,load:ic},cr=Object.prototype.toString,dr=Object.prototype.hasOwnProperty,la=65279,ac=9,Pt=10,sc=13,rc=32,nc=33,oc=34,ca=35,lc=37,cc=38,dc=39,uc=42,ur=44,hc=45,pi=58,pc=61,_c=62,mc=63,fc=64,hr=91,pr=93,gc=96,_r=123,vc=124,mr=125,ce={};ce[0]="\\0",ce[7]="\\a",ce[8]="\\b",ce[9]="\\t",ce[10]="\\n",ce[11]="\\v",ce[12]="\\f",ce[13]="\\r",ce[27]="\\e",ce[34]='\\"',ce[92]="\\\\",ce[133]="\\N",ce[160]="\\_",ce[8232]="\\L",ce[8233]="\\P";var yc=["y","Y","yes","Yes","YES","on","On","ON","n","N","no","No","NO","off","Off","OFF"],bc=/^[-+]?[0-9_]+(?::[0-9_]+)+(?:\.[0-9_]*)?$/;function xc(i,e){var t,a,s,r,n,o,l;if(e===null)return{};for(t={},a=Object.keys(e),s=0,r=a.length;s<r;s+=1)n=a[s],o=String(e[n]),n.slice(0,2)==="!!"&&(n="tag:yaml.org,2002:"+n.slice(2)),l=i.compiledTypeMap.fallback[n],l&&dr.call(l.styleAliases,o)&&(o=l.styleAliases[o]),t[n]=o;return t}function wc(i){var e,t,a;if(e=i.toString(16).toUpperCase(),i<=255)t="x",a=2;else if(i<=65535)t="u",a=4;else if(i<=4294967295)t="U",a=8;else throw new ue("code point within a string may not be greater than 0xFFFFFFFF");return"\\"+t+te.repeat("0",a-e.length)+e}var kc=1,Ot=2;function Ec(i){this.schema=i.schema||sa,this.indent=Math.max(1,i.indent||2),this.noArrayIndent=i.noArrayIndent||!1,this.skipInvalid=i.skipInvalid||!1,this.flowLevel=te.isNothing(i.flowLevel)?-1:i.flowLevel,this.styleMap=xc(this.schema,i.styles||null),this.sortKeys=i.sortKeys||!1,this.lineWidth=i.lineWidth||80,this.noRefs=i.noRefs||!1,this.noCompatMode=i.noCompatMode||!1,this.condenseFlow=i.condenseFlow||!1,this.quotingType=i.quotingType==='"'?Ot:kc,this.forceQuotes=i.forceQuotes||!1,this.replacer=typeof i.replacer=="function"?i.replacer:null,this.implicitTypes=this.schema.compiledImplicit,this.explicitTypes=this.schema.compiledExplicit,this.tag=null,this.result="",this.duplicates=[],this.usedDuplicates=null}function fr(i,e){for(var t=te.repeat(" ",e),a=0,s=-1,r="",n,o=i.length;a<o;)s=i.indexOf(`
`,a),s===-1?(n=i.slice(a),a=o):(n=i.slice(a,s+1),a=s+1),n.length&&n!==`
`&&(r+=t),r+=n;return r}function da(i,e){return`
`+te.repeat(" ",i.indent*e)}function Ac(i,e){var t,a,s;for(t=0,a=i.implicitTypes.length;t<a;t+=1)if(s=i.implicitTypes[t],s.resolve(e))return!0;return!1}function _i(i){return i===rc||i===ac}function Rt(i){return 32<=i&&i<=126||161<=i&&i<=55295&&i!==8232&&i!==8233||57344<=i&&i<=65533&&i!==la||65536<=i&&i<=1114111}function gr(i){return Rt(i)&&i!==la&&i!==sc&&i!==Pt}function vr(i,e,t){var a=gr(i),s=a&&!_i(i);return(t?a:a&&i!==ur&&i!==hr&&i!==pr&&i!==_r&&i!==mr)&&i!==ca&&!(e===pi&&!s)||gr(e)&&!_i(e)&&i===ca||e===pi&&s}function Sc(i){return Rt(i)&&i!==la&&!_i(i)&&i!==hc&&i!==mc&&i!==pi&&i!==ur&&i!==hr&&i!==pr&&i!==_r&&i!==mr&&i!==ca&&i!==cc&&i!==uc&&i!==nc&&i!==vc&&i!==pc&&i!==_c&&i!==dc&&i!==oc&&i!==lc&&i!==fc&&i!==gc}function $c(i){return!_i(i)&&i!==pi}function zt(i,e){var t=i.charCodeAt(e),a;return t>=55296&&t<=56319&&e+1<i.length&&(a=i.charCodeAt(e+1),a>=56320&&a<=57343)?(t-55296)*1024+a-56320+65536:t}function yr(i){var e=/^\n* /;return e.test(i)}var br=1,ua=2,xr=3,wr=4,_t=5;function Ic(i,e,t,a,s,r,n,o){var l,c=0,u=null,d=!1,p=!1,_=a!==-1,f=-1,g=Sc(zt(i,0))&&$c(zt(i,i.length-1));if(e||n)for(l=0;l<i.length;c>=65536?l+=2:l++){if(c=zt(i,l),!Rt(c))return _t;g=g&&vr(c,u,o),u=c}else{for(l=0;l<i.length;c>=65536?l+=2:l++){if(c=zt(i,l),c===Pt)d=!0,_&&(p=p||l-f-1>a&&i[f+1]!==" ",f=l);else if(!Rt(c))return _t;g=g&&vr(c,u,o),u=c}p=p||_&&l-f-1>a&&i[f+1]!==" "}return!d&&!p?g&&!n&&!s(i)?br:r===Ot?_t:ua:t>9&&yr(i)?_t:n?r===Ot?_t:ua:p?wr:xr}function Cc(i,e,t,a,s){i.dump=(function(){if(e.length===0)return i.quotingType===Ot?'""':"''";if(!i.noCompatMode&&(yc.indexOf(e)!==-1||bc.test(e)))return i.quotingType===Ot?'"'+e+'"':"'"+e+"'";var r=i.indent*Math.max(1,t),n=i.lineWidth===-1?-1:Math.max(Math.min(i.lineWidth,40),i.lineWidth-r),o=a||i.flowLevel>-1&&t>=i.flowLevel;function l(c){return Ac(i,c)}switch(Ic(e,o,i.indent,n,l,i.quotingType,i.forceQuotes&&!a,s)){case br:return e;case ua:return"'"+e.replace(/'/g,"''")+"'";case xr:return"|"+kr(e,i.indent)+Er(fr(e,r));case wr:return">"+kr(e,i.indent)+Er(fr(Tc(e,n),r));case _t:return'"'+Mc(e)+'"';default:throw new ue("impossible error: invalid scalar style")}})()}function kr(i,e){var t=yr(i)?String(e):"",a=i[i.length-1]===`
`,s=a&&(i[i.length-2]===`
`||i===`
`),r=s?"+":a?"":"-";return t+r+`
        ...
        <div class="entity-options-container entity-options-container-opening">
          <div class="entity-options-sheet${d||f?" chips-mode":""} entity-options-sheet-opening" 
                      ...
                      <div class="chip-row search-filter-chips" id="search-filter-chip-row" style="margin-bottom:12px; justify-content: center; align-items: center;">
                        ...
                        ${v.map(H=>m`
                          <button
                            ...
                            style="
                              width: 72px;
                              background: ${P===H?this._customAccent:"#282828"};
                              opacity: ${P===H?"1":"0.8"};
                              font-weight: ${P===H?"bold":"normal"};
                            "
                            ?selected=${P===H}
            ...
            <div class="entity-options-search-results ${this.config.search_view==="card"?"search-results-card-view":"list-view"}" 
              ...
              ${(()=>{this._searchMediaClassFilter;const v=this._getDisplaySearchResults(),P=Math.max(15,this._searchTotalRows||v.length),H=[...v,...Array.from({length:Math.max(0,P-v.length)},()=>null)];return this._searchAttempted&&v.length===0&&!this._searchLoading?m`<div class="entity-options-search-empty">${h("common.no_results")}</div>`:H.map(N=>N?m`
              ...
              `:this._showGrouping?this._renderGroupingSheet():m`
                ...
                <div class="floating-source-index">
                  ${pe.map((v,P)=>{const H=Ae.has(v),N=this._hoveredSourceLetterIndex;let M="";if(H&&N!==null&&N!==void 0){const Se=Math.abs(N-P);Se===0?M="max":Se===1?M="large":Se===2&&(M="med")}return m`
                      <button
                        class="source-index-letter"
                        ?disabled=${!H}
                        data-scale=${M}
                        @mouseenter=${H?()=>{this._hoveredSourceLetterIndex=P,this.requestUpdate()}:y}
                        @mouseleave=${()=>{this._hoveredSourceLetterIndex=null,this.requestUpdate()}}
                        @click=${H?()=>this._scrollToSourceLetter(v):y}
                      >
                        ${v}
                      </button>
                    `})}
            ...
            ${Ga?m`
              <div class="persistent-media-controls" @click=${v=>v.stopPropagation()}>
                <div class="persistent-controls-artwork">
                  ${(()=>{const v=this.currentPlaybackStateObj,P=this.currentStateObj,H=this._getArtworkUrl(v)||this._getArtworkUrl(P);return H?.url&&this._isValidArtworkUrl(H.url)?m`
                ...
                ${(()=>{const v=this._selectedIndex,P=this._getVolumeEntity(v);if(!P)return y;const H=P.startsWith&&P.startsWith("remote."),N=this.currentVolumeStateObj,M=Number(N?.attributes?.volume_level??0),Se=H?null:`${Math.round((M||0)*100)}%`;return this.config.volume_mode==="hidden"?y:m`
