 ...
 */const ro=ao(class extends so{constructor(i){if(super(i),i.type!==io.ATTRIBUTE||i.name!=="class"||i.strings?.length>2)throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(i){return" "+Object.keys(i).filter((e=>i[e])).join(" ")+" "}update(i,[e]){if(this.st===void 0){this.st=new Set,i.strings!==void 0&&(this.nt=new Set(i.strings.join(" ").split(/\s/).filter((a=>a!==""))));for(const a in e)e[a]&&!this.nt?.has(a)&&this.st.add(a);return this.render(e)}const t=i.element.classList;for(const a of this.st)a in e||(t.remove(a),this.st.delete(a));for(const a in e){const s=!!e[a];s===this.st.has(a)||this.nt?.has(a)||(s?(t.add(a),this.st.add(a)):(t.remove(a),this.st.delete(a)))}return Je}});function xe(i,e){const t=i?.[e];return typeof t=="string"&&t.trim()!==""?t:null}async function no(i,e,t){if(!e||typeof e!="string")return t;if(!e.includes("{{")&&!e.includes("{%"))return e;try{const a=(await i.callApi("POST","template",{template:e})||"").toString().trim();return a&&/^([a-z_]+)\.[A-Za-z0-9_]+$/.test(a)?a:t}catch{return t}}async function oo(i,e,t={}){if(!e||typeof e!="string")return e;if(!e.includes("{{")&&!e.includes("{%")){if(/%7B%7B|%7B%25/i.test(e))try{e=decodeURIComponent(e)}catch{}if(!e.includes("{{")&&!e.includes("{%"))return e}let a=e;t&&Object.keys(t).length>0&&(a=`${Object.entries(t).map(([s,r])=>`{% set ${s} = ${JSON.stringify(r)} %}`).join(" ")} ${e}`);try{return(await i.callApi("POST","template",{template:a})||"").toString().trim()}catch(s){return console.warn("yamp: Error resolving template:",e,s),e}}function lo(i,e,t={}){if(!e||typeof e!="string")return e;let a=e;if(/%7B%7B|%7B%25/i.test(a))try{a=decodeURIComponent(a)}catch{}if(!a.includes("{{")&&!a.includes("{%"))return a;let s=a,r=!0;return s=s.replace(/\{\{\s*(.*?)\s*\}\}/g,(n,o)=>{let l=o.trim(),c=!1;l.endsWith("| urlencode")?(c=!0,l=l.replace(/\|\s*urlencode$/,"").trim()):l.endsWith("|urlencode")&&(c=!0,l=l.replace(/\|urlencode$/,"").trim());let u=l.match(/^state_attr\(\s*(['"]?)([\w.]+)\1\s*,\s*(['"]?)([\w_]+)\3\s*\)$/);if(u){let p=u[2],m=t[p]!==void 0&&!u[1]?t[p]:p,f=u[4];const g=i?.states?.[m];if(g&&g.attributes&&g.attributes[f]!==void 0){let y=String(g.attributes[f]);return c?encodeURIComponent(y):y}return""}let d=l.match(/^states\(\s*(['"]?)([\w.]+)\1\s*\)$/);if(d){let p=d[2],m=t[p]!==void 0&&!d[1]?t[p]:p;const f=i?.states?.[m];if(f&&f.state!==void 0){let g=String(f.state);return c?encodeURIComponent(g):g}return""}if(/^[\w_]+$/.test(l)&&t[l]!==void 0){let p=String(t[l]);return c?encodeURIComponent(p):p}return r=!1,n}),!r||s.includes("{%")?null:s}function co(i,e){if(!i?.states||!e)return[];const t=[],a=i.states[e];if(!a)return[];const s=a.attributes?.device_id,r=a.attributes?.friendly_name||e;for(const[n,o]of Object.entries(i.states))if(n.startsWith("button.")&&o.attributes){const l=o.attributes.device_id,c=o.attributes.friendly_name||n;s&&l===s?t.push({entity_id:n,friendly_name:c,device_class:o.attributes.device_class,reason:"same_device"}):(c.toLowerCase().includes(r.toLowerCase())||r.toLowerCase().includes(c.toLowerCase()))&&t.push({entity_id:n,friendly_name:c,device_class:o.attributes.device_class,reason:"name_similarity"})}return t}function uo(i,e){if(!i?.states||!e)return null;const t=i.states[e];return t&&t.attributes&&(t.attributes.media_content_id||t.attributes.media_content_type||t.attributes.media_album_name||t.attributes.media_artist||t.attributes.media_title)?t:null}function ct(i){return!i||!i.attributes?!1:i.attributes.app_id==="music_assistant"||i.attributes.mass_player_type!==void 0}function ho(i){if(!i)return"";const e=i.media_type||i.media_class||i.media_content_type,t=i.name||i.title||i.media_title||"Unknown Title",a=i.artists?.[0],s=i.artist||a?.name||(typeof a=="string"?a:void 0)||i.media_artist||"Unknown Artist";return e==="track"?`${t} - ${s}`:e==="album"?`${t} - ${s}`:t}function ms(i,e="",t=[],a=null){if(!i||!i.attributes)return null;const s=i.attributes,r=i.entity_id;s.app_id;let n=null,o=null;if(t&&Array.isArray(t)&&t.length){const l=(d,p)=>{if(d)return d[p]},c=[["media_title","media_title"],["media_artist","media_artist"],["media_album_name","media_album_name"],["media_content_id","media_content_id"],["media_channel","media_channel"],["app_name","app_name"],["media_content_type","media_content_type"],["entity_id","entity_id"],["entity_state","entity_state"]];let u=t.find(d=>c.some(([p,m])=>{const f=l(d,m);return f===void 0?!1:(p==="entity_id"?r:p==="entity_state"?i?.state:s[p])===f}));u||xe(s,"entity_picture_local")||xe(s,"entity_picture")||xe(s,"album_art")||(u=t.find(d=>d?.missing_art_url),u?.missing_art_url&&(u={...u,image_url:u.missing_art_url})),u?.image_url&&(n=u.image_url,o=u?.size_percentage)}return n||(n=xe(s,"entity_picture_local")||xe(s,"entity_picture")||xe(s,"album_art")||null),!n&&a&&(a==="smart"?s.media_title==="TV"||s.media_channel||s.app_id==="tv"||s.app_id==="androidtv"?n="data:image/svg+xml;base64,":n="data:image/svg+xml;base64,":typeof a=="string"&&(n=a)),n&&e&&!n.startsWith("http")&&(n=e+n),{url:n,sizePercentage:o}}function po({idx:i,selected:e,playing:t,name:a,art:s,icon:r,pinned:n,holdToPin:o,maActive:l,onChipClick:c,onIconClick:u,onPinClick:d,onPointerDown:p,onPointerMove:m,onPointerUp:f,objectFit:g,quickGroupingState:y,onQuickGroupClick:w,onDoubleClick:k}){const I=g?`object-fit: ${g};`:"";return _`
  ...
  `}function _o({idx:i,selected:e,playing:t,groupName:a,art:s,icon:r,pinned:n,holdToPin:o,maActive:l,onChipClick:c,onIconClick:u,onPinClick:d,onPointerDown:p,onPointerMove:m,onPointerUp:f,objectFit:g,quickGroupingState:y,onQuickGroupClick:w,onDoubleClick:k}){const I=g?`object-fit: ${g};`:"";return _`
  ...
  `}function mo({onPin:i,onHoldEnd:e,holdTime:t=600,moveThreshold:a=8}){let s=null,r=null,n=null,o=!1;return{pointerDown:(l,c)=>{r=l.clientX,n=l.clientY,o=!1,s=setTimeout(()=>{o||(i(c,l),e&&e(c))},t)},pointerMove:(l,c)=>{if(s&&r!==null&&n!==null){const u=Math.abs(l.clientX-r),d=Math.abs(l.clientY-n);(u>a||d>a)&&(o=!0,clearTimeout(s),s=null)}},pointerUp:(l,c)=>{s&&(clearTimeout(s),s=null),r=null,n=null,o=!1}}}function gs({groupedSortedEntityIds:i,entityIds:e,selectedEntityId:t,pinnedIndex:a,holdToPin:s,getChipName:r,getActualGroupMaster:n,getIsChipPlaying:o,getChipArt:l,getIsMaActive:c,isIdle:u,hass:d,artworkHostname:p="",mediaArtworkOverrides:m=[],fallbackArtwork:f=null,onChipClick:g,onIconClick:y,onPointerClick:w,onPinClick:k,onPointerDown:I,onPointerMove:E,onPointerUp:U,quickGroupingMode:B,getQuickGroupingState:F,onQuickGroupClick:D,onDoubleClick:L}){return!i||!i.length?v:_`
    ${i.map(z=>{if(z.length>1){const T=n(z),N=e.indexOf(T),G=d?.states?.[T],te=typeof o=="function"?o(T,t===T):G?.state==="playing",ie=typeof l=="function"?l(T):ms(G,p,m,f),Z=ie?.url,ne=ie?.objectFit,oe=G?.attributes?.icon||"mdi:cast",Se=typeof c=="function"?c(T):!1;return _o({idx:N,selected:t===T,playing:te,groupName:r(T)+(z.length>1?` [${z.length}]`:""),art:Z,icon:oe,pinned:a===N,holdToPin:s,maActive:Se,onChipClick:g,onIconClick:y,onPinClick:k,onPointerDown:pe=>I(pe,N),onPointerMove:pe=>E(pe,N),onPointerUp:pe=>U(pe,N),objectFit:ne,quickGroupingState:B&&typeof F=="function"?F(T):null,onQuickGroupClick:D,onDoubleClick:L})}else{const T=z[0],N=e.indexOf(T),G=d?.states?.[T],te=typeof o=="function"?o(T,t===T):G?.state==="playing",ie=typeof l=="function"?l(T):ms(G,p,m,f),Z=ie?.url,ne=ie?.objectFit,oe=t===T?!u&&Z:te&&Z,Se=G?.attributes?.icon||"mdi:cast",pe=typeof c=="function"?c(T):!1;return po({idx:N,selected:t===T,playing:te,name:r(T),art:oe,icon:Se,pinned:a===N,holdToPin:s,maActive:pe,onChipClick:g,onPinClick:k,onPointerDown:ae=>I(ae,N),onPointerMove:ae=>E(ae,N),onPointerUp:ae=>U(ae,N),objectFit:ne,quickGroupingState:B&&typeof F=="function"?F(T):null,onQuickGroupClick:D,onDoubleClick:L})}})}
  `}function fo({actions:i,onActionChipClick:e}){return i?.length?_`
...
`,Co=[{mode:"replace",icon:"mdi:playlist-remove",label:h("search.replace")},{mode:"next",icon:"mdi:playlist-play",label:h("search.play_next")},{mode:"replace_next",icon:"mdi:playlist-music",label:h("search.replace_play")},{mode:"add",icon:"mdi:playlist-plus",label:h("search.add_queue")},{mode:"add_to_playlist",icon:"mdi:plus",label:h("search.add_to_playlist")}],jt=["artist","album","track","playlist","radio","podcast","audiobook"];function xs(i){return i&&(i.media_class==="track"||i.media_content_type==="track")}const Ne=(i,{cap:e,floor:t}={})=>{const a=Number(i);if(!Number.isFinite(a)||a<=0)return;let s=a;return typeof t=="number"&&(s=Math.max(t,s)),typeof e=="number"&&(s=Math.min(e,s)),s},ws=3e4;let Pt=null,Zi=0;async function li(i){const e=Date.now();if(Pt&&e-Zi<ws)return Pt;try{return Pt=(await i.callApi("GET","config/config_entries/entry")).find(t=>t.domain==="music_assistant"&&t.state==="loaded")?.entry_id||null,Zi=e,Pt}catch(t){return console.error("yamp: Failed to resolve Music Assistant config entry",t),Pt=null,Zi=e,null}}let Dt=null,Ki=0;async function Xi(i){const e=Date.now();if(Dt&&e-Ki<ws)return Dt;try{return Dt=(await i.callApi("GET","config/config_entries/entry")).find(t=>t.domain==="mass_queue"&&t.state==="loaded")?.entry_id||null,Ki=e,Dt}catch(t){return console.error("yamp: Failed to resolve mass_queue config entry",t),Dt=null,Ki=e,null}}function dt(i){return i?{title:i.name,media_content_id:i.uri,media_content_type:i.media_type,media_class:i.media_type,item_id:i.item_id,thumbnail:i.image,...i.artists&&{artist:i.artists.map(e=>e.name).join(", ")},...i.album&&{album:i.album.name},is_browsable:i.media_type==="artist"||i.media_type==="album"||i.media_type==="playlist",is_editable:i.is_editable===!0}:null}function ks({item:i,onPlay:e,onOptionsToggle:t,upcomingFilterActive:a=!1,isMusicAssistant:s=!1,massQueueAvailable:r=!1,searchView:n="list",isInline:o=!1,onMoveUp:l,onMoveDown:c,onMoveNext:u,onRemove:d}){const p=!!(a&&i.queue_item_id&&s&&r),m=o?"entity-options-search-buttons":n==="card"?"card-overlay-buttons":"search-sheet-buttons",f=o?"entity-options-search-play":n==="card"?"search-sheet-play icon-only":"search-sheet-play",g=o?"entity-options-search-queue":n==="card"?"search-sheet-queue icon-only":"search-sheet-queue";return _`
  ...
  `}function To({item:i,activeSearchRowMenuId:e,onPlayOption:t,onOptionsToggle:a,searchView:s="list",isQueueItem:r=!1,massQueueAvailable:n=!1,onMoveUp:o,onMoveDown:l,onMoveNext:c,onRemove:u}){const d=e!=null&&i.media_content_id!=null&&e===i.media_content_id;return _`
  ...
  `}function Mo({item:i,onClose:e,onPlayOption:t,massQueueAvailable:a=!1}){return i?_`
    <div class="entity-options-overlay entity-options-overlay-opening" @click=${e}>
      <div class="entity-options-container entity-options-sheet-opening" @click=${s=>s.stopPropagation()}>
        <div class="entity-options-sheet">
          ...
          ${Co.filter(s=>s.mode==="add_to_playlist"?xs(i)&&a:!0).map(s=>_`
...
`,e-1))}function Hl(i,e,t){var a,s,r,n,o,l,c,u,d=i.kind,p=i.result,m;if(m=i.input.charCodeAt(i.position),me(m)||ut(m)||m===35||m===38||m===42||m===33||m===124||m===62||m===39||m===34||m===37||m===64||m===96||(m===63||m===45)&&(s=i.input.charCodeAt(i.position+1),me(s)||t&&ut(s)))return!1;for(i.kind="scalar",i.result="",r=n=i.position,o=!1;m!==0;){if(m===58){if(s=i.input.charCodeAt(i.position+1),me(s)||t&&ut(s))break}else if(m===35){if(a=i.input.charCodeAt(i.position-1),me(a))break}else{if(i.position===i.lineStart&&hi(i)||t&&ut(m))break;if(Ie(m))if(l=i.line,c=i.lineStart,u=i.lineIndent,K(i,!1,-1),i.lineIndent>=e){o=!0,m=i.input.charCodeAt(i.position);continue}else{i.position=n,i.line=l,i.lineStart=c,i.lineIndent=u;break}}o&&(Ue(i,r,n,!1),na(i,i.line-l),r=n=i.position,o=!1),it(m)||(n=i.position+1),m=i.input.charCodeAt(++i.position)}return Ue(i,r,n,!1),i.result?!0:(i.kind=d,i.result=p,!1)}function Vl(i,e){var t,a,s;if(t=i.input.charCodeAt(i.position),t!==39)return!1;for(i.kind="scalar",i.result="",i.position++,a=s=i.position;(t=i.input.charCodeAt(i.position))!==0;)if(t===39)if(Ue(i,a,i.position,!0),t=i.input.charCodeAt(++i.position),t===39)a=i.position,i.position++,s=i.position;else return!0;else Ie(t)?(Ue(i,a,s,!0),na(i,K(i,!1,e)),a=s=i.position):i.position===i.lineStart&&hi(i)?A(i,"unexpected end of the document within a single quoted scalar"):(i.position++,s=i.position);A(i,"unexpected end of the stream within a single quoted scalar")}function Ql(i,e){var t,a,s,r,n,o;if(o=i.input.charCodeAt(i.position),o!==34)return!1;for(i.kind="scalar",i.result="",i.position++,t=a=i.position;(o=i.input.charCodeAt(i.position))!==0;){if(o===34)return Ue(i,t,i.position,!0),i.position++,!0;if(o===92){if(Ue(i,t,i.position,!0),o=i.input.charCodeAt(++i.position),Ie(o))K(i,!1,e);else if(o<256&&ir[o])i.result+=ar[o],i.position++;else if((n=ql(o))>0){for(s=n,r=0;s>0;s--)o=i.input.charCodeAt(++i.position),(n=Nl(o))>=0?r=(r<<4)+n:A(i,"expected hexadecimal character");i.result+=Bl(r),i.position++}else A(i,"unknown escape sequence");t=a=i.position}else Ie(o)?(Ue(i,t,a,!0),na(i,K(i,!1,e)),t=a=i.position):i.position===i.lineStart&&hi(i)?A(i,"unexpected end of the document within a double quoted scalar"):(i.position++,a=i.position)}A(i,"unexpected end of the stream within a double quoted scalar")}function Wl(i,e){var t=!0,a,s,r,n=i.tag,o,l=i.anchor,c,u,d,p,m,f=Object.create(null),g,y,w,k;if(k=i.input.charCodeAt(i.position),k===91)u=93,m=!1,o=[];else if(k===123)u=125,m=!0,o={};else return!1;for(i.anchor!==null&&(i.anchorMap[i.anchor]=o),k=i.input.charCodeAt(++i.position);k!==0;){if(K(i,!0,e),k=i.input.charCodeAt(i.position),k===u)return i.position++,i.tag=n,i.anchor=l,i.kind=m?"mapping":"sequence",i.result=o,!0;t?k===44&&A(i,"expected the node content, but found ','"):A(i,"missed comma between flow collection entries"),y=g=w=null,d=p=!1,k===63&&(c=i.input.charCodeAt(i.position+1),me(c)&&(d=p=!0,i.position++,K(i,!0,e))),a=i.line,s=i.lineStart,r=i.position,_t(i,e,ci,!1,!0),y=i.tag,g=i.result,K(i,!0,e),k=i.input.charCodeAt(i.position),(p||i.line===a)&&k===58&&(d=!0,k=i.input.charCodeAt(++i.position),K(i,!0,e),_t(i,e,ci,!1,!0),w=i.result),m?pt(i,o,f,y,g,w,a,s,r):d?o.push(pt(i,null,f,y,g,w,a,s,r)):o.push(g),K(i,!0,e),k=i.input.charCodeAt(i.position),k===44?(t=!0,k=i.input.charCodeAt(++i.position)):t=!1}A(i,"unexpected end of the stream within a flow collection")}function Yl(i,e){var t,a,s=sa,r=!1,n=!1,o=e,l=0,c=!1,u,d;if(d=i.input.charCodeAt(i.position),d===124)a=!1;else if(d===62)a=!0;else return!1;for(i.kind="scalar",i.result="";d!==0;)if(d=i.input.charCodeAt(++i.position),d===43||d===45)sa===s?s=d===43?Zs:Ol:A(i,"repeat of a chomping mode identifier");else if((u=Ul(d))>=0)u===0?A(i,"bad explicit indentation width of a block scalar; it cannot be less than one"):n?A(i,"repeat of an indentation width identifier"):(o=e+u-1,n=!0);else break;if(it(d)){do d=i.input.charCodeAt(++i.position);while(it(d));if(d===35)do d=i.input.charCodeAt(++i.position);while(!Ie(d)&&d!==0)}for(;d!==0;){for(ra(i),i.lineIndent=0,d=i.input.charCodeAt(i.position);(!n||i.lineIndent<o)&&d===32;)i.lineIndent++,d=i.input.charCodeAt(++i.position);if(!n&&i.lineIndent>o&&(o=i.lineIndent),Ie(d)){l++;continue}if(i.lineIndent<o){s===Zs?i.result+=ee.repeat(`
            ...
            <div class="card-lower-content-container" style="${Ya?`min-height:${Ya}px;`:""}">
              ...
              <div class="card-lower-content${V?" collapsed transitioning":" transitioning"}${V&&le?" has-artwork":""}" style="${Qe?V?`min-height: ${this._collapsedBaselineHeight||220}px;`:"min-height: 350px;":""}">
                ...
                <div class="details" style="${(()=>{const b=[];return this._showEntityOptions&&(b.push("visibility:hidden"),b.push("opacity:0")),b.push(`min-height:${Sn}px`),ke||b.push("opacity:0"),b.join(";")})()}">
                  ...
                  `}
                  <div
                      class="artist ${ke&&D.attributes.media_artist?"clickable-artist":""}"
                      @click=${()=>{ke&&D.attributes.media_artist&&this._searchArtistFromNowPlaying()}}
                      title=${ke&&D.attributes.media_artist?h("search.search_artist"):""}
                    >${ke&&La?La:_`&nbsp;`}</div>
                </div>
        ...
        <div class="entity-options-container entity-options-container-opening">
          <div class="entity-options-sheet${d||f?" chips-mode":""} entity-options-sheet-opening" 
            ...
            <div class="entity-options-search-results ${this.config.search_view==="card"?"search-results-card-view":"list-view"}" 
              ...
              ${(()=>{this._searchMediaClassFilter;const b=this._getDisplaySearchResults(),q=Math.max(15,this._searchTotalRows||b.length),Q=[...b,...Array.from({length:Math.max(0,q-b.length)},()=>null)];return this._searchAttempted&&b.length===0&&!this._searchLoading?_`<div class="entity-options-search-empty">${h("common.no_results")}</div>`:Q.map(O=>O?_`
                            <!-- EXISTING non‑placeholder row markup -->
                            <div class="entity-options-search-result ${this.config.search_view==="card"?"search-result-card":""} ${O._justMoved?"just-moved":""} ${O.media_content_id!=null&&this._activeSearchRowMenuId===O.media_content_id?"menu-active":""}">
                               <div class="search-sheet-thumb-container"
                                    data-clickable="${this.config.search_view==="card"}"
                                    @click=${this.config.search_view==="card"?()=>this._playMediaFromSearch(O):null}>
                                ${O.thumbnail&&this._isValidArtworkUrl(O.thumbnail)&&!String(O.thumbnail).includes("imageproxy")?_`
                                   <img
                                ...
                                `}
                                ${this.config.search_view==="card"?ks({item:O,onPlay:M=>this._playMediaFromSearch(M),onOptionsToggle:M=>{this._activeSearchRowMenuId=M?.media_content_id||null,this.requestUpdate()},upcomingFilterActive:!!this._upcomingFilterActive,isMusicAssistant:this._isMusicAssistantEntity(),massQueueAvailable:this._massQueueAvailable,searchView:"card"}):v}
                               </div>
                               <div class="search-sheet-info">
                                <span class="${this._isClickableSearchResult(O)?"clickable-search-result":""} ${this.config.search_view==="card"?"search-sheet-title":""}"
                                      @touchstart=${M=>this._handleSearchResultTouch(O,M)}
                                      @click=${()=>this._handleSearchResultClick(O)}
                                      title=${this._getSearchResultClickTitle(O)}>
                                  ${O.title}
                                </span>
                                 <span class="search-sheet-subtitle">
                                  ${(()=>{const M=this._searchMediaClassFilter==="track"||this._searchMediaClassFilter==="album",$e=!!this._recentlyPlayedFilterActive,Fn=!!this._upcomingFilterActive,jn=!!this._recommendationsFilterActive;return(M||$e||Fn||jn)&&O.artist?O.artist:O.media_class?O.media_class.charAt(0).toUpperCase()+O.media_class.slice(1):""})()}
                                </span>
                                ${this.config.search_view==="card"?_`
                                  <div class="card-menu-button" @click=${M=>{M.preventDefault(),M.stopPropagation(),this._activeSearchRowMenuId=O.media_content_id,this.requestUpdate()}}>
                                    <ha-icon icon="mdi:dots-vertical"></ha-icon>
                                  </div>
                                `:v}
                              </div>
                              ${this.config.search_view!=="card"?ks({item:O,onPlay:M=>this._playMediaFromSearch(M),onOptionsToggle:M=>{this._activeSearchRowMenuId=M?.media_content_id||null,this.requestUpdate()},upcomingFilterActive:!!this._upcomingFilterActive,isMusicAssistant:this._isMusicAssistantEntity(),massQueueAvailable:this._massQueueAvailable,searchView:"list",isInline:!0,onMoveUp:M=>this._moveQueueItemUp(M.queue_item_id),onMoveDown:M=>this._moveQueueItemDown(M.queue_item_id),onMoveNext:M=>this._moveQueueItemNext(M.queue_item_id),onRemove:M=>this._removeQueueItem(M.queue_item_id)}):v}
                                ...
                                ${To({item:O,activeSearchRowMenuId:this._activeSearchRowMenuId,loadingSearchRowMenuId:this._loadingSearchRowMenuId,onPlayOption:(M,$e)=>this._performSearchOptionAction(M,$e),onOptionsToggle:M=>{this._activeSearchRowMenuId=M?.media_content_id||null,this.requestUpdate()},searchView:this.config.search_view,isQueueItem:this._isMusicAssistantEntity()&&O.queue_item_id&&!!this._upcomingFilterActive&&this._massQueueAvailable,massQueueAvailable:this._massQueueAvailable,onMoveUp:M=>this._moveQueueItemUp(M.queue_item_id),onMoveDown:M=>this._moveQueueItemDown(M.queue_item_id),onMoveNext:M=>this._moveQueueItemNext(M.queue_item_id),onRemove:M=>this._removeQueueItem(M.queue_item_id)})}

                        ${this._loadingSearchRowMenuId===O.media_content_id?_`
                        ...
                        ${this._errorSearchRowMenuId===O.media_content_id?_`
                        ...
                        ${this._successSearchRowMenuId===O.media_content_id?_`
              ...
              `:this._showGrouping?this._renderGroupingSheet():_`
                ...
                <div class="floating-source-index">
                  ${pe.map((b,q)=>{const Q=Se.has(b),O=this._hoveredSourceLetterIndex;let M="";if(Q&&O!==null&&O!==void 0){const $e=Math.abs(O-q);$e===0?M="max":$e===1?M="large":$e===2&&(M="med")}return _`
                      <button
...
`}
            ...
            ${Ga?_`
              <div class="persistent-media-controls" @click=${b=>b.stopPropagation()}>
                ...
                ${(()=>{const b=this._selectedIndex,q=this._getVolumeEntity(b);if(!q)return v;const Q=q.startsWith&&q.startsWith("remote."),O=this.currentVolumeStateObj,M=Number(O?.attributes?.volume_level??0),$e=Q?null:`${Math.round((M||0)*100)}%`;return this.config.volume_mode==="hidden"?v:_`
        ...
        `:v}
          ${this._searchActiveOptionsItem?Mo({item:this._searchActiveOptionsItem,onClose:()=>{this._searchActiveOptionsItem=null,this.requestUpdate()},onPlayOption:(b,q)=>this._performSearchOptionAction(b,q),massQueueAvailable:this._massQueueAvailable}):v}
