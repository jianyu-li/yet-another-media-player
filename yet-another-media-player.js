...
class YetAnotherMediaPlayerCard extends i$1 {
  ...
  _getTransferQueueTargets() {
    ...
    for (let idx = 0; idx < this.entityObjs.length; idx++) {
      var _this$hass8, _this$hass9, _mainState$attributes, _maState$attributes8, _displayState$attribu;
      const obj = this.entityObjs[idx];
      if (!obj) continue;
  ...
  _getActivePlaybackEntityIdForIndex(idx) {
    ...
    const mainState = mainId ? (_this$hass14 = this.hass) === null || _this$hass14 === void 0 || (_this$hass14 = _this$hass14.states) === null || _this$hass14 === void 0 ? void 0 : _this$hass14[mainId] : null;
    const maState = maId ? (_this$hass15 = this.hass) === null || _this$hass15 === void 0 || (_this$hass15 = _this$hass15.states) === null || _this$hass15 === void 0 ? void 0 : _this$hass15[maId] : null;
    if (maId === mainId) return mainId;
  ...
  _getGroupKey(id) {
    ...
    const st = (_this$hass16 = this.hass) === null || _this$hass16 === void 0 || (_this$hass16 = _this$hass16.states) === null || _this$hass16 === void 0 ? void 0 : _this$hass16[groupingId];
    if (!st) return id;
  ...
  get currentActivePlaybackEntityId() {
    ...
    const cacheKey = "".concat(this._selectedIndex, "-").concat((_this$hass17 = this.hass) === null || _this$hass17 === void 0 || (_this$hass17 = _this$hass17.states) === null || _this$hass17 === void 0 || (_this$hass17 = _this$hass17[this.currentEntityId]) === null || _this$hass17 === void 0 ? void 0 : _this$hass17.state, "-").concat((_this$hass18 = this.hass) === null || _this$hass18 === void 0 || (_this$hass18 = _this$hass18.states) === null || _this$hass18 === void 0 || (_this$hass18 = _this$hass18[this._getSearchEntityId(this._selectedIndex)]) === null || _this$hass18 === void 0 ? void 0 : _this$hass18.state);
  ...
  get currentActivePlaybackStateObj() {
    ...
    return id ? (_this$hass19 = this.hass) === null || _this$hass19 === void 0 || (_this$hass19 = _this$hass19.states) === null || _this$hass19 === void 0 ? void 0 : _this$hass19[id] : null;
  }
  ...
  render() {
    var _this$config$actions2, _this$currentStateObj, _this$_optimisticPlay, _this$hass27, _this$_lastPlayingEnt9, _this$_lastPlayingEnt0, _this$_playbackLinger4, _this$config$entities, _this$_lastPlayingEnt1, _this$_maResolveCache3, _this$_playbackLinger5, _this$hass28, _finalPlaybackStateOb, _finalPlaybackStateOb2, _finalPlaybackStateOb3, _displaySource$attrib, _displaySource$attrib2, _displaySource$attrib3, _displaySource$attrib4, _displaySource$attrib5, _displaySource$attrib6, _displaySource$attrib8, _displaySource$attrib9, _this$currentVolumeSt2, _this$shadowRoot$host, _this$shadowRoot, _this$config11, _this$config12, _this$config13, _this$currentVolumeSt3, _this$currentVolumeSt4, _this$config14, _this$config15, _this$config16, _this$currentStateObj2, _this$currentPlayback, _this$config17;
    ...
    const sourceList = stateObj.attributes.source_list && stateObj.attributes.source_list.length > 0 ? stateObj.attributes.source_list : ((_this$currentStateObj = this.currentStateObj) === null || _this$currentStateObj === void 0 || (_this$currentStateObj = _this$currentStateObj.attributes) === null || _this$currentStateObj === void 0 ? void 0 : _this$currentStateObj.source_list) || [];
    ...
    }, Array.isArray((_this$currentStateObj2 = this.currentStateObj) === null || _this$currentStateObj2 === void 0 || (_this$currentStateObj2 = _this$currentStateObj2.attributes) === null || _this$currentStateObj2 === void 0 ? void 0 : _this$currentStateObj2.source_list) && this.currentStateObj.attributes.source_list.length > 0 ? x(_templateObject20 || (_templateObject20 = _taggedTemplateLiteral(["\n                      <button class=\"entity-options-item\" @click=", ">Source</button>\n                    "])), () => this._openSourceList()) : E, this._canShowTransferQueueOption() ? x(_templateObject21 || (_templateObject21 = _taggedTemplateLiteral(["\n                    <button class=\"entity-options-item\" @click=", ">Transfer Queue</button>\n                  "])), () => this._openTransferQueue()) : E, (() => {
