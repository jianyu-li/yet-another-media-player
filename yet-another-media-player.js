          ...
          >
            ...
            <div class="card-lower-content-container" style="${as?`min-height:${as}px;`:""}">
              <div class="card-lower-content-bg"
                style="${(()=>{const b=[];return Ha&&rs?b.push("background-image: none","filter: none"):b.push(ns),b.push(`min-height: ${Q?ut?`${this._collapsedBaselineHeight||220}px`:"0px":"350px"}`),b.push("transition: min-height 0.4s cubic-bezier(0.6,0,0.4,1), background 0.4s"),b.join("; ")})()}"
              ></div>
              ${Ua||Ft?g:_`<div class="card-lower-fade"></div>`}
              <div class="card-lower-content${Q?" collapsed transitioning":" transitioning"}${Q&&le?" has-artwork":""}" style="${ut?Q?`min-height: ${this._collapsedBaselineHeight||220}px;`:"min-height: 350px;":""}">
