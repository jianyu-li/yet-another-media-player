 ...
 */const Jn=Kn(class extends Xn{constructor(i){if(super(i),i.type!==Zn.ATTRIBUTE||i.name!=="class"||i.strings?.length>2)throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(i){return" "+Object.keys(i).filter((e=>i[e])).join(" ")+" "}update(i,[e]){if(this.st===void 0){this.st=new Set,i.strings!==void 0&&(this.nt=new Set(i.strings.join(" ").split(/\s/).filter((a=>a!==""))));for(const a in e)e[a]&&!this.nt?.has(a)&&this.st.add(a);return this.render(e)}const t=i.element.classList;for(const a of this.st)a in e||(t.remove(a),this.st.delete(a));for(const a in e){const s=!!e[a];s===this.st.has(a)||this.nt?.has(a)||(s?(t.add(a),this.st.add(a)):(t.remove(a),this.st.delete(a)))}return Xe}});function we(i,e){const t=i?.[e];return typeof t=="string"&&t.trim()!==""?t:null}async function eo(i,e,t){if(!e||typeof e!="string")return t;if(!e.includes("{{")&&!e.includes("{%"))return e;try{const a=(await i.callApi("POST","template",{template:e})||"").toString().trim();return a&&/^([a-z_]+)\.[A-Za-z0-9_]+$/.test(a)?a:t}catch{return t}}async function to(i,e,t={}){if(!e||typeof e!="string")return e;if(!e.includes("{{")&&!e.includes("{%")){if(/%7B%7B|%7B%25/i.test(e))try{e=decodeURIComponent(e)}catch{}if(!e.includes("{{")&&!e.includes("{%"))return e}let a=e;t&&Object.keys(t).length>0&&(a=`${Object.entries(t).map(([s,r])=>`{% set ${s} = ${JSON.stringify(r)} %}`).join(" ")} ${e}`);try{return(await i.callApi("POST","template",{template:a})||"").toString().trim()}catch(s){return console.warn("yamp: Error resolving template:",e,s),e}}function io(i,e,t={}){if(!e||typeof e!="string")return e;let a=e;if(/%7B%7B|%7B%25/i.test(a))try{a=decodeURIComponent(a)}catch{}if(!a.includes("{{")&&!a.includes("{%"))return a;let s=a,r=!0;return s=s.replace(/\{\{\s*(.*?)\s*\}\}/g,(n,o)=>{let l=o.trim(),c=!1;l.endsWith("| urlencode")?(c=!0,l=l.replace(/\|\s*urlencode$/,"").trim()):l.endsWith("|urlencode")&&(c=!0,l=l.replace(/\|urlencode$/,"").trim());let u=l.match(/^state_attr\(\s*(['"]?)([\w.]+)\1\s*,\s*(['"]?)([\w_]+)\3\s*\)$/);if(u){let p=u[2],_=t[p]!==void 0&&!u[1]?t[p]:p,g=u[4];const y=i?.states?.[_];if(y&&y.attributes&&y.attributes[g]!==void 0){let v=String(y.attributes[g]);return c?encodeURIComponent(v):v}return""}let d=l.match(/^states\(\s*(['"]?)([\w.]+)\1\s*\)$/);if(d){let p=d[2],_=t[p]!==void 0&&!d[1]?t[p]:p;const g=i?.states?.[_];if(g&&g.state!==void 0){let y=String(g.state);return c?encodeURIComponent(y):y}return""}if(/^[\w_]+$/.test(l)&&t[l]!==void 0){let p=String(t[l]);return c?encodeURIComponent(p):p}return r=!1,n}),!r||s.includes("{%")?null:s}function ao(i,e){if(!i?.states||!e)return[];const t=[],a=i.states[e];if(!a)return[];const s=a.attributes?.device_id,r=a.attributes?.friendly_name||e;for(const[n,o]of Object.entries(i.states))if(n.startsWith("button.")&&o.attributes){const l=o.attributes.device_id,c=o.attributes.friendly_name||n;s&&l===s?t.push({entity_id:n,friendly_name:c,device_class:o.attributes.device_class,reason:"same_device"}):(c.toLowerCase().includes(r.toLowerCase())||r.toLowerCase().includes(c.toLowerCase()))&&t.push({entity_id:n,friendly_name:c,device_class:o.attributes.device_class,reason:"name_similarity"})}return t}function so(i,e){if(!i?.states||!e)return null;const t=i.states[e];return t&&t.attributes&&(t.attributes.media_content_id||t.attributes.media_content_type||t.attributes.media_album_name||t.attributes.media_artist||t.attributes.media_title)?t:null}function tt(i){return!i||!i.attributes?!1:i.attributes.app_id==="music_assistant"||i.attributes.mass_player_type!==void 0}function ro(i){if(!i)return"";const e=i.media_type||i.media_class||i.media_content_type,t=i.name||i.title||i.media_title||"Unknown Title",a=i.artists?.[0],s=i.artist||a?.name||(typeof a=="string"?a:void 0)||i.media_artist||"Unknown Artist";return e==="track"?`${t} - ${s}`:e==="album"?`${t} - ${s}`:t}function fs(i,e="",t=[],a=null){if(!i||!i.attributes)return null;const s=i.attributes,r=i.entity_id;s.app_id;let n=null,o=null;if(t&&Array.isArray(t)&&t.length){const l=(d,p)=>{if(d)return d[p]},c=[["media_title","media_title"],["media_artist","media_artist"],["media_album_name","media_album_name"],["media_content_id","media_content_id"],["media_channel","media_channel"],["app_name","app_name"],["media_content_type","media_content_type"],["entity_id","entity_id"],["entity_state","entity_state"]];let u=t.find(d=>c.some(([p,_])=>{const g=l(d,_);return g===void 0?!1:(p==="entity_id"?r:p==="entity_state"?i?.state:s[p])===g}));u||we(s,"entity_picture_local")||we(s,"entity_picture")||we(s,"album_art")||(u=t.find(d=>d?.missing_art_url),u?.missing_art_url&&(u={...u,image_url:u.missing_art_url})),u?.image_url&&(n=u.image_url,o=u?.size_percentage)}return n||(n=we(s,"entity_picture_local")||we(s,"entity_picture")||we(s,"album_art")||null),!n&&a&&(a==="smart"?s.media_title==="TV"||s.media_channel||s.app_id==="tv"||s.app_id==="androidtv"?n="data:image/svg+xml;base64,":n="data:image/svg+xml;base64,":typeof a=="string"&&(n=a)),n&&e&&!n.startsWith("http")&&(n=e+n),{url:n,sizePercentage:o}}function no({idx:i,selected:e,playing:t,name:a,art:s,icon:r,pinned:n,holdToPin:o,maActive:l,onChipClick:c,onIconClick:u,onPinClick:d,onPointerDown:p,onPointerMove:_,onPointerUp:g,objectFit:y,quickGroupingState:v,onQuickGroupClick:k,onDoubleClick:x}){const D=y?`object-fit: ${y};`:"";return m`
    <button class="chip"
      ...
      ${v&&v.isGroupable?m`
            <span class="chip-quick-group" @click=${E=>{E.stopPropagation(),k&&!v.isBusy&&!v.isPrimary&&k(i,E)}} title=${v.tooltip||(v.isPrimary?"Primary":v.isBusy?"Unavailable":v.grouped?"Unjoin":"Join")} style="${v.isPrimary?"cursor:default;opacity:0.7;":v.isBusy?"opacity:0.5;cursor:not-allowed;":""}">
              <ha-icon .icon=${v.isPrimary?"mdi:star-circle-outline":v.grouped?"mdi:minus":"mdi:plus"}></ha-icon>
            </span>
          `:b}
    </button>
  `}function oo({idx:i,selected:e,playing:t,groupName:a,art:s,icon:r,pinned:n,holdToPin:o,maActive:l,onChipClick:c,onIconClick:u,onPinClick:d,onPointerDown:p,onPointerMove:_,onPointerUp:g,objectFit:y,quickGroupingState:v,onQuickGroupClick:k,onDoubleClick:x}){const D=y?`object-fit: ${y};`:"";return m`
...
`,ko=[{mode:"replace",icon:"mdi:playlist-remove",label:h("search.replace")},{mode:"next",icon:"mdi:playlist-play",label:h("search.play_next")},{mode:"replace_next",icon:"mdi:playlist-music",label:h("search.replace_play")},{mode:"add",icon:"mdi:playlist-plus",label:h("search.add_queue")}],Le=(i,{cap:e,floor:t}={})=>{const a=Number(i);if(!Number.isFinite(a)||a<=0)return;let s=a;return typeof t=="number"&&(s=Math.max(t,s)),typeof e=="number"&&(s=Math.min(e,s)),s},ys=3e4;let Tt=null,Xi=0;async function ni(i){const e=Date.now();if(Tt&&e-Xi<ys)return Tt;try{return Tt=(await i.callApi("GET","config/config_entries/entry")).find(t=>t.domain==="music_assistant"&&t.state==="loaded")?.entry_id||null,Xi=e,Tt}catch(t){return console.error("yamp: Failed to resolve Music Assistant config entry",t),Tt=null,Xi=e,null}}let Mt=null,Ji=0;async function Eo(i){const e=Date.now();if(Mt&&e-Ji<ys)return Mt;try{return Mt=(await i.callApi("GET","config/config_entries/entry")).find(t=>t.domain==="mass_queue"&&t.state==="loaded")?.entry_id||null,Ji=e,Mt}catch(t){return console.error("yamp: Failed to resolve mass_queue config entry",t),Mt=null,Ji=e,null}}function jt(i){return i?{title:i.name,media_content_id:i.uri,media_content_type:i.media_type,media_class:i.media_type,thumbnail:i.image,...i.artists&&{artist:i.artists.map(e=>e.name).join(", ")},...i.album&&{album:i.album.name},is_browsable:i.media_type==="artist"||i.media_type==="album"}:null}function oi({item:i,onPlay:e,onOptionsToggle:t,upcomingFilterActive:a=!1,isMusicAssistant:s=!1,massQueueAvailable:r=!1,searchView:n="list",isInline:o=!1,onMoveUp:l,onMoveDown:c,onMoveNext:u,onRemove:d}){const p=!!(a&&i.queue_item_id&&s&&r),_=o?"entity-options-search-buttons":n==="card"?"card-overlay-buttons":"search-sheet-buttons",g=o?"entity-options-search-play":n==="card"?"search-sheet-play icon-only":"search-sheet-play",y=o?"entity-options-search-queue":n==="card"?"search-sheet-queue icon-only":"search-sheet-queue";return m`
  ...
  `}function Ao({open:i,query:e,onQueryInput:t,onSearch:a,onClose:s,loading:r,results:n,onPlay:o,onQueue:l,error:c,showQueueSuccess:u,matchTheme:d=!1,upcomingFilterActive:p=!1,disableAutofocus:_=!1,activeSearchRowMenuId:g,successSearchRowMenuId:y,onOptionsToggle:v,onPlayOption:k,onResultClick:x,searchView:D="list",searchCardColumns:E=4,massQueueAvailable:G=!1,onMoveUp:B,onMoveDown:z,onMoveNext:L,onRemove:N}){return i?m`
        ...
        ${(n||[]).length===0&&!r?m`<div class="search-sheet-empty">${h("common.no_results")}</div>`:(n||[]).map(T=>{const M=tt(T.media_content_id);return m`
                <div class="search-sheet-result ${D==="card"?"search-result-card":""}">
                  <div class="search-sheet-thumb-container" 
                    ...
                    `}
                    ${D==="card"?oi({item:T,onPlay:o,onOptionsToggle:v,upcomingFilterActive:p,isMusicAssistant:M,massQueueAvailable:G,searchView:"card",onMoveUp:B,onMoveDown:z,onMoveNext:L,onRemove:N}):b}
                  </div>
                  ...
                  ${D!=="card"?oi({item:T,onPlay:o,onOptionsToggle:v,upcomingFilterActive:p,isMusicAssistant:M,massQueueAvailable:G,searchView:"list",isInline:!0,onMoveUp:B,onMoveDown:z,onMoveNext:L,onRemove:N}):b}
                  
                  ${bs({item:T,activeSearchRowMenuId:g,successSearchRowMenuId:y,onPlayOption:k,onOptionsToggle:v,searchView:D,isQueueItem:M&&T.queue_item_id&&p&&G,onMoveUp:B,onMoveDown:z,onMoveNext:L,onRemove:N})}
                </div>
              `})}
      </div>
    </div>
        ...
        <ha-card class="yamp-card" style=${a&&(!Q||this._alwaysCollapsed)?`height:${t}px;`:b}>
          ...
          >
            ${Oa&&Xa?m`
              ...
              ${Da?b:m`<div class="full-bleed-artwork-fade"></div>`}
            `:b}
            ...
            <div class="card-lower-content-container" style="${Za?`min-height:${Za}px;`:""}">
              ...
              ></div>
              ${Da?b:m`<div class="card-lower-fade"></div>`}
          ...
          <div class="entity-options-sheet${d||g?" chips-mode":""} entity-options-sheet-opening" 
            ...
            ${d||g?m`
                ...
                <div class="chip-row entity-options-chips-strip">
                  ${gs({groupedSortedEntityIds:this.groupedSortedEntityIds,entityIds:this.entityIds,selectedEntityId:this.currentEntityId,pinnedIndex:this._pinnedIndex,holdToPin:this._holdToPin,getChipName:f=>this.getChipName(f),getActualGroupMaster:f=>this._getActualGroupMaster(f),getIsChipPlaying:(f,A)=>{const F=this._findEntityObjByAnyId(f)?.entity_id||f,j=this.entityIds.indexOf(F);if(j<0)return!1;const $=this._getEntityForPurpose(j,"playback_control"),ie=this.hass?.states?.[$];return this._isEntityPlaying(ie)},getChipArt:f=>{const A=this._findEntityObjByAnyId(f)?.entity_id||f,F=this.entityIds.indexOf(A);if(F<0)return null;const j=this._getEntityForPurpose(F,"playback_control"),$=this.hass?.states?.[j],ie=this.hass?.states?.[A],Ni=this._getArtworkUrl($),qi=this._getArtworkUrl(ie);return Ni||qi},getIsMaActive:f=>{const A=this._findEntityObjByAnyId(f)?.entity_id||f,F=this.entityIds.indexOf(A);if(F<0)return!1;const j=this.entityObjs[F];if(!j?.music_assistant_entity)return!1;const $=this._getEntityForPurpose(F,"playback_control"),ie=this.hass?.states?.[$];return $===this._resolveEntity(j.music_assistant_entity,j.entity_id,F)&&this._isEntityPlaying(ie)},isIdle:this._isIdle,hass:this.hass,artworkHostname:this.config?.artwork_hostname||"",mediaArtworkOverrides:this.config?.media_artwork_overrides||[],fallbackArtwork:this.config?.fallback_artwork||null,onChipClick:f=>this._onChipClick(f),onIconClick:(f,A)=>{const F=this.entityIds[f],j=this.groupedSortedEntityIds.find($=>$.includes(F));j&&j.length>1&&(this._selectedIndex=f,this._showEntityOptions=!0,this._showGrouping=!0,this.requestUpdate())},onPinClick:(f,A)=>{A.stopPropagation(),this._onPinClick(A)},onPointerDown:(f,A)=>this._handleChipPointerDown(f,A),onPointerMove:(f,A)=>this._handleChipPointerMove(f,A),onPointerUp:(f,A)=>this._handleChipPointerUp(f,A),quickGroupingMode:this._quickGroupingMode,getQuickGroupingState:f=>{const A=this.currentEntityId,F=this.entityIds.indexOf(A),j=F>=0?this._getGroupingEntityId(F):A,$=j?this.hass.states[j]:null,ie=this._getGroupKey(this.currentEntityId);return this._getGroupPlayerState(f,A,null,$,ie)},onQuickGroupClick:(f,A)=>{const F=this.entityIds[f];F&&this._toggleGroup(F)},onDoubleClick:f=>{f.stopPropagation(),this._quickGroupingMode=!this._quickGroupingMode,this.requestUpdate()}})}
                </div>
              </div>
            `:b}
                      ...
                      <div class="chip-row search-filter-chips" id="search-filter-chip-row" style="margin-bottom:12px; justify-content: center; align-items: center;">
                        ...
                        ${f.map(F=>m`
                          <button
                            ...
                            style="
                              width: 72px;
                              background: ${A===F?this._customAccent:"#282828"};
                              opacity: ${A===F?"1":"0.8"};
                              font-weight: ${A===F?"bold":"normal"};
                            "
                            ?selected=${A===F}
                            @click=${()=>this._doSearch(F)}
                          >
                            ${h(`search.filters.${F}`)}
                          </button>
                        `)}
            ...
            <div class="entity-options-search-results ${this.config.search_view==="card"?"search-results-card-view":"list-view"}" 
              ...
              ${(()=>{this._searchMediaClassFilter;const f=this._getDisplaySearchResults(),A=Math.max(15,this._searchTotalRows||f.length),F=[...f,...Array.from({length:Math.max(0,A-f.length)},()=>null)];return this._searchAttempted&&f.length===0&&!this._searchLoading?m`<div class="entity-options-search-empty" style="color: white;">No results.</div>`:F.map(j=>j?m`
                            <!-- EXISTING non‑placeholder row markup -->
                            <div class="entity-options-search-result ${this.config.search_view==="card"?"search-result-card":""} ${j._justMoved?"just-moved":""} ${j.media_content_id!=null&&this._activeSearchRowMenuId===j.media_content_id?"menu-active":""}">
                               <div class="search-sheet-thumb-container"
                                    data-clickable="${this.config.search_view==="card"}"
                                    @click=${this.config.search_view==="card"?()=>this._playMediaFromSearch(j):null}>
                                ${j.thumbnail&&this._isValidArtworkUrl(j.thumbnail)&&!String(j.thumbnail).includes("imageproxy")?m`
                                   <img
                                ...
                                `}
                                ${this.config.search_view==="card"?oi({item:j,onPlay:$=>this._playMediaFromSearch($),onOptionsToggle:$=>{this._activeSearchRowMenuId=$?.media_content_id||null,this.requestUpdate()},upcomingFilterActive:!!this._upcomingFilterActive,isMusicAssistant:this._isMusicAssistantEntity(),massQueueAvailable:this._massQueueAvailable,searchView:"card"}):b}
                               </div>
                               <div class="search-sheet-info">
                                <span class="${this._isClickableSearchResult(j)?"clickable-search-result":""} ${this.config.search_view==="card"?"search-sheet-title":""}"
                                      @touchstart=${$=>this._handleSearchResultTouch(j,$)}
                                      @click=${()=>this._handleSearchResultClick(j)}
                                      title=${this._getSearchResultClickTitle(j)}>
                                  ${j.title}
                                </span>
                                 <span class="search-sheet-subtitle">
                                  ${(()=>{const $=this._searchMediaClassFilter==="track"||this._searchMediaClassFilter==="album",ie=!!this._recentlyPlayedFilterActive,Ni=!!this._upcomingFilterActive,qi=!!this._recommendationsFilterActive;return($||ie||Ni||qi)&&j.artist?j.artist:j.media_class?j.media_class.charAt(0).toUpperCase()+j.media_class.slice(1):""})()}
                                </span>
                                ${this.config.search_view==="card"?m`
                                  <div class="card-menu-button" @click=${$=>{$.preventDefault(),$.stopPropagation(),this._activeSearchRowMenuId=j.media_content_id,this.requestUpdate()}}>
                                    <ha-icon icon="mdi:dots-vertical"></ha-icon>
                                  </div>
                                `:b}
                              </div>
                              ${this.config.search_view!=="card"?oi({item:j,onPlay:$=>this._playMediaFromSearch($),onOptionsToggle:$=>{this._activeSearchRowMenuId=$?.media_content_id||null,this.requestUpdate()},upcomingFilterActive:!!this._upcomingFilterActive,isMusicAssistant:this._isMusicAssistantEntity(),massQueueAvailable:this._massQueueAvailable,searchView:"list",isInline:!0,onMoveUp:$=>this._moveQueueItemUp($.queue_item_id),onMoveDown:$=>this._moveQueueItemDown($.queue_item_id),onMoveNext:$=>this._moveQueueItemNext($.queue_item_id),onRemove:$=>this._removeQueueItem($.queue_item_id)}):b}
                                ...
                                ${bs({item:j,activeSearchRowMenuId:this._activeSearchRowMenuId,successSearchRowMenuId:this._successSearchRowMenuId,onPlayOption:($,ie)=>this._performSearchOptionAction($,ie),onOptionsToggle:$=>{this._activeSearchRowMenuId=$?.media_content_id||null,this.requestUpdate()},searchView:this.config.search_view,isQueueItem:this._isMusicAssistantEntity()&&j.queue_item_id&&!!this._upcomingFilterActive&&this._massQueueAvailable,onMoveUp:$=>this._moveQueueItemUp($.queue_item_id),onMoveDown:$=>this._moveQueueItemDown($.queue_item_id),onMoveNext:$=>this._moveQueueItemNext($.queue_item_id),onRemove:$=>this._removeQueueItem($.queue_item_id)})}
                            </div>
                          `:m`
              ...
              `:this._showGrouping?this._renderGroupingSheet():m`
                ...
                <div class="floating-source-index">
                  ${_e.map((f,A)=>{const F=Se.has(f),j=this._hoveredSourceLetterIndex;let $="";if(F&&j!==null&&j!==void 0){const ie=Math.abs(j-A);ie===0?$="max":ie===1?$="large":ie===2&&($="med")}return m`
                      <button
                        class="source-index-letter"
                        ?disabled=${!F}
                        data-scale=${$}
                        @mouseenter=${F?()=>{this._hoveredSourceLetterIndex=A,this.requestUpdate()}:b}
                        @mouseleave=${()=>{this._hoveredSourceLetterIndex=null,this.requestUpdate()}}
                        @click=${F?()=>this._scrollToSourceLetter(f):b}
                      >
                        ${f}
                      </button>
                    `})}
            ...
            ${Ha?m`
              <div class="persistent-media-controls" @click=${f=>f.stopPropagation()}>
                <div class="persistent-controls-artwork">
                  ${(()=>{const f=this.currentPlaybackStateObj,A=this.currentStateObj,F=this._getArtworkUrl(f)||this._getArtworkUrl(A);return F?.url&&this._isValidArtworkUrl(F.url)?m`
                      <img src="${F.url}" alt="Album Art" class="persistent-artwork" onerror="this.style.display='none'">
                    `:m`
                ...
                ${(()=>{const f=this._selectedIndex,A=this._getVolumeEntity(f);if(!A)return b;const F=A.startsWith&&A.startsWith("remote."),j=this.currentVolumeStateObj,$=Number(j?.attributes?.volume_level??0),ie=F?null:`${Math.round(($||0)*100)}%`;return this.config.volume_mode==="hidden"?b:m`
