...
class YetAnotherMediaPlayerCard extends i$2 {
  ...
  render() {
    ...
    return x(_templateObject28 || (_templateObject28 = _taggedTemplateLiteral(["\n        <ha-card class=\"yamp-card\" style=", ">\n          <div\n            data-match-theme=\"", "\"\n            class=", "\n          >\n            ", "\n            ", "\n            <div class=\"card-lower-content-container\" style=\"", "\">\n              <div class=\"card-lower-content-bg\"\n                style=\"", "\"\n              ></div>\n              ", "\n              <div class=\"card-lower-content", "", "\" style=\"", "\">\n                ", "\n                ", "\n                <div class=\"details\" style=\"", "\">\n                  <div class=\"title\">\n                    ", "\n                  </div>\n                  <div\n                      class=\"artist ", "\"\n                      @click=", "\n                      title=", "\n                    >", "</div>\n                </div>\n                ", "\n                ", "\n                ", "\n                <div style=\"", "\">\n                    ", "\n\n                    ", "\n                  </div>\n            ", "\n            ", "\n          </div>\n        </div>\n\n      ", "\n          ", "\n          ", "\n          </div>\n    </ha-card>\n  "])), hasCustomCardHeight && (!collapsed || this._alwaysCollapsed) ? "height:".concat(customCardHeight, "px;") : E, String(this.config.match_theme === true), e({
      ...
      return chipsHiddenInline ? x(_templateObject32 || (_templateObject32 = _taggedTemplateLiteral(["", "", ""])), actionRowTemplate, chipRowTemplate) : x(_templateObject33 || (_templateObject33 = _taggedTemplateLiteral(["", "", ""])), chipRowTemplate, actionRowTemplate);
    ...
    })(), shouldShowDetails && title ? title : x(_templateObject38 || (_templateObject38 = _taggedTemplateLiteral(["&nbsp;"]))), shouldShowDetails && stateObj.attributes.media_artist ? 'clickable-artist' : '', () => {
      if (shouldShowDetails && stateObj.attributes.media_artist) this._searchArtistFromNowPlaying();
    }, shouldShowDetails && stateObj.attributes.media_artist ? localize('search.search_artist') : "", shouldShowDetails && artist ? artist : x(_templateObject39 || (_templateObject39 = _taggedTemplateLiteral(["&nbsp;"]))), !collapsed && !this._alternateProgressBar ? isPlaying && duration ? renderProgressBar({
      progress,
      seekEnabled: true,
      ...
      moreInfoMenu: x(_templateObject41 || (_templateObject41 = _taggedTemplateLiteral(["\n                        <div class=\"more-info-menu\">\n                          <button class=\"more-info-btn\" @click=", ">\n                            <span class=\"more-info-icon\">&#9776;</span>\n                          </button>\n                        </div>\n                      "])), async () => await this._openEntityOptions())
    }), hideControlsNow && !this._showEntityOptions ? x(_templateObject42 || (_templateObject42 = _taggedTemplateLiteral(["\n              <div class=\"more-info-menu\" style=\"position: absolute; right: 18px; bottom: 18px; z-index: ", ";\">\n                <button class=\"more-info-btn\" @click=", ">\n                  <span class=\"more-info-icon\">&#9776;</span>\n                </button>\n              </div>\n            "])), Z_LAYERS.FLOATING_ELEMENT, async () => await this._openEntityOptions()) : E, showChipsInMenu && !this._showEntityOptions && !this._hideActiveEntityLabel ? x(_templateObject43 || (_templateObject43 = _taggedTemplateLiteral(["\n              <div class=\"in-menu-active-label\">", "</div>\n            "])), activeChipName) : E, this._showEntityOptions ? x(_templateObject44 || (_templateObject44 = _taggedTemplateLiteral(["\n      <div class=\"entity-options-overlay entity-options-overlay-opening\" @click=", ">\n        <div class=\"entity-options-container entity-options-container-opening\">\n          <div class=\"entity-options-sheet", " entity-options-sheet-opening\" \n               @click=", "\n               data-pin-search-headers=\"", "\">\n            ", "\n              ", "\n              </div>\n            </div>\n            <!-- Persistent Media Controls Section - Outside Scrollable Area -->\n            ", "\n          </div>\n        "])), e => this._closeEntityOptions(e), showChipsInMenu || reserveChipSpaceInMenu ? ' chips-mode' : '', e => e.stopPropagation(), effectivePinHeaders, showChipsInMenu || reserveChipSpaceInMenu ? x(_templateObject45 || (_templateObject45 = _taggedTemplateLiteral(["\n                <div class=\"entity-options-chips-wrapper\" style=\"", "\" @click=", ">\n                <div class=\"chip-row entity-options-chips-strip\">\n                  ", "\n                </div>\n              </div>\n            "])), reserveChipSpaceInMenu && !showChipsInMenu ? 'visibility:hidden;pointer-events:none;' : '', e => e.stopPropagation(), renderChipRow({
      groupedSortedEntityIds: this.groupedSortedEntityIds,
      entityIds: this.entityIds,
      selectedEntityId: this.currentEntityId,
      pinnedIndex: this._pinnedIndex,
      ...
      onPointerMove: (e, idx) => this._handleChipPointerMove(e, idx),
      onPointerUp: (e, idx) => this._handleChipPointerUp(e, idx)
    })) : E, !this._showGrouping && !this._showSourceList && !this._showSearchInSheet && !this._showResolvedEntities && !this._showTransferQueue ? this._renderMainMenu(sourceList, menuOnlyActions, showChipsInMenu) : this._showGrouping ? this._renderGroupingSheet() : this._showTransferQueue ? this._renderTransferQueueSheet() : this._showResolvedEntities ? this._renderResolvedEntitiesSheet() : this._showSearchInSheet ? x(_templateObject46 || (_templateObject46 = _taggedTemplateLiteral(["\n              <div class=\"entity-options-search\" style = \"margin-top:12px;\" >\n                ", "\n                  ", "\n                  <div class=\"entity-options-search-row\">\n                      <input\n                        type=\"text\"\n                        id=\"search-input-box\"\n                        ?autofocus=", "\n                        class=\"entity-options-search-input\"\n                        .value=", "\n                        @input=", "\n                        @keydown=", "\n                        placeholder=\"", "\"\n                        style=\"flex:1; min-width:0; font-size:1.1em;\"\n                      />\n                    <button\n                      class=\"entity-options-item\"\n                      style=\"min-width:80px;\"\n                      @click=", "\n                      ?disabled=", ">\n                      ", "\n                    </button>\n                    <button\n                      class=\"entity-options-item\"\n                      style=\"min-width:80px;\"\n                      @click=", ">\n              ", "\n                    </button>\n                  </div>\n                  <!--FILTER CHIPS-->\n              ", "\n                  ", "\n                  ", "\n                  \n                  ", "\n\n            <div class=\"entity-options-search-results\">\n              ", "\n            </div>\n                  </div>\n                </div>\n              "])), this._searchHierarchy.length > 0 ? x(_templateObject47 || (_templateObject47 = _taggedTemplateLiteral(["\n                    <button class=\"entity-options-item close-item\" @click=", ">\n                      Back\n                    </button>\n                    <div class=\"entity-options-divider\"></div>\n                  "])), () => {
      if (this._quickMenuInvoke) {
        this._dismissWithAnimation();
      } else {
        this._goBackInSearch();
      }
    }) : E, this._searchBreadcrumb ? x(_templateObject48 || (_templateObject48 = _taggedTemplateLiteral(["\n                    <div class=\"entity-options-search-breadcrumb\">\n                      <div class=\"entity-options-search-breadcrumb-text\">", "</div>\n                    </div>\n                  "])), this._searchBreadcrumb) : x(_templateObject49 || (_templateObject49 = _taggedTemplateLiteral(["<div class=\"entity-options-search-skeleton\"></div>"]))), !this._disableSearchAutofocus, this._searchQuery, e => {
      ...
      return x(_templateObject50 || (_templateObject50 = _taggedTemplateLiteral(["\n                      <div class=\"chip-row search-filter-chips\" id=\"search-filter-chip-row\" style=\"margin-bottom:12px; justify-content: center; align-items: center;\">\n                        <button\n                          class=\"chip\"\n                          style=\"\n                            width: 72px;\n                            background: ", ";\n                            opacity: ", ";\n                            font-weight: ", ";\n                          \"\n                          ?selected=", "\n                          @click=", "\n                        >", "</button>\n                        ", "\n                      </div>\n                    "])), filter === 'all' ? this._customAccent : '#282828', filter === 'all' ? '1' : '0.8', filter === 'all' ? 'bold' : 'normal', filter === 'all', () => this._doSearch(), localize('search.filters.all'), classes.map(c => x(_templateObject51 || (_templateObject51 = _taggedTemplateLiteral(["\n                          <button\n                            class=\"chip\"\n                            style=\"\n                              width: 72px;\n                              background: ", ";\n                              opacity: ", ";\n                              font-weight: ", ";\n                            \"\n                            ?selected=", "\n                            @click=", "\n                          >\n                            ", "\n                          </button>\n                        "])), filter === c ? this._customAccent : '#282828', filter === c ? '1' : '0.8', filter === c ? 'bold' : 'normal', filter === c, () => this._doSearch(c), localize("search.filters.".concat(c)))));
    })(), this._searchLoading ? x(_templateObject52 || (_templateObject52 = _taggedTemplateLiteral(["<div class=\"entity-options-search-loading\">", "</div>"])), localize('common.loading')) : E, this._searchError ? x(_templateObject53 || (_templateObject53 = _taggedTemplateLiteral(["<div class=\"entity-options-search-error\">", "</div>"])), this._searchError) : E, this._usingMusicAssistant && !this._searchLoading ? x(_templateObject54 || (_templateObject54 = _taggedTemplateLiteral(["\n                    <div class=\"search-sub-filters\" style=\"display: flex; align-items: center; margin-bottom: 2px; margin-top: 4px; padding-left: 3px; width: 100%; gap: 8px;\">\n                      <div style=\"display: flex; align-items: center; flex-wrap: wrap; flex: 1; min-width: 0;\">\n                        <button\n                          class=\"button", "\"\n                          style=\"\n                            background: none;\n                            border: none;\n                            font-size: 1.2em;\n                            cursor: ", ";\n                            padding: 4px 8px;\n                            border-radius: 50%;\n                            transition: all 0.2s ease;\n                            margin-right: 8px;\n                            display: flex;\n                            align-items: center;\n                            opacity: ", ";\n                          \"\n                          @click=", "\n                          title=\"", "\"\n                        >\n                                                  <ha-icon .icon=", "></ha-icon>\n                          ", "\n                      </button>\n                      <button\n                          class=\"button", "\"\n                          style=\"\n                            background: none;\n                            border: none;\n                            font-size: 1.2em;\n                            cursor: ", ";\n                            padding: 4px 8px;\n                            border-radius: 50%;\n                            transition: all 0.2s ease;\n                            margin-right: 8px;\n                            display: flex;\n                            align-items: center;\n                            opacity: ", ";\n                          \"\n                          @click=", "\n                          title=\"", "\"\n                        >\n                          <ha-icon .icon=", "></ha-icon>\n                          ", "\n                      </button>\n                      ", "\n                      <button\n                          class=\"radio-mode-button", "\"\n                          @click=", "\n                          title=\"Radio Mode\"\n                        >\n                          <ha-icon .icon=", "></ha-icon>\n                      </button>\n                      ", "\n                      ", "\n                    </div>\n                  "])), this._initialFavoritesLoaded || this._favoritesFilterActive ? ' active' : '', this._searchAttempted ? 'pointer' : 'default', this._searchAttempted ? '1' : '0.5', this._searchAttempted ? () => {
      this._toggleFavoritesFilter();
    } : () => {}, localize('search.favorites'), this._initialFavoritesLoaded || this._favoritesFilterActive ? 'mdi:cards-heart' : 'mdi:cards-heart-outline', this._initialFavoritesLoaded || this._favoritesFilterActive ? x(_templateObject55 || (_templateObject55 = _taggedTemplateLiteral(["\n                            <span style=\"margin-left:6px;font-size:0.82em;font-weight:600;color:rgba(255,255,255,0.85);white-space:nowrap;\">\n                              ", "\n                            </span>\n                          "])), localize('search.favorites')) : E, this._recentlyPlayedFilterActive ? ' active' : '', this._searchAttempted ? 'pointer' : 'default', this._searchAttempted ? '1' : '0.5', this._searchAttempted ? () => {
      this._toggleRecentlyPlayedFilter();
    } : () => {}, localize('search.recently_played'), this._recentlyPlayedFilterActive ? 'mdi:clock' : 'mdi:clock-outline', this._recentlyPlayedFilterActive ? x(_templateObject56 || (_templateObject56 = _taggedTemplateLiteral(["\n                            <span style=\"margin-left:6px;font-size:0.82em;font-weight:600;color:rgba(255,255,255,0.85);white-space:nowrap;\">\n                              ", "\n                            </span>\n                          "])), localize('search.recently_played')) : E, this._isMusicAssistantEntity() ? x(_templateObject57 || (_templateObject57 = _taggedTemplateLiteral(["\n                        <button\n                            class=\"button", "\"\n                            style=\"\n                              background: none;\n                              border: none;\n                              font-size: 1.2em;\n                              cursor: ", ";\n                              padding: 4px 8px;\n                              border-radius: 50%;\n                              transition: all 0.2s ease;\n                              margin-right: 8px;\n                              display: flex;\n                              align-items: center;\n                              opacity: ", ";\n                            \"\n                            @click=", "\n                            title=\"", "\"\n                          >\n                            <ha-icon .icon=", "></ha-icon>\n                            ", "\n                        </button>\n                        ", "\n                      "])), this._upcomingFilterActive ? ' active' : '', this._searchAttempted ? 'pointer' : 'default', this._searchAttempted ? '1' : '0.5', this._searchAttempted ? () => {
      this._toggleUpcomingFilter();
    } : () => {}, localize('search.next_up'), this._upcomingFilterActive ? 'mdi:playlist-music' : 'mdi:playlist-music-outline', this._upcomingFilterActive ? x(_templateObject58 || (_templateObject58 = _taggedTemplateLiteral(["\n                              <span style=\"margin-left:6px;font-size:0.82em;font-weight:600;color:rgba(255,255,255,0.85);white-space:nowrap;\">\n                                ", "\n                              </span>\n                            "])), localize('search.next_up')) : E, this._hasMassQueueIntegration ? x(_templateObject59 || (_templateObject59 = _taggedTemplateLiteral(["\n                          <button\n                              class=\"button", "\"\n                              style=\"\n                                background: none;\n                                border: none;\n                                font-size: 1.2em;\n                                cursor: ", ";\n                                padding: 4px 8px;\n                                border-radius: 50%;\n                                transition: all 0.2s ease;\n                                margin-right: 8px;\n                                display: flex;\n                                align-items: center;\n                                opacity: ", ";\n                              \"\n                              @click=", "\n                              title=\"", "\"\n                            >\n                              <ha-icon .icon=", "></ha-icon>\n                              ", "\n                          </button>\n                        "])), this._recommendationsFilterActive ? ' active' : '', this._searchAttempted ? 'pointer' : 'default', this._searchAttempted ? '1' : '0.5', this._searchAttempted ? () => {
      this._toggleRecommendationsFilter();
    } : () => {}, localize('search.recommendations'), this._recommendationsFilterActive ? 'mdi:thumb-up' : 'mdi:thumb-up-outline', this._recommendationsFilterActive ? x(_templateObject60 || (_templateObject60 = _taggedTemplateLiteral(["\n                                <span style=\"margin-left:6px;font-size:0.81em;font-weight:600;color:rgba(255,255,255,0.85);white-space:nowrap;\">\n                                  ", "\n                                </span>\n                              "])), localize('search.recommendations')) : E) : E) : E, this._radioModeActive ? ' active' : '', () => this._toggleRadioMode(), this._radioModeActive ? 'mdi:radio' : 'mdi:radio-off', this._shouldShowSearchSortToggle() ? x(_templateObject61 || (_templateObject61 = _taggedTemplateLiteral(["\n                        <button\n                          class=\"button\"\n                          style=\"\n                            background: none;\n                            border: none;\n                            font-size: 1.2em;\n                            cursor: ", ";\n                            padding: 4px 8px;\n                            border-radius: 50%;\n                            transition: all 0.2s ease;\n                            margin-right: 8px;\n                            display: flex;\n                            align-items: center;\n                            opacity: ", ";\n                          \"\n                          @click=", "\n                          title=", "\n                        >\n                          <ha-icon .icon=", "></ha-icon>\n                        </button>\n                      "])), this._searchAttempted ? 'pointer' : 'default', this._searchAttempted ? '1' : '0.5', this._searchAttempted ? () => this._toggleSearchResultsSortDirection() : () => {}, this._getSearchSortToggleTitle(), this._getSearchSortToggleIcon()) : E, this._shouldShowSearchResultsCount() ? x(_templateObject62 || (_templateObject62 = _taggedTemplateLiteral(["\n                        <span class=\"search-results-count\">\n                          ", "\n                        </span>\n                      "])), this._getSearchResultsCountLabel()) : E) : E, (() => {
      this._searchMediaClassFilter || "all";
      ...
      return this._searchAttempted && currentResults.length === 0 && !this._searchLoading ? x(_templateObject63 || (_templateObject63 = _taggedTemplateLiteral(["<div class=\"entity-options-search-empty\" style=\"color: white;\">No results.</div>"]))) : paddedResults.map(item => item ? x(_templateObject64 || (_templateObject64 = _taggedTemplateLiteral(["\n                            <!-- EXISTING non\u2011placeholder row markup -->\n                            <div class=\"entity-options-search-result ", " ", "\">\n                              ", "\n                              <div style=\"flex:1; display:flex; flex-direction:column; justify-content:center;\">\n                                <span class=\"", "\"\n                                      @touchstart=", "\n                                      @click=", "\n                                      title=", ">\n                                  ", "\n                                </span>\n                                <span style=\"font-size:0.86em; color:#bbb; line-height:1.16; margin-top:2px;\">\n                                  ", "\n                                </span>\n                              </div>\n                                <div class=\"entity-options-search-buttons\">\n                              <button class=\"entity-options-search-play\" @click=", " title=\"", "\">\n                                    <ha-icon icon=\"mdi:play\"></ha-icon>\n                                  </button>\n                                  ", "\n                                </div>\n                                <!-- SLIDE-OUT MENU -->\n                                <div class=\"search-row-slide-out ", "\">\n                                  <button class=\"slide-out-button\" @click=", " title=\"", "\">\n                                    <ha-icon icon=\"mdi:playlist-remove\"></ha-icon> ", "\n                                  </button>\n                                  <button class=\"slide-out-button\" @click=", " title=\"", "\">\n                                    <ha-icon icon=\"mdi:playlist-play\"></ha-icon> ", "\n                                  </button>\n                                  <button class=\"slide-out-button\" @click=", " title=\"", "\">\n                                    <ha-icon icon=\"mdi:playlist-music\"></ha-icon> ", "\n                                  </button>\n                                  <button class=\"slide-out-button\" @click=", " title=\"", "\">\n                                    <ha-icon icon=\"mdi:playlist-plus\"></ha-icon> ", "\n                                  </button>\n                                  <div class=\"slide-out-close\" @click=", ">\n                                    <ha-icon icon=\"mdi:close\"></ha-icon>\n                                  </div>\n\n                                  ", "\n                                </div>\n                            </div>\n                          "])), item._justMoved ? 'just-moved' : '', item.media_content_id != null && this._activeSearchRowMenuId === item.media_content_id ? 'menu-active' : '', item.thumbnail && this._isValidArtworkUrl(item.thumbnail) && !String(item.thumbnail).includes('imageproxy') ? x(_templateObject65 || (_templateObject65 = _taggedTemplateLiteral(["\n                                <img\n                                  class=\"entity-options-search-thumb\"\n                                  src=", "\n                                  alt=", "\n                                  style=\"height:38px;width:38px;object-fit:var(--yamp-artwork-fit, cover);border-radius:5px;margin-right:12px;\"\n                                  onerror=\"this.style.display='none'\"\n                                />\n                              "])), item.thumbnail, item.title) : x(_templateObject66 || (_templateObject66 = _taggedTemplateLiteral(["\n                                <div class=\"entity-options-search-thumb-placeholder\" \n                                     style=\"height:38px;width:38px;border-radius:5px;margin-right:12px;background:rgba(255,255,255,0.1);display:flex;align-items:center;justify-content:center;\">\n                                  <ha-icon icon=\"mdi:music\" style=\"color:rgba(255,255,255,0.6);font-size:16px;\"></ha-icon>\n                                </div>\n                              "]))), this._isClickableSearchResult(item) ? 'clickable-search-result' : '', e => this._handleSearchResultTouch(item, e), () => this._handleSearchResultClick(item), this._getSearchResultClickTitle(item), item.title, (() => {
      ...
      }, localize('search.remove')) : x(_templateObject70 || (_templateObject70 = _taggedTemplateLiteral(["\n                                      <button class=\"entity-options-search-queue\" @click=", " title=\"More Options\">\n                                        <ha-icon icon=\"mdi:dots-vertical\"></ha-icon>\n                                      </button>\n                                    "])), e => {
        e.preventDefault();
        e.stopPropagation();
        this._activeSearchRowMenuId = item.media_content_id;
        this.requestUpdate();
        ...
        this._activeSearchRowMenuId = null;
        this.requestUpdate();
      }, this._successSearchRowMenuId === item.media_content_id ? x(_templateObject71 || (_templateObject71 = _taggedTemplateLiteral(["\n                                    <div class=\"search-row-success-overlay\">\n                                      \u2705 ", "\n                                    </div>\n                                  "])), localize('search.added')) : E) : x(_templateObject72 || (_templateObject72 = _taggedTemplateLiteral(["\n                            <!-- placeholder row keeps height -->\n                            <div class=\"entity-options-search-result placeholder\"></div>\n                          "]))));
    })()) : this._showGrouping ? this._renderGroupingSheet() : x(_templateObject73 || (_templateObject73 = _taggedTemplateLiteral(["\n                <div class=\"entity-options-header\">\n                  <button class=\"entity-options-item close-item\" @click=", ">\n                    ", "\n                  </button>\n                  <div class=\"entity-options-divider\"></div>\n                </div>\n                <div class=\"entity-options-scroll source-list-centering-wrapper\">\n                  <div class=\"source-list-sheet\">\n                    <div class=\"source-list-scroll\">\n                      ", "\n                    </div>\n                  </div>\n                </div>\n                <div class=\"floating-source-index\">\n                  ", "\n                </div>\n"])), () => {
      if (this._quickMenuInvoke) {
        this._dismissWithAnimation();
      } else {
        this._closeSourceList();
      }
    }, localize('common.back'), sourceList.map(src => x(_templateObject74 || (_templateObject74 = _taggedTemplateLiteral(["\n                        <div class=\"entity-options-item\" data-source-name=\"", "\" @click=", ">", "</div>\n                      "])), src, () => this._selectSource(src), src)), sourceLetters.map((letter, i) => {
      ...
      return artwork !== null && artwork !== void 0 && artwork.url && this._isValidArtworkUrl(artwork.url) ? x(_templateObject77 || (_templateObject77 = _taggedTemplateLiteral(["\n                      <img src=\"", "\" alt=\"Album Art\" class=\"persistent-artwork\" onerror=\"this.style.display='none'\">\n                    "])), artwork.url) : x(_templateObject78 || (_templateObject78 = _taggedTemplateLiteral(["\n                      <div class=\"persistent-artwork-placeholder\">\n                        <ha-icon icon=\"mdi:music\"></ha-icon>\n                      </div>\n                    "])));
      ...
      return x(_templateObject79 || (_templateObject79 = _taggedTemplateLiteral(["\n                    <div class=\"persistent-volume-stepper\">\n                      <button class=\"stepper-btn\" @click=", " title=\"", "\">\u2013</button>\n                      ", "\n                      <button class=\"stepper-btn\" @click=", " title=\"", "\">+</button>\n                    </div>\n                  "])), () => this._onVolumeStep(-1), localize('common.vol_down'), percentLabel ? x(_templateObject80 || (_templateObject80 = _taggedTemplateLiteral(["<span class=\"stepper-value\">", "</span>"])), percentLabel) : E, () => this._onVolumeStep(1), localize('common.vol_up'));
