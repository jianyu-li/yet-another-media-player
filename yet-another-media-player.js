...
`,So=[{mode:"replace",icon:"mdi:playlist-remove",label:h("search.replace")},{mode:"next",icon:"mdi:playlist-play",label:h("search.play_next")},{mode:"replace_next",icon:"mdi:playlist-music",label:h("search.replace_play")},{mode:"add",icon:"mdi:playlist-plus",label:h("search.add_queue")},{mode:"add_to_playlist",icon:"mdi:plus",label:h("search.add_to_playlist")}],Mt=["artist","album","track","playlist","radio","podcast","audiobook"],Ne=(i,{cap:e,floor:t}={})=>{const a=Number(i);if(!Number.isFinite(a)||a<=0)return;let s=a;return typeof t=="number"&&(s=Math.max(t,s)),typeof e=="number"&&(s=Math.min(e,s)),s},bs=3e4;let Ft=null,Ki=0;async function oi(i){const e=Date.now();if(Ft&&e-Ki<bs)return Ft;try{return Ft=(await i.callApi("GET","config/config_entries/entry")).find(t=>t.domain==="music_assistant"&&t.state==="loaded")?.entry_id||null,Ki=e,Ft}catch(t){return console.error("yamp: Failed to resolve Music Assistant config entry",t),Ft=null,Ki=e,null}}let Dt=null,Xi=0;async function Ji(i){const e=Date.now();if(Dt&&e-Xi<bs)return Dt;try{return Dt=(await i.callApi("GET","config/config_entries/entry")).find(t=>t.domain==="mass_queue"&&t.state==="loaded")?.entry_id||null,Xi=e,Dt}catch(t){return console.error("yamp: Failed to resolve mass_queue config entry",t),Dt=null,Xi=e,null}}function ct(i){return i?{title:i.name,media_content_id:i.uri,media_content_type:i.media_type,media_class:i.media_type,thumbnail:i.image,...i.artists&&{artist:i.artists.map(e=>e.name).join(", ")},...i.album&&{album:i.album.name},is_browsable:i.media_type==="artist"||i.media_type==="album"||i.media_type==="playlist",is_editable:i.is_editable===!0}:null}function li({item:i,onPlay:e,onOptionsToggle:t,upcomingFilterActive:a=!1,isMusicAssistant:s=!1,massQueueAvailable:r=!1,searchView:n="list",isInline:o=!1,onMoveUp:l,onMoveDown:c,onMoveNext:u,onRemove:d}){const p=!!(a&&i.queue_item_id&&s&&r),_=o?"entity-options-search-buttons":n==="card"?"card-overlay-buttons":"search-sheet-buttons",f=o?"entity-options-search-play":n==="card"?"search-sheet-play icon-only":"search-sheet-play",g=o?"entity-options-search-queue":n==="card"?"search-sheet-queue icon-only":"search-sheet-queue";return m`
  ...
  `}function xs({item:i,activeSearchRowMenuId:e,successSearchRowMenuId:t,successSearchRowType:a,onPlayOption:s,onOptionsToggle:r,searchView:n="list",isQueueItem:o=!1,onMoveUp:l,onMoveDown:c,onMoveNext:u,onRemove:d}){const p=e!=null&&i.media_content_id!=null&&e===i.media_content_id,_=t===i.media_content_id;return m`
    <div class="search-row-slide-out ${p?"active":""}">
      ${o&&n==="card"?m`
        <button class="slide-out-button" @click=${()=>{l(i),r(null)}} title="${h("search.move_up")}">
          ${h("search.move_up")}
        </button>
        <button class="slide-out-button" @click=${()=>{c(i),r(null)}} title="${h("search.move_down")}">
          ${h("search.move_down")}
        </button>
        <button class="slide-out-button" @click=${()=>{u(i),r(null)}} title="${h("search.move_next")}">
          ${h("search.move_next")}
        </button>
        <button class="slide-out-button" @click=${()=>{d(i),r(null)}} title="${h("search.remove")}">
          ${h("search.remove")}
        </button>
      `:m`
        ...
        ${i.media_class==="track"||i.media_content_type==="track"?m`
        ...
        `:y}
      `}
      <div class="slide-out-close" @click=${f=>{f.stopPropagation(),r(null)}}>
        <ha-icon icon="mdi:close"></ha-icon>
      </div>
  ...
  `}function $o({open:i,query:e,onQueryInput:t,onSearch:a,onClose:s,loading:r,results:n,onPlay:o,onQueue:l,error:c,showQueueSuccess:u,matchTheme:d=!1,upcomingFilterActive:p=!1,disableAutofocus:_=!1,activeSearchRowMenuId:f,successSearchRowMenuId:g,successSearchRowType:b,onOptionsToggle:k,onPlayOption:x,onResultClick:T,searchView:E="list",searchCardColumns:H=4,massQueueAvailable:F=!1,onMoveUp:D,onMoveDown:z,onMoveNext:R,onRemove:L}){return i?m`
    <div class="search-sheet" data-match-theme="${d}" data-card-view="${E==="card"}">
      ...
      <div class="search-sheet-results ${E==="card"?"search-results-card-view":"list-view"}">
        ${(n||[]).length===0&&!r?m`<div class="search-sheet-empty">${h("common.no_results")}</div>`:(n||[]).map(A=>{const N=tt(A.media_content_id),U=A.is_browsable&&(A.media_class!=="playlist"||F);return m`
                <div class="search-sheet-result ${E==="card"?"search-result-card":""}">
                  <div class="search-sheet-thumb-container" 
                    ...
                    `}
                    ${E==="card"?li({item:A,onPlay:o,onOptionsToggle:k,upcomingFilterActive:p,isMusicAssistant:N,massQueueAvailable:F,searchView:"card",onMoveUp:D,onMoveDown:z,onMoveNext:R,onRemove:L}):y}
                  </div>
                  ...
                  ${E!=="card"?li({item:A,onPlay:o,onOptionsToggle:k,upcomingFilterActive:p,isMusicAssistant:N,massQueueAvailable:F,searchView:"list",isInline:!0,onMoveUp:D,onMoveDown:z,onMoveNext:R,onRemove:L}):y}
                  
                  ${xs({item:A,activeSearchRowMenuId:f,successSearchRowMenuId:g,successSearchRowType:b,onPlayOption:x,onOptionsToggle:k,searchView:E,isQueueItem:N&&A.queue_item_id&&p&&F,onMoveUp:D,onMoveDown:z,onMoveNext:R,onRemove:L})}
                </div>
              `})}
      </div>
    </div>
  `:y}function Io({item:i,onClose:e,onPlayOption:t}){return i?m`
    <div class="entity-options-overlay entity-options-overlay-opening" @click=${e}>
      <div class="entity-options-container entity-options-sheet-opening" @click=${a=>a.stopPropagation()}>
        <div class="entity-options-sheet">
          ...
          ${So.map(a=>a.mode==="add_to_playlist"&&i.media_class!=="track"&&i.media_content_type!=="track"?y:m`
        ...
        <ha-card class="yamp-card" style=${a&&(!Q||this._alwaysCollapsed)?`height:${t}px;`:y}>
          ...
          >
            ${Oa&&Xa?m`
              ...
              ${ja?y:m`<div class="full-bleed-artwork-fade"></div>`}
            `:y}
            ...
            <div class="card-lower-content-container" style="${Za?`min-height:${Za}px;`:""}">
              ...
              ></div>
              ${ja?y:m`<div class="card-lower-fade"></div>`}
              <div class="card-lower-content${Q?" collapsed transitioning":" transitioning"}${Q&&le?" has-artwork":""}" style="${Qe?Q?`min-height: ${this._collapsedBaselineHeight||220}px;`:"min-height: 350px;":""}">
                ...
                `:y}
                ${ji||!Q?m`
                  <div class="card-artwork-spacer${ji?" show-placeholder":""}"
                    @pointerdown=${v=>this._onTapAreaPointerDown(v)}
                    @pointermove=${v=>this._onTapAreaPointerMove(v)}
                    @pointerup=${v=>this._onTapAreaPointerUp(v)}
                    @pointercancel=${()=>{this._gestureActive=!1,clearTimeout(this._gestureHoldTimer)}}
          ...
          <div class="entity-options-sheet${d||f?" chips-mode":""} entity-options-sheet-opening" 
            ...
            `:y}
              ...
              ${h("common.cancel")}
                  ...
                  `:y}
                  <!--FILTER CHIPS-->
               ${l?(()=>{const v=this._getVisibleSearchFilterClasses(),j=this._searchMediaClassFilter||"all";return this._searchHierarchy.length>0||v.length<2&&!this._usingMusicAssistant?y:m`
                      <div class="chip-row search-filter-chips" id="search-filter-chip-row" style="margin-bottom:12px; justify-content: center; align-items: center;">
                        ...
                        ${v.map(G=>m`
                          <button
                            ...
                            style="
                              width: 72px;
                              background: ${j===G?this._customAccent:"#282828"};
                              opacity: ${j===G?"1":"0.8"};
                              font-weight: ${j===G?"bold":"normal"};
                            "
                            ?selected=${j===G}
            ...
            <div class="entity-options-search-results ${this.config.search_view==="card"?"search-results-card-view":"list-view"}" 
              ...
              ${(()=>{this._searchMediaClassFilter;const v=this._getDisplaySearchResults(),j=Math.max(15,this._searchTotalRows||v.length),G=[...v,...Array.from({length:Math.max(0,j-v.length)},()=>null)];return this._searchAttempted&&v.length===0&&!this._searchLoading?m`<div class="entity-options-search-empty">${h("common.no_results")}</div>`:G.map(q=>q?m`
                            ...
                            <div class="entity-options-search-result ${this.config.search_view==="card"?"search-result-card":""} ${q._justMoved?"just-moved":""} ${q.media_content_id!=null&&this._activeSearchRowMenuId===q.media_content_id?"menu-active":""}">
                               <div class="search-sheet-thumb-container"
                                ...
                                `}
                                ${this.config.search_view==="card"?li({item:q,onPlay:M=>this._playMediaFromSearch(M),onOptionsToggle:M=>{this._activeSearchRowMenuId=M?.media_content_id||null,this.requestUpdate()},upcomingFilterActive:!!this._upcomingFilterActive,isMusicAssistant:this._isMusicAssistantEntity(),massQueueAvailable:this._massQueueAvailable,searchView:"card"}):y}
                               </div>
                               <div class="search-sheet-info">
                                <span class="${this._isClickableSearchResult(q)?"clickable-search-result":""} ${this.config.search_view==="card"?"search-sheet-title":""}"
                                      @touchstart=${M=>this._handleSearchResultTouch(q,M)}
                                      @click=${()=>this._handleSearchResultClick(q)}
                                      title=${this._getSearchResultClickTitle(q)}>
                                  ${q.title}
                                </span>
                                 <span class="search-sheet-subtitle">
                                  ${(()=>{const M=this._searchMediaClassFilter==="track"||this._searchMediaClassFilter==="album",Se=!!this._recentlyPlayedFilterActive,Cn=!!this._upcomingFilterActive,Tn=!!this._recommendationsFilterActive;return(M||Se||Cn||Tn)&&q.artist?q.artist:q.media_class?q.media_class.charAt(0).toUpperCase()+q.media_class.slice(1):""})()}
                                </span>
                                ${this.config.search_view==="card"?m`
                                  <div class="card-menu-button" @click=${M=>{M.preventDefault(),M.stopPropagation(),this._activeSearchRowMenuId=q.media_content_id,this.requestUpdate()}}>
                                    <ha-icon icon="mdi:dots-vertical"></ha-icon>
                                  </div>
                                `:y}
                              </div>
              ...
              `:this._showGrouping?this._renderGroupingSheet():m`
                ...
                <div class="floating-source-index">
                  ${pe.map((v,j)=>{const G=Ae.has(v),q=this._hoveredSourceLetterIndex;let M="";if(G&&q!==null&&q!==void 0){const Se=Math.abs(q-j);Se===0?M="max":Se===1?M="large":Se===2&&(M="med")}return m`
                      <button
                        class="source-index-letter"
                        ?disabled=${!G}
                        data-scale=${M}
                        @mouseenter=${G?()=>{this._hoveredSourceLetterIndex=j,this.requestUpdate()}:y}
...
`}
            ...
            ${Ha?m`
              <div class="persistent-media-controls" @click=${v=>v.stopPropagation()}>
                <div class="persistent-controls-artwork">
                  ${(()=>{const v=this.currentPlaybackStateObj,j=this.currentStateObj,G=this._getArtworkUrl(v)||this._getArtworkUrl(j);return G?.url&&this._isValidArtworkUrl(G.url)?m`
                ...
                ${(()=>{const v=this._selectedIndex,j=this._getVolumeEntity(v);if(!j)return y;const G=j.startsWith&&j.startsWith("remote."),q=this.currentVolumeStateObj,M=Number(q?.attributes?.volume_level??0),Se=G?null:`${Math.round((M||0)*100)}%`;return this.config.volume_mode==="hidden"?y:m`
        ...
        `:y}
          ${this._searchActiveOptionsItem?Io({item:this._searchActiveOptionsItem,onClose:()=>{this._searchActiveOptionsItem=null,this.requestUpdate()},onPlayOption:(v,j)=>this._performSearchOptionAction(v,j)}):y}
