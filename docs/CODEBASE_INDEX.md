...
| **Lyrics Synchronization** | [`src/lyrics-view.js`](../src/lyrics-view.js), [`src/lyrics-parser.js`](../src/lyrics-parser.js) | `parseLrc`, `_syncActiveLyric` | Synchronized LRC parser, auto-scroll lyrics overlay, time-based line highlights. |
