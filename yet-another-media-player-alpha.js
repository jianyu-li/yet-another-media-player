...
class YetAnotherMediaPlayerCard extends i$1 {
  ...
  _getFavoriteButtonEntity() {
    var _this$hass2, _mainState$attributes, _this$hass3, _maState$attributes;
    ...
    const mainState = (_this$hass2 = this.hass) === null || _this$hass2 === void 0 || (_this$hass2 = _this$hass2.states) === null || _this$hass2 === void 0 ? void 0 : _this$hass2[mainEntityId];
    if ((mainState === null || mainState === void 0 || (_mainState$attributes = mainState.attributes) === null || _mainState$attributes === void 0 ? void 0 : _mainState$attributes.app_id) === 'music_assistant') {
    ...
    if (!maState || ((_maState$attributes = maState.attributes) === null || _maState$attributes === void 0 ? void 0 : _maState$attributes.app_id) !== 'music_assistant') return null;
  ...
  _getMusicAssistantState() {
    var _this$hass4, _mainState$attributes2, _this$hass5, _maState$attributes2;
    const obj = this.entityObjs[this._selectedIndex];
    if (!obj) return null;

    // Check if the main entity is a Music Assistant entity
    const mainEntityId = obj.entity_id;
    const mainState = (_this$hass4 = this.hass) === null || _this$hass4 === void 0 || (_this$hass4 = _this$hass4.states) === null || _this$hass4 === void 0 ? void 0 : _this$hass4[mainEntityId];
    if ((mainState === null || mainState === void 0 || (_mainState$attributes2 = mainState.attributes) === null || _mainState$attributes2 === void 0 ? void 0 : _mainState$attributes2.app_id) === 'music_assistant') {
      return mainState;
    }
    ...
    const maEntityId = this._resolveEntity(obj.music_assistant_entity, obj.entity_id, this._selectedIndex);
    if (!maEntityId) return null;
    const maState = (_this$hass5 = this.hass) === null || _this$hass5 === void 0 || (_this$hass5 = _this$hass5.states) === null || _this$hass5 === void 0 ? void 0 : _this$hass5[maEntityId];
    if (!maState || ((_maState$attributes2 = maState.attributes) === null || _maState$attributes2 === void 0 ? void 0 : _maState$attributes2.app_id) !== 'music_assistant') {
      return null;
    }
    return maState;
  }
  ...
  _isCurrentTrackFavorited() {
    ...
    const mediaContentId = (_maState$attributes3 = maState.attributes) === null || _maState$attributes3 === void 0 ? void 0 : _maState$attributes3.media_content_id;
    if (!mediaContentId) return false;

    // Check if Music Assistant provides favorite status in entity attributes
    if (typeof ((_maState$attributes4 = maState.attributes) === null || _maState$attributes4 === void 0 ? void 0 : _maState$attributes4.is_favorite) === 'boolean') {
  ...
  async _checkFavoriteStatusAsync(mediaContentId) {
    ...
    try {
      var _maState$attributes5, _maState$attributes6;
      // Get the current Music Assistant entity ID
      const maState = this._getMusicAssistantState();
      const entityId = maState === null || maState === void 0 ? void 0 : maState.entity_id;
      const trackName = (_maState$attributes5 = maState.attributes) === null || _maState$attributes5 === void 0 ? void 0 : _maState$attributes5.media_title;
      const artistName = (_maState$attributes6 = maState.attributes) === null || _maState$attributes6 === void 0 ? void 0 : _maState$attributes6.media_artist;
  ...
  _getEntityForPurpose(idx, purpose) {
    ...
    switch (purpose) {
      ...
      case 'grouping_control':
        ...
        const mainIsMA = (mainState === null || mainState === void 0 || (_mainState$attributes3 = mainState.attributes) === null || _mainState$attributes3 === void 0 ? void 0 : _mainState$attributes3.supported_features) && (mainState.attributes.supported_features & SUPPORT_GROUPING) !== 0;
        if (mainIsMA) {
          return obj.entity_id;
        }
      ...
      case "favorite":
        {
          ...
          if (favoriteButtonEntity) {
            var _this$hass16, _maState$attributes7;
            ...
            if (maState !== null && maState !== void 0 && (_maState$attributes7 = maState.attributes) !== null && _maState$attributes7 !== void 0 && _maState$attributes7.media_content_id) {
              if (this._favoriteStatusCache) {
  ...
  render() {
    var _this$_optimisticPlay, _this$hass20, _this$_lastPlayingEnt4, _this$_lastPlayingEnt5, _this$_playbackLinger3, _this$config$entities, _this$_lastPlayingEnt6, _this$_maResolveCache3, _this$_playbackLinger4, _this$hass21, _mainState$attributes4, _mainState$attributes5, _mainState$attributes6, _mainState$attributes7, _this$currentVolumeSt2, _this$config4, _this$config5, _this$config6, _this$currentVolumeSt3, _this$currentStateObj;
    ...
    const title = shouldShowDetails ? finalPlaybackStateObj.attributes.media_title || (mainState === null || mainState === void 0 || (_mainState$attributes4 = mainState.attributes) === null || _mainState$attributes4 === void 0 ? void 0 : _mainState$attributes4.media_title) || "" : "";
  ...
  _updateIdleState() {
    ...
    const actualMaState = actualMaId ? (_this$hass27 = this.hass) === null || _this$hass27 === void 0 || (_this$hass27 = _this$hass27.states) === null || _this$hass27 === void 0 ? void 0 : _this$hass27[actualMaId] : null;
