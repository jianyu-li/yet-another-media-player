...
export class YetAnotherMediaPlayerEditor extends LitElement {
  ...
  _renderTemplateToggle(key, currentValue, updateCallback, disabled = false) {
    ...
    return html`
      <ha-icon
        class="icon-button-small icon-button-toggle ${isTemplate ? "active" : ""} ${disabled ? "icon-button-disabled" : ""
      }"
  ...
  _renderActionsTab() {
    ...
    return html`
      ...
      (act, idx) => html`
          ...
          ? html`
                              <ha-icon
                                class="icon-button icon-button-compact icon-button-toggle ${act?.in_menu === "hidden"
              ? "icon-button-disabled"
              : act?.in_menu === true
                ? "active"
                : ""
