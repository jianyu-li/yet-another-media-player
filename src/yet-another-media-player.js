                  ...
                  : "";
                              ...
                              <div class="entity-options-search-buttons">
                                ...
                                ${!(this._upcomingFilterActive && item.queue_item_id && this._isMusicAssistantEntity() && this._massQueueAvailable) ? html`
                                  <button class="entity-options-search-queue" @click=${(e) => { e.preventDefault(); e.stopPropagation(); this._searchActiveOptionsItem = item; this.requestUpdate(); }} title="More Options">
